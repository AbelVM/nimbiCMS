...
function safeGet(mod, name) {
  try {
    ...
    try {
      if (mod.default) return mod.default[name];
    } catch (e) {}
    return undefined;
  } catch (e) {
    return undefined;
      ...
      try {
        ...
        try {
          if (it.path && typeof it.path === "string") {
            ...
            const found =
              findSlugForPath(baseOnly) || mdToSlug?.get(baseOnly) || "" || "";
            ...
            if (!raw && it.title && String(it.title).trim())
              canonical = slugify(String(it.title).trim());
            else canonical = raw || "";
          }
        } catch (e) {
...
export async function buildNav(
  ...
  const navDoc = parser
    ? parser.parseFromString(navHtml || "", "text/html")
    : null;
  ...
  try {
    seedNavSlugMappings(linkEls, contentBase);
  } catch (_) {}
  ...
  function closeMobileMenu() {
    try {
      ...
      debugWarn("[nimbi-cms] closeMobileMenu failed", err);
    }
  }
      ...
      try {
        if (typeof requestAnimationFrame === "function") {
          requestAnimationFrame(() => {
            try {
              if (contentEl) contentEl.classList.remove("is-inactive");
            } catch (e) {}
          });
        } else {
          try {
    ...
    try {
      ...
      try {
        if (entry && entry.path && typeof entry.path === "string") {
          ...
          try {
            if (navHrefToSlug && navHrefToSlug.has(pathNorm))
              return { page: navHrefToSlug.get(pathNorm), hash };
            if (navHrefToSlug && navHrefToSlug.has(base))
              return { page: navHrefToSlug.get(base), hash };
          } catch (_) {}
          try {
            if (mdToSlug?.has?.(pathNorm))
              return { page: mdToSlug.get(pathNorm), hash };
          } catch (_) {}
          try {
      ...
      if (s && (s.includes(".") || s.includes("/"))) {
        const candidatePath = normalizePath(
          entry && entry.path ? String(entry.path) : s,
        );
        const candBase = candidatePath.replace(/^.*\//, "");
        try {
          if (navHrefToSlug && navHrefToSlug.has(candidatePath))
            return { page: navHrefToSlug.get(candidatePath), hash };
          if (navHrefToSlug && navHrefToSlug.has(candBase))
            return { page: navHrefToSlug.get(candBase), hash };
        } catch (_) {}
        try {
            ...
            try {
              ...
              for (const [k, v] of slugToMd.entries()) {
                try {
                  ...
                  if (
                    val === normCand ||
                    val.endsWith("/" + normCand) ||
                    normCand.endsWith("/" + val) ||
                    val.endsWith(candBase2) ||
                    normCand.endsWith(candBase2)
                  ) {
                    found = k;
                    break;
                  }
  ...
  const ensureSearchIndex = () => {
    ...
    searchIndexPromise = (async () => {
      try {
        ...
        const globalWorker =
          typeof globalThis !== "undefined"
            ? globalThis.buildSearchIndexWorker
            : undefined;
        const buildFn =
    ...
    searchIndexPromise
      .then((idx) => {
        try {
          ...
          try {
            normalizeSearchIndexEntriesMut(idx);
          } catch (_) {}
          try {
            if (typeof window !== "undefined") {
                ...
                (async () => {
                  try {
                    try {
                      ...
                      try {
                        _setSearchIndex(Array.isArray(idx) ? idx : []);
                      } catch (_) {}
                      Object.defineProperty(window, "__nimbiResolvedIndex", {
                        get() {
                          return Array.isArray(searchIndex)
                            ? searchIndex
                            : Array.isArray(resolvedIndexForSitemap)
                              ? resolvedIndexForSitemap
                              : [];
                        },
                        enumerable: true,
                        configurable: true,
                      ...
                      try {
                        window.__nimbiResolvedIndex = Array.isArray(searchIndex)
                          ? searchIndex
                          : Array.isArray(resolvedIndexForSitemap)
                            ? resolvedIndexForSitemap
                            : [];
              ...
              try {
                window.__nimbi_contentBase = contentBase;
              } catch (e) {}
              try {
                window.__nimbi_indexDepth = indexDepth;
              } catch (e) {}
              try {
                window.__nimbi_noIndexing = noIndexing;
              } catch (e) {}
            }
          } catch (e) {}
          const qnow = String((searchInput && searchInput.value) ?? "")
            .trim()
            .toLowerCase();
          ...
          const resultsEl =
            typeof dropdownContent !== "undefined" && dropdownContent
              ? dropdownContent
              : typeof document !== "undefined"
                ? document.getElementById("nimbi-search-results")
                : null;
          if (!resultsEl) return;
          try {
            if (typeof resultsEl.replaceChildren === "function")
            ...
            filteredNow.slice(0, 10).forEach((it) => {
              try {
                if (it.parentTitle) {
                  ...
                  p.className =
                    "panel-heading nimbi-search-title nimbi-search-parent";
                ...
                try {
                  if (it.path && typeof it.path === "string") {
                    try {
                      storeSlugMapping(_t.page, it.path);
                    } catch (ee) {}
                  }
                } catch (e) {}
      ...
      .finally(() => {
        (async () => {
          try {
            ...
            try {
              debugWarn("[nimbi-cms] sitemap dynamic import failed", err);
            } catch (_) {}
          }
        })();
      });
    ...
    try {
      ...
      try {
        if (
          ...
          (/(?:\.md|\.html?)$/i.test(target) || target.includes("/"))
        ) {
      ...
      try {
        const slugCandidate =
          ...
          (/(?:\.md|\.html?)$/i.test(homePage) || homePage.includes("/"))
            ? findSlugForPath(homePage)
            : typeof homePage === "string" && !homePage.includes(".")
              ? homePage
              : null;
  ...
  if (logoSrc) {
    try {
      ...
      const label =
        t && typeof t === "function" ? t("home") || t("siteLogo") || "" : "";
      img.alt = label;
      img.title = label;
      img.src = logoSrc;
      try {
      ...
      /* ignore image insertion failures */
    }
  }
  ...
  function findSlugForPath(p) {
    try {
      ...
      try {
        if (mdToSlug?.has?.(norm)) return mdToSlug.get(norm);
      } catch (e) {}
      // Try basename lookup
      const base = norm.replace(/^.*\//, "");
      try {
        if (mdToSlug?.has?.(base)) return mdToSlug.get(base);
      } catch (e) {}
      ...
      try {
        for (const [slug, entry] of slugToMd.entries()) {
          ...
          if (typeof entry === "string") {
            ...
            if (entry.default && normalizePath(entry.default) === norm)
              return slug;
    ...
    try {
      ...
      for (let i = 0; i < linkEls.length; i++) {
        try {
          ...
          let existing = null;
          try {
            if (navHrefToSlug && navHrefToSlug.has(norm))
              existing = navHrefToSlug.get(norm);
          } catch (_) {}
          try {
            if (!existing && mdToSlug?.has?.(norm))
              existing = mdToSlug.get(norm);
          } catch (_) {}
          ...
          try {
            displayName =
              a.textContent && String(a.textContent).trim()
          ...
          if (candidate) {
            ...
            try {
              toUpgrade.push({ path: norm, candidate });
            } catch (_) {}
          }
        } catch (_) {}
      }
          ...
          try {
            ...
            if (md.isHtml) {
              try {
                ...
                const doc = parser2
                  ? parser2.parseFromString(md.raw, "text/html")
                  : null;
                const h1el = doc
                  ? doc.querySelector("h1") || doc.querySelector("title")
                  : null;
                if (h1el && h1el.textContent)
                  h1 = String(h1el.textContent).trim();
              } catch (_) {}
            } else {
              try {
            ...
            if (h1) {
              ...
              if (h1Slug && h1Slug !== cur.candidate) {
                try {
                  storeSlugMapping(h1Slug, cur.path);
                } catch (_) {}
                try {
                  navHrefToSlug.set(cur.path, h1Slug);
                } catch (_) {}
                try {
                  navHrefToSlug.set(cur.path.replace(/^.*\//, ""), h1Slug);
                } catch (_) {}
                ...
                try {
                  try {
                    if (Array.isArray(searchIndex)) {
                      ...
                      try {
                        if (changed) _setSearchIndex(searchIndex);
                      } catch (_) {}
                    }
                  } catch (_) {}
                } catch (_) {}
  ...
  try {
    burger.addEventListener("click", (ev) => {
      try {
        const targetId =
          burger.dataset && burger.dataset.target
            ? burger.dataset.target
            : null;
        const target = targetId
          ? navbar && navbar.querySelector
            ? navbar.querySelector(`#${targetId}`) ||
              (navbarWrap && navbarWrap.querySelector
                ? navbarWrap.querySelector(`#${targetId}`)
                : document.getElementById(targetId))
  ...
  if (!effectiveSearchEnabled) {
    ...
    try {
      const ariaLabel =
        (t && typeof t === "function" ? t("searchAria") : null) ||
      ...
      try {
        searchInput.setAttribute("aria-controls", "nimbi-search-results");
      } catch (e) {}
      try {
    ...
    const showResults = (items) => {
      ...
      try {
        if (typeof dropdownContent.replaceChildren === "function")
        ...
        try {
          ...
          if (key === "ArrowDown") {
            ...
            const next =
              selectedIndex < 0
                ? 0
                : Math.min(all.length - 1, selectedIndex + 1);
          ...
          if (key === "Enter") {
            ev.preventDefault();
            const el =
              dropdownContent.querySelector(
                ".nimbi-search-result.is-selected",
              ) || dropdownContent.querySelector(".nimbi-search-result");
            if (el) {
              try {
                el.click();
              } catch (e) {}
          ...
          if (key === "Escape") {
            ...
            try {
              dropdownContent.removeEventListener("keydown", resultsKeydown);
            } catch (e) {}
            try {
            ...
            try {
              if (searchInput)
                searchInput.removeEventListener("keydown", inputKeyHandler);
            } catch (e) {}
            return;
          }
        } catch (e) {
            ...
            try {
              ...
              try {
                ...
                try {
                  ...
                  /* ignore URL parse errors, fall back to navigation */
                }
                ...
                if (pageParam) {
                  try {
                    history.pushState(
                      { page: pageParam },
                      "",
                      buildPageUrl(pageParam, hash),
                    );
                    try {
                      runRenderWithTransition();
                    } catch (e) {
                      /* best-effort: if helper missing, fallback to window render */
                      try {
                        if (
                    ...
                    /* if pushState fails, fall through to location change */
                  }
                }
              } catch (e) {
                /* ignore navigation helper failures */
              }
      ...
      try {
        dropdownContent.addEventListener("keydown", resultsKeydown);
      } catch (e) {}
      try {
        if (searchInput)
          searchInput.addEventListener("keydown", inputKeyHandler);
      } catch (e) {}
    };
    ...
    if (searchInput) {
      const handleInput = debounce(async () => {
        const domInput =
          searchInput ||
          (typeof navbar !== "undefined" && navbar && navbar.querySelector
            ? navbar.querySelector("input#nimbi-search")
            : navbarWrap && navbarWrap.querySelector
              ? navbarWrap.querySelector("input#nimbi-search")
              : typeof document !== "undefined"
                ? document.querySelector("input#nimbi-search")
                : null);
        const q = String((domInput && domInput.value) ?? "")
          .trim()
          .toLowerCase();
      ...
      searchIndexPromise.finally(() => {
        ...
        (async () => {
          try {
            ...
            try {
              await handleSitemapRequest({
                index: Array.isArray(idx) ? idx : undefined,
                homePage,
                contentBase,
                indexDepth,
                noIndexing,
    ...
    try {
      const searchOutsideHandler = (ev) => {
        try {
          ...
          if (
            tgt &&
            (resultsContainer.contains(tgt) ||
              (searchInput &&
                (tgt === searchInput ||
                  (searchInput.contains && searchInput.contains(tgt)))))
          )
            return;
          if (dropdown) {
            dropdown.classList.remove("is-active");
  ...
  for (let i = 0; i < linkEls.length; i++) {
    ...
    try {
          ...
          try {
            ...
            if (res && res.raw) {
              try {
                const parser2 = getSharedParser();
                const doc = parser2
                  ? parser2.parseFromString(res.raw, "text/html")
                  : null;
                ...
                if (titleText) {
                  ...
                  if (slugKey) {
                    try {
                      ...
                      debugWarn("[nimbi-cms] slugToMd/mdToSlug set failed", ee);
                    }
      ...
      debugWarn("[nimbi-cms] nav item href parse failed", e);
      item.href = href;
    }
    try {
      const displayName =
        ...
        try {
          ...
          if (slugKey) {
            ...
            if (/^[^#?]*\.(?:md|html?)(?:$|[?#])/i.test(hrefVal)) {
              mappingTarget = normalizePath(
                String(hrefVal ?? "").split(/[?#]/)[0],
              );
            } else {
              // If it's a canonical ?page=... form, use the page value
              try {
                const p = parseHrefToRoute(hrefVal);
                if (p && p.type === "canonical" && p.page)
                  mappingTarget = normalizePath(p.page);
              } catch (_e) {}
            }
            if (mappingTarget) {
              ...
              try {
                ...
                if (
                  /\.(?:html?)(?:$|[?#])/i.test(String(mappingTarget ?? ""))
                ) {
                  persistMapping = true;
                } else if (
                  /\.(?:md)(?:$|[?#])/i.test(String(mappingTarget ?? ""))
                ) {
                  ...
                  if (allMarkdownPathsSet && allMarkdownPathsSet.size) {
                    if (
                      allMarkdownPathsSet.has(norm) ||
                      allMarkdownPathsSet.has(baseName)
                    )
                      persistMapping = true;
                  }
                }
              ...
              if (persistMapping) {
                try {
                  ...
                  try {
                    if (
                      findSlugForPath &&
                      typeof findSlugForPath === "function" &&
                      findSlugForPath(norm)
                    )
                      alreadyMapped = true;
                  } catch (_) {}
                  ...
                  try {
                    storeSlugMapping(slugKey, mappingTarget);
                  } catch (ee) {}
                  try {
                    if (norm) {
                      try {
                        navHrefToSlug.set(norm, slugKey);
                      } catch (_) {}
                      try {
                        const b = norm.replace(/^.*\//, "");
                        if (b) navHrefToSlug.set(b, slugKey);
                      } catch (_) {}
                    }
                  } catch (_) {}
                  ...
                  if (alreadyMapped) {
                    try {
                      item.href = buildPageUrl(slugKey);
                    } catch (_) {}
                  }
                } catch (_) {}
              }
          ...
          debugWarn("[nimbi-cms] nav slug mapping failed", ee);
        }
      }
    } catch (ee) {
      debugWarn("[nimbi-cms] nav slug mapping failed", ee);
  ...
  try {
    start.appendChild(startFrag);
  } catch (e) {
    /* fallback: if append fails, leave per-item appended above */
  }
  ...
  try {
    const outsideHandler = (ev) => {
      try {
        ...
        const navEl =
          burgerEl && burgerEl.closest ? burgerEl.closest(".navbar") : navbar;
  ...
  try {
    menu.addEventListener("click", (ev) => {
      ...
      try {
        ...
        debugWarn("[nimbi-cms] navbar click handler failed", e);
      }
      try {
        const burgerEl =
          typeof navbar !== "undefined" && navbar && navbar.querySelector
            ...
            : navbarWrap && navbarWrap.querySelector
              ...
              : null;
        const targetId =
          burgerEl && burgerEl.dataset ? burgerEl.dataset.target : null;
        const target = targetId
          ? navbar && navbar.querySelector
            ? navbar.querySelector(`#${targetId}`) ||
              (navbarWrap && navbarWrap.querySelector
        ...
        debugWarn("[nimbi-cms] mobile menu close failed", err);
      }
    });
  } catch (e) {
    debugWarn("[nimbi-cms] attach content click handler failed", e);
  }
