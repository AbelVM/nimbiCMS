...
`)}}}fences(t){let e=this.rules.block.fences.exec(t);if(e){let r=e[0],s=Fs(r,e[3]||"",this.rules);return{type:"code",raw:r,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:s}}}heading(t){let e=this.rules.block.heading.exec(t);if(e){let r=e[2].trim();if(this.rules.other.endingHash.test(r)){let s=St(r,"#");(this.options.pedantic||!s||this.rules.other.endingSpaceChar.test(s))&&(r=s.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:r,tokens:this.lexer.inline(r)}}}hr(t){let e=this.rules.block.hr.exec(t);if(e)return{type:"hr",raw:St(e[0],`
...
${o}`:o,n=n?`${n}
${c}`:c;let u=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(c,i,!0),this.lexer.state.top=u,r.length===0)break;let f=i.at(-1);if(f?.type==="code")break;if(f?.type==="blockquote"){let p=f,d=p.raw+`
`+r.join(`
...
`)?"":`
`)+n.raw,a.text+=`
`+n.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=a.text):r.push(n);continue}if(e){let a="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(a);break}else throw new Error(a)}}return this.state.top=!0,r}inline(e,r=[]){return this.inlineQueue.push({src:e,tokens:r}),r}inlineTokens(e,r=[]){let s=e,n=null;if(this.tokens.links){let l=Object.keys(this.tokens.links);if(l.length>0)for(;(n=this.tokenizer.rules.inline.reflinkSearch.exec(s))!=null;)l.includes(n[0].slice(n[0].lastIndexOf("[")+1,-1))&&(s=s.slice(0,n.index)+"["+"a".repeat(n[0].length-2)+"]"+s.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(n=this.tokenizer.rules.inline.anyPunctuation.exec(s))!=null;)s=s.slice(0,n.index)+"++"+s.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let i;for(;(n=this.tokenizer.rules.inline.blockSkip.exec(s))!=null;)i=n[2]?n[2].length:0,s=s.slice(0,n.index+i)+"["+"a".repeat(n[0].length-i-2)+"]"+s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);s=this.options.hooks?.emStrongMask?.call({lexer:this},s)??s;let a=!1,h="";for(;e;){a||(h=""),a=!1;let l;if(this.options.extensions?.inline?.some(c=>(l=c.call({lexer:this},e,r))?(e=e.substring(l.raw.length),r.push(l),!0):!1))continue;if(l=this.tokenizer.escape(e)){e=e.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.tag(e)){e=e.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.link(e)){e=e.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(l.raw.length);let c=r.at(-1);l.type==="text"&&c?.type==="text"?(c.raw+=l.raw,c.text+=l.text):r.push(l);continue}if(l=this.tokenizer.emStrong(e,s,h)){e=e.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.codespan(e)){e=e.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.br(e)){e=e.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.del(e,s,h)){e=e.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.autolink(e)){e=e.substring(l.raw.length),r.push(l);continue}if(!this.state.inLink&&(l=this.tokenizer.url(e))){e=e.substring(l.raw.length),r.push(l);continue}let o=e;if(this.options.extensions?.startInline){let c=1/0,u=e.slice(1),f;this.options.extensions.startInline.forEach(p=>{f=p.call({lexer:this},u),typeof f=="number"&&f>=0&&(c=Math.min(c,f))}),c<1/0&&c>=0&&(o=e.substring(0,c+1))}if(l=this.tokenizer.inlineText(o)){e=e.substring(l.raw.length),l.raw.slice(-1)!=="_"&&(h=l.raw.slice(-1)),a=!0;let c=r.at(-1);c?.type==="text"?(c.raw+=l.raw,c.text+=l.text):r.push(l);continue}if(e){let c="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(c);break}else throw new Error(c)}}return r}},Zt=class{options;parser;constructor(t){this.options=t||Ye}space(t){return""}code({text:t,lang:e,escaped:r}){let s=(e||"").match(ve.notSpaceStart)?.[0],n=t.replace(ve.endingNewline,"")+`
...
`;for(let w=l;w<=o;w++)if((e(f[w])||!u(f[w])&&(u(f[w+1])||e(f[w+1])))&&h++,e(f[w]))for(;w<=o&&(s(f[w+1])||u(f[w+1]));)w++;const p=h/c,d=Math.round(p*60*1e3);return{text:Math.ceil(p.toFixed(2))+" min read",minutes:p,time:d,words:h}}return zn=n,zn}var da=ha();const pa=Gn(da);function Gr(t,e){let r=document.querySelector(`meta[name="${t}"]`);r||(r=document.createElement("meta"),r.setAttribute("name",t),document.head.appendChild(r)),r.setAttribute("content",e)}function ot(t,e,r){let s=`meta[${t}="${e}"]`,n=document.querySelector(s);n||(n=document.createElement("meta"),n.setAttribute(t,e),document.head.appendChild(n)),n.setAttribute("content",r)}function fa(t,e){try{let r=document.querySelector(`link[rel="${t}"]`);r||(r=document.createElement("link"),r.setAttribute("rel",t),document.head.appendChild(r)),r.setAttribute("href",e)}catch(r){console.warn("[seoManager] upsertLinkRel failed",r)}}function ga(t,e,r,s){const n=e&&String(e).trim()?e:t.title||document.title;ot("property","og:title",n);const i=s&&String(s).trim()?s:t.description||"";i&&String(i).trim()&&ot("property","og:description",i),ot("name","twitter:card",t.twitter_card||"summary_large_image");const a=r||t.image;a&&(ot("property","og:image",a),ot("name","twitter:image",a))}function ma(t,e,r,s,n=""){const i=t.meta||{},a=document&&document.querySelector&&document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",h=s&&String(s).trim()?s:i.description&&String(i.description).trim()?i.description:a&&String(a).trim()?a:"";h&&String(h).trim()&&Gr("description",h),Gr("robots",i.robots||"index,follow"),ga(i,e,r,h)}function wa(){try{const t=['meta[name="site"]','meta[name="site-name"]','meta[name="siteName"]','meta[property="og:site_name"]','meta[name="twitter:site"]'];for(const e of t){const r=document.querySelector(e);if(r){const s=r.getAttribute("content")||"";if(s&&s.trim())return s.trim()}}}catch(t){console.warn("[seoManager] getSiteNameFromMeta failed",t)}return""}function ba(t,e,r,s,n,i=""){try{const a=t.meta||{},h=r&&String(r).trim()?r:a.title||i||document.title,l=n&&String(n).trim()?n:a.description||document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",o=s||a.image||null;let c="";try{if(e){const d=ue(e);try{c=(location.origin+location.pathname).split("?")[0]+"?page="+encodeURIComponent(d)}catch{c=location.href.split("#")[0]}}else c=location.href.split("#")[0]}catch(d){c=location.href.split("#")[0],console.warn("[seoManager] compute canonical failed",d)}c&&fa("canonical",c);try{ot("property","og:url",c)}catch(d){console.warn("[seoManager] upsertMeta og:url failed",d)}const u={"@context":"https://schema.org","@type":"Article",headline:h||"",description:l||"",url:c||location.href.split("#")[0]};o&&(u.image=String(o)),a.date&&(u.datePublished=a.date),a.dateModified&&(u.dateModified=a.dateModified);const f="nimbi-jsonld";let p=document.getElementById(f);p||(p=document.createElement("script"),p.type="application/ld+json",p.id=f,document.head.appendChild(p)),p.textContent=JSON.stringify(u,null,2)}catch(a){console.warn("[seoManager] setStructuredData failed",a)}}function ya(t,e,r,s,n,i,a,h,l,o,c){try{const u=s.querySelector(".menu-label");u&&(u.textContent=h&&h.textContent||t("onThisPage"))}catch(u){console.warn("[seoManager] update toc label failed",u)}try{const u=r.meta&&r.meta.title?String(r.meta.title).trim():"",f=n.querySelector("img"),p=f&&(f.getAttribute("src")||f.src)||null;let d="";try{let w="";try{const y=h||(n&&n.querySelector?n.querySelector("h1"):null);if(y){let x=y.nextElementSibling;const B=[];for(;x&&!(x.tagName&&x.tagName.toLowerCase()==="h2");){const I=(x.textContent||"").trim();I&&B.push(I),x=x.nextElementSibling}B.length&&(w=B.join(" ").replace(/\s+/g," ").trim()),!w&&l&&(w=String(l).trim())}}catch(y){console.warn("[seoManager] compute descOverride failed",y)}w&&String(w).length>160&&(w=String(w).slice(0,157).trim()+"..."),d=w}catch(w){console.warn("[seoManager] compute descOverride failed",w)}try{ma(r,l,p,d)}catch(w){console.warn("[seoManager] setMetaTags failed",w)}try{ba(r,o,l,p,d,e)}catch(w){console.warn("[seoManager] setStructuredData failed",w)}const m=wa();l?m?document.title=`${m} - ${l}`:document.title=`${e||"Site"} - ${l}`:u?document.title=u:document.title=e||document.title}catch(u){console.warn("[seoManager] applyPageMeta failed",u)}try{const u=n.querySelector(".nimbi-reading-time");if(u&&u.remove(),l){const f=pa(c.raw||""),p=f&&typeof f.minutes=="number"?Math.ceil(f.minutes):0,d=document.createElement("p");d.className="nimbi-reading-time",d.textContent=p?t("readingTime",{minutes:p}):"";const m=n.querySelector("h1");m&&m.insertAdjacentElement("afterend",d)}}catch(u){console.warn("[seoManager] reading time update failed",u)}}let ke=null,W=null,xe=1,Qe=(t,e)=>e,Et=0,At=0,Qt=()=>{},Rt=.25;function ka(){if(ke&&document.contains(ke))return ke;ke=null;const t=document.createElement("dialog");t.className="nimbi-image-preview",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label",Qe("imagePreviewTitle","Image preview")),t.innerHTML=`
  ...
  `,t.addEventListener("click",b=>{b.target===t&&Bn()}),t.addEventListener("wheel",b=>{if(!ne())return;b.preventDefault();const A=b.deltaY<0?Rt:-Rt;qe(xe+A),o(),c()},{passive:!1}),t.addEventListener("keydown",b=>{if(b.key==="Escape"){Bn();return}if(xe>1){const A=t.querySelector(".nimbi-image-preview__image-wrapper");if(!A)return;const M=40;switch(b.key){case"ArrowUp":A.scrollTop-=M,b.preventDefault();break;case"ArrowDown":A.scrollTop+=M,b.preventDefault();break;case"ArrowLeft":A.scrollLeft-=M,b.preventDefault();break;case"ArrowRight":A.scrollLeft+=M,b.preventDefault();break}}}),document.body.appendChild(t),ke=t,W=t.querySelector("[data-nimbi-preview-image]");const e=t.querySelector("[data-nimbi-preview-fit]"),r=t.querySelector("[data-nimbi-preview-original]"),s=t.querySelector("[data-nimbi-preview-zoom-in]"),n=t.querySelector("[data-nimbi-preview-zoom-out]"),i=t.querySelector("[data-nimbi-preview-reset]"),a=t.querySelector("[data-nimbi-preview-close]"),h=t.querySelector("[data-nimbi-preview-zoom-label]"),l=t.querySelector("[data-nimbi-preview-zoom-hud]");function o(){h&&(h.textContent=`${Math.round(xe*100)}%`)}const c=()=>{l&&(l.textContent=`${Math.round(xe*100)}%`,l.classList.add("visible"),clearTimeout(l._timeout),l._timeout=setTimeout(()=>l.classList.remove("visible"),800))};Qt=o,s.addEventListener("click",()=>{qe(xe+Rt),o(),c()}),n.addEventListener("click",()=>{qe(xe-Rt),o(),c()}),e.addEventListener("click",()=>{Tt(),o(),c()}),r.addEventListener("click",()=>{qe(1),o(),c()}),i.addEventListener("click",()=>{Tt(),o(),c()}),a.addEventListener("click",Bn),e.title=Qe("imagePreviewFit","Fit to screen"),r.title=Qe("imagePreviewOriginal","Original size"),n.title=Qe("imagePreviewZoomOut","Zoom out"),s.title=Qe("imagePreviewZoomIn","Zoom in"),a.title=Qe("imagePreviewClose","Close"),a.setAttribute("aria-label",Qe("imagePreviewClose","Close"));let u=!1,f=0,p=0,d=0,m=0;const w=new Map;let y=0,x=1;const B=(b,A)=>{const M=b.x-A.x,k=b.y-A.y;return Math.hypot(M,k)},I=()=>{u=!1,w.clear(),y=0,W&&(W.style.cursor="all-scroll")};let E=0,q=0,O=0;const G=b=>{const A=Date.now(),M=A-E,k=b.clientX-q,Q=b.clientY-O;E=A,q=b.clientX,O=b.clientY,M<300&&Math.hypot(k,Q)<30&&(qe(xe>1?1:2),o(),b.preventDefault())},Y=b=>{qe(xe>1?1:2),o(),b.preventDefault()},ne=()=>ke?typeof ke.open=="boolean"?ke.open:ke.classList.contains("is-active"):!1,$=(b,A,M=1)=>{if(w.has(M)&&w.set(M,{x:b,y:A}),w.size===2){const ce=Array.from(w.values()),Me=B(ce[0],ce[1]);if(y>0){const Ee=Me/y;qe(x*Ee)}return}if(!u)return;const k=W.closest(".nimbi-image-preview__image-wrapper");if(!k)return;const Q=b-f,he=A-p;k.scrollLeft=d-Q,k.scrollTop=m-he},T=(b,A,M=1)=>{if(!ne())return;if(w.set(M,{x:b,y:A}),w.size===2){const he=Array.from(w.values());y=B(he[0],he[1]),x=xe;return}const k=W.closest(".nimbi-image-preview__image-wrapper");!k||!(k.scrollWidth>k.clientWidth||k.scrollHeight>k.clientHeight)||(u=!0,f=b,p=A,d=k.scrollLeft,m=k.scrollTop,W.style.cursor="all-scroll",window.addEventListener("pointermove",P),window.addEventListener("pointerup",C),window.addEventListener("pointercancel",C))},P=b=>{u&&(b.preventDefault(),$(b.clientX,b.clientY,b.pointerId))},C=()=>{I(),window.removeEventListener("pointermove",P),window.removeEventListener("pointerup",C),window.removeEventListener("pointercancel",C)};W.addEventListener("pointerdown",b=>{b.preventDefault(),T(b.clientX,b.clientY,b.pointerId)}),W.addEventListener("pointermove",b=>{(u||w.size===2)&&b.preventDefault(),$(b.clientX,b.clientY,b.pointerId)}),W.addEventListener("pointerup",b=>{b.preventDefault(),b.pointerType==="touch"&&G(b),I()}),W.addEventListener("dblclick",Y),W.addEventListener("pointercancel",I),W.addEventListener("mousedown",b=>{b.preventDefault(),T(b.clientX,b.clientY,1)}),W.addEventListener("mousemove",b=>{u&&b.preventDefault(),$(b.clientX,b.clientY,1)}),W.addEventListener("mouseup",b=>{b.preventDefault(),I()});const v=t.querySelector(".nimbi-image-preview__image-wrapper");return v&&(v.addEventListener("pointerdown",b=>{T(b.clientX,b.clientY,b.pointerId)}),v.addEventListener("pointermove",b=>{$(b.clientX,b.clientY,b.pointerId)}),v.addEventListener("pointerup",I),v.addEventListener("pointercancel",I),v.addEventListener("mousedown",b=>{T(b.clientX,b.clientY,1)}),v.addEventListener("mousemove",b=>{$(b.clientX,b.clientY,1)}),v.addEventListener("mouseup",I)),t}function qe(t){if(!W)return;const e=Number(t);xe=Number.isFinite(e)?Math.max(.1,Math.min(4,e)):1;const s=W.getBoundingClientRect(),n=Et||W.naturalWidth||W.width||s.width||0,i=At||W.naturalHeight||W.height||s.height||0;n&&i?(W.style.maxWidth="none",W.style.maxHeight="none",W.style.width=`${n*xe}px`,W.style.height=`${i*xe}px`,W.style.transform=""):(W.style.maxWidth="",W.style.maxHeight="",W.style.width="",W.style.height="",W.style.transform=`scale(${xe})`),W&&(W.style.cursor="all-scroll")}function Tt(){if(!W)return;const t=W.closest(".nimbi-image-preview__image-wrapper");if(!t)return;const e=t.getBoundingClientRect();if(e.width===0||e.height===0)return;const r=Et||W.naturalWidth||e.width,s=At||W.naturalHeight||e.height;if(!r||!s)return;const n=e.width/r,i=e.height/s,a=Math.min(n,i,1);qe(Number.isFinite(a)?a:1)}function xa(t,e="",r=0,s=0){const n=ka();xe=1,Et=r||0,At=s||0,W.src=t,W.alt=e,W.style.transform="scale(1)";const i=()=>{Et=W.naturalWidth||W.width||0,At=W.naturalHeight||W.height||0};if(i(),Tt(),Qt(),requestAnimationFrame(()=>{Tt(),Qt()}),!Et||!At){const a=()=>{i(),requestAnimationFrame(()=>{Tt(),Qt()}),W.removeEventListener("load",a)};W.addEventListener("load",a)}typeof n.showModal=="function"&&(n.open||n.showModal()),n.classList.add("is-active"),n.focus()}function Bn(){ke&&(typeof ke.close=="function"&&ke.open&&ke.close(),ke.classList.remove("is-active"))}function Sa(t,{t:e,zoomStep:r=.25}={}){if(!t||!t.querySelectorAll)return;Qe=(p,d)=>(typeof e=="function"?e(p):void 0)||d,Rt=r,t.addEventListener("click",p=>{const d=p.target;if(!d||d.tagName!=="IMG")return;const m=d;if(m.src){if(p.defaultPrevented!==!0){const w=m.closest("a");w&&w.getAttribute("href")&&p.preventDefault()}xa(m.src,m.alt||"",m.naturalWidth||0,m.naturalHeight||0)}});let s=!1,n=0,i=0,a=0,h=0;const l=new Map;let o=0,c=1;const u=(p,d)=>{const m=p.x-d.x,w=p.y-d.y;return Math.hypot(m,w)};t.addEventListener("pointerdown",p=>{const d=p.target;if(!d||d.tagName!=="IMG"||!ke||!ke.open)return;if(l.set(p.pointerId,{x:p.clientX,y:p.clientY}),l.size===2){const w=Array.from(l.values());o=u(w[0],w[1]),c=xe;return}const m=d.closest(".nimbi-image-preview__image-wrapper");m&&(xe<=1||(p.preventDefault(),s=!0,n=p.clientX,i=p.clientY,a=m.scrollLeft,h=m.scrollTop,d.setPointerCapture(p.pointerId),d.style.cursor="grabbing"))}),t.addEventListener("pointermove",p=>{if(l.has(p.pointerId)&&l.set(p.pointerId,{x:p.clientX,y:p.clientY}),l.size===2){p.preventDefault();const x=Array.from(l.values()),B=u(x[0],x[1]);if(o>0){const I=B/o;qe(c*I)}return}if(!s)return;p.preventDefault();const m=p.target.closest(".nimbi-image-preview__image-wrapper");if(!m)return;const w=p.clientX-n,y=p.clientY-i;m.scrollLeft=a-w,m.scrollTop=h-y});const f=()=>{s=!1,l.clear(),o=0};t.addEventListener("pointerup",f),t.addEventListener("pointercancel",f)}function va(t){const{contentWrap:e,navWrap:r,container:s,mountOverlay:n=null,t:i,contentBase:a,homePage:h,initialDocumentTitle:l,runHooks:o}=t||{};if(!e||!(e instanceof HTMLElement))throw new TypeError("contentWrap must be an HTMLElement");let c=null;const u=Vs(i,[{path:h,name:i("home"),isIndex:!0,children:[]}]);async function f(y,x){let B,I,E;try{({data:B,pagePath:I,anchor:E}=await rs(y,a))}catch(T){console.error("[nimbi-cms] fetchPageData failed",T),Fr(e,i,T);return}!E&&x&&(E=x);try{In(null)}catch(T){console.warn("[nimbi-cms] scrollToAnchorOrTop failed",T)}e.innerHTML="";const{article:q,parsed:O,toc:G,topH1:Y,h1Text:ne,slugKey:$}=await aa(i,B,I,E,a);ya(i,l,O,G,q,I,E,Y,ne,$,B),r.innerHTML="",r.appendChild(G),oa(G);try{await o("transformHtml",{article:q,parsed:O,toc:G,pagePath:I,anchor:E,topH1:Y,h1Text:ne,slugKey:$,data:B})}catch(T){console.warn("[nimbi-cms] transformHtml hooks failed",T)}e.appendChild(q);try{Sa(q,{t:i})}catch(T){console.warn("[nimbi-cms] attachImagePreview failed",T)}try{$t(s,100,!1),requestAnimationFrame(()=>$t(s,100,!1)),setTimeout(()=>$t(s,100,!1),250)}catch(T){console.warn("[nimbi-cms] setEagerForAboveFoldImages failed",T)}In(E),ca(q,Y,{mountOverlay:n,container:s,navWrap:r,t:i});try{await o("onPageLoad",{data:B,pagePath:I,anchor:E,article:q,toc:G,topH1:Y,h1Text:ne,slugKey:$,contentWrap:e,navWrap:r})}catch(T){console.warn("[nimbi-cms] onPageLoad hooks failed",T)}c=I}async function p(){let y=new URLSearchParams(location.search).get("page")||h;const x=location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null;try{await f(y,x)}catch(B){console.warn("[nimbi-cms] renderByQuery failed for",y,B),Fr(e,i,B)}}window.addEventListener("popstate",p);const d=()=>`nimbi-cms-scroll:${location.pathname}${location.search}`,m=()=>{try{const y=s||document.querySelector(".nimbi-cms");if(!y)return;const x={top:y.scrollTop||0,left:y.scrollLeft||0};sessionStorage.setItem(d(),JSON.stringify(x))}catch{}},w=()=>{try{const y=s||document.querySelector(".nimbi-cms");if(!y)return;const x=sessionStorage.getItem(d());if(!x)return;const B=JSON.parse(x);B&&typeof B.top=="number"&&y.scrollTo({top:B.top,left:B.left||0,behavior:"auto"})}catch{}};return window.addEventListener("pageshow",y=>{if(y.persisted)try{w(),$t(s,100,!1)}catch(x){console.warn("[nimbi-cms] bfcache restore failed",x)}}),window.addEventListener("pagehide",()=>{try{m()}catch(y){console.warn("[nimbi-cms] save scroll position failed",y)}}),{renderByQuery:p,siteNav:u,getCurrentPagePath:()=>c}}function Ea(t){try{const e=typeof t=="string"?t:typeof window<"u"&&window.location?window.location.search:"";if(!e)return{};const r=new URLSearchParams(e.startsWith("?")?e.slice(1):e),s={},n=i=>{if(i==null)return;const a=String(i).toLowerCase();if(a==="1"||a==="true"||a==="yes")return!0;if(a==="0"||a==="false"||a==="no")return!1};if(r.has("contentPath")&&(s.contentPath=r.get("contentPath")),r.has("searchIndex")){const i=n(r.get("searchIndex"));typeof i=="boolean"&&(s.searchIndex=i)}if(r.has("searchIndexMode")){const i=r.get("searchIndexMode");(i==="eager"||i==="lazy")&&(s.searchIndexMode=i)}if(r.has("defaultStyle")){const i=r.get("defaultStyle");(i==="light"||i==="dark")&&(s.defaultStyle=i)}if(r.has("bulmaCustomize")&&(s.bulmaCustomize=r.get("bulmaCustomize")),r.has("lang")&&(s.lang=r.get("lang")),r.has("l10nFile")){const i=r.get("l10nFile");s.l10nFile=i==="null"?null:i}if(r.has("cacheTtlMinutes")){const i=Number(r.get("cacheTtlMinutes"));Number.isFinite(i)&&i>=0&&(s.cacheTtlMinutes=i)}if(r.has("cacheMaxEntries")){const i=Number(r.get("cacheMaxEntries"));Number.isInteger(i)&&i>=0&&(s.cacheMaxEntries=i)}if(r.has("homePage")&&(s.homePage=r.get("homePage")),r.has("notFoundPage")&&(s.notFoundPage=r.get("notFoundPage")),r.has("availableLanguages")&&(s.availableLanguages=r.get("availableLanguages").split(",").map(i=>i.trim()).filter(Boolean)),r.has("indexDepth")){const i=Number(r.get("indexDepth"));Number.isInteger(i)&&(i===1||i===2||i===3)&&(s.indexDepth=i)}if(r.has("noIndexing")){const a=(r.get("noIndexing")||"").split(",").map(h=>h.trim()).filter(Boolean);a.length&&(s.noIndexing=a)}return s}catch{return{}}}function Aa(t){return!(typeof t!="string"||!t.trim()||t.includes("..")||/^[a-zA-Z][a-zA-Z0-9+.-]*:\/\//.test(t)||t.startsWith("//")||t.startsWith("/")||/^[A-Za-z]:\\/.test(t))}function Qr(t){if(typeof t!="string")return!1;const e=t.trim();return!(!e||e.includes("/")||e.includes("\\")||e.includes("..")||!/^[A-Za-z0-9._-]+\.(md|html)$/.test(e))}let On="";async function Ra(t={}){if(!t||typeof t!="object")throw new TypeError("initCMS(options): options must be an object");const e=Ea();if(e&&(e.contentPath||e.homePage||e.notFoundPage))if(t&&t.allowUrlPathOverrides===!0)try{console.warn("[nimbi-cms] allowUrlPathOverrides enabled by host; honoring URL overrides for contentPath/homePage/notFoundPage")}catch(k){console.warn("[nimbi-cms] allowUrlPathOverrides logging failed",k)}else{try{console.warn("[nimbi-cms] ignoring unsafe URL overrides for contentPath/homePage/notFoundPage")}catch(k){console.warn("[nimbi-cms] logging ignore of URL overrides failed",k)}delete e.contentPath,delete e.homePage,delete e.notFoundPage}const r=Object.assign({},e,t),{el:s,contentPath:n="/content",crawlMaxQueue:i=1e3,searchIndex:a=!0,searchIndexMode:h="eager",indexDepth:l=1,noIndexing:o=void 0,defaultStyle:c="light",bulmaCustomize:u="none",lang:f=void 0,l10nFile:p=null,cacheTtlMinutes:d=5,cacheMaxEntries:m,markdownExtensions:w,availableLanguages:y,homePage:x="_home.md",notFoundPage:B="_404.md"}=r,{skipRootReadme:I=!1}=r;if(r.contentPath!=null&&!Aa(r.contentPath))throw new TypeError('initCMS(options): "contentPath" contains unsafe characters or patterns');if(r.homePage!=null&&!Qr(r.homePage))throw new TypeError('initCMS(options): "homePage" must be a simple basename ending with .md or .html');if(r.notFoundPage!=null&&!Qr(r.notFoundPage))throw new TypeError('initCMS(options): "notFoundPage" must be a simple basename ending with .md or .html');if(!s)throw new Error("el is required");let E=s;if(typeof s=="string"){if(E=document.querySelector(s),!E)throw new Error(`el selector "${s}" did not match any element`)}else if(!(s instanceof Element))throw new TypeError("el must be a CSS selector string or a DOM element");if(typeof n!="string"||!n.trim())throw new TypeError('initCMS(options): "contentPath" must be a non-empty string when provided');if(typeof a!="boolean")throw new TypeError('initCMS(options): "searchIndex" must be a boolean when provided');if(h!=null&&h!=="eager"&&h!=="lazy")throw new TypeError('initCMS(options): "searchIndexMode" must be "eager" or "lazy" when provided');if(l!=null&&l!==1&&l!==2&&l!==3)throw new TypeError('initCMS(options): "indexDepth" must be 1, 2, or 3 when provided');if(c!=="light"&&c!=="dark")throw new TypeError('initCMS(options): "defaultStyle" must be "light" or "dark"');if(u!=null&&typeof u!="string")throw new TypeError('initCMS(options): "bulmaCustomize" must be a string when provided');if(f!=null&&typeof f!="string")throw new TypeError('initCMS(options): "lang" must be a string when provided');if(p!=null&&typeof p!="string")throw new TypeError('initCMS(options): "l10nFile" must be a string or null when provided');if(d!=null&&(typeof d!="number"||!Number.isFinite(d)||d<0))throw new TypeError('initCMS(options): "cacheTtlMinutes" must be a non‑negative number when provided');if(m!=null&&(typeof m!="number"||!Number.isInteger(m)||m<0))throw new TypeError('initCMS(options): "cacheMaxEntries" must be a non‑negative integer when provided');if(w!=null&&(!Array.isArray(w)||w.some(k=>!k||typeof k!="object")))throw new TypeError('initCMS(options): "markdownExtensions" must be an array of extension objects when provided');if(y!=null&&(!Array.isArray(y)||y.some(k=>typeof k!="string"||!k.trim())))throw new TypeError('initCMS(options): "availableLanguages" must be an array of non-empty strings when provided');if(o!=null&&(!Array.isArray(o)||o.some(k=>typeof k!="string"||!k.trim())))throw new TypeError('initCMS(options): "noIndexing" must be an array of non-empty strings when provided');if(I!=null&&typeof I!="boolean")throw new TypeError('initCMS(options): "skipRootReadme" must be a boolean when provided');if(x!=null&&(typeof x!="string"||!x.trim()||!/\.(md|html)$/.test(x)))throw new TypeError('initCMS(options): "homePage" must be a non-empty string ending with .md or .html');if(B!=null&&(typeof B!="string"||!B.trim()||!/\.(md|html)$/.test(B)))throw new TypeError('initCMS(options): "notFoundPage" must be a non-empty string ending with .md or .html');const q=!!a;try{sr(!!I)}catch(k){console.warn("[nimbi-cms] setSkipRootReadme failed",k)}try{E.classList.add("nimbi-mount"),E.style.position=E.style.position||"relative",E.style.overflow=E.style.overflow||"hidden"}catch(k){console.warn("[nimbi-cms] mount element setup failed",k)}const O=document.createElement("div");O.className="nimbi-cms";try{O.style.position=O.style.position||"relative",O.style.overflow=O.style.overflow||"auto";try{O.style.webkitOverflowScrolling||(O.style.webkitOverflowScrolling="touch")}catch(k){console.warn("[nimbi-cms] set container webkitOverflowScrolling failed",k)}O.style.width=O.style.width||"100%",O.style.height=O.style.height||"100%",O.style.boxSizing=O.style.boxSizing||"border-box"}catch(k){console.warn("[nimbi-cms] container style setup failed",k)}const G=document.createElement("div");G.className="columns";const Y=document.createElement("div");Y.className="column is-full-mobile is-3-tablet nimbi-nav-wrap",Y.setAttribute("role","navigation");try{const k=typeof st=="function"?st("navigation"):null;k&&Y.setAttribute("aria-label",k)}catch(k){console.warn("[nimbi-cms] set nav aria-label failed",k)}G.appendChild(Y);const ne=document.createElement("div");ne.className="column nimbi-content",ne.setAttribute("role","main"),G.appendChild(ne),O.appendChild(G);const $=Y,T=ne;E.appendChild(O);let P=null;try{P=E.querySelector(".nimbi-overlay"),P||(P=document.createElement("div"),P.className="nimbi-overlay",E.appendChild(P))}catch(k){P=null,console.warn("[nimbi-cms] mount overlay setup failed",k)}const C=location.pathname||"/",v=C.endsWith("/")?C:C.substring(0,C.lastIndexOf("/")+1);try{On=document.title||""}catch(k){On="",console.warn("[nimbi-cms] read initial document title failed",k)}let b=n;(b==="."||b==="./")&&(b=""),b.startsWith("./")&&(b=b.slice(2)),b.startsWith("/")&&(b=b.slice(1)),b!==""&&!b.endsWith("/")&&(b=b+"/");const A=new URL(v+b,location.origin).toString();try{mn&&mn(x)}catch{}p&&await cn(p,v),y&&Array.isArray(y)&&ar(y),f&&un(f);const M=va({contentWrap:T,navWrap:$,container:O,mountOverlay:P,t:st,contentBase:A,homePage:x,initialDocumentTitle:On,runHooks:nn});if(typeof d=="number"&&d>=0&&typeof mr=="function"&&mr(d*60*1e3),typeof m=="number"&&m>=0&&typeof gr=="function"&&gr(m),w&&Array.isArray(w)&&w.length)try{w.forEach(k=>{typeof k=="object"&&Ys&&typeof Ln=="function"&&Ln(k)})}catch(k){console.warn("[nimbi-cms] applying markdownExtensions failed",k)}try{typeof i=="number"&&Promise.resolve().then(()=>Ht).then(({setDefaultCrawlMaxQueue:k})=>{try{k(i)}catch(Q){console.warn("[nimbi-cms] setDefaultCrawlMaxQueue failed",Q)}})}catch(k){console.warn("[nimbi-cms] setDefaultCrawlMaxQueue import failed",k)}try{Bt(A)}catch(k){console.warn("[nimbi-cms] setContentBase failed",k)}try{gn(B)}catch(k){console.warn("[nimbi-cms] setNotFoundPage failed",k)}try{Bt(A)}catch(k){console.warn("[nimbi-cms] setContentBase failed",k)}try{gn(B)}catch(k){console.warn("[nimbi-cms] setNotFoundPage failed",k)}try{await be(x,A)}catch(k){throw x==="_home.md"?new Error("Required _home.md not found"):new Error(`Required ${x} not found at ${A}${x}: ${k.message}`)}Vn(c),await Yn(u,v);try{const k=document.createElement("header");k.className="nimbi-site-navbar",E.insertBefore(k,O);const Q=await be("_navigation.md",A),he=await Gt(Q.raw||""),{navbar:ce,linkEls:Me}=await ua(k,O,he.html||"",A,x,st,M.renderByQuery,q,h,l,o);try{await nn("onNavBuild",{navWrap:$,navbar:ce,linkEls:Me,contentBase:A})}catch(Ee){console.warn("[nimbi-cms] onNavBuild hooks failed",Ee)}try{const Ee=()=>{const Ce=k&&k.getBoundingClientRect&&Math.round(k.getBoundingClientRect().height)||k&&k.offsetHeight||0;if(Ce>0){try{E.style.setProperty("--nimbi-site-navbar-height",`${Ce}px`)}catch(ge){console.warn("[nimbi-cms] set CSS var failed",ge)}try{O.style.paddingTop=""}catch(ge){console.warn("[nimbi-cms] set container paddingTop failed",ge)}try{const ge=E&&E.getBoundingClientRect&&Math.round(E.getBoundingClientRect().height)||E&&E.clientHeight||0;if(ge>0){const Oe=Math.max(0,ge-Ce);try{O.style.boxSizing="border-box"}catch(et){console.warn("[nimbi-cms] set container boxSizing failed",et)}try{O.style.height=`${Oe}px`}catch(et){console.warn("[nimbi-cms] set container height failed",et)}try{O.style.setProperty("--nimbi-cms-height",`${Oe}px`)}catch(et){console.warn("[nimbi-cms] set --nimbi-cms-height failed",et)}}else{try{O.style.height="calc(100vh - var(--nimbi-site-navbar-height))"}catch(Oe){console.warn("[nimbi-cms] set container height failed",Oe)}try{O.style.setProperty("--nimbi-cms-height","calc(100vh - var(--nimbi-site-navbar-height))")}catch(Oe){console.warn("[nimbi-cms] set --nimbi-cms-height failed",Oe)}}}catch(ge){console.warn("[nimbi-cms] compute container height failed",ge)}try{k.style.setProperty("--nimbi-site-navbar-height",`${Ce}px`)}catch(ge){console.warn("[nimbi-cms] set navbar CSS var failed",ge)}}};Ee();try{if(typeof ResizeObserver<"u"){const Ce=new ResizeObserver(()=>Ee());try{Ce.observe(k)}catch(ge){console.warn("[nimbi-cms] ResizeObserver.observe failed",ge)}}}catch(Ce){console.warn("[nimbi-cms] ResizeObserver setup failed",Ce)}}catch(Ee){console.warn("[nimbi-cms] compute navbar height failed",Ee)}}catch(k){console.warn("[nimbi-cms] build navigation failed",k)}await M.renderByQuery();try{Promise.resolve().then(()=>Ta).then(({getVersion:k})=>{typeof k=="function"&&k().then(Q=>{try{const he=Q||"0.0.0",ce=document.createElement("div");ce.className="nimbi-version-label",ce.textContent=`Ninbi CMS v. ${he}`,ce.style.position="absolute",ce.style.left="8px",ce.style.bottom="6px",ce.style.fontSize="11px",ce.style.opacity="0.6",ce.style.pointerEvents="none",ce.style.zIndex="9999",ce.style.userSelect="none";try{E.appendChild(ce)}catch(Me){console.warn("[nimbi-cms] append version label failed",Me)}}catch(he){console.warn("[nimbi-cms] building version label failed",he)}}).catch(Q=>{console.warn("[nimbi-cms] getVersion() failed",Q)})}).catch(k=>{console.warn("[nimbi-cms] import version module failed",k)})}catch(k){console.warn("[nimbi-cms] version label setup failed",k)}}async function Xr(){try{let t=null;try{t=await Promise.resolve().then(()=>li)}catch{try{t=await Promise.resolve().then(()=>li)}catch{t=null}}const e=t?.default?.version||t?.version;return typeof e=="string"&&e.trim()?e:"0.0.0"}catch{return"0.0.0"}}const Ta=Object.freeze(Object.defineProperty({__proto__:null,getVersion:Xr},Symbol.toStringTag,{value:"Module"})),Kr="nimbi-cms",Yr="0.1.0",Vr="module",Jr={dev:"vite","dev:example":'sh -c "npm run build -- --outDir example/dist --config vite.config.js && vite example --port 5173 &"',build:"vite build --config vite.config.js","build:lib":"vite build --config vite.config.js","build:analyze":"ANALYZE=1 vite build --config vite.config.js",preview:"vite preview",test:"npx vitest run","gen-dts":"node scripts/gen-dts.js","check-dts":"npx tsc --noEmit src/index.d.ts --lib es2015,dom --skipLibCheck","type-test":"npx tsd",docs:"typedoc --options typedoc.json"},ei={bulma:"^1.0.4","highlight.js":"^11.11.1",marked:"^17.0.4"},ti={"@vitest/coverage-v8":"^4.0.18","comment-parser":"^0.7.6",eslint:"^10.0.3","eslint-plugin-unused-imports":"^4.4.1",glob:"^10.4.1",jsdom:"^28.1.0","reading-time":"^1.5.0",terser:"^5.17.0",typedoc:"^0.28.17","typedoc-plugin-markdown":"^4.10.0",typescript:"^5.9.3",tsd:"^0.33.0",vite:"^7.3.1","rollup-plugin-visualizer":"^5.8.0","vite-plugin-restart":"^2.0.0",vitest:"^4.0.18"},ni="dist/nimbi-cms.cjs.js",ri="dist/nimbi-cms.es.js",ii="src/index.d.ts",si="dist/nimbi-cms.js",ai=["dist","src/index.d.ts"],li=Object.freeze(Object.defineProperty({__proto__:null,default:{name:Kr,version:Yr,private:!0,type:Vr,scripts:Jr,dependencies:ei,devDependencies:ti,main:ni,module:ri,types:ii,unpkg:si,files:ai},dependencies:ei,devDependencies:ti,files:ai,main:ni,module:ri,name:Kr,scripts:Jr,type:Vr,types:ii,unpkg:si,version:Yr},Symbol.toStringTag,{value:"Module"}));le.BAD_LANGUAGES=sn,le.SUPPORTED_HLJS_MAP=V,le._clearHooks=Ti,le.addHook=Lt,le.default=Ra,le.ensureBulma=Yn,le.getVersion=Xr,le.loadL10nFile=cn,le.loadSupportedLanguages=an,le.observeCodeBlocks=Kn,le.onNavBuild=Ai,le.onPageLoad=Ei,le.registerLanguage=rt,le.runHooks=nn,le.setHighlightTheme=$i,le.setLang=un,le.setStyle=Vn,le.setThemeVars=Ii,le.t=st,le.transformHtml=Ri,Object.defineProperties(le,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})}));
