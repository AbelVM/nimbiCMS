(function(oe,De){typeof exports=="object"&&typeof module<"u"?De(exports):typeof define=="function"&&define.amd?define(["exports"],De):(oe=typeof globalThis<"u"?globalThis:oe||self,De(oe.nimbiCMS={}))})(this,(function(oe){"use strict";const De={onPageLoad:[],onNavBuild:[],transformHtml:[]};function Tt(t,e){if(!Object.prototype.hasOwnProperty.call(De,t))throw new Error('Unknown hook "'+t+'"');if(typeof e!="function")throw new TypeError("hook callback must be a function");De[t].push(e)}function ys(t){Tt("onPageLoad",t)}function ks(t){Tt("onNavBuild",t)}function xs(t){Tt("transformHtml",t)}async function Jt(t,e){const r=De[t]||[];for(const i of r)try{await i(e)}catch(n){console.warn("[nimbi-cms] runHooks callback failed",n)}}function Ss(){Object.keys(De).forEach(t=>{De[t].length=0})}function jn(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var en,Fn;function vs(){if(Fn)return en;Fn=1;function t(g){return g instanceof Map?g.clear=g.delete=g.set=function(){throw new Error("map is read-only")}:g instanceof Set&&(g.add=g.clear=g.delete=function(){throw new Error("set is read-only")}),Object.freeze(g),Object.getOwnPropertyNames(g).forEach(v=>{const C=g[v],F=typeof C;(F==="object"||F==="function")&&!Object.isFrozen(C)&&t(C)}),g}class e{constructor(v){v.data===void 0&&(v.data={}),this.data=v.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function r(g){return g.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function i(g,...v){const C=Object.create(null);for(const F in g)C[F]=g[F];return v.forEach(function(F){for(const he in F)C[he]=F[he]}),C}const n="</span>",s=g=>!!g.scope,a=(g,{prefix:v})=>{if(g.startsWith("language:"))return g.replace("language:","language-");if(g.includes(".")){const C=g.split(".");return[`${v}${C.shift()}`,...C.map((F,he)=>`${F}${"_".repeat(he+1)}`)].join(" ")}return`${v}${g}`};class h{constructor(v,C){this.buffer="",this.classPrefix=C.classPrefix,v.walk(this)}addText(v){this.buffer+=r(v)}openNode(v){if(!s(v))return;const C=a(v.scope,{prefix:this.classPrefix});this.span(C)}closeNode(v){s(v)&&(this.buffer+=n)}value(){return this.buffer}span(v){this.buffer+=`<span class="${v}">`}}const l=(g={})=>{const v={children:[]};return Object.assign(v,g),v};class o{constructor(){this.rootNode=l(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(v){this.top.children.push(v)}openNode(v){const C=l({scope:v});this.add(C),this.stack.push(C)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(v){return this.constructor._walk(v,this.rootNode)}static _walk(v,C){return typeof C=="string"?v.addText(C):C.children&&(v.openNode(C),C.children.forEach(F=>this._walk(v,F)),v.closeNode(C)),v}static _collapse(v){typeof v!="string"&&v.children&&(v.children.every(C=>typeof C=="string")?v.children=[v.children.join("")]:v.children.forEach(C=>{o._collapse(C)}))}}class c extends o{constructor(v){super(),this.options=v}addText(v){v!==""&&this.add(v)}startScope(v){this.openNode(v)}endScope(){this.closeNode()}__addSublanguage(v,C){const F=v.root;C&&(F.scope=`language:${C}`),this.add(F)}toHTML(){return new h(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function u(g){return g?typeof g=="string"?g:g.source:null}function f(g){return m("(?=",g,")")}function p(g){return m("(?:",g,")*")}function d(g){return m("(?:",g,")?")}function m(...g){return g.map(C=>u(C)).join("")}function w(g){const v=g[g.length-1];return typeof v=="object"&&v.constructor===Object?(g.splice(g.length-1,1),v):{}}function k(...g){return"("+(w(g).capture?"":"?:")+g.map(F=>u(F)).join("|")+")"}function x(g){return new RegExp(g.toString()+"|").exec("").length-1}function P(g,v){const C=g&&g.exec(v);return C&&C.index===0}const E=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function N(g,{joinWith:v}){let C=0;return g.map(F=>{C+=1;const he=C;let de=u(F),O="";for(;de.length>0;){const z=E.exec(de);if(!z){O+=de;break}O+=de.substring(0,z.index),de=de.substring(z.index+z[0].length),z[0][0]==="\\"&&z[1]?O+="\\"+String(Number(z[1])+he):(O+=z[0],z[0]==="("&&C++)}return O}).map(F=>`(${F})`).join(v)}const M=/\b\B/,W="[a-zA-Z]\\w*",X="[a-zA-Z_]\\w*",K="\\b\\d+(\\.\\d+)?",re="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",I="\\b(0b[01]+)",T="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",$=(g={})=>{const v=/^#![ ]*\//;return g.binary&&(g.begin=m(v,/.*\b/,g.binary,/\b.*/)),i({scope:"meta",begin:v,end:/$/,relevance:0,"on:begin":(C,F)=>{C.index!==0&&F.ignoreMatch()}},g)},L={begin:"\\\\[\\s\\S]",relevance:0},S={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[L]},b={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[L]},R={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},y=function(g,v,C={}){const F=i({scope:"comment",begin:g,end:v,contains:[]},C);F.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const he=k("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return F.contains.push({begin:m(/[ ]+/,"(",he,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),F},B=y("//","$"),Y=y("/\\*","\\*/"),se=y("#","$"),Ce={scope:"number",begin:K,relevance:0},Ee={scope:"number",begin:re,relevance:0},xe={scope:"number",begin:I,relevance:0},we={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[L,{begin:/\[/,end:/\]/,relevance:0,contains:[L]}]},Le={scope:"title",begin:W,relevance:0},qe={scope:"title",begin:X,relevance:0},xa={begin:"\\.\\s*"+X,relevance:0};var Zt=Object.freeze({__proto__:null,APOS_STRING_MODE:S,BACKSLASH_ESCAPE:L,BINARY_NUMBER_MODE:xe,BINARY_NUMBER_RE:I,COMMENT:y,C_BLOCK_COMMENT_MODE:Y,C_LINE_COMMENT_MODE:B,C_NUMBER_MODE:Ee,C_NUMBER_RE:re,END_SAME_AS_BEGIN:function(g){return Object.assign(g,{"on:begin":(v,C)=>{C.data._beginMatch=v[1]},"on:end":(v,C)=>{C.data._beginMatch!==v[1]&&C.ignoreMatch()}})},HASH_COMMENT_MODE:se,IDENT_RE:W,MATCH_NOTHING_RE:M,METHOD_GUARD:xa,NUMBER_MODE:Ce,NUMBER_RE:K,PHRASAL_WORDS_MODE:R,QUOTE_STRING_MODE:b,REGEXP_MODE:we,RE_STARTERS_RE:T,SHEBANG:$,TITLE_MODE:Le,UNDERSCORE_IDENT_RE:X,UNDERSCORE_TITLE_MODE:qe});function Sa(g,v){g.input[g.index-1]==="."&&v.ignoreMatch()}function va(g,v){g.className!==void 0&&(g.scope=g.className,delete g.className)}function Ea(g,v){v&&g.beginKeywords&&(g.begin="\\b("+g.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",g.__beforeBegin=Sa,g.keywords=g.keywords||g.beginKeywords,delete g.beginKeywords,g.relevance===void 0&&(g.relevance=0))}function Aa(g,v){Array.isArray(g.illegal)&&(g.illegal=k(...g.illegal))}function Ra(g,v){if(g.match){if(g.begin||g.end)throw new Error("begin & end are not supported with match");g.begin=g.match,delete g.match}}function Ta(g,v){g.relevance===void 0&&(g.relevance=1)}const Ca=(g,v)=>{if(!g.beforeMatch)return;if(g.starts)throw new Error("beforeMatch cannot be used with starts");const C=Object.assign({},g);Object.keys(g).forEach(F=>{delete g[F]}),g.keywords=C.keywords,g.begin=m(C.beforeMatch,f(C.begin)),g.starts={relevance:0,contains:[Object.assign(C,{endsParent:!0})]},g.relevance=0,delete C.beforeMatch},La=["of","and","for","in","not","or","if","then","parent","list","value"],_a="keyword";function rs(g,v,C=_a){const F=Object.create(null);return typeof g=="string"?he(C,g.split(" ")):Array.isArray(g)?he(C,g):Object.keys(g).forEach(function(de){Object.assign(F,rs(g[de],v,de))}),F;function he(de,O){v&&(O=O.map(z=>z.toLowerCase())),O.forEach(function(z){const q=z.split("|");F[q[0]]=[de,Ma(q[0],q[1])]})}}function Ma(g,v){return v?Number(v):$a(g)?0:1}function $a(g){return La.includes(g.toLowerCase())}const ss={},et=g=>{console.error(g)},is=(g,...v)=>{console.log(`WARN: ${g}`,...v)},ot=(g,v)=>{ss[`${g}/${v}`]||(console.log(`Deprecated as of ${g}. ${v}`),ss[`${g}/${v}`]=!0)},Qt=new Error;function as(g,v,{key:C}){let F=0;const he=g[C],de={},O={};for(let z=1;z<=v.length;z++)O[z+F]=he[z],de[z+F]=!0,F+=x(v[z-1]);g[C]=O,g[C]._emit=de,g[C]._multi=!0}function Pa(g){if(Array.isArray(g.begin)){if(g.skip||g.excludeBegin||g.returnBegin)throw et("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Qt;if(typeof g.beginScope!="object"||g.beginScope===null)throw et("beginScope must be object"),Qt;as(g,g.begin,{key:"beginScope"}),g.begin=N(g.begin,{joinWith:""})}}function Ia(g){if(Array.isArray(g.end)){if(g.skip||g.excludeEnd||g.returnEnd)throw et("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Qt;if(typeof g.endScope!="object"||g.endScope===null)throw et("endScope must be object"),Qt;as(g,g.end,{key:"endScope"}),g.end=N(g.end,{joinWith:""})}}function za(g){g.scope&&typeof g.scope=="object"&&g.scope!==null&&(g.beginScope=g.scope,delete g.scope)}function Ba(g){za(g),typeof g.beginScope=="string"&&(g.beginScope={_wrap:g.beginScope}),typeof g.endScope=="string"&&(g.endScope={_wrap:g.endScope}),Pa(g),Ia(g)}function Oa(g){function v(O,z){return new RegExp(u(O),"m"+(g.case_insensitive?"i":"")+(g.unicodeRegex?"u":"")+(z?"g":""))}class C{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(z,q){q.position=this.position++,this.matchIndexes[this.matchAt]=q,this.regexes.push([q,z]),this.matchAt+=x(z)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const z=this.regexes.map(q=>q[1]);this.matcherRe=v(N(z,{joinWith:"|"}),!0),this.lastIndex=0}exec(z){this.matcherRe.lastIndex=this.lastIndex;const q=this.matcherRe.exec(z);if(!q)return null;const ge=q.findIndex((Rt,zn)=>zn>0&&Rt!==void 0),pe=this.matchIndexes[ge];return q.splice(0,ge),Object.assign(q,pe)}}class F{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(z){if(this.multiRegexes[z])return this.multiRegexes[z];const q=new C;return this.rules.slice(z).forEach(([ge,pe])=>q.addRule(ge,pe)),q.compile(),this.multiRegexes[z]=q,q}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(z,q){this.rules.push([z,q]),q.type==="begin"&&this.count++}exec(z){const q=this.getMatcher(this.regexIndex);q.lastIndex=this.lastIndex;let ge=q.exec(z);if(this.resumingScanAtSamePosition()&&!(ge&&ge.index===this.lastIndex)){const pe=this.getMatcher(0);pe.lastIndex=this.lastIndex+1,ge=pe.exec(z)}return ge&&(this.regexIndex+=ge.position+1,this.regexIndex===this.count&&this.considerAll()),ge}}function he(O){const z=new F;return O.contains.forEach(q=>z.addRule(q.begin,{rule:q,type:"begin"})),O.terminatorEnd&&z.addRule(O.terminatorEnd,{type:"end"}),O.illegal&&z.addRule(O.illegal,{type:"illegal"}),z}function de(O,z){const q=O;if(O.isCompiled)return q;[va,Ra,Ba,Ca].forEach(pe=>pe(O,z)),g.compilerExtensions.forEach(pe=>pe(O,z)),O.__beforeBegin=null,[Ea,Aa,Ta].forEach(pe=>pe(O,z)),O.isCompiled=!0;let ge=null;return typeof O.keywords=="object"&&O.keywords.$pattern&&(O.keywords=Object.assign({},O.keywords),ge=O.keywords.$pattern,delete O.keywords.$pattern),ge=ge||/\w+/,O.keywords&&(O.keywords=rs(O.keywords,g.case_insensitive)),q.keywordPatternRe=v(ge,!0),z&&(O.begin||(O.begin=/\B|\b/),q.beginRe=v(q.begin),!O.end&&!O.endsWithParent&&(O.end=/\B|\b/),O.end&&(q.endRe=v(q.end)),q.terminatorEnd=u(q.end)||"",O.endsWithParent&&z.terminatorEnd&&(q.terminatorEnd+=(O.end?"|":"")+z.terminatorEnd)),O.illegal&&(q.illegalRe=v(O.illegal)),O.contains||(O.contains=[]),O.contains=[].concat(...O.contains.map(function(pe){return Na(pe==="self"?O:pe)})),O.contains.forEach(function(pe){de(pe,q)}),O.starts&&de(O.starts,z),q.matcher=he(q),q}if(g.compilerExtensions||(g.compilerExtensions=[]),g.contains&&g.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return g.classNameAliases=i(g.classNameAliases||{}),de(g)}function ls(g){return g?g.endsWithParent||ls(g.starts):!1}function Na(g){return g.variants&&!g.cachedVariants&&(g.cachedVariants=g.variants.map(function(v){return i(g,{variants:null},v)})),g.cachedVariants?g.cachedVariants:ls(g)?i(g,{starts:g.starts?i(g.starts):null}):Object.isFrozen(g)?i(g):g}var Da="11.11.1";class Ha extends Error{constructor(v,C){super(v),this.name="HTMLInjectionError",this.html=C}}const In=r,os=i,cs=Symbol("nomatch"),Ua=7,us=function(g){const v=Object.create(null),C=Object.create(null),F=[];let he=!0;const de="Could not find the language '{}', did you forget to load/include a language module?",O={disableAutodetect:!0,name:"Plain text",contains:[]};let z={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:c};function q(A){return z.noHighlightRe.test(A)}function ge(A){let U=A.className+" ";U+=A.parentNode?A.parentNode.className:"";const J=z.languageDetectRe.exec(U);if(J){const ae=Xe(J[1]);return ae||(is(de.replace("{}",J[1])),is("Falling back to no-highlight mode for this block.",A)),ae?J[1]:"no-highlight"}return U.split(/\s+/).find(ae=>q(ae)||Xe(ae))}function pe(A,U,J){let ae="",fe="";typeof U=="object"?(ae=A,J=U.ignoreIllegals,fe=U.language):(ot("10.7.0","highlight(lang, code, ...args) has been deprecated."),ot("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),fe=A,ae=U),J===void 0&&(J=!0);const Ie={code:ae,language:fe};Xt("before:highlight",Ie);const Ke=Ie.result?Ie.result:Rt(Ie.language,Ie.code,J);return Ke.code=Ie.code,Xt("after:highlight",Ke),Ke}function Rt(A,U,J,ae){const fe=Object.create(null);function Ie(_,D){return _.keywords[D]}function Ke(){if(!Z.keywords){be.addText(le);return}let _=0;Z.keywordPatternRe.lastIndex=0;let D=Z.keywordPatternRe.exec(le),Q="";for(;D;){Q+=le.substring(_,D.index);const ie=Ne.case_insensitive?D[0].toLowerCase():D[0],Se=Ie(Z,ie);if(Se){const[je,sl]=Se;if(be.addText(Q),Q="",fe[ie]=(fe[ie]||0)+1,fe[ie]<=Ua&&(Vt+=sl),je.startsWith("_"))Q+=D[0];else{const il=Ne.classNameAliases[je]||je;Oe(D[0],il)}}else Q+=D[0];_=Z.keywordPatternRe.lastIndex,D=Z.keywordPatternRe.exec(le)}Q+=le.substring(_),be.addText(Q)}function Kt(){if(le==="")return;let _=null;if(typeof Z.subLanguage=="string"){if(!v[Z.subLanguage]){be.addText(le);return}_=Rt(Z.subLanguage,le,!0,bs[Z.subLanguage]),bs[Z.subLanguage]=_._top}else _=Bn(le,Z.subLanguage.length?Z.subLanguage:null);Z.relevance>0&&(Vt+=_.relevance),be.__addSublanguage(_._emitter,_.language)}function _e(){Z.subLanguage!=null?Kt():Ke(),le=""}function Oe(_,D){_!==""&&(be.startScope(D),be.addText(_),be.endScope())}function fs(_,D){let Q=1;const ie=D.length-1;for(;Q<=ie;){if(!_._emit[Q]){Q++;continue}const Se=Ne.classNameAliases[_[Q]]||_[Q],je=D[Q];Se?Oe(je,Se):(le=je,Ke(),le=""),Q++}}function gs(_,D){return _.scope&&typeof _.scope=="string"&&be.openNode(Ne.classNameAliases[_.scope]||_.scope),_.beginScope&&(_.beginScope._wrap?(Oe(le,Ne.classNameAliases[_.beginScope._wrap]||_.beginScope._wrap),le=""):_.beginScope._multi&&(fs(_.beginScope,D),le="")),Z=Object.create(_,{parent:{value:Z}}),Z}function ms(_,D,Q){let ie=P(_.endRe,Q);if(ie){if(_["on:end"]){const Se=new e(_);_["on:end"](D,Se),Se.isMatchIgnored&&(ie=!1)}if(ie){for(;_.endsParent&&_.parent;)_=_.parent;return _}}if(_.endsWithParent)return ms(_.parent,D,Q)}function Ja(_){return Z.matcher.regexIndex===0?(le+=_[0],1):(Hn=!0,0)}function el(_){const D=_[0],Q=_.rule,ie=new e(Q),Se=[Q.__beforeBegin,Q["on:begin"]];for(const je of Se)if(je&&(je(_,ie),ie.isMatchIgnored))return Ja(D);return Q.skip?le+=D:(Q.excludeBegin&&(le+=D),_e(),!Q.returnBegin&&!Q.excludeBegin&&(le=D)),gs(Q,_),Q.returnBegin?0:D.length}function tl(_){const D=_[0],Q=U.substring(_.index),ie=ms(Z,_,Q);if(!ie)return cs;const Se=Z;Z.endScope&&Z.endScope._wrap?(_e(),Oe(D,Z.endScope._wrap)):Z.endScope&&Z.endScope._multi?(_e(),fs(Z.endScope,_)):Se.skip?le+=D:(Se.returnEnd||Se.excludeEnd||(le+=D),_e(),Se.excludeEnd&&(le=D));do Z.scope&&be.closeNode(),!Z.skip&&!Z.subLanguage&&(Vt+=Z.relevance),Z=Z.parent;while(Z!==ie.parent);return ie.starts&&gs(ie.starts,_),Se.returnEnd?0:D.length}function nl(){const _=[];for(let D=Z;D!==Ne;D=D.parent)D.scope&&_.unshift(D.scope);_.forEach(D=>be.openNode(D))}let Yt={};function ws(_,D){const Q=D&&D[0];if(le+=_,Q==null)return _e(),0;if(Yt.type==="begin"&&D.type==="end"&&Yt.index===D.index&&Q===""){if(le+=U.slice(D.index,D.index+1),!he){const ie=new Error(`0 width match regex (${A})`);throw ie.languageName=A,ie.badRule=Yt.rule,ie}return 1}if(Yt=D,D.type==="begin")return el(D);if(D.type==="illegal"&&!J){const ie=new Error('Illegal lexeme "'+Q+'" for mode "'+(Z.scope||"<unnamed>")+'"');throw ie.mode=Z,ie}else if(D.type==="end"){const ie=tl(D);if(ie!==cs)return ie}if(D.type==="illegal"&&Q==="")return le+=`
`,1;if(Dn>1e5&&Dn>D.index*3)throw new Error("potential infinite loop, way more iterations than matches");return le+=Q,Q.length}const Ne=Xe(A);if(!Ne)throw et(de.replace("{}",A)),new Error('Unknown language: "'+A+'"');const rl=Oa(Ne);let Nn="",Z=ae||rl;const bs={},be=new z.__emitter(z);nl();let le="",Vt=0,tt=0,Dn=0,Hn=!1;try{if(Ne.__emitTokens)Ne.__emitTokens(U,be);else{for(Z.matcher.considerAll();;){Dn++,Hn?Hn=!1:Z.matcher.considerAll(),Z.matcher.lastIndex=tt;const _=Z.matcher.exec(U);if(!_)break;const D=U.substring(tt,_.index),Q=ws(D,_);tt=_.index+Q}ws(U.substring(tt))}return be.finalize(),Nn=be.toHTML(),{language:A,value:Nn,relevance:Vt,illegal:!1,_emitter:be,_top:Z}}catch(_){if(_.message&&_.message.includes("Illegal"))return{language:A,value:In(U),illegal:!0,relevance:0,_illegalBy:{message:_.message,index:tt,context:U.slice(tt-100,tt+100),mode:_.mode,resultSoFar:Nn},_emitter:be};if(he)return{language:A,value:In(U),illegal:!1,relevance:0,errorRaised:_,_emitter:be,_top:Z};throw _}}function zn(A){const U={value:In(A),illegal:!1,relevance:0,_top:O,_emitter:new z.__emitter(z)};return U._emitter.addText(A),U}function Bn(A,U){U=U||z.languages||Object.keys(v);const J=zn(A),ae=U.filter(Xe).filter(ps).map(_e=>Rt(_e,A,!1));ae.unshift(J);const fe=ae.sort((_e,Oe)=>{if(_e.relevance!==Oe.relevance)return Oe.relevance-_e.relevance;if(_e.language&&Oe.language){if(Xe(_e.language).supersetOf===Oe.language)return 1;if(Xe(Oe.language).supersetOf===_e.language)return-1}return 0}),[Ie,Ke]=fe,Kt=Ie;return Kt.secondBest=Ke,Kt}function qa(A,U,J){const ae=U&&C[U]||J;A.classList.add("hljs"),A.classList.add(`language-${ae}`)}function On(A){let U=null;const J=ge(A);if(q(J))return;if(Xt("before:highlightElement",{el:A,language:J}),A.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",A);return}if(A.children.length>0&&(z.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(A)),z.throwUnescapedHTML))throw new Ha("One of your code blocks includes unescaped HTML.",A.innerHTML);U=A;const ae=U.textContent,fe=J?pe(ae,{language:J,ignoreIllegals:!0}):Bn(ae);A.innerHTML=fe.value,A.dataset.highlighted="yes",qa(A,J,fe.language),A.result={language:fe.language,re:fe.relevance,relevance:fe.relevance},fe.secondBest&&(A.secondBest={language:fe.secondBest.language,relevance:fe.secondBest.relevance}),Xt("after:highlightElement",{el:A,result:fe,text:ae})}function ja(A){z=os(z,A)}const Fa=()=>{Gt(),ot("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function Wa(){Gt(),ot("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let hs=!1;function Gt(){function A(){Gt()}if(document.readyState==="loading"){hs||window.addEventListener("DOMContentLoaded",A,!1),hs=!0;return}document.querySelectorAll(z.cssSelector).forEach(On)}function Za(A,U){let J=null;try{J=U(g)}catch(ae){if(et("Language definition for '{}' could not be registered.".replace("{}",A)),he)et(ae);else throw ae;J=O}J.name||(J.name=A),v[A]=J,J.rawDefinition=U.bind(null,g),J.aliases&&ds(J.aliases,{languageName:A})}function Qa(A){delete v[A];for(const U of Object.keys(C))C[U]===A&&delete C[U]}function Ga(){return Object.keys(v)}function Xe(A){return A=(A||"").toLowerCase(),v[A]||v[C[A]]}function ds(A,{languageName:U}){typeof A=="string"&&(A=[A]),A.forEach(J=>{C[J.toLowerCase()]=U})}function ps(A){const U=Xe(A);return U&&!U.disableAutodetect}function Xa(A){A["before:highlightBlock"]&&!A["before:highlightElement"]&&(A["before:highlightElement"]=U=>{A["before:highlightBlock"](Object.assign({block:U.el},U))}),A["after:highlightBlock"]&&!A["after:highlightElement"]&&(A["after:highlightElement"]=U=>{A["after:highlightBlock"](Object.assign({block:U.el},U))})}function Ka(A){Xa(A),F.push(A)}function Ya(A){const U=F.indexOf(A);U!==-1&&F.splice(U,1)}function Xt(A,U){const J=A;F.forEach(function(ae){ae[J]&&ae[J](U)})}function Va(A){return ot("10.7.0","highlightBlock will be removed entirely in v12.0"),ot("10.7.0","Please use highlightElement now."),On(A)}Object.assign(g,{highlight:pe,highlightAuto:Bn,highlightAll:Gt,highlightElement:On,highlightBlock:Va,configure:ja,initHighlighting:Fa,initHighlightingOnLoad:Wa,registerLanguage:Za,unregisterLanguage:Qa,listLanguages:Ga,getLanguage:Xe,registerAliases:ds,autoDetection:ps,inherit:os,addPlugin:Ka,removePlugin:Ya}),g.debugMode=function(){he=!1},g.safeMode=function(){he=!0},g.versionString=Da,g.regex={concat:m,lookahead:f,either:k,optional:d,anyNumberOfTimes:p};for(const A in Zt)typeof Zt[A]=="object"&&t(Zt[A]);return Object.assign(g,Zt),g},ct=us({});return ct.newInstance=()=>us({}),en=ct,ct.HighlightJS=ct,ct.default=ct,en}var Es=vs();const ce=jn(Es),V=new Map,As="https://raw.githubusercontent.com/highlightjs/highlight.js/main/SUPPORTED_LANGUAGES.md",Ae={shell:"bash",sh:"bash",zsh:"bash",js:"javascript",ts:"typescript",py:"python",csharp:"cs","c#":"cs"};Ae.html="xml",Ae.xhtml="xml",Ae.markup="xml";const tn=new Set(["magic","undefined"]);let Fe=null;const Wn=new Map,Rs=300*1e3;async function nn(t=As){if(t)return Fe||(Fe=(async()=>{try{const e=await fetch(t);if(!e.ok)return;const i=(await e.text()).split(/\r?\n/);let n=-1;for(let o=0;o<i.length;o++)if(/\|\s*Language\s*\|/i.test(i[o])){n=o;break}if(n===-1)return;const s=i[n].replace(/^\||\|$/g,"").split("|").map(o=>o.trim().toLowerCase());let a=s.findIndex(o=>/alias|aliases|equivalent|alt|alternates?/i.test(o));a===-1&&(a=1);let h=s.findIndex(o=>/file|filename|module|module name|module-name|short|slug/i.test(o));if(h===-1){const o=s.findIndex(c=>/language/i.test(c));h=o!==-1?o:0}let l=[];for(let o=n+1;o<i.length;o++){const c=i[o].trim();if(!c||!c.startsWith("|"))break;const u=c.replace(/^\||\|$/g,"").split("|").map(w=>w.trim());if(u.every(w=>/^-+$/.test(w)))continue;const f=u;if(!f.length)continue;const d=(f[h]||f[0]||"").toString().trim().toLowerCase();if(!d||/^-+$/.test(d))continue;V.set(d,d);const m=f[a]||"";if(m){const w=String(m).split(",").map(k=>k.replace(/`/g,"").trim()).filter(Boolean);if(w.length){const x=w[0].toLowerCase().replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");x&&/[a-z0-9]/i.test(x)&&(V.set(x,x),l.push(x))}}}try{const o=[];for(const c of l){const u=String(c||"").replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");u&&/[a-z0-9]/i.test(u)?o.push(u):V.delete(c)}l=o}catch(o){console.warn("[codeblocksManager] cleanup aliases failed",o)}try{let o=0;for(const c of Array.from(V.keys())){if(!c||/^-+$/.test(c)||!/[a-z0-9]/i.test(c)){V.delete(c),o++;continue}if(/^[:]+/.test(c)){const u=c.replace(/^[:]+/,"");if(u&&/[a-z0-9]/i.test(u)){const f=V.get(c);V.delete(c),V.set(u,f)}else V.delete(c),o++}}for(const[c,u]of Array.from(V.entries()))(!u||/^-+$/.test(u)||!/[a-z0-9]/i.test(u))&&(V.delete(c),o++);try{const c=":---------------------";V.has(c)&&(V.delete(c),o++)}catch(c){console.warn("[codeblocksManager] remove sep key failed",c)}try{const c=Array.from(V.keys()).sort()}catch(c){console.warn("[codeblocksManager] compute supported keys failed",c)}}catch(o){console.warn("[codeblocksManager] ignored error",o)}}catch(e){console.warn("[codeblocksManager] loadSupportedLanguages failed",e)}})(),Fe)}const rn=new Set;async function nt(t,e){if(Fe||(async()=>{try{await nn()}catch(n){console.warn("[codeblocksManager] loadSupportedLanguages (IIFE) failed",n)}})(),Fe)try{await Fe}catch{}if(t=t==null?"":String(t),t=t.trim(),!t)return!1;const r=t.toLowerCase();if(tn.has(r))return!1;if(V.size&&!V.has(r)){const n=Ae;if(!n[r]&&!n[t])return!1}if(rn.has(t))return!0;const i=Ae;try{const n=(e||t||"").toString().replace(/\.js$/i,"").trim(),s=(i[t]||t||"").toString(),a=(i[n]||n||"").toString();let h=Array.from(new Set([s,a,n,t,i[n],i[t]].filter(Boolean))).map(c=>String(c).toLowerCase()).filter(c=>c&&c!=="undefined");V.size&&(h=h.filter(c=>{if(V.has(c))return!0;const u=Ae[c];return!!(u&&V.has(u))}));let l=null,o=null;for(const c of h)try{const u=Date.now(),f=Wn.get(c);if(f){if(f.ok===!1&&u-(f.ts||0)<Rs)l=null;else if(f.module)l=f.module;else if(f.promise)try{l=await f.promise}catch{l=null}}else{const p={promise:null,module:null,ok:null,ts:0};Wn.set(c,p),p.promise=(async()=>{try{try{return await import(`highlight.js/lib/languages/${c}.js`)}catch{try{const m=`https://cdn.jsdelivr.net/npm/highlight.js/es/languages/${c}.js`;return await new Function("u","return import(u)")(m)}catch{try{const w=`https://cdn.jsdelivr.net/npm/highlight.js/lib/languages/${c}.js`;return await new Function("u","return import(u)")(w)}catch{return null}}}}catch{return null}})();try{l=await p.promise,p.module=l,p.ok=!!l,p.ts=Date.now()}catch{p.module=null,p.ok=!1,p.ts=Date.now(),l=null}}if(l){const p=l.default||l;try{const d=V.size&&V.get(t)||c||t;return ce.registerLanguage(d,p),rn.add(d),d!==t&&(ce.registerLanguage(t,p),rn.add(t)),!0}catch(d){o=d}}}catch(u){o=u}if(o)throw o;return!1}catch{return!1}}let Ct=null;function Zn(t=document){Fe||(async()=>{try{await nn()}catch(s){console.warn("[codeblocksManager] loadSupportedLanguages (observer) failed",s)}})();const e=Ae,i=Ct||(typeof IntersectionObserver>"u"?null:(Ct=new IntersectionObserver((s,a)=>{s.forEach(h=>{if(!h.isIntersecting)return;const l=h.target;try{a.unobserve(l)}catch(o){console.warn("[codeblocksManager] observer unobserve failed",o)}(async()=>{try{const o=l.getAttribute&&l.getAttribute("class")||l.className||"",c=o.match(/language-([a-zA-Z0-9_+-]+)/)||o.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(c&&c[1]){const u=(c[1]||"").toLowerCase(),f=e[u]||u,p=V.size&&(V.get(f)||V.get(String(f).toLowerCase()))||f;try{await nt(p)}catch(d){console.warn("[codeblocksManager] registerLanguage failed",d)}try{ce.highlightElement(l)}catch(d){console.warn("[codeblocksManager] hljs.highlightElement failed",d)}}else try{const u=l.textContent||"";try{if(ce&&typeof ce.getLanguage=="function"&&ce.getLanguage("plaintext")){const f=ce.highlight(u,{language:"plaintext"});f&&f.value&&(l.innerHTML=f.value)}}catch{try{ce.highlightElement(l)}catch(p){console.warn("[codeblocksManager] fallback highlightElement failed",p)}}}catch(u){console.warn("[codeblocksManager] auto-detect plaintext failed",u)}}catch(o){console.warn("[codeblocksManager] observer entry processing failed",o)}})()})},{root:null,rootMargin:"300px",threshold:.1}),Ct)),n=t&&t.querySelectorAll?t.querySelectorAll("pre code"):[];if(!i){n.forEach(async s=>{try{const a=s.getAttribute&&s.getAttribute("class")||s.className||"",h=a.match(/language-([a-zA-Z0-9_+-]+)/)||a.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(h&&h[1]){const l=(h[1]||"").toLowerCase(),o=e[l]||l,c=V.size&&(V.get(o)||V.get(String(o).toLowerCase()))||o;try{await nt(c)}catch(u){console.warn("[codeblocksManager] registerLanguage failed (no observer)",u)}}try{ce.highlightElement(s)}catch(l){console.warn("[codeblocksManager] hljs.highlightElement failed (no observer)",l)}}catch(a){console.warn("[codeblocksManager] loadSupportedLanguages fallback ignored error",a)}});return}n.forEach(s=>{try{i.observe(s)}catch(a){console.warn("[codeblocksManager] observe failed",a)}})}function Ts(t,{useCdn:e=!0}={}){const r=document.querySelector("link[data-hl-theme]");r&&r.remove();let i=t||"monokai";if(i==="monokai")return;if(!e){console.warn("Requested highlight theme not bundled; set useCdn=true to load from CDN");return}const n=`https://cdn.jsdelivr.net/npm/highlight.js@11.8.0/styles/${i}.css`,s=document.createElement("link");s.rel="stylesheet",s.href=n,s.setAttribute("data-hl-theme",i),document.head.appendChild(s)}let sn="light";function Cs(t,e={}){if(document.querySelector(`link[href="${t}"]`))return;const r=document.createElement("link");r.rel="stylesheet",r.href=t,Object.entries(e).forEach(([i,n])=>r.setAttribute(i,n)),document.head.appendChild(r)}async function Qn(t="none",e="/"){if(!t||t==="none")return;const r=[e+"bulma.css","/bulma.css"],i=Array.from(new Set(r));if(t==="local"){if(document.querySelector("style[data-bulma-override]"))return;for(const n of i)try{const s=await fetch(n,{method:"GET"});if(s.ok){const a=await s.text(),h=document.createElement("style");h.setAttribute("data-bulma-override",n),h.appendChild(document.createTextNode(`
/* bulma override: ${n} */
`+a)),document.head.appendChild(h);return}}catch(s){console.warn("[bulmaManager] fetch local bulma candidate failed",s)}return}try{const n=String(t).trim();if(!n)return;const s=`https://unpkg.com/bulmaswatch/${encodeURIComponent(n)}/bulmaswatch.min.css`;Cs(s,{"data-bulmaswatch-theme":n})}catch(n){console.warn("[bulmaManager] ensureBulma failed",n)}}function Gn(t){sn=t==="dark"?"dark":"light",document.documentElement.setAttribute("data-theme",sn),sn==="dark"?document.body.classList.add("is-dark"):document.body.classList.remove("is-dark")}function Ls(t){const e=document.documentElement;for(const[r,i]of Object.entries(t||{}))try{e.style.setProperty(`--${r}`,i)}catch(n){console.warn("[bulmaManager] setThemeVars failed for",r,n)}}const Xn={en:{navigation:"Navigation",onThisPage:"On this page",home:"Home",scrollToTop:"Scroll to top",readingTime:"{minutes} min read",searchPlaceholder:"Search…",imagePreviewTitle:"Image preview",imagePreviewFit:"Fit to screen",imagePreviewOriginal:"Original size",imagePreviewZoomOut:"Zoom out",imagePreviewZoomIn:"Zoom in",imagePreviewClose:"Close"},es:{navigation:"Navegación",onThisPage:"En esta página",home:"Inicio",scrollToTop:"Ir arriba",readingTime:"{minutes} min de lectura",searchPlaceholder:"Buscar…",imagePreviewTitle:"Previsualización de imagen",imagePreviewFit:"Ajustar a la pantalla",imagePreviewOriginal:"Tamaño original",imagePreviewZoomOut:"Alejar",imagePreviewZoomIn:"Acercar",imagePreviewClose:"Cerrar"},de:{navigation:"Navigation",onThisPage:"Auf dieser Seite",home:"Startseite",scrollToTop:"Nach oben",readingTime:"{minutes} min Lesezeit",searchPlaceholder:"Suchen…",imagePreviewTitle:"Bildvorschau",imagePreviewFit:"An Bildschirm anpassen",imagePreviewOriginal:"Originalgröße",imagePreviewZoomOut:"Verkleinern",imagePreviewZoomIn:"Vergrößern",imagePreviewClose:"Schließen"},fr:{navigation:"Navigation",onThisPage:"Sur cette page",home:"Accueil",scrollToTop:"Aller en haut",readingTime:"{minutes} min de lecture",searchPlaceholder:"Rechercher…",imagePreviewTitle:"Aperçu de l’image",imagePreviewFit:"Ajuster à l’écran",imagePreviewOriginal:"Taille originale",imagePreviewZoomOut:"Dézoomer",imagePreviewZoomIn:"Zoomer",imagePreviewClose:"Fermer"},pt:{navigation:"Navegação",onThisPage:"Nesta página",home:"Início",scrollToTop:"Ir para o topo",readingTime:"{minutes} min de leitura",searchPlaceholder:"Procurar…",imagePreviewTitle:"Visualização da imagem",imagePreviewFit:"Ajustar à tela",imagePreviewOriginal:"Tamanho original",imagePreviewZoomOut:"Diminuir",imagePreviewZoomIn:"Aumentar",imagePreviewClose:"Fechar"}},rt=JSON.parse(JSON.stringify(Xn));let Lt="en";if(typeof navigator<"u"){const t=navigator.language||navigator.languages&&navigator.languages[0]||"en";Lt=String(t).split("-")[0].toLowerCase()}Xn[Lt]||(Lt="en");let We=Lt;function st(t,e={}){const r=rt[We]||rt.en;let i=r&&r[t]?r[t]:rt.en[t]||"";for(const n of Object.keys(e))i=i.replace(new RegExp(`{${n}}`,"g"),String(e[n]));return i}async function an(t,e){if(!t)return;let r=t;try{/^https?:\/\//.test(t)||(r=new URL(t,location.origin+e).toString());const i=await fetch(r);if(!i.ok)return;const n=await i.json();for(const s of Object.keys(n||{}))rt[s]=Object.assign({},rt[s]||{},n[s])}catch{}}function ln(t){const e=String(t).split("-")[0].toLowerCase();We=rt[e]?e:"en"}const _s=Object.freeze(Object.defineProperty({__proto__:null,get currentLang(){return We},loadL10nFile:an,setLang:ln,t:st},Symbol.toStringTag,{value:"Module"})),Ms=`import { buildSearchIndex, crawlForSlug } from '../slugManager.js'
...
`;function Kn(t,e="worker"){let r=null;function i(){if(!r)try{const h=t();r=h||null,h&&h.addEventListener("error",()=>{try{r===h&&(r=null,h.terminate&&h.terminate())}catch(l){console.warn("["+e+"] worker termination failed",l)}})}catch(h){r=null,console.warn("["+e+"] worker init failed",h)}return r}function n(){try{r&&(r.terminate&&r.terminate(),r=null)}catch(h){console.warn("["+e+"] worker termination failed",h)}}function s(h,l=1e3){return new Promise((o,c)=>{const u=i();if(!u)return c(new Error("worker unavailable"));const f=String(Math.random());h.id=f;let p=null;const d=()=>{p&&clearTimeout(p),u.removeEventListener("message",m),u.removeEventListener("error",w)},m=k=>{const x=k.data||{};x.id===f&&(d(),x.error?c(new Error(x.error)):o(x.result))},w=k=>{d(),console.warn("["+e+"] worker error event",k);try{r===u&&(r=null,u.terminate&&u.terminate())}catch(x){console.warn("["+e+"] worker termination failed",x)}c(new Error(k&&k.message||"worker error"))};p=setTimeout(()=>{d(),console.warn("["+e+"] worker timed out");try{r===u&&(r=null,u.terminate&&u.terminate())}catch(k){console.warn("["+e+"] worker termination on timeout failed",k)}c(new Error("worker timeout"))},l),u.addEventListener("message",m),u.addEventListener("error",w);try{u.postMessage(h)}catch(k){d(),c(k)}})}return{get:i,send:s,terminate:n}}function $s(t){try{if(typeof Blob<"u"&&typeof URL<"u"&&t){const e=new Blob([t],{type:"application/javascript"}),r=URL.createObjectURL(e);return new Worker(r,{type:"module"})}}catch(e){console.warn("[worker-manager] createWorkerFromRaw failed",e)}return null}const ze=new Set;function on(t){Ps(),ze.clear();for(const e of Te)e&&ze.add(e);Yn(G),Yn(H),on._refreshed=!0}function Yn(t){if(!(!t||typeof t.values!="function"))for(const e of t.values())e&&ze.add(e)}function Vn(t){if(!t||typeof t.set!="function")return;const e=t.set;t.set=function(r,i){return i&&ze.add(i),e.call(this,r,i)}}let Jn=!1;function Ps(){Jn||(Vn(G),Vn(H),Jn=!0)}function er(t){return!t||typeof t!="string"?!1:/^(https?:)?\/\//.test(t)||t.startsWith("mailto:")||t.startsWith("tel:")}function ue(t){return String(t||"").replace(/^[.\/]+/,"")}function ut(t){return String(t||"").replace(/\/+$/,"")}function ht(t){return ut(t)+"/"}function Is(t){try{if(!t||typeof document>"u"||!document.head||t.startsWith("data:")||document.head.querySelector(`link[rel="preload"][as="image"][href="${t}"]`))return;const r=document.createElement("link");r.rel="preload",r.as="image",r.href=t,document.head.appendChild(r)}catch(e){console.warn("[helpers] preloadImage failed",e)}}function _t(t,e=0,r=!1){try{if(typeof window>"u"||!t||!t.querySelectorAll)return;const i=Array.from(t.querySelectorAll("img"));if(!i.length)return;const n=t,s=n&&n.getBoundingClientRect?n.getBoundingClientRect():null,a=0,h=typeof window<"u"&&(window.innerHeight||document.documentElement.clientHeight)||0,l=s?Math.max(a,s.top):a,c=(s?Math.min(h,s.bottom):h)+Number(e||0);let u=0;n&&(u=n.clientHeight||(s?s.height:0)),u||(u=h-a);let f=.6;try{const w=n&&window.getComputedStyle?window.getComputedStyle(n):null,k=w&&w.getPropertyValue("--nimbi-image-max-height-ratio"),x=k?parseFloat(k):NaN;!Number.isNaN(x)&&x>0&&x<=1&&(f=x)}catch(w){console.warn("[helpers] read CSS ratio failed",w)}const p=Math.max(200,Math.floor(u*f));let d=!1,m=null;if(i.forEach(w=>{try{const k=w.getAttribute?w.getAttribute("loading"):void 0;k!=="eager"&&w.setAttribute&&w.setAttribute("loading","lazy");const x=w.getBoundingClientRect?w.getBoundingClientRect():null,P=w.src||w.getAttribute&&w.getAttribute("src"),E=x&&x.height>1?x.height:p,N=x?x.top:0,M=N+E,W=!!(x&&E>0&&N<=c&&M>=l);W&&(w.setAttribute?(w.setAttribute("loading","eager"),w.setAttribute("fetchpriority","high"),w.setAttribute("data-eager-by-nimbi","1")):(w.loading="eager",w.fetchPriority="high"),Is(P),d=!0),!m&&x&&x.top<=c&&(m={img:w,src:P,rect:x,beforeLoading:k}),r&&console.log("[helpers] setEagerForAboveFoldImages:",{src:P,rect:x,marginPx:e,visibleTop:l,visibleBottom:c,beforeLoading:k,isAboveFold:W,effectiveHeight:E,maxImageHeight:p})}catch(k){console.warn("[helpers] setEagerForAboveFoldImages per-image failed",k)}}),!d&&m){const{img:w,src:k,rect:x,beforeLoading:P}=m;try{w.setAttribute?(w.setAttribute("loading","eager"),w.setAttribute("fetchpriority","high"),w.setAttribute("data-eager-by-nimbi","1")):(w.loading="eager",w.fetchPriority="high"),r&&console.log("[helpers] setEagerForAboveFoldImages (fallback first visible):",{src:k,rect:x,marginPx:e,visibleTop:l,visibleBottom:c,beforeLoading:P,fallback:!0})}catch(E){console.warn("[helpers] setEagerForAboveFoldImages fallback failed",E)}}}catch(i){console.warn("[helpers] setEagerForAboveFoldImages failed",i)}}function Mt(t){try{const e=t();return e&&typeof e.then=="function"?e.catch(r=>{console.warn("[helpers] safe swallowed error",r)}):e}catch(e){console.warn("[helpers] safe swallowed error",e)}}try{typeof globalThis<"u"&&!globalThis.safe&&(globalThis.safe=Mt)}catch(t){console.warn("[helpers] global attach failed",t)}const G=new Map;let Re=[];function tr(t){Re=Array.isArray(t)?t.slice():[]}function zs(){return Re}const nr=Kn(()=>$s(Ms),"slugManager");function cn(){return nr.get()}function rr(t){return nr.send(t)}async function Bs(t,e=1,r=void 0){if(!cn())return Bt(t,e,r);try{return await rr({type:"buildSearchIndex",contentBase:t,indexDepth:e,noIndexing:r})}catch(n){try{return await Bt(t,e,r)}catch(s){throw console.warn("[slugManager] buildSearchIndex fallback failed",s),n}}}async function Os(t,e,r){return cn()?rr({type:"crawlForSlug",slug:t,base:e,maxQueue:r}):pn(t,e,r)}function Ze(t,e){if(t)if(Re&&Re.length){const i=e.split("/")[0],n=Re.includes(i);let s=G.get(t);(!s||typeof s=="string")&&(s={default:typeof s=="string"?s:void 0,langs:{}}),n?s.langs[i]=e:s.default=e,G.set(t,s)}else G.set(t,e)}const $t=new Set;function Ns(t){typeof t=="function"&&$t.add(t)}function Ds(t){typeof t=="function"&&$t.delete(t)}const H=new Map;let un={},Te=[],it="_404.md",at="_home.md";function hn(t){t!=null&&(it=String(t||""))}function dn(t){t!=null&&(at=String(t||""))}function Hs(t){un=t||{}}const dt=new Map,Pt=new Set;function Us(){dt.clear(),Pt.clear()}function qs(t){if(!t||t.length===0)return"";let e=t[0];for(let i=1;i<t.length;i++){const n=t[i];let s=0;const a=Math.min(e.length,n.length);for(;s<a&&e[s]===n[s];)s++;e=e.slice(0,s)}const r=e.lastIndexOf("/");return r===-1?e:e.slice(0,r+1)}function It(t){G.clear(),H.clear(),Te=[],Re=Re||[];const e=Object.keys(un||{});if(!e.length)return;let r="";try{if(t){try{/^[a-z][a-z0-9+.-]*:/i.test(String(t))?r=new URL(String(t)).pathname:r=String(t||"")}catch(i){r=String(t||""),console.warn("[slugManager] parse contentBase failed",i)}r=ht(r)}}catch(i){r="",console.warn("[slugManager] setContentBase prefix derivation failed",i)}r||(r=qs(e));for(const i of e){let n=i;r&&i.startsWith(r)?n=ue(i.slice(r.length)):n=ue(i),Te.push(n);try{on()}catch(a){console.warn("[slugManager] refreshIndexPaths failed",a)}const s=un[i];if(typeof s=="string"){const a=(s||"").match(/^#\s+(.+)$/m);if(a&&a[1]){const h=ne(a[1].trim());if(h)try{if(Re&&Re.length){const o=n.split("/")[0],c=Re.includes(o);let u=G.get(h);(!u||typeof u=="string")&&(u={default:typeof u=="string"?u:void 0,langs:{}}),c?u.langs[o]=n:u.default=n,G.set(h,u)}else G.set(h,n);H.set(n,h)}catch(l){console.warn("[slugManager] set slug mapping failed",l)}}}}}try{It()}catch(t){console.warn("[slugManager] initial setContentBase failed",t)}function ne(t){let e=String(t||"").toLowerCase().replace(/[^a-z0-9\- ]/g,"").replace(/ /g,"-");return e=e.replace(/(?:-?)(?:md|html)$/,""),e}function pt(t){if(!t||!G.has(t))return null;const e=G.get(t);if(!e)return null;if(typeof e=="string")return e;if(Re&&Re.length&&We&&e.langs&&e.langs[We])return e.langs[We];if(e.default)return e.default;if(e.langs){const r=Object.keys(e.langs);if(r.length)return e.langs[r[0]]}return null}const ft=new Map;function js(){ft.clear()}let me=async function(t,e){if(!t)throw new Error("path required");try{const s=(String(t||"").match(/([^\/]+)\.md(?:$|[?#])/)||[])[1];if(s&&G.has(s)){const a=pt(s)||G.get(s);a&&a!==t&&(t=a)}}catch(s){console.warn("[slugManager] slug mapping normalization failed",s)}const r=e==null?"":ut(String(e));let i="";try{r?/^[a-z][a-z0-9+.-]*:/i.test(r)?i=r.replace(/\/$/,"")+"/"+t.replace(/^\//,""):i=(r.startsWith("/")?"":"/")+r.replace(/\/$/,"")+"/"+t.replace(/^\//,""):i="/"+t.replace(/^\//,"")}catch{i="/"+t.replace(/^\//,"")}if(ft.has(i))return ft.get(i);const n=(async()=>{const s=await fetch(i);if(!s||typeof s.ok!="boolean"||!s.ok){if(s&&s.status===404)try{const u=`${r}/${it}`,f=await globalThis.fetch(u);if(f&&typeof f.ok=="boolean"&&f.ok)return{raw:await f.text(),status:404}}catch(u){console.warn("[slugManager] fetching fallback 404 failed",u)}let c="";try{s&&typeof s.clone=="function"?c=await s.clone().text():s&&typeof s.text=="function"?c=await s.text():c=""}catch(u){c="",console.warn("[slugManager] reading error body failed",u)}throw console.error("fetchMarkdown failed:",{url:i,status:s?s.status:void 0,statusText:s?s.statusText:void 0,body:c.slice(0,200)}),new Error("failed to fetch md")}const a=await s.text(),h=a.trim().slice(0,16).toLowerCase(),l=h.startsWith("<!doctype")||h.startsWith("<html"),o=l||String(t||"").toLowerCase().endsWith(".html");if(l&&String(t||"").toLowerCase().endsWith(".md")){try{const c=`${r}/${it}`,u=await globalThis.fetch(c);if(u.ok)return{raw:await u.text(),status:404}}catch(c){console.warn("[slugManager] fetching fallback 404 failed",c)}throw console.error("fetchMarkdown: server returned HTML for .md request",i),new Error("failed to fetch md")}return o?{raw:a,isHtml:!0}:{raw:a}})();return ft.set(i,n),n};function Fs(t){typeof t=="function"&&(me=t)}const zt=new Map;let He=[],gt=null;async function Bt(t,e=1,r=void 0){const i=Array.isArray(r)?Array.from(new Set((r||[]).map(n=>ue(String(n||""))))):[];try{const n=ue(String(it||""));n&&!i.includes(n)&&i.push(n)}catch{}if(He&&He.length&&e===1&&!He.some(s=>{try{return i.includes(ue(String(s.path||"")))}catch{return!1}}))return He;if(gt)return gt;gt=(async()=>{let n=Array.isArray(r)?Array.from(new Set((r||[]).map(o=>ue(String(o||""))))):[];try{const o=ue(String(it||""));o&&!n.includes(o)&&n.push(o)}catch{}const s=o=>{if(!n||!n.length)return!1;for(const c of n)if(c&&(o===c||o.startsWith(c+"/")))return!0;return!1};let a=[];if(Te&&Te.length&&(a=Array.from(Te)),!a.length)for(const o of G.values())o&&a.push(o);try{const o=await lr(t);o&&o.length&&(a=a.concat(o))}catch(o){console.warn("[slugManager] crawlAllMarkdown during buildSearchIndex failed",o)}try{const o=new Set(a),c=[...a];for(o.size;c.length&&o.size<=mt;){const u=c.shift();try{const f=await me(u,t);if(f&&f.raw){if(f.status===404)continue;let p=f.raw;const d=[],m=String(u||"").replace(/^.*\//,"");if(/^readme(?:\.md)?$/i.test(m))continue;const w=/\[[^\]]+\]\(([^)]+)\)/g;let k;for(;k=w.exec(p);)d.push(k[1]);const x=/<a\s+[^>]*href=["']([^"']+)["'][^>]*>/gi;for(;k=x.exec(p);)d.push(k[1]);const P=u&&u.includes("/")?u.substring(0,u.lastIndexOf("/")+1):"";for(let E of d)try{if(/^[a-z][a-z0-9+.-]*:/i.test(E)||E.startsWith("/")||E.startsWith("..")||E.indexOf("/../")!==-1||(P&&!E.startsWith("./")&&!E.startsWith("/")&&!E.startsWith("../")&&(E=P+E),E=ue(E),!/\.(md|html?)(?:$|[?#])/i.test(E))||(E=E.split(/[?#]/)[0],s(E)))continue;o.has(E)||(o.add(E),c.push(E),a.push(E))}catch(N){console.warn("[slugManager] href processing failed",E,N)}}}catch(f){console.warn("[slugManager] discovery fetch failed for",u,f)}}}catch(o){console.warn("[slugManager] discovery loop failed",o)}const h=new Set;a=a.filter(o=>!o||h.has(o)||s(o)?!1:(h.add(o),!0));const l=[];for(const o of a)if(/\.(?:md|html?)(?:$|[?#])/i.test(o))try{const c=await me(o,t);if(c&&c.raw){if(c.status===404)continue;let u="",f="";if(c.isHtml)try{const m=new DOMParser().parseFromString(c.raw,"text/html"),w=m.querySelector("title")||m.querySelector("h1");w&&w.textContent&&(u=w.textContent.trim());const k=m.querySelector("p");if(k&&k.textContent&&(f=k.textContent.trim()),e>=2)try{const x=m.querySelector("h1"),P=x&&x.textContent?x.textContent.trim():u||"",E=(()=>{try{if(H.has(o))return H.get(o)}catch{}return ne(u||o)})(),N=Array.from(m.querySelectorAll("h2"));for(const M of N)try{const W=(M.textContent||"").trim();if(!W)continue;const X=M.id?M.id:ne(W),K=E?`${E}::${X}`:`${ne(o)}::${X}`;let re="",I=M.nextElementSibling;for(;I&&I.tagName&&I.tagName.toLowerCase()==="script";)I=I.nextElementSibling;I&&I.textContent&&(re=String(I.textContent).trim()),l.push({slug:K,title:W,excerpt:re,path:o,parentTitle:P})}catch(W){console.warn("[slugManager] indexing H2 failed",W)}if(e===3)try{const M=Array.from(m.querySelectorAll("h3"));for(const W of M)try{const X=(W.textContent||"").trim();if(!X)continue;const K=W.id?W.id:ne(X),re=E?`${E}::${K}`:`${ne(o)}::${K}`;let I="",T=W.nextElementSibling;for(;T&&T.tagName&&T.tagName.toLowerCase()==="script";)T=T.nextElementSibling;T&&T.textContent&&(I=String(T.textContent).trim()),l.push({slug:re,title:X,excerpt:I,path:o,parentTitle:P})}catch(X){console.warn("[slugManager] indexing H3 failed",X)}}catch(M){console.warn("[slugManager] collect H3s failed",M)}}catch(x){console.warn("[slugManager] collect H2s failed",x)}}catch(d){console.warn("[slugManager] parsing HTML for index failed",d)}else{const d=c.raw,m=d.match(/^#\s+(.+)$/m);u=m?m[1].trim():"";const w=d.split(/\r?\n\s*\r?\n/);if(w.length>1)for(let k=1;k<w.length;k++){const x=w[k].trim();if(x&&!/^#/.test(x)){f=x.replace(/\r?\n/g," ");break}}if(e>=2){let k="",x="";try{const P=(d.match(/^#\s+(.+)$/m)||[])[1];k=P?P.trim():"",x=(function(){try{if(H.has(o))return H.get(o)}catch{}return ne(u||o)})();const E=/^##\s+(.+)$/gm;let N;for(;N=E.exec(d);)try{const M=(N[1]||"").trim();if(!M)continue;const W=ne(M),X=x?`${x}::${W}`:`${ne(o)}::${W}`,re=d.slice(E.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),I=re&&re[1]?String(re[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";l.push({slug:X,title:M,excerpt:I,path:o,parentTitle:k})}catch(M){console.warn("[slugManager] indexing markdown H2 failed",M)}}catch(P){console.warn("[slugManager] collect markdown H2s failed",P)}if(e===3)try{const P=/^###\s+(.+)$/gm;let E;for(;E=P.exec(d);)try{const N=(E[1]||"").trim();if(!N)continue;const M=ne(N),W=x?`${x}::${M}`:`${ne(o)}::${M}`,K=d.slice(P.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),re=K&&K[1]?String(K[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";l.push({slug:W,title:N,excerpt:re,path:o,parentTitle:k})}catch(N){console.warn("[slugManager] indexing markdown H3 failed",N)}}catch(P){console.warn("[slugManager] collect markdown H3s failed",P)}}}let p="";try{H.has(o)&&(p=H.get(o))}catch(d){console.warn("[slugManager] mdToSlug access failed",d)}p||(p=ne(u||o)),l.push({slug:p,title:u,excerpt:f,path:o})}}catch(c){console.warn("[slugManager] buildSearchIndex: entry fetch failed",c)}try{He=l.filter(c=>{try{return!s(String(c.path||""))}catch{return!0}})}catch(o){console.warn("[slugManager] filtering index by excludes failed",o),He=l}return He})();try{await gt}catch(n){console.warn("[slugManager] awaiting _indexPromise failed",n)}return gt=null,He}const sr=1e3;let mt=sr;function Ws(t){typeof t=="number"&&t>=0&&(mt=t)}const ir=new DOMParser,ar="a[href]";let pn=async function(t,e,r=mt){if(zt.has(t))return zt.get(t);let i=null;const n=new Set,s=[""];for(;s.length&&!i&&!(s.length>r);){const a=s.shift();if(n.has(a))continue;n.add(a);let h=e;h.endsWith("/")||(h+="/"),h+=a;try{const l=await globalThis.fetch(h);if(!l.ok)continue;const o=await l.text(),u=ir.parseFromString(o,"text/html").querySelectorAll(ar);for(const f of u)try{let p=f.getAttribute("href")||"";if(!p||/^[a-z][a-z0-9+.-]*:/i.test(p)||p.startsWith("/")||p.startsWith("..")||p.indexOf("/../")!==-1)continue;if(p.endsWith("/")){const d=a+p;n.has(d)||s.push(d);continue}if(p.toLowerCase().endsWith(".md")){const d=ue(a+p);try{if(H.has(d))continue;for(const m of G.values());}catch(m){console.warn("[slugManager] slug map access failed",m)}try{const m=await me(d,e);if(m&&m.raw){const w=(m.raw||"").match(/^#\s+(.+)$/m);if(w&&w[1]&&ne(w[1].trim())===t){i=d;break}}}catch(m){console.warn("[slugManager] crawlForSlug: fetchMarkdown failed",m)}}}catch(p){console.warn("[slugManager] crawlForSlug: link iteration failed",p)}}catch(l){console.warn("[slugManager] crawlForSlug: directory fetch failed",l)}}return zt.set(t,i),i};async function lr(t,e=mt){const r=new Set,i=new Set,n=[""];for(;n.length&&!(n.length>e);){const s=n.shift();if(i.has(s))continue;i.add(s);let a=t;a.endsWith("/")||(a+="/"),a+=s;try{const h=await globalThis.fetch(a);if(!h.ok)continue;const l=await h.text(),c=ir.parseFromString(l,"text/html").querySelectorAll(ar);for(const u of c)try{let f=u.getAttribute("href")||"";if(!f||/^[a-z][a-z0-9+.-]*:/i.test(f)||f.startsWith("/")||f.startsWith("..")||f.indexOf("/../")!==-1)continue;if(f.endsWith("/")){const d=s+f;i.has(d)||n.push(d);continue}const p=(s+f).replace(/^\/+/,"");/\.(md|html?)$/i.test(p)&&r.add(p)}catch(f){console.warn("[slugManager] crawlAllMarkdown: link iteration failed",f)}}catch(h){console.warn("[slugManager] crawlAllMarkdown: directory fetch failed",h)}}return Array.from(r)}async function or(t,e,r){if(t&&typeof t=="string"&&(t=ue(t),t=ut(t)),G.has(t))return pt(t)||G.get(t);for(const n of $t)try{const s=await n(t,e);if(s)return Ze(t,s),H.set(s,t),s}catch(s){console.warn("[slugManager] slug resolver failed",s)}if(Te&&Te.length){if(dt.has(t)){const n=dt.get(t);return G.set(t,n),H.set(n,t),n}for(const n of Te)if(!Pt.has(n))try{const s=await me(n,e);if(s&&s.raw){const a=(s.raw||"").match(/^#\s+(.+)$/m);if(a&&a[1]){const h=ne(a[1].trim());if(Pt.add(n),h&&dt.set(h,n),h===t)return Ze(t,n),H.set(n,t),n}}}catch(s){console.warn("[slugManager] manifest title fetch failed",s)}}try{const n=await Bt(e);if(n&&n.length){const s=n.find(a=>a.slug===t);if(s)return Ze(t,s.path),H.set(s.path,t),s.path}}catch(n){console.warn("[slugManager] buildSearchIndex lookup failed",n)}try{const n=await pn(t,e,r);if(n)return Ze(t,n),H.set(n,t),n}catch(n){console.warn("[slugManager] crawlForSlug lookup failed",n)}const i=[`${t}.html`,`${t}.md`];for(const n of i)try{const s=await me(n,e);if(s&&s.raw)return Ze(t,n),H.set(n,t),n}catch(s){console.warn("[slugManager] candidate fetch failed",s)}if(Te&&Te.length)for(const n of Te)try{const s=n.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(ne(s)===t)return Ze(t,n),H.set(n,t),n}catch(s){console.warn("[slugManager] build-time filename match failed",s)}try{const n=[];at&&typeof at=="string"&&at.trim()&&n.push(at),n.includes("_home.md")||n.push("_home.md");for(const s of n)try{const a=await me(s,e);if(a&&a.raw){const h=(a.raw||"").match(/^#\s+(.+)$/m);if(h&&h[1]&&ne(h[1].trim())===t)return Ze(t,s),H.set(s,t),s}}catch{}}catch(n){console.warn("[slugManager] home page fetch failed",n)}return null}const Ot=Object.freeze(Object.defineProperty({__proto__:null,CRAWL_MAX_QUEUE:sr,_setAllMd:Hs,_storeSlugMapping:Ze,addSlugResolver:Ns,get allMarkdownPaths(){return Te},get availableLanguages(){return Re},buildSearchIndex:Bt,buildSearchIndexWorker:Bs,clearFetchCache:js,clearListCaches:Us,crawlAllMarkdown:lr,crawlCache:zt,crawlForSlug:pn,crawlForSlugWorker:Os,get defaultCrawlMaxQueue(){return mt},ensureSlug:or,fetchCache:ft,get fetchMarkdown(){return me},getLanguages:zs,get homePage(){return at},initSlugWorker:cn,listPathsFetched:Pt,listSlugCache:dt,mdToSlug:H,get notFoundPage(){return it},removeSlugResolver:Ds,resolveSlugPath:pt,get searchIndex(){return He},setContentBase:It,setDefaultCrawlMaxQueue:Ws,setFetchMarkdown:Fs,setHomePage:dn,setLanguages:tr,setNotFoundPage:hn,slugResolvers:$t,slugToMd:G,slugify:ne},Symbol.toStringTag,{value:"Module"}));let cr=100;function ur(t){cr=t}let wt=300*1e3;function hr(t){wt=t}const Me=new Map;function Zs(t){if(!Me.has(t))return;const e=Me.get(t),r=Date.now();if(e.ts+wt<r){Me.delete(t);return}return Me.delete(t),Me.set(t,e),e.value}function Qs(t,e){if(dr(),dr(),Me.delete(t),Me.set(t,{value:e,ts:Date.now()}),Me.size>cr){const r=Me.keys().next().value;r!==void 0&&Me.delete(r)}}function dr(){if(!wt||wt<=0)return;const t=Date.now();for(const[e,r]of Me.entries())r.ts+wt<t&&Me.delete(e)}async function Gs(t,e){const r=new Set(ze),i=document.querySelectorAll(".nimbi-site-navbar a, .navbar a, .nimbi-nav a");for(const n of Array.from(i||[])){const s=n.getAttribute("href")||"";if(s)try{const a=new URL(s,location.href);if(a.origin!==location.origin)continue;const h=(a.hash||a.pathname).match(/([^#?]+\.md)(?:$|[?#])/)||(a.pathname||"").match(/([^#?]+\.md)(?:$|[?#])/);if(h){let o=ue(h[1]);o&&r.add(o);continue}const l=a.pathname||"";if(l){const o=new URL(e),c=ht(o.pathname);if(l.indexOf(c)!==-1){let u=l.startsWith(c)?l.slice(c.length):l;u=ue(u),u&&r.add(u)}}}catch(a){console.warn("[router] malformed URL while discovering index candidates",a)}}for(const n of r)try{if(!n||!String(n).includes(".md"))continue;const s=await me(n,e);if(!s||!s.raw)continue;const a=(s.raw||"").match(/^#\s+(.+)$/m);if(a){const h=(a[1]||"").trim();if(h&&ne(h)===t)return n}}catch(s){console.warn("[router] fetchMarkdown during index discovery failed",s)}return null}function Xs(t){const e=[];if(String(t).includes(".md")||String(t).includes(".html"))/index\.html$/i.test(t)||e.push(t);else try{const r=decodeURIComponent(String(t||""));if(G.has(r)){const i=pt(r)||G.get(r);i&&(/\.(md|html?)$/i.test(i)?/index\.html$/i.test(i)||e.push(i):(e.push(i),e.push(i+".html")))}else{if(ze&&ze.size)for(const i of ze){const n=i.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(ne(n)===r&&!/index\.html$/i.test(i)){e.push(i);break}}!e.length&&r&&!/\.(md|html?)$/i.test(r)&&(e.push(r+".html"),e.push(r+".md"))}}catch(r){console.warn("[router] buildPageCandidates failed during slug handling",r)}return e}async function Ks(t,e){const r=t||"",i=location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null;let n=t||"",s=null;if(n&&String(n).includes("::")){const d=String(n).split("::",2);n=d[0],s=d[1]||null}const h=`${t}|||${typeof _s<"u"&&We?We:""}`,l=Zs(h);if(l)n=l.resolved,s=l.anchor||s;else{if(!String(n).includes(".md")&&!String(n).includes(".html")){let d=decodeURIComponent(String(n||""));if(d&&typeof d=="string"&&(d=ue(d),d=ut(d)),G.has(d))n=pt(d)||G.get(d);else{let m=await Gs(d,e);if(m)n=m;else if(on._refreshed&&ze&&ze.size||typeof e=="string"&&/^[a-z][a-z0-9+.-]*:\/\//i.test(e)){const w=await or(d,e);w&&(n=w)}}}Qs(h,{resolved:n,anchor:s})}!s&&i&&(s=i);const o=Xs(n),c=String(r||"").includes(".md")||String(r||"").includes(".html");if(c&&o.length===0&&(String(n).includes(".md")||String(n).includes(".html"))&&o.push(n),o.length===0&&(String(n).includes(".md")||String(n).includes(".html"))&&o.push(n),o.length===1&&/index\.html$/i.test(o[0])&&!c&&!G.has(n)&&!G.has(decodeURIComponent(String(n||"")))&&!String(n||"").includes("/"))throw new Error("Unknown slug: index.html fallback prevented");let u=null,f=null,p=null;for(const d of o)if(d)try{const m=ue(d);u=await me(m,e),f=m;break}catch(m){p=m;try{console.warn("[router] candidate fetch failed",{candidate:d,contentBase:e,err:m&&m.message||m})}catch{}}if(!u){try{console.error("[router] fetchPageData: no page data for",{originalRaw:r,resolved:n,pageCandidates:o,contentBase:e,fetchError:p&&(p.message||String(p))||null})}catch{}try{if(c&&String(r||"").toLowerCase().includes(".html"))try{const d=new URL(String(r||""),location.href).toString();console.warn("[router] attempting absolute HTML fetch fallback",d);const m=await fetch(d);if(m&&m.ok){const w=await m.text(),k=m&&m.headers&&typeof m.headers.get=="function"&&m.headers.get("content-type")||"",x=(w||"").toLowerCase(),P=k&&k.indexOf&&k.indexOf("text/html")!==-1||x.indexOf("<!doctype")!==-1||x.indexOf("<html")!==-1;if(P||console.warn("[router] absolute fetch returned non-HTML",{abs:d,contentType:k,snippet:x.slice(0,200)}),P)try{const E=d,N=new URL(".",E).toString();try{const W=typeof DOMParser<"u"?new DOMParser:null;if(W){const X=W.parseFromString(w||"","text/html"),K=($,L)=>{try{const S=L.getAttribute($)||"";if(!S||/^(https?:)?\/\//i.test(S)||S.startsWith("/")||S.startsWith("#"))return;try{const b=new URL(S,E).toString();L.setAttribute($,b)}catch{}}catch{}},re=X.querySelectorAll("[src],[href],[srcset],[xlink:href],[poster]"),I=[];for(const $ of Array.from(re||[]))try{const L=$.tagName?$.tagName.toLowerCase():"";if(L==="a")continue;if($.hasAttribute("src")){const S=$.getAttribute("src");K("src",$);const b=$.getAttribute("src");S!==b&&I.push({attr:"src",tag:L,before:S,after:b})}if($.hasAttribute("href")&&L==="link"){const S=$.getAttribute("href");K("href",$);const b=$.getAttribute("href");S!==b&&I.push({attr:"href",tag:L,before:S,after:b})}if($.hasAttribute("href")&&L!=="link"){const S=$.getAttribute("href");K("href",$);const b=$.getAttribute("href");S!==b&&I.push({attr:"href",tag:L,before:S,after:b})}if($.hasAttribute("xlink:href")){const S=$.getAttribute("xlink:href");K("xlink:href",$);const b=$.getAttribute("xlink:href");S!==b&&I.push({attr:"xlink:href",tag:L,before:S,after:b})}if($.hasAttribute("poster")){const S=$.getAttribute("poster");K("poster",$);const b=$.getAttribute("poster");S!==b&&I.push({attr:"poster",tag:L,before:S,after:b})}if($.hasAttribute("srcset")){const R=($.getAttribute("srcset")||"").split(",").map(y=>y.trim()).filter(Boolean).map(y=>{const[B,Y]=y.split(/\s+/,2);if(!B||/^(https?:)?\/\//i.test(B)||B.startsWith("/"))return y;try{const se=new URL(B,E).toString();return Y?`${se} ${Y}`:se}catch{return y}}).join(", ");$.setAttribute("srcset",R)}}catch{}const T=X.documentElement&&X.documentElement.outerHTML?X.documentElement.outerHTML:w;try{I&&I.length&&console.warn("[router] rewritten asset refs",{abs:d,rewritten:I})}catch{}return{data:{raw:T,isHtml:!0},pagePath:String(r||""),anchor:s}}}catch{}let M=w;return/<base\s+[^>]*>/i.test(w)||(/<head[^>]*>/i.test(w)?M=w.replace(/(<head[^>]*>)/i,`$1<base href="${N}">`):M=`<base href="${N}">`+w),{data:{raw:M,isHtml:!0},pagePath:String(r||""),anchor:s}}catch{return{data:{raw:w,isHtml:!0},pagePath:String(r||""),anchor:s}}}}catch(d){console.warn("[router] absolute HTML fetch fallback failed",d)}}catch{}throw new Error("no page data")}return{data:u,pagePath:f,anchor:s}}function fn(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Ye=fn();function pr(t){Ye=t}var Ve={exec:()=>null};function ee(t,e=""){let r=typeof t=="string"?t:t.source,i={replace:(n,s)=>{let a=typeof s=="string"?s:s.source;return a=a.replace(ve.caret,"$1"),r=r.replace(n,a),i},getRegex:()=>new RegExp(r,e)};return i}var Ys=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),ve={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:t=>new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}#`),htmlBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}>`)},Vs=/^(?:[ \t]*(?:\n|$))+/,Js=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,ei=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,bt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,ti=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,gn=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,fr=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,gr=ee(fr).replace(/bull/g,gn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),ni=ee(fr).replace(/bull/g,gn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),mn=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,ri=/^[^\n]+/,wn=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,si=ee(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",wn).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),ii=ee(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,gn).getRegex(),Nt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",bn=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ai=ee("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",bn).replace("tag",Nt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),mr=ee(mn).replace("hr",bt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Nt).getRegex(),li=ee(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",mr).getRegex(),yn={blockquote:li,code:Js,def:si,fences:ei,heading:ti,hr:bt,html:ai,lheading:gr,list:ii,newline:Vs,paragraph:mr,table:Ve,text:ri},wr=ee("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",bt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Nt).getRegex(),oi={...yn,lheading:ni,table:wr,paragraph:ee(mn).replace("hr",bt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",wr).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Nt).getRegex()},ci={...yn,html:ee(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",bn).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ve,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:ee(mn).replace("hr",bt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",gr).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},ui=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,hi=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,br=/^( {2,}|\\)\n(?!\s*$)/,di=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Dt=/[\p{P}\p{S}]/u,kn=/[\s\p{P}\p{S}]/u,yr=/[^\s\p{P}\p{S}]/u,pi=ee(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,kn).getRegex(),kr=/(?!~)[\p{P}\p{S}]/u,fi=/(?!~)[\s\p{P}\p{S}]/u,gi=/(?:[^\s\p{P}\p{S}]|~)/u,xr=/(?![*_])[\p{P}\p{S}]/u,mi=/(?![*_])[\s\p{P}\p{S}]/u,wi=/(?:[^\s\p{P}\p{S}]|[*_])/u,bi=ee(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Ys?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Sr=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,yi=ee(Sr,"u").replace(/punct/g,Dt).getRegex(),ki=ee(Sr,"u").replace(/punct/g,kr).getRegex(),vr="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",xi=ee(vr,"gu").replace(/notPunctSpace/g,yr).replace(/punctSpace/g,kn).replace(/punct/g,Dt).getRegex(),Si=ee(vr,"gu").replace(/notPunctSpace/g,gi).replace(/punctSpace/g,fi).replace(/punct/g,kr).getRegex(),vi=ee("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,yr).replace(/punctSpace/g,kn).replace(/punct/g,Dt).getRegex(),Ei=ee(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,xr).getRegex(),Ai="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",Ri=ee(Ai,"gu").replace(/notPunctSpace/g,wi).replace(/punctSpace/g,mi).replace(/punct/g,xr).getRegex(),Ti=ee(/\\(punct)/,"gu").replace(/punct/g,Dt).getRegex(),Ci=ee(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Li=ee(bn).replace("(?:-->|$)","-->").getRegex(),_i=ee("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Li).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Ht=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Mi=ee(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",Ht).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Er=ee(/^!?\[(label)\]\[(ref)\]/).replace("label",Ht).replace("ref",wn).getRegex(),Ar=ee(/^!?\[(ref)\](?:\[\])?/).replace("ref",wn).getRegex(),$i=ee("reflink|nolink(?!\\()","g").replace("reflink",Er).replace("nolink",Ar).getRegex(),Rr=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,xn={_backpedal:Ve,anyPunctuation:Ti,autolink:Ci,blockSkip:bi,br,code:hi,del:Ve,delLDelim:Ve,delRDelim:Ve,emStrongLDelim:yi,emStrongRDelimAst:xi,emStrongRDelimUnd:vi,escape:ui,link:Mi,nolink:Ar,punctuation:pi,reflink:Er,reflinkSearch:$i,tag:_i,text:di,url:Ve},Pi={...xn,link:ee(/^!?\[(label)\]\((.*?)\)/).replace("label",Ht).getRegex(),reflink:ee(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Ht).getRegex()},Sn={...xn,emStrongRDelimAst:Si,emStrongLDelim:ki,delLDelim:Ei,delRDelim:Ri,url:ee(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Rr).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:ee(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Rr).getRegex()},Ii={...Sn,br:ee(br).replace("{2,}","*").getRegex(),text:ee(Sn.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Ut={normal:yn,gfm:oi,pedantic:ci},yt={normal:xn,gfm:Sn,breaks:Ii,pedantic:Pi},zi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Tr=t=>zi[t];function Be(t,e){if(e){if(ve.escapeTest.test(t))return t.replace(ve.escapeReplace,Tr)}else if(ve.escapeTestNoEncode.test(t))return t.replace(ve.escapeReplaceNoEncode,Tr);return t}function Cr(t){try{t=encodeURI(t).replace(ve.percentDecode,"%")}catch{return null}return t}function Lr(t,e){let r=t.replace(ve.findPipe,(s,a,h)=>{let l=!1,o=a;for(;--o>=0&&h[o]==="\\";)l=!l;return l?"|":" |"}),i=r.split(ve.splitPipe),n=0;if(i[0].trim()||i.shift(),i.length>0&&!i.at(-1)?.trim()&&i.pop(),e)if(i.length>e)i.splice(e);else for(;i.length<e;)i.push("");for(;n<i.length;n++)i[n]=i[n].trim().replace(ve.slashPipe,"|");return i}function kt(t,e,r){let i=t.length;if(i===0)return"";let n=0;for(;n<i&&t.charAt(i-n-1)===e;)n++;return t.slice(0,i-n)}function Bi(t,e){if(t.indexOf(e[1])===-1)return-1;let r=0;for(let i=0;i<t.length;i++)if(t[i]==="\\")i++;else if(t[i]===e[0])r++;else if(t[i]===e[1]&&(r--,r<0))return i;return r>0?-2:-1}function Oi(t,e=0){let r=e,i="";for(let n of t)if(n==="	"){let s=4-r%4;i+=" ".repeat(s),r+=s}else i+=n,r++;return i}function _r(t,e,r,i,n){let s=e.href,a=e.title||null,h=t[1].replace(n.other.outputLinkReplace,"$1");i.state.inLink=!0;let l={type:t[0].charAt(0)==="!"?"image":"link",raw:r,href:s,title:a,text:h,tokens:i.inlineTokens(h)};return i.state.inLink=!1,l}function Ni(t,e,r){let i=t.match(r.other.indentCodeCompensation);if(i===null)return e;let n=i[1];return e.split(`
`).map(s=>{let a=s.match(r.other.beginningSpace);if(a===null)return s;let[h]=a;return h.length>=n.length?s.slice(n.length):s}).join(`
`)}var qt=class{options;rules;lexer;constructor(t){this.options=t||Ye}space(t){let e=this.rules.block.newline.exec(t);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(t){let e=this.rules.block.code.exec(t);if(e){let r=e[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?r:kt(r,`
...
`}strong({tokens:t}){return`<strong>${this.parser.parseInline(t)}</strong>`}em({tokens:t}){return`<em>${this.parser.parseInline(t)}</em>`}codespan({text:t}){return`<code>${Be(t,!0)}</code>`}br(t){return"<br>"}del({tokens:t}){return`<del>${this.parser.parseInline(t)}</del>`}link({href:t,title:e,tokens:r}){let i=this.parser.parseInline(r),n=Cr(t);if(n===null)return i;t=n;let s='<a href="'+t+'"';return e&&(s+=' title="'+Be(e)+'"'),s+=">"+i+"</a>",s}image({href:t,title:e,text:r,tokens:i}){i&&(r=this.parser.parseInline(i,this.parser.textRenderer));let n=Cr(t);if(n===null)return Be(r);t=n;let s=`<img src="${t}" alt="${Be(r)}"`;return e&&(s+=` title="${Be(e)}"`),s+=">",s}text(t){return"tokens"in t&&t.tokens?this.parser.parseInline(t.tokens):"escaped"in t&&t.escaped?t.text:Be(t.text)}},vn=class{strong({text:t}){return t}em({text:t}){return t}codespan({text:t}){return t}del({text:t}){return t}html({text:t}){return t}text({text:t}){return t}link({text:t}){return""+t}image({text:t}){return""+t}br(){return""}checkbox({raw:t}){return t}},Pe=class qn{options;renderer;textRenderer;constructor(e){this.options=e||Ye,this.options.renderer=this.options.renderer||new jt,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new vn}static parse(e,r){return new qn(r).parse(e)}static parseInline(e,r){return new qn(r).parseInline(e)}parse(e){let r="";for(let i=0;i<e.length;i++){let n=e[i];if(this.options.extensions?.renderers?.[n.type]){let a=n,h=this.options.extensions.renderers[a.type].call({parser:this},a);if(h!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(a.type)){r+=h||"";continue}}let s=n;switch(s.type){case"space":{r+=this.renderer.space(s);break}case"hr":{r+=this.renderer.hr(s);break}case"heading":{r+=this.renderer.heading(s);break}case"code":{r+=this.renderer.code(s);break}case"table":{r+=this.renderer.table(s);break}case"blockquote":{r+=this.renderer.blockquote(s);break}case"list":{r+=this.renderer.list(s);break}case"checkbox":{r+=this.renderer.checkbox(s);break}case"html":{r+=this.renderer.html(s);break}case"def":{r+=this.renderer.def(s);break}case"paragraph":{r+=this.renderer.paragraph(s);break}case"text":{r+=this.renderer.text(s);break}default:{let a='Token with "'+s.type+'" type was not found.';if(this.options.silent)return console.error(a),"";throw new Error(a)}}}return r}parseInline(e,r=this.renderer){let i="";for(let n=0;n<e.length;n++){let s=e[n];if(this.options.extensions?.renderers?.[s.type]){let h=this.options.extensions.renderers[s.type].call({parser:this},s);if(h!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(s.type)){i+=h||"";continue}}let a=s;switch(a.type){case"escape":{i+=r.text(a);break}case"html":{i+=r.html(a);break}case"link":{i+=r.link(a);break}case"image":{i+=r.image(a);break}case"checkbox":{i+=r.checkbox(a);break}case"strong":{i+=r.strong(a);break}case"em":{i+=r.em(a);break}case"codespan":{i+=r.codespan(a);break}case"br":{i+=r.br(a);break}case"del":{i+=r.del(a);break}case"text":{i+=r.text(a);break}default:{let h='Token with "'+a.type+'" type was not found.';if(this.options.silent)return console.error(h),"";throw new Error(h)}}}return i}},xt=class{options;block;constructor(t){this.options=t||Ye}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens","emStrongMask"]);static passThroughHooksRespectAsync=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(t){return t}postprocess(t){return t}processAllTokens(t){return t}emStrongMask(t){return t}provideLexer(){return this.block?$e.lex:$e.lexInline}provideParser(){return this.block?Pe.parse:Pe.parseInline}},Di=class{defaults=fn();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=Pe;Renderer=jt;TextRenderer=vn;Lexer=$e;Tokenizer=qt;Hooks=xt;constructor(...t){this.use(...t)}walkTokens(t,e){let r=[];for(let i of t)switch(r=r.concat(e.call(this,i)),i.type){case"table":{let n=i;for(let s of n.header)r=r.concat(this.walkTokens(s.tokens,e));for(let s of n.rows)for(let a of s)r=r.concat(this.walkTokens(a.tokens,e));break}case"list":{let n=i;r=r.concat(this.walkTokens(n.items,e));break}default:{let n=i;this.defaults.extensions?.childTokens?.[n.type]?this.defaults.extensions.childTokens[n.type].forEach(s=>{let a=n[s].flat(1/0);r=r.concat(this.walkTokens(a,e))}):n.tokens&&(r=r.concat(this.walkTokens(n.tokens,e)))}}return r}use(...t){let e=this.defaults.extensions||{renderers:{},childTokens:{}};return t.forEach(r=>{let i={...r};if(i.async=this.defaults.async||i.async||!1,r.extensions&&(r.extensions.forEach(n=>{if(!n.name)throw new Error("extension name required");if("renderer"in n){let s=e.renderers[n.name];s?e.renderers[n.name]=function(...a){let h=n.renderer.apply(this,a);return h===!1&&(h=s.apply(this,a)),h}:e.renderers[n.name]=n.renderer}if("tokenizer"in n){if(!n.level||n.level!=="block"&&n.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let s=e[n.level];s?s.unshift(n.tokenizer):e[n.level]=[n.tokenizer],n.start&&(n.level==="block"?e.startBlock?e.startBlock.push(n.start):e.startBlock=[n.start]:n.level==="inline"&&(e.startInline?e.startInline.push(n.start):e.startInline=[n.start]))}"childTokens"in n&&n.childTokens&&(e.childTokens[n.name]=n.childTokens)}),i.extensions=e),r.renderer){let n=this.defaults.renderer||new jt(this.defaults);for(let s in r.renderer){if(!(s in n))throw new Error(`renderer '${s}' does not exist`);if(["options","parser"].includes(s))continue;let a=s,h=r.renderer[a],l=n[a];n[a]=(...o)=>{let c=h.apply(n,o);return c===!1&&(c=l.apply(n,o)),c||""}}i.renderer=n}if(r.tokenizer){let n=this.defaults.tokenizer||new qt(this.defaults);for(let s in r.tokenizer){if(!(s in n))throw new Error(`tokenizer '${s}' does not exist`);if(["options","rules","lexer"].includes(s))continue;let a=s,h=r.tokenizer[a],l=n[a];n[a]=(...o)=>{let c=h.apply(n,o);return c===!1&&(c=l.apply(n,o)),c}}i.tokenizer=n}if(r.hooks){let n=this.defaults.hooks||new xt;for(let s in r.hooks){if(!(s in n))throw new Error(`hook '${s}' does not exist`);if(["options","block"].includes(s))continue;let a=s,h=r.hooks[a],l=n[a];xt.passThroughHooks.has(s)?n[a]=o=>{if(this.defaults.async&&xt.passThroughHooksRespectAsync.has(s))return(async()=>{let u=await h.call(n,o);return l.call(n,u)})();let c=h.call(n,o);return l.call(n,c)}:n[a]=(...o)=>{if(this.defaults.async)return(async()=>{let u=await h.apply(n,o);return u===!1&&(u=await l.apply(n,o)),u})();let c=h.apply(n,o);return c===!1&&(c=l.apply(n,o)),c}}i.hooks=n}if(r.walkTokens){let n=this.defaults.walkTokens,s=r.walkTokens;i.walkTokens=function(a){let h=[];return h.push(s.call(this,a)),n&&(h=h.concat(n.call(this,a))),h}}this.defaults={...this.defaults,...i}}),this}setOptions(t){return this.defaults={...this.defaults,...t},this}lexer(t,e){return $e.lex(t,e??this.defaults)}parser(t,e){return Pe.parse(t,e??this.defaults)}parseMarkdown(t){return(e,r)=>{let i={...r},n={...this.defaults,...i},s=this.onError(!!n.silent,!!n.async);if(this.defaults.async===!0&&i.async===!1)return s(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof e>"u"||e===null)return s(new Error("marked(): input parameter is undefined or null"));if(typeof e!="string")return s(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected"));if(n.hooks&&(n.hooks.options=n,n.hooks.block=t),n.async)return(async()=>{let a=n.hooks?await n.hooks.preprocess(e):e,h=await(n.hooks?await n.hooks.provideLexer():t?$e.lex:$e.lexInline)(a,n),l=n.hooks?await n.hooks.processAllTokens(h):h;n.walkTokens&&await Promise.all(this.walkTokens(l,n.walkTokens));let o=await(n.hooks?await n.hooks.provideParser():t?Pe.parse:Pe.parseInline)(l,n);return n.hooks?await n.hooks.postprocess(o):o})().catch(s);try{n.hooks&&(e=n.hooks.preprocess(e));let a=(n.hooks?n.hooks.provideLexer():t?$e.lex:$e.lexInline)(e,n);n.hooks&&(a=n.hooks.processAllTokens(a)),n.walkTokens&&this.walkTokens(a,n.walkTokens);let h=(n.hooks?n.hooks.provideParser():t?Pe.parse:Pe.parseInline)(a,n);return n.hooks&&(h=n.hooks.postprocess(h)),h}catch(a){return s(a)}}}onError(t,e){return r=>{if(r.message+=`
Please report this to https://github.com/markedjs/marked.`,t){let i="<p>An error occurred:</p><pre>"+Be(r.message+"",!0)+"</pre>";return e?Promise.resolve(i):i}if(e)return Promise.reject(r);throw r}}},Je=new Di;function te(t,e){return Je.parse(t,e)}te.options=te.setOptions=function(t){return Je.setOptions(t),te.defaults=Je.defaults,pr(te.defaults),te},te.getDefaults=fn,te.defaults=Ye,te.use=function(...t){return Je.use(...t),te.defaults=Je.defaults,pr(te.defaults),te},te.walkTokens=function(t,e){return Je.walkTokens(t,e)},te.parseInline=Je.parseInline,te.Parser=Pe,te.parser=Pe.parse,te.Renderer=jt,te.TextRenderer=vn,te.Lexer=$e,te.lexer=$e.lex,te.Tokenizer=qt,te.Hooks=xt,te.parse=te,te.options,te.setOptions,te.use,te.walkTokens,te.parseInline,Pe.parse,$e.lex;const Mr=`function j() {
...
`;for(let w=l;w<=o;w++)if((e(f[w])||!u(f[w])&&(u(f[w+1])||e(f[w+1])))&&h++,e(f[w]))for(;w<=o&&(i(f[w+1])||u(f[w+1]));)w++;const p=h/c,d=Math.round(p*60*1e3);return{text:Math.ceil(p.toFixed(2))+" min read",minutes:p,time:d,words:h}}return Mn=n,Mn}var ia=sa();const aa=jn(ia);function qr(t,e){let r=document.querySelector(`meta[name="${t}"]`);r||(r=document.createElement("meta"),r.setAttribute("name",t),document.head.appendChild(r)),r.setAttribute("content",e)}function lt(t,e,r){let i=`meta[${t}="${e}"]`,n=document.querySelector(i);n||(n=document.createElement("meta"),n.setAttribute(t,e),document.head.appendChild(n)),n.setAttribute("content",r)}function la(t,e){try{let r=document.querySelector(`link[rel="${t}"]`);r||(r=document.createElement("link"),r.setAttribute("rel",t),document.head.appendChild(r)),r.setAttribute("href",e)}catch(r){console.warn("[seoManager] upsertLinkRel failed",r)}}function oa(t,e,r,i){const n=e&&String(e).trim()?e:t.title||document.title;lt("property","og:title",n);const s=i&&String(i).trim()?i:t.description||"";s&&String(s).trim()&&lt("property","og:description",s),lt("name","twitter:card",t.twitter_card||"summary_large_image");const a=r||t.image;a&&(lt("property","og:image",a),lt("name","twitter:image",a))}function ca(t,e,r,i,n=""){const s=t.meta||{},a=document&&document.querySelector&&document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",h=i&&String(i).trim()?i:s.description&&String(s.description).trim()?s.description:a&&String(a).trim()?a:"";h&&String(h).trim()&&qr("description",h),qr("robots",s.robots||"index,follow"),oa(s,e,r,h)}function ua(){try{const t=['meta[name="site"]','meta[name="site-name"]','meta[name="siteName"]','meta[property="og:site_name"]','meta[name="twitter:site"]'];for(const e of t){const r=document.querySelector(e);if(r){const i=r.getAttribute("content")||"";if(i&&i.trim())return i.trim()}}}catch(t){console.warn("[seoManager] getSiteNameFromMeta failed",t)}return""}function ha(t,e,r,i,n,s=""){try{const a=t.meta||{},h=r&&String(r).trim()?r:a.title||s||document.title,l=n&&String(n).trim()?n:a.description||document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",o=i||a.image||null;let c="";try{if(e){const d=ue(e);try{c=(location.origin+location.pathname).split("?")[0]+"?page="+encodeURIComponent(d)}catch{c=location.href.split("#")[0]}}else c=location.href.split("#")[0]}catch(d){c=location.href.split("#")[0],console.warn("[seoManager] compute canonical failed",d)}c&&la("canonical",c);try{lt("property","og:url",c)}catch(d){console.warn("[seoManager] upsertMeta og:url failed",d)}const u={"@context":"https://schema.org","@type":"Article",headline:h||"",description:l||"",url:c||location.href.split("#")[0]};o&&(u.image=String(o)),a.date&&(u.datePublished=a.date),a.dateModified&&(u.dateModified=a.dateModified);const f="nimbi-jsonld";let p=document.getElementById(f);p||(p=document.createElement("script"),p.type="application/ld+json",p.id=f,document.head.appendChild(p)),p.textContent=JSON.stringify(u,null,2)}catch(a){console.warn("[seoManager] setStructuredData failed",a)}}function da(t,e,r,i,n,s,a,h,l,o,c){try{const u=i.querySelector(".menu-label");u&&(u.textContent=h&&h.textContent||t("onThisPage"))}catch(u){console.warn("[seoManager] update toc label failed",u)}try{const u=r.meta&&r.meta.title?String(r.meta.title).trim():"",f=n.querySelector("img"),p=f&&(f.getAttribute("src")||f.src)||null;let d="";try{let w="";try{const k=h||(n&&n.querySelector?n.querySelector("h1"):null);if(k){let x=k.nextElementSibling;const P=[];for(;x&&!(x.tagName&&x.tagName.toLowerCase()==="h2");){const E=(x.textContent||"").trim();E&&P.push(E),x=x.nextElementSibling}P.length&&(w=P.join(" ").replace(/\s+/g," ").trim()),!w&&l&&(w=String(l).trim())}}catch(k){console.warn("[seoManager] compute descOverride failed",k)}w&&String(w).length>160&&(w=String(w).slice(0,157).trim()+"..."),d=w}catch(w){console.warn("[seoManager] compute descOverride failed",w)}try{ca(r,l,p,d)}catch(w){console.warn("[seoManager] setMetaTags failed",w)}try{ha(r,o,l,p,d,e)}catch(w){console.warn("[seoManager] setStructuredData failed",w)}const m=ua();l?m?document.title=`${m} - ${l}`:document.title=`${e||"Site"} - ${l}`:u?document.title=u:document.title=e||document.title}catch(u){console.warn("[seoManager] applyPageMeta failed",u)}try{const u=n.querySelector(".nimbi-reading-time");if(u&&u.remove(),l){const f=aa(c.raw||""),p=f&&typeof f.minutes=="number"?Math.ceil(f.minutes):0,d=document.createElement("p");d.className="nimbi-reading-time",d.textContent=p?t("readingTime",{minutes:p}):"";const m=n.querySelector("h1");m&&m.insertAdjacentElement("afterend",d)}}catch(u){console.warn("[seoManager] reading time update failed",u)}}let ye=null,j=null,ke=1,Ge=(t,e)=>e,St=0,vt=0,Wt=()=>{},Et=.25;function pa(){if(ye&&document.contains(ye))return ye;ye=null;const t=document.createElement("dialog");t.className="nimbi-image-preview",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label",Ge("imagePreviewTitle","Image preview")),t.innerHTML=`
  ...
  `,t.addEventListener("click",b=>{b.target===t&&$n()}),t.addEventListener("wheel",b=>{if(!re())return;b.preventDefault();const R=b.deltaY<0?Et:-Et;Ue(ke+R),o(),c()},{passive:!1}),t.addEventListener("keydown",b=>{if(b.key==="Escape"){$n();return}if(ke>1){const R=t.querySelector(".nimbi-image-preview__image-wrapper");if(!R)return;const y=40;switch(b.key){case"ArrowUp":R.scrollTop-=y,b.preventDefault();break;case"ArrowDown":R.scrollTop+=y,b.preventDefault();break;case"ArrowLeft":R.scrollLeft-=y,b.preventDefault();break;case"ArrowRight":R.scrollLeft+=y,b.preventDefault();break}}}),document.body.appendChild(t),ye=t,j=t.querySelector("[data-nimbi-preview-image]");const e=t.querySelector("[data-nimbi-preview-fit]"),r=t.querySelector("[data-nimbi-preview-original]"),i=t.querySelector("[data-nimbi-preview-zoom-in]"),n=t.querySelector("[data-nimbi-preview-zoom-out]"),s=t.querySelector("[data-nimbi-preview-reset]"),a=t.querySelector("[data-nimbi-preview-close]"),h=t.querySelector("[data-nimbi-preview-zoom-label]"),l=t.querySelector("[data-nimbi-preview-zoom-hud]");function o(){h&&(h.textContent=`${Math.round(ke*100)}%`)}const c=()=>{l&&(l.textContent=`${Math.round(ke*100)}%`,l.classList.add("visible"),clearTimeout(l._timeout),l._timeout=setTimeout(()=>l.classList.remove("visible"),800))};Wt=o,i.addEventListener("click",()=>{Ue(ke+Et),o(),c()}),n.addEventListener("click",()=>{Ue(ke-Et),o(),c()}),e.addEventListener("click",()=>{At(),o(),c()}),r.addEventListener("click",()=>{Ue(1),o(),c()}),s.addEventListener("click",()=>{At(),o(),c()}),a.addEventListener("click",$n),e.title=Ge("imagePreviewFit","Fit to screen"),r.title=Ge("imagePreviewOriginal","Original size"),n.title=Ge("imagePreviewZoomOut","Zoom out"),i.title=Ge("imagePreviewZoomIn","Zoom in"),a.title=Ge("imagePreviewClose","Close"),a.setAttribute("aria-label",Ge("imagePreviewClose","Close"));let u=!1,f=0,p=0,d=0,m=0;const w=new Map;let k=0,x=1;const P=(b,R)=>{const y=b.x-R.x,B=b.y-R.y;return Math.hypot(y,B)},E=()=>{u=!1,w.clear(),k=0,j&&(j.style.cursor="all-scroll")};let N=0,M=0,W=0;const X=b=>{const R=Date.now(),y=R-N,B=b.clientX-M,Y=b.clientY-W;N=R,M=b.clientX,W=b.clientY,y<300&&Math.hypot(B,Y)<30&&(Ue(ke>1?1:2),o(),b.preventDefault())},K=b=>{Ue(ke>1?1:2),o(),b.preventDefault()},re=()=>ye?typeof ye.open=="boolean"?ye.open:ye.classList.contains("is-active"):!1,I=(b,R,y=1)=>{if(w.has(y)&&w.set(y,{x:b,y:R}),w.size===2){const Ce=Array.from(w.values()),Ee=P(Ce[0],Ce[1]);if(k>0){const xe=Ee/k;Ue(x*xe)}return}if(!u)return;const B=j.closest(".nimbi-image-preview__image-wrapper");if(!B)return;const Y=b-f,se=R-p;B.scrollLeft=d-Y,B.scrollTop=m-se},T=(b,R,y=1)=>{if(!re())return;if(w.set(y,{x:b,y:R}),w.size===2){const se=Array.from(w.values());k=P(se[0],se[1]),x=ke;return}const B=j.closest(".nimbi-image-preview__image-wrapper");!B||!(B.scrollWidth>B.clientWidth||B.scrollHeight>B.clientHeight)||(u=!0,f=b,p=R,d=B.scrollLeft,m=B.scrollTop,j.style.cursor="all-scroll",window.addEventListener("pointermove",$),window.addEventListener("pointerup",L),window.addEventListener("pointercancel",L))},$=b=>{u&&(b.preventDefault(),I(b.clientX,b.clientY,b.pointerId))},L=()=>{E(),window.removeEventListener("pointermove",$),window.removeEventListener("pointerup",L),window.removeEventListener("pointercancel",L)};j.addEventListener("pointerdown",b=>{b.preventDefault(),T(b.clientX,b.clientY,b.pointerId)}),j.addEventListener("pointermove",b=>{(u||w.size===2)&&b.preventDefault(),I(b.clientX,b.clientY,b.pointerId)}),j.addEventListener("pointerup",b=>{b.preventDefault(),b.pointerType==="touch"&&X(b),E()}),j.addEventListener("dblclick",K),j.addEventListener("pointercancel",E),j.addEventListener("mousedown",b=>{b.preventDefault(),T(b.clientX,b.clientY,1)}),j.addEventListener("mousemove",b=>{u&&b.preventDefault(),I(b.clientX,b.clientY,1)}),j.addEventListener("mouseup",b=>{b.preventDefault(),E()});const S=t.querySelector(".nimbi-image-preview__image-wrapper");return S&&(S.addEventListener("pointerdown",b=>{T(b.clientX,b.clientY,b.pointerId)}),S.addEventListener("pointermove",b=>{I(b.clientX,b.clientY,b.pointerId)}),S.addEventListener("pointerup",E),S.addEventListener("pointercancel",E),S.addEventListener("mousedown",b=>{T(b.clientX,b.clientY,1)}),S.addEventListener("mousemove",b=>{I(b.clientX,b.clientY,1)}),S.addEventListener("mouseup",E)),t}function Ue(t){if(!j)return;const e=Number(t);ke=Number.isFinite(e)?Math.max(.1,Math.min(4,e)):1;const i=j.getBoundingClientRect(),n=St||j.naturalWidth||j.width||i.width||0,s=vt||j.naturalHeight||j.height||i.height||0;n&&s?(j.style.maxWidth="none",j.style.maxHeight="none",j.style.width=`${n*ke}px`,j.style.height=`${s*ke}px`,j.style.transform=""):(j.style.maxWidth="",j.style.maxHeight="",j.style.width="",j.style.height="",j.style.transform=`scale(${ke})`),j&&(j.style.cursor="all-scroll")}function At(){if(!j)return;const t=j.closest(".nimbi-image-preview__image-wrapper");if(!t)return;const e=t.getBoundingClientRect();if(e.width===0||e.height===0)return;const r=St||j.naturalWidth||e.width,i=vt||j.naturalHeight||e.height;if(!r||!i)return;const n=e.width/r,s=e.height/i,a=Math.min(n,s,1);Ue(Number.isFinite(a)?a:1)}function fa(t,e="",r=0,i=0){const n=pa();ke=1,St=r||0,vt=i||0,j.src=t,j.alt=e,j.style.transform="scale(1)";const s=()=>{St=j.naturalWidth||j.width||0,vt=j.naturalHeight||j.height||0};if(s(),At(),Wt(),requestAnimationFrame(()=>{At(),Wt()}),!St||!vt){const a=()=>{s(),requestAnimationFrame(()=>{At(),Wt()}),j.removeEventListener("load",a)};j.addEventListener("load",a)}typeof n.showModal=="function"&&(n.open||n.showModal()),n.classList.add("is-active"),n.focus()}function $n(){ye&&(typeof ye.close=="function"&&ye.open&&ye.close(),ye.classList.remove("is-active"))}function ga(t,{t:e,zoomStep:r=.25}={}){if(!t||!t.querySelectorAll)return;Ge=(p,d)=>(typeof e=="function"?e(p):void 0)||d,Et=r,t.addEventListener("click",p=>{const d=p.target;if(!d||d.tagName!=="IMG")return;const m=d;if(m.src){if(p.defaultPrevented!==!0){const w=m.closest("a");w&&w.getAttribute("href")&&p.preventDefault()}fa(m.src,m.alt||"",m.naturalWidth||0,m.naturalHeight||0)}});let i=!1,n=0,s=0,a=0,h=0;const l=new Map;let o=0,c=1;const u=(p,d)=>{const m=p.x-d.x,w=p.y-d.y;return Math.hypot(m,w)};t.addEventListener("pointerdown",p=>{const d=p.target;if(!d||d.tagName!=="IMG"||!ye||!ye.open)return;if(l.set(p.pointerId,{x:p.clientX,y:p.clientY}),l.size===2){const w=Array.from(l.values());o=u(w[0],w[1]),c=ke;return}const m=d.closest(".nimbi-image-preview__image-wrapper");m&&(ke<=1||(p.preventDefault(),i=!0,n=p.clientX,s=p.clientY,a=m.scrollLeft,h=m.scrollTop,d.setPointerCapture(p.pointerId),d.style.cursor="grabbing"))}),t.addEventListener("pointermove",p=>{if(l.has(p.pointerId)&&l.set(p.pointerId,{x:p.clientX,y:p.clientY}),l.size===2){p.preventDefault();const x=Array.from(l.values()),P=u(x[0],x[1]);if(o>0){const E=P/o;Ue(c*E)}return}if(!i)return;p.preventDefault();const m=p.target.closest(".nimbi-image-preview__image-wrapper");if(!m)return;const w=p.clientX-n,k=p.clientY-s;m.scrollLeft=a-w,m.scrollTop=h-k});const f=()=>{i=!1,l.clear(),o=0};t.addEventListener("pointerup",f),t.addEventListener("pointercancel",f)}function ma(t){const{contentWrap:e,navWrap:r,container:i,mountOverlay:n=null,t:s,contentBase:a,homePage:h,initialDocumentTitle:l,runHooks:o}=t||{};if(!e||!(e instanceof HTMLElement))throw new TypeError("contentWrap must be an HTMLElement");let c=null;const u=Wi(s,[{path:h,name:s("home"),isIndex:!0,children:[]}]);async function f(k,x){let P,E,N;try{({data:P,pagePath:E,anchor:N}=await Ks(k,a))}catch(T){console.error("[nimbi-cms] fetchPageData failed",T),Hr(e,s,T);return}!N&&x&&(N=x);try{_n(null)}catch(T){console.warn("[nimbi-cms] scrollToAnchorOrTop failed",T)}e.innerHTML="";const{article:M,parsed:W,toc:X,topH1:K,h1Text:re,slugKey:I}=await Ji(s,P,E,N,a);da(s,l,W,X,M,E,N,K,re,I,P),r.innerHTML="",r.appendChild(X),ta(X);try{await o("transformHtml",{article:M,parsed:W,toc:X,pagePath:E,anchor:N,topH1:K,h1Text:re,slugKey:I,data:P})}catch(T){console.warn("[nimbi-cms] transformHtml hooks failed",T)}e.appendChild(M);try{ga(M,{t:s})}catch(T){console.warn("[nimbi-cms] attachImagePreview failed",T)}try{_t(i,100,!1),requestAnimationFrame(()=>_t(i,100,!1)),setTimeout(()=>_t(i,100,!1),250)}catch(T){console.warn("[nimbi-cms] setEagerForAboveFoldImages failed",T)}_n(N),na(M,K,{mountOverlay:n,container:i,navWrap:r,t:s});try{await o("onPageLoad",{data:P,pagePath:E,anchor:N,article:M,toc:X,topH1:K,h1Text:re,slugKey:I,contentWrap:e,navWrap:r})}catch(T){console.warn("[nimbi-cms] onPageLoad hooks failed",T)}c=E}async function p(){let k=new URLSearchParams(location.search).get("page")||h;const x=location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null;try{await f(k,x)}catch(P){console.warn("[nimbi-cms] renderByQuery failed for",k,P),Hr(e,s,P)}}window.addEventListener("popstate",p);const d=()=>`nimbi-cms-scroll:${location.pathname}${location.search}`,m=()=>{try{const k=i||document.querySelector(".nimbi-cms");if(!k)return;const x={top:k.scrollTop||0,left:k.scrollLeft||0};sessionStorage.setItem(d(),JSON.stringify(x))}catch{}},w=()=>{try{const k=i||document.querySelector(".nimbi-cms");if(!k)return;const x=sessionStorage.getItem(d());if(!x)return;const P=JSON.parse(x);P&&typeof P.top=="number"&&k.scrollTo({top:P.top,left:P.left||0,behavior:"auto"})}catch{}};return window.addEventListener("pageshow",k=>{if(k.persisted)try{w(),_t(i,100,!1)}catch(x){console.warn("[nimbi-cms] bfcache restore failed",x)}}),window.addEventListener("pagehide",()=>{try{m()}catch(k){console.warn("[nimbi-cms] save scroll position failed",k)}}),{renderByQuery:p,siteNav:u,getCurrentPagePath:()=>c}}function wa(t){try{const e=typeof t=="string"?t:typeof window<"u"&&window.location?window.location.search:"";if(!e)return{};const r=new URLSearchParams(e.startsWith("?")?e.slice(1):e),i={},n=s=>{if(s==null)return;const a=String(s).toLowerCase();if(a==="1"||a==="true"||a==="yes")return!0;if(a==="0"||a==="false"||a==="no")return!1};if(r.has("contentPath")&&(i.contentPath=r.get("contentPath")),r.has("searchIndex")){const s=n(r.get("searchIndex"));typeof s=="boolean"&&(i.searchIndex=s)}if(r.has("searchIndexMode")){const s=r.get("searchIndexMode");(s==="eager"||s==="lazy")&&(i.searchIndexMode=s)}if(r.has("defaultStyle")){const s=r.get("defaultStyle");(s==="light"||s==="dark")&&(i.defaultStyle=s)}if(r.has("bulmaCustomize")&&(i.bulmaCustomize=r.get("bulmaCustomize")),r.has("lang")&&(i.lang=r.get("lang")),r.has("l10nFile")){const s=r.get("l10nFile");i.l10nFile=s==="null"?null:s}if(r.has("cacheTtlMinutes")){const s=Number(r.get("cacheTtlMinutes"));Number.isFinite(s)&&s>=0&&(i.cacheTtlMinutes=s)}if(r.has("cacheMaxEntries")){const s=Number(r.get("cacheMaxEntries"));Number.isInteger(s)&&s>=0&&(i.cacheMaxEntries=s)}if(r.has("homePage")&&(i.homePage=r.get("homePage")),r.has("notFoundPage")&&(i.notFoundPage=r.get("notFoundPage")),r.has("availableLanguages")&&(i.availableLanguages=r.get("availableLanguages").split(",").map(s=>s.trim()).filter(Boolean)),r.has("indexDepth")){const s=Number(r.get("indexDepth"));Number.isInteger(s)&&(s===1||s===2||s===3)&&(i.indexDepth=s)}if(r.has("noIndexing")){const a=(r.get("noIndexing")||"").split(",").map(h=>h.trim()).filter(Boolean);a.length&&(i.noIndexing=a)}return i}catch{return{}}}function ba(t){return!(typeof t!="string"||!t.trim()||t.includes("..")||/^[a-zA-Z][a-zA-Z0-9+.-]*:\/\//.test(t)||t.startsWith("//")||t.startsWith("/")||/^[A-Za-z]:\\/.test(t))}function jr(t){if(typeof t!="string")return!1;const e=t.trim();return!(!e||e.includes("/")||e.includes("\\")||e.includes("..")||!/^[A-Za-z0-9._-]+\.(md|html)$/.test(e))}let Pn="";async function ya(t={}){if(!t||typeof t!="object")throw new TypeError("initCMS(options): options must be an object");const e=wa();if(e&&(e.contentPath||e.homePage||e.notFoundPage))if(t&&t.allowUrlPathOverrides===!0)try{console.warn("[nimbi-cms] allowUrlPathOverrides enabled by host; honoring URL overrides for contentPath/homePage/notFoundPage")}catch(y){console.warn("[nimbi-cms] allowUrlPathOverrides logging failed",y)}else{try{console.warn("[nimbi-cms] ignoring unsafe URL overrides for contentPath/homePage/notFoundPage")}catch(y){console.warn("[nimbi-cms] logging ignore of URL overrides failed",y)}delete e.contentPath,delete e.homePage,delete e.notFoundPage}const r=Object.assign({},e,t),{el:i,contentPath:n="/content",crawlMaxQueue:s=1e3,searchIndex:a=!0,searchIndexMode:h="eager",indexDepth:l=1,noIndexing:o=void 0,defaultStyle:c="light",bulmaCustomize:u="none",lang:f=void 0,l10nFile:p=null,cacheTtlMinutes:d=5,cacheMaxEntries:m,markdownExtensions:w,availableLanguages:k,homePage:x="_home.md",notFoundPage:P="_404.md"}=r;if(r.contentPath!=null&&!ba(r.contentPath))throw new TypeError('initCMS(options): "contentPath" contains unsafe characters or patterns');if(r.homePage!=null&&!jr(r.homePage))throw new TypeError('initCMS(options): "homePage" must be a simple basename ending with .md or .html');if(r.notFoundPage!=null&&!jr(r.notFoundPage))throw new TypeError('initCMS(options): "notFoundPage" must be a simple basename ending with .md or .html');if(!i)throw new Error("el is required");let E=i;if(typeof i=="string"){if(E=document.querySelector(i),!E)throw new Error(`el selector "${i}" did not match any element`)}else if(!(i instanceof Element))throw new TypeError("el must be a CSS selector string or a DOM element");if(typeof n!="string"||!n.trim())throw new TypeError('initCMS(options): "contentPath" must be a non-empty string when provided');if(typeof a!="boolean")throw new TypeError('initCMS(options): "searchIndex" must be a boolean when provided');if(h!=null&&h!=="eager"&&h!=="lazy")throw new TypeError('initCMS(options): "searchIndexMode" must be "eager" or "lazy" when provided');if(l!=null&&l!==1&&l!==2&&l!==3)throw new TypeError('initCMS(options): "indexDepth" must be 1, 2, or 3 when provided');if(c!=="light"&&c!=="dark")throw new TypeError('initCMS(options): "defaultStyle" must be "light" or "dark"');if(u!=null&&typeof u!="string")throw new TypeError('initCMS(options): "bulmaCustomize" must be a string when provided');if(f!=null&&typeof f!="string")throw new TypeError('initCMS(options): "lang" must be a string when provided');if(p!=null&&typeof p!="string")throw new TypeError('initCMS(options): "l10nFile" must be a string or null when provided');if(d!=null&&(typeof d!="number"||!Number.isFinite(d)||d<0))throw new TypeError('initCMS(options): "cacheTtlMinutes" must be a non‑negative number when provided');if(m!=null&&(typeof m!="number"||!Number.isInteger(m)||m<0))throw new TypeError('initCMS(options): "cacheMaxEntries" must be a non‑negative integer when provided');if(w!=null&&(!Array.isArray(w)||w.some(y=>!y||typeof y!="object")))throw new TypeError('initCMS(options): "markdownExtensions" must be an array of extension objects when provided');if(k!=null&&(!Array.isArray(k)||k.some(y=>typeof y!="string"||!y.trim())))throw new TypeError('initCMS(options): "availableLanguages" must be an array of non-empty strings when provided');if(o!=null&&(!Array.isArray(o)||o.some(y=>typeof y!="string"||!y.trim())))throw new TypeError('initCMS(options): "noIndexing" must be an array of non-empty strings when provided');if(x!=null&&(typeof x!="string"||!x.trim()||!/\.(md|html)$/.test(x)))throw new TypeError('initCMS(options): "homePage" must be a non-empty string ending with .md or .html');if(P!=null&&(typeof P!="string"||!P.trim()||!/\.(md|html)$/.test(P)))throw new TypeError('initCMS(options): "notFoundPage" must be a non-empty string ending with .md or .html');const N=!!a;try{E.classList.add("nimbi-mount"),E.style.position=E.style.position||"relative",E.style.overflow=E.style.overflow||"hidden"}catch(y){console.warn("[nimbi-cms] mount element setup failed",y)}const M=document.createElement("div");M.className="nimbi-cms";try{M.style.position=M.style.position||"relative",M.style.overflow=M.style.overflow||"auto";try{M.style.webkitOverflowScrolling||(M.style.webkitOverflowScrolling="touch")}catch(y){console.warn("[nimbi-cms] set container webkitOverflowScrolling failed",y)}M.style.width=M.style.width||"100%",M.style.height=M.style.height||"100%",M.style.boxSizing=M.style.boxSizing||"border-box"}catch(y){console.warn("[nimbi-cms] container style setup failed",y)}const W=document.createElement("div");W.className="columns";const X=document.createElement("div");X.className="column is-full-mobile is-3-tablet nimbi-nav-wrap",X.setAttribute("role","navigation");try{const y=typeof st=="function"?st("navigation"):null;y&&X.setAttribute("aria-label",y)}catch(y){console.warn("[nimbi-cms] set nav aria-label failed",y)}W.appendChild(X);const K=document.createElement("div");K.className="column nimbi-content",K.setAttribute("role","main"),W.appendChild(K),M.appendChild(W);const re=X,I=K;E.appendChild(M);let T=null;try{T=E.querySelector(".nimbi-overlay"),T||(T=document.createElement("div"),T.className="nimbi-overlay",E.appendChild(T))}catch(y){T=null,console.warn("[nimbi-cms] mount overlay setup failed",y)}const $=location.pathname||"/",L=$.endsWith("/")?$:$.substring(0,$.lastIndexOf("/")+1);try{Pn=document.title||""}catch(y){Pn="",console.warn("[nimbi-cms] read initial document title failed",y)}let S=n;(S==="."||S==="./")&&(S=""),S.startsWith("./")&&(S=S.slice(2)),S.startsWith("/")&&(S=S.slice(1)),S!==""&&!S.endsWith("/")&&(S=S+"/");const b=new URL(L+S,location.origin).toString();try{dn&&dn(x)}catch{}p&&await an(p,L),k&&Array.isArray(k)&&tr(k),f&&ln(f);const R=ma({contentWrap:I,navWrap:re,container:M,mountOverlay:T,t:st,contentBase:b,homePage:x,initialDocumentTitle:Pn,runHooks:Jt});if(typeof d=="number"&&d>=0&&typeof hr=="function"&&hr(d*60*1e3),typeof m=="number"&&m>=0&&typeof ur=="function"&&ur(m),w&&Array.isArray(w)&&w.length)try{w.forEach(y=>{typeof y=="object"&&Fi&&typeof An=="function"&&An(y)})}catch(y){console.warn("[nimbi-cms] applying markdownExtensions failed",y)}try{typeof s=="number"&&Promise.resolve().then(()=>Ot).then(({setDefaultCrawlMaxQueue:y})=>{try{y(s)}catch(B){console.warn("[nimbi-cms] setDefaultCrawlMaxQueue failed",B)}})}catch(y){console.warn("[nimbi-cms] setDefaultCrawlMaxQueue import failed",y)}try{It(b)}catch(y){console.warn("[nimbi-cms] setContentBase failed",y)}try{hn(P)}catch(y){console.warn("[nimbi-cms] setNotFoundPage failed",y)}try{It(b)}catch(y){console.warn("[nimbi-cms] setContentBase failed",y)}try{hn(P)}catch(y){console.warn("[nimbi-cms] setNotFoundPage failed",y)}try{await me(x,b)}catch(y){throw x==="_home.md"?new Error("Required _home.md not found"):new Error(`Required ${x} not found at ${b}${x}: ${y.message}`)}Gn(c),await Qn(u,L);try{const y=document.createElement("header");y.className="nimbi-site-navbar",E.insertBefore(y,M);const B=await me("_navigation.md",b),Y=await Ft(B.raw||""),{navbar:se,linkEls:Ce}=await ra(y,M,Y.html||"",b,x,st,R.renderByQuery,N,h,l,o);try{await Jt("onNavBuild",{navWrap:re,navbar:se,linkEls:Ce,contentBase:b})}catch(Ee){console.warn("[nimbi-cms] onNavBuild hooks failed",Ee)}try{const Ee=()=>{const xe=y&&y.getBoundingClientRect&&Math.round(y.getBoundingClientRect().height)||y&&y.offsetHeight||0;if(xe>0){try{E.style.setProperty("--nimbi-site-navbar-height",`${xe}px`)}catch(we){console.warn("[nimbi-cms] set CSS var failed",we)}try{M.style.paddingTop=""}catch(we){console.warn("[nimbi-cms] set container paddingTop failed",we)}try{const we=E&&E.getBoundingClientRect&&Math.round(E.getBoundingClientRect().height)||E&&E.clientHeight||0;if(we>0){const Le=Math.max(0,we-xe);try{M.style.boxSizing="border-box"}catch(qe){console.warn("[nimbi-cms] set container boxSizing failed",qe)}try{M.style.height=`${Le}px`}catch(qe){console.warn("[nimbi-cms] set container height failed",qe)}try{M.style.setProperty("--nimbi-cms-height",`${Le}px`)}catch(qe){console.warn("[nimbi-cms] set --nimbi-cms-height failed",qe)}}else{try{M.style.height="calc(100% - var(--nimbi-site-navbar-height))"}catch(Le){console.warn("[nimbi-cms] set container height failed",Le)}try{M.style.setProperty("--nimbi-cms-height","calc(100% - var(--nimbi-site-navbar-height))")}catch(Le){console.warn("[nimbi-cms] set --nimbi-cms-height failed",Le)}}}catch(we){console.warn("[nimbi-cms] compute container height failed",we)}try{y.style.setProperty("--nimbi-site-navbar-height",`${xe}px`)}catch(we){console.warn("[nimbi-cms] set navbar CSS var failed",we)}}};Ee();try{if(typeof ResizeObserver<"u"){const xe=new ResizeObserver(()=>Ee());try{xe.observe(y)}catch(we){console.warn("[nimbi-cms] ResizeObserver.observe failed",we)}}}catch(xe){console.warn("[nimbi-cms] ResizeObserver setup failed",xe)}}catch(Ee){console.warn("[nimbi-cms] compute navbar height failed",Ee)}}catch(y){console.warn("[nimbi-cms] build navigation failed",y)}await R.renderByQuery();try{Promise.resolve().then(()=>ka).then(({getVersion:y})=>{typeof y=="function"&&y().then(B=>{try{const Y=B||"0.0.0",se=document.createElement("div");se.className="nimbi-version-label",se.textContent=`Ninbi CMS v. ${Y}`,se.style.position="absolute",se.style.left="8px",se.style.bottom="6px",se.style.fontSize="11px",se.style.opacity="0.6",se.style.pointerEvents="none",se.style.zIndex="9999",se.style.userSelect="none";try{E.appendChild(se)}catch(Ce){console.warn("[nimbi-cms] append version label failed",Ce)}}catch(Y){console.warn("[nimbi-cms] building version label failed",Y)}}).catch(B=>{console.warn("[nimbi-cms] getVersion() failed",B)})}).catch(y=>{console.warn("[nimbi-cms] import version module failed",y)})}catch(y){console.warn("[nimbi-cms] version label setup failed",y)}}async function Fr(){try{let t=null;try{t=await Promise.resolve().then(()=>ns)}catch{try{t=await Promise.resolve().then(()=>ns)}catch{t=null}}const e=t?.default?.version||t?.version;return typeof e=="string"&&e.trim()?e:"0.0.0"}catch{return"0.0.0"}}const ka=Object.freeze(Object.defineProperty({__proto__:null,getVersion:Fr},Symbol.toStringTag,{value:"Module"})),Wr="nimbi-cms",Zr="0.1.0",Qr="module",Gr={dev:"vite","dev:example":'sh -c "npm run build -- --outDir example/dist --config vite.config.js && vite example --port 5173 &"',build:"vite build --config vite.config.js","build:lib":"vite build --config vite.config.js","build:analyze":"ANALYZE=1 vite build --config vite.config.js",preview:"vite preview",test:"npx vitest run","gen-dts":"node scripts/gen-dts.js","check-dts":"npx tsc --noEmit src/index.d.ts --lib es2015,dom --skipLibCheck","type-test":"npx tsd",docs:"typedoc --options typedoc.json"},Xr={bulma:"^1.0.4","highlight.js":"^11.11.1",marked:"^17.0.4"},Kr={"@vitest/coverage-v8":"^4.0.18","comment-parser":"^0.7.6",eslint:"^10.0.3","eslint-plugin-unused-imports":"^4.4.1",glob:"^10.4.1",jsdom:"^28.1.0","reading-time":"^1.5.0",terser:"^5.17.0",typedoc:"^0.28.17","typedoc-plugin-markdown":"^4.10.0",typescript:"^5.9.3",tsd:"^0.33.0",vite:"^7.3.1","rollup-plugin-visualizer":"^5.8.0","vite-plugin-restart":"^2.0.0",vitest:"^4.0.18"},Yr="dist/nimbi-cms.cjs.js",Vr="dist/nimbi-cms.es.js",Jr="src/index.d.ts",es="dist/nimbi-cms.js",ts=["dist","src/index.d.ts"],ns=Object.freeze(Object.defineProperty({__proto__:null,default:{name:Wr,version:Zr,private:!0,type:Qr,scripts:Gr,dependencies:Xr,devDependencies:Kr,main:Yr,module:Vr,types:Jr,unpkg:es,files:ts},dependencies:Xr,devDependencies:Kr,files:ts,main:Yr,module:Vr,name:Wr,scripts:Gr,type:Qr,types:Jr,unpkg:es,version:Zr},Symbol.toStringTag,{value:"Module"}));oe.BAD_LANGUAGES=tn,oe.SUPPORTED_HLJS_MAP=V,oe._clearHooks=Ss,oe.addHook=Tt,oe.default=ya,oe.ensureBulma=Qn,oe.getVersion=Fr,oe.loadL10nFile=an,oe.loadSupportedLanguages=nn,oe.observeCodeBlocks=Zn,oe.onNavBuild=ks,oe.onPageLoad=ys,oe.registerLanguage=nt,oe.runHooks=Jt,oe.setHighlightTheme=Ts,oe.setLang=ln,oe.setStyle=Gn,oe.setThemeVars=Ls,oe.t=st,oe.transformHtml=xs,Object.defineProperties(oe,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})}));
