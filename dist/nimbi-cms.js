...
`;for(let g=o;g<=u;g++)if((t(d[g])||!h(d[g])&&(h(d[g+1])||t(d[g+1])))&&l++,t(d[g]))for(;g<=u&&(i(d[g+1])||h(d[g+1]));)g++;const f=l/c,p=Math.round(f*60*1e3);return{text:Math.ceil(f.toFixed(2))+" min read",minutes:f,time:p,words:l}}return Rr=r,Rr}var $s=Ps();const Is=yi($s);function yn(e,t){let n=document.querySelector(`meta[name="${e}"]`);n||(n=document.createElement("meta"),n.setAttribute("name",e),document.head.appendChild(n)),n.setAttribute("content",t)}function It(e,t,n){let i=`meta[${e}="${t}"]`,r=document.querySelector(i);r||(r=document.createElement("meta"),r.setAttribute(e,t),document.head.appendChild(r)),r.setAttribute("content",n)}function Ui(e,t){try{let n=document.querySelector(`link[rel="${e}"]`);n||(n=document.createElement("link"),n.setAttribute("rel",e),document.head.appendChild(n)),n.setAttribute("href",t)}catch(n){_("[seoManager] upsertLinkRel failed",n)}}function Ns(e,t,n,i){const r=t&&String(t).trim()?t:e.title||document.title;It("property","og:title",r);const a=i&&String(i).trim()?i:e.description||"";a&&String(a).trim()&&It("property","og:description",a),a&&String(a).trim()&&It("name","twitter:description",a),It("name","twitter:card",e.twitter_card||"summary_large_image");const s=n||e.image;s&&(It("property","og:image",s),It("name","twitter:image",s))}function zr(e,t,n,i,r=""){const a=e.meta||{},s=document&&document.querySelector&&document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",l=i&&String(i).trim()?i:a.description&&String(a.description).trim()?a.description:s&&String(s).trim()?s:"";l&&String(l).trim()&&yn("description",l),yn("robots",a.robots||"index,follow"),Ns(a,t,n,l)}function Os(){try{const e=['meta[name="site"]','meta[name="site-name"]','meta[name="siteName"]','meta[property="og:site_name"]','meta[name="twitter:site"]'];for(const t of e){const n=document.querySelector(t);if(n){const i=n.getAttribute("content")||"";if(i&&i.trim())return i.trim()}}}catch(e){_("[seoManager] getSiteNameFromMeta failed",e)}return""}function Pr(e,t,n,i,r,a=""){try{const s=e.meta||{},l=n&&String(n).trim()?n:s.title||a||document.title,o=r&&String(r).trim()?r:s.description||document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",u=i||s.image||null;let c="";try{if(t){const p=Y(t);try{c=(location.origin+location.pathname).split("?")[0]+"?page="+encodeURIComponent(p)}catch{c=location.href.split("#")[0]}}else c=location.href.split("#")[0]}catch(p){c=location.href.split("#")[0],_("[seoManager] compute canonical failed",p)}c&&Ui("canonical",c);try{It("property","og:url",c)}catch(p){_("[seoManager] upsertMeta og:url failed",p)}const h={"@context":"https://schema.org","@type":"Article",headline:l||"",description:o||"",url:c||location.href.split("#")[0]};u&&(h.image=String(u)),s.date&&(h.datePublished=s.date),s.dateModified&&(h.dateModified=s.dateModified);const d="nimbi-jsonld";let f=document.getElementById(d);f||(f=document.createElement("script"),f.type="application/ld+json",f.id=d,document.head.appendChild(f)),f.textContent=JSON.stringify(h,null,2)}catch(s){_("[seoManager] setStructuredData failed",s)}}let bn=typeof window<"u"&&window.__SEO_MAP?window.__SEO_MAP:{};function Bs(e){try{if(!e||typeof e!="object"){bn={};return}bn=Object.assign({},e)}catch(t){_("[seoManager] setSeoMap failed",t)}}function js(e,t=""){try{if(!e)return;const n=bn&&bn[e]?bn[e]:typeof window<"u"&&window.__SEO_MAP&&window.__SEO_MAP[e]?window.__SEO_MAP[e]:null;try{const i=location.origin+location.pathname+"?page="+encodeURIComponent(String(e||""));Ui("canonical",i);try{It("property","og:url",i)}catch{}}catch{}if(!n)return;try{n.title&&(document.title=String(n.title))}catch{}try{n.description&&yn("description",String(n.description))}catch{}try{try{zr({meta:n},n.title||void 0,n.image||void 0,n.description||void 0,t)}catch{}}catch{}try{Pr({meta:n},e,n.title||void 0,n.image||void 0,n.description||void 0,t)}catch(i){_("[seoManager] inject structured data failed",i)}}catch(n){_("[seoManager] injectSeoForPage failed",n)}}function Xn(e={},t="",n=void 0,i=void 0){try{const r=e||{},a=typeof n=="string"&&n.trim()?n:r.title||"Not Found",s=typeof i=="string"&&i.trim()?i:r.description||"";try{yn("robots","noindex,follow")}catch{}try{s&&String(s).trim()&&yn("description",String(s))}catch{}try{zr({meta:Object.assign({},r,{robots:"noindex,follow"})},a,r.image||void 0,s)}catch{}try{Pr({meta:Object.assign({},r,{title:a,description:s})},t||"",a,r.image||void 0,s)}catch{}}catch(r){_("[seoManager] markNotFound failed",r)}}function Hs(e,t,n,i,r,a,s,l,o,u,c){try{if(i&&i.querySelector){const h=i.querySelector(".menu-label");h&&(h.textContent=l&&l.textContent||e("onThisPage"))}}catch(h){_("[seoManager] update toc label failed",h)}try{const h=n.meta&&n.meta.title?String(n.meta.title).trim():"",d=r.querySelector("img"),f=d&&(d.getAttribute("src")||d.src)||null;let p="";try{let m="";try{const b=l||(r&&r.querySelector?r.querySelector("h1"):null);if(b){let w=b.nextElementSibling;const k=[];for(;w&&!(w.tagName&&w.tagName.toLowerCase()==="h2");){try{if(w.classList&&w.classList.contains("nimbi-article-subtitle")){w=w.nextElementSibling;continue}}catch{}const S=(w.textContent||"").trim();S&&k.push(S),w=w.nextElementSibling}k.length&&(m=k.join(" ").replace(/\s+/g," ").trim()),!m&&o&&(m=String(o).trim())}}catch(b){_("[seoManager] compute descOverride failed",b)}m&&String(m).length>160&&(m=String(m).slice(0,157).trim()+"..."),p=m}catch(m){_("[seoManager] compute descOverride failed",m)}let y="";try{h&&(y=h)}catch{}if(!y)try{l&&l.textContent&&(y=String(l.textContent).trim())}catch{}if(!y)try{const m=r.querySelector("h2");m&&m.textContent&&(y=String(m.textContent).trim())}catch{}y||(y=a||"");try{zr(n,y||void 0,f,p)}catch(m){_("[seoManager] setMetaTags failed",m)}try{Pr(n,u,y||void 0,f,p,t)}catch(m){_("[seoManager] setStructuredData failed",m)}const g=Os();y?g?document.title=`${g} - ${y}`:document.title=`${t||"Site"} - ${y}`:h?document.title=h:document.title=t||document.title}catch(h){_("[seoManager] applyPageMeta failed",h)}try{try{const h=r.querySelectorAll(".nimbi-reading-time");h&&h.forEach(d=>d.remove())}catch{}if(o){const h=Is(c.raw||""),d=h&&typeof h.minutes=="number"?Math.ceil(h.minutes):0,f=d?e("readingTime",{minutes:d}):"";if(!f)return;const p=r.querySelector("h1");if(p){const y=r.querySelector(".nimbi-article-subtitle");try{if(y){const g=document.createElement("span");g.className="nimbi-reading-time",g.textContent=f,y.appendChild(g)}else{const g=document.createElement("p");g.className="nimbi-article-subtitle is-6 has-text-grey-light";const m=document.createElement("span");m.className="nimbi-reading-time",m.textContent=f,g.appendChild(m);try{p.parentElement.insertBefore(g,p.nextSibling)}catch{try{p.insertAdjacentElement("afterend",g)}catch{}}}}catch{try{const m=document.createElement("p");m.className="nimbi-article-subtitle is-6 has-text-grey-light";const b=document.createElement("span");b.className="nimbi-reading-time",b.textContent=f,m.appendChild(b),p.insertAdjacentElement("afterend",m)}catch{}}}}}catch(h){_("[seoManager] reading time update failed",h)}}let Wi=100;function Zi(e){Wi=e}function ut(){try{if(Ht(2))return!0}catch{}try{return!1}catch{return!1}}let wn=300*1e3;function Gi(e){wn=e}const ft=new Map;function qs(e){if(!ft.has(e))return;const t=ft.get(e),n=Date.now();if(t.ts+wn<n){ft.delete(e);return}return ft.delete(e),ft.set(e,t),t.value}function Ds(e,t){if(Xi(),Xi(),ft.delete(e),ft.set(e,{value:t,ts:Date.now()}),ft.size>Wi){const n=ft.keys().next().value;n!==void 0&&ft.delete(n)}}function Xi(){if(!wn||wn<=0)return;const e=Date.now();for(const[t,n]of ft.entries())n.ts+wn<e&&ft.delete(t)}async function Fs(e,t){const n=new Set(tt),i=document.querySelectorAll(".nimbi-site-navbar a, .navbar a, .nimbi-nav a");for(const r of Array.from(i||[])){const a=r.getAttribute("href")||"";if(a)try{try{const h=et(a);if(h){if(h.type==="canonical"&&h.page){const d=Y(h.page);if(d){n.add(d);continue}}if(h.type==="cosmetic"&&h.page){const d=h.page;if(ee.has(d)){const f=ee.get(d);if(f)return f}continue}}}catch{}const s=new URL(a,location.href);if(s.origin!==location.origin)continue;const l=(s.hash||s.pathname).match(/([^#?]+\.md)(?:$|[?#])/)||(s.pathname||"").match(/([^#?]+\.md)(?:$|[?#])/);if(l){let h=Y(l[1]);h&&n.add(h);continue}const o=(r.textContent||"").trim(),u=(s.pathname||"").replace(/^.*\//,"");if(o&&de(o)===e||u&&de(u.replace(/\.(html?|md)$/i,""))===e)return s.toString();if(/\.(html?)$/i.test(s.pathname)){let h=s.pathname.replace(/^\//,"");n.add(h);continue}const c=s.pathname||"";if(c){const h=new URL(t),d=Ut(h.pathname);if(c.indexOf(d)!==-1){let f=c.startsWith(d)?c.slice(d.length):c;f=Y(f),f&&n.add(f)}}}catch(s){_("[router] malformed URL while discovering index candidates",s)}}for(const r of n)try{if(!r||!String(r).includes(".md"))continue;const a=await Ce(r,t);if(!a||!a.raw)continue;const s=(a.raw||"").match(/^#\s+(.+)$/m);if(s){const l=(s[1]||"").trim();if(l&&de(l)===e)return r}}catch(a){_("[router] fetchMarkdown during index discovery failed",a)}return null}function Us(e){const t=[];if(String(e).includes(".md")||String(e).includes(".html"))/index\.html$/i.test(e)||t.push(e);else try{const n=decodeURIComponent(String(e||""));if(ee.has(n)){const i=nn(n)||ee.get(n);i&&(/\.(md|html?)$/i.test(i)?/index\.html$/i.test(i)||t.push(i):(t.push(i),t.push(i+".html")))}else{if(tt&&tt.size)for(const i of tt){const r=i.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(de(r)===n&&!/index\.html$/i.test(i)){t.push(i);break}}!t.length&&n&&!/\.(md|html?)$/i.test(n)&&(t.push(n+".html"),t.push(n+".md"))}}catch(n){_("[router] buildPageCandidates failed during slug handling",n)}return t}async function Ws(e,t){const n=e||"";try{try{gi("fetchPageData")}catch{}try{mi("fetchPageData")}catch{}}catch{}let i=null;try{const m=et(typeof location<"u"?location.href:"");m&&m.anchor&&(i=m.anchor)}catch{try{i=location&&location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null}catch{i=null}}let r=e||"",a=null;const s=String(n||"").includes(".md")||String(n||"").includes(".html");if(r&&String(r).includes("::")){const m=String(r).split("::",2);r=m[0],a=m[1]||null}const o=`${e}|||${typeof ss<"u"&&Rt?Rt:""}`,u=qs(o);if(u)r=u.resolved,a=u.anchor||a;else{if(!String(r).includes(".md")&&!String(r).includes(".html")){let m=decodeURIComponent(String(r||""));if(m&&typeof m=="string"&&(m=Y(m),m=tn(m)),ee.has(m))r=nn(m)||ee.get(m);else{let b=await Fs(m,t);if(b)r=b;else if(Ft._refreshed&&tt&&tt.size||typeof t=="string"&&/^[a-z][a-z0-9+.-]*:\/\//i.test(t)){const w=await Di(m,t);w&&(r=w)}}}Ds(o,{resolved:r,anchor:a})}let c=!0;try{const m=String(r||"").includes(".md")||String(r||"").includes(".html")||r&&(r.startsWith("http://")||r.startsWith("https://")||r.startsWith("/"));c=typeof oe=="string"&&oe||ee.has(r)||tt&&tt.size||Ft._refreshed||s||m}catch{c=!0}!a&&i&&(a=i);try{if(c&&r&&(r.startsWith("http://")||r.startsWith("https://")||r.startsWith("/"))){const m=r.startsWith("/")?new URL(r,location.origin).toString():r;try{const b=await fetch(m);if(b&&b.ok){const w=await b.text(),k=b&&b.headers&&typeof b.headers.get=="function"&&b.headers.get("content-type")||"",S=(w||"").toLowerCase();if(k&&k.indexOf&&k.indexOf("text/html")!==-1||S.indexOf("<!doctype")!==-1||S.indexOf("<html")!==-1){if(!s)try{let O=m;try{O=new URL(m).pathname.replace(/^\//,"")}catch{O=String(m||"").replace(/^\//,"")}const H=O.replace(/\.html$/i,".md");try{const U=await Ce(H,t);if(U&&U.raw)return{data:U,pagePath:H,anchor:a}}catch{}if(typeof oe=="string"&&oe)try{const U=await Ce(oe,t);if(U&&U.raw){try{Xn(U.meta||{},oe)}catch{}return{data:U,pagePath:oe,anchor:a}}}catch{}try{g=new Error("site shell detected (absolute fetch)")}catch{}}catch{}if(S.indexOf('<div id="app"')!==-1||S.indexOf("nimbi-cms")!==-1||S.indexOf("nimbi-mount")!==-1||S.indexOf("nimbi-")!==-1||S.indexOf("initcms(")!==-1||S.indexOf("window.nimbi")!==-1||/\bnimbi\b/.test(S))try{let O=m;try{O=new URL(m).pathname.replace(/^\//,"")}catch{O=String(m||"").replace(/^\//,"")}const H=O.replace(/\.html$/i,".md");try{const U=await Ce(H,t);if(U&&U.raw)return{data:U,pagePath:H,anchor:a}}catch{}if(typeof oe=="string"&&oe)try{const U=await Ce(oe,t);if(U&&U.raw){try{Xn(U.meta||{},oe)}catch{}return{data:U,pagePath:oe,anchor:a}}}catch{}try{g=new Error("site shell detected (absolute fetch)")}catch{}}catch{}}}}catch{}}}catch{}const h=Us(r);try{if(ut())try{Lt("[router-debug] fetchPageData candidates",{originalRaw:n,resolved:r,pageCandidates:h})}catch{}}catch{}const d=String(n||"").includes(".md")||String(n||"").includes(".html");let f=null;if(!d)try{let m=decodeURIComponent(String(n||""));m=Y(m),m=tn(m),m&&!/\.(md|html?)$/i.test(m)&&(f=m)}catch{f=null}if(d&&h.length===0&&(String(r).includes(".md")||String(r).includes(".html"))&&h.push(r),h.length===0&&(String(r).includes(".md")||String(r).includes(".html"))&&h.push(r),h.length===1&&/index\.html$/i.test(h[0])&&!d&&!ee.has(r)&&!ee.has(decodeURIComponent(String(r||"")))&&!String(r||"").includes("/"))throw new Error("Unknown slug: index.html fallback prevented");let p=null,y=null,g=null;try{const m=String(r||"").includes(".md")||String(r||"").includes(".html")||r&&(r.startsWith("http://")||r.startsWith("https://")||r.startsWith("/"));c=typeof oe=="string"&&oe||ee.has(r)||tt&&tt.size||Ft._refreshed||d||m}catch{c=!0}if(!c)g=new Error("no page data");else for(const m of h)if(m)try{const b=Y(m);if(p=await Ce(b,t),y=b,f&&!ee.has(f))try{let w="";if(p&&p.isHtml)try{const k=qe();if(k){const S=k.parseFromString(p.raw||"","text/html"),v=S.querySelector("h1")||S.querySelector("title");v&&v.textContent&&(w=v.textContent.trim())}}catch{}else{const k=(p&&p.raw||"").match(/^#\s+(.+)$/m);k&&k[1]&&(w=k[1].trim())}if(w&&de(w)!==f)try{if(/\.html$/i.test(b)){const S=b.replace(/\.html$/i,".md");if(h.includes(S))try{const v=await Ce(S,t);if(v&&v.raw)p=v,y=S;else if(typeof oe=="string"&&oe)try{const E=await Ce(oe,t);if(E&&E.raw)p=E,y=oe;else{p=null,y=null,g=new Error("slug mismatch for candidate");continue}}catch{p=null,y=null,g=new Error("slug mismatch for candidate");continue}else{p=null,y=null,g=new Error("slug mismatch for candidate");continue}}catch{try{const E=await Ce(oe,t);if(E&&E.raw)p=E,y=oe;else{p=null,y=null,g=new Error("slug mismatch for candidate");continue}}catch{p=null,y=null,g=new Error("slug mismatch for candidate");continue}}else{p=null,y=null,g=new Error("slug mismatch for candidate");continue}}else{p=null,y=null,g=new Error("slug mismatch for candidate");continue}}catch{p=null,y=null,g=new Error("slug mismatch for candidate");continue}}catch{}try{if(!d&&/\.html$/i.test(b)){const w=b.replace(/\.html$/i,".md");if(h.includes(w))try{const S=String(p&&p.raw||"").trim().slice(0,128).toLowerCase();if(p&&p.isHtml||/^(?:<!doctype|<html|<title|<h1)/i.test(S)||S.indexOf('<div id="app"')!==-1||S.indexOf("nimbi-")!==-1||S.indexOf("nimbi")!==-1||S.indexOf("initcms(")!==-1){let E=!1;try{const O=await Ce(w,t);if(O&&O.raw)p=O,y=w,E=!0;else if(typeof oe=="string"&&oe)try{const H=await Ce(oe,t);H&&H.raw&&(p=H,y=oe,E=!0)}catch{}}catch{try{const H=await Ce(oe,t);H&&H.raw&&(p=H,y=oe,E=!0)}catch{}}if(!E){p=null,y=null,g=new Error("site shell detected (candidate HTML rejected)");continue}}}catch{}}}catch{}try{if(ut())try{Lt("[router-debug] fetchPageData accepted candidate",{candidate:b,pagePath:y,isHtml:p&&p.isHtml,snippet:p&&p.raw?String(p.raw).slice(0,160):null})}catch{}}catch{}break}catch(b){g=b;try{ut()&&_("[router] candidate fetch failed",{candidate:m,contentBase:t,err:b&&b.message||b})}catch{}}if(!p){const m=g&&(g.message||String(g))||null,b=m&&/failed to fetch md|site shell detected/i.test(m);try{if(ut())try{Lt("[router-debug] fetchPageData no data",{originalRaw:n,resolved:r,pageCandidates:h,fetchError:m})}catch{}}catch{}if(b)try{if(ut())try{_("[router] fetchPageData: no page data (expected)",{originalRaw:n,resolved:r,pageCandidates:h,contentBase:t,fetchError:m})}catch{}}catch{}else try{if(ut())try{Nn("[router] fetchPageData: no page data for",{originalRaw:n,resolved:r,pageCandidates:h,contentBase:t,fetchError:m})}catch{}}catch{}if(typeof oe=="string"&&oe)try{const w=await Ce(oe,t);if(w&&w.raw){try{Xn(w.meta||{},oe)}catch{}return{data:w,pagePath:oe,anchor:a}}}catch{}try{if(d&&String(n||"").toLowerCase().includes(".html"))try{const w=new URL(String(n||""),location.href).toString();ut()&&_("[router] attempting absolute HTML fetch fallback",w);const k=await fetch(w);if(k&&k.ok){const S=await k.text(),v=k&&k.headers&&typeof k.headers.get=="function"&&k.headers.get("content-type")||"",E=(S||"").toLowerCase(),O=v&&v.indexOf&&v.indexOf("text/html")!==-1||E.indexOf("<!doctype")!==-1||E.indexOf("<html")!==-1;if(!O&&ut())try{_("[router] absolute fetch returned non-HTML",()=>({abs:w,contentType:v,snippet:E.slice(0,200)}))}catch{}if(O){const H=(S||"").toLowerCase();if(/<title>\s*index of\b/i.test(S)||/<h1>\s*index of\b/i.test(S)||H.indexOf("parent directory")!==-1||/<title>\s*directory listing/i.test(S)||/<h1>\s*directory listing/i.test(S))try{ut()&&_("[router] absolute fetch returned directory listing; treating as not found",{abs:w})}catch{}else try{const P=w,K=new URL(".",P).toString();try{const ie=qe();if(ie){const q=ie.parseFromString(S||"","text/html"),L=(te,ce)=>{try{const _e=ce.getAttribute(te)||"";if(!_e||/^(https?:)?\/\//i.test(_e)||_e.startsWith("/")||_e.startsWith("#"))return;try{const Ee=new URL(_e,P).toString();ce.setAttribute(te,Ee)}catch(Ee){_("[router] rewrite attribute failed",te,Ee)}}catch(_e){_("[router] rewrite helper failed",_e)}},D=q.querySelectorAll("[src],[href],[srcset],[xlink:href],[poster]"),F=[];for(const te of Array.from(D||[]))try{const ce=te.tagName?te.tagName.toLowerCase():"";if(ce==="a")continue;if(te.hasAttribute("src")){const _e=te.getAttribute("src");L("src",te);const Ee=te.getAttribute("src");_e!==Ee&&F.push({attr:"src",tag:ce,before:_e,after:Ee})}if(te.hasAttribute("href")&&ce==="link"){const _e=te.getAttribute("href");L("href",te);const Ee=te.getAttribute("href");_e!==Ee&&F.push({attr:"href",tag:ce,before:_e,after:Ee})}if(te.hasAttribute("href")&&ce!=="link"){const _e=te.getAttribute("href");L("href",te);const Ee=te.getAttribute("href");_e!==Ee&&F.push({attr:"href",tag:ce,before:_e,after:Ee})}if(te.hasAttribute("xlink:href")){const _e=te.getAttribute("xlink:href");L("xlink:href",te);const Ee=te.getAttribute("xlink:href");_e!==Ee&&F.push({attr:"xlink:href",tag:ce,before:_e,after:Ee})}if(te.hasAttribute("poster")){const _e=te.getAttribute("poster");L("poster",te);const Ee=te.getAttribute("poster");_e!==Ee&&F.push({attr:"poster",tag:ce,before:_e,after:Ee})}if(te.hasAttribute("srcset")){const De=(te.getAttribute("srcset")||"").split(",").map(xe=>xe.trim()).filter(Boolean).map(xe=>{const[Ue,T]=xe.split(/\s+/,2);if(!Ue||/^(https?:)?\/\//i.test(Ue)||Ue.startsWith("/"))return xe;try{const N=new URL(Ue,P).toString();return T?`${N} ${T}`:N}catch{return xe}}).join(", ");te.setAttribute("srcset",De)}}catch{}const le=q.documentElement&&q.documentElement.outerHTML?q.documentElement.outerHTML:S;try{ut()&&F&&F.length&&_("[router] rewritten asset refs",{abs:w,rewritten:F})}catch{}return{data:{raw:le,isHtml:!0},pagePath:String(n||""),anchor:a}}}catch{}let Z=S;return/<base\s+[^>]*>/i.test(S)||(/<head[^>]*>/i.test(S)?Z=S.replace(/(<head[^>]*>)/i,`$1<base href="${K}">`):Z=`<base href="${K}">`+S),{data:{raw:Z,isHtml:!0},pagePath:String(n||""),anchor:a}}catch{return{data:{raw:S,isHtml:!0},pagePath:String(n||""),anchor:a}}}}}catch(w){ut()&&_("[router] absolute HTML fetch fallback failed",w)}}catch{}try{const w=decodeURIComponent(String(r||""));if(w&&!/\.(md|html?)$/i.test(w)&&typeof oe=="string"&&oe&&ut()){const S=[`/assets/${w}.html`,`/assets/${w}/index.html`];for(const v of S)try{const E=await fetch(v,{method:"GET"});if(E&&E.ok)return{data:{raw:await E.text(),isHtml:!0},pagePath:v.replace(/^\//,""),anchor:a}}catch{}}}catch(w){ut()&&_("[router] assets fallback failed",w)}throw new Error("no page data")}return{data:p,pagePath:y,anchor:a}}function Qn(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Nt=Qn();function Qi(e){Nt=e}var Gt={exec:()=>null};function Re(e,t=""){let n=typeof e=="string"?e:e.source,i={replace:(r,a)=>{let s=typeof a=="string"?a:a.source;return s=s.replace(lt.caret,"$1"),n=n.replace(r,s),i},getRegex:()=>new RegExp(n,t)};return i}var Zs=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),lt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}>`)},Gs=/^(?:[ \t]*(?:\n|$))+/,Xs=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Qs=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,_n=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Ks=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,$r=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,Ki=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Vi=Re(Ki).replace(/bull/g,$r).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Vs=Re(Ki).replace(/bull/g,$r).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Ir=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Ys=/^[^\n]+/,Nr=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Js=Re(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Nr).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),eo=Re(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,$r).getRegex(),Kn="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Or=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,to=Re("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Or).replace("tag",Kn).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Yi=Re(Ir).replace("hr",_n).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Kn).getRegex(),no=Re(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Yi).getRegex(),Br={blockquote:no,code:Xs,def:Js,fences:Qs,heading:Ks,hr:_n,html:to,lheading:Vi,list:eo,newline:Gs,paragraph:Yi,table:Gt,text:Ys},Ji=Re("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",_n).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Kn).getRegex(),ro={...Br,lheading:Vs,table:Ji,paragraph:Re(Ir).replace("hr",_n).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Ji).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Kn).getRegex()},io={...Br,html:Re(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Or).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Gt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:Re(Ir).replace("hr",_n).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Vi).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},ao=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,so=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,ea=/^( {2,}|\\)\n(?!\s*$)/,oo=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Vn=/[\p{P}\p{S}]/u,jr=/[\s\p{P}\p{S}]/u,ta=/[^\s\p{P}\p{S}]/u,lo=Re(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,jr).getRegex(),na=/(?!~)[\p{P}\p{S}]/u,co=/(?!~)[\s\p{P}\p{S}]/u,uo=/(?:[^\s\p{P}\p{S}]|~)/u,ra=/(?![*_])[\p{P}\p{S}]/u,ho=/(?![*_])[\s\p{P}\p{S}]/u,fo=/(?:[^\s\p{P}\p{S}]|[*_])/u,po=Re(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Zs?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),ia=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,go=Re(ia,"u").replace(/punct/g,Vn).getRegex(),mo=Re(ia,"u").replace(/punct/g,na).getRegex(),aa="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",yo=Re(aa,"gu").replace(/notPunctSpace/g,ta).replace(/punctSpace/g,jr).replace(/punct/g,Vn).getRegex(),bo=Re(aa,"gu").replace(/notPunctSpace/g,uo).replace(/punctSpace/g,co).replace(/punct/g,na).getRegex(),wo=Re("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,ta).replace(/punctSpace/g,jr).replace(/punct/g,Vn).getRegex(),_o=Re(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,ra).getRegex(),ko="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",xo=Re(ko,"gu").replace(/notPunctSpace/g,fo).replace(/punctSpace/g,ho).replace(/punct/g,ra).getRegex(),So=Re(/\\(punct)/,"gu").replace(/punct/g,Vn).getRegex(),vo=Re(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Ao=Re(Or).replace("(?:-->|$)","-->").getRegex(),Eo=Re("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Ao).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Yn=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Co=Re(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",Yn).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),sa=Re(/^!?\[(label)\]\[(ref)\]/).replace("label",Yn).replace("ref",Nr).getRegex(),oa=Re(/^!?\[(ref)\](?:\[\])?/).replace("ref",Nr).getRegex(),Mo=Re("reflink|nolink(?!\\()","g").replace("reflink",sa).replace("nolink",oa).getRegex(),la=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Hr={_backpedal:Gt,anyPunctuation:So,autolink:vo,blockSkip:po,br:ea,code:so,del:Gt,delLDelim:Gt,delRDelim:Gt,emStrongLDelim:go,emStrongRDelimAst:yo,emStrongRDelimUnd:wo,escape:ao,link:Co,nolink:oa,punctuation:lo,reflink:sa,reflinkSearch:Mo,tag:Eo,text:oo,url:Gt},Lo={...Hr,link:Re(/^!?\[(label)\]\((.*?)\)/).replace("label",Yn).getRegex(),reflink:Re(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Yn).getRegex()},qr={...Hr,emStrongRDelimAst:bo,emStrongLDelim:mo,delLDelim:_o,delRDelim:xo,url:Re(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",la).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:Re(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",la).getRegex()},To={...qr,br:Re(ea).replace("{2,}","*").getRegex(),text:Re(qr.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Jn={normal:Br,gfm:ro,pedantic:io},kn={normal:Hr,gfm:qr,breaks:To,pedantic:Lo},Ro={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ca=e=>Ro[e];function bt(e,t){if(t){if(lt.escapeTest.test(e))return e.replace(lt.escapeReplace,ca)}else if(lt.escapeTestNoEncode.test(e))return e.replace(lt.escapeReplaceNoEncode,ca);return e}function ua(e){try{e=encodeURI(e).replace(lt.percentDecode,"%")}catch{return null}return e}function ha(e,t){let n=e.replace(lt.findPipe,(a,s,l)=>{let o=!1,u=s;for(;--u>=0&&l[u]==="\\";)o=!o;return o?"|":" |"}),i=n.split(lt.splitPipe),r=0;if(i[0].trim()||i.shift(),i.length>0&&!i.at(-1)?.trim()&&i.pop(),t)if(i.length>t)i.splice(t);else for(;i.length<t;)i.push("");for(;r<i.length;r++)i[r]=i[r].trim().replace(lt.slashPipe,"|");return i}function xn(e,t,n){let i=e.length;if(i===0)return"";let r=0;for(;r<i&&e.charAt(i-r-1)===t;)r++;return e.slice(0,i-r)}function zo(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let i=0;i<e.length;i++)if(e[i]==="\\")i++;else if(e[i]===t[0])n++;else if(e[i]===t[1]&&(n--,n<0))return i;return n>0?-2:-1}function Po(e,t=0){let n=t,i="";for(let r of e)if(r==="	"){let a=4-n%4;i+=" ".repeat(a),n+=a}else i+=r,n++;return i}function da(e,t,n,i,r){let a=t.href,s=t.title||null,l=e[1].replace(r.other.outputLinkReplace,"$1");i.state.inLink=!0;let o={type:e[0].charAt(0)==="!"?"image":"link",raw:n,href:a,title:s,text:l,tokens:i.inlineTokens(l)};return i.state.inLink=!1,o}function $o(e,t,n){let i=e.match(n.other.indentCodeCompensation);if(i===null)return t;let r=i[1];return t.split(`
`).map(a=>{let s=a.match(n.other.beginningSpace);if(s===null)return a;let[l]=s;return l.length>=r.length?a.slice(r.length):a}).join(`
`)}var Sn=class{options;rules;lexer;constructor(e){this.options=e||Nt}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let n=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?n:xn(n,`
