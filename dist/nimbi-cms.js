(function(Be,Dt){typeof exports=="object"&&typeof module<"u"?Dt(exports):typeof define=="function"&&define.amd?define(["exports"],Dt):(Be=typeof globalThis<"u"?globalThis:Be||self,Dt(Be.nimbiCMS={}))})(this,(function(Be){"use strict";let Dt=0;const vi=Object.create(null);function Ai(e){try{const t=Number(e);Dt=Number.isFinite(t)&&t>=0?Math.max(0,Math.min(3,Math.floor(t))):0}catch{Dt=0}}function Ut(e=1){try{return Number(Dt)>=Number(e||1)}catch{return!1}}function kr(){return Ut(1)}function qn(...e){try{if(!Ut(1)||!console||typeof console.error!="function")return;const t=e.map(n=>typeof n=="function"?n():n);console.error(...t)}catch{}}function k(...e){try{if(!Ut(2)||!console||typeof console.warn!="function")return;const t=e.map(n=>typeof n=="function"?n():n);console.warn(...t)}catch{}}function zt(...e){try{if(!Ut(3)||!console||typeof console.info!="function")return;const t=e.map(n=>typeof n=="function"?n():n);console.info(...t)}catch{}}function Rt(...e){try{if(!Ut(3)||!console||typeof console.log!="function")return;const t=e.map(n=>typeof n=="function"?n():n);console.log(...t)}catch{}}function Ei(e){try{if(!kr())return;const t=String(e||"");if(!t)return;vi[t]=(vi[t]||0)+1}catch{}}function Ci(e){try{if(typeof globalThis>"u"||!globalThis.__nimbiCMSDebug)return;const t=String(e||"");if(!t)return;try{globalThis.__nimbiCMSDebug[t]=(globalThis.__nimbiCMSDebug[t]||0)+1}catch{}}catch{}}const gn={onPageLoad:[],onNavBuild:[],transformHtml:[]};function Hn(e,t){if(!Object.prototype.hasOwnProperty.call(gn,e))throw new Error('Unknown hook "'+e+'"');if(typeof t!="function")throw new TypeError("hook callback must be a function");gn[e].push(t)}function is(e){Hn("onPageLoad",e)}function as(e){Hn("onNavBuild",e)}function ss(e){Hn("transformHtml",e)}async function xr(e,t){const n=gn[e]||[];for(const i of n)try{await i(t)}catch(r){try{k("[nimbi-cms] runHooks callback failed",r)}catch{}}}function os(){Object.keys(gn).forEach(e=>{gn[e].length=0})}function Mi(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Sr,Li;function ls(){if(Li)return Sr;Li=1;function e(x){return x instanceof Map?x.clear=x.delete=x.set=function(){throw new Error("map is read-only")}:x instanceof Set&&(x.add=x.clear=x.delete=function(){throw new Error("set is read-only")}),Object.freeze(x),Object.getOwnPropertyNames(x).forEach(B=>{const ee=x[B],we=typeof ee;(we==="object"||we==="function")&&!Object.isFrozen(ee)&&e(ee)}),x}class t{constructor(B){B.data===void 0&&(B.data={}),this.data=B.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function n(x){return x.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function i(x,...B){const ee=Object.create(null);for(const we in x)ee[we]=x[we];return B.forEach(function(we){for(const We in we)ee[We]=we[We]}),ee}const r="</span>",a=x=>!!x.scope,s=(x,{prefix:B})=>{if(x.startsWith("language:"))return x.replace("language:","language-");if(x.includes(".")){const ee=x.split(".");return[`${B}${ee.shift()}`,...ee.map((we,We)=>`${we}${"_".repeat(We+1)}`)].join(" ")}return`${B}${x}`};class o{constructor(B,ee){this.buffer="",this.classPrefix=ee.classPrefix,B.walk(this)}addText(B){this.buffer+=n(B)}openNode(B){if(!a(B))return;const ee=s(B.scope,{prefix:this.classPrefix});this.span(ee)}closeNode(B){a(B)&&(this.buffer+=r)}value(){return this.buffer}span(B){this.buffer+=`<span class="${B}">`}}const l=(x={})=>{const B={children:[]};return Object.assign(B,x),B};class c{constructor(){this.rootNode=l(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(B){this.top.children.push(B)}openNode(B){const ee=l({scope:B});this.add(ee),this.stack.push(ee)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(B){return this.constructor._walk(B,this.rootNode)}static _walk(B,ee){return typeof ee=="string"?B.addText(ee):ee.children&&(B.openNode(ee),ee.children.forEach(we=>this._walk(B,we)),B.closeNode(ee)),B}static _collapse(B){typeof B!="string"&&B.children&&(B.children.every(ee=>typeof ee=="string")?B.children=[B.children.join("")]:B.children.forEach(ee=>{c._collapse(ee)}))}}class u extends c{constructor(B){super(),this.options=B}addText(B){B!==""&&this.add(B)}startScope(B){this.openNode(B)}endScope(){this.closeNode()}__addSublanguage(B,ee){const we=B.root;ee&&(we.scope=`language:${ee}`),this.add(we)}toHTML(){return new o(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function g(x){return x?typeof x=="string"?x:x.source:null}function h(x){return m("(?=",x,")")}function d(x){return m("(?:",x,")*")}function p(x){return m("(?:",x,")?")}function m(...x){return x.map(ee=>g(ee)).join("")}function f(x){const B=x[x.length-1];return typeof B=="object"&&B.constructor===Object?(x.splice(x.length-1,1),B):{}}function w(...x){return"("+(f(x).capture?"":"?:")+x.map(we=>g(we)).join("|")+")"}function y(x){return new RegExp(x.toString()+"|").exec("").length-1}function _(x,B){const ee=x&&x.exec(B);return ee&&ee.index===0}const b=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function v(x,{joinWith:B}){let ee=0;return x.map(we=>{ee+=1;const We=ee;let Ze=g(we),oe="";for(;Ze.length>0;){const ae=b.exec(Ze);if(!ae){oe+=Ze;break}oe+=Ze.substring(0,ae.index),Ze=Ze.substring(ae.index+ae[0].length),ae[0][0]==="\\"&&ae[1]?oe+="\\"+String(Number(ae[1])+We):(oe+=ae[0],ae[0]==="("&&ee++)}return oe}).map(we=>`(${we})`).join(B)}const S=/\b\B/,E="[a-zA-Z]\\w*",P="[a-zA-Z_]\\w*",I="\\b\\d+(\\.\\d+)?",U="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",z="\\b(0b[01]+)",O="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",W=(x={})=>{const B=/^#![ ]*\//;return x.binary&&(x.begin=m(B,/.*\b/,x.binary,/\b.*/)),i({scope:"meta",begin:B,end:/$/,relevance:0,"on:begin":(ee,we)=>{ee.index!==0&&we.ignoreMatch()}},x)},te={begin:"\\\\[\\s\\S]",relevance:0},H={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[te]},M={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[te]},F={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},G=function(x,B,ee={}){const we=i({scope:"comment",begin:x,end:B,contains:[]},ee);we.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const We=w("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return we.contains.push({begin:m(/[ ]+/,"(",We,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),we},ie=G("//","$"),ye=G("/\\*","\\*/"),J=G("#","$"),Re={scope:"number",begin:I,relevance:0},ke={scope:"number",begin:U,relevance:0},xe={scope:"number",begin:z,relevance:0},Ce={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[te,{begin:/\[/,end:/\]/,relevance:0,contains:[te]}]},Fe={scope:"title",begin:E,relevance:0},R={scope:"title",begin:P,relevance:0},N={begin:"\\.\\s*"+P,relevance:0};var A=Object.freeze({__proto__:null,APOS_STRING_MODE:H,BACKSLASH_ESCAPE:te,BINARY_NUMBER_MODE:xe,BINARY_NUMBER_RE:z,COMMENT:G,C_BLOCK_COMMENT_MODE:ye,C_LINE_COMMENT_MODE:ie,C_NUMBER_MODE:ke,C_NUMBER_RE:U,END_SAME_AS_BEGIN:function(x){return Object.assign(x,{"on:begin":(B,ee)=>{ee.data._beginMatch=B[1]},"on:end":(B,ee)=>{ee.data._beginMatch!==B[1]&&ee.ignoreMatch()}})},HASH_COMMENT_MODE:J,IDENT_RE:E,MATCH_NOTHING_RE:S,METHOD_GUARD:N,NUMBER_MODE:Re,NUMBER_RE:I,PHRASAL_WORDS_MODE:F,QUOTE_STRING_MODE:M,REGEXP_MODE:Ce,RE_STARTERS_RE:O,SHEBANG:W,TITLE_MODE:Fe,UNDERSCORE_IDENT_RE:P,UNDERSCORE_TITLE_MODE:R});function L(x,B){x.input[x.index-1]==="."&&B.ignoreMatch()}function D(x,B){x.className!==void 0&&(x.scope=x.className,delete x.className)}function V(x,B){B&&x.beginKeywords&&(x.begin="\\b("+x.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",x.__beforeBegin=L,x.keywords=x.keywords||x.beginKeywords,delete x.beginKeywords,x.relevance===void 0&&(x.relevance=0))}function q(x,B){Array.isArray(x.illegal)&&(x.illegal=w(...x.illegal))}function $(x,B){if(x.match){if(x.begin||x.end)throw new Error("begin & end are not supported with match");x.begin=x.match,delete x.match}}function T(x,B){x.relevance===void 0&&(x.relevance=1)}const j=(x,B)=>{if(!x.beforeMatch)return;if(x.starts)throw new Error("beforeMatch cannot be used with starts");const ee=Object.assign({},x);Object.keys(x).forEach(we=>{delete x[we]}),x.keywords=ee.keywords,x.begin=m(ee.beforeMatch,h(ee.begin)),x.starts={relevance:0,contains:[Object.assign(ee,{endsParent:!0})]},x.relevance=0,delete ee.beforeMatch},X=["of","and","for","in","not","or","if","then","parent","list","value"],se="keyword";function pe(x,B,ee=se){const we=Object.create(null);return typeof x=="string"?We(ee,x.split(" ")):Array.isArray(x)?We(ee,x):Object.keys(x).forEach(function(Ze){Object.assign(we,pe(x[Ze],B,Ze))}),we;function We(Ze,oe){B&&(oe=oe.map(ae=>ae.toLowerCase())),oe.forEach(function(ae){const me=ae.split("|");we[me[0]]=[Ze,be(me[0],me[1])]})}}function be(x,B){return B?Number(B):ge(x)?0:1}function ge(x){return X.includes(x.toLowerCase())}const Se={},$e=x=>{console.error(x)},Ue=(x,...B)=>{console.log(`WARN: ${x}`,...B)},Ke=(x,B)=>{Se[`${x}/${B}`]||(console.log(`Deprecated as of ${x}. ${B}`),Se[`${x}/${B}`]=!0)},Mt=new Error;function Bn(x,B,{key:ee}){let we=0;const We=x[ee],Ze={},oe={};for(let ae=1;ae<=B.length;ae++)oe[ae+we]=We[ae],Ze[ae+we]=!0,we+=y(B[ae-1]);x[ee]=oe,x[ee]._emit=Ze,x[ee]._multi=!0}function Lt(x){if(Array.isArray(x.begin)){if(x.skip||x.excludeBegin||x.returnBegin)throw $e("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Mt;if(typeof x.beginScope!="object"||x.beginScope===null)throw $e("beginScope must be object"),Mt;Bn(x,x.begin,{key:"beginScope"}),x.begin=v(x.begin,{joinWith:""})}}function Yl(x){if(Array.isArray(x.end)){if(x.skip||x.excludeEnd||x.returnEnd)throw $e("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Mt;if(typeof x.endScope!="object"||x.endScope===null)throw $e("endScope must be object"),Mt;Bn(x,x.end,{key:"endScope"}),x.end=v(x.end,{joinWith:""})}}function Jl(x){x.scope&&typeof x.scope=="object"&&x.scope!==null&&(x.beginScope=x.scope,delete x.scope)}function ec(x){Jl(x),typeof x.beginScope=="string"&&(x.beginScope={_wrap:x.beginScope}),typeof x.endScope=="string"&&(x.endScope={_wrap:x.endScope}),Lt(x),Yl(x)}function tc(x){function B(oe,ae){return new RegExp(g(oe),"m"+(x.case_insensitive?"i":"")+(x.unicodeRegex?"u":"")+(ae?"g":""))}class ee{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(ae,me){me.position=this.position++,this.matchIndexes[this.matchAt]=me,this.regexes.push([me,ae]),this.matchAt+=y(ae)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const ae=this.regexes.map(me=>me[1]);this.matcherRe=B(v(ae,{joinWith:"|"}),!0),this.lastIndex=0}exec(ae){this.matcherRe.lastIndex=this.lastIndex;const me=this.matcherRe.exec(ae);if(!me)return null;const Ye=me.findIndex((jn,mi)=>mi>0&&jn!==void 0),Ge=this.matchIndexes[Ye];return me.splice(0,Ye),Object.assign(me,Ge)}}class we{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(ae){if(this.multiRegexes[ae])return this.multiRegexes[ae];const me=new ee;return this.rules.slice(ae).forEach(([Ye,Ge])=>me.addRule(Ye,Ge)),me.compile(),this.multiRegexes[ae]=me,me}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(ae,me){this.rules.push([ae,me]),me.type==="begin"&&this.count++}exec(ae){const me=this.getMatcher(this.regexIndex);me.lastIndex=this.lastIndex;let Ye=me.exec(ae);if(this.resumingScanAtSamePosition()&&!(Ye&&Ye.index===this.lastIndex)){const Ge=this.getMatcher(0);Ge.lastIndex=this.lastIndex+1,Ye=Ge.exec(ae)}return Ye&&(this.regexIndex+=Ye.position+1,this.regexIndex===this.count&&this.considerAll()),Ye}}function We(oe){const ae=new we;return oe.contains.forEach(me=>ae.addRule(me.begin,{rule:me,type:"begin"})),oe.terminatorEnd&&ae.addRule(oe.terminatorEnd,{type:"end"}),oe.illegal&&ae.addRule(oe.illegal,{type:"illegal"}),ae}function Ze(oe,ae){const me=oe;if(oe.isCompiled)return me;[D,$,ec,j].forEach(Ge=>Ge(oe,ae)),x.compilerExtensions.forEach(Ge=>Ge(oe,ae)),oe.__beforeBegin=null,[V,q,T].forEach(Ge=>Ge(oe,ae)),oe.isCompiled=!0;let Ye=null;return typeof oe.keywords=="object"&&oe.keywords.$pattern&&(oe.keywords=Object.assign({},oe.keywords),Ye=oe.keywords.$pattern,delete oe.keywords.$pattern),Ye=Ye||/\w+/,oe.keywords&&(oe.keywords=pe(oe.keywords,x.case_insensitive)),me.keywordPatternRe=B(Ye,!0),ae&&(oe.begin||(oe.begin=/\B|\b/),me.beginRe=B(me.begin),!oe.end&&!oe.endsWithParent&&(oe.end=/\B|\b/),oe.end&&(me.endRe=B(me.end)),me.terminatorEnd=g(me.end)||"",oe.endsWithParent&&ae.terminatorEnd&&(me.terminatorEnd+=(oe.end?"|":"")+ae.terminatorEnd)),oe.illegal&&(me.illegalRe=B(oe.illegal)),oe.contains||(oe.contains=[]),oe.contains=[].concat(...oe.contains.map(function(Ge){return nc(Ge==="self"?oe:Ge)})),oe.contains.forEach(function(Ge){Ze(Ge,me)}),oe.starts&&Ze(oe.starts,ae),me.matcher=We(me),me}if(x.compilerExtensions||(x.compilerExtensions=[]),x.contains&&x.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return x.classNameAliases=i(x.classNameAliases||{}),Ze(x)}function Za(x){return x?x.endsWithParent||Za(x.starts):!1}function nc(x){return x.variants&&!x.cachedVariants&&(x.cachedVariants=x.variants.map(function(B){return i(x,{variants:null},B)})),x.cachedVariants?x.cachedVariants:Za(x)?i(x,{starts:x.starts?i(x.starts):null}):Object.isFrozen(x)?i(x):x}var rc="11.11.1";class ic extends Error{constructor(B,ee){super(B),this.name="HTMLInjectionError",this.html=ee}}const pi=n,Ga=i,Xa=Symbol("nomatch"),ac=7,Qa=function(x){const B=Object.create(null),ee=Object.create(null),we=[];let We=!0;const Ze="Could not find the language '{}', did you forget to load/include a language module?",oe={disableAutodetect:!0,name:"Plain text",contains:[]};let ae={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:u};function me(Q){return ae.noHighlightRe.test(Q)}function Ye(Q){let ue=Q.className+" ";ue+=Q.parentNode?Q.parentNode.className:"";const Me=ae.languageDetectRe.exec(ue);if(Me){const je=Ht(Me[1]);return je||(Ue(Ze.replace("{}",Me[1])),Ue("Falling back to no-highlight mode for this block.",Q)),je?Me[1]:"no-highlight"}return ue.split(/\s+/).find(je=>me(je)||Ht(je))}function Ge(Q,ue,Me){let je="",Ve="";typeof ue=="object"?(je=Q,Me=ue.ignoreIllegals,Ve=ue.language):(Ke("10.7.0","highlight(lang, code, ...args) has been deprecated."),Ke("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),Ve=Q,je=ue),Me===void 0&&(Me=!0);const _t={code:je,language:Ve};yr("before:highlight",_t);const Ft=_t.result?_t.result:jn(_t.language,_t.code,Me);return Ft.code=_t.code,yr("after:highlight",Ft),Ft}function jn(Q,ue,Me,je){const Ve=Object.create(null);function _t(ne,ce){return ne.keywords[ce]}function Ft(){if(!_e.keywords){Je.addText(qe);return}let ne=0;_e.keywordPatternRe.lastIndex=0;let ce=_e.keywordPatternRe.exec(qe),ve="";for(;ce;){ve+=qe.substring(ne,ce.index);const Ne=Et.case_insensitive?ce[0].toLowerCase():ce[0],at=_t(_e,Ne);if(at){const[Tt,xc]=at;if(Je.addText(ve),ve="",Ve[Ne]=(Ve[Ne]||0)+1,Ve[Ne]<=ac&&(_r+=xc),Tt.startsWith("_"))ve+=ce[0];else{const Sc=Et.classNameAliases[Tt]||Tt;At(ce[0],Sc)}}else ve+=ce[0];ne=_e.keywordPatternRe.lastIndex,ce=_e.keywordPatternRe.exec(qe)}ve+=qe.substring(ne),Je.addText(ve)}function br(){if(qe==="")return;let ne=null;if(typeof _e.subLanguage=="string"){if(!B[_e.subLanguage]){Je.addText(qe);return}ne=jn(_e.subLanguage,qe,!0,rs[_e.subLanguage]),rs[_e.subLanguage]=ne._top}else ne=yi(qe,_e.subLanguage.length?_e.subLanguage:null);_e.relevance>0&&(_r+=ne.relevance),Je.__addSublanguage(ne._emitter,ne.language)}function gt(){_e.subLanguage!=null?br():Ft(),qe=""}function At(ne,ce){ne!==""&&(Je.startScope(ce),Je.addText(ne),Je.endScope())}function Ja(ne,ce){let ve=1;const Ne=ce.length-1;for(;ve<=Ne;){if(!ne._emit[ve]){ve++;continue}const at=Et.classNameAliases[ne[ve]]||ne[ve],Tt=ce[ve];at?At(Tt,at):(qe=Tt,Ft(),qe=""),ve++}}function es(ne,ce){return ne.scope&&typeof ne.scope=="string"&&Je.openNode(Et.classNameAliases[ne.scope]||ne.scope),ne.beginScope&&(ne.beginScope._wrap?(At(qe,Et.classNameAliases[ne.beginScope._wrap]||ne.beginScope._wrap),qe=""):ne.beginScope._multi&&(Ja(ne.beginScope,ce),qe="")),_e=Object.create(ne,{parent:{value:_e}}),_e}function ts(ne,ce,ve){let Ne=_(ne.endRe,ve);if(Ne){if(ne["on:end"]){const at=new t(ne);ne["on:end"](ce,at),at.isMatchIgnored&&(Ne=!1)}if(Ne){for(;ne.endsParent&&ne.parent;)ne=ne.parent;return ne}}if(ne.endsWithParent)return ts(ne.parent,ce,ve)}function yc(ne){return _e.matcher.regexIndex===0?(qe+=ne[0],1):(ki=!0,0)}function bc(ne){const ce=ne[0],ve=ne.rule,Ne=new t(ve),at=[ve.__beforeBegin,ve["on:begin"]];for(const Tt of at)if(Tt&&(Tt(ne,Ne),Ne.isMatchIgnored))return yc(ce);return ve.skip?qe+=ce:(ve.excludeBegin&&(qe+=ce),gt(),!ve.returnBegin&&!ve.excludeBegin&&(qe=ce)),es(ve,ne),ve.returnBegin?0:ce.length}function wc(ne){const ce=ne[0],ve=ue.substring(ne.index),Ne=ts(_e,ne,ve);if(!Ne)return Xa;const at=_e;_e.endScope&&_e.endScope._wrap?(gt(),At(ce,_e.endScope._wrap)):_e.endScope&&_e.endScope._multi?(gt(),Ja(_e.endScope,ne)):at.skip?qe+=ce:(at.returnEnd||at.excludeEnd||(qe+=ce),gt(),at.excludeEnd&&(qe=ce));do _e.scope&&Je.closeNode(),!_e.skip&&!_e.subLanguage&&(_r+=_e.relevance),_e=_e.parent;while(_e!==Ne.parent);return Ne.starts&&es(Ne.starts,ne),at.returnEnd?0:ce.length}function _c(){const ne=[];for(let ce=_e;ce!==Et;ce=ce.parent)ce.scope&&ne.unshift(ce.scope);ne.forEach(ce=>Je.openNode(ce))}let wr={};function ns(ne,ce){const ve=ce&&ce[0];if(qe+=ne,ve==null)return gt(),0;if(wr.type==="begin"&&ce.type==="end"&&wr.index===ce.index&&ve===""){if(qe+=ue.slice(ce.index,ce.index+1),!We){const Ne=new Error(`0 width match regex (${Q})`);throw Ne.languageName=Q,Ne.badRule=wr.rule,Ne}return 1}if(wr=ce,ce.type==="begin")return bc(ce);if(ce.type==="illegal"&&!Me){const Ne=new Error('Illegal lexeme "'+ve+'" for mode "'+(_e.scope||"<unnamed>")+'"');throw Ne.mode=_e,Ne}else if(ce.type==="end"){const Ne=wc(ce);if(Ne!==Xa)return Ne}if(ce.type==="illegal"&&ve==="")return qe+=`
`,1;if(_i>1e5&&_i>ce.index*3)throw new Error("potential infinite loop, way more iterations than matches");return qe+=ve,ve.length}const Et=Ht(Q);if(!Et)throw $e(Ze.replace("{}",Q)),new Error('Unknown language: "'+Q+'"');const kc=tc(Et);let wi="",_e=je||kc;const rs={},Je=new ae.__emitter(ae);_c();let qe="",_r=0,tn=0,_i=0,ki=!1;try{if(Et.__emitTokens)Et.__emitTokens(ue,Je);else{for(_e.matcher.considerAll();;){_i++,ki?ki=!1:_e.matcher.considerAll(),_e.matcher.lastIndex=tn;const ne=_e.matcher.exec(ue);if(!ne)break;const ce=ue.substring(tn,ne.index),ve=ns(ce,ne);tn=ne.index+ve}ns(ue.substring(tn))}return Je.finalize(),wi=Je.toHTML(),{language:Q,value:wi,relevance:_r,illegal:!1,_emitter:Je,_top:_e}}catch(ne){if(ne.message&&ne.message.includes("Illegal"))return{language:Q,value:pi(ue),illegal:!0,relevance:0,_illegalBy:{message:ne.message,index:tn,context:ue.slice(tn-100,tn+100),mode:ne.mode,resultSoFar:wi},_emitter:Je};if(We)return{language:Q,value:pi(ue),illegal:!1,relevance:0,errorRaised:ne,_emitter:Je,_top:_e};throw ne}}function mi(Q){const ue={value:pi(Q),illegal:!1,relevance:0,_top:oe,_emitter:new ae.__emitter(ae)};return ue._emitter.addText(Q),ue}function yi(Q,ue){ue=ue||ae.languages||Object.keys(B);const Me=mi(Q),je=ue.filter(Ht).filter(Ya).map(gt=>jn(gt,Q,!1));je.unshift(Me);const Ve=je.sort((gt,At)=>{if(gt.relevance!==At.relevance)return At.relevance-gt.relevance;if(gt.language&&At.language){if(Ht(gt.language).supersetOf===At.language)return 1;if(Ht(At.language).supersetOf===gt.language)return-1}return 0}),[_t,Ft]=Ve,br=_t;return br.secondBest=Ft,br}function sc(Q,ue,Me){const je=ue&&ee[ue]||Me;Q.classList.add("hljs"),Q.classList.add(`language-${je}`)}function bi(Q){let ue=null;const Me=Ye(Q);if(me(Me))return;if(yr("before:highlightElement",{el:Q,language:Me}),Q.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",Q);return}if(Q.children.length>0&&(ae.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(Q)),ae.throwUnescapedHTML))throw new ic("One of your code blocks includes unescaped HTML.",Q.innerHTML);ue=Q;const je=ue.textContent,Ve=Me?Ge(je,{language:Me,ignoreIllegals:!0}):yi(je);Q.innerHTML=Ve.value,Q.dataset.highlighted="yes",sc(Q,Me,Ve.language),Q.result={language:Ve.language,re:Ve.relevance,relevance:Ve.relevance},Ve.secondBest&&(Q.secondBest={language:Ve.secondBest.language,relevance:Ve.secondBest.relevance}),yr("after:highlightElement",{el:Q,result:Ve,text:je})}function oc(Q){ae=Ga(ae,Q)}const lc=()=>{mr(),Ke("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function cc(){mr(),Ke("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let Ka=!1;function mr(){function Q(){mr()}if(document.readyState==="loading"){Ka||window.addEventListener("DOMContentLoaded",Q,!1),Ka=!0;return}document.querySelectorAll(ae.cssSelector).forEach(bi)}function uc(Q,ue){let Me=null;try{Me=ue(x)}catch(je){if($e("Language definition for '{}' could not be registered.".replace("{}",Q)),We)$e(je);else throw je;Me=oe}Me.name||(Me.name=Q),B[Q]=Me,Me.rawDefinition=ue.bind(null,x),Me.aliases&&Va(Me.aliases,{languageName:Q})}function hc(Q){delete B[Q];for(const ue of Object.keys(ee))ee[ue]===Q&&delete ee[ue]}function dc(){return Object.keys(B)}function Ht(Q){return Q=(Q||"").toLowerCase(),B[Q]||B[ee[Q]]}function Va(Q,{languageName:ue}){typeof Q=="string"&&(Q=[Q]),Q.forEach(Me=>{ee[Me.toLowerCase()]=ue})}function Ya(Q){const ue=Ht(Q);return ue&&!ue.disableAutodetect}function fc(Q){Q["before:highlightBlock"]&&!Q["before:highlightElement"]&&(Q["before:highlightElement"]=ue=>{Q["before:highlightBlock"](Object.assign({block:ue.el},ue))}),Q["after:highlightBlock"]&&!Q["after:highlightElement"]&&(Q["after:highlightElement"]=ue=>{Q["after:highlightBlock"](Object.assign({block:ue.el},ue))})}function gc(Q){fc(Q),we.push(Q)}function pc(Q){const ue=we.indexOf(Q);ue!==-1&&we.splice(ue,1)}function yr(Q,ue){const Me=Q;we.forEach(function(je){je[Me]&&je[Me](ue)})}function mc(Q){return Ke("10.7.0","highlightBlock will be removed entirely in v12.0"),Ke("10.7.0","Please use highlightElement now."),bi(Q)}Object.assign(x,{highlight:Ge,highlightAuto:yi,highlightAll:mr,highlightElement:bi,highlightBlock:mc,configure:oc,initHighlighting:lc,initHighlightingOnLoad:cc,registerLanguage:uc,unregisterLanguage:hc,listLanguages:dc,getLanguage:Ht,registerAliases:Va,autoDetection:Ya,inherit:Ga,addPlugin:gc,removePlugin:pc}),x.debugMode=function(){We=!1},x.safeMode=function(){We=!0},x.versionString=rc,x.regex={concat:m,lookahead:h,either:w,optional:p,anyNumberOfTimes:d};for(const Q in A)typeof A[Q]=="object"&&e(A[Q]);return Object.assign(x,A),x},fn=Qa({});return fn.newInstance=()=>Qa({}),Sr=fn,fn.HighlightJS=fn,fn.default=fn,Sr}var cs=ls();const Te=Mi(cs);class Fn{constructor(t={}){const{maxSize:n=0,ttlMs:i=0,onEvict:r=null}=t||{};this._map=new Map,this._maxSize=Math.max(0,Number(n)||0),this._ttlMs=Math.max(0,Number(i)||0),this._onEvict=typeof r=="function"?r:null}get size(){return this._map.size}has(t){const n=this._map.get(t);return n?this._ttlMs&&Date.now()-(n.ts||0)>=this._ttlMs?(this._evictKey(t,n),!1):(this._map.delete(t),this._map.set(t,n),!0):!1}get(t){const n=this._map.get(t);if(n){if(this._ttlMs&&Date.now()-(n.ts||0)>=this._ttlMs){this._evictKey(t,n);return}return this._map.delete(t),this._map.set(t,n),n.value}}set(t,n){if(this._map.has(t)&&this._map.delete(t),this._map.set(t,{value:n,ts:Date.now()}),this._maxSize&&this._map.size>this._maxSize)for(;this._map.size>this._maxSize;){const i=this._map.keys().next().value,r=this._map.get(i);if(this._map.delete(i),this._onEvict)try{this._onEvict(i,r&&r.value)}catch{}}return this}delete(t){return this._map.delete(t)}clear(){if(this._onEvict)for(const[t,n]of this._map.entries())try{this._onEvict(t,n&&n.value)}catch{}this._map.clear()}_evictKey(t,n){try{this._map.delete(t)}catch{}if(this._onEvict)try{this._onEvict(t,n&&n.value)}catch{}}}const Dn=new Fn({maxSize:500});let Ti=300*1e3;function us(){Dn.clear()}function hs(e){Ti=Number(e)||0}async function vr(e,t){try{if(!e)return null;const n=Date.now();let i=Dn.get(e);if(i&&i.ok===!1&&n-(i.ts||0)>=Ti&&(Dn.delete(e),i=void 0),i){if(i.module)return i.module;if(i.promise)try{return await i.promise}catch{return null}}const r={promise:null,module:null,ok:null,ts:Date.now()};Dn.set(e,r),r.promise=(async()=>{try{return await t()}catch{return null}})();try{const a=await r.promise;return r.module=a,r.ok=!!a,r.ts=Date.now(),a}catch{return r.module=null,r.ok=!1,r.ts=Date.now(),null}}catch{return null}}async function ds(e){return await vr(e,async()=>{try{return await import(e)}catch{return null}})}const fs="11.11.1",Ae=new Map,gs="https://raw.githubusercontent.com/highlightjs/highlight.js/main/SUPPORTED_LANGUAGES.md",ct={shell:"bash",sh:"bash",zsh:"bash",js:"javascript",ts:"typescript",py:"python",csharp:"cs","c#":"cs"};ct.html="xml",ct.xhtml="xml",ct.markup="xml";const Ar=new Set(["magic","undefined"]);let $t=null,ps=null;async function Er(e=gs){if(e)return $t||($t=(async()=>{try{const t=await fetch(e);if(!t.ok)return;const i=(await t.text()).split(/\r?\n/);let r=-1;for(let c=0;c<i.length;c++)if(/\|\s*Language\s*\|/i.test(i[c])){r=c;break}if(r===-1)return;const a=i[r].replace(/^\||\|$/g,"").split("|").map(c=>c.trim().toLowerCase());let s=a.findIndex(c=>/alias|aliases|equivalent|alt|alternates?/i.test(c));s===-1&&(s=1);let o=a.findIndex(c=>/file|filename|module|module name|module-name|short|slug/i.test(c));if(o===-1){const c=a.findIndex(u=>/language/i.test(u));o=c!==-1?c:0}let l=[];for(let c=r+1;c<i.length;c++){const u=i[c].trim();if(!u||!u.startsWith("|"))break;const g=u.replace(/^\||\|$/g,"").split("|").map(f=>f.trim());if(g.every(f=>/^-+$/.test(f)))continue;const h=g;if(!h.length)continue;const p=(h[o]||h[0]||"").toString().trim().toLowerCase();if(!p||/^-+$/.test(p))continue;Ae.set(p,p);const m=h[s]||"";if(m){const f=String(m).split(",").map(w=>w.replace(/`/g,"").trim()).filter(Boolean);if(f.length){const y=f[0].toLowerCase().replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");y&&/[a-z0-9]/i.test(y)&&(Ae.set(y,y),l.push(y))}}}try{const c=[];for(const u of l){const g=String(u||"").replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");g&&/[a-z0-9]/i.test(g)?c.push(g):Ae.delete(u)}l=c}catch(c){k("[codeblocksManager] cleanup aliases failed",c)}try{let c=0;for(const u of Array.from(Ae.keys())){if(!u||/^-+$/.test(u)||!/[a-z0-9]/i.test(u)){Ae.delete(u),c++;continue}if(/^[:]+/.test(u)){const g=u.replace(/^[:]+/,"");if(g&&/[a-z0-9]/i.test(g)){const h=Ae.get(u);Ae.delete(u),Ae.set(g,h)}else Ae.delete(u),c++}}for(const[u,g]of Array.from(Ae.entries()))(!g||/^-+$/.test(g)||!/[a-z0-9]/i.test(g))&&(Ae.delete(u),c++);try{const u=":---------------------";Ae.has(u)&&(Ae.delete(u),c++)}catch(u){k("[codeblocksManager] remove sep key failed",u)}try{const u=Array.from(Ae.keys()).sort()}catch(u){k("[codeblocksManager] compute supported keys failed",u)}}catch(c){k("[codeblocksManager] ignored error",c)}}catch(t){k("[codeblocksManager] loadSupportedLanguages failed",t)}})(),$t)}const pn=new Set;async function nn(e,t){if($t||(async()=>{try{await Er()}catch(r){k("[codeblocksManager] loadSupportedLanguages (IIFE) failed",r)}})(),$t)try{await $t}catch{}if(e=e==null?"":String(e),e=e.trim(),!e)return!1;const n=e.toLowerCase();if(Ar.has(n))return!1;if(Ae.size&&!Ae.has(n)){const r=ct;if(!r[n]&&!r[e])return!1}if(pn.has(e))return!0;const i=ct;try{const r=(t||e||"").toString().replace(/\.js$/i,"").trim(),a=(i[e]||e||"").toString(),s=(i[r]||r||"").toString();let o=Array.from(new Set([a,s,r,e,i[r],i[e]].filter(Boolean))).map(u=>String(u).toLowerCase()).filter(u=>u&&u!=="undefined");Ae.size&&(o=o.filter(u=>{if(Ae.has(u))return!0;const g=ct[u];return!!(g&&Ae.has(g))}));let l=null,c=null;for(const u of o)try{if(l=await vr(u,async()=>{try{try{try{return await import(`highlight.js/lib/languages/${u}.js`)}catch{return await import(`highlight.js/lib/languages/${u}`)}}catch{try{return await import(`https://cdn.jsdelivr.net/npm/highlight.js/es/languages/${u}.js`)}catch{try{return await import(`https://cdn.jsdelivr.net/npm/highlight.js/lib/languages/${u}.js`)}catch{return null}}}}catch{return null}}),l){const g=l.default||l;try{const h=Ae.size&&Ae.get(e)||u||e;return Te.registerLanguage(h,g),pn.add(h),h!==e&&(Te.registerLanguage(e,g),pn.add(e)),!0}catch(h){c=h}}else try{if(Ae.has(u)||Ae.has(e)){const g=()=>({});try{Te.registerLanguage(u,g),pn.add(u)}catch{}try{u!==e&&(Te.registerLanguage(e,g),pn.add(e))}catch{}return!0}}catch{}}catch(g){c=g}if(c)throw c;return!1}catch{return!1}}let Un=null;function zi(e){const t=e&&e.querySelector?e:typeof document<"u"?document:null;$t||(async()=>{try{await Er()}catch(s){k("[codeblocksManager] loadSupportedLanguages (observer) failed",s)}})();const n=ct,r=Un||(typeof IntersectionObserver>"u"?null:(Un=new IntersectionObserver((s,o)=>{s.forEach(l=>{if(!l.isIntersecting)return;const c=l.target;try{o.unobserve(c)}catch(u){k("[codeblocksManager] observer unobserve failed",u)}(async()=>{try{const u=c.getAttribute&&c.getAttribute("class")||c.className||"",g=u.match(/language-([a-zA-Z0-9_+-]+)/)||u.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(g&&g[1]){const h=(g[1]||"").toLowerCase(),d=n[h]||h,p=Ae.size&&(Ae.get(d)||Ae.get(String(d).toLowerCase()))||d;try{await nn(p)}catch(m){k("[codeblocksManager] registerLanguage failed",m)}try{try{const m=c.textContent||c.innerText||"";m!=null&&(c.textContent=m)}catch{}try{c&&c.dataset&&c.dataset.highlighted&&delete c.dataset.highlighted}catch{}Te.highlightElement(c)}catch(m){k("[codeblocksManager] hljs.highlightElement failed",m)}}else try{const h=c.textContent||"";try{if(Te&&typeof Te.getLanguage=="function"&&Te.getLanguage("plaintext")){const d=Te.highlight(h,{language:"plaintext"});if(d&&d.value)try{if(typeof document<"u"&&document.createRange&&typeof document.createRange=="function"){const p=document.createRange().createContextualFragment(d.value);if(typeof c.replaceChildren=="function")c.replaceChildren(...Array.from(p.childNodes));else{for(;c.firstChild;)c.removeChild(c.firstChild);c.appendChild(p)}}else c.innerHTML=d.value}catch{try{c.innerHTML=d.value}catch{}}}}catch{try{Te.highlightElement(c)}catch(p){k("[codeblocksManager] fallback highlightElement failed",p)}}}catch(h){k("[codeblocksManager] auto-detect plaintext failed",h)}}catch(u){k("[codeblocksManager] observer entry processing failed",u)}})()})},{root:null,rootMargin:"300px",threshold:.1}),Un)),a=t&&t.querySelectorAll?t.querySelectorAll("pre code"):[];if(!r){a.forEach(async s=>{try{const o=s.getAttribute&&s.getAttribute("class")||s.className||"",l=o.match(/language-([a-zA-Z0-9_+-]+)/)||o.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(l&&l[1]){const c=(l[1]||"").toLowerCase(),u=n[c]||c,g=Ae.size&&(Ae.get(u)||Ae.get(String(u).toLowerCase()))||u;try{await nn(g)}catch(h){k("[codeblocksManager] registerLanguage failed (no observer)",h)}}try{try{const c=s.textContent||s.innerText||"";c!=null&&(s.textContent=c)}catch{}try{s&&s.dataset&&s.dataset.highlighted&&delete s.dataset.highlighted}catch{}Te.highlightElement(s)}catch(c){k("[codeblocksManager] hljs.highlightElement failed (no observer)",c)}}catch(o){k("[codeblocksManager] loadSupportedLanguages fallback ignored error",o)}});return}a.forEach(s=>{try{r.observe(s)}catch(o){k("[codeblocksManager] observe failed",o)}})}function ms(e,{useCdn:t=!0}={}){const n=typeof document<"u"&&document.head&&document.head.querySelector?document.head.querySelector("link[data-hl-theme]"):typeof document<"u"?document.querySelector("link[data-hl-theme]"):null,i=n&&n.getAttribute?n.getAttribute("data-hl-theme"):null,r=e==null?"default":String(e),a=r&&String(r).toLowerCase()||"";if(a==="default"||a==="monokai"){try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}return}if(i&&i.toLowerCase()===a)return;if(!t){try{k("Requested highlight theme not bundled; set useCdn=true to load theme from CDN")}catch{}return}const s=a,o=`https://cdn.jsdelivr.net/npm/highlight.js@${fs}/styles/${s}.css`,l=document.createElement("link");l.rel="stylesheet",l.href=o,l.setAttribute("data-hl-theme",s),l.addEventListener("load",()=>{try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}}),document.head.appendChild(l)}let Wt="light";function ys(e,t={}){if(document.querySelector(`link[href="${e}"]`))return;const n=document.createElement("link");if(n.rel="stylesheet",n.href=e,Object.entries(t).forEach(([i,r])=>n.setAttribute(i,r)),document.head.appendChild(n),t["data-bulmaswatch-theme"])try{if(n.getAttribute("data-bulmaswatch-observer"))return;let i=Number(n.getAttribute("data-bulmaswatch-move-count")||0),r=!1;const a=new MutationObserver(()=>{try{if(r)return;const o=n.parentNode;if(!o||o.lastElementChild===n)return;if(i>=1e3){n.setAttribute("data-bulmaswatch-move-stopped","1");return}r=!0;try{o.appendChild(n)}catch{}i+=1,n.setAttribute("data-bulmaswatch-move-count",String(i)),r=!1}catch{}});try{a.observe(document.head,{childList:!0}),n.setAttribute("data-bulmaswatch-observer","1"),n.setAttribute("data-bulmaswatch-move-count",String(i))}catch{}const s=document.head;s&&s.lastElementChild!==n&&s.appendChild(n)}catch{}}function Cr(){try{const e=typeof document<"u"&&document.head?document.head:document,t=Array.from(e.querySelectorAll("link[data-bulmaswatch-theme]"));for(const n of t)n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}try{const e=typeof document<"u"&&document.head?document.head:document,t=Array.from(e.querySelectorAll("style[data-bulma-override]"));for(const n of t)n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}}async function Ri(e="none",t="/"){try{Rt("[bulmaManager] ensureBulma called",{bulmaCustomize:e,pageDir:t})}catch{}if(!e)return;if(e==="none"){try{Cr()}catch{}return}const n=[t+"bulma.css","/bulma.css"],i=Array.from(new Set(n));if(e==="local"){if(Cr(),document.querySelector("style[data-bulma-override]"))return;for(const r of i)try{const a=await fetch(r,{method:"GET"});if(a.ok){const s=await a.text(),o=document.createElement("style");o.setAttribute("data-bulma-override",r),o.appendChild(document.createTextNode(`
/* bulma override: ${r} */
`+s)),document.head.appendChild(o);return}}catch(a){k("[bulmaManager] fetch local bulma candidate failed",a)}return}try{const r=String(e).trim();if(!r)return;Cr();const a=`https://unpkg.com/bulmaswatch/${encodeURIComponent(r)}/bulmaswatch.min.css`;ys(a,{"data-bulmaswatch-theme":r})}catch(r){k("[bulmaManager] ensureBulma failed",r)}}function $i(e){Wt=e==="dark"?"dark":e==="system"?"system":"light";try{const t=Array.from(document.querySelectorAll(".nimbi-mount"));if(t.length>0)for(const n of t)Wt==="dark"?n.setAttribute("data-theme","dark"):Wt==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme");else{const n=document.documentElement;Wt==="dark"?n.setAttribute("data-theme","dark"):Wt==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme")}}catch{}}function bs(e){const t=document.documentElement;for(const[n,i]of Object.entries(e||{}))try{t.style.setProperty(`--${n}`,i)}catch(r){k("[bulmaManager] setThemeVars failed for",n,r)}}function Pi(e){if(!e||!(e instanceof HTMLElement))return()=>{};const t=e.closest&&e.closest(".nimbi-mount")||null;try{t&&(Wt==="dark"?t.setAttribute("data-theme","dark"):Wt==="light"?t.setAttribute("data-theme","light"):t.removeAttribute("data-theme"))}catch{}return()=>{}}const Ii={en:{navigation:"Navigation",onThisPage:"On this page",home:"Home",scrollToTop:"Scroll to top",readingTime:"{minutes} min read",searchPlaceholder:"Search…",searchNoResults:"No results",imagePreviewTitle:"Image preview",imagePreviewFit:"Fit to screen",imagePreviewOriginal:"Original size",imagePreviewZoomOut:"Zoom out",imagePreviewZoomIn:"Zoom in",imagePreviewClose:"Close"},es:{navigation:"Navegación",onThisPage:"En esta página",home:"Inicio",scrollToTop:"Ir arriba",readingTime:"{minutes} min de lectura",searchPlaceholder:"Buscar…",searchNoResults:"Sin resultados",imagePreviewTitle:"Previsualización de imagen",imagePreviewFit:"Ajustar a la pantalla",imagePreviewOriginal:"Tamaño original",imagePreviewZoomOut:"Alejar",imagePreviewZoomIn:"Acercar",imagePreviewClose:"Cerrar"},de:{navigation:"Navigation",onThisPage:"Auf dieser Seite",home:"Startseite",scrollToTop:"Nach oben",readingTime:"{minutes} min Lesezeit",searchPlaceholder:"Suchen…",searchNoResults:"Keine Ergebnisse",imagePreviewTitle:"Bildvorschau",imagePreviewFit:"An Bildschirm anpassen",imagePreviewOriginal:"Originalgröße",imagePreviewZoomOut:"Verkleinern",imagePreviewZoomIn:"Vergrößern",imagePreviewClose:"Schließen"},fr:{navigation:"Navigation",onThisPage:"Sur cette page",home:"Accueil",scrollToTop:"Aller en haut",readingTime:"{minutes} min de lecture",searchPlaceholder:"Rechercher…",searchNoResults:"Aucun résultat",imagePreviewTitle:"Aperçu de l’image",imagePreviewFit:"Ajuster à l’écran",imagePreviewOriginal:"Taille originale",imagePreviewZoomOut:"Dézoomer",imagePreviewZoomIn:"Zoomer",imagePreviewClose:"Fermer"},pt:{navigation:"Navegação",onThisPage:"Nesta página",home:"Início",scrollToTop:"Ir para o topo",readingTime:"{minutes} min de leitura",searchPlaceholder:"Procurar…",searchNoResults:"Sem resultados",imagePreviewTitle:"Visualização da imagem",imagePreviewFit:"Ajustar à tela",imagePreviewOriginal:"Tamanho original",imagePreviewZoomOut:"Diminuir",imagePreviewZoomIn:"Aumentar",imagePreviewClose:"Fechar"}},rn=JSON.parse(JSON.stringify(Ii));let Wn="en";if(typeof navigator<"u"){const e=navigator.language||navigator.languages&&navigator.languages[0]||"en";Wn=String(e).split("-")[0].toLowerCase()}Ii[Wn]||(Wn="en");let Pt=Wn;function an(e,t={}){const n=rn[Pt]||rn.en;let i=n&&n[e]?n[e]:rn.en[e]||"";for(const r of Object.keys(t))i=i.replace(new RegExp(`{${r}}`,"g"),String(t[r]));return i}async function Mr(e,t){if(!e)return;let n=e;try{/^https?:\/\//.test(e)||(n=new URL(e,location.origin+t).toString());const i=await fetch(n);if(!i.ok)return;const r=await i.json();for(const a of Object.keys(r||{}))rn[a]=Object.assign({},rn[a]||{},r[a])}catch{}}function Lr(e){const t=String(e).split("-")[0].toLowerCase();Pt=rn[t]?t:"en"}const ws=Object.freeze(Object.defineProperty({__proto__:null,get currentLang(){return Pt},loadL10nFile:Mr,setLang:Lr,t:an},Symbol.toStringTag,{value:"Module"}));function _s(e){try{return String(e||"").split("/").map(t=>encodeURIComponent(t)).join("/")}catch{return String(e||"")}}function Ni(e,t=null,n=void 0){let r="#/"+_s(String(e||""));t&&(r+="#"+encodeURIComponent(String(t)));try{let a="";if(typeof n=="string")a=n;else if(typeof location<"u"&&location&&location.search)a=location.search;else if(typeof location<"u"&&location&&location.hash)try{const s=et(location.href);s&&s.params&&(a=s.params)}catch{}if(a){const s=typeof a=="string"&&a.startsWith("?")?a.slice(1):a;try{const o=new URLSearchParams(s);o.delete("page");const l=o.toString();l&&(r+="?"+l)}catch{const l=String(s||"").replace(/^page=[^&]*&?/,"");l&&(r+="?"+l)}}}catch{}return r}function et(e){try{const t=new URL(e,typeof location<"u"?location.href:"http://localhost/"),n=t.searchParams.get("page");if(n){let r=null,a="";if(t.hash){const c=t.hash.replace(/^#/,"");if(c.includes("&")){const u=c.split("&");r=u.shift()||null,a=u.join("&")}else r=c||null}const s=new URLSearchParams(t.search);s.delete("page");const l=[s.toString(),a].filter(Boolean).join("&");return{type:"canonical",page:decodeURIComponent(n),anchor:r,params:l}}const i=t.hash?decodeURIComponent(t.hash.replace(/^#/,"")):"";if(i&&i.startsWith("/")){let r=i,a="";if(r.indexOf("?")!==-1){const c=r.split("?");r=c.shift()||"",a=c.join("?")||""}let s=r,o=null;if(s.indexOf("#")!==-1){const c=s.split("#");s=c.shift()||"",o=c.join("#")||null}return{type:"cosmetic",page:s.replace(/^\/+/,"")||null,anchor:o,params:a}}return{type:"path",page:(t.pathname||"").replace(/^\//,"")||null,anchor:t.hash?t.hash.replace(/^#/,""):null,params:t.search?t.search.replace(/^\?/,""):""}}catch{return{type:"unknown",page:e,anchor:null,params:""}}}let Zn=typeof DOMParser<"u"?new DOMParser:null;function He(){return Zn||(typeof DOMParser<"u"?(Zn=new DOMParser,Zn):null)}async function mn(e,t,n=4){if(!Array.isArray(e)||e.length===0)return[];const i=new Array(e.length);let r=0;const a=[],s=Math.max(1,Number(n)||1);async function o(){for(;;){const l=r++;if(l>=e.length)return;try{i[l]=await t(e[l],l)}catch{i[l]=void 0}}}for(let l=0;l<Math.min(s,e.length);l++)a.push(o());return await Promise.all(a),i}const ks=`/**
...
`;for(let f=l;f<=c;f++)if((t(h[f])||!g(h[f])&&(g(h[f+1])||t(h[f+1])))&&o++,t(h[f]))for(;f<=c&&(i(h[f+1])||g(h[f+1]));)f++;const d=o/u,p=Math.round(d*60*1e3);return{text:Math.ceil(d.toFixed(2))+" min read",minutes:d,time:p,words:o}}return jr=r,jr}var Ks=Qs();const Vs=Mi(Ks),kn=new Map,Ys=200;function Js(e){return String(e||"")}function eo(e,t){if(kn.set(e,t),kn.size>Ys){const n=kn.keys().next().value;n&&kn.delete(n)}}function to(e){return e?String(e).trim().split(/\s+/).filter(Boolean).length:0}function no(e){const t=Js(e),n=kn.get(t);if(n)return Object.assign({},n);const i=Vs(e||""),r=typeof i.words=="number"?i.words:to(e),a={readingTime:i,wordCount:r};return eo(t,a),Object.assign({},a)}function xn(e,t){let n=document.querySelector(`meta[name="${e}"]`);n||(n=document.createElement("meta"),n.setAttribute("name",e),document.head.appendChild(n)),n.setAttribute("content",t)}function jt(e,t,n){let i=`meta[${e}="${t}"]`,r=document.querySelector(i);r||(r=document.createElement("meta"),r.setAttribute(e,t),document.head.appendChild(r)),r.setAttribute("content",n)}function ta(e,t){try{let n=document.querySelector(`link[rel="${e}"]`);n||(n=document.createElement("link"),n.setAttribute("rel",e),document.head.appendChild(n)),n.setAttribute("href",t)}catch(n){k("[seoManager] upsertLinkRel failed",n)}}function ro(e,t,n,i){const r=t&&String(t).trim()?t:e.title||document.title;jt("property","og:title",r);const a=i&&String(i).trim()?i:e.description||"";a&&String(a).trim()&&jt("property","og:description",a),a&&String(a).trim()&&jt("name","twitter:description",a),jt("name","twitter:card",e.twitter_card||"summary_large_image");const s=n||e.image;s&&(jt("property","og:image",s),jt("name","twitter:image",s))}function qr(e,t,n,i,r=""){const a=e.meta||{},s=document&&document.querySelector&&document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",o=i&&String(i).trim()?i:a.description&&String(a.description).trim()?a.description:s&&String(s).trim()?s:"";o&&String(o).trim()&&xn("description",o),xn("robots",a.robots||"index,follow"),ro(a,t,n,o)}function io(){try{const e=['meta[name="site"]','meta[name="site-name"]','meta[name="siteName"]','meta[property="og:site_name"]','meta[name="twitter:site"]'];for(const t of e){const n=document.querySelector(t);if(n){const i=n.getAttribute("content")||"";if(i&&i.trim())return i.trim()}}}catch(e){k("[seoManager] getSiteNameFromMeta failed",e)}return""}function Hr(e,t,n,i,r,a=""){try{const s=e.meta||{},o=n&&String(n).trim()?n:s.title||a||document.title,l=r&&String(r).trim()?r:s.description||document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",c=i||s.image||null;let u="";try{if(t){const p=Y(t);try{u=(location.origin+location.pathname).split("?")[0]+"?page="+encodeURIComponent(p)}catch{u=location.href.split("#")[0]}}else u=location.href.split("#")[0]}catch(p){u=location.href.split("#")[0],k("[seoManager] compute canonical failed",p)}u&&ta("canonical",u);try{jt("property","og:url",u)}catch(p){k("[seoManager] upsertMeta og:url failed",p)}const g={"@context":"https://schema.org","@type":"Article",headline:o||"",description:l||"",url:u||location.href.split("#")[0]};c&&(g.image=String(c)),s.date&&(g.datePublished=s.date),s.dateModified&&(g.dateModified=s.dateModified);const h="nimbi-jsonld";let d=document.getElementById(h);d||(d=document.createElement("script"),d.type="application/ld+json",d.id=h,document.head.appendChild(d)),d.textContent=JSON.stringify(g,null,2)}catch(s){k("[seoManager] setStructuredData failed",s)}}let Sn=typeof window<"u"&&window.__SEO_MAP?window.__SEO_MAP:{};function ao(e){try{if(!e||typeof e!="object"){Sn={};return}Sn=Object.assign({},e)}catch(t){k("[seoManager] setSeoMap failed",t)}}function so(e,t=""){try{if(!e)return;const n=Sn&&Sn[e]?Sn[e]:typeof window<"u"&&window.__SEO_MAP&&window.__SEO_MAP[e]?window.__SEO_MAP[e]:null;try{const i=location.origin+location.pathname+"?page="+encodeURIComponent(String(e||""));ta("canonical",i);try{jt("property","og:url",i)}catch{}}catch{}if(!n)return;try{n.title&&(document.title=String(n.title))}catch{}try{n.description&&xn("description",String(n.description))}catch{}try{try{qr({meta:n},n.title||void 0,n.image||void 0,n.description||void 0,t)}catch{}}catch{}try{Hr({meta:n},e,n.title||void 0,n.image||void 0,n.description||void 0,t)}catch(i){k("[seoManager] inject structured data failed",i)}}catch(n){k("[seoManager] injectSeoForPage failed",n)}}function er(e={},t="",n=void 0,i=void 0){try{const r=e||{},a=typeof n=="string"&&n.trim()?n:r.title||"Not Found",s=typeof i=="string"&&i.trim()?i:r.description||"";try{xn("robots","noindex,follow")}catch{}try{s&&String(s).trim()&&xn("description",String(s))}catch{}try{qr({meta:Object.assign({},r,{robots:"noindex,follow"})},a,r.image||void 0,s)}catch{}try{Hr({meta:Object.assign({},r,{title:a,description:s})},t||"",a,r.image||void 0,s)}catch{}}catch(r){k("[seoManager] markNotFound failed",r)}}function oo(e,t,n,i,r,a,s,o,l,c,u){try{if(i&&i.querySelector){const g=i.querySelector(".menu-label");g&&(g.textContent=o&&o.textContent||e("onThisPage"))}}catch(g){k("[seoManager] update toc label failed",g)}try{const g=n.meta&&n.meta.title?String(n.meta.title).trim():"",h=r.querySelector("img"),d=h&&(h.getAttribute("src")||h.src)||null;let p="";try{let w="";try{const y=o||(r&&r.querySelector?r.querySelector("h1"):null);if(y){let _=y.nextElementSibling;const b=[];for(;_&&!(_.tagName&&_.tagName.toLowerCase()==="h2");){try{if(_.classList&&_.classList.contains("nimbi-article-subtitle")){_=_.nextElementSibling;continue}}catch{}const v=(_.textContent||"").trim();v&&b.push(v),_=_.nextElementSibling}b.length&&(w=b.join(" ").replace(/\s+/g," ").trim()),!w&&l&&(w=String(l).trim())}}catch(y){k("[seoManager] compute descOverride failed",y)}w&&String(w).length>160&&(w=String(w).slice(0,157).trim()+"..."),p=w}catch(w){k("[seoManager] compute descOverride failed",w)}let m="";try{g&&(m=g)}catch{}if(!m)try{o&&o.textContent&&(m=String(o.textContent).trim())}catch{}if(!m)try{const w=r.querySelector("h2");w&&w.textContent&&(m=String(w.textContent).trim())}catch{}m||(m=a||"");try{qr(n,m||void 0,d,p)}catch(w){k("[seoManager] setMetaTags failed",w)}try{Hr(n,c,m||void 0,d,p,t)}catch(w){k("[seoManager] setStructuredData failed",w)}const f=io();m?f?document.title=`${f} - ${m}`:document.title=`${t||"Site"} - ${m}`:g?document.title=g:document.title=t||document.title}catch(g){k("[seoManager] applyPageMeta failed",g)}try{try{const g=r.querySelectorAll(".nimbi-reading-time");g&&g.forEach(h=>h.remove())}catch{}if(l){const g=no(u.raw||""),h=g&&g.readingTime?g.readingTime:null,d=h&&typeof h.minutes=="number"?Math.ceil(h.minutes):0,p=d?e("readingTime",{minutes:d}):"";if(!p)return;const m=r.querySelector("h1");if(m){const f=r.querySelector(".nimbi-article-subtitle");try{if(f){const w=document.createElement("span");w.className="nimbi-reading-time",w.textContent=p,f.appendChild(w)}else{const w=document.createElement("p");w.className="nimbi-article-subtitle is-6 has-text-grey-light";const y=document.createElement("span");y.className="nimbi-reading-time",y.textContent=p,w.appendChild(y);try{m.parentElement.insertBefore(w,m.nextSibling)}catch{try{m.insertAdjacentElement("afterend",w)}catch{}}}}catch{try{const y=document.createElement("p");y.className="nimbi-article-subtitle is-6 has-text-grey-light";const _=document.createElement("span");_.className="nimbi-reading-time",_.textContent=p,y.appendChild(_),m.insertAdjacentElement("afterend",y)}catch{}}}}}catch(g){k("[seoManager] reading time update failed",g)}}let na=100;function ra(e){na=e}function ht(){try{if(Ut(2))return!0}catch{}try{return!1}catch{return!1}}let vn=300*1e3,An=null;function dt(e,t,n){try{if(typeof Oe=="function"&&typeof Oe.length=="number"&&Oe.length>=3)return Oe(e,t,{signal:n})}catch{}return Oe(e,t)}function ia(e){vn=e}const pt=new Map;function lo(e){if(!pt.has(e))return;const t=pt.get(e),n=Date.now();if(t.ts+vn<n){pt.delete(e);return}return pt.delete(e),pt.set(e,t),t.value}function co(e,t){if(aa(),aa(),pt.delete(e),pt.set(e,{value:t,ts:Date.now()}),pt.size>na){const n=pt.keys().next().value;n!==void 0&&pt.delete(n)}}function aa(){if(!vn||vn<=0)return;const e=Date.now();for(const[t,n]of pt.entries())n.ts+vn<e&&pt.delete(t)}async function uo(e,t,n){const i=new Set(tt);let r=[];try{if(typeof document<"u"&&document.getElementsByClassName){const a=s=>{const o=document.getElementsByClassName(s);for(let l=0;l<o.length;l++){const c=o[l].getElementsByTagName("a");for(let u=0;u<c.length;u++)r.push(c[u])}};a("nimbi-site-navbar"),a("navbar"),a("nimbi-nav")}else r=Array.from(document.querySelectorAll(".nimbi-site-navbar a, .navbar a, .nimbi-nav a"))}catch{try{r=Array.from(document.querySelectorAll(".nimbi-site-navbar a, .navbar a, .nimbi-nav a"))}catch{r=[]}}for(const a of Array.from(r||[])){const s=a.getAttribute("href")||"";if(s)try{try{const h=et(s);if(h){if(h.type==="canonical"&&h.page){const d=Y(h.page);if(d){i.add(d);continue}}if(h.type==="cosmetic"&&h.page){const d=h.page;if(K.has(d)){const p=K.get(d);if(p)return p}continue}}}catch{}const o=new URL(s,location.href);if(o.origin!==location.origin)continue;const l=(o.hash||o.pathname).match(/([^#?]+\.md)(?:$|[?#])/)||(o.pathname||"").match(/([^#?]+\.md)(?:$|[?#])/);if(l){let h=Y(l[1]);h&&i.add(h);continue}const c=(a.textContent||"").trim(),u=(o.pathname||"").replace(/^.*\//,"");if(c&&he(c)===e||u&&he(u.replace(/\.(html?|md)$/i,""))===e)return o.toString();if(/\.(html?)$/i.test(o.pathname)){let h=o.pathname.replace(/^\//,"");i.add(h);continue}const g=o.pathname||"";if(g){const h=new URL(t),d=Xt(h.pathname);if(g.indexOf(d)!==-1){let p=g.startsWith(d)?g.slice(d.length):g;p=Y(p),p&&i.add(p)}}}catch(o){k("[router] malformed URL while discovering index candidates",o)}}for(const a of i)try{if(!a||!String(a).includes(".md"))continue;const s=await dt(a,t,n);if(!s||!s.raw)continue;const o=(s.raw||"").match(/^#\s+(.+)$/m);if(o){const l=(o[1]||"").trim();if(l&&he(l)===e)return a}}catch(s){k("[router] fetchMarkdown during index discovery failed",s)}return null}function ho(e){const t=[];if(String(e).includes(".md")||String(e).includes(".html"))/index\.html$/i.test(e)||t.push(e);else try{const n=decodeURIComponent(String(e||""));if(K.has(n)){const i=ln(n)||K.get(n);i&&(/\.(md|html?)$/i.test(i)?/index\.html$/i.test(i)||t.push(i):(t.push(i),t.push(i+".html")))}else{if(tt&&tt.size)for(const i of tt){const r=i.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(he(r)===n&&!/index\.html$/i.test(i)){t.push(i);break}}!t.length&&n&&!/\.(md|html?)$/i.test(n)&&(t.push(n+".html"),t.push(n+".md"))}}catch(n){k("[router] buildPageCandidates failed during slug handling",n)}return t}async function fo(e,t){const n=e||"";try{try{Ei("fetchPageData")}catch{}try{Ci("fetchPageData")}catch{}}catch{}try{if(An&&typeof An.abort=="function")try{An.abort()}catch{}}catch{}An=typeof AbortController<"u"?new AbortController:null;const i=An;let r=null;try{const y=et(typeof location<"u"?location.href:"");y&&y.anchor&&(r=y.anchor)}catch{try{r=location&&location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null}catch{r=null}}let a=e||"",s=null;const o=String(n||"").includes(".md")||String(n||"").includes(".html");if(a&&String(a).includes("::")){const y=String(a).split("::",2);a=y[0],s=y[1]||null}const c=`${e}|||${typeof ws<"u"&&Pt?Pt:""}`,u=lo(c);if(u)a=u.resolved,s=u.anchor||s;else{if(!String(a).includes(".md")&&!String(a).includes(".html")){let y=decodeURIComponent(String(a||""));if(y&&typeof y=="string"&&(y=Y(y),y=on(y)),K.has(y))a=ln(y)||K.get(y);else{let _=await uo(y,t,i?i.signal:void 0);if(_)a=_;else if(Gt._refreshed&&tt&&tt.size||typeof t=="string"&&/^[a-z][a-z0-9+.-]*:\/\//i.test(t)){const b=await Ji(y,t);b&&(a=b)}}}co(c,{resolved:a,anchor:s})}let g=!0;try{const y=String(a||"").includes(".md")||String(a||"").includes(".html")||a&&(a.startsWith("http://")||a.startsWith("https://")||a.startsWith("/"));g=typeof le=="string"&&le||K.has(a)||tt&&tt.size||Gt._refreshed||o||y}catch{g=!0}!s&&r&&(s=r);try{if(g&&a&&(a.startsWith("http://")||a.startsWith("https://")||a.startsWith("/"))){const y=a.startsWith("/")?new URL(a,location.origin).toString():a;try{const _=await fetch(y,i?{signal:i.signal}:void 0);if(_&&_.ok){const b=await _.text(),v=_&&_.headers&&typeof _.headers.get=="function"&&_.headers.get("content-type")||"",S=(b||"").toLowerCase();if(v&&v.indexOf&&v.indexOf("text/html")!==-1||S.indexOf("<!doctype")!==-1||S.indexOf("<html")!==-1){if(!o)try{let I=y;try{I=new URL(y).pathname.replace(/^\//,"")}catch{I=String(y||"").replace(/^\//,"")}const U=I.replace(/\.html$/i,".md");try{const z=await dt(U,t,i?i.signal:void 0);if(z&&z.raw)return{data:z,pagePath:U,anchor:s}}catch{}if(typeof le=="string"&&le)try{const z=await dt(le,t,i?i.signal:void 0);if(z&&z.raw){try{er(z.meta||{},le)}catch{}return{data:z,pagePath:le,anchor:s}}}catch{}try{w=new Error("site shell detected (absolute fetch)")}catch{}}catch{}if(S.indexOf('<div id="app"')!==-1||S.indexOf("nimbi-cms")!==-1||S.indexOf("nimbi-mount")!==-1||S.indexOf("nimbi-")!==-1||S.indexOf("initcms(")!==-1||S.indexOf("window.nimbi")!==-1||/\bnimbi\b/.test(S))try{let I=y;try{I=new URL(y).pathname.replace(/^\//,"")}catch{I=String(y||"").replace(/^\//,"")}const U=I.replace(/\.html$/i,".md");try{const z=await dt(U,t,i?i.signal:void 0);if(z&&z.raw)return{data:z,pagePath:U,anchor:s}}catch{}if(typeof le=="string"&&le)try{const z=await dt(le,t,i?i.signal:void 0);if(z&&z.raw){try{er(z.meta||{},le)}catch{}return{data:z,pagePath:le,anchor:s}}}catch{}try{w=new Error("site shell detected (absolute fetch)")}catch{}}catch{}}}}catch{}}}catch{}const h=ho(a);try{if(ht())try{Rt("[router-debug] fetchPageData candidates",{originalRaw:n,resolved:a,pageCandidates:h})}catch{}}catch{}const d=String(n||"").includes(".md")||String(n||"").includes(".html");let p=null;if(!d)try{let y=decodeURIComponent(String(n||""));y=Y(y),y=on(y),y&&!/\.(md|html?)$/i.test(y)&&(p=y)}catch{p=null}if(d&&h.length===0&&(String(a).includes(".md")||String(a).includes(".html"))&&h.push(a),h.length===0&&(String(a).includes(".md")||String(a).includes(".html"))&&h.push(a),h.length===1&&/index\.html$/i.test(h[0])&&!d&&!K.has(a)&&!K.has(decodeURIComponent(String(a||"")))&&!String(a||"").includes("/"))throw new Error("Unknown slug: index.html fallback prevented");let m=null,f=null,w=null;try{const y=String(a||"").includes(".md")||String(a||"").includes(".html")||a&&(a.startsWith("http://")||a.startsWith("https://")||a.startsWith("/"));g=typeof le=="string"&&le||K.has(a)||tt&&tt.size||Gt._refreshed||d||y}catch{g=!0}if(!g)w=new Error("no page data");else for(const y of h)if(y)try{const _=Y(y);if(m=await dt(_,t,i?i.signal:void 0),f=_,p&&!K.has(p))try{let b="";if(m&&m.isHtml)try{const v=He();if(v){const S=v.parseFromString(m.raw||"","text/html"),E=S.querySelector("h1")||S.querySelector("title");E&&E.textContent&&(b=E.textContent.trim())}}catch{}else{const v=(m&&m.raw||"").match(/^#\s+(.+)$/m);v&&v[1]&&(b=v[1].trim())}if(b&&he(b)!==p)try{if(/\.html$/i.test(_)){const S=_.replace(/\.html$/i,".md");if(h.includes(S))try{const E=await dt(S,t,i?i.signal:void 0);if(E&&E.raw)m=E,f=S;else if(typeof le=="string"&&le)try{const P=await dt(le,t,i?i.signal:void 0);if(P&&P.raw)m=P,f=le;else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{m=null,f=null,w=new Error("slug mismatch for candidate");continue}else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{try{const P=await dt(le,t,i?i.signal:void 0);if(P&&P.raw)m=P,f=le;else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{}try{if(!d&&/\.html$/i.test(_)){const b=_.replace(/\.html$/i,".md");if(h.includes(b))try{const S=String(m&&m.raw||"").trim().slice(0,128).toLowerCase();if(m&&m.isHtml||/^(?:<!doctype|<html|<title|<h1)/i.test(S)||S.indexOf('<div id="app"')!==-1||S.indexOf("nimbi-")!==-1||S.indexOf("nimbi")!==-1||S.indexOf("initcms(")!==-1){let P=!1;try{const I=await dt(b,t,i?i.signal:void 0);if(I&&I.raw)m=I,f=b,P=!0;else if(typeof le=="string"&&le)try{const U=await dt(le,t,i?i.signal:void 0);U&&U.raw&&(m=U,f=le,P=!0)}catch{}}catch{try{const U=await dt(le,t,i?i.signal:void 0);U&&U.raw&&(m=U,f=le,P=!0)}catch{}}if(!P){m=null,f=null,w=new Error("site shell detected (candidate HTML rejected)");continue}}}catch{}}}catch{}try{if(ht())try{Rt("[router-debug] fetchPageData accepted candidate",{candidate:_,pagePath:f,isHtml:m&&m.isHtml,snippet:m&&m.raw?String(m.raw).slice(0,160):null})}catch{}}catch{}break}catch(_){w=_;try{ht()&&k("[router] candidate fetch failed",{candidate:y,contentBase:t,err:_&&_.message||_})}catch{}}if(!m){const y=w&&(w.message||String(w))||null,_=y&&/failed to fetch md|site shell detected/i.test(y);try{if(ht())try{Rt("[router-debug] fetchPageData no data",{originalRaw:n,resolved:a,pageCandidates:h,fetchError:y})}catch{}}catch{}if(_)try{if(ht())try{k("[router] fetchPageData: no page data (expected)",{originalRaw:n,resolved:a,pageCandidates:h,contentBase:t,fetchError:y})}catch{}}catch{}else try{if(ht())try{qn("[router] fetchPageData: no page data for",{originalRaw:n,resolved:a,pageCandidates:h,contentBase:t,fetchError:y})}catch{}}catch{}if(typeof le=="string"&&le)try{const b=await dt(le,t,i?i.signal:void 0);if(b&&b.raw){try{er(b.meta||{},le)}catch{}return{data:b,pagePath:le,anchor:s}}}catch{}try{if(d&&String(n||"").toLowerCase().includes(".html"))try{const b=new URL(String(n||""),location.href).toString();ht()&&k("[router] attempting absolute HTML fetch fallback",b);const v=await fetch(b,i?{signal:i.signal}:void 0);if(v&&v.ok){const S=await v.text(),E=v&&v.headers&&typeof v.headers.get=="function"&&v.headers.get("content-type")||"",P=(S||"").toLowerCase(),I=E&&E.indexOf&&E.indexOf("text/html")!==-1||P.indexOf("<!doctype")!==-1||P.indexOf("<html")!==-1;if(!I&&ht())try{k("[router] absolute fetch returned non-HTML",()=>({abs:b,contentType:E,snippet:P.slice(0,200)}))}catch{}if(I){const U=(S||"").toLowerCase();if(/<title>\s*index of\b/i.test(S)||/<h1>\s*index of\b/i.test(S)||U.indexOf("parent directory")!==-1||/<title>\s*directory listing/i.test(S)||/<h1>\s*directory listing/i.test(S))try{ht()&&k("[router] absolute fetch returned directory listing; treating as not found",{abs:b})}catch{}else try{const O=b,W=new URL(".",O).toString();try{const H=He();if(H){const M=H.parseFromString(S||"","text/html"),F=(J,Re)=>{try{const ke=Re.getAttribute(J)||"";if(!ke||/^(https?:)?\/\//i.test(ke)||ke.startsWith("/")||ke.startsWith("#"))return;try{const xe=new URL(ke,O).toString();Re.setAttribute(J,xe)}catch(xe){k("[router] rewrite attribute failed",J,xe)}}catch(ke){k("[router] rewrite helper failed",ke)}},G=M.querySelectorAll("[src],[href],[srcset],[xlink:href],[poster]"),ie=[];for(const J of Array.from(G||[]))try{const Re=J.tagName?J.tagName.toLowerCase():"";if(Re==="a")continue;if(J.hasAttribute("src")){const ke=J.getAttribute("src");F("src",J);const xe=J.getAttribute("src");ke!==xe&&ie.push({attr:"src",tag:Re,before:ke,after:xe})}if(J.hasAttribute("href")&&Re==="link"){const ke=J.getAttribute("href");F("href",J);const xe=J.getAttribute("href");ke!==xe&&ie.push({attr:"href",tag:Re,before:ke,after:xe})}if(J.hasAttribute("href")&&Re!=="link"){const ke=J.getAttribute("href");F("href",J);const xe=J.getAttribute("href");ke!==xe&&ie.push({attr:"href",tag:Re,before:ke,after:xe})}if(J.hasAttribute("xlink:href")){const ke=J.getAttribute("xlink:href");F("xlink:href",J);const xe=J.getAttribute("xlink:href");ke!==xe&&ie.push({attr:"xlink:href",tag:Re,before:ke,after:xe})}if(J.hasAttribute("poster")){const ke=J.getAttribute("poster");F("poster",J);const xe=J.getAttribute("poster");ke!==xe&&ie.push({attr:"poster",tag:Re,before:ke,after:xe})}if(J.hasAttribute("srcset")){const Ce=(J.getAttribute("srcset")||"").split(",").map(Fe=>Fe.trim()).filter(Boolean).map(Fe=>{const[R,N]=Fe.split(/\s+/,2);if(!R||/^(https?:)?\/\//i.test(R)||R.startsWith("/"))return Fe;try{const C=new URL(R,O).toString();return N?`${C} ${N}`:C}catch{return Fe}}).join(", ");J.setAttribute("srcset",Ce)}}catch{}const ye=M.documentElement&&M.documentElement.outerHTML?M.documentElement.outerHTML:S;try{ht()&&ie&&ie.length&&k("[router] rewritten asset refs",{abs:b,rewritten:ie})}catch{}return{data:{raw:ye,isHtml:!0},pagePath:String(n||""),anchor:s}}}catch{}let te=S;return/<base\s+[^>]*>/i.test(S)||(/<head[^>]*>/i.test(S)?te=S.replace(/(<head[^>]*>)/i,`$1<base href="${W}">`):te=`<base href="${W}">`+S),{data:{raw:te,isHtml:!0},pagePath:String(n||""),anchor:s}}catch{return{data:{raw:S,isHtml:!0},pagePath:String(n||""),anchor:s}}}}}catch(b){ht()&&k("[router] absolute HTML fetch fallback failed",b)}}catch{}try{const b=decodeURIComponent(String(a||""));if(b&&!/\.(md|html?)$/i.test(b)&&typeof le=="string"&&le&&ht()){const S=[`/assets/${b}.html`,`/assets/${b}/index.html`];for(const E of S)try{const P=await fetch(E,Object.assign({method:"GET"},i?{signal:i.signal}:{}));if(P&&P.ok)return{data:{raw:await P.text(),isHtml:!0},pagePath:E.replace(/^\//,""),anchor:s}}catch{}}}catch(b){ht()&&k("[router] assets fallback failed",b)}throw new Error("no page data")}return{data:m,pagePath:f,anchor:s}}function tr(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var qt=tr();function sa(e){qt=e}var Vt={exec:()=>null};function Le(e,t=""){let n=typeof e=="string"?e:e.source,i={replace:(r,a)=>{let s=typeof a=="string"?a:a.source;return s=s.replace(lt.caret,"$1"),n=n.replace(r,s),i},getRegex:()=>new RegExp(n,t)};return i}var go=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),lt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}>`)},po=/^(?:[ \t]*(?:\n|$))+/,mo=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,yo=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,En=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,bo=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Fr=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,oa=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,la=Le(oa).replace(/bull/g,Fr).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),wo=Le(oa).replace(/bull/g,Fr).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Dr=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,_o=/^[^\n]+/,Ur=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,ko=Le(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Ur).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),xo=Le(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Fr).getRegex(),nr="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Wr=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,So=Le("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Wr).replace("tag",nr).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),ca=Le(Dr).replace("hr",En).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",nr).getRegex(),vo=Le(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",ca).getRegex(),Zr={blockquote:vo,code:mo,def:ko,fences:yo,heading:bo,hr:En,html:So,lheading:la,list:xo,newline:po,paragraph:ca,table:Vt,text:_o},ua=Le("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",En).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",nr).getRegex(),Ao={...Zr,lheading:wo,table:ua,paragraph:Le(Dr).replace("hr",En).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",ua).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",nr).getRegex()},Eo={...Zr,html:Le(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Wr).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Vt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:Le(Dr).replace("hr",En).replace("heading",` *#{1,6} *[^
]`).replace("lheading",la).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Co=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Mo=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,ha=/^( {2,}|\\)\n(?!\s*$)/,Lo=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,rr=/[\p{P}\p{S}]/u,Gr=/[\s\p{P}\p{S}]/u,da=/[^\s\p{P}\p{S}]/u,To=Le(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Gr).getRegex(),fa=/(?!~)[\p{P}\p{S}]/u,zo=/(?!~)[\s\p{P}\p{S}]/u,Ro=/(?:[^\s\p{P}\p{S}]|~)/u,ga=/(?![*_])[\p{P}\p{S}]/u,$o=/(?![*_])[\s\p{P}\p{S}]/u,Po=/(?:[^\s\p{P}\p{S}]|[*_])/u,Io=Le(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",go?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),pa=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,No=Le(pa,"u").replace(/punct/g,rr).getRegex(),Oo=Le(pa,"u").replace(/punct/g,fa).getRegex(),ma="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Bo=Le(ma,"gu").replace(/notPunctSpace/g,da).replace(/punctSpace/g,Gr).replace(/punct/g,rr).getRegex(),jo=Le(ma,"gu").replace(/notPunctSpace/g,Ro).replace(/punctSpace/g,zo).replace(/punct/g,fa).getRegex(),qo=Le("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,da).replace(/punctSpace/g,Gr).replace(/punct/g,rr).getRegex(),Ho=Le(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,ga).getRegex(),Fo="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",Do=Le(Fo,"gu").replace(/notPunctSpace/g,Po).replace(/punctSpace/g,$o).replace(/punct/g,ga).getRegex(),Uo=Le(/\\(punct)/,"gu").replace(/punct/g,rr).getRegex(),Wo=Le(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Zo=Le(Wr).replace("(?:-->|$)","-->").getRegex(),Go=Le("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Zo).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),ir=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Xo=Le(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",ir).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),ya=Le(/^!?\[(label)\]\[(ref)\]/).replace("label",ir).replace("ref",Ur).getRegex(),ba=Le(/^!?\[(ref)\](?:\[\])?/).replace("ref",Ur).getRegex(),Qo=Le("reflink|nolink(?!\\()","g").replace("reflink",ya).replace("nolink",ba).getRegex(),wa=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Xr={_backpedal:Vt,anyPunctuation:Uo,autolink:Wo,blockSkip:Io,br:ha,code:Mo,del:Vt,delLDelim:Vt,delRDelim:Vt,emStrongLDelim:No,emStrongRDelimAst:Bo,emStrongRDelimUnd:qo,escape:Co,link:Xo,nolink:ba,punctuation:To,reflink:ya,reflinkSearch:Qo,tag:Go,text:Lo,url:Vt},Ko={...Xr,link:Le(/^!?\[(label)\]\((.*?)\)/).replace("label",ir).getRegex(),reflink:Le(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",ir).getRegex()},Qr={...Xr,emStrongRDelimAst:jo,emStrongLDelim:Oo,delLDelim:Ho,delRDelim:Do,url:Le(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",wa).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:Le(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",wa).getRegex()},Vo={...Qr,br:Le(ha).replace("{2,}","*").getRegex(),text:Le(Qr.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},ar={normal:Zr,gfm:Ao,pedantic:Eo},Cn={normal:Xr,gfm:Qr,breaks:Vo,pedantic:Ko},Yo={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},_a=e=>Yo[e];function kt(e,t){if(t){if(lt.escapeTest.test(e))return e.replace(lt.escapeReplace,_a)}else if(lt.escapeTestNoEncode.test(e))return e.replace(lt.escapeReplaceNoEncode,_a);return e}function ka(e){try{e=encodeURI(e).replace(lt.percentDecode,"%")}catch{return null}return e}function xa(e,t){let n=e.replace(lt.findPipe,(a,s,o)=>{let l=!1,c=s;for(;--c>=0&&o[c]==="\\";)l=!l;return l?"|":" |"}),i=n.split(lt.splitPipe),r=0;if(i[0].trim()||i.shift(),i.length>0&&!i.at(-1)?.trim()&&i.pop(),t)if(i.length>t)i.splice(t);else for(;i.length<t;)i.push("");for(;r<i.length;r++)i[r]=i[r].trim().replace(lt.slashPipe,"|");return i}function Mn(e,t,n){let i=e.length;if(i===0)return"";let r=0;for(;r<i&&e.charAt(i-r-1)===t;)r++;return e.slice(0,i-r)}function Jo(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let i=0;i<e.length;i++)if(e[i]==="\\")i++;else if(e[i]===t[0])n++;else if(e[i]===t[1]&&(n--,n<0))return i;return n>0?-2:-1}function el(e,t=0){let n=t,i="";for(let r of e)if(r==="	"){let a=4-n%4;i+=" ".repeat(a),n+=a}else i+=r,n++;return i}function Sa(e,t,n,i,r){let a=t.href,s=t.title||null,o=e[1].replace(r.other.outputLinkReplace,"$1");i.state.inLink=!0;let l={type:e[0].charAt(0)==="!"?"image":"link",raw:n,href:a,title:s,text:o,tokens:i.inlineTokens(o)};return i.state.inLink=!1,l}function tl(e,t,n){let i=e.match(n.other.indentCodeCompensation);if(i===null)return t;let r=i[1];return t.split(`
...
`,n}function fi(e){const t=e&&Array.isArray(e.entries)?e.entries:Array.isArray(e)?e:[],n=ui().split("?")[0];let i=`<?xml version="1.0" encoding="UTF-8"?>
`;i+=`<rss version="2.0">
`,i+=`<channel>
...
`,i+=`</rss>
`,i}function gi(e){const t=e&&Array.isArray(e.entries)?e.entries:Array.isArray(e)?e:[],n=ui().split("?")[0],i=e&&e.generatedAt?new Date(e.generatedAt).toISOString():new Date().toISOString();let r=`<?xml version="1.0" encoding="utf-8"?>
