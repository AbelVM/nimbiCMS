(function(ce,De){typeof exports=="object"&&typeof module<"u"?De(exports):typeof define=="function"&&define.amd?define(["exports"],De):(ce=typeof globalThis<"u"?globalThis:ce||self,De(ce.nimbiCMS={}))})(this,(function(ce){"use strict";const De={onPageLoad:[],onNavBuild:[],transformHtml:[]};function _t(t,e){if(!Object.prototype.hasOwnProperty.call(De,t))throw new Error('Unknown hook "'+t+'"');if(typeof e!="function")throw new TypeError("hook callback must be a function");De[t].push(e)}function Ri(t){_t("onPageLoad",t)}function Ti(t){_t("onNavBuild",t)}function Li(t){_t("transformHtml",t)}async function rn(t,e){const n=De[t]||[];for(const s of n)try{await s(e)}catch(r){console.warn("[nimbi-cms] runHooks callback failed",r)}}function Ci(){Object.keys(De).forEach(t=>{De[t].length=0})}function Gn(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var sn,Qn;function _i(){if(Qn)return sn;Qn=1;function t(g){return g instanceof Map?g.clear=g.delete=g.set=function(){throw new Error("map is read-only")}:g instanceof Set&&(g.add=g.clear=g.delete=function(){throw new Error("set is read-only")}),Object.freeze(g),Object.getOwnPropertyNames(g).forEach(S=>{const T=g[S],W=typeof T;(W==="object"||W==="function")&&!Object.isFrozen(T)&&t(T)}),g}class e{constructor(S){S.data===void 0&&(S.data={}),this.data=S.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function n(g){return g.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function s(g,...S){const T=Object.create(null);for(const W in g)T[W]=g[W];return S.forEach(function(W){for(const pe in W)T[pe]=W[pe]}),T}const r="</span>",i=g=>!!g.scope,a=(g,{prefix:S})=>{if(g.startsWith("language:"))return g.replace("language:","language-");if(g.includes(".")){const T=g.split(".");return[`${S}${T.shift()}`,...T.map((W,pe)=>`${W}${"_".repeat(pe+1)}`)].join(" ")}return`${S}${g}`};class c{constructor(S,T){this.buffer="",this.classPrefix=T.classPrefix,S.walk(this)}addText(S){this.buffer+=n(S)}openNode(S){if(!i(S))return;const T=a(S.scope,{prefix:this.classPrefix});this.span(T)}closeNode(S){i(S)&&(this.buffer+=r)}value(){return this.buffer}span(S){this.buffer+=`<span class="${S}">`}}const o=(g={})=>{const S={children:[]};return Object.assign(S,g),S};class l{constructor(){this.rootNode=o(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(S){this.top.children.push(S)}openNode(S){const T=o({scope:S});this.add(T),this.stack.push(T)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(S){return this.constructor._walk(S,this.rootNode)}static _walk(S,T){return typeof T=="string"?S.addText(T):T.children&&(S.openNode(T),T.children.forEach(W=>this._walk(S,W)),S.closeNode(T)),S}static _collapse(S){typeof S!="string"&&S.children&&(S.children.every(T=>typeof T=="string")?S.children=[S.children.join("")]:S.children.forEach(T=>{l._collapse(T)}))}}class u extends l{constructor(S){super(),this.options=S}addText(S){S!==""&&this.add(S)}startScope(S){this.openNode(S)}endScope(){this.closeNode()}__addSublanguage(S,T){const W=S.root;T&&(W.scope=`language:${T}`),this.add(W)}toHTML(){return new c(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function h(g){return g?typeof g=="string"?g:g.source:null}function f(g){return m("(?=",g,")")}function p(g){return m("(?:",g,")*")}function d(g){return m("(?:",g,")?")}function m(...g){return g.map(T=>h(T)).join("")}function w(g){const S=g[g.length-1];return typeof S=="object"&&S.constructor===Object?(g.splice(g.length-1,1),S):{}}function y(...g){return"("+(w(g).capture?"":"?:")+g.map(W=>h(W)).join("|")+")"}function x(g){return new RegExp(g.toString()+"|").exec("").length-1}function I(g,S){const T=g&&g.exec(S);return T&&T.index===0}const P=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function A(g,{joinWith:S}){let T=0;return g.map(W=>{T+=1;const pe=T;let fe=h(W),B="";for(;fe.length>0;){const $=P.exec(fe);if(!$){B+=fe;break}B+=fe.substring(0,$.index),fe=fe.substring($.index+$[0].length),$[0][0]==="\\"&&$[1]?B+="\\"+String(Number($[1])+pe):(B+=$[0],$[0]==="("&&T++)}return B}).map(W=>`(${W})`).join(S)}const q=/\b\B/,j="[a-zA-Z]\\w*",G="[a-zA-Z_]\\w*",Y="\\b\\d+(\\.\\d+)?",re="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",D="\\b(0b[01]+)",L="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",C=(g={})=>{const S=/^#![ ]*\//;return g.binary&&(g.begin=m(S,/.*\b/,g.binary,/\b.*/)),s({scope:"meta",begin:S,end:/$/,relevance:0,"on:begin":(T,W)=>{T.index!==0&&W.ignoreMatch()}},g)},R={begin:"\\\\[\\s\\S]",relevance:0},v={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[R]},b={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[R]},_={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},z=function(g,S,T={}){const W=s({scope:"comment",begin:g,end:S,contains:[]},T);W.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const pe=y("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return W.contains.push({begin:m(/[ ]+/,"(",pe,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),W},k=z("//","$"),ie=z("/\\*","\\*/"),he=z("#","$"),Ae={scope:"number",begin:Y,relevance:0},xe={scope:"number",begin:re,relevance:0},ee={scope:"number",begin:D,relevance:0},ue={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[R,{begin:/\[/,end:/\]/,relevance:0,contains:[R]}]},ge={scope:"title",begin:j,relevance:0},Je={scope:"title",begin:G,relevance:0},Nn={begin:"\\.\\s*"+G,relevance:0};var Kt=Object.freeze({__proto__:null,APOS_STRING_MODE:v,BACKSLASH_ESCAPE:R,BINARY_NUMBER_MODE:ee,BINARY_NUMBER_RE:D,COMMENT:z,C_BLOCK_COMMENT_MODE:ie,C_LINE_COMMENT_MODE:k,C_NUMBER_MODE:xe,C_NUMBER_RE:re,END_SAME_AS_BEGIN:function(g){return Object.assign(g,{"on:begin":(S,T)=>{T.data._beginMatch=S[1]},"on:end":(S,T)=>{T.data._beginMatch!==S[1]&&T.ignoreMatch()}})},HASH_COMMENT_MODE:he,IDENT_RE:j,MATCH_NOTHING_RE:q,METHOD_GUARD:Nn,NUMBER_MODE:Ae,NUMBER_RE:Y,PHRASAL_WORDS_MODE:_,QUOTE_STRING_MODE:b,REGEXP_MODE:ue,RE_STARTERS_RE:L,SHEBANG:C,TITLE_MODE:ge,UNDERSCORE_IDENT_RE:G,UNDERSCORE_TITLE_MODE:Je});function $a(g,S){g.input[g.index-1]==="."&&S.ignoreMatch()}function Ia(g,S){g.className!==void 0&&(g.scope=g.className,delete g.className)}function Ba(g,S){S&&g.beginKeywords&&(g.begin="\\b("+g.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",g.__beforeBegin=$a,g.keywords=g.keywords||g.beginKeywords,delete g.beginKeywords,g.relevance===void 0&&(g.relevance=0))}function za(g,S){Array.isArray(g.illegal)&&(g.illegal=y(...g.illegal))}function Na(g,S){if(g.match){if(g.begin||g.end)throw new Error("begin & end are not supported with match");g.begin=g.match,delete g.match}}function Oa(g,S){g.relevance===void 0&&(g.relevance=1)}const Da=(g,S)=>{if(!g.beforeMatch)return;if(g.starts)throw new Error("beforeMatch cannot be used with starts");const T=Object.assign({},g);Object.keys(g).forEach(W=>{delete g[W]}),g.keywords=T.keywords,g.begin=m(T.beforeMatch,f(T.begin)),g.starts={relevance:0,contains:[Object.assign(T,{endsParent:!0})]},g.relevance=0,delete T.beforeMatch},Ha=["of","and","for","in","not","or","if","then","parent","list","value"],Ua="keyword";function ui(g,S,T=Ua){const W=Object.create(null);return typeof g=="string"?pe(T,g.split(" ")):Array.isArray(g)?pe(T,g):Object.keys(g).forEach(function(fe){Object.assign(W,ui(g[fe],S,fe))}),W;function pe(fe,B){S&&(B=B.map($=>$.toLowerCase())),B.forEach(function($){const F=$.split("|");W[F[0]]=[fe,qa(F[0],F[1])]})}}function qa(g,S){return S?Number(S):ja(g)?0:1}function ja(g){return Ha.includes(g.toLowerCase())}const hi={},et=g=>{console.error(g)},di=(g,...S)=>{console.log(`WARN: ${g}`,...S)},lt=(g,S)=>{hi[`${g}/${S}`]||(console.log(`Deprecated as of ${g}. ${S}`),hi[`${g}/${S}`]=!0)},Yt=new Error;function pi(g,S,{key:T}){let W=0;const pe=g[T],fe={},B={};for(let $=1;$<=S.length;$++)B[$+W]=pe[$],fe[$+W]=!0,W+=x(S[$-1]);g[T]=B,g[T]._emit=fe,g[T]._multi=!0}function Fa(g){if(Array.isArray(g.begin)){if(g.skip||g.excludeBegin||g.returnBegin)throw et("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Yt;if(typeof g.beginScope!="object"||g.beginScope===null)throw et("beginScope must be object"),Yt;pi(g,g.begin,{key:"beginScope"}),g.begin=A(g.begin,{joinWith:""})}}function Wa(g){if(Array.isArray(g.end)){if(g.skip||g.excludeEnd||g.returnEnd)throw et("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Yt;if(typeof g.endScope!="object"||g.endScope===null)throw et("endScope must be object"),Yt;pi(g,g.end,{key:"endScope"}),g.end=A(g.end,{joinWith:""})}}function Za(g){g.scope&&typeof g.scope=="object"&&g.scope!==null&&(g.beginScope=g.scope,delete g.scope)}function Ga(g){Za(g),typeof g.beginScope=="string"&&(g.beginScope={_wrap:g.beginScope}),typeof g.endScope=="string"&&(g.endScope={_wrap:g.endScope}),Fa(g),Wa(g)}function Qa(g){function S(B,$){return new RegExp(h(B),"m"+(g.case_insensitive?"i":"")+(g.unicodeRegex?"u":"")+($?"g":""))}class T{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule($,F){F.position=this.position++,this.matchIndexes[this.matchAt]=F,this.regexes.push([F,$]),this.matchAt+=x($)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const $=this.regexes.map(F=>F[1]);this.matcherRe=S(A($,{joinWith:"|"}),!0),this.lastIndex=0}exec($){this.matcherRe.lastIndex=this.lastIndex;const F=this.matcherRe.exec($);if(!F)return null;const ye=F.findIndex((Ct,Dn)=>Dn>0&&Ct!==void 0),me=this.matchIndexes[ye];return F.splice(0,ye),Object.assign(F,me)}}class W{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher($){if(this.multiRegexes[$])return this.multiRegexes[$];const F=new T;return this.rules.slice($).forEach(([ye,me])=>F.addRule(ye,me)),F.compile(),this.multiRegexes[$]=F,F}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule($,F){this.rules.push([$,F]),F.type==="begin"&&this.count++}exec($){const F=this.getMatcher(this.regexIndex);F.lastIndex=this.lastIndex;let ye=F.exec($);if(this.resumingScanAtSamePosition()&&!(ye&&ye.index===this.lastIndex)){const me=this.getMatcher(0);me.lastIndex=this.lastIndex+1,ye=me.exec($)}return ye&&(this.regexIndex+=ye.position+1,this.regexIndex===this.count&&this.considerAll()),ye}}function pe(B){const $=new W;return B.contains.forEach(F=>$.addRule(F.begin,{rule:F,type:"begin"})),B.terminatorEnd&&$.addRule(B.terminatorEnd,{type:"end"}),B.illegal&&$.addRule(B.illegal,{type:"illegal"}),$}function fe(B,$){const F=B;if(B.isCompiled)return F;[Ia,Na,Ga,Da].forEach(me=>me(B,$)),g.compilerExtensions.forEach(me=>me(B,$)),B.__beforeBegin=null,[Ba,za,Oa].forEach(me=>me(B,$)),B.isCompiled=!0;let ye=null;return typeof B.keywords=="object"&&B.keywords.$pattern&&(B.keywords=Object.assign({},B.keywords),ye=B.keywords.$pattern,delete B.keywords.$pattern),ye=ye||/\w+/,B.keywords&&(B.keywords=ui(B.keywords,g.case_insensitive)),F.keywordPatternRe=S(ye,!0),$&&(B.begin||(B.begin=/\B|\b/),F.beginRe=S(F.begin),!B.end&&!B.endsWithParent&&(B.end=/\B|\b/),B.end&&(F.endRe=S(F.end)),F.terminatorEnd=h(F.end)||"",B.endsWithParent&&$.terminatorEnd&&(F.terminatorEnd+=(B.end?"|":"")+$.terminatorEnd)),B.illegal&&(F.illegalRe=S(B.illegal)),B.contains||(B.contains=[]),B.contains=[].concat(...B.contains.map(function(me){return Xa(me==="self"?B:me)})),B.contains.forEach(function(me){fe(me,F)}),B.starts&&fe(B.starts,$),F.matcher=pe(F),F}if(g.compilerExtensions||(g.compilerExtensions=[]),g.contains&&g.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return g.classNameAliases=s(g.classNameAliases||{}),fe(g)}function fi(g){return g?g.endsWithParent||fi(g.starts):!1}function Xa(g){return g.variants&&!g.cachedVariants&&(g.cachedVariants=g.variants.map(function(S){return s(g,{variants:null},S)})),g.cachedVariants?g.cachedVariants:fi(g)?s(g,{starts:g.starts?s(g.starts):null}):Object.isFrozen(g)?s(g):g}var Ka="11.11.1";class Ya extends Error{constructor(S,T){super(S),this.name="HTMLInjectionError",this.html=T}}const On=n,gi=s,mi=Symbol("nomatch"),Va=7,wi=function(g){const S=Object.create(null),T=Object.create(null),W=[];let pe=!0;const fe="Could not find the language '{}', did you forget to load/include a language module?",B={disableAutodetect:!0,name:"Plain text",contains:[]};let $={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:u};function F(E){return $.noHighlightRe.test(E)}function ye(E){let H=E.className+" ";H+=E.parentNode?E.parentNode.className:"";const V=$.languageDetectRe.exec(H);if(V){const oe=Qe(V[1]);return oe||(di(fe.replace("{}",V[1])),di("Falling back to no-highlight mode for this block.",E)),oe?V[1]:"no-highlight"}return H.split(/\s+/).find(oe=>F(oe)||Qe(oe))}function me(E,H,V){let oe="",be="";typeof H=="object"?(oe=E,V=H.ignoreIllegals,be=H.language):(lt("10.7.0","highlight(lang, code, ...args) has been deprecated."),lt("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),be=E,oe=H),V===void 0&&(V=!0);const Ie={code:oe,language:be};Jt("before:highlight",Ie);const Xe=Ie.result?Ie.result:Ct(Ie.language,Ie.code,V);return Xe.code=Ie.code,Jt("after:highlight",Xe),Xe}function Ct(E,H,V,oe){const be=Object.create(null);function Ie(M,N){return M.keywords[N]}function Xe(){if(!Z.keywords){Se.addText(le);return}let M=0;Z.keywordPatternRe.lastIndex=0;let N=Z.keywordPatternRe.exec(le),Q="";for(;N;){Q+=le.substring(M,N.index);const se=Oe.case_insensitive?N[0].toLowerCase():N[0],Ee=Ie(Z,se);if(Ee){const[qe,mo]=Ee;if(Se.addText(Q),Q="",be[se]=(be[se]||0)+1,be[se]<=Va&&(nn+=mo),qe.startsWith("_"))Q+=N[0];else{const wo=Oe.classNameAliases[qe]||qe;Ne(N[0],wo)}}else Q+=N[0];M=Z.keywordPatternRe.lastIndex,N=Z.keywordPatternRe.exec(le)}Q+=le.substring(M),Se.addText(Q)}function en(){if(le==="")return;let M=null;if(typeof Z.subLanguage=="string"){if(!S[Z.subLanguage]){Se.addText(le);return}M=Ct(Z.subLanguage,le,!0,Ei[Z.subLanguage]),Ei[Z.subLanguage]=M._top}else M=Hn(le,Z.subLanguage.length?Z.subLanguage:null);Z.relevance>0&&(nn+=M.relevance),Se.__addSublanguage(M._emitter,M.language)}function _e(){Z.subLanguage!=null?en():Xe(),le=""}function Ne(M,N){M!==""&&(Se.startScope(N),Se.addText(M),Se.endScope())}function xi(M,N){let Q=1;const se=N.length-1;for(;Q<=se;){if(!M._emit[Q]){Q++;continue}const Ee=Oe.classNameAliases[M[Q]]||M[Q],qe=N[Q];Ee?Ne(qe,Ee):(le=qe,Xe(),le=""),Q++}}function Si(M,N){return M.scope&&typeof M.scope=="string"&&Se.openNode(Oe.classNameAliases[M.scope]||M.scope),M.beginScope&&(M.beginScope._wrap?(Ne(le,Oe.classNameAliases[M.beginScope._wrap]||M.beginScope._wrap),le=""):M.beginScope._multi&&(xi(M.beginScope,N),le="")),Z=Object.create(M,{parent:{value:Z}}),Z}function vi(M,N,Q){let se=I(M.endRe,Q);if(se){if(M["on:end"]){const Ee=new e(M);M["on:end"](N,Ee),Ee.isMatchIgnored&&(se=!1)}if(se){for(;M.endsParent&&M.parent;)M=M.parent;return M}}if(M.endsWithParent)return vi(M.parent,N,Q)}function uo(M){return Z.matcher.regexIndex===0?(le+=M[0],1):(Fn=!0,0)}function ho(M){const N=M[0],Q=M.rule,se=new e(Q),Ee=[Q.__beforeBegin,Q["on:begin"]];for(const qe of Ee)if(qe&&(qe(M,se),se.isMatchIgnored))return uo(N);return Q.skip?le+=N:(Q.excludeBegin&&(le+=N),_e(),!Q.returnBegin&&!Q.excludeBegin&&(le=N)),Si(Q,M),Q.returnBegin?0:N.length}function po(M){const N=M[0],Q=H.substring(M.index),se=vi(Z,M,Q);if(!se)return mi;const Ee=Z;Z.endScope&&Z.endScope._wrap?(_e(),Ne(N,Z.endScope._wrap)):Z.endScope&&Z.endScope._multi?(_e(),xi(Z.endScope,M)):Ee.skip?le+=N:(Ee.returnEnd||Ee.excludeEnd||(le+=N),_e(),Ee.excludeEnd&&(le=N));do Z.scope&&Se.closeNode(),!Z.skip&&!Z.subLanguage&&(nn+=Z.relevance),Z=Z.parent;while(Z!==se.parent);return se.starts&&Si(se.starts,M),Ee.returnEnd?0:N.length}function fo(){const M=[];for(let N=Z;N!==Oe;N=N.parent)N.scope&&M.unshift(N.scope);M.forEach(N=>Se.openNode(N))}let tn={};function Ai(M,N){const Q=N&&N[0];if(le+=M,Q==null)return _e(),0;if(tn.type==="begin"&&N.type==="end"&&tn.index===N.index&&Q===""){if(le+=H.slice(N.index,N.index+1),!pe){const se=new Error(`0 width match regex (${E})`);throw se.languageName=E,se.badRule=tn.rule,se}return 1}if(tn=N,N.type==="begin")return ho(N);if(N.type==="illegal"&&!V){const se=new Error('Illegal lexeme "'+Q+'" for mode "'+(Z.scope||"<unnamed>")+'"');throw se.mode=Z,se}else if(N.type==="end"){const se=po(N);if(se!==mi)return se}if(N.type==="illegal"&&Q==="")return le+=`
`,1;if(jn>1e5&&jn>N.index*3)throw new Error("potential infinite loop, way more iterations than matches");return le+=Q,Q.length}const Oe=Qe(E);if(!Oe)throw et(fe.replace("{}",E)),new Error('Unknown language: "'+E+'"');const go=Qa(Oe);let qn="",Z=oe||go;const Ei={},Se=new $.__emitter($);fo();let le="",nn=0,tt=0,jn=0,Fn=!1;try{if(Oe.__emitTokens)Oe.__emitTokens(H,Se);else{for(Z.matcher.considerAll();;){jn++,Fn?Fn=!1:Z.matcher.considerAll(),Z.matcher.lastIndex=tt;const M=Z.matcher.exec(H);if(!M)break;const N=H.substring(tt,M.index),Q=Ai(N,M);tt=M.index+Q}Ai(H.substring(tt))}return Se.finalize(),qn=Se.toHTML(),{language:E,value:qn,relevance:nn,illegal:!1,_emitter:Se,_top:Z}}catch(M){if(M.message&&M.message.includes("Illegal"))return{language:E,value:On(H),illegal:!0,relevance:0,_illegalBy:{message:M.message,index:tt,context:H.slice(tt-100,tt+100),mode:M.mode,resultSoFar:qn},_emitter:Se};if(pe)return{language:E,value:On(H),illegal:!1,relevance:0,errorRaised:M,_emitter:Se,_top:Z};throw M}}function Dn(E){const H={value:On(E),illegal:!1,relevance:0,_top:B,_emitter:new $.__emitter($)};return H._emitter.addText(E),H}function Hn(E,H){H=H||$.languages||Object.keys(S);const V=Dn(E),oe=H.filter(Qe).filter(ki).map(_e=>Ct(_e,E,!1));oe.unshift(V);const be=oe.sort((_e,Ne)=>{if(_e.relevance!==Ne.relevance)return Ne.relevance-_e.relevance;if(_e.language&&Ne.language){if(Qe(_e.language).supersetOf===Ne.language)return 1;if(Qe(Ne.language).supersetOf===_e.language)return-1}return 0}),[Ie,Xe]=be,en=Ie;return en.secondBest=Xe,en}function Ja(E,H,V){const oe=H&&T[H]||V;E.classList.add("hljs"),E.classList.add(`language-${oe}`)}function Un(E){let H=null;const V=ye(E);if(F(V))return;if(Jt("before:highlightElement",{el:E,language:V}),E.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",E);return}if(E.children.length>0&&($.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(E)),$.throwUnescapedHTML))throw new Ya("One of your code blocks includes unescaped HTML.",E.innerHTML);H=E;const oe=H.textContent,be=V?me(oe,{language:V,ignoreIllegals:!0}):Hn(oe);E.innerHTML=be.value,E.dataset.highlighted="yes",Ja(E,V,be.language),E.result={language:be.language,re:be.relevance,relevance:be.relevance},be.secondBest&&(E.secondBest={language:be.secondBest.language,relevance:be.secondBest.relevance}),Jt("after:highlightElement",{el:E,result:be,text:oe})}function eo(E){$=gi($,E)}const to=()=>{Vt(),lt("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function no(){Vt(),lt("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let bi=!1;function Vt(){function E(){Vt()}if(document.readyState==="loading"){bi||window.addEventListener("DOMContentLoaded",E,!1),bi=!0;return}document.querySelectorAll($.cssSelector).forEach(Un)}function ro(E,H){let V=null;try{V=H(g)}catch(oe){if(et("Language definition for '{}' could not be registered.".replace("{}",E)),pe)et(oe);else throw oe;V=B}V.name||(V.name=E),S[E]=V,V.rawDefinition=H.bind(null,g),V.aliases&&yi(V.aliases,{languageName:E})}function io(E){delete S[E];for(const H of Object.keys(T))T[H]===E&&delete T[H]}function so(){return Object.keys(S)}function Qe(E){return E=(E||"").toLowerCase(),S[E]||S[T[E]]}function yi(E,{languageName:H}){typeof E=="string"&&(E=[E]),E.forEach(V=>{T[V.toLowerCase()]=H})}function ki(E){const H=Qe(E);return H&&!H.disableAutodetect}function ao(E){E["before:highlightBlock"]&&!E["before:highlightElement"]&&(E["before:highlightElement"]=H=>{E["before:highlightBlock"](Object.assign({block:H.el},H))}),E["after:highlightBlock"]&&!E["after:highlightElement"]&&(E["after:highlightElement"]=H=>{E["after:highlightBlock"](Object.assign({block:H.el},H))})}function oo(E){ao(E),W.push(E)}function lo(E){const H=W.indexOf(E);H!==-1&&W.splice(H,1)}function Jt(E,H){const V=E;W.forEach(function(oe){oe[V]&&oe[V](H)})}function co(E){return lt("10.7.0","highlightBlock will be removed entirely in v12.0"),lt("10.7.0","Please use highlightElement now."),Un(E)}Object.assign(g,{highlight:me,highlightAuto:Hn,highlightAll:Vt,highlightElement:Un,highlightBlock:co,configure:eo,initHighlighting:to,initHighlightingOnLoad:no,registerLanguage:ro,unregisterLanguage:io,listLanguages:so,getLanguage:Qe,registerAliases:yi,autoDetection:ki,inherit:gi,addPlugin:oo,removePlugin:lo}),g.debugMode=function(){pe=!1},g.safeMode=function(){pe=!0},g.versionString=Ka,g.regex={concat:m,lookahead:f,either:y,optional:d,anyNumberOfTimes:p};for(const E in Kt)typeof Kt[E]=="object"&&t(Kt[E]);return Object.assign(g,Kt),g},ct=wi({});return ct.newInstance=()=>wi({}),sn=ct,ct.HighlightJS=ct,ct.default=ct,sn}var Mi=_i();const ae=Gn(Mi),K=new Map,Pi="https://raw.githubusercontent.com/highlightjs/highlight.js/main/SUPPORTED_LANGUAGES.md",Te={shell:"bash",sh:"bash",zsh:"bash",js:"javascript",ts:"typescript",py:"python",csharp:"cs","c#":"cs"};Te.html="xml",Te.xhtml="xml",Te.markup="xml";const an=new Set(["magic","undefined"]);let je=null;const on=new Map,$i=300*1e3;async function ln(t=Pi){if(t)return je||(je=(async()=>{try{const e=await fetch(t);if(!e.ok)return;const s=(await e.text()).split(/\r?\n/);let r=-1;for(let l=0;l<s.length;l++)if(/\|\s*Language\s*\|/i.test(s[l])){r=l;break}if(r===-1)return;const i=s[r].replace(/^\||\|$/g,"").split("|").map(l=>l.trim().toLowerCase());let a=i.findIndex(l=>/alias|aliases|equivalent|alt|alternates?/i.test(l));a===-1&&(a=1);let c=i.findIndex(l=>/file|filename|module|module name|module-name|short|slug/i.test(l));if(c===-1){const l=i.findIndex(u=>/language/i.test(u));c=l!==-1?l:0}let o=[];for(let l=r+1;l<s.length;l++){const u=s[l].trim();if(!u||!u.startsWith("|"))break;const h=u.replace(/^\||\|$/g,"").split("|").map(w=>w.trim());if(h.every(w=>/^-+$/.test(w)))continue;const f=h;if(!f.length)continue;const d=(f[c]||f[0]||"").toString().trim().toLowerCase();if(!d||/^-+$/.test(d))continue;K.set(d,d);const m=f[a]||"";if(m){const w=String(m).split(",").map(y=>y.replace(/`/g,"").trim()).filter(Boolean);if(w.length){const x=w[0].toLowerCase().replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");x&&/[a-z0-9]/i.test(x)&&(K.set(x,x),o.push(x))}}}try{const l=[];for(const u of o){const h=String(u||"").replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");h&&/[a-z0-9]/i.test(h)?l.push(h):K.delete(u)}o=l}catch(l){console.warn("[codeblocksManager] cleanup aliases failed",l)}try{let l=0;for(const u of Array.from(K.keys())){if(!u||/^-+$/.test(u)||!/[a-z0-9]/i.test(u)){K.delete(u),l++;continue}if(/^[:]+/.test(u)){const h=u.replace(/^[:]+/,"");if(h&&/[a-z0-9]/i.test(h)){const f=K.get(u);K.delete(u),K.set(h,f)}else K.delete(u),l++}}for(const[u,h]of Array.from(K.entries()))(!h||/^-+$/.test(h)||!/[a-z0-9]/i.test(h))&&(K.delete(u),l++);try{const u=":---------------------";K.has(u)&&(K.delete(u),l++)}catch(u){console.warn("[codeblocksManager] remove sep key failed",u)}try{const u=Array.from(K.keys()).sort()}catch(u){console.warn("[codeblocksManager] compute supported keys failed",u)}}catch(l){console.warn("[codeblocksManager] ignored error",l)}}catch(e){console.warn("[codeblocksManager] loadSupportedLanguages failed",e)}})(),je)}const ut=new Set;async function nt(t,e){if(je||(async()=>{try{await ln()}catch(r){console.warn("[codeblocksManager] loadSupportedLanguages (IIFE) failed",r)}})(),je)try{await je}catch{}if(t=t==null?"":String(t),t=t.trim(),!t)return!1;const n=t.toLowerCase();if(an.has(n))return!1;if(K.size&&!K.has(n)){const r=Te;if(!r[n]&&!r[t])return!1}if(ut.has(t))return!0;const s=Te;try{const r=(e||t||"").toString().replace(/\.js$/i,"").trim(),i=(s[t]||t||"").toString(),a=(s[r]||r||"").toString();let c=Array.from(new Set([i,a,r,t,s[r],s[t]].filter(Boolean))).map(u=>String(u).toLowerCase()).filter(u=>u&&u!=="undefined");K.size&&(c=c.filter(u=>{if(K.has(u))return!0;const h=Te[u];return!!(h&&K.has(h))}));let o=null,l=null;for(const u of c)try{const h=Date.now();let f=on.get(u);if(f&&f.ok===!1&&h-(f.ts||0)>=$i&&(on.delete(u),f=void 0),f){if(f.module)o=f.module;else if(f.promise)try{o=await f.promise}catch{o=null}}else{const p={promise:null,module:null,ok:null,ts:0};on.set(u,p),p.promise=(async()=>{try{try{try{return await import(`highlight.js/lib/languages/${u}.js`)}catch{return await import(`highlight.js/lib/languages/${u}`)}}catch{try{const m=`https://cdn.jsdelivr.net/npm/highlight.js/es/languages/${u}.js`;return await new Function("u","return import(u)")(m)}catch{try{const w=`https://cdn.jsdelivr.net/npm/highlight.js/lib/languages/${u}.js`;return await new Function("u","return import(u)")(w)}catch{return null}}}}catch{return null}})();try{o=await p.promise,p.module=o,p.ok=!!o,p.ts=Date.now()}catch{p.module=null,p.ok=!1,p.ts=Date.now(),o=null}}if(o){const p=o.default||o;try{const d=K.size&&K.get(t)||u||t;return ae.registerLanguage(d,p),ut.add(d),d!==t&&(ae.registerLanguage(t,p),ut.add(t)),!0}catch(d){l=d}}else try{if(K.has(u)||K.has(t)){const p=()=>({});try{ae.registerLanguage(u,p),ut.add(u)}catch{}try{u!==t&&(ae.registerLanguage(t,p),ut.add(t))}catch{}return!0}}catch{}}catch(h){l=h}if(l)throw l;return!1}catch{return!1}}let Mt=null;function Xn(t=document){je||(async()=>{try{await ln()}catch(i){console.warn("[codeblocksManager] loadSupportedLanguages (observer) failed",i)}})();const e=Te,s=Mt||(typeof IntersectionObserver>"u"?null:(Mt=new IntersectionObserver((i,a)=>{i.forEach(c=>{if(!c.isIntersecting)return;const o=c.target;try{a.unobserve(o)}catch(l){console.warn("[codeblocksManager] observer unobserve failed",l)}(async()=>{try{const l=o.getAttribute&&o.getAttribute("class")||o.className||"",u=l.match(/language-([a-zA-Z0-9_+-]+)/)||l.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(u&&u[1]){const h=(u[1]||"").toLowerCase(),f=e[h]||h,p=K.size&&(K.get(f)||K.get(String(f).toLowerCase()))||f;try{await nt(p)}catch(d){console.warn("[codeblocksManager] registerLanguage failed",d)}try{ae.highlightElement(o)}catch(d){console.warn("[codeblocksManager] hljs.highlightElement failed",d)}}else try{const h=o.textContent||"";try{if(ae&&typeof ae.getLanguage=="function"&&ae.getLanguage("plaintext")){const f=ae.highlight(h,{language:"plaintext"});f&&f.value&&(o.innerHTML=f.value)}}catch{try{ae.highlightElement(o)}catch(p){console.warn("[codeblocksManager] fallback highlightElement failed",p)}}}catch(h){console.warn("[codeblocksManager] auto-detect plaintext failed",h)}}catch(l){console.warn("[codeblocksManager] observer entry processing failed",l)}})()})},{root:null,rootMargin:"300px",threshold:.1}),Mt)),r=t&&t.querySelectorAll?t.querySelectorAll("pre code"):[];if(!s){r.forEach(async i=>{try{const a=i.getAttribute&&i.getAttribute("class")||i.className||"",c=a.match(/language-([a-zA-Z0-9_+-]+)/)||a.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(c&&c[1]){const o=(c[1]||"").toLowerCase(),l=e[o]||o,u=K.size&&(K.get(l)||K.get(String(l).toLowerCase()))||l;try{await nt(u)}catch(h){console.warn("[codeblocksManager] registerLanguage failed (no observer)",h)}}try{ae.highlightElement(i)}catch(o){console.warn("[codeblocksManager] hljs.highlightElement failed (no observer)",o)}}catch(a){console.warn("[codeblocksManager] loadSupportedLanguages fallback ignored error",a)}});return}r.forEach(i=>{try{s.observe(i)}catch(a){console.warn("[codeblocksManager] observe failed",a)}})}function Ii(t,{useCdn:e=!0}={}){const n=document.querySelector("link[data-hl-theme]");n&&n.remove();let s=t||"monokai";if(s==="monokai")return;if(!e){console.warn("Requested highlight theme not bundled; set useCdn=true to load from CDN");return}const r=`https://cdn.jsdelivr.net/npm/highlight.js@11.8.0/styles/${s}.css`,i=document.createElement("link");i.rel="stylesheet",i.href=r,i.setAttribute("data-hl-theme",s),document.head.appendChild(i)}let ht="light";function Bi(t,e={}){if(document.querySelector(`link[href="${t}"]`))return;const n=document.createElement("link");n.rel="stylesheet",n.href=t,Object.entries(e).forEach(([s,r])=>n.setAttribute(s,r)),document.head.appendChild(n)}async function Kn(t="none",e="/"){if(!t||t==="none")return;const n=[e+"bulma.css","/bulma.css"],s=Array.from(new Set(n));if(t==="local"){if(document.querySelector("style[data-bulma-override]"))return;for(const r of s)try{const i=await fetch(r,{method:"GET"});if(i.ok){const a=await i.text(),c=document.createElement("style");c.setAttribute("data-bulma-override",r),c.appendChild(document.createTextNode(`
/* bulma override: ${r} */
`+a)),document.head.appendChild(c);return}}catch(i){console.warn("[bulmaManager] fetch local bulma candidate failed",i)}return}try{const r=String(t).trim();if(!r)return;const i=`https://unpkg.com/bulmaswatch/${encodeURIComponent(r)}/bulmaswatch.min.css`;Bi(i,{"data-bulmaswatch-theme":r})}catch(r){console.warn("[bulmaManager] ensureBulma failed",r)}}function Yn(t){ht=t==="dark"?"dark":"light",document.documentElement.setAttribute("data-theme",ht),ht==="dark"?document.body.classList.add("is-dark"):document.body.classList.remove("is-dark")}function zi(t){const e=document.documentElement;for(const[n,s]of Object.entries(t||{}))try{e.style.setProperty(`--${n}`,s)}catch(r){console.warn("[bulmaManager] setThemeVars failed for",n,r)}}function Vn(t){if(!t||!(t instanceof HTMLElement))return()=>{};const e=()=>{ht==="dark"?(t.classList.add("is-dark"),t.classList.remove("is-light")):(t.classList.add("is-light"),t.classList.remove("is-dark"))};e();const n=new MutationObserver(()=>{ht=document.documentElement.getAttribute("data-theme")==="dark"?"dark":"light",e()});try{n.observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]})}catch{}return()=>{try{n.disconnect()}catch{}}}const Jn={en:{navigation:"Navigation",onThisPage:"On this page",home:"Home",scrollToTop:"Scroll to top",readingTime:"{minutes} min read",searchPlaceholder:"Search…",imagePreviewTitle:"Image preview",imagePreviewFit:"Fit to screen",imagePreviewOriginal:"Original size",imagePreviewZoomOut:"Zoom out",imagePreviewZoomIn:"Zoom in",imagePreviewClose:"Close"},es:{navigation:"Navegación",onThisPage:"En esta página",home:"Inicio",scrollToTop:"Ir arriba",readingTime:"{minutes} min de lectura",searchPlaceholder:"Buscar…",imagePreviewTitle:"Previsualización de imagen",imagePreviewFit:"Ajustar a la pantalla",imagePreviewOriginal:"Tamaño original",imagePreviewZoomOut:"Alejar",imagePreviewZoomIn:"Acercar",imagePreviewClose:"Cerrar"},de:{navigation:"Navigation",onThisPage:"Auf dieser Seite",home:"Startseite",scrollToTop:"Nach oben",readingTime:"{minutes} min Lesezeit",searchPlaceholder:"Suchen…",imagePreviewTitle:"Bildvorschau",imagePreviewFit:"An Bildschirm anpassen",imagePreviewOriginal:"Originalgröße",imagePreviewZoomOut:"Verkleinern",imagePreviewZoomIn:"Vergrößern",imagePreviewClose:"Schließen"},fr:{navigation:"Navigation",onThisPage:"Sur cette page",home:"Accueil",scrollToTop:"Aller en haut",readingTime:"{minutes} min de lecture",searchPlaceholder:"Rechercher…",imagePreviewTitle:"Aperçu de l’image",imagePreviewFit:"Ajuster à l’écran",imagePreviewOriginal:"Taille originale",imagePreviewZoomOut:"Dézoomer",imagePreviewZoomIn:"Zoomer",imagePreviewClose:"Fermer"},pt:{navigation:"Navegação",onThisPage:"Nesta página",home:"Início",scrollToTop:"Ir para o topo",readingTime:"{minutes} min de leitura",searchPlaceholder:"Procurar…",imagePreviewTitle:"Visualização da imagem",imagePreviewFit:"Ajustar à tela",imagePreviewOriginal:"Tamanho original",imagePreviewZoomOut:"Diminuir",imagePreviewZoomIn:"Aumentar",imagePreviewClose:"Fechar"}},rt=JSON.parse(JSON.stringify(Jn));let Pt="en";if(typeof navigator<"u"){const t=navigator.language||navigator.languages&&navigator.languages[0]||"en";Pt=String(t).split("-")[0].toLowerCase()}Jn[Pt]||(Pt="en");let Fe=Pt;function it(t,e={}){const n=rt[Fe]||rt.en;let s=n&&n[t]?n[t]:rt.en[t]||"";for(const r of Object.keys(e))s=s.replace(new RegExp(`{${r}}`,"g"),String(e[r]));return s}async function cn(t,e){if(!t)return;let n=t;try{/^https?:\/\//.test(t)||(n=new URL(t,location.origin+e).toString());const s=await fetch(n);if(!s.ok)return;const r=await s.json();for(const i of Object.keys(r||{}))rt[i]=Object.assign({},rt[i]||{},r[i])}catch{}}function un(t){const e=String(t).split("-")[0].toLowerCase();Fe=rt[e]?e:"en"}const Ni=Object.freeze(Object.defineProperty({__proto__:null,get currentLang(){return Fe},loadL10nFile:cn,setLang:un,t:it},Symbol.toStringTag,{value:"Module"})),Oi=`import { buildSearchIndex, crawlForSlug } from '../slugManager.js'
...
`;function er(t,e="worker"){let n=null;function s(){if(!n)try{const c=t();n=c||null,c&&c.addEventListener("error",()=>{try{n===c&&(n=null,c.terminate&&c.terminate())}catch(o){console.warn("["+e+"] worker termination failed",o)}})}catch(c){n=null,console.warn("["+e+"] worker init failed",c)}return n}function r(){try{n&&(n.terminate&&n.terminate(),n=null)}catch(c){console.warn("["+e+"] worker termination failed",c)}}function i(c,o=1e3){return new Promise((l,u)=>{const h=s();if(!h)return u(new Error("worker unavailable"));const f=String(Math.random());c.id=f;let p=null;const d=()=>{p&&clearTimeout(p),h.removeEventListener("message",m),h.removeEventListener("error",w)},m=y=>{const x=y.data||{};x.id===f&&(d(),x.error?u(new Error(x.error)):l(x.result))},w=y=>{d(),console.warn("["+e+"] worker error event",y);try{n===h&&(n=null,h.terminate&&h.terminate())}catch(x){console.warn("["+e+"] worker termination failed",x)}u(new Error(y&&y.message||"worker error"))};p=setTimeout(()=>{d(),console.warn("["+e+"] worker timed out");try{n===h&&(n=null,h.terminate&&h.terminate())}catch(y){console.warn("["+e+"] worker termination on timeout failed",y)}u(new Error("worker timeout"))},o),h.addEventListener("message",m),h.addEventListener("error",w);try{h.postMessage(c)}catch(y){d(),u(y)}})}return{get:s,send:i,terminate:r}}function Di(t){try{if(typeof Blob<"u"&&typeof URL<"u"&&t){const e=new Blob([t],{type:"application/javascript"}),n=URL.createObjectURL(e);return new Worker(n,{type:"module"})}}catch(e){console.warn("[worker-manager] createWorkerFromRaw failed",e)}return null}const Be=new Set;function hn(t){Hi(),Be.clear();for(const e of Ce)e&&Be.add(e);tr(X),tr(U),hn._refreshed=!0}function tr(t){if(!(!t||typeof t.values!="function"))for(const e of t.values())e&&Be.add(e)}function nr(t){if(!t||typeof t.set!="function")return;const e=t.set;t.set=function(n,s){return s&&Be.add(s),e.call(this,n,s)}}let rr=!1;function Hi(){rr||(nr(X),nr(U),rr=!0)}function ir(t){return!t||typeof t!="string"?!1:/^(https?:)?\/\//.test(t)||t.startsWith("mailto:")||t.startsWith("tel:")}function de(t){return String(t||"").replace(/^[.\/]+/,"")}function dt(t){return String(t||"").replace(/\/+$/,"")}function pt(t){return dt(t)+"/"}function Ui(t){try{if(!t||typeof document>"u"||!document.head||t.startsWith("data:")||document.head.querySelector(`link[rel="preload"][as="image"][href="${t}"]`))return;const n=document.createElement("link");n.rel="preload",n.as="image",n.href=t,document.head.appendChild(n)}catch(e){console.warn("[helpers] preloadImage failed",e)}}function $t(t,e=0,n=!1){try{if(typeof window>"u"||!t||!t.querySelectorAll)return;const s=Array.from(t.querySelectorAll("img"));if(!s.length)return;const r=t,i=r&&r.getBoundingClientRect?r.getBoundingClientRect():null,a=0,c=typeof window<"u"&&(window.innerHeight||document.documentElement.clientHeight)||0,o=i?Math.max(a,i.top):a,u=(i?Math.min(c,i.bottom):c)+Number(e||0);let h=0;r&&(h=r.clientHeight||(i?i.height:0)),h||(h=c-a);let f=.6;try{const w=r&&window.getComputedStyle?window.getComputedStyle(r):null,y=w&&w.getPropertyValue("--nimbi-image-max-height-ratio"),x=y?parseFloat(y):NaN;!Number.isNaN(x)&&x>0&&x<=1&&(f=x)}catch(w){console.warn("[helpers] read CSS ratio failed",w)}const p=Math.max(200,Math.floor(h*f));let d=!1,m=null;if(s.forEach(w=>{try{const y=w.getAttribute?w.getAttribute("loading"):void 0;y!=="eager"&&w.setAttribute&&w.setAttribute("loading","lazy");const x=w.getBoundingClientRect?w.getBoundingClientRect():null,I=w.src||w.getAttribute&&w.getAttribute("src"),P=x&&x.height>1?x.height:p,A=x?x.top:0,q=A+P;x&&P>0&&A<=u&&q>=o&&(w.setAttribute?(w.setAttribute("loading","eager"),w.setAttribute("fetchpriority","high"),w.setAttribute("data-eager-by-nimbi","1")):(w.loading="eager",w.fetchPriority="high"),Ui(I),d=!0),!m&&x&&x.top<=u&&(m={img:w,src:I,rect:x,beforeLoading:y})}catch(y){console.warn("[helpers] setEagerForAboveFoldImages per-image failed",y)}}),!d&&m){const{img:w,src:y,rect:x,beforeLoading:I}=m;try{w.setAttribute?(w.setAttribute("loading","eager"),w.setAttribute("fetchpriority","high"),w.setAttribute("data-eager-by-nimbi","1")):(w.loading="eager",w.fetchPriority="high")}catch(P){console.warn("[helpers] setEagerForAboveFoldImages fallback failed",P)}}}catch(s){console.warn("[helpers] setEagerForAboveFoldImages failed",s)}}function It(t){try{const e=t();return e&&typeof e.then=="function"?e.catch(n=>{console.warn("[helpers] safe swallowed error",n)}):e}catch(e){console.warn("[helpers] safe swallowed error",e)}}try{typeof globalThis<"u"&&!globalThis.safe&&(globalThis.safe=It)}catch(t){console.warn("[helpers] global attach failed",t)}const X=new Map;let Le=[],dn=!1;function qi(t){dn=!!t}function sr(t){Le=Array.isArray(t)?t.slice():[]}function ji(){return Le}const ar=er(()=>Di(Oi),"slugManager");function pn(){return ar.get()}function or(t){return ar.send(t)}async function Fi(t,e=1,n=void 0){if(!pn())return Ht(t,e,n);try{return await or({type:"buildSearchIndex",contentBase:t,indexDepth:e,noIndexing:n})}catch(r){try{return await Ht(t,e,n)}catch(i){throw console.warn("[slugManager] buildSearchIndex fallback failed",i),r}}}async function Wi(t,e,n){return pn()?or({type:"crawlForSlug",slug:t,base:e,maxQueue:n}):mn(t,e,n)}function We(t,e){if(t)if(Le&&Le.length){const s=e.split("/")[0],r=Le.includes(s);let i=X.get(t);(!i||typeof i=="string")&&(i={default:typeof i=="string"?i:void 0,langs:{}}),r?i.langs[s]=e:i.default=e,X.set(t,i)}else X.set(t,e)}const Bt=new Set;function Zi(t){typeof t=="function"&&Bt.add(t)}function Gi(t){typeof t=="function"&&Bt.delete(t)}const U=new Map;let fn={},Ce=[],st="_404.md",at="_home.md";function gn(t){t!=null&&(st=String(t||""))}function Qi(t){t!=null&&(at=String(t||""))}function Xi(t){fn=t||{}}const ft=new Map,zt=new Set;function Ki(){ft.clear(),zt.clear()}function Yi(t){if(!t||t.length===0)return"";let e=t[0];for(let s=1;s<t.length;s++){const r=t[s];let i=0;const a=Math.min(e.length,r.length);for(;i<a&&e[i]===r[i];)i++;e=e.slice(0,i)}const n=e.lastIndexOf("/");return n===-1?e:e.slice(0,n+1)}function Nt(t){X.clear(),U.clear(),Ce=[],Le=Le||[];const e=Object.keys(fn||{});if(!e.length)return;let n="";try{if(t){try{/^[a-z][a-z0-9+.-]*:/i.test(String(t))?n=new URL(String(t)).pathname:n=String(t||"")}catch(s){n=String(t||""),console.warn("[slugManager] parse contentBase failed",s)}n=pt(n)}}catch(s){n="",console.warn("[slugManager] setContentBase prefix derivation failed",s)}n||(n=Yi(e));for(const s of e){let r=s;n&&s.startsWith(n)?r=de(s.slice(n.length)):r=de(s),Ce.push(r);try{hn()}catch(a){console.warn("[slugManager] refreshIndexPaths failed",a)}const i=fn[s];if(typeof i=="string"){const a=(i||"").match(/^#\s+(.+)$/m);if(a&&a[1]){const c=ne(a[1].trim());if(c)try{if(Le&&Le.length){const l=r.split("/")[0],u=Le.includes(l);let h=X.get(c);(!h||typeof h=="string")&&(h={default:typeof h=="string"?h:void 0,langs:{}}),u?h.langs[l]=r:h.default=r,X.set(c,h)}else X.set(c,r);U.set(r,c)}catch(o){console.warn("[slugManager] set slug mapping failed",o)}}}}}try{Nt()}catch(t){console.warn("[slugManager] initial setContentBase failed",t)}function ne(t){let n=String(t||"").toLowerCase().replace(/[^a-z0-9\- ]/g,"").replace(/ /g,"-");return n=n.replace(/(?:-?)(?:md|html)$/,""),n.length>80&&(n=n.slice(0,80).replace(/-+$/g,"")),n}function Vi(t){return gt(t,void 0)}function gt(t,e){if(!t)return!1;if(t.startsWith("//"))return!0;if(/^[a-z][a-z0-9+.-]*:/i.test(t)){if(e&&typeof e=="string")try{const n=new URL(t),s=new URL(e);return n.origin!==s.origin?!0:!n.pathname.startsWith(s.pathname)}catch{return!0}return!0}if(t.startsWith("/")&&e&&typeof e=="string")try{const n=new URL(t,e),s=new URL(e);return n.origin!==s.origin?!0:!n.pathname.startsWith(s.pathname)}catch{return!0}return!1}function Ot(t){return t==null?t:String(t).replace(/\\([\\`*_{}\[\]()#+\-.!])/g,(e,n)=>n)}function mt(t){if(!t||!X.has(t))return null;const e=X.get(t);if(!e)return null;if(typeof e=="string")return e;if(Le&&Le.length&&Fe&&e.langs&&e.langs[Fe])return e.langs[Fe];if(e.default)return e.default;if(e.langs){const n=Object.keys(e.langs);if(n.length)return e.langs[n[0]]}return null}const wt=new Map;function Ji(){wt.clear()}let ke=async function(t,e){if(!t)throw new Error("path required");try{const i=(String(t||"").match(/([^\/]+)\.md(?:$|[?#])/)||[])[1];if(i&&X.has(i)){const a=mt(i)||X.get(i);a&&a!==t&&(t=a)}}catch(i){console.warn("[slugManager] slug mapping normalization failed",i)}const n=e==null?"":dt(String(e));let s="";try{if(n)if(/^[a-z][a-z0-9+.-]*:/i.test(n))s=n.replace(/\/$/,"")+"/"+t.replace(/^\//,"");else if(n.startsWith("/"))s=n.replace(/\/$/,"")+"/"+t.replace(/^\//,"");else{const i=typeof location<"u"&&location.origin?location.origin:"http://localhost",a=n.startsWith("/")?n:"/"+n;s=i+a.replace(/\/$/,"")+"/"+t.replace(/^\//,"")}else s=(typeof location<"u"&&location.origin?location.origin:"http://localhost")+"/"+t.replace(/^\//,"")}catch{s="/"+t.replace(/^\//,"")}if(wt.has(s))return wt.get(s);const r=(async()=>{const i=await fetch(s);if(!i||typeof i.ok!="boolean"||!i.ok){if(i&&i.status===404)try{const h=`${n}/${st}`,f=await globalThis.fetch(h);if(f&&typeof f.ok=="boolean"&&f.ok)return{raw:await f.text(),status:404}}catch(h){console.warn("[slugManager] fetching fallback 404 failed",h)}let u="";try{i&&typeof i.clone=="function"?u=await i.clone().text():i&&typeof i.text=="function"?u=await i.text():u=""}catch(h){u="",console.warn("[slugManager] reading error body failed",h)}throw console.error("fetchMarkdown failed:",{url:s,status:i?i.status:void 0,statusText:i?i.statusText:void 0,body:u.slice(0,200)}),new Error("failed to fetch md")}const a=await i.text(),c=a.trim().slice(0,16).toLowerCase(),o=c.startsWith("<!doctype")||c.startsWith("<html"),l=o||String(t||"").toLowerCase().endsWith(".html");if(o&&String(t||"").toLowerCase().endsWith(".md")){try{const u=`${n}/${st}`,h=await globalThis.fetch(u);if(h.ok)return{raw:await h.text(),status:404}}catch(u){console.warn("[slugManager] fetching fallback 404 failed",u)}throw console.error("fetchMarkdown: server returned HTML for .md request",s),new Error("failed to fetch md")}return l?{raw:a,isHtml:!0}:{raw:a}})();return wt.set(s,r),r};function es(t){typeof t=="function"&&(ke=t)}const Dt=new Map;function ts(t){if(!t||typeof t!="string")return"";let e=t.replace(/```[\s\S]*?```/g,"");return e=e.replace(/<pre[\s\S]*?<\/pre>/gi,""),e=e.replace(/<code[\s\S]*?<\/code>/gi,""),e=e.replace(/<!--([\s\S]*?)-->/g,""),e=e.replace(/^ {4,}.*$/gm,""),e=e.replace(/`[^`]*`/g,""),e}let He=[],bt=null;async function Ht(t,e=1,n=void 0){const s=Array.isArray(n)?Array.from(new Set((n||[]).map(r=>de(String(r||""))))):[];try{const r=de(String(st||""));r&&!s.includes(r)&&s.push(r)}catch{}if(He&&He.length&&e===1&&!He.some(i=>{try{return s.includes(de(String(i.path||"")))}catch{return!1}}))return He;if(bt)return bt;bt=(async()=>{let r=Array.isArray(n)?Array.from(new Set((n||[]).map(l=>de(String(l||""))))):[];try{const l=de(String(st||""));l&&!r.includes(l)&&r.push(l)}catch{}const i=l=>{if(!r||!r.length)return!1;for(const u of r)if(u&&(l===u||l.startsWith(u+"/")))return!0;return!1};let a=[];if(Ce&&Ce.length&&(a=Array.from(Ce)),!a.length)for(const l of X.values())l&&a.push(l);try{const l=await hr(t);l&&l.length&&(a=a.concat(l))}catch(l){console.warn("[slugManager] crawlAllMarkdown during buildSearchIndex failed",l)}try{const l=new Set(a),u=[...a];for(l.size;u.length&&l.size<=yt;){const h=u.shift();try{const f=await ke(h,t);if(f&&f.raw){if(f.status===404)continue;let p=f.raw;const d=[],m=String(h||"").replace(/^.*\//,"");if(/^readme(?:\.md)?$/i.test(m)&&dn&&(!h||!h.includes("/")))continue;const w=ts(p),y=/\[[^\]]+\]\(([^)]+)\)/g;let x;for(;x=y.exec(w);)d.push(x[1]);const I=/<a\s+[^>]*href=["']([^"']+)["'][^>]*>/gi;for(;x=I.exec(w);)d.push(x[1]);const P=h&&h.includes("/")?h.substring(0,h.lastIndexOf("/")+1):"";for(let A of d)try{if(gt(A,t)||A.startsWith("..")||A.indexOf("/../")!==-1||(P&&!A.startsWith("./")&&!A.startsWith("/")&&!A.startsWith("../")&&(A=P+A),A=de(A),!/\.(md|html?)(?:$|[?#])/i.test(A))||(A=A.split(/[?#]/)[0],i(A)))continue;l.has(A)||(l.add(A),u.push(A),a.push(A))}catch(q){console.warn("[slugManager] href processing failed",A,q)}}}catch(f){console.warn("[slugManager] discovery fetch failed for",h,f)}}}catch(l){console.warn("[slugManager] discovery loop failed",l)}const c=new Set;a=a.filter(l=>!l||c.has(l)||i(l)?!1:(c.add(l),!0));const o=[];for(const l of a)if(/\.(?:md|html?)(?:$|[?#])/i.test(l))try{const u=await ke(l,t);if(u&&u.raw){if(u.status===404)continue;let h="",f="";if(u.isHtml)try{const m=new DOMParser().parseFromString(u.raw,"text/html"),w=m.querySelector("title")||m.querySelector("h1");w&&w.textContent&&(h=w.textContent.trim());const y=m.querySelector("p");if(y&&y.textContent&&(f=y.textContent.trim()),e>=2)try{const x=m.querySelector("h1"),I=x&&x.textContent?x.textContent.trim():h||"",P=(()=>{try{if(U.has(l))return U.get(l)}catch{}return ne(h||l)})(),A=Array.from(m.querySelectorAll("h2"));for(const q of A)try{const j=(q.textContent||"").trim();if(!j)continue;const G=q.id?q.id:ne(j),Y=P?`${P}::${G}`:`${ne(l)}::${G}`;let re="",D=q.nextElementSibling;for(;D&&D.tagName&&D.tagName.toLowerCase()==="script";)D=D.nextElementSibling;D&&D.textContent&&(re=String(D.textContent).trim()),o.push({slug:Y,title:j,excerpt:re,path:l,parentTitle:I})}catch(j){console.warn("[slugManager] indexing H2 failed",j)}if(e===3)try{const q=Array.from(m.querySelectorAll("h3"));for(const j of q)try{const G=(j.textContent||"").trim();if(!G)continue;const Y=j.id?j.id:ne(G),re=P?`${P}::${Y}`:`${ne(l)}::${Y}`;let D="",L=j.nextElementSibling;for(;L&&L.tagName&&L.tagName.toLowerCase()==="script";)L=L.nextElementSibling;L&&L.textContent&&(D=String(L.textContent).trim()),o.push({slug:re,title:G,excerpt:D,path:l,parentTitle:I})}catch(G){console.warn("[slugManager] indexing H3 failed",G)}}catch(q){console.warn("[slugManager] collect H3s failed",q)}}catch(x){console.warn("[slugManager] collect H2s failed",x)}}catch(d){console.warn("[slugManager] parsing HTML for index failed",d)}else{const d=u.raw,m=d.match(/^#\s+(.+)$/m);h=m?m[1].trim():"";try{h=Ot(h)}catch{}const w=d.split(/\r?\n\s*\r?\n/);if(w.length>1)for(let y=1;y<w.length;y++){const x=w[y].trim();if(x&&!/^#/.test(x)){f=x.replace(/\r?\n/g," ");break}}if(e>=2){let y="",x="";try{const I=(d.match(/^#\s+(.+)$/m)||[])[1];y=I?I.trim():"",x=(function(){try{if(U.has(l))return U.get(l)}catch{}return ne(h||l)})();const P=/^##\s+(.+)$/gm;let A;for(;A=P.exec(d);)try{const q=(A[1]||"").trim(),j=Ot(q);if(!q)continue;const G=ne(q),Y=x?`${x}::${G}`:`${ne(l)}::${G}`,D=d.slice(P.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),L=D&&D[1]?String(D[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";o.push({slug:Y,title:j,excerpt:L,path:l,parentTitle:y})}catch(q){console.warn("[slugManager] indexing markdown H2 failed",q)}}catch(I){console.warn("[slugManager] collect markdown H2s failed",I)}if(e===3)try{const I=/^###\s+(.+)$/gm;let P;for(;P=I.exec(d);)try{const A=(P[1]||"").trim(),q=Ot(A);if(!A)continue;const j=ne(A),G=x?`${x}::${j}`:`${ne(l)}::${j}`,re=d.slice(I.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),D=re&&re[1]?String(re[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";o.push({slug:G,title:q,excerpt:D,path:l,parentTitle:y})}catch(A){console.warn("[slugManager] indexing markdown H3 failed",A)}}catch(I){console.warn("[slugManager] collect markdown H3s failed",I)}}}let p="";try{U.has(l)&&(p=U.get(l))}catch(d){console.warn("[slugManager] mdToSlug access failed",d)}p||(p=ne(h||l)),o.push({slug:p,title:h,excerpt:f,path:l})}}catch(u){console.warn("[slugManager] buildSearchIndex: entry fetch failed",u)}try{He=o.filter(u=>{try{return!i(String(u.path||""))}catch{return!0}})}catch(l){console.warn("[slugManager] filtering index by excludes failed",l),He=o}return He})();try{await bt}catch(r){console.warn("[slugManager] awaiting _indexPromise failed",r)}return bt=null,He}const lr=1e3;let yt=lr;function ns(t){typeof t=="number"&&t>=0&&(yt=t)}const cr=new DOMParser,ur="a[href]";let mn=async function(t,e,n=yt){if(Dt.has(t))return Dt.get(t);let s=null;const r=new Set,i=[""];for(;i.length&&!s&&!(i.length>n);){const a=i.shift();if(r.has(a))continue;r.add(a);let c=e;c.endsWith("/")||(c+="/"),c+=a;try{let o;try{o=await globalThis.fetch(c)}catch(f){console.warn("[slugManager] crawlAllMarkdown: fetch failed",{url:c,error:f});continue}if(!o||!o.ok){o&&!o.ok&&console.warn("[slugManager] crawlAllMarkdown: directory fetch non-ok",{url:c,status:o.status});continue}const l=await o.text(),h=cr.parseFromString(l,"text/html").querySelectorAll(ur);for(const f of h)try{let p=f.getAttribute("href")||"";if(!p||gt(p,e)||p.startsWith("..")||p.indexOf("/../")!==-1)continue;if(p.endsWith("/")){const d=a+p;r.has(d)||i.push(d);continue}if(p.toLowerCase().endsWith(".md")){const d=de(a+p);try{if(U.has(d))continue;for(const m of X.values());}catch(m){console.warn("[slugManager] slug map access failed",m)}try{const m=await ke(d,e);if(m&&m.raw){const w=(m.raw||"").match(/^#\s+(.+)$/m);if(w&&w[1]&&ne(w[1].trim())===t){s=d;break}}}catch(m){console.warn("[slugManager] crawlForSlug: fetchMarkdown failed",m)}}}catch(p){console.warn("[slugManager] crawlForSlug: link iteration failed",p)}}catch(o){console.warn("[slugManager] crawlForSlug: directory fetch failed",o)}}return Dt.set(t,s),s};async function hr(t,e=yt){const n=new Set,s=new Set,r=[""];for(;r.length&&!(r.length>e);){const i=r.shift();if(s.has(i))continue;s.add(i);let a=t;a.endsWith("/")||(a+="/"),a+=i;try{let c;try{c=await globalThis.fetch(a)}catch(h){console.warn("[slugManager] crawlAllMarkdown: fetch failed",{url:a,error:h});continue}if(!c||!c.ok){c&&!c.ok&&console.warn("[slugManager] crawlAllMarkdown: directory fetch non-ok",{url:a,status:c.status});continue}const o=await c.text(),u=cr.parseFromString(o,"text/html").querySelectorAll(ur);for(const h of u)try{let f=h.getAttribute("href")||"";if(!f||gt(f,t)||f.startsWith("..")||f.indexOf("/../")!==-1)continue;if(f.endsWith("/")){const d=i+f;s.has(d)||r.push(d);continue}const p=(i+f).replace(/^\/+/,"");/\.(md|html?)$/i.test(p)&&n.add(p)}catch(f){console.warn("[slugManager] crawlAllMarkdown: link iteration failed",f)}}catch(c){console.warn("[slugManager] crawlAllMarkdown: directory fetch failed",c)}}return Array.from(n)}async function dr(t,e,n){if(t&&typeof t=="string"&&(t=de(t),t=dt(t)),X.has(t))return mt(t)||X.get(t);for(const r of Bt)try{const i=await r(t,e);if(i)return We(t,i),U.set(i,t),i}catch(i){console.warn("[slugManager] slug resolver failed",i)}if(Ce&&Ce.length){if(ft.has(t)){const r=ft.get(t);return X.set(t,r),U.set(r,t),r}for(const r of Ce)if(!zt.has(r))try{const i=await ke(r,e);if(i&&i.raw){const a=(i.raw||"").match(/^#\s+(.+)$/m);if(a&&a[1]){const c=ne(a[1].trim());if(zt.add(r),c&&ft.set(c,r),c===t)return We(t,r),U.set(r,t),r}}}catch(i){console.warn("[slugManager] manifest title fetch failed",i)}}try{const r=await Ht(e);if(r&&r.length){const i=r.find(a=>a.slug===t);if(i)return We(t,i.path),U.set(i.path,t),i.path}}catch(r){console.warn("[slugManager] buildSearchIndex lookup failed",r)}try{const r=await mn(t,e,n);if(r)return We(t,r),U.set(r,t),r}catch(r){console.warn("[slugManager] crawlForSlug lookup failed",r)}const s=[`${t}.html`,`${t}.md`];for(const r of s)try{const i=await ke(r,e);if(i&&i.raw)return We(t,r),U.set(r,t),r}catch(i){console.warn("[slugManager] candidate fetch failed",i)}if(Ce&&Ce.length)for(const r of Ce)try{const i=r.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(ne(i)===t)return We(t,r),U.set(r,t),r}catch(i){console.warn("[slugManager] build-time filename match failed",i)}try{const r=[];at&&typeof at=="string"&&at.trim()&&r.push(at),r.includes("_home.md")||r.push("_home.md");for(const i of r)try{const a=await ke(i,e);if(a&&a.raw){const c=(a.raw||"").match(/^#\s+(.+)$/m);if(c&&c[1]&&ne(c[1].trim())===t)return We(t,i),U.set(i,t),i}}catch{}}catch(r){console.warn("[slugManager] home page fetch failed",r)}return null}const Ut=Object.freeze(Object.defineProperty({__proto__:null,CRAWL_MAX_QUEUE:lr,_setAllMd:Xi,_storeSlugMapping:We,addSlugResolver:Zi,get allMarkdownPaths(){return Ce},get availableLanguages(){return Le},buildSearchIndex:Ht,buildSearchIndexWorker:Fi,clearFetchCache:Ji,clearListCaches:Ki,crawlAllMarkdown:hr,crawlCache:Dt,crawlForSlug:mn,crawlForSlugWorker:Wi,get defaultCrawlMaxQueue(){return yt},ensureSlug:dr,fetchCache:wt,get fetchMarkdown(){return ke},getLanguages:ji,get homePage(){return at},initSlugWorker:pn,isExternalLink:Vi,isExternalLinkWithBase:gt,listPathsFetched:zt,listSlugCache:ft,mdToSlug:U,get notFoundPage(){return st},removeSlugResolver:Gi,resolveSlugPath:mt,get searchIndex(){return He},setContentBase:Nt,setDefaultCrawlMaxQueue:ns,setFetchMarkdown:es,setHomePage:Qi,setLanguages:sr,setNotFoundPage:gn,setSkipRootReadme:qi,get skipRootReadme(){return dn},slugResolvers:Bt,slugToMd:X,slugify:ne,unescapeMarkdown:Ot},Symbol.toStringTag,{value:"Module"}));let pr=100;function fr(t){pr=t}let kt=300*1e3;function gr(t){kt=t}const Me=new Map;function rs(t){if(!Me.has(t))return;const e=Me.get(t),n=Date.now();if(e.ts+kt<n){Me.delete(t);return}return Me.delete(t),Me.set(t,e),e.value}function is(t,e){if(mr(),mr(),Me.delete(t),Me.set(t,{value:e,ts:Date.now()}),Me.size>pr){const n=Me.keys().next().value;n!==void 0&&Me.delete(n)}}function mr(){if(!kt||kt<=0)return;const t=Date.now();for(const[e,n]of Me.entries())n.ts+kt<t&&Me.delete(e)}async function ss(t,e){const n=new Set(Be),s=document.querySelectorAll(".nimbi-site-navbar a, .navbar a, .nimbi-nav a");for(const r of Array.from(s||[])){const i=r.getAttribute("href")||"";if(i)try{const a=new URL(i,location.href);if(a.origin!==location.origin)continue;const c=(a.hash||a.pathname).match(/([^#?]+\.md)(?:$|[?#])/)||(a.pathname||"").match(/([^#?]+\.md)(?:$|[?#])/);if(c){let l=de(c[1]);l&&n.add(l);continue}const o=a.pathname||"";if(o){const l=new URL(e),u=pt(l.pathname);if(o.indexOf(u)!==-1){let h=o.startsWith(u)?o.slice(u.length):o;h=de(h),h&&n.add(h)}}}catch(a){console.warn("[router] malformed URL while discovering index candidates",a)}}for(const r of n)try{if(!r||!String(r).includes(".md"))continue;const i=await ke(r,e);if(!i||!i.raw)continue;const a=(i.raw||"").match(/^#\s+(.+)$/m);if(a){const c=(a[1]||"").trim();if(c&&ne(c)===t)return r}}catch(i){console.warn("[router] fetchMarkdown during index discovery failed",i)}return null}function as(t){const e=[];if(String(t).includes(".md")||String(t).includes(".html"))/index\.html$/i.test(t)||e.push(t);else try{const n=decodeURIComponent(String(t||""));if(X.has(n)){const s=mt(n)||X.get(n);s&&(/\.(md|html?)$/i.test(s)?/index\.html$/i.test(s)||e.push(s):(e.push(s),e.push(s+".html")))}else{if(Be&&Be.size)for(const s of Be){const r=s.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(ne(r)===n&&!/index\.html$/i.test(s)){e.push(s);break}}!e.length&&n&&!/\.(md|html?)$/i.test(n)&&(e.push(n+".html"),e.push(n+".md"))}}catch(n){console.warn("[router] buildPageCandidates failed during slug handling",n)}return e}async function os(t,e){const n=t||"",s=location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null;let r=t||"",i=null;if(r&&String(r).includes("::")){const d=String(r).split("::",2);r=d[0],i=d[1]||null}const c=`${t}|||${typeof Ni<"u"&&Fe?Fe:""}`,o=rs(c);if(o)r=o.resolved,i=o.anchor||i;else{if(!String(r).includes(".md")&&!String(r).includes(".html")){let d=decodeURIComponent(String(r||""));if(d&&typeof d=="string"&&(d=de(d),d=dt(d)),X.has(d))r=mt(d)||X.get(d);else{let m=await ss(d,e);if(m)r=m;else if(hn._refreshed&&Be&&Be.size||typeof e=="string"&&/^[a-z][a-z0-9+.-]*:\/\//i.test(e)){const w=await dr(d,e);w&&(r=w)}}}is(c,{resolved:r,anchor:i})}!i&&s&&(i=s);const l=as(r),u=String(n||"").includes(".md")||String(n||"").includes(".html");if(u&&l.length===0&&(String(r).includes(".md")||String(r).includes(".html"))&&l.push(r),l.length===0&&(String(r).includes(".md")||String(r).includes(".html"))&&l.push(r),l.length===1&&/index\.html$/i.test(l[0])&&!u&&!X.has(r)&&!X.has(decodeURIComponent(String(r||"")))&&!String(r||"").includes("/"))throw new Error("Unknown slug: index.html fallback prevented");let h=null,f=null,p=null;for(const d of l)if(d)try{const m=de(d);h=await ke(m,e),f=m;break}catch(m){p=m;try{console.warn("[router] candidate fetch failed",{candidate:d,contentBase:e,err:m&&m.message||m})}catch{}}if(!h){try{console.error("[router] fetchPageData: no page data for",{originalRaw:n,resolved:r,pageCandidates:l,contentBase:e,fetchError:p&&(p.message||String(p))||null})}catch{}try{if(u&&String(n||"").toLowerCase().includes(".html"))try{const d=new URL(String(n||""),location.href).toString();console.warn("[router] attempting absolute HTML fetch fallback",d);const m=await fetch(d);if(m&&m.ok){const w=await m.text(),y=m&&m.headers&&typeof m.headers.get=="function"&&m.headers.get("content-type")||"",x=(w||"").toLowerCase(),I=y&&y.indexOf&&y.indexOf("text/html")!==-1||x.indexOf("<!doctype")!==-1||x.indexOf("<html")!==-1;if(I||console.warn("[router] absolute fetch returned non-HTML",{abs:d,contentType:y,snippet:x.slice(0,200)}),I)try{const P=d,A=new URL(".",P).toString();try{const j=typeof DOMParser<"u"?new DOMParser:null;if(j){const G=j.parseFromString(w||"","text/html"),Y=(C,R)=>{try{const v=R.getAttribute(C)||"";if(!v||/^(https?:)?\/\//i.test(v)||v.startsWith("/")||v.startsWith("#"))return;try{const b=new URL(v,P).toString();R.setAttribute(C,b)}catch(b){console.warn("[router] rewrite attribute failed",C,b)}}catch(v){console.warn("[router] rewrite helper failed",v)}},re=G.querySelectorAll("[src],[href],[srcset],[xlink:href],[poster]"),D=[];for(const C of Array.from(re||[]))try{const R=C.tagName?C.tagName.toLowerCase():"";if(R==="a")continue;if(C.hasAttribute("src")){const v=C.getAttribute("src");Y("src",C);const b=C.getAttribute("src");v!==b&&D.push({attr:"src",tag:R,before:v,after:b})}if(C.hasAttribute("href")&&R==="link"){const v=C.getAttribute("href");Y("href",C);const b=C.getAttribute("href");v!==b&&D.push({attr:"href",tag:R,before:v,after:b})}if(C.hasAttribute("href")&&R!=="link"){const v=C.getAttribute("href");Y("href",C);const b=C.getAttribute("href");v!==b&&D.push({attr:"href",tag:R,before:v,after:b})}if(C.hasAttribute("xlink:href")){const v=C.getAttribute("xlink:href");Y("xlink:href",C);const b=C.getAttribute("xlink:href");v!==b&&D.push({attr:"xlink:href",tag:R,before:v,after:b})}if(C.hasAttribute("poster")){const v=C.getAttribute("poster");Y("poster",C);const b=C.getAttribute("poster");v!==b&&D.push({attr:"poster",tag:R,before:v,after:b})}if(C.hasAttribute("srcset")){const _=(C.getAttribute("srcset")||"").split(",").map(z=>z.trim()).filter(Boolean).map(z=>{const[k,ie]=z.split(/\s+/,2);if(!k||/^(https?:)?\/\//i.test(k)||k.startsWith("/"))return z;try{const he=new URL(k,P).toString();return ie?`${he} ${ie}`:he}catch{return z}}).join(", ");C.setAttribute("srcset",_)}}catch{}const L=G.documentElement&&G.documentElement.outerHTML?G.documentElement.outerHTML:w;try{D&&D.length&&console.warn("[router] rewritten asset refs",{abs:d,rewritten:D})}catch{}return{data:{raw:L,isHtml:!0},pagePath:String(n||""),anchor:i}}}catch{}let q=w;return/<base\s+[^>]*>/i.test(w)||(/<head[^>]*>/i.test(w)?q=w.replace(/(<head[^>]*>)/i,`$1<base href="${A}">`):q=`<base href="${A}">`+w),{data:{raw:q,isHtml:!0},pagePath:String(n||""),anchor:i}}catch{return{data:{raw:w,isHtml:!0},pagePath:String(n||""),anchor:i}}}}catch(d){console.warn("[router] absolute HTML fetch fallback failed",d)}}catch{}throw new Error("no page data")}return{data:h,pagePath:f,anchor:i}}function wn(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Ke=wn();function wr(t){Ke=t}var Ye={exec:()=>null};function J(t,e=""){let n=typeof t=="string"?t:t.source,s={replace:(r,i)=>{let a=typeof i=="string"?i:i.source;return a=a.replace(Re.caret,"$1"),n=n.replace(r,a),s},getRegex:()=>new RegExp(n,e)};return s}var ls=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),Re={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:t=>new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}#`),htmlBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}>`)},cs=/^(?:[ \t]*(?:\n|$))+/,us=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,hs=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,xt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,ds=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,bn=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,br=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,yr=J(br).replace(/bull/g,bn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),ps=J(br).replace(/bull/g,bn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),yn=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,fs=/^[^\n]+/,kn=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,gs=J(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",kn).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),ms=J(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,bn).getRegex(),qt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",xn=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ws=J("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",xn).replace("tag",qt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),kr=J(yn).replace("hr",xt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",qt).getRegex(),bs=J(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",kr).getRegex(),Sn={blockquote:bs,code:us,def:gs,fences:hs,heading:ds,hr:xt,html:ws,lheading:yr,list:ms,newline:cs,paragraph:kr,table:Ye,text:fs},xr=J("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",xt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",qt).getRegex(),ys={...Sn,lheading:ps,table:xr,paragraph:J(yn).replace("hr",xt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",xr).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",qt).getRegex()},ks={...Sn,html:J(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",xn).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ye,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:J(yn).replace("hr",xt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",yr).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},xs=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ss=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Sr=/^( {2,}|\\)\n(?!\s*$)/,vs=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,jt=/[\p{P}\p{S}]/u,vn=/[\s\p{P}\p{S}]/u,vr=/[^\s\p{P}\p{S}]/u,As=J(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,vn).getRegex(),Ar=/(?!~)[\p{P}\p{S}]/u,Es=/(?!~)[\s\p{P}\p{S}]/u,Rs=/(?:[^\s\p{P}\p{S}]|~)/u,Er=/(?![*_])[\p{P}\p{S}]/u,Ts=/(?![*_])[\s\p{P}\p{S}]/u,Ls=/(?:[^\s\p{P}\p{S}]|[*_])/u,Cs=J(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",ls?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Rr=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,_s=J(Rr,"u").replace(/punct/g,jt).getRegex(),Ms=J(Rr,"u").replace(/punct/g,Ar).getRegex(),Tr="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Ps=J(Tr,"gu").replace(/notPunctSpace/g,vr).replace(/punctSpace/g,vn).replace(/punct/g,jt).getRegex(),$s=J(Tr,"gu").replace(/notPunctSpace/g,Rs).replace(/punctSpace/g,Es).replace(/punct/g,Ar).getRegex(),Is=J("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,vr).replace(/punctSpace/g,vn).replace(/punct/g,jt).getRegex(),Bs=J(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,Er).getRegex(),zs="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",Ns=J(zs,"gu").replace(/notPunctSpace/g,Ls).replace(/punctSpace/g,Ts).replace(/punct/g,Er).getRegex(),Os=J(/\\(punct)/,"gu").replace(/punct/g,jt).getRegex(),Ds=J(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Hs=J(xn).replace("(?:-->|$)","-->").getRegex(),Us=J("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Hs).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Ft=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,qs=J(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",Ft).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Lr=J(/^!?\[(label)\]\[(ref)\]/).replace("label",Ft).replace("ref",kn).getRegex(),Cr=J(/^!?\[(ref)\](?:\[\])?/).replace("ref",kn).getRegex(),js=J("reflink|nolink(?!\\()","g").replace("reflink",Lr).replace("nolink",Cr).getRegex(),_r=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,An={_backpedal:Ye,anyPunctuation:Os,autolink:Ds,blockSkip:Cs,br:Sr,code:Ss,del:Ye,delLDelim:Ye,delRDelim:Ye,emStrongLDelim:_s,emStrongRDelimAst:Ps,emStrongRDelimUnd:Is,escape:xs,link:qs,nolink:Cr,punctuation:As,reflink:Lr,reflinkSearch:js,tag:Us,text:vs,url:Ye},Fs={...An,link:J(/^!?\[(label)\]\((.*?)\)/).replace("label",Ft).getRegex(),reflink:J(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Ft).getRegex()},En={...An,emStrongRDelimAst:$s,emStrongLDelim:Ms,delLDelim:Bs,delRDelim:Ns,url:J(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",_r).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:J(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",_r).getRegex()},Ws={...En,br:J(Sr).replace("{2,}","*").getRegex(),text:J(En.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Wt={normal:Sn,gfm:ys,pedantic:ks},St={normal:An,gfm:En,breaks:Ws,pedantic:Fs},Zs={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Mr=t=>Zs[t];function ze(t,e){if(e){if(Re.escapeTest.test(t))return t.replace(Re.escapeReplace,Mr)}else if(Re.escapeTestNoEncode.test(t))return t.replace(Re.escapeReplaceNoEncode,Mr);return t}function Pr(t){try{t=encodeURI(t).replace(Re.percentDecode,"%")}catch{return null}return t}function $r(t,e){let n=t.replace(Re.findPipe,(i,a,c)=>{let o=!1,l=a;for(;--l>=0&&c[l]==="\\";)o=!o;return o?"|":" |"}),s=n.split(Re.splitPipe),r=0;if(s[0].trim()||s.shift(),s.length>0&&!s.at(-1)?.trim()&&s.pop(),e)if(s.length>e)s.splice(e);else for(;s.length<e;)s.push("");for(;r<s.length;r++)s[r]=s[r].trim().replace(Re.slashPipe,"|");return s}function vt(t,e,n){let s=t.length;if(s===0)return"";let r=0;for(;r<s&&t.charAt(s-r-1)===e;)r++;return t.slice(0,s-r)}function Gs(t,e){if(t.indexOf(e[1])===-1)return-1;let n=0;for(let s=0;s<t.length;s++)if(t[s]==="\\")s++;else if(t[s]===e[0])n++;else if(t[s]===e[1]&&(n--,n<0))return s;return n>0?-2:-1}function Qs(t,e=0){let n=e,s="";for(let r of t)if(r==="	"){let i=4-n%4;s+=" ".repeat(i),n+=i}else s+=r,n++;return s}function Ir(t,e,n,s,r){let i=e.href,a=e.title||null,c=t[1].replace(r.other.outputLinkReplace,"$1");s.state.inLink=!0;let o={type:t[0].charAt(0)==="!"?"image":"link",raw:n,href:i,title:a,text:c,tokens:s.inlineTokens(c)};return s.state.inLink=!1,o}function Xs(t,e,n){let s=t.match(n.other.indentCodeCompensation);if(s===null)return e;let r=s[1];return e.split(`
...
`;for(let w=o;w<=l;w++)if((e(f[w])||!h(f[w])&&(h(f[w+1])||e(f[w+1])))&&c++,e(f[w]))for(;w<=l&&(s(f[w+1])||h(f[w+1]));)w++;const p=c/u,d=Math.round(p*60*1e3);return{text:Math.ceil(p.toFixed(2))+" min read",minutes:p,time:d,words:c}}return In=r,In}var wa=ma();const ba=Gn(wa);function Gr(t,e){let n=document.querySelector(`meta[name="${t}"]`);n||(n=document.createElement("meta"),n.setAttribute("name",t),document.head.appendChild(n)),n.setAttribute("content",e)}function ot(t,e,n){let s=`meta[${t}="${e}"]`,r=document.querySelector(s);r||(r=document.createElement("meta"),r.setAttribute(t,e),document.head.appendChild(r)),r.setAttribute("content",n)}function ya(t,e){try{let n=document.querySelector(`link[rel="${t}"]`);n||(n=document.createElement("link"),n.setAttribute("rel",t),document.head.appendChild(n)),n.setAttribute("href",e)}catch(n){console.warn("[seoManager] upsertLinkRel failed",n)}}function ka(t,e,n,s){const r=e&&String(e).trim()?e:t.title||document.title;ot("property","og:title",r);const i=s&&String(s).trim()?s:t.description||"";i&&String(i).trim()&&ot("property","og:description",i),ot("name","twitter:card",t.twitter_card||"summary_large_image");const a=n||t.image;a&&(ot("property","og:image",a),ot("name","twitter:image",a))}function xa(t,e,n,s,r=""){const i=t.meta||{},a=document&&document.querySelector&&document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",c=s&&String(s).trim()?s:i.description&&String(i.description).trim()?i.description:a&&String(a).trim()?a:"";c&&String(c).trim()&&Gr("description",c),Gr("robots",i.robots||"index,follow"),ka(i,e,n,c)}function Sa(){try{const t=['meta[name="site"]','meta[name="site-name"]','meta[name="siteName"]','meta[property="og:site_name"]','meta[name="twitter:site"]'];for(const e of t){const n=document.querySelector(e);if(n){const s=n.getAttribute("content")||"";if(s&&s.trim())return s.trim()}}}catch(t){console.warn("[seoManager] getSiteNameFromMeta failed",t)}return""}function va(t,e,n,s,r,i=""){try{const a=t.meta||{},c=n&&String(n).trim()?n:a.title||i||document.title,o=r&&String(r).trim()?r:a.description||document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",l=s||a.image||null;let u="";try{if(e){const d=de(e);try{u=(location.origin+location.pathname).split("?")[0]+"?page="+encodeURIComponent(d)}catch{u=location.href.split("#")[0]}}else u=location.href.split("#")[0]}catch(d){u=location.href.split("#")[0],console.warn("[seoManager] compute canonical failed",d)}u&&ya("canonical",u);try{ot("property","og:url",u)}catch(d){console.warn("[seoManager] upsertMeta og:url failed",d)}const h={"@context":"https://schema.org","@type":"Article",headline:c||"",description:o||"",url:u||location.href.split("#")[0]};l&&(h.image=String(l)),a.date&&(h.datePublished=a.date),a.dateModified&&(h.dateModified=a.dateModified);const f="nimbi-jsonld";let p=document.getElementById(f);p||(p=document.createElement("script"),p.type="application/ld+json",p.id=f,document.head.appendChild(p)),p.textContent=JSON.stringify(h,null,2)}catch(a){console.warn("[seoManager] setStructuredData failed",a)}}function Aa(t,e,n,s,r,i,a,c,o,l,u){try{const h=s.querySelector(".menu-label");h&&(h.textContent=c&&c.textContent||t("onThisPage"))}catch(h){console.warn("[seoManager] update toc label failed",h)}try{const h=n.meta&&n.meta.title?String(n.meta.title).trim():"",f=r.querySelector("img"),p=f&&(f.getAttribute("src")||f.src)||null;let d="";try{let w="";try{const y=c||(r&&r.querySelector?r.querySelector("h1"):null);if(y){let x=y.nextElementSibling;const I=[];for(;x&&!(x.tagName&&x.tagName.toLowerCase()==="h2");){const P=(x.textContent||"").trim();P&&I.push(P),x=x.nextElementSibling}I.length&&(w=I.join(" ").replace(/\s+/g," ").trim()),!w&&o&&(w=String(o).trim())}}catch(y){console.warn("[seoManager] compute descOverride failed",y)}w&&String(w).length>160&&(w=String(w).slice(0,157).trim()+"..."),d=w}catch(w){console.warn("[seoManager] compute descOverride failed",w)}try{xa(n,o,p,d)}catch(w){console.warn("[seoManager] setMetaTags failed",w)}try{va(n,l,o,p,d,e)}catch(w){console.warn("[seoManager] setStructuredData failed",w)}const m=Sa();o?m?document.title=`${m} - ${o}`:document.title=`${e||"Site"} - ${o}`:h?document.title=h:document.title=e||document.title}catch(h){console.warn("[seoManager] applyPageMeta failed",h)}try{const h=r.querySelector(".nimbi-reading-time");if(h&&h.remove(),o){const f=ba(u.raw||""),p=f&&typeof f.minutes=="number"?Math.ceil(f.minutes):0,d=document.createElement("p");d.className="nimbi-reading-time",d.textContent=p?t("readingTime",{minutes:p}):"";const m=r.querySelector("h1");m&&m.insertAdjacentElement("afterend",d)}}catch(h){console.warn("[seoManager] reading time update failed",h)}}let ve=null,O=null,we=1,Ge=(t,e)=>e,Et=0,Rt=0,Xt=()=>{},Tt=.25;function Ea(){if(ve&&document.contains(ve))return ve;ve=null;const t=document.createElement("dialog");t.className="nimbi-image-preview",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label",Ge("imagePreviewTitle","Image preview")),t.innerHTML=`
  ...
  `,t.addEventListener("click",b=>{b.target===t&&Bn()}),t.addEventListener("wheel",b=>{if(!re())return;b.preventDefault();const _=b.deltaY<0?Tt:-Tt;Ue(we+_),l(),u()},{passive:!1}),t.addEventListener("keydown",b=>{if(b.key==="Escape"){Bn();return}if(we>1){const _=t.querySelector(".nimbi-image-preview__image-wrapper");if(!_)return;const z=40;switch(b.key){case"ArrowUp":_.scrollTop-=z,b.preventDefault();break;case"ArrowDown":_.scrollTop+=z,b.preventDefault();break;case"ArrowLeft":_.scrollLeft-=z,b.preventDefault();break;case"ArrowRight":_.scrollLeft+=z,b.preventDefault();break}}}),document.body.appendChild(t),ve=t,O=t.querySelector("[data-nimbi-preview-image]");const e=t.querySelector("[data-nimbi-preview-fit]"),n=t.querySelector("[data-nimbi-preview-original]"),s=t.querySelector("[data-nimbi-preview-zoom-in]"),r=t.querySelector("[data-nimbi-preview-zoom-out]"),i=t.querySelector("[data-nimbi-preview-reset]"),a=t.querySelector("[data-nimbi-preview-close]"),c=t.querySelector("[data-nimbi-preview-zoom-label]"),o=t.querySelector("[data-nimbi-preview-zoom-hud]");function l(){c&&(c.textContent=`${Math.round(we*100)}%`)}const u=()=>{o&&(o.textContent=`${Math.round(we*100)}%`,o.classList.add("visible"),clearTimeout(o._timeout),o._timeout=setTimeout(()=>o.classList.remove("visible"),800))};Xt=l,s.addEventListener("click",()=>{Ue(we+Tt),l(),u()}),r.addEventListener("click",()=>{Ue(we-Tt),l(),u()}),e.addEventListener("click",()=>{Lt(),l(),u()}),n.addEventListener("click",()=>{Ue(1),l(),u()}),i.addEventListener("click",()=>{Lt(),l(),u()}),a.addEventListener("click",Bn),e.title=Ge("imagePreviewFit","Fit to screen"),n.title=Ge("imagePreviewOriginal","Original size"),r.title=Ge("imagePreviewZoomOut","Zoom out"),s.title=Ge("imagePreviewZoomIn","Zoom in"),a.title=Ge("imagePreviewClose","Close"),a.setAttribute("aria-label",Ge("imagePreviewClose","Close"));let h=!1,f=0,p=0,d=0,m=0;const w=new Map;let y=0,x=1;const I=(b,_)=>{const z=b.x-_.x,k=b.y-_.y;return Math.hypot(z,k)},P=()=>{if(h=!1,w.clear(),y=0,O){O.classList.add("is-panning"),O.classList.remove("is-grabbing");try{O.style.cursor="all-scroll"}catch{}}};let A=0,q=0,j=0;const G=b=>{const _=Date.now(),z=_-A,k=b.clientX-q,ie=b.clientY-j;A=_,q=b.clientX,j=b.clientY,z<300&&Math.hypot(k,ie)<30&&(Ue(we>1?1:2),l(),b.preventDefault())},Y=b=>{Ue(we>1?1:2),l(),b.preventDefault()},re=()=>ve?typeof ve.open=="boolean"?ve.open:ve.classList.contains("is-active"):!1,D=(b,_,z=1)=>{if(w.has(z)&&w.set(z,{x:b,y:_}),w.size===2){const Ae=Array.from(w.values()),xe=I(Ae[0],Ae[1]);if(y>0){const ee=xe/y;Ue(x*ee)}return}if(!h)return;const k=O.closest(".nimbi-image-preview__image-wrapper");if(!k)return;const ie=b-f,he=_-p;k.scrollLeft=d-ie,k.scrollTop=m-he},L=(b,_,z=1)=>{if(!re())return;if(w.set(z,{x:b,y:_}),w.size===2){const he=Array.from(w.values());y=I(he[0],he[1]),x=we;return}const k=O.closest(".nimbi-image-preview__image-wrapper");if(!(!k||!(k.scrollWidth>k.clientWidth||k.scrollHeight>k.clientHeight))){h=!0,f=b,p=_,d=k.scrollLeft,m=k.scrollTop,O.classList.add("is-panning"),O.classList.remove("is-grabbing");try{O.style.cursor="all-scroll"}catch{}window.addEventListener("pointermove",C),window.addEventListener("pointerup",R),window.addEventListener("pointercancel",R)}},C=b=>{h&&(b.preventDefault(),D(b.clientX,b.clientY,b.pointerId))},R=()=>{P(),window.removeEventListener("pointermove",C),window.removeEventListener("pointerup",R),window.removeEventListener("pointercancel",R)};O.addEventListener("pointerdown",b=>{b.preventDefault(),L(b.clientX,b.clientY,b.pointerId)}),O.addEventListener("pointermove",b=>{(h||w.size===2)&&b.preventDefault(),D(b.clientX,b.clientY,b.pointerId)}),O.addEventListener("pointerup",b=>{b.preventDefault(),b.pointerType==="touch"&&G(b),P()}),O.addEventListener("dblclick",Y),O.addEventListener("pointercancel",P),O.addEventListener("mousedown",b=>{b.preventDefault(),L(b.clientX,b.clientY,1)}),O.addEventListener("mousemove",b=>{h&&b.preventDefault(),D(b.clientX,b.clientY,1)}),O.addEventListener("mouseup",b=>{b.preventDefault(),P()});const v=t.querySelector(".nimbi-image-preview__image-wrapper");return v&&(v.addEventListener("pointerdown",b=>{if(L(b.clientX,b.clientY,b.pointerId),b&&b.target&&b.target.tagName==="IMG")try{b.target.classList.add("is-grabbing"),b.target.style.cursor="grabbing"}catch{}}),v.addEventListener("pointermove",b=>{D(b.clientX,b.clientY,b.pointerId)}),v.addEventListener("pointerup",P),v.addEventListener("pointercancel",P),v.addEventListener("mousedown",b=>{if(L(b.clientX,b.clientY,1),b&&b.target&&b.target.tagName==="IMG")try{b.target.classList.add("is-grabbing"),b.target.style.cursor="grabbing"}catch{}}),v.addEventListener("mousemove",b=>{D(b.clientX,b.clientY,1)}),v.addEventListener("mouseup",P)),t}function Ue(t){if(!O)return;const e=Number(t);we=Number.isFinite(e)?Math.max(.1,Math.min(4,e)):1;const s=O.getBoundingClientRect(),r=Et||O.naturalWidth||O.width||s.width||0,i=Rt||O.naturalHeight||O.height||s.height||0;if(r&&i){O.style.setProperty("--nimbi-preview-img-max-width","none"),O.style.setProperty("--nimbi-preview-img-max-height","none"),O.style.setProperty("--nimbi-preview-img-width",`${r*we}px`),O.style.setProperty("--nimbi-preview-img-height",`${i*we}px`),O.style.setProperty("--nimbi-preview-img-transform","none");try{O.style.width=`${r*we}px`,O.style.height=`${i*we}px`,O.style.transform="none"}catch{}}else{O.style.setProperty("--nimbi-preview-img-max-width",""),O.style.setProperty("--nimbi-preview-img-max-height",""),O.style.setProperty("--nimbi-preview-img-width",""),O.style.setProperty("--nimbi-preview-img-height",""),O.style.setProperty("--nimbi-preview-img-transform",`scale(${we})`);try{O.style.transform=`scale(${we})`}catch{}}if(O){O.classList.add("is-panning"),O.classList.remove("is-grabbing");try{O.style.cursor="all-scroll"}catch{}}}function Lt(){if(!O)return;const t=O.closest(".nimbi-image-preview__image-wrapper");if(!t)return;const e=t.getBoundingClientRect();if(e.width===0||e.height===0)return;const n=Et||O.naturalWidth||e.width,s=Rt||O.naturalHeight||e.height;if(!n||!s)return;const r=e.width/n,i=e.height/s,a=Math.min(r,i,1);Ue(Number.isFinite(a)?a:1)}function Ra(t,e="",n=0,s=0){const r=Ea();we=1,Et=n||0,Rt=s||0,O.src=t,O.alt=e,O.style.transform="scale(1)";const i=()=>{Et=O.naturalWidth||O.width||0,Rt=O.naturalHeight||O.height||0};if(i(),Lt(),Xt(),requestAnimationFrame(()=>{Lt(),Xt()}),!Et||!Rt){const a=()=>{i(),requestAnimationFrame(()=>{Lt(),Xt()}),O.removeEventListener("load",a)};O.addEventListener("load",a)}typeof r.showModal=="function"&&(r.open||r.showModal()),r.classList.add("is-active"),r.focus()}function Bn(){ve&&(typeof ve.close=="function"&&ve.open&&ve.close(),ve.classList.remove("is-active"))}function Ta(t,{t:e,zoomStep:n=.25}={}){if(!t||!t.querySelectorAll)return;Ge=(p,d)=>(typeof e=="function"?e(p):void 0)||d,Tt=n,t.addEventListener("click",p=>{const d=p.target;if(!d||d.tagName!=="IMG")return;const m=d;if(m.src){if(p.defaultPrevented!==!0){const w=m.closest("a");w&&w.getAttribute("href")&&p.preventDefault()}Ra(m.src,m.alt||"",m.naturalWidth||0,m.naturalHeight||0)}});let s=!1,r=0,i=0,a=0,c=0;const o=new Map;let l=0,u=1;const h=(p,d)=>{const m=p.x-d.x,w=p.y-d.y;return Math.hypot(m,w)};t.addEventListener("pointerdown",p=>{const d=p.target;if(!d||d.tagName!=="IMG"||!ve||!ve.open)return;if(o.set(p.pointerId,{x:p.clientX,y:p.clientY}),o.size===2){const w=Array.from(o.values());l=h(w[0],w[1]),u=we;return}const m=d.closest(".nimbi-image-preview__image-wrapper");m&&(we<=1||(p.preventDefault(),s=!0,r=p.clientX,i=p.clientY,a=m.scrollLeft,c=m.scrollTop,d.setPointerCapture(p.pointerId),d.style.cursor="grabbing"))}),t.addEventListener("pointermove",p=>{if(o.has(p.pointerId)&&o.set(p.pointerId,{x:p.clientX,y:p.clientY}),o.size===2){p.preventDefault();const x=Array.from(o.values()),I=h(x[0],x[1]);if(l>0){const P=I/l;Ue(u*P)}return}if(!s)return;p.preventDefault();const m=p.target.closest(".nimbi-image-preview__image-wrapper");if(!m)return;const w=p.clientX-r,y=p.clientY-i;m.scrollLeft=a-w,m.scrollTop=c-y});const f=()=>{s=!1,o.clear(),l=0};t.addEventListener("pointerup",f),t.addEventListener("pointercancel",f)}function La(t){const{contentWrap:e,navWrap:n,container:s,mountOverlay:r=null,t:i,contentBase:a,homePage:c,initialDocumentTitle:o,runHooks:l}=t||{};if(!e||!(e instanceof HTMLElement))throw new TypeError("contentWrap must be an HTMLElement");let u=null;const h=ra(i,[{path:c,name:i("home"),isIndex:!0,children:[]}]);async function f(y,x){let I,P,A;try{({data:I,pagePath:P,anchor:A}=await os(y,a))}catch(L){console.error("[nimbi-cms] fetchPageData failed",L),Fr(e,i,L);return}!A&&x&&(A=x);try{$n(null)}catch(L){console.warn("[nimbi-cms] scrollToAnchorOrTop failed",L)}e.innerHTML="";const{article:q,parsed:j,toc:G,topH1:Y,h1Text:re,slugKey:D}=await ha(i,I,P,A,a);Aa(i,o,j,G,q,P,A,Y,re,D,I),n.innerHTML="",n.appendChild(G),pa(G);try{await l("transformHtml",{article:q,parsed:j,toc:G,pagePath:P,anchor:A,topH1:Y,h1Text:re,slugKey:D,data:I})}catch(L){console.warn("[nimbi-cms] transformHtml hooks failed",L)}e.appendChild(q);try{Ta(q,{t:i})}catch(L){console.warn("[nimbi-cms] attachImagePreview failed",L)}try{$t(s,100,!1),requestAnimationFrame(()=>$t(s,100,!1)),setTimeout(()=>$t(s,100,!1),250)}catch(L){console.warn("[nimbi-cms] setEagerForAboveFoldImages failed",L)}$n(A),fa(q,Y,{mountOverlay:r,container:s,navWrap:n,t:i});try{await l("onPageLoad",{data:I,pagePath:P,anchor:A,article:q,toc:G,topH1:Y,h1Text:re,slugKey:D,contentWrap:e,navWrap:n})}catch(L){console.warn("[nimbi-cms] onPageLoad hooks failed",L)}u=P}async function p(){let y=new URLSearchParams(location.search).get("page")||c;const x=location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null;try{await f(y,x)}catch(I){console.warn("[nimbi-cms] renderByQuery failed for",y,I),Fr(e,i,I)}}window.addEventListener("popstate",p);const d=()=>`nimbi-cms-scroll:${location.pathname}${location.search}`,m=()=>{try{const y=s||document.querySelector(".nimbi-cms");if(!y)return;const x={top:y.scrollTop||0,left:y.scrollLeft||0};sessionStorage.setItem(d(),JSON.stringify(x))}catch{}},w=()=>{try{const y=s||document.querySelector(".nimbi-cms");if(!y)return;const x=sessionStorage.getItem(d());if(!x)return;const I=JSON.parse(x);I&&typeof I.top=="number"&&y.scrollTo({top:I.top,left:I.left||0,behavior:"auto"})}catch{}};return window.addEventListener("pageshow",y=>{if(y.persisted)try{w(),$t(s,100,!1)}catch(x){console.warn("[nimbi-cms] bfcache restore failed",x)}}),window.addEventListener("pagehide",()=>{try{m()}catch(y){console.warn("[nimbi-cms] save scroll position failed",y)}}),{renderByQuery:p,siteNav:h,getCurrentPagePath:()=>u}}function Ca(t){try{const e=typeof t=="string"?t:typeof window<"u"&&window.location?window.location.search:"";if(!e)return{};const n=new URLSearchParams(e.startsWith("?")?e.slice(1):e),s={},r=i=>{if(i==null)return;const a=String(i).toLowerCase();if(a==="1"||a==="true"||a==="yes")return!0;if(a==="0"||a==="false"||a==="no")return!1};if(n.has("contentPath")&&(s.contentPath=n.get("contentPath")),n.has("searchIndex")){const i=r(n.get("searchIndex"));typeof i=="boolean"&&(s.searchIndex=i)}if(n.has("searchIndexMode")){const i=n.get("searchIndexMode");(i==="eager"||i==="lazy")&&(s.searchIndexMode=i)}if(n.has("defaultStyle")){const i=n.get("defaultStyle");(i==="light"||i==="dark")&&(s.defaultStyle=i)}if(n.has("bulmaCustomize")&&(s.bulmaCustomize=n.get("bulmaCustomize")),n.has("lang")&&(s.lang=n.get("lang")),n.has("l10nFile")){const i=n.get("l10nFile");s.l10nFile=i==="null"?null:i}if(n.has("cacheTtlMinutes")){const i=Number(n.get("cacheTtlMinutes"));Number.isFinite(i)&&i>=0&&(s.cacheTtlMinutes=i)}if(n.has("cacheMaxEntries")){const i=Number(n.get("cacheMaxEntries"));Number.isInteger(i)&&i>=0&&(s.cacheMaxEntries=i)}if(n.has("homePage")&&(s.homePage=n.get("homePage")),n.has("notFoundPage")&&(s.notFoundPage=n.get("notFoundPage")),n.has("availableLanguages")&&(s.availableLanguages=n.get("availableLanguages").split(",").map(i=>i.trim()).filter(Boolean)),n.has("indexDepth")){const i=Number(n.get("indexDepth"));Number.isInteger(i)&&(i===1||i===2||i===3)&&(s.indexDepth=i)}if(n.has("noIndexing")){const a=(n.get("noIndexing")||"").split(",").map(c=>c.trim()).filter(Boolean);a.length&&(s.noIndexing=a)}return s}catch{return{}}}function _a(t){return!(typeof t!="string"||!t.trim()||t.includes("..")||/^[a-zA-Z][a-zA-Z0-9+.-]*:\/\//.test(t)||t.startsWith("//")||t.startsWith("/")||/^[A-Za-z]:\\/.test(t))}function Qr(t){if(typeof t!="string")return!1;const e=t.trim();return!(!e||e.includes("/")||e.includes("\\")||e.includes("..")||!/^[A-Za-z0-9._-]+\.(md|html)$/.test(e))}let zn="";async function Ma(t={}){if(!t||typeof t!="object")throw new TypeError("initCMS(options): options must be an object");const e=Ca();if(e&&(e.contentPath||e.homePage||e.notFoundPage))if(t&&t.allowUrlPathOverrides===!0)try{console.warn("[nimbi-cms] allowUrlPathOverrides enabled by host; honoring URL overrides for contentPath/homePage/notFoundPage")}catch(k){console.warn("[nimbi-cms] allowUrlPathOverrides logging failed",k)}else{try{console.warn("[nimbi-cms] ignoring unsafe URL overrides for contentPath/homePage/notFoundPage")}catch(k){console.warn("[nimbi-cms] logging ignore of URL overrides failed",k)}delete e.contentPath,delete e.homePage,delete e.notFoundPage}const n=Object.assign({},e,t),{el:s,contentPath:r="/content",crawlMaxQueue:i=1e3,searchIndex:a=!0,searchIndexMode:c="eager",indexDepth:o=1,noIndexing:l=void 0,defaultStyle:u="light",bulmaCustomize:h="none",lang:f=void 0,l10nFile:p=null,cacheTtlMinutes:d=5,cacheMaxEntries:m,markdownExtensions:w,availableLanguages:y,homePage:x="_home.md",notFoundPage:I="_404.md"}=n,{skipRootReadme:P=!1}=n;if(n.contentPath!=null&&!_a(n.contentPath))throw new TypeError('initCMS(options): "contentPath" contains unsafe characters or patterns');if(n.homePage!=null&&!Qr(n.homePage))throw new TypeError('initCMS(options): "homePage" must be a simple basename ending with .md or .html');if(n.notFoundPage!=null&&!Qr(n.notFoundPage))throw new TypeError('initCMS(options): "notFoundPage" must be a simple basename ending with .md or .html');if(!s)throw new Error("el is required");let A=s;if(typeof s=="string"){if(A=document.querySelector(s),!A)throw new Error(`el selector "${s}" did not match any element`)}else if(!(s instanceof Element))throw new TypeError("el must be a CSS selector string or a DOM element");if(typeof r!="string"||!r.trim())throw new TypeError('initCMS(options): "contentPath" must be a non-empty string when provided');if(typeof a!="boolean")throw new TypeError('initCMS(options): "searchIndex" must be a boolean when provided');if(c!=null&&c!=="eager"&&c!=="lazy")throw new TypeError('initCMS(options): "searchIndexMode" must be "eager" or "lazy" when provided');if(o!=null&&o!==1&&o!==2&&o!==3)throw new TypeError('initCMS(options): "indexDepth" must be 1, 2, or 3 when provided');if(u!=="light"&&u!=="dark")throw new TypeError('initCMS(options): "defaultStyle" must be "light" or "dark"');if(h!=null&&typeof h!="string")throw new TypeError('initCMS(options): "bulmaCustomize" must be a string when provided');if(f!=null&&typeof f!="string")throw new TypeError('initCMS(options): "lang" must be a string when provided');if(p!=null&&typeof p!="string")throw new TypeError('initCMS(options): "l10nFile" must be a string or null when provided');if(d!=null&&(typeof d!="number"||!Number.isFinite(d)||d<0))throw new TypeError('initCMS(options): "cacheTtlMinutes" must be a non‑negative number when provided');if(m!=null&&(typeof m!="number"||!Number.isInteger(m)||m<0))throw new TypeError('initCMS(options): "cacheMaxEntries" must be a non‑negative integer when provided');if(w!=null&&(!Array.isArray(w)||w.some(k=>!k||typeof k!="object")))throw new TypeError('initCMS(options): "markdownExtensions" must be an array of extension objects when provided');if(y!=null&&(!Array.isArray(y)||y.some(k=>typeof k!="string"||!k.trim())))throw new TypeError('initCMS(options): "availableLanguages" must be an array of non-empty strings when provided');if(l!=null&&(!Array.isArray(l)||l.some(k=>typeof k!="string"||!k.trim())))throw new TypeError('initCMS(options): "noIndexing" must be an array of non-empty strings when provided');if(P!=null&&typeof P!="boolean")throw new TypeError('initCMS(options): "skipRootReadme" must be a boolean when provided');if(x!=null&&(typeof x!="string"||!x.trim()||!/\.(md|html)$/.test(x)))throw new TypeError('initCMS(options): "homePage" must be a non-empty string ending with .md or .html');if(I!=null&&(typeof I!="string"||!I.trim()||!/\.(md|html)$/.test(I)))throw new TypeError('initCMS(options): "notFoundPage" must be a non-empty string ending with .md or .html');const q=!!a;try{Promise.resolve().then(()=>Ut).then(k=>{try{k&&typeof k.setSkipRootReadme=="function"&&k.setSkipRootReadme(!!P)}catch(ie){console.warn("[nimbi-cms] setSkipRootReadme failed",ie)}}).catch(k=>{})}catch(k){console.warn("[nimbi-cms] setSkipRootReadme dynamic import failed",k)}try{A.classList.add("nimbi-mount")}catch(k){console.warn("[nimbi-cms] mount element setup failed",k)}const j=document.createElement("div");j.className="nimbi-cms";const G=document.createElement("div");G.className="columns";const Y=document.createElement("div");Y.className="column is-full-mobile is-3-tablet nimbi-nav-wrap",Y.setAttribute("role","navigation");try{const k=typeof it=="function"?it("navigation"):null;k&&Y.setAttribute("aria-label",k)}catch(k){console.warn("[nimbi-cms] set nav aria-label failed",k)}G.appendChild(Y);const re=document.createElement("div");re.className="column nimbi-content",re.setAttribute("role","main"),G.appendChild(re),j.appendChild(G);const D=Y,L=re;A.appendChild(j);let C=null;try{C=A.querySelector(".nimbi-overlay"),C||(C=document.createElement("div"),C.className="nimbi-overlay",A.appendChild(C))}catch(k){C=null,console.warn("[nimbi-cms] mount overlay setup failed",k)}const R=location.pathname||"/",v=R.endsWith("/")?R:R.substring(0,R.lastIndexOf("/")+1);try{zn=document.title||""}catch(k){zn="",console.warn("[nimbi-cms] read initial document title failed",k)}let b=r;(b==="."||b==="./")&&(b=""),b.startsWith("./")&&(b=b.slice(2)),b.startsWith("/")&&(b=b.slice(1)),b!==""&&!b.endsWith("/")&&(b=b+"/");const _=new URL(v+b,location.origin).toString();try{Promise.resolve().then(()=>Ut).then(k=>{try{k&&typeof k.setHomePage=="function"&&k.setHomePage(x)}catch(ie){console.warn("[nimbi-cms] setHomePage failed",ie)}}).catch(k=>{})}catch(k){console.warn("[nimbi-cms] setHomePage dynamic import failed",k)}p&&await cn(p,v),y&&Array.isArray(y)&&sr(y),f&&un(f);const z=La({contentWrap:L,navWrap:D,container:j,mountOverlay:C,t:it,contentBase:_,homePage:x,initialDocumentTitle:zn,runHooks:rn});if(typeof d=="number"&&d>=0&&typeof gr=="function"&&gr(d*60*1e3),typeof m=="number"&&m>=0&&typeof fr=="function"&&fr(m),w&&Array.isArray(w)&&w.length)try{w.forEach(k=>{typeof k=="object"&&ta&&typeof Ln=="function"&&Ln(k)})}catch(k){console.warn("[nimbi-cms] applying markdownExtensions failed",k)}try{typeof i=="number"&&Promise.resolve().then(()=>Ut).then(({setDefaultCrawlMaxQueue:k})=>{try{k(i)}catch(ie){console.warn("[nimbi-cms] setDefaultCrawlMaxQueue failed",ie)}})}catch(k){console.warn("[nimbi-cms] setDefaultCrawlMaxQueue import failed",k)}try{Nt(_)}catch(k){console.warn("[nimbi-cms] setContentBase failed",k)}try{gn(I)}catch(k){console.warn("[nimbi-cms] setNotFoundPage failed",k)}try{Nt(_)}catch(k){console.warn("[nimbi-cms] setContentBase failed",k)}try{gn(I)}catch(k){console.warn("[nimbi-cms] setNotFoundPage failed",k)}try{await ke(x,_)}catch(k){throw x==="_home.md"?new Error("Required _home.md not found"):new Error(`Required ${x} not found at ${_}${x}: ${k.message}`)}Yn(u),await Kn(h,v);try{const k=document.createElement("header");k.className="nimbi-site-navbar",A.insertBefore(k,j);const ie=await ke("_navigation.md",_),he=await Qt(ie.raw||""),{navbar:Ae,linkEls:xe}=await ga(k,j,he.html||"",_,x,it,z.renderByQuery,q,c,o,l);try{await rn("onNavBuild",{navWrap:D,navbar:Ae,linkEls:xe,contentBase:_})}catch(ee){console.warn("[nimbi-cms] onNavBuild hooks failed",ee)}try{const ee=()=>{const ue=k&&k.getBoundingClientRect&&Math.round(k.getBoundingClientRect().height)||k&&k.offsetHeight||0;if(ue>0){try{A.style.setProperty("--nimbi-site-navbar-height",`${ue}px`)}catch(ge){console.warn("[nimbi-cms] set CSS var failed",ge)}try{j.style.paddingTop=""}catch(ge){console.warn("[nimbi-cms] set container paddingTop failed",ge)}try{const ge=A&&A.getBoundingClientRect&&Math.round(A.getBoundingClientRect().height)||A&&A.clientHeight||0;if(ge>0){const Je=Math.max(0,ge-ue);try{j.style.setProperty("--nimbi-cms-height",`${Je}px`)}catch(Nn){console.warn("[nimbi-cms] set --nimbi-cms-height failed",Nn)}}else try{j.style.setProperty("--nimbi-cms-height","calc(100vh - var(--nimbi-site-navbar-height))")}catch(Je){console.warn("[nimbi-cms] set --nimbi-cms-height failed",Je)}}catch(ge){console.warn("[nimbi-cms] compute container height failed",ge)}try{k.style.setProperty("--nimbi-site-navbar-height",`${ue}px`)}catch(ge){console.warn("[nimbi-cms] set navbar CSS var failed",ge)}}};ee();try{if(typeof ResizeObserver<"u"){const ue=new ResizeObserver(()=>ee());try{ue.observe(k)}catch(ge){console.warn("[nimbi-cms] ResizeObserver.observe failed",ge)}}}catch(ue){console.warn("[nimbi-cms] ResizeObserver setup failed",ue)}}catch(ee){console.warn("[nimbi-cms] compute navbar height failed",ee)}}catch(k){console.warn("[nimbi-cms] build navigation failed",k)}await z.renderByQuery();try{Promise.resolve().then(()=>Pa).then(({getVersion:k})=>{typeof k=="function"&&k().then(ie=>{try{const he=ie||"0.0.0";try{const Ae=xe=>{const ee=document.createElement("a");ee.className="nimbi-version-label tag is-small",ee.textContent=`Ninbi CMS v. ${he}`,ee.href=xe||"#",ee.target="_blank",ee.rel="noopener noreferrer nofollow",ee.setAttribute("aria-label",`Ninbi CMS version ${he}`);try{Vn(ee)}catch{}try{A.appendChild(ee)}catch(ue){console.warn("[nimbi-cms] append version label failed",ue)}};(async()=>{try{const xe=await Promise.resolve().then(()=>ci).catch(()=>null),ee=xe&&(xe.default||xe);let ue=null;ee&&(ee.homepage&&typeof ee.homepage=="string"?ue=ee.homepage:ee.repository&&(typeof ee.repository=="string"?ue=ee.repository:ee.repository.url&&typeof ee.repository.url=="string"&&(ue=ee.repository.url)));try{ue&&new URL(ue)}catch{ue=null}Ae(ue||"#")}catch{Ae("#")}})()}catch(Ae){console.warn("[nimbi-cms] building version label failed",Ae)}}catch(he){console.warn("[nimbi-cms] building version label failed",he)}}).catch(ie=>{console.warn("[nimbi-cms] getVersion() failed",ie)})}).catch(k=>{console.warn("[nimbi-cms] import version module failed",k)})}catch(k){console.warn("[nimbi-cms] version label setup failed",k)}}async function Xr(){try{let t=null;try{t=await Promise.resolve().then(()=>ci)}catch{try{if(typeof fetch=="function"&&typeof location<"u"){const s=new URL("../package.json",location.href).toString(),r=await fetch(s);r&&r.ok?t={default:await r.json()}:t=null}else t=null}catch{t=null}}const e=t?.default?.version||t?.version;return typeof e=="string"&&e.trim()?e:"0.0.0"}catch{return"0.0.0"}}const Pa=Object.freeze(Object.defineProperty({__proto__:null,getVersion:Xr},Symbol.toStringTag,{value:"Module"})),Kr="nimbi-cms",Yr="0.1.0",Vr={type:"git",url:"git+https://github.com/AbelVM/nimbiCMS.git"},Jr="https://abelvm.github.io/nimbiCMS/",ei="module",ti={dev:"vite","dev:example":'sh -c "npm run build -- --outDir example/dist --config vite.config.js && vite example --port 5173 &"',build:"vite build --config vite.config.js","build:lib":"vite build --config vite.config.js","build:analyze":"ANALYZE=1 vite build --config vite.config.js",preview:"vite preview",test:"npx vitest run","gen-dts":"node scripts/gen-dts.js","check-dts":"npx tsc --noEmit src/index.d.ts --lib es2015,dom --skipLibCheck","type-test":"npx tsd",docs:"typedoc --options typedoc.json"},ni={bulma:"^1.0.4","highlight.js":"^11.11.1",marked:"^17.0.4"},ri={"@vitest/coverage-v8":"^4.0.18","comment-parser":"^0.7.6",eslint:"^10.0.3","eslint-plugin-unused-imports":"^4.4.1",glob:"^10.4.1",jsdom:"^28.1.0","reading-time":"^1.5.0",terser:"^5.17.0",typedoc:"^0.28.17","typedoc-plugin-markdown":"^4.10.0",typescript:"^5.9.3",tsd:"^0.33.0",vite:"^7.3.1","rollup-plugin-visualizer":"^5.8.0","vite-plugin-restart":"^2.0.0",vitest:"^4.0.18"},ii="dist/nimbi-cms.cjs.js",si="dist/nimbi-cms.es.js",ai="src/index.d.ts",oi="dist/nimbi-cms.js",li=["dist","src/index.d.ts"],ci=Object.freeze(Object.defineProperty({__proto__:null,default:{name:Kr,version:Yr,repository:Vr,homepage:Jr,private:!0,type:ei,scripts:ti,dependencies:ni,devDependencies:ri,main:ii,module:si,types:ai,unpkg:oi,files:li},dependencies:ni,devDependencies:ri,files:li,homepage:Jr,main:ii,module:si,name:Kr,repository:Vr,scripts:ti,type:ei,types:ai,unpkg:oi,version:Yr},Symbol.toStringTag,{value:"Module"}));ce.BAD_LANGUAGES=an,ce.SUPPORTED_HLJS_MAP=K,ce._clearHooks=Ci,ce.addHook=_t,ce.default=Ma,ce.ensureBulma=Kn,ce.getVersion=Xr,ce.loadL10nFile=cn,ce.loadSupportedLanguages=ln,ce.observeCodeBlocks=Xn,ce.onNavBuild=Ti,ce.onPageLoad=Ri,ce.registerLanguage=nt,ce.runHooks=rn,ce.setHighlightTheme=Ii,ce.setLang=un,ce.setStyle=Yn,ce.setThemeVars=zi,ce.t=it,ce.transformHtml=Li,Object.defineProperties(ce,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})}));
