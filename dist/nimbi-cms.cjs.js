"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const Nt={onPageLoad:[],onNavBuild:[],transformHtml:[]};function dn(e,t){if(!Object.prototype.hasOwnProperty.call(Nt,e))throw new Error('Unknown hook "'+e+'"');if(typeof t!="function")throw new TypeError("hook callback must be a function");Nt[e].push(t)}function pa(e){dn("onPageLoad",e)}function ga(e){dn("onNavBuild",e)}function fa(e){dn("transformHtml",e)}async function In(e,t){const n=Nt[e]||[];for(const i of n)try{await i(t)}catch(r){console.warn("[nimbi-cms] runHooks callback failed",r)}}function ma(){Object.keys(Nt).forEach(e=>{Nt[e].length=0})}function Zr(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var En,xr;function ba(){if(xr)return En;xr=1;function e(b){return b instanceof Map?b.clear=b.delete=b.set=function(){throw new Error("map is read-only")}:b instanceof Set&&(b.add=b.clear=b.delete=function(){throw new Error("set is read-only")}),Object.freeze(b),Object.getOwnPropertyNames(b).forEach(x=>{const M=b[x],J=typeof M;(J==="object"||J==="function")&&!Object.isFrozen(M)&&e(M)}),b}class t{constructor(x){x.data===void 0&&(x.data={}),this.data=x.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function n(b){return b.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function i(b,...x){const M=Object.create(null);for(const J in b)M[J]=b[J];return x.forEach(function(J){for(const Se in J)M[Se]=J[Se]}),M}const r="</span>",a=b=>!!b.scope,s=(b,{prefix:x})=>{if(b.startsWith("language:"))return b.replace("language:","language-");if(b.includes(".")){const M=b.split(".");return[`${x}${M.shift()}`,...M.map((J,Se)=>`${J}${"_".repeat(Se+1)}`)].join(" ")}return`${x}${b}`};class c{constructor(x,M){this.buffer="",this.classPrefix=M.classPrefix,x.walk(this)}addText(x){this.buffer+=n(x)}openNode(x){if(!a(x))return;const M=s(x.scope,{prefix:this.classPrefix});this.span(M)}closeNode(x){a(x)&&(this.buffer+=r)}value(){return this.buffer}span(x){this.buffer+=`<span class="${x}">`}}const o=(b={})=>{const x={children:[]};return Object.assign(x,b),x};class l{constructor(){this.rootNode=o(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(x){this.top.children.push(x)}openNode(x){const M=o({scope:x});this.add(M),this.stack.push(M)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(x){return this.constructor._walk(x,this.rootNode)}static _walk(x,M){return typeof M=="string"?x.addText(M):M.children&&(x.openNode(M),M.children.forEach(J=>this._walk(x,J)),x.closeNode(M)),x}static _collapse(x){typeof x!="string"&&x.children&&(x.children.every(M=>typeof M=="string")?x.children=[x.children.join("")]:x.children.forEach(M=>{l._collapse(M)}))}}class u extends l{constructor(x){super(),this.options=x}addText(x){x!==""&&this.add(x)}startScope(x){this.openNode(x)}endScope(){this.closeNode()}__addSublanguage(x,M){const J=x.root;M&&(J.scope=`language:${M}`),this.add(J)}toHTML(){return new c(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function p(b){return b?typeof b=="string"?b:b.source:null}function m(b){return g("(?=",b,")")}function h(b){return g("(?:",b,")*")}function d(b){return g("(?:",b,")?")}function g(...b){return b.map(M=>p(M)).join("")}function f(b){const x=b[b.length-1];return typeof x=="object"&&x.constructor===Object?(b.splice(b.length-1,1),x):{}}function w(...b){return"("+(f(b).capture?"":"?:")+b.map(J=>p(J)).join("|")+")"}function y(b){return new RegExp(b.toString()+"|").exec("").length-1}function k(b,x){const M=b&&b.exec(x);return M&&M.index===0}const L=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function R(b,{joinWith:x}){let M=0;return b.map(J=>{M+=1;const Se=M;let ve=p(J),O="";for(;ve.length>0;){const N=L.exec(ve);if(!N){O+=ve;break}O+=ve.substring(0,N.index),ve=ve.substring(N.index+N[0].length),N[0][0]==="\\"&&N[1]?O+="\\"+String(Number(N[1])+Se):(O+=N[0],N[0]==="("&&M++)}return O}).map(J=>`(${J})`).join(x)}const I=/\b\B/,U="[a-zA-Z]\\w*",z="[a-zA-Z_]\\w*",K="\\b\\d+(\\.\\d+)?",oe="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",E="\\b(0b[01]+)",j="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",be=(b={})=>{const x=/^#![ ]*\//;return b.binary&&(b.begin=g(x,/.*\b/,b.binary,/\b.*/)),i({scope:"meta",begin:x,end:/$/,relevance:0,"on:begin":(M,J)=>{M.index!==0&&J.ignoreMatch()}},b)},V={begin:"\\\\[\\s\\S]",relevance:0},H={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[V]},v={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[V]},F={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},Z=function(b,x,M={}){const J=i({scope:"comment",begin:b,end:x,contains:[]},M);J.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const Se=w("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return J.contains.push({begin:g(/[ ]+/,"(",Se,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),J},ge=Z("//","$"),A=Z("/\\*","\\*/"),S=Z("#","$"),P={scope:"number",begin:K,relevance:0},C={scope:"number",begin:oe,relevance:0},B={scope:"number",begin:E,relevance:0},_={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[V,{begin:/\[/,end:/\]/,relevance:0,contains:[V]}]},q={scope:"title",begin:U,relevance:0},ue={scope:"title",begin:z,relevance:0},fe={begin:"\\.\\s*"+z,relevance:0};var ne=Object.freeze({__proto__:null,APOS_STRING_MODE:H,BACKSLASH_ESCAPE:V,BINARY_NUMBER_MODE:B,BINARY_NUMBER_RE:E,COMMENT:Z,C_BLOCK_COMMENT_MODE:A,C_LINE_COMMENT_MODE:ge,C_NUMBER_MODE:C,C_NUMBER_RE:oe,END_SAME_AS_BEGIN:function(b){return Object.assign(b,{"on:begin":(x,M)=>{M.data._beginMatch=x[1]},"on:end":(x,M)=>{M.data._beginMatch!==x[1]&&M.ignoreMatch()}})},HASH_COMMENT_MODE:S,IDENT_RE:U,MATCH_NOTHING_RE:I,METHOD_GUARD:fe,NUMBER_MODE:P,NUMBER_RE:K,PHRASAL_WORDS_MODE:F,QUOTE_STRING_MODE:v,REGEXP_MODE:_,RE_STARTERS_RE:j,SHEBANG:be,TITLE_MODE:q,UNDERSCORE_IDENT_RE:z,UNDERSCORE_TITLE_MODE:ue});function le(b,x){b.input[b.index-1]==="."&&x.ignoreMatch()}function X(b,x){b.className!==void 0&&(b.scope=b.className,delete b.className)}function ke(b,x){x&&b.beginKeywords&&(b.begin="\\b("+b.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",b.__beforeBegin=le,b.keywords=b.keywords||b.beginKeywords,delete b.beginKeywords,b.relevance===void 0&&(b.relevance=0))}function Ve(b,x){Array.isArray(b.illegal)&&(b.illegal=w(...b.illegal))}function wn(b,x){if(b.match){if(b.begin||b.end)throw new Error("begin & end are not supported with match");b.begin=b.match,delete b.match}}function Pi(b,x){b.relevance===void 0&&(b.relevance=1)}const Ii=(b,x)=>{if(!b.beforeMatch)return;if(b.starts)throw new Error("beforeMatch cannot be used with starts");const M=Object.assign({},b);Object.keys(b).forEach(J=>{delete b[J]}),b.keywords=M.keywords,b.begin=g(M.beforeMatch,m(M.begin)),b.starts={relevance:0,contains:[Object.assign(M,{endsParent:!0})]},b.relevance=0,delete M.beforeMatch},Ni=["of","and","for","in","not","or","if","then","parent","list","value"],Bi="keyword";function sr(b,x,M=Bi){const J=Object.create(null);return typeof b=="string"?Se(M,b.split(" ")):Array.isArray(b)?Se(M,b):Object.keys(b).forEach(function(ve){Object.assign(J,sr(b[ve],x,ve))}),J;function Se(ve,O){x&&(O=O.map(N=>N.toLowerCase())),O.forEach(function(N){const Y=N.split("|");J[Y[0]]=[ve,Oi(Y[0],Y[1])]})}}function Oi(b,x){return x?Number(x):qi(b)?0:1}function qi(b){return Ni.includes(b.toLowerCase())}const or={},at=b=>{console.error(b)},lr=(b,...x)=>{console.log(`WARN: ${b}`,...x)},dt=(b,x)=>{or[`${b}/${x}`]||(console.log(`Deprecated as of ${b}. ${x}`),or[`${b}/${x}`]=!0)},Ft=new Error;function cr(b,x,{key:M}){let J=0;const Se=b[M],ve={},O={};for(let N=1;N<=x.length;N++)O[N+J]=Se[N],ve[N+J]=!0,J+=y(x[N-1]);b[M]=O,b[M]._emit=ve,b[M]._multi=!0}function Di(b){if(Array.isArray(b.begin)){if(b.skip||b.excludeBegin||b.returnBegin)throw at("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Ft;if(typeof b.beginScope!="object"||b.beginScope===null)throw at("beginScope must be object"),Ft;cr(b,b.begin,{key:"beginScope"}),b.begin=R(b.begin,{joinWith:""})}}function Hi(b){if(Array.isArray(b.end)){if(b.skip||b.excludeEnd||b.returnEnd)throw at("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Ft;if(typeof b.endScope!="object"||b.endScope===null)throw at("endScope must be object"),Ft;cr(b,b.end,{key:"endScope"}),b.end=R(b.end,{joinWith:""})}}function ji(b){b.scope&&typeof b.scope=="object"&&b.scope!==null&&(b.beginScope=b.scope,delete b.scope)}function Ui(b){ji(b),typeof b.beginScope=="string"&&(b.beginScope={_wrap:b.beginScope}),typeof b.endScope=="string"&&(b.endScope={_wrap:b.endScope}),Di(b),Hi(b)}function Wi(b){function x(O,N){return new RegExp(p(O),"m"+(b.case_insensitive?"i":"")+(b.unicodeRegex?"u":"")+(N?"g":""))}class M{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(N,Y){Y.position=this.position++,this.matchIndexes[this.matchAt]=Y,this.regexes.push([Y,N]),this.matchAt+=y(N)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const N=this.regexes.map(Y=>Y[1]);this.matcherRe=x(R(N,{joinWith:"|"}),!0),this.lastIndex=0}exec(N){this.matcherRe.lastIndex=this.lastIndex;const Y=this.matcherRe.exec(N);if(!Y)return null;const Te=Y.findIndex((_t,kn)=>kn>0&&_t!==void 0),Ae=this.matchIndexes[Te];return Y.splice(0,Te),Object.assign(Y,Ae)}}class J{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(N){if(this.multiRegexes[N])return this.multiRegexes[N];const Y=new M;return this.rules.slice(N).forEach(([Te,Ae])=>Y.addRule(Te,Ae)),Y.compile(),this.multiRegexes[N]=Y,Y}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(N,Y){this.rules.push([N,Y]),Y.type==="begin"&&this.count++}exec(N){const Y=this.getMatcher(this.regexIndex);Y.lastIndex=this.lastIndex;let Te=Y.exec(N);if(this.resumingScanAtSamePosition()&&!(Te&&Te.index===this.lastIndex)){const Ae=this.getMatcher(0);Ae.lastIndex=this.lastIndex+1,Te=Ae.exec(N)}return Te&&(this.regexIndex+=Te.position+1,this.regexIndex===this.count&&this.considerAll()),Te}}function Se(O){const N=new J;return O.contains.forEach(Y=>N.addRule(Y.begin,{rule:Y,type:"begin"})),O.terminatorEnd&&N.addRule(O.terminatorEnd,{type:"end"}),O.illegal&&N.addRule(O.illegal,{type:"illegal"}),N}function ve(O,N){const Y=O;if(O.isCompiled)return Y;[X,wn,Ui,Ii].forEach(Ae=>Ae(O,N)),b.compilerExtensions.forEach(Ae=>Ae(O,N)),O.__beforeBegin=null,[ke,Ve,Pi].forEach(Ae=>Ae(O,N)),O.isCompiled=!0;let Te=null;return typeof O.keywords=="object"&&O.keywords.$pattern&&(O.keywords=Object.assign({},O.keywords),Te=O.keywords.$pattern,delete O.keywords.$pattern),Te=Te||/\w+/,O.keywords&&(O.keywords=sr(O.keywords,b.case_insensitive)),Y.keywordPatternRe=x(Te,!0),N&&(O.begin||(O.begin=/\B|\b/),Y.beginRe=x(Y.begin),!O.end&&!O.endsWithParent&&(O.end=/\B|\b/),O.end&&(Y.endRe=x(Y.end)),Y.terminatorEnd=p(Y.end)||"",O.endsWithParent&&N.terminatorEnd&&(Y.terminatorEnd+=(O.end?"|":"")+N.terminatorEnd)),O.illegal&&(Y.illegalRe=x(O.illegal)),O.contains||(O.contains=[]),O.contains=[].concat(...O.contains.map(function(Ae){return Fi(Ae==="self"?O:Ae)})),O.contains.forEach(function(Ae){ve(Ae,Y)}),O.starts&&ve(O.starts,N),Y.matcher=Se(Y),Y}if(b.compilerExtensions||(b.compilerExtensions=[]),b.contains&&b.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return b.classNameAliases=i(b.classNameAliases||{}),ve(b)}function ur(b){return b?b.endsWithParent||ur(b.starts):!1}function Fi(b){return b.variants&&!b.cachedVariants&&(b.cachedVariants=b.variants.map(function(x){return i(b,{variants:null},x)})),b.cachedVariants?b.cachedVariants:ur(b)?i(b,{starts:b.starts?i(b.starts):null}):Object.isFrozen(b)?i(b):b}var Zi="11.11.1";class Gi extends Error{constructor(x,M){super(x),this.name="HTMLInjectionError",this.html=M}}const yn=n,hr=i,dr=Symbol("nomatch"),Qi=7,pr=function(b){const x=Object.create(null),M=Object.create(null),J=[];let Se=!0;const ve="Could not find the language '{}', did you forget to load/include a language module?",O={disableAutodetect:!0,name:"Plain text",contains:[]};let N={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:u};function Y(T){return N.noHighlightRe.test(T)}function Te(T){let W=T.className+" ";W+=T.parentNode?T.parentNode.className:"";const ce=N.languageDetectRe.exec(W);if(ce){const we=Je(ce[1]);return we||(lr(ve.replace("{}",ce[1])),lr("Falling back to no-highlight mode for this block.",T)),we?ce[1]:"no-highlight"}return W.split(/\s+/).find(we=>Y(we)||Je(we))}function Ae(T,W,ce){let we="",Ee="";typeof W=="object"?(we=T,ce=W.ignoreIllegals,Ee=W.language):(dt("10.7.0","highlight(lang, code, ...args) has been deprecated."),dt("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),Ee=T,we=W),ce===void 0&&(ce=!0);const je={code:we,language:Ee};Gt("before:highlight",je);const et=je.result?je.result:_t(je.language,je.code,ce);return et.code=je.code,Gt("after:highlight",et),et}function _t(T,W,ce,we){const Ee=Object.create(null);function je($,D){return $.keywords[D]}function et(){if(!ee.keywords){Me.addText(ye);return}let $=0;ee.keywordPatternRe.lastIndex=0;let D=ee.keywordPatternRe.exec(ye),ie="";for(;D;){ie+=ye.substring($,D.index);const me=We.case_insensitive?D[0].toLowerCase():D[0],Re=je(ee,me);if(Re){const[Xe,ha]=Re;if(Me.addText(ie),ie="",Ee[me]=(Ee[me]||0)+1,Ee[me]<=Qi&&(Kt+=ha),Xe.startsWith("_"))ie+=D[0];else{const da=We.classNameAliases[Xe]||Xe;Ue(D[0],da)}}else ie+=D[0];$=ee.keywordPatternRe.lastIndex,D=ee.keywordPatternRe.exec(ye)}ie+=ye.substring($),Me.addText(ie)}function Qt(){if(ye==="")return;let $=null;if(typeof ee.subLanguage=="string"){if(!x[ee.subLanguage]){Me.addText(ye);return}$=_t(ee.subLanguage,ye,!0,_r[ee.subLanguage]),_r[ee.subLanguage]=$._top}else $=_n(ye,ee.subLanguage.length?ee.subLanguage:null);ee.relevance>0&&(Kt+=$.relevance),Me.__addSublanguage($._emitter,$.language)}function Ne(){ee.subLanguage!=null?Qt():et(),ye=""}function Ue($,D){$!==""&&(Me.startScope(D),Me.addText($),Me.endScope())}function br($,D){let ie=1;const me=D.length-1;for(;ie<=me;){if(!$._emit[ie]){ie++;continue}const Re=We.classNameAliases[$[ie]]||$[ie],Xe=D[ie];Re?Ue(Xe,Re):(ye=Xe,et(),ye=""),ie++}}function wr($,D){return $.scope&&typeof $.scope=="string"&&Me.openNode(We.classNameAliases[$.scope]||$.scope),$.beginScope&&($.beginScope._wrap?(Ue(ye,We.classNameAliases[$.beginScope._wrap]||$.beginScope._wrap),ye=""):$.beginScope._multi&&(br($.beginScope,D),ye="")),ee=Object.create($,{parent:{value:ee}}),ee}function yr($,D,ie){let me=k($.endRe,ie);if(me){if($["on:end"]){const Re=new t($);$["on:end"](D,Re),Re.isMatchIgnored&&(me=!1)}if(me){for(;$.endsParent&&$.parent;)$=$.parent;return $}}if($.endsWithParent)return yr($.parent,D,ie)}function sa($){return ee.matcher.regexIndex===0?(ye+=$[0],1):(An=!0,0)}function oa($){const D=$[0],ie=$.rule,me=new t(ie),Re=[ie.__beforeBegin,ie["on:begin"]];for(const Xe of Re)if(Xe&&(Xe($,me),me.isMatchIgnored))return sa(D);return ie.skip?ye+=D:(ie.excludeBegin&&(ye+=D),Ne(),!ie.returnBegin&&!ie.excludeBegin&&(ye=D)),wr(ie,$),ie.returnBegin?0:D.length}function la($){const D=$[0],ie=W.substring($.index),me=yr(ee,$,ie);if(!me)return dr;const Re=ee;ee.endScope&&ee.endScope._wrap?(Ne(),Ue(D,ee.endScope._wrap)):ee.endScope&&ee.endScope._multi?(Ne(),br(ee.endScope,$)):Re.skip?ye+=D:(Re.returnEnd||Re.excludeEnd||(ye+=D),Ne(),Re.excludeEnd&&(ye=D));do ee.scope&&Me.closeNode(),!ee.skip&&!ee.subLanguage&&(Kt+=ee.relevance),ee=ee.parent;while(ee!==me.parent);return me.starts&&wr(me.starts,$),Re.returnEnd?0:D.length}function ca(){const $=[];for(let D=ee;D!==We;D=D.parent)D.scope&&$.unshift(D.scope);$.forEach(D=>Me.openNode(D))}let Xt={};function kr($,D){const ie=D&&D[0];if(ye+=$,ie==null)return Ne(),0;if(Xt.type==="begin"&&D.type==="end"&&Xt.index===D.index&&ie===""){if(ye+=W.slice(D.index,D.index+1),!Se){const me=new Error(`0 width match regex (${T})`);throw me.languageName=T,me.badRule=Xt.rule,me}return 1}if(Xt=D,D.type==="begin")return oa(D);if(D.type==="illegal"&&!ce){const me=new Error('Illegal lexeme "'+ie+'" for mode "'+(ee.scope||"<unnamed>")+'"');throw me.mode=ee,me}else if(D.type==="end"){const me=la(D);if(me!==dr)return me}if(D.type==="illegal"&&ie==="")return ye+=`
`,1;if(vn>1e5&&vn>D.index*3)throw new Error("potential infinite loop, way more iterations than matches");return ye+=ie,ie.length}const We=Je(T);if(!We)throw at(ve.replace("{}",T)),new Error('Unknown language: "'+T+'"');const ua=Wi(We);let Sn="",ee=we||ua;const _r={},Me=new N.__emitter(N);ca();let ye="",Kt=0,st=0,vn=0,An=!1;try{if(We.__emitTokens)We.__emitTokens(W,Me);else{for(ee.matcher.considerAll();;){vn++,An?An=!1:ee.matcher.considerAll(),ee.matcher.lastIndex=st;const $=ee.matcher.exec(W);if(!$)break;const D=W.substring(st,$.index),ie=kr(D,$);st=$.index+ie}kr(W.substring(st))}return Me.finalize(),Sn=Me.toHTML(),{language:T,value:Sn,relevance:Kt,illegal:!1,_emitter:Me,_top:ee}}catch($){if($.message&&$.message.includes("Illegal"))return{language:T,value:yn(W),illegal:!0,relevance:0,_illegalBy:{message:$.message,index:st,context:W.slice(st-100,st+100),mode:$.mode,resultSoFar:Sn},_emitter:Me};if(Se)return{language:T,value:yn(W),illegal:!1,relevance:0,errorRaised:$,_emitter:Me,_top:ee};throw $}}function kn(T){const W={value:yn(T),illegal:!1,relevance:0,_top:O,_emitter:new N.__emitter(N)};return W._emitter.addText(T),W}function _n(T,W){W=W||N.languages||Object.keys(x);const ce=kn(T),we=W.filter(Je).filter(mr).map(Ne=>_t(Ne,T,!1));we.unshift(ce);const Ee=we.sort((Ne,Ue)=>{if(Ne.relevance!==Ue.relevance)return Ue.relevance-Ne.relevance;if(Ne.language&&Ue.language){if(Je(Ne.language).supersetOf===Ue.language)return 1;if(Je(Ue.language).supersetOf===Ne.language)return-1}return 0}),[je,et]=Ee,Qt=je;return Qt.secondBest=et,Qt}function Xi(T,W,ce){const we=W&&M[W]||ce;T.classList.add("hljs"),T.classList.add(`language-${we}`)}function xn(T){let W=null;const ce=Te(T);if(Y(ce))return;if(Gt("before:highlightElement",{el:T,language:ce}),T.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",T);return}if(T.children.length>0&&(N.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(T)),N.throwUnescapedHTML))throw new Gi("One of your code blocks includes unescaped HTML.",T.innerHTML);W=T;const we=W.textContent,Ee=ce?Ae(we,{language:ce,ignoreIllegals:!0}):_n(we);T.innerHTML=Ee.value,T.dataset.highlighted="yes",Xi(T,ce,Ee.language),T.result={language:Ee.language,re:Ee.relevance,relevance:Ee.relevance},Ee.secondBest&&(T.secondBest={language:Ee.secondBest.language,relevance:Ee.secondBest.relevance}),Gt("after:highlightElement",{el:T,result:Ee,text:we})}function Ki(T){N=hr(N,T)}const Yi=()=>{Zt(),dt("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function Vi(){Zt(),dt("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let gr=!1;function Zt(){function T(){Zt()}if(document.readyState==="loading"){gr||window.addEventListener("DOMContentLoaded",T,!1),gr=!0;return}document.querySelectorAll(N.cssSelector).forEach(xn)}function Ji(T,W){let ce=null;try{ce=W(b)}catch(we){if(at("Language definition for '{}' could not be registered.".replace("{}",T)),Se)at(we);else throw we;ce=O}ce.name||(ce.name=T),x[T]=ce,ce.rawDefinition=W.bind(null,b),ce.aliases&&fr(ce.aliases,{languageName:T})}function ea(T){delete x[T];for(const W of Object.keys(M))M[W]===T&&delete M[W]}function ta(){return Object.keys(x)}function Je(T){return T=(T||"").toLowerCase(),x[T]||x[M[T]]}function fr(T,{languageName:W}){typeof T=="string"&&(T=[T]),T.forEach(ce=>{M[ce.toLowerCase()]=W})}function mr(T){const W=Je(T);return W&&!W.disableAutodetect}function na(T){T["before:highlightBlock"]&&!T["before:highlightElement"]&&(T["before:highlightElement"]=W=>{T["before:highlightBlock"](Object.assign({block:W.el},W))}),T["after:highlightBlock"]&&!T["after:highlightElement"]&&(T["after:highlightElement"]=W=>{T["after:highlightBlock"](Object.assign({block:W.el},W))})}function ra(T){na(T),J.push(T)}function ia(T){const W=J.indexOf(T);W!==-1&&J.splice(W,1)}function Gt(T,W){const ce=T;J.forEach(function(we){we[ce]&&we[ce](W)})}function aa(T){return dt("10.7.0","highlightBlock will be removed entirely in v12.0"),dt("10.7.0","Please use highlightElement now."),xn(T)}Object.assign(b,{highlight:Ae,highlightAuto:_n,highlightAll:Zt,highlightElement:xn,highlightBlock:aa,configure:Ki,initHighlighting:Yi,initHighlightingOnLoad:Vi,registerLanguage:Ji,unregisterLanguage:ea,listLanguages:ta,getLanguage:Je,registerAliases:fr,autoDetection:mr,inherit:hr,addPlugin:ra,removePlugin:ia}),b.debugMode=function(){Se=!1},b.safeMode=function(){Se=!0},b.versionString=Zi,b.regex={concat:g,lookahead:m,either:w,optional:d,anyNumberOfTimes:h};for(const T in ne)typeof ne[T]=="object"&&e(ne[T]);return Object.assign(b,ne),b},pt=pr({});return pt.newInstance=()=>pr({}),En=pt,pt.HighlightJS=pt,pt.default=pt,En}var wa=ba();const de=Zr(wa),ya="11.11.1",ae=new Map,ka="https://raw.githubusercontent.com/highlightjs/highlight.js/main/SUPPORTED_LANGUAGES.md",Be={shell:"bash",sh:"bash",zsh:"bash",js:"javascript",ts:"typescript",py:"python",csharp:"cs","c#":"cs"};Be.html="xml";Be.xhtml="xml";Be.markup="xml";const Wn=new Set(["magic","undefined"]);let nt=null;const Ln=new Map,_a=300*1e3;async function Fn(e=ka){if(e)return nt||(nt=(async()=>{try{const t=await fetch(e);if(!t.ok)return;const i=(await t.text()).split(/\r?\n/);let r=-1;for(let l=0;l<i.length;l++)if(/\|\s*Language\s*\|/i.test(i[l])){r=l;break}if(r===-1)return;const a=i[r].replace(/^\||\|$/g,"").split("|").map(l=>l.trim().toLowerCase());let s=a.findIndex(l=>/alias|aliases|equivalent|alt|alternates?/i.test(l));s===-1&&(s=1);let c=a.findIndex(l=>/file|filename|module|module name|module-name|short|slug/i.test(l));if(c===-1){const l=a.findIndex(u=>/language/i.test(u));c=l!==-1?l:0}let o=[];for(let l=r+1;l<i.length;l++){const u=i[l].trim();if(!u||!u.startsWith("|"))break;const p=u.replace(/^\||\|$/g,"").split("|").map(f=>f.trim());if(p.every(f=>/^-+$/.test(f)))continue;const m=p;if(!m.length)continue;const d=(m[c]||m[0]||"").toString().trim().toLowerCase();if(!d||/^-+$/.test(d))continue;ae.set(d,d);const g=m[s]||"";if(g){const f=String(g).split(",").map(w=>w.replace(/`/g,"").trim()).filter(Boolean);if(f.length){const y=f[0].toLowerCase().replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");y&&/[a-z0-9]/i.test(y)&&(ae.set(y,y),o.push(y))}}}try{const l=[];for(const u of o){const p=String(u||"").replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");p&&/[a-z0-9]/i.test(p)?l.push(p):ae.delete(u)}o=l}catch(l){console.warn("[codeblocksManager] cleanup aliases failed",l)}try{let l=0;for(const u of Array.from(ae.keys())){if(!u||/^-+$/.test(u)||!/[a-z0-9]/i.test(u)){ae.delete(u),l++;continue}if(/^[:]+/.test(u)){const p=u.replace(/^[:]+/,"");if(p&&/[a-z0-9]/i.test(p)){const m=ae.get(u);ae.delete(u),ae.set(p,m)}else ae.delete(u),l++}}for(const[u,p]of Array.from(ae.entries()))(!p||/^-+$/.test(p)||!/[a-z0-9]/i.test(p))&&(ae.delete(u),l++);try{const u=":---------------------";ae.has(u)&&(ae.delete(u),l++)}catch(u){console.warn("[codeblocksManager] remove sep key failed",u)}try{const u=Array.from(ae.keys()).sort()}catch(u){console.warn("[codeblocksManager] compute supported keys failed",u)}}catch(l){console.warn("[codeblocksManager] ignored error",l)}}catch(t){console.warn("[codeblocksManager] loadSupportedLanguages failed",t)}})(),nt)}const xt=new Set;async function yt(e,t){if(nt||(async()=>{try{await Fn()}catch(r){console.warn("[codeblocksManager] loadSupportedLanguages (IIFE) failed",r)}})(),nt)try{await nt}catch{}if(e=e==null?"":String(e),e=e.trim(),!e)return!1;const n=e.toLowerCase();if(Wn.has(n))return!1;if(ae.size&&!ae.has(n)){const r=Be;if(!r[n]&&!r[e])return!1}if(xt.has(e))return!0;const i=Be;try{const r=(t||e||"").toString().replace(/\.js$/i,"").trim(),a=(i[e]||e||"").toString(),s=(i[r]||r||"").toString();let c=Array.from(new Set([a,s,r,e,i[r],i[e]].filter(Boolean))).map(u=>String(u).toLowerCase()).filter(u=>u&&u!=="undefined");ae.size&&(c=c.filter(u=>{if(ae.has(u))return!0;const p=Be[u];return!!(p&&ae.has(p))}));let o=null,l=null;for(const u of c)try{const p=Date.now();let m=Ln.get(u);if(m&&m.ok===!1&&p-(m.ts||0)>=_a&&(Ln.delete(u),m=void 0),m){if(m.module)o=m.module;else if(m.promise)try{o=await m.promise}catch{o=null}}else{const h={promise:null,module:null,ok:null,ts:0};Ln.set(u,h),h.promise=(async()=>{try{try{try{return await import(`highlight.js/lib/languages/${u}.js`)}catch{return await import(`highlight.js/lib/languages/${u}`)}}catch{try{const g=`https://cdn.jsdelivr.net/npm/highlight.js/es/languages/${u}.js`;return await new Function("u","return import(u)")(g)}catch{try{const f=`https://cdn.jsdelivr.net/npm/highlight.js/lib/languages/${u}.js`;return await new Function("u","return import(u)")(f)}catch{return null}}}}catch{return null}})();try{o=await h.promise,h.module=o,h.ok=!!o,h.ts=Date.now()}catch{h.module=null,h.ok=!1,h.ts=Date.now(),o=null}}if(o){const h=o.default||o;try{const d=ae.size&&ae.get(e)||u||e;return de.registerLanguage(d,h),xt.add(d),d!==e&&(de.registerLanguage(e,h),xt.add(e)),!0}catch(d){l=d}}else try{if(ae.has(u)||ae.has(e)){const h=()=>({});try{de.registerLanguage(u,h),xt.add(u)}catch{}try{u!==e&&(de.registerLanguage(e,h),xt.add(e))}catch{}return!0}}catch{}}catch(p){l=p}if(l)throw l;return!1}catch{return!1}}let Yt=null;function Gr(e=document){nt||(async()=>{try{await Fn()}catch(a){console.warn("[codeblocksManager] loadSupportedLanguages (observer) failed",a)}})();const t=Be,i=Yt||(typeof IntersectionObserver>"u"?null:(Yt=new IntersectionObserver((a,s)=>{a.forEach(c=>{if(!c.isIntersecting)return;const o=c.target;try{s.unobserve(o)}catch(l){console.warn("[codeblocksManager] observer unobserve failed",l)}(async()=>{try{const l=o.getAttribute&&o.getAttribute("class")||o.className||"",u=l.match(/language-([a-zA-Z0-9_+-]+)/)||l.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(u&&u[1]){const p=(u[1]||"").toLowerCase(),m=t[p]||p,h=ae.size&&(ae.get(m)||ae.get(String(m).toLowerCase()))||m;try{await yt(h)}catch(d){console.warn("[codeblocksManager] registerLanguage failed",d)}try{try{const d=o.textContent||o.innerText||"";d!=null&&(o.textContent=d)}catch{}try{o&&o.dataset&&o.dataset.highlighted&&delete o.dataset.highlighted}catch{}de.highlightElement(o)}catch(d){console.warn("[codeblocksManager] hljs.highlightElement failed",d)}}else try{const p=o.textContent||"";try{if(de&&typeof de.getLanguage=="function"&&de.getLanguage("plaintext")){const m=de.highlight(p,{language:"plaintext"});m&&m.value&&(o.innerHTML=m.value)}}catch{try{de.highlightElement(o)}catch(h){console.warn("[codeblocksManager] fallback highlightElement failed",h)}}}catch(p){console.warn("[codeblocksManager] auto-detect plaintext failed",p)}}catch(l){console.warn("[codeblocksManager] observer entry processing failed",l)}})()})},{root:null,rootMargin:"300px",threshold:.1}),Yt)),r=e&&e.querySelectorAll?e.querySelectorAll("pre code"):[];if(!i){r.forEach(async a=>{try{const s=a.getAttribute&&a.getAttribute("class")||a.className||"",c=s.match(/language-([a-zA-Z0-9_+-]+)/)||s.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(c&&c[1]){const o=(c[1]||"").toLowerCase(),l=t[o]||o,u=ae.size&&(ae.get(l)||ae.get(String(l).toLowerCase()))||l;try{await yt(u)}catch(p){console.warn("[codeblocksManager] registerLanguage failed (no observer)",p)}}try{try{const o=a.textContent||a.innerText||"";o!=null&&(a.textContent=o)}catch{}try{a&&a.dataset&&a.dataset.highlighted&&delete a.dataset.highlighted}catch{}de.highlightElement(a)}catch(o){console.warn("[codeblocksManager] hljs.highlightElement failed (no observer)",o)}}catch(s){console.warn("[codeblocksManager] loadSupportedLanguages fallback ignored error",s)}});return}r.forEach(a=>{try{i.observe(a)}catch(s){console.warn("[codeblocksManager] observe failed",s)}})}function xa(e,{useCdn:t=!0}={}){const n=document.querySelector("link[data-hl-theme]"),i=n&&n.getAttribute?n.getAttribute("data-hl-theme"):null,r=e==null?"default":String(e),a=r&&String(r).toLowerCase()||"";if(a==="default"||a==="monokai"){try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}return}if(i&&i.toLowerCase()===a)return;if(!t){console.warn("Requested highlight theme not bundled; set useCdn=true to load theme from CDN");return}const s=a,c=`https://cdn.jsdelivr.net/npm/highlight.js@${ya}/styles/${s}.css`,o=document.createElement("link");o.rel="stylesheet",o.href=c,o.setAttribute("data-hl-theme",s),o.addEventListener("load",()=>{try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}}),document.head.appendChild(o)}let lt="light";function Sa(e,t={}){if(document.querySelector(`link[href="${e}"]`))return;const n=document.createElement("link");if(n.rel="stylesheet",n.href=e,Object.entries(t).forEach(([i,r])=>n.setAttribute(i,r)),document.head.appendChild(n),t["data-bulmaswatch-theme"])try{if(n.getAttribute("data-bulmaswatch-observer"))return;let i=Number(n.getAttribute("data-bulmaswatch-move-count")||0),r=!1;const a=new MutationObserver(()=>{try{if(r)return;const c=n.parentNode;if(!c||c.lastElementChild===n)return;if(i>=1e3){n.setAttribute("data-bulmaswatch-move-stopped","1");return}r=!0;try{c.appendChild(n)}catch{}i+=1,n.setAttribute("data-bulmaswatch-move-count",String(i)),r=!1}catch{}});try{a.observe(document.head,{childList:!0}),n.setAttribute("data-bulmaswatch-observer","1"),n.setAttribute("data-bulmaswatch-move-count",String(i))}catch{}const s=document.head;s&&s.lastElementChild!==n&&s.appendChild(n)}catch{}}function Sr(){try{const e=Array.from(document.querySelectorAll("link[data-bulmaswatch-theme]"));for(const t of e)t&&t.parentNode&&t.parentNode.removeChild(t)}catch{}try{const e=Array.from(document.querySelectorAll("style[data-bulma-override]"));for(const t of e)t&&t.parentNode&&t.parentNode.removeChild(t)}catch{}}async function Qr(e="none",t="/"){if(typeof window<"u"&&window.__nimbiCMSDebug)try{console.debug("[bulmaManager] ensureBulma called",{bulmaCustomize:e,pageDir:t})}catch{}if(!e)return;if(e==="none"){try{const a=[location&&location.protocol&&location.protocol==="file:"?"https://unpkg.com/bulma/css/bulma.min.css":"//unpkg.com/bulma/css/bulma.min.css","https://unpkg.com/bulma/css/bulma.min.css"];let s=!1;for(const c of a)try{if(document.querySelector(`link[href="${c}"]`)){s=!0;break}}catch{}if(!s){const c=a[0],o=document.createElement("link");o.rel="stylesheet",o.href=c,o.setAttribute("data-bulma-base","1");const l=document.querySelector('link[href*="/dist/nimbi-cms.css"], link[href*="dist/nimbi-cms.css"]');l&&l.parentNode?l.parentNode.insertBefore(o,l):document.head.appendChild(o)}}catch{}try{const a=Array.from(document.querySelectorAll("link[data-bulmaswatch-theme]"));for(const s of a)s&&s.parentNode&&s.parentNode.removeChild(s)}catch{}try{const a=Array.from(document.querySelectorAll("style[data-bulma-override]"));for(const s of a)s&&s.parentNode&&s.parentNode.removeChild(s)}catch{}return}const i=[t+"bulma.css","/bulma.css"],r=Array.from(new Set(i));if(e==="local"){if(Sr(),document.querySelector("style[data-bulma-override]"))return;for(const a of r)try{const s=await fetch(a,{method:"GET"});if(s.ok){const c=await s.text(),o=document.createElement("style");o.setAttribute("data-bulma-override",a),o.appendChild(document.createTextNode(`
/* bulma override: ${a} */
`+c)),document.head.appendChild(o);return}}catch(s){console.warn("[bulmaManager] fetch local bulma candidate failed",s)}return}try{const a=String(e).trim();if(!a)return;Sr();const s=`https://unpkg.com/bulmaswatch/${encodeURIComponent(a)}/bulmaswatch.min.css`;Sa(s,{"data-bulmaswatch-theme":a})}catch(a){console.warn("[bulmaManager] ensureBulma failed",a)}}function Xr(e){lt=e==="dark"?"dark":e==="system"?"system":"light";try{const t=Array.from(document.querySelectorAll(".nimbi-mount"));if(t.length>0)for(const n of t)lt==="dark"?n.setAttribute("data-theme","dark"):lt==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme");else{const n=document.documentElement;lt==="dark"?n.setAttribute("data-theme","dark"):lt==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme")}}catch{}}function va(e){const t=document.documentElement;for(const[n,i]of Object.entries(e||{}))try{t.style.setProperty(`--${n}`,i)}catch(r){console.warn("[bulmaManager] setThemeVars failed for",n,r)}}function Kr(e){if(!e||!(e instanceof HTMLElement))return()=>{};const t=e.closest&&e.closest(".nimbi-mount")||null;try{t&&(lt==="dark"?t.setAttribute("data-theme","dark"):lt==="light"?t.setAttribute("data-theme","light"):t.removeAttribute("data-theme"))}catch{}return()=>{}}const Yr={en:{navigation:"Navigation",onThisPage:"On this page",home:"Home",scrollToTop:"Scroll to top",readingTime:"{minutes} min read",searchPlaceholder:"Search…",imagePreviewTitle:"Image preview",imagePreviewFit:"Fit to screen",imagePreviewOriginal:"Original size",imagePreviewZoomOut:"Zoom out",imagePreviewZoomIn:"Zoom in",imagePreviewClose:"Close"},es:{navigation:"Navegación",onThisPage:"En esta página",home:"Inicio",scrollToTop:"Ir arriba",readingTime:"{minutes} min de lectura",searchPlaceholder:"Buscar…",imagePreviewTitle:"Previsualización de imagen",imagePreviewFit:"Ajustar a la pantalla",imagePreviewOriginal:"Tamaño original",imagePreviewZoomOut:"Alejar",imagePreviewZoomIn:"Acercar",imagePreviewClose:"Cerrar"},de:{navigation:"Navigation",onThisPage:"Auf dieser Seite",home:"Startseite",scrollToTop:"Nach oben",readingTime:"{minutes} min Lesezeit",searchPlaceholder:"Suchen…",imagePreviewTitle:"Bildvorschau",imagePreviewFit:"An Bildschirm anpassen",imagePreviewOriginal:"Originalgröße",imagePreviewZoomOut:"Verkleinern",imagePreviewZoomIn:"Vergrößern",imagePreviewClose:"Schließen"},fr:{navigation:"Navigation",onThisPage:"Sur cette page",home:"Accueil",scrollToTop:"Aller en haut",readingTime:"{minutes} min de lecture",searchPlaceholder:"Rechercher…",imagePreviewTitle:"Aperçu de l’image",imagePreviewFit:"Ajuster à l’écran",imagePreviewOriginal:"Taille originale",imagePreviewZoomOut:"Dézoomer",imagePreviewZoomIn:"Zoomer",imagePreviewClose:"Fermer"},pt:{navigation:"Navegação",onThisPage:"Nesta página",home:"Início",scrollToTop:"Ir para o topo",readingTime:"{minutes} min de leitura",searchPlaceholder:"Procurar…",imagePreviewTitle:"Visualização da imagem",imagePreviewFit:"Ajustar à tela",imagePreviewOriginal:"Tamanho original",imagePreviewZoomOut:"Diminuir",imagePreviewZoomIn:"Aumentar",imagePreviewClose:"Fechar"}},bt=JSON.parse(JSON.stringify(Yr));let rn="en";if(typeof navigator<"u"){const e=navigator.language||navigator.languages&&navigator.languages[0]||"en";rn=String(e).split("-")[0].toLowerCase()}Yr[rn]||(rn="en");let rt=rn;function gt(e,t={}){const n=bt[rt]||bt.en;let i=n&&n[e]?n[e]:bt.en[e]||"";for(const r of Object.keys(t))i=i.replace(new RegExp(`{${r}}`,"g"),String(t[r]));return i}async function Zn(e,t){if(!e)return;let n=e;try{/^https?:\/\//.test(e)||(n=new URL(e,location.origin+t).toString());const i=await fetch(n);if(!i.ok)return;const r=await i.json();for(const a of Object.keys(r||{}))bt[a]=Object.assign({},bt[a]||{},r[a])}catch{}}function Gn(e){const t=String(e).split("-")[0].toLowerCase();rt=bt[t]?t:"en"}const Aa=Object.freeze(Object.defineProperty({__proto__:null,get currentLang(){return rt},loadL10nFile:Zn,setLang:Gn,t:gt},Symbol.toStringTag,{value:"Module"})),Ea=`import { buildSearchIndex, crawlForSlug } from '../slugManager.js'
...
`;function La(e,t="worker"){let n=null;const i=typeof globalThis<"u"&&typeof globalThis.__nimbiCMSDebug<"u"?!!globalThis.__nimbiCMSDebug:!1;function r(...l){try{i&&console&&typeof console.warn=="function"&&console.warn(...l)}catch{}}function a(){if(!n)try{const l=e();n=l||null,l&&l.addEventListener("error",()=>{try{n===l&&(n=null,l.terminate&&l.terminate())}catch(u){r("["+t+"] worker termination failed",u)}})}catch(l){n=null,r("["+t+"] worker init failed",l)}return n}function s(){try{n&&(n.terminate&&n.terminate(),n=null)}catch(l){r("["+t+"] worker termination failed",l)}}function c(l,u=1e4){return new Promise((p,m)=>{const h=a();if(!h)return m(new Error("worker unavailable"));const d=String(Math.random()),g=Object.assign({},l,{id:d});let f=null;const w=()=>{f&&clearTimeout(f),h.removeEventListener("message",y),h.removeEventListener("error",k)},y=L=>{const R=L.data||{};R.id===d&&(w(),R.error?m(new Error(R.error)):p(R.result))},k=L=>{w(),r("["+t+"] worker error event",L);try{n===h&&(n=null,h.terminate&&h.terminate())}catch(R){r("["+t+"] worker termination failed",R)}m(new Error(L&&L.message||"worker error"))};f=setTimeout(()=>{w(),r("["+t+"] worker timed out");try{n===h&&(n=null,h.terminate&&h.terminate())}catch(L){r("["+t+"] worker termination on timeout failed",L)}m(new Error("worker timeout"))},u),h.addEventListener("message",y),h.addEventListener("error",k);try{h.postMessage(g)}catch(L){w(),m(L)}})}return{get:a,send:c,terminate:s}}function Vr(e,t="worker-pool",n=2){const i=new Array(n).fill(null);let r=0;const a=typeof globalThis<"u"&&typeof globalThis.__nimbiCMSDebug<"u"?!!globalThis.__nimbiCMSDebug:!1;function s(...g){try{a&&console&&typeof console.warn=="function"&&console.warn(...g)}catch{}}function c(g){if(!i[g])try{const f=e();i[g]=f||null,f&&f.addEventListener("error",()=>{try{i[g]===f&&(i[g]=null,f.terminate&&f.terminate())}catch(w){s("["+t+"] worker termination failed",w)}})}catch(f){i[g]=null,s("["+t+"] worker init failed",f)}return i[g]}const o=new Array(n).fill(0),l=new Array(n).fill(null),u=30*1e3;function p(g){try{o[g]=Date.now(),l[g]&&(clearTimeout(l[g]),l[g]=null),l[g]=setTimeout(()=>{try{i[g]&&(i[g].terminate&&i[g].terminate(),i[g]=null)}catch(f){s("["+t+"] idle termination failed",f)}l[g]=null},u)}catch{}}function m(){for(let g=0;g<i.length;g++){const f=c(g);if(f)return f}return null}function h(){for(let g=0;g<i.length;g++)try{i[g]&&(i[g].terminate&&i[g].terminate(),i[g]=null)}catch(f){s("["+t+"] worker termination failed",f)}}function d(g,f=1e4){return new Promise((w,y)=>{const k=r++%i.length,L=R=>{const I=(k+R)%i.length,U=c(I);if(!U)return R+1<i.length?L(R+1):y(new Error("worker pool unavailable"));const z=String(Math.random()),K=Object.assign({},g,{id:z});let oe=null;const E=()=>{oe&&clearTimeout(oe),U.removeEventListener("message",j),U.removeEventListener("error",be)},j=V=>{const H=V.data||{};H.id===z&&(E(),H.error?y(new Error(H.error)):w(H.result))},be=V=>{E(),s("["+t+"] worker error event",V);try{i[I]===U&&(i[I]=null,U.terminate&&U.terminate())}catch(H){s("["+t+"] worker termination failed",H)}y(new Error(V&&V.message||"worker error"))};oe=setTimeout(()=>{E(),s("["+t+"] worker timed out");try{i[I]===U&&(i[I]=null,U.terminate&&U.terminate())}catch(V){s("["+t+"] worker termination on timeout failed",V)}y(new Error("worker timeout"))},f),U.addEventListener("message",j),U.addEventListener("error",be);try{p(I),U.postMessage(K)}catch(V){E(),y(V)}};L(0)})}return{get:m,send:d,terminate:h}}function Lt(e){try{if(typeof Blob<"u"&&typeof URL<"u"&&e)try{Lt._blobUrlCache||(Lt._blobUrlCache=new Map);const t=Lt._blobUrlCache;let n=t.get(e);if(!n){const i=new Blob([e],{type:"application/javascript"});n=URL.createObjectURL(i),t.set(e,n)}return new Worker(n,{type:"module"})}catch(t){try{typeof globalThis<"u"&&globalThis.__nimbiCMSDebug&&console&&typeof console.warn=="function"&&console.warn("[worker-manager] createWorkerFromRaw failed",t)}catch{}}}catch(t){try{typeof globalThis<"u"&&globalThis.__nimbiCMSDebug&&console&&typeof console.warn=="function"&&console.warn("[worker-manager] createWorkerFromRaw failed",t)}catch{}}return null}const Ge=new Set;function Qn(e){Ta(),Ge.clear();for(const t of Oe)t&&Ge.add(t);vr(re),vr(G),Qn._refreshed=!0}function vr(e){if(!(!e||typeof e.values!="function"))for(const t of e.values())t&&Ge.add(t)}function Ar(e){if(!e||typeof e.set!="function")return;const t=e.set;e.set=function(n,i){return i&&Ge.add(i),t.call(this,n,i)}}let Er=!1;function Ta(){Er||(Ar(re),Ar(G),Er=!0)}function Jr(e){return!e||typeof e!="string"?!1:/^(https?:)?\/\//.test(e)||e.startsWith("mailto:")||e.startsWith("tel:")}function xe(e){return String(e||"").replace(/^[.\/]+/,"")}function Dt(e){return String(e||"").replace(/\/+$/,"")}function Bt(e){return Dt(e)+"/"}function Ca(e){try{if(!e||typeof document>"u"||!document.head||e.startsWith("data:")||document.head.querySelector(`link[rel="preload"][as="image"][href="${e}"]`))return;const n=document.createElement("link");n.rel="preload",n.as="image",n.href=e,document.head.appendChild(n)}catch(t){console.warn("[helpers] preloadImage failed",t)}}function Vt(e,t=0,n=!1){try{if(typeof window>"u"||!e||!e.querySelectorAll)return;const i=Array.from(e.querySelectorAll("img"));if(!i.length)return;const r=e,a=r&&r.getBoundingClientRect?r.getBoundingClientRect():null,s=0,c=typeof window<"u"&&(window.innerHeight||document.documentElement.clientHeight)||0,o=a?Math.max(s,a.top):s,u=(a?Math.min(c,a.bottom):c)+Number(t||0);let p=0;r&&(p=r.clientHeight||(a?a.height:0)),p||(p=c-s);let m=.6;try{const f=r&&window.getComputedStyle?window.getComputedStyle(r):null,w=f&&f.getPropertyValue("--nimbi-image-max-height-ratio"),y=w?parseFloat(w):NaN;!Number.isNaN(y)&&y>0&&y<=1&&(m=y)}catch(f){console.warn("[helpers] read CSS ratio failed",f)}const h=Math.max(200,Math.floor(p*m));let d=!1,g=null;if(i.forEach(f=>{try{const w=f.getAttribute?f.getAttribute("loading"):void 0;w!=="eager"&&f.setAttribute&&f.setAttribute("loading","lazy");const y=f.getBoundingClientRect?f.getBoundingClientRect():null,k=f.src||f.getAttribute&&f.getAttribute("src"),L=y&&y.height>1?y.height:h,R=y?y.top:0,I=R+L;y&&L>0&&R<=u&&I>=o&&(f.setAttribute?(f.setAttribute("loading","eager"),f.setAttribute("fetchpriority","high"),f.setAttribute("data-eager-by-nimbi","1")):(f.loading="eager",f.fetchPriority="high"),Ca(k),d=!0),!g&&y&&y.top<=u&&(g={img:f,src:k,rect:y,beforeLoading:w})}catch(w){console.warn("[helpers] setEagerForAboveFoldImages per-image failed",w)}}),!d&&g){const{img:f,src:w,rect:y,beforeLoading:k}=g;try{f.setAttribute?(f.setAttribute("loading","eager"),f.setAttribute("fetchpriority","high"),f.setAttribute("data-eager-by-nimbi","1")):(f.loading="eager",f.fetchPriority="high")}catch(L){console.warn("[helpers] setEagerForAboveFoldImages fallback failed",L)}}}catch(i){console.warn("[helpers] setEagerForAboveFoldImages failed",i)}}function _e(e,t=null,n){try{const i=typeof n=="string"?n:typeof window<"u"&&window.location?window.location.search:"",r=new URLSearchParams(i.startsWith("?")?i.slice(1):i),a=String(e||"");r.delete("page");const s=new URLSearchParams;s.set("page",a);for(const[l,u]of r.entries())s.append(l,u);const c=s.toString();let o=c?`?${c}`:"";return t&&(o+=`#${encodeURIComponent(t)}`),o||`?page=${encodeURIComponent(a)}`}catch{const r=`?page=${encodeURIComponent(String(e||""))}`;return t?`${r}#${encodeURIComponent(t)}`:r}}function an(e){try{const t=e();return t&&typeof t.then=="function"?t.catch(n=>{console.warn("[helpers] safe swallowed error",n)}):t}catch(t){console.warn("[helpers] safe swallowed error",t)}}try{typeof globalThis<"u"&&!globalThis.safe&&(globalThis.safe=an)}catch(e){console.warn("[helpers] global attach failed",e)}function Ma(e){try{if(!e&&e!==0)return"";const t=String(e),n={amp:"&",lt:"<",gt:">",quot:'"',apos:"'",nbsp:" "};return t.replace(/&(#x?[0-9a-fA-F]+|[a-zA-Z]+);/g,(i,r)=>{if(!r)return i;if(r[0]==="#")try{return r[1]==="x"||r[1]==="X"?String.fromCharCode(parseInt(r.slice(2),16)):String.fromCharCode(parseInt(r.slice(1),10))}catch{return i}return n[r]!==void 0?n[r]:i})}catch{return String(e||"")}}const re=new Map;let Pe=[],Xn=!1;function Ra(e){Xn=!!e}function ei(e){Pe=Array.isArray(e)?e.slice():[]}function za(){return Pe}const ti=typeof navigator<"u"&&navigator.hardwareConcurrency?Math.max(1,Math.floor(navigator.hardwareConcurrency/2)):2,ni=Vr(()=>Lt(Ea),"slugManager",ti);function $a(){return ni.get()}function ri(e){return ni.send(e,5e3)}async function Pa(e,t=1,n=void 0){const i=await Promise.resolve().then(()=>wt);if(!(i.initSlugWorker&&i.initSlugWorker()))throw new Error("slug worker required but unavailable");return await ri({type:"buildSearchIndex",contentBase:e,indexDepth:t,noIndexing:n})}async function Ia(e,t,n){const i=await Promise.resolve().then(()=>wt);if(!(i.initSlugWorker&&i.initSlugWorker()))throw new Error("slug worker required but unavailable");return ri({type:"crawlForSlug",slug:e,base:t,maxQueue:n})}function tt(e,t){if(e)if(Pe&&Pe.length){const i=t.split("/")[0],r=Pe.includes(i);let a=re.get(e);(!a||typeof a=="string")&&(a={default:typeof a=="string"?a:void 0,langs:{}}),r?a.langs[i]=t:a.default=t,re.set(e,a)}else re.set(e,t)}const pn=new Set;function Na(e){typeof e=="function"&&pn.add(e)}function Ba(e){typeof e=="function"&&pn.delete(e)}const G=new Map;let Nn={},Oe=[],kt="_404.md",ft="_home.md";function Bn(e){e!=null&&(kt=String(e||""))}function Oa(e){e!=null&&(ft=String(e||""))}function qa(e){Nn=e||{}}const Tt=new Map,sn=new Set;function Da(){Tt.clear(),sn.clear()}function Ha(e){if(!e||e.length===0)return"";let t=e[0];for(let i=1;i<e.length;i++){const r=e[i];let a=0;const s=Math.min(t.length,r.length);for(;a<s&&t[a]===r[a];)a++;t=t.slice(0,a)}const n=t.lastIndexOf("/");return n===-1?t:t.slice(0,n+1)}function on(e){re.clear(),G.clear(),Oe=[],Pe=Pe||[];const t=Object.keys(Nn||{});if(!t.length)return;let n="";try{if(e){try{/^[a-z][a-z0-9+.-]*:/i.test(String(e))?n=new URL(String(e)).pathname:n=String(e||"")}catch(i){n=String(e||""),console.warn("[slugManager] parse contentBase failed",i)}n=Bt(n)}}catch(i){n="",console.warn("[slugManager] setContentBase prefix derivation failed",i)}n||(n=Ha(t));for(const i of t){let r=i;n&&i.startsWith(n)?r=xe(i.slice(n.length)):r=xe(i),Oe.push(r);try{Qn()}catch(s){console.warn("[slugManager] refreshIndexPaths failed",s)}const a=Nn[i];if(typeof a=="string"){const s=(a||"").match(/^#\s+(.+)$/m);if(s&&s[1]){const c=pe(s[1].trim());if(c)try{let o=c;if((!Pe||!Pe.length)&&(o=ii(o,new Set(re.keys()))),Pe&&Pe.length){const u=r.split("/")[0],p=Pe.includes(u);let m=re.get(o);(!m||typeof m=="string")&&(m={default:typeof m=="string"?m:void 0,langs:{}}),p?m.langs[u]=r:m.default=r,re.set(o,m)}else re.set(o,r);G.set(r,o)}catch(o){console.warn("[slugManager] set slug mapping failed",o)}}}}}try{on()}catch(e){console.warn("[slugManager] initial setContentBase failed",e)}function pe(e){let n=String(e||"").toLowerCase().replace(/[^a-z0-9\- ]/g,"").replace(/ /g,"-");return n=n.replace(/(?:-?)(?:md|html)$/,""),n=n.replace(/-+/g,"-"),n=n.replace(/^-|-$/g,""),n.length>80&&(n=n.slice(0,80).replace(/-+$/g,"")),n}function ii(e,t){if(!t.has(e))return e;let n=2,i=`${e}-${n}`;for(;t.has(i);)n+=1,i=`${e}-${n}`;return i}function ja(e){return Ht(e,void 0)}function Ht(e,t){if(!e)return!1;if(e.startsWith("//"))return!0;if(/^[a-z][a-z0-9+.-]*:/i.test(e)){if(t&&typeof t=="string")try{const n=new URL(e),i=new URL(t);return n.origin!==i.origin?!0:!n.pathname.startsWith(i.pathname)}catch{return!0}return!0}if(e.startsWith("/")&&t&&typeof t=="string")try{const n=new URL(e,t),i=new URL(t);return n.origin!==i.origin?!0:!n.pathname.startsWith(i.pathname)}catch{return!0}return!1}function en(e){return e==null?e:String(e).replace(/\\([\\`*_{}\[\]()#+\-.!])/g,(t,n)=>n)}function jt(e){if(!e||!re.has(e))return null;const t=re.get(e);if(!t)return null;if(typeof t=="string")return t;if(Pe&&Pe.length&&rt&&t.langs&&t.langs[rt])return t.langs[rt];if(t.default)return t.default;if(t.langs){const n=Object.keys(t.langs);if(n.length)return t.langs[n[0]]}return null}const Ct=new Map;function Ua(){Ct.clear()}let Ce=async function(e,t){if(!e)throw new Error("path required");try{const a=(String(e||"").match(/([^\/]+)\.md(?:$|[?#])/)||[])[1];if(a&&re.has(a)){const s=jt(a)||re.get(a);s&&s!==e&&(e=s)}}catch(a){console.warn("[slugManager] slug mapping normalization failed",a)}const n=t==null?"":Dt(String(t));let i="";try{if(n)if(/^[a-z][a-z0-9+.-]*:/i.test(n))i=n.replace(/\/$/,"")+"/"+e.replace(/^\//,"");else if(n.startsWith("/"))i=n.replace(/\/$/,"")+"/"+e.replace(/^\//,"");else{const a=typeof location<"u"&&location.origin?location.origin:"http://localhost",s=n.startsWith("/")?n:"/"+n;i=a+s.replace(/\/$/,"")+"/"+e.replace(/^\//,"")}else i=(typeof location<"u"&&location.origin?location.origin:"http://localhost")+"/"+e.replace(/^\//,"")}catch{i="/"+e.replace(/^\//,"")}if(Ct.has(i))return Ct.get(i);const r=(async()=>{const a=await fetch(i);if(!a||typeof a.ok!="boolean"||!a.ok){if(a&&a.status===404)try{const p=`${n}/${kt}`,m=await globalThis.fetch(p);if(m&&typeof m.ok=="boolean"&&m.ok)return{raw:await m.text(),status:404}}catch(p){console.warn("[slugManager] fetching fallback 404 failed",p)}let u="";try{a&&typeof a.clone=="function"?u=await a.clone().text():a&&typeof a.text=="function"?u=await a.text():u=""}catch(p){u="",console.warn("[slugManager] reading error body failed",p)}throw console.error("fetchMarkdown failed:",{url:i,status:a?a.status:void 0,statusText:a?a.statusText:void 0,body:u.slice(0,200)}),new Error("failed to fetch md")}const s=await a.text(),c=s.trim().slice(0,128).toLowerCase(),o=/^(?:<!doctype|<html|<title|<h1)/.test(c),l=o||String(e||"").toLowerCase().endsWith(".html");if(o&&String(e||"").toLowerCase().endsWith(".md")){try{const u=`${n}/${kt}`,p=await globalThis.fetch(u);if(p.ok)return{raw:await p.text(),status:404}}catch(u){console.warn("[slugManager] fetching fallback 404 failed",u)}throw console.error("fetchMarkdown: server returned HTML for .md request",i),new Error("failed to fetch md")}return l?{raw:s,isHtml:!0}:{raw:s}})();return Ct.set(i,r),r};function Wa(e){typeof e=="function"&&(Ce=e)}const tn=new Map;function Fa(e){if(!e||typeof e!="string")return"";let t=e.replace(/```[\s\S]*?```/g,"");return t=t.replace(/<pre[\s\S]*?<\/pre>/gi,""),t=t.replace(/<code[\s\S]*?<\/code>/gi,""),t=t.replace(/<!--([\s\S]*?)-->/g,""),t=t.replace(/^ {4,}.*$/gm,""),t=t.replace(/`[^`]*`/g,""),t}let Ke=[],St=null;async function ai(e,t=1,n=void 0){const i=Array.isArray(n)?Array.from(new Set((n||[]).map(r=>xe(String(r||""))))):[];try{const r=xe(String(kt||""));r&&!i.includes(r)&&i.push(r)}catch{}if(Ke&&Ke.length&&t===1&&!Ke.some(a=>{try{return i.includes(xe(String(a.path||"")))}catch{return!1}}))return Ke;if(St)return St;St=(async()=>{let r=Array.isArray(n)?Array.from(new Set((n||[]).map(l=>xe(String(l||""))))):[];try{const l=xe(String(kt||""));l&&!r.includes(l)&&r.push(l)}catch{}const a=l=>{if(!r||!r.length)return!1;for(const u of r)if(u&&(l===u||l.startsWith(u+"/")))return!0;return!1};let s=[];if(Oe&&Oe.length&&(s=Array.from(Oe)),!s.length)for(const l of re.values())l&&s.push(l);try{const l=await ui(e);l&&l.length&&(s=s.concat(l))}catch(l){console.warn("[slugManager] crawlAllMarkdown during buildSearchIndex failed",l)}try{const l=new Set(s),u=[...s],p=Math.max(1,ti),m=async()=>{for(;!(l.size>Ut);){const d=u.shift();if(!d)break;try{const g=await Ce(d,e);if(g&&g.raw){if(g.status===404)continue;let f=g.raw;const w=[],y=String(d||"").replace(/^.*\//,"");if(/^readme(?:\.md)?$/i.test(y)&&Xn&&(!d||!d.includes("/")))continue;const k=Fa(f),L=/\[[^\]]+\]\(([^)]+)\)/g;let R;for(;R=L.exec(k);)w.push(R[1]);const I=/<a\s+[^>]*href=["']([^"']+)["'][^>]*>/gi;for(;R=I.exec(k);)w.push(R[1]);const U=d&&d.includes("/")?d.substring(0,d.lastIndexOf("/")+1):"";for(let z of w)try{if(Ht(z,e)||z.startsWith("..")||z.indexOf("/../")!==-1||(U&&!z.startsWith("./")&&!z.startsWith("/")&&!z.startsWith("../")&&(z=U+z),z=xe(z),!/\.(md|html?)(?:$|[?#])/i.test(z))||(z=z.split(/[?#]/)[0],a(z)))continue;l.has(z)||(l.add(z),u.push(z),s.push(z))}catch(K){console.warn("[slugManager] href processing failed",z,K)}}}catch(g){console.warn("[slugManager] discovery fetch failed for",d,g)}}},h=[];for(let d=0;d<p;d++)h.push(m());await Promise.all(h)}catch(l){console.warn("[slugManager] discovery loop failed",l)}const c=new Set;s=s.filter(l=>!l||c.has(l)||a(l)?!1:(c.add(l),!0));const o=[];for(const l of s)if(/\.(?:md|html?)(?:$|[?#])/i.test(l))try{const u=await Ce(l,e);if(u&&u.raw){if(u.status===404)continue;let p="",m="";if(u.isHtml)try{const g=new DOMParser().parseFromString(u.raw,"text/html"),f=g.querySelector("title")||g.querySelector("h1");f&&f.textContent&&(p=f.textContent.trim());const w=g.querySelector("p");if(w&&w.textContent&&(m=w.textContent.trim()),t>=2)try{const y=g.querySelector("h1"),k=y&&y.textContent?y.textContent.trim():p||"",L=(()=>{try{if(G.has(l))return G.get(l)}catch{}return pe(p||l)})(),R=Array.from(g.querySelectorAll("h2"));for(const I of R)try{const U=(I.textContent||"").trim();if(!U)continue;const z=I.id?I.id:pe(U),K=L?`${L}::${z}`:`${pe(l)}::${z}`;let oe="",E=I.nextElementSibling;for(;E&&E.tagName&&E.tagName.toLowerCase()==="script";)E=E.nextElementSibling;E&&E.textContent&&(oe=String(E.textContent).trim()),o.push({slug:K,title:U,excerpt:oe,path:l,parentTitle:k})}catch(U){console.warn("[slugManager] indexing H2 failed",U)}if(t===3)try{const I=Array.from(g.querySelectorAll("h3"));for(const U of I)try{const z=(U.textContent||"").trim();if(!z)continue;const K=U.id?U.id:pe(z),oe=L?`${L}::${K}`:`${pe(l)}::${K}`;let E="",j=U.nextElementSibling;for(;j&&j.tagName&&j.tagName.toLowerCase()==="script";)j=j.nextElementSibling;j&&j.textContent&&(E=String(j.textContent).trim()),o.push({slug:oe,title:z,excerpt:E,path:l,parentTitle:k})}catch(z){console.warn("[slugManager] indexing H3 failed",z)}}catch(I){console.warn("[slugManager] collect H3s failed",I)}}catch(y){console.warn("[slugManager] collect H2s failed",y)}}catch(d){console.warn("[slugManager] parsing HTML for index failed",d)}else{const d=u.raw,g=d.match(/^#\s+(.+)$/m);p=g?g[1].trim():"";try{p=en(p)}catch{}const f=d.split(/\r?\n\s*\r?\n/);if(f.length>1)for(let w=1;w<f.length;w++){const y=f[w].trim();if(y&&!/^#/.test(y)){m=y.replace(/\r?\n/g," ");break}}if(t>=2){let w="",y="";try{const k=(d.match(/^#\s+(.+)$/m)||[])[1];w=k?k.trim():"",y=(function(){try{if(G.has(l))return G.get(l)}catch{}return pe(p||l)})();const L=/^##\s+(.+)$/gm;let R;for(;R=L.exec(d);)try{const I=(R[1]||"").trim(),U=en(I);if(!I)continue;const z=pe(I),K=y?`${y}::${z}`:`${pe(l)}::${z}`,E=d.slice(L.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),j=E&&E[1]?String(E[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";o.push({slug:K,title:U,excerpt:j,path:l,parentTitle:w})}catch(I){console.warn("[slugManager] indexing markdown H2 failed",I)}}catch(k){console.warn("[slugManager] collect markdown H2s failed",k)}if(t===3)try{const k=/^###\s+(.+)$/gm;let L;for(;L=k.exec(d);)try{const R=(L[1]||"").trim(),I=en(R);if(!R)continue;const U=pe(R),z=y?`${y}::${U}`:`${pe(l)}::${U}`,oe=d.slice(k.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),E=oe&&oe[1]?String(oe[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";o.push({slug:z,title:I,excerpt:E,path:l,parentTitle:w})}catch(R){console.warn("[slugManager] indexing markdown H3 failed",R)}}catch(k){console.warn("[slugManager] collect markdown H3s failed",k)}}}let h="";try{G.has(l)&&(h=G.get(l))}catch(d){console.warn("[slugManager] mdToSlug access failed",d)}h||(h=pe(p||l)),o.push({slug:h,title:p,excerpt:m,path:l})}}catch(u){console.warn("[slugManager] buildSearchIndex: entry fetch failed",u)}try{Ke=o.filter(u=>{try{return!a(String(u.path||""))}catch{return!0}})}catch(l){console.warn("[slugManager] filtering index by excludes failed",l),Ke=o}return Ke})();try{await St}catch(r){console.warn("[slugManager] awaiting _indexPromise failed",r)}return St=null,Ke}const si=1e3;let Ut=si;function Za(e){typeof e=="number"&&e>=0&&(Ut=e)}const oi=new DOMParser,li="a[href]";let ci=async function(e,t,n=Ut){if(tn.has(e))return tn.get(e);let i=null;const r=new Set,a=[""];for(;a.length&&!i&&!(a.length>n);){const s=a.shift();if(r.has(s))continue;r.add(s);let c=t;c.endsWith("/")||(c+="/"),c+=s;try{let o;try{o=await globalThis.fetch(c)}catch(m){console.warn("[slugManager] crawlAllMarkdown: fetch failed",{url:c,error:m});continue}if(!o||!o.ok){o&&!o.ok&&console.warn("[slugManager] crawlAllMarkdown: directory fetch non-ok",{url:c,status:o.status});continue}const l=await o.text(),p=oi.parseFromString(l,"text/html").querySelectorAll(li);for(const m of p)try{let h=m.getAttribute("href")||"";if(!h||Ht(h,t)||h.startsWith("..")||h.indexOf("/../")!==-1)continue;if(h.endsWith("/")){const d=s+h;r.has(d)||a.push(d);continue}if(h.toLowerCase().endsWith(".md")){const d=xe(s+h);try{if(G.has(d))continue;for(const g of re.values());}catch(g){console.warn("[slugManager] slug map access failed",g)}try{const g=await Ce(d,t);if(g&&g.raw){const f=(g.raw||"").match(/^#\s+(.+)$/m);if(f&&f[1]&&pe(f[1].trim())===e){i=d;break}}}catch(g){console.warn("[slugManager] crawlForSlug: fetchMarkdown failed",g)}}}catch(h){console.warn("[slugManager] crawlForSlug: link iteration failed",h)}}catch(o){console.warn("[slugManager] crawlForSlug: directory fetch failed",o)}}return tn.set(e,i),i};async function ui(e,t=Ut){const n=new Set,i=new Set,r=[""];for(;r.length&&!(r.length>t);){const a=r.shift();if(i.has(a))continue;i.add(a);let s=e;s.endsWith("/")||(s+="/"),s+=a;try{let c;try{c=await globalThis.fetch(s)}catch(p){console.warn("[slugManager] crawlAllMarkdown: fetch failed",{url:s,error:p});continue}if(!c||!c.ok){c&&!c.ok&&console.warn("[slugManager] crawlAllMarkdown: directory fetch non-ok",{url:s,status:c.status});continue}const o=await c.text(),u=oi.parseFromString(o,"text/html").querySelectorAll(li);for(const p of u)try{let m=p.getAttribute("href")||"";if(!m||Ht(m,e)||m.startsWith("..")||m.indexOf("/../")!==-1)continue;if(m.endsWith("/")){const d=a+m;i.has(d)||r.push(d);continue}const h=(a+m).replace(/^\/+/,"");/\.(md|html?)$/i.test(h)&&n.add(h)}catch(m){console.warn("[slugManager] crawlAllMarkdown: link iteration failed",m)}}catch(c){console.warn("[slugManager] crawlAllMarkdown: directory fetch failed",c)}}return Array.from(n)}async function hi(e,t,n){if(e&&typeof e=="string"&&(e=xe(e),e=Dt(e)),re.has(e))return jt(e)||re.get(e);for(const r of pn)try{const a=await r(e,t);if(a)return tt(e,a),G.set(a,e),a}catch(a){console.warn("[slugManager] slug resolver failed",a)}if(Oe&&Oe.length){if(Tt.has(e)){const r=Tt.get(e);return re.set(e,r),G.set(r,e),r}for(const r of Oe)if(!sn.has(r))try{const a=await Ce(r,t);if(a&&a.raw){const s=(a.raw||"").match(/^#\s+(.+)$/m);if(s&&s[1]){const c=pe(s[1].trim());if(sn.add(r),c&&Tt.set(c,r),c===e)return tt(e,r),G.set(r,e),r}}}catch(a){console.warn("[slugManager] manifest title fetch failed",a)}}try{const r=await ai(t);if(r&&r.length){const a=r.find(s=>s.slug===e);if(a)return tt(e,a.path),G.set(a.path,e),a.path}}catch(r){console.warn("[slugManager] buildSearchIndex lookup failed",r)}try{const r=await ci(e,t,n);if(r)return tt(e,r),G.set(r,e),r}catch(r){console.warn("[slugManager] crawlForSlug lookup failed",r)}const i=[`${e}.html`,`${e}.md`];for(const r of i)try{const a=await Ce(r,t);if(a&&a.raw)return tt(e,r),G.set(r,e),r}catch(a){console.warn("[slugManager] candidate fetch failed",a)}if(Oe&&Oe.length)for(const r of Oe)try{const a=r.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(pe(a)===e)return tt(e,r),G.set(r,e),r}catch(a){console.warn("[slugManager] build-time filename match failed",a)}try{const r=[];ft&&typeof ft=="string"&&ft.trim()&&r.push(ft),r.includes("_home.md")||r.push("_home.md");for(const a of r)try{const s=await Ce(a,t);if(s&&s.raw){const c=(s.raw||"").match(/^#\s+(.+)$/m);if(c&&c[1]&&pe(c[1].trim())===e)return tt(e,a),G.set(a,e),a}}catch{}}catch(r){console.warn("[slugManager] home page fetch failed",r)}return null}const wt=Object.freeze(Object.defineProperty({__proto__:null,CRAWL_MAX_QUEUE:si,_setAllMd:qa,_storeSlugMapping:tt,addSlugResolver:Na,get allMarkdownPaths(){return Oe},get availableLanguages(){return Pe},buildSearchIndex:ai,buildSearchIndexWorker:Pa,clearFetchCache:Ua,clearListCaches:Da,crawlAllMarkdown:ui,crawlCache:tn,crawlForSlug:ci,crawlForSlugWorker:Ia,get defaultCrawlMaxQueue(){return Ut},ensureSlug:hi,fetchCache:Ct,get fetchMarkdown(){return Ce},getLanguages:za,get homePage(){return ft},initSlugWorker:$a,isExternalLink:ja,isExternalLinkWithBase:Ht,listPathsFetched:sn,listSlugCache:Tt,mdToSlug:G,get notFoundPage(){return kt},removeSlugResolver:Ba,resolveSlugPath:jt,get searchIndex(){return Ke},setContentBase:on,setDefaultCrawlMaxQueue:Za,setFetchMarkdown:Wa,setHomePage:Oa,setLanguages:ei,setNotFoundPage:Bn,setSkipRootReadme:Ra,get skipRootReadme(){return Xn},slugResolvers:pn,slugToMd:re,slugify:pe,unescapeMarkdown:en,uniqueSlug:ii},Symbol.toStringTag,{value:"Module"}));let di=100;function Lr(e){di=e}let Mt=300*1e3;function Tr(e){Mt=e}const He=new Map;function Ga(e){if(!He.has(e))return;const t=He.get(e),n=Date.now();if(t.ts+Mt<n){He.delete(e);return}return He.delete(e),He.set(e,t),t.value}function Qa(e,t){if(Cr(),Cr(),He.delete(e),He.set(e,{value:t,ts:Date.now()}),He.size>di){const n=He.keys().next().value;n!==void 0&&He.delete(n)}}function Cr(){if(!Mt||Mt<=0)return;const e=Date.now();for(const[t,n]of He.entries())n.ts+Mt<e&&He.delete(t)}async function Xa(e,t){const n=new Set(Ge),i=document.querySelectorAll(".nimbi-site-navbar a, .navbar a, .nimbi-nav a");for(const r of Array.from(i||[])){const a=r.getAttribute("href")||"";if(a)try{const s=new URL(a,location.href);if(s.origin!==location.origin)continue;const c=(s.hash||s.pathname).match(/([^#?]+\.md)(?:$|[?#])/)||(s.pathname||"").match(/([^#?]+\.md)(?:$|[?#])/);if(c){let p=xe(c[1]);p&&n.add(p);continue}const o=(r.textContent||"").trim(),l=(s.pathname||"").replace(/^.*\//,"");if(o&&pe(o)===e||l&&pe(l.replace(/\.(html?|md)$/i,""))===e)return s.toString();if(/\.(html?)$/i.test(s.pathname)){let p=s.pathname.replace(/^\//,"");n.add(p);continue}const u=s.pathname||"";if(u){const p=new URL(t),m=Bt(p.pathname);if(u.indexOf(m)!==-1){let h=u.startsWith(m)?u.slice(m.length):u;h=xe(h),h&&n.add(h)}}}catch(s){console.warn("[router] malformed URL while discovering index candidates",s)}}for(const r of n)try{if(!r||!String(r).includes(".md"))continue;const a=await Ce(r,t);if(!a||!a.raw)continue;const s=(a.raw||"").match(/^#\s+(.+)$/m);if(s){const c=(s[1]||"").trim();if(c&&pe(c)===e)return r}}catch(a){console.warn("[router] fetchMarkdown during index discovery failed",a)}return null}function Ka(e){const t=[];if(String(e).includes(".md")||String(e).includes(".html"))/index\.html$/i.test(e)||t.push(e);else try{const n=decodeURIComponent(String(e||""));if(re.has(n)){const i=jt(n)||re.get(n);i&&(/\.(md|html?)$/i.test(i)?/index\.html$/i.test(i)||t.push(i):(t.push(i),t.push(i+".html")))}else{if(Ge&&Ge.size)for(const i of Ge){const r=i.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(pe(r)===n&&!/index\.html$/i.test(i)){t.push(i);break}}!t.length&&n&&!/\.(md|html?)$/i.test(n)&&(t.push(n+".html"),t.push(n+".md"))}}catch(n){console.warn("[router] buildPageCandidates failed during slug handling",n)}return t}async function Ya(e,t){const n=e||"",i=location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null;let r=e||"",a=null;if(r&&String(r).includes("::")){const d=String(r).split("::",2);r=d[0],a=d[1]||null}const c=`${e}|||${typeof Aa<"u"&&rt?rt:""}`,o=Ga(c);if(o)r=o.resolved,a=o.anchor||a;else{if(!String(r).includes(".md")&&!String(r).includes(".html")){let d=decodeURIComponent(String(r||""));if(d&&typeof d=="string"&&(d=xe(d),d=Dt(d)),re.has(d))r=jt(d)||re.get(d);else{let g=await Xa(d,t);if(g)r=g;else if(Qn._refreshed&&Ge&&Ge.size||typeof t=="string"&&/^[a-z][a-z0-9+.-]*:\/\//i.test(t)){const f=await hi(d,t);f&&(r=f)}}}Qa(c,{resolved:r,anchor:a})}!a&&i&&(a=i);try{if(r&&(r.startsWith("http://")||r.startsWith("https://")||r.startsWith("/"))){const d=r.startsWith("/")?new URL(r,location.origin).toString():r;try{const g=await fetch(d);if(g&&g.ok){const f=await g.text(),w=g&&g.headers&&typeof g.headers.get=="function"&&g.headers.get("content-type")||"",y=(f||"").toLowerCase();if(w&&w.indexOf&&w.indexOf("text/html")!==-1||y.indexOf("<!doctype")!==-1||y.indexOf("<html")!==-1)return{data:{raw:f,isHtml:!0},pagePath:d.replace(/^\//,""),anchor:a}}}catch{}}}catch{}const l=Ka(r),u=String(n||"").includes(".md")||String(n||"").includes(".html");if(u&&l.length===0&&(String(r).includes(".md")||String(r).includes(".html"))&&l.push(r),l.length===0&&(String(r).includes(".md")||String(r).includes(".html"))&&l.push(r),l.length===1&&/index\.html$/i.test(l[0])&&!u&&!re.has(r)&&!re.has(decodeURIComponent(String(r||"")))&&!String(r||"").includes("/"))throw new Error("Unknown slug: index.html fallback prevented");let p=null,m=null,h=null;for(const d of l)if(d)try{const g=xe(d);p=await Ce(g,t),m=g;break}catch(g){h=g;try{console.warn("[router] candidate fetch failed",{candidate:d,contentBase:t,err:g&&g.message||g})}catch{}}if(!p){try{console.error("[router] fetchPageData: no page data for",{originalRaw:n,resolved:r,pageCandidates:l,contentBase:t,fetchError:h&&(h.message||String(h))||null})}catch{}try{if(u&&String(n||"").toLowerCase().includes(".html"))try{const d=new URL(String(n||""),location.href).toString();console.warn("[router] attempting absolute HTML fetch fallback",d);const g=await fetch(d);if(g&&g.ok){const f=await g.text(),w=g&&g.headers&&typeof g.headers.get=="function"&&g.headers.get("content-type")||"",y=(f||"").toLowerCase(),k=w&&w.indexOf&&w.indexOf("text/html")!==-1||y.indexOf("<!doctype")!==-1||y.indexOf("<html")!==-1;if(k||console.warn("[router] absolute fetch returned non-HTML",{abs:d,contentType:w,snippet:y.slice(0,200)}),k){const L=(f||"").toLowerCase();if(/<title>\s*index of\b/i.test(f)||/<h1>\s*index of\b/i.test(f)||L.indexOf("parent directory")!==-1||/<title>\s*directory listing/i.test(f)||/<h1>\s*directory listing/i.test(f))try{console.warn("[router] absolute fetch returned directory listing; treating as not found",{abs:d})}catch{}else try{const I=d,U=new URL(".",I).toString();try{const K=typeof DOMParser<"u"?new DOMParser:null;if(K){const oe=K.parseFromString(f||"","text/html"),E=(H,v)=>{try{const F=v.getAttribute(H)||"";if(!F||/^(https?:)?\/\//i.test(F)||F.startsWith("/")||F.startsWith("#"))return;try{const Z=new URL(F,I).toString();v.setAttribute(H,Z)}catch(Z){console.warn("[router] rewrite attribute failed",H,Z)}}catch(F){console.warn("[router] rewrite helper failed",F)}},j=oe.querySelectorAll("[src],[href],[srcset],[xlink:href],[poster]"),be=[];for(const H of Array.from(j||[]))try{const v=H.tagName?H.tagName.toLowerCase():"";if(v==="a")continue;if(H.hasAttribute("src")){const F=H.getAttribute("src");E("src",H);const Z=H.getAttribute("src");F!==Z&&be.push({attr:"src",tag:v,before:F,after:Z})}if(H.hasAttribute("href")&&v==="link"){const F=H.getAttribute("href");E("href",H);const Z=H.getAttribute("href");F!==Z&&be.push({attr:"href",tag:v,before:F,after:Z})}if(H.hasAttribute("href")&&v!=="link"){const F=H.getAttribute("href");E("href",H);const Z=H.getAttribute("href");F!==Z&&be.push({attr:"href",tag:v,before:F,after:Z})}if(H.hasAttribute("xlink:href")){const F=H.getAttribute("xlink:href");E("xlink:href",H);const Z=H.getAttribute("xlink:href");F!==Z&&be.push({attr:"xlink:href",tag:v,before:F,after:Z})}if(H.hasAttribute("poster")){const F=H.getAttribute("poster");E("poster",H);const Z=H.getAttribute("poster");F!==Z&&be.push({attr:"poster",tag:v,before:F,after:Z})}if(H.hasAttribute("srcset")){const ge=(H.getAttribute("srcset")||"").split(",").map(A=>A.trim()).filter(Boolean).map(A=>{const[S,P]=A.split(/\s+/,2);if(!S||/^(https?:)?\/\//i.test(S)||S.startsWith("/"))return A;try{const C=new URL(S,I).toString();return P?`${C} ${P}`:C}catch{return A}}).join(", ");H.setAttribute("srcset",ge)}}catch{}const V=oe.documentElement&&oe.documentElement.outerHTML?oe.documentElement.outerHTML:f;try{be&&be.length&&console.warn("[router] rewritten asset refs",{abs:d,rewritten:be})}catch{}return{data:{raw:V,isHtml:!0},pagePath:String(n||""),anchor:a}}}catch{}let z=f;return/<base\s+[^>]*>/i.test(f)||(/<head[^>]*>/i.test(f)?z=f.replace(/(<head[^>]*>)/i,`$1<base href="${U}">`):z=`<base href="${U}">`+f),{data:{raw:z,isHtml:!0},pagePath:String(n||""),anchor:a}}catch{return{data:{raw:f,isHtml:!0},pagePath:String(n||""),anchor:a}}}}}catch(d){console.warn("[router] absolute HTML fetch fallback failed",d)}}catch{}try{const d=decodeURIComponent(String(r||""));if(d&&!/\.(md|html?)$/i.test(d)){const g=[`/assets/${d}.html`,`/assets/${d}/index.html`];for(const f of g)try{const w=await fetch(f,{method:"GET"});if(w&&w.ok)return{data:{raw:await w.text(),isHtml:!0},pagePath:f.replace(/^\//,""),anchor:a}}catch{}}}catch(d){console.warn("[router] assets fallback failed",d)}throw new Error("no page data")}return{data:p,pagePath:m,anchor:a}}function gn(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var it=gn();function pi(e){it=e}var ct={exec:()=>null};function he(e,t=""){let n=typeof e=="string"?e:e.source,i={replace:(r,a)=>{let s=typeof a=="string"?a:a.source;return s=s.replace(Ie.caret,"$1"),n=n.replace(r,s),i},getRegex:()=>new RegExp(n,t)};return i}var Va=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),Ie={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}>`)},Ja=/^(?:[ \t]*(?:\n|$))+/,es=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,ts=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Wt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,ns=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Kn=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,gi=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,fi=he(gi).replace(/bull/g,Kn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),rs=he(gi).replace(/bull/g,Kn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Yn=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,is=/^[^\n]+/,Vn=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,as=he(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Vn).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),ss=he(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Kn).getRegex(),fn="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Jn=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,os=he("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Jn).replace("tag",fn).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),mi=he(Yn).replace("hr",Wt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",fn).getRegex(),ls=he(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",mi).getRegex(),er={blockquote:ls,code:es,def:as,fences:ts,heading:ns,hr:Wt,html:os,lheading:fi,list:ss,newline:Ja,paragraph:mi,table:ct,text:is},Mr=he("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Wt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",fn).getRegex(),cs={...er,lheading:rs,table:Mr,paragraph:he(Yn).replace("hr",Wt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Mr).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",fn).getRegex()},us={...er,html:he(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Jn).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:ct,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:he(Yn).replace("hr",Wt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",fi).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},hs=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,ds=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,bi=/^( {2,}|\\)\n(?!\s*$)/,ps=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,mn=/[\p{P}\p{S}]/u,tr=/[\s\p{P}\p{S}]/u,wi=/[^\s\p{P}\p{S}]/u,gs=he(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,tr).getRegex(),yi=/(?!~)[\p{P}\p{S}]/u,fs=/(?!~)[\s\p{P}\p{S}]/u,ms=/(?:[^\s\p{P}\p{S}]|~)/u,ki=/(?![*_])[\p{P}\p{S}]/u,bs=/(?![*_])[\s\p{P}\p{S}]/u,ws=/(?:[^\s\p{P}\p{S}]|[*_])/u,ys=he(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Va?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),_i=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,ks=he(_i,"u").replace(/punct/g,mn).getRegex(),_s=he(_i,"u").replace(/punct/g,yi).getRegex(),xi="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",xs=he(xi,"gu").replace(/notPunctSpace/g,wi).replace(/punctSpace/g,tr).replace(/punct/g,mn).getRegex(),Ss=he(xi,"gu").replace(/notPunctSpace/g,ms).replace(/punctSpace/g,fs).replace(/punct/g,yi).getRegex(),vs=he("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,wi).replace(/punctSpace/g,tr).replace(/punct/g,mn).getRegex(),As=he(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,ki).getRegex(),Es="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",Ls=he(Es,"gu").replace(/notPunctSpace/g,ws).replace(/punctSpace/g,bs).replace(/punct/g,ki).getRegex(),Ts=he(/\\(punct)/,"gu").replace(/punct/g,mn).getRegex(),Cs=he(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Ms=he(Jn).replace("(?:-->|$)","-->").getRegex(),Rs=he("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Ms).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),ln=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,zs=he(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",ln).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Si=he(/^!?\[(label)\]\[(ref)\]/).replace("label",ln).replace("ref",Vn).getRegex(),vi=he(/^!?\[(ref)\](?:\[\])?/).replace("ref",Vn).getRegex(),$s=he("reflink|nolink(?!\\()","g").replace("reflink",Si).replace("nolink",vi).getRegex(),Rr=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,nr={_backpedal:ct,anyPunctuation:Ts,autolink:Cs,blockSkip:ys,br:bi,code:ds,del:ct,delLDelim:ct,delRDelim:ct,emStrongLDelim:ks,emStrongRDelimAst:xs,emStrongRDelimUnd:vs,escape:hs,link:zs,nolink:vi,punctuation:gs,reflink:Si,reflinkSearch:$s,tag:Rs,text:ps,url:ct},Ps={...nr,link:he(/^!?\[(label)\]\((.*?)\)/).replace("label",ln).getRegex(),reflink:he(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",ln).getRegex()},On={...nr,emStrongRDelimAst:Ss,emStrongLDelim:_s,delLDelim:As,delRDelim:Ls,url:he(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Rr).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:he(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Rr).getRegex()},Is={...On,br:he(bi).replace("{2,}","*").getRegex(),text:he(On.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Jt={normal:er,gfm:cs,pedantic:us},vt={normal:nr,gfm:On,breaks:Is,pedantic:Ps},Ns={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},zr=e=>Ns[e];function Fe(e,t){if(t){if(Ie.escapeTest.test(e))return e.replace(Ie.escapeReplace,zr)}else if(Ie.escapeTestNoEncode.test(e))return e.replace(Ie.escapeReplaceNoEncode,zr);return e}function $r(e){try{e=encodeURI(e).replace(Ie.percentDecode,"%")}catch{return null}return e}function Pr(e,t){let n=e.replace(Ie.findPipe,(a,s,c)=>{let o=!1,l=s;for(;--l>=0&&c[l]==="\\";)o=!o;return o?"|":" |"}),i=n.split(Ie.splitPipe),r=0;if(i[0].trim()||i.shift(),i.length>0&&!i.at(-1)?.trim()&&i.pop(),t)if(i.length>t)i.splice(t);else for(;i.length<t;)i.push("");for(;r<i.length;r++)i[r]=i[r].trim().replace(Ie.slashPipe,"|");return i}function At(e,t,n){let i=e.length;if(i===0)return"";let r=0;for(;r<i&&e.charAt(i-r-1)===t;)r++;return e.slice(0,i-r)}function Bs(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let i=0;i<e.length;i++)if(e[i]==="\\")i++;else if(e[i]===t[0])n++;else if(e[i]===t[1]&&(n--,n<0))return i;return n>0?-2:-1}function Os(e,t=0){let n=t,i="";for(let r of e)if(r==="	"){let a=4-n%4;i+=" ".repeat(a),n+=a}else i+=r,n++;return i}function Ir(e,t,n,i,r){let a=t.href,s=t.title||null,c=e[1].replace(r.other.outputLinkReplace,"$1");i.state.inLink=!0;let o={type:e[0].charAt(0)==="!"?"image":"link",raw:n,href:a,title:s,text:c,tokens:i.inlineTokens(c)};return i.state.inLink=!1,o}function qs(e,t,n){let i=e.match(n.other.indentCodeCompensation);if(i===null)return t;let r=i[1];return t.split(`
`).map(a=>{let s=a.match(n.other.beginningSpace);if(s===null)return a;let[c]=s;return c.length>=r.length?a.slice(r.length):a}).join(`
`)}var Ot=class{options;rules;lexer;constructor(e){this.options=e||it}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let n=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?n:At(n,`
