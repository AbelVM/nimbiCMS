"use strict";var zs=Object.create;var Ni=Object.defineProperty;var Rs=Object.getOwnPropertyDescriptor;var $s=Object.getOwnPropertyNames;var Ps=Object.getPrototypeOf,Is=Object.prototype.hasOwnProperty;var Ns=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of $s(t))!Is.call(e,r)&&r!==n&&Ni(e,r,{get:()=>t[r],enumerable:!(i=Rs(t,r))||i.enumerable});return e};var Os=(e,t,n)=>(n=e!=null?zs(Ps(e)):{},Ns(t||!e||!e.__esModule?Ni(n,"default",{value:e,enumerable:!0}):n,e));Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});let Pr=0;const Oi=Object.create(null);function Bi(e){try{const t=Number(e);Pr=Number.isFinite(t)&&t>=0?Math.max(0,Math.min(3,Math.floor(t))):0}catch{Pr=0}}function Jt(e=1){try{return Number(Pr)>=Number(e||1)}catch{return!1}}function Jr(){return Jt(1)}function nr(...e){try{if(!Jt(1)||!console||typeof console.error!="function")return;const t=e.map(n=>typeof n=="function"?n():n);console.error(...t)}catch{}}function k(...e){try{if(!Jt(2)||!console||typeof console.warn!="function")return;const t=e.map(n=>typeof n=="function"?n():n);console.warn(...t)}catch{}}function $t(...e){try{if(!Jt(3)||!console||typeof console.info!="function")return;const t=e.map(n=>typeof n=="function"?n():n);console.info(...t)}catch{}}function Bt(...e){try{if(!Jt(3)||!console||typeof console.log!="function")return;const t=e.map(n=>typeof n=="function"?n():n);console.log(...t)}catch{}}function ha(e){try{if(!Jr())return;const t=String(e||"");if(!t)return;Oi[t]=(Oi[t]||0)+1}catch{}}function da(e){try{if(typeof globalThis>"u"||!globalThis.__nimbiCMSDebug)return;const t=String(e||"");if(!t)return;try{globalThis.__nimbiCMSDebug[t]=(globalThis.__nimbiCMSDebug[t]||0)+1}catch{}}catch{}}const Tn={onPageLoad:[],onNavBuild:[],transformHtml:[]};function hr(e,t){if(!Object.prototype.hasOwnProperty.call(Tn,e))throw new Error('Unknown hook "'+e+'"');if(typeof t!="function")throw new TypeError("hook callback must be a function");Tn[e].push(t)}function Bs(e){hr("onPageLoad",e)}function js(e){hr("onNavBuild",e)}function qs(e){hr("transformHtml",e)}async function Ir(e,t){const n=Tn[e]||[];for(const i of n)try{await i(t)}catch(r){try{k("[nimbi-cms] runHooks callback failed",r)}catch{}}}function Hs(){Object.keys(Tn).forEach(e=>{Tn[e].length=0})}function fa(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Er,ji;function Fs(){if(ji)return Er;ji=1;function e(x){return x instanceof Map?x.clear=x.delete=x.set=function(){throw new Error("map is read-only")}:x instanceof Set&&(x.add=x.clear=x.delete=function(){throw new Error("set is read-only")}),Object.freeze(x),Object.getOwnPropertyNames(x).forEach(j=>{const ee=x[j],_e=typeof ee;(_e==="object"||_e==="function")&&!Object.isFrozen(ee)&&e(ee)}),x}class t{constructor(j){j.data===void 0&&(j.data={}),this.data=j.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function n(x){return x.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function i(x,...j){const ee=Object.create(null);for(const _e in x)ee[_e]=x[_e];return j.forEach(function(_e){for(const Ue in _e)ee[Ue]=_e[Ue]}),ee}const r="</span>",a=x=>!!x.scope,s=(x,{prefix:j})=>{if(x.startsWith("language:"))return x.replace("language:","language-");if(x.includes(".")){const ee=x.split(".");return[`${j}${ee.shift()}`,...ee.map((_e,Ue)=>`${_e}${"_".repeat(Ue+1)}`)].join(" ")}return`${j}${x}`};class o{constructor(j,ee){this.buffer="",this.classPrefix=ee.classPrefix,j.walk(this)}addText(j){this.buffer+=n(j)}openNode(j){if(!a(j))return;const ee=s(j.scope,{prefix:this.classPrefix});this.span(ee)}closeNode(j){a(j)&&(this.buffer+=r)}value(){return this.buffer}span(j){this.buffer+=`<span class="${j}">`}}const l=(x={})=>{const j={children:[]};return Object.assign(j,x),j};class c{constructor(){this.rootNode=l(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(j){this.top.children.push(j)}openNode(j){const ee=l({scope:j});this.add(ee),this.stack.push(ee)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(j){return this.constructor._walk(j,this.rootNode)}static _walk(j,ee){return typeof ee=="string"?j.addText(ee):ee.children&&(j.openNode(ee),ee.children.forEach(_e=>this._walk(j,_e)),j.closeNode(ee)),j}static _collapse(j){typeof j!="string"&&j.children&&(j.children.every(ee=>typeof ee=="string")?j.children=[j.children.join("")]:j.children.forEach(ee=>{c._collapse(ee)}))}}class u extends c{constructor(j){super(),this.options=j}addText(j){j!==""&&this.add(j)}startScope(j){this.openNode(j)}endScope(){this.closeNode()}__addSublanguage(j,ee){const _e=j.root;ee&&(_e.scope=`language:${ee}`),this.add(_e)}toHTML(){return new o(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function g(x){return x?typeof x=="string"?x:x.source:null}function h(x){return m("(?=",x,")")}function d(x){return m("(?:",x,")*")}function p(x){return m("(?:",x,")?")}function m(...x){return x.map(ee=>g(ee)).join("")}function f(x){const j=x[x.length-1];return typeof j=="object"&&j.constructor===Object?(x.splice(x.length-1,1),j):{}}function w(...x){return"("+(f(x).capture?"":"?:")+x.map(_e=>g(_e)).join("|")+")"}function y(x){return new RegExp(x.toString()+"|").exec("").length-1}function _(x,j){const ee=x&&x.exec(j);return ee&&ee.index===0}const b=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function v(x,{joinWith:j}){let ee=0;return x.map(_e=>{ee+=1;const Ue=ee;let We=g(_e),oe="";for(;We.length>0;){const ae=b.exec(We);if(!ae){oe+=We;break}oe+=We.substring(0,ae.index),We=We.substring(ae.index+ae[0].length),ae[0][0]==="\\"&&ae[1]?oe+="\\"+String(Number(ae[1])+Ue):(oe+=ae[0],ae[0]==="("&&ee++)}return oe}).map(_e=>`(${_e})`).join(j)}const S=/\b\B/,E="[a-zA-Z]\\w*",P="[a-zA-Z_]\\w*",I="\\b\\d+(\\.\\d+)?",U="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",z="\\b(0b[01]+)",O="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",W=(x={})=>{const j=/^#![ ]*\//;return x.binary&&(x.begin=m(j,/.*\b/,x.binary,/\b.*/)),i({scope:"meta",begin:j,end:/$/,relevance:0,"on:begin":(ee,_e)=>{ee.index!==0&&_e.ignoreMatch()}},x)},te={begin:"\\\\[\\s\\S]",relevance:0},H={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[te]},M={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[te]},F={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},G=function(x,j,ee={}){const _e=i({scope:"comment",begin:x,end:j,contains:[]},ee);_e.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const Ue=w("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return _e.contains.push({begin:m(/[ ]+/,"(",Ue,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),_e},ie=G("//","$"),ye=G("/\\*","\\*/"),J=G("#","$"),ze={scope:"number",begin:I,relevance:0},xe={scope:"number",begin:U,relevance:0},Se={scope:"number",begin:z,relevance:0},Me={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[te,{begin:/\[/,end:/\]/,relevance:0,contains:[te]}]},Fe={scope:"title",begin:E,relevance:0},R={scope:"title",begin:P,relevance:0},N={begin:"\\.\\s*"+P,relevance:0};var A=Object.freeze({__proto__:null,APOS_STRING_MODE:H,BACKSLASH_ESCAPE:te,BINARY_NUMBER_MODE:Se,BINARY_NUMBER_RE:z,COMMENT:G,C_BLOCK_COMMENT_MODE:ye,C_LINE_COMMENT_MODE:ie,C_NUMBER_MODE:xe,C_NUMBER_RE:U,END_SAME_AS_BEGIN:function(x){return Object.assign(x,{"on:begin":(j,ee)=>{ee.data._beginMatch=j[1]},"on:end":(j,ee)=>{ee.data._beginMatch!==j[1]&&ee.ignoreMatch()}})},HASH_COMMENT_MODE:J,IDENT_RE:E,MATCH_NOTHING_RE:S,METHOD_GUARD:N,NUMBER_MODE:ze,NUMBER_RE:I,PHRASAL_WORDS_MODE:F,QUOTE_STRING_MODE:M,REGEXP_MODE:Me,RE_STARTERS_RE:O,SHEBANG:W,TITLE_MODE:Fe,UNDERSCORE_IDENT_RE:P,UNDERSCORE_TITLE_MODE:R});function L(x,j){x.input[x.index-1]==="."&&j.ignoreMatch()}function D(x,j){x.className!==void 0&&(x.scope=x.className,delete x.className)}function K(x,j){j&&x.beginKeywords&&(x.begin="\\b("+x.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",x.__beforeBegin=L,x.keywords=x.keywords||x.beginKeywords,delete x.beginKeywords,x.relevance===void 0&&(x.relevance=0))}function q(x,j){Array.isArray(x.illegal)&&(x.illegal=w(...x.illegal))}function $(x,j){if(x.match){if(x.begin||x.end)throw new Error("begin & end are not supported with match");x.begin=x.match,delete x.match}}function T(x,j){x.relevance===void 0&&(x.relevance=1)}const B=(x,j)=>{if(!x.beforeMatch)return;if(x.starts)throw new Error("beforeMatch cannot be used with starts");const ee=Object.assign({},x);Object.keys(x).forEach(_e=>{delete x[_e]}),x.keywords=ee.keywords,x.begin=m(ee.beforeMatch,h(ee.begin)),x.starts={relevance:0,contains:[Object.assign(ee,{endsParent:!0})]},x.relevance=0,delete ee.beforeMatch},X=["of","and","for","in","not","or","if","then","parent","list","value"],se="keyword";function pe(x,j,ee=se){const _e=Object.create(null);return typeof x=="string"?Ue(ee,x.split(" ")):Array.isArray(x)?Ue(ee,x):Object.keys(x).forEach(function(We){Object.assign(_e,pe(x[We],j,We))}),_e;function Ue(We,oe){j&&(oe=oe.map(ae=>ae.toLowerCase())),oe.forEach(function(ae){const me=ae.split("|");_e[me[0]]=[We,be(me[0],me[1])]})}}function be(x,j){return j?Number(j):ge(x)?0:1}function ge(x){return X.includes(x.toLowerCase())}const we={},ve=x=>{console.error(x)},Ie=(x,...j)=>{console.log(`WARN: ${x}`,...j)},Ge=(x,j)=>{we[`${x}/${j}`]||(console.log(`Deprecated as of ${x}. ${j}`),we[`${x}/${j}`]=!0)},Et=new Error;function dn(x,j,{key:ee}){let _e=0;const Ue=x[ee],We={},oe={};for(let ae=1;ae<=j.length;ae++)oe[ae+_e]=Ue[ae],We[ae+_e]=!0,_e+=y(j[ae-1]);x[ee]=oe,x[ee]._emit=We,x[ee]._multi=!0}function Ct(x){if(Array.isArray(x.begin)){if(x.skip||x.excludeBegin||x.returnBegin)throw ve("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Et;if(typeof x.beginScope!="object"||x.beginScope===null)throw ve("beginScope must be object"),Et;dn(x,x.begin,{key:"beginScope"}),x.begin=v(x.begin,{joinWith:""})}}function as(x){if(Array.isArray(x.end)){if(x.skip||x.excludeEnd||x.returnEnd)throw ve("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Et;if(typeof x.endScope!="object"||x.endScope===null)throw ve("endScope must be object"),Et;dn(x,x.end,{key:"endScope"}),x.end=v(x.end,{joinWith:""})}}function ss(x){x.scope&&typeof x.scope=="object"&&x.scope!==null&&(x.beginScope=x.scope,delete x.scope)}function os(x){ss(x),typeof x.beginScope=="string"&&(x.beginScope={_wrap:x.beginScope}),typeof x.endScope=="string"&&(x.endScope={_wrap:x.endScope}),Ct(x),as(x)}function ls(x){function j(oe,ae){return new RegExp(g(oe),"m"+(x.case_insensitive?"i":"")+(x.unicodeRegex?"u":"")+(ae?"g":""))}class ee{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(ae,me){me.position=this.position++,this.matchIndexes[this.matchAt]=me,this.regexes.push([me,ae]),this.matchAt+=y(ae)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const ae=this.regexes.map(me=>me[1]);this.matcherRe=j(v(ae,{joinWith:"|"}),!0),this.lastIndex=0}exec(ae){this.matcherRe.lastIndex=this.lastIndex;const me=this.matcherRe.exec(ae);if(!me)return null;const Ve=me.findIndex((fn,_r)=>_r>0&&fn!==void 0),Ze=this.matchIndexes[Ve];return me.splice(0,Ve),Object.assign(me,Ze)}}class _e{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(ae){if(this.multiRegexes[ae])return this.multiRegexes[ae];const me=new ee;return this.rules.slice(ae).forEach(([Ve,Ze])=>me.addRule(Ve,Ze)),me.compile(),this.multiRegexes[ae]=me,me}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(ae,me){this.rules.push([ae,me]),me.type==="begin"&&this.count++}exec(ae){const me=this.getMatcher(this.regexIndex);me.lastIndex=this.lastIndex;let Ve=me.exec(ae);if(this.resumingScanAtSamePosition()&&!(Ve&&Ve.index===this.lastIndex)){const Ze=this.getMatcher(0);Ze.lastIndex=this.lastIndex+1,Ve=Ze.exec(ae)}return Ve&&(this.regexIndex+=Ve.position+1,this.regexIndex===this.count&&this.considerAll()),Ve}}function Ue(oe){const ae=new _e;return oe.contains.forEach(me=>ae.addRule(me.begin,{rule:me,type:"begin"})),oe.terminatorEnd&&ae.addRule(oe.terminatorEnd,{type:"end"}),oe.illegal&&ae.addRule(oe.illegal,{type:"illegal"}),ae}function We(oe,ae){const me=oe;if(oe.isCompiled)return me;[D,$,os,B].forEach(Ze=>Ze(oe,ae)),x.compilerExtensions.forEach(Ze=>Ze(oe,ae)),oe.__beforeBegin=null,[K,q,T].forEach(Ze=>Ze(oe,ae)),oe.isCompiled=!0;let Ve=null;return typeof oe.keywords=="object"&&oe.keywords.$pattern&&(oe.keywords=Object.assign({},oe.keywords),Ve=oe.keywords.$pattern,delete oe.keywords.$pattern),Ve=Ve||/\w+/,oe.keywords&&(oe.keywords=pe(oe.keywords,x.case_insensitive)),me.keywordPatternRe=j(Ve,!0),ae&&(oe.begin||(oe.begin=/\B|\b/),me.beginRe=j(me.begin),!oe.end&&!oe.endsWithParent&&(oe.end=/\B|\b/),oe.end&&(me.endRe=j(me.end)),me.terminatorEnd=g(me.end)||"",oe.endsWithParent&&ae.terminatorEnd&&(me.terminatorEnd+=(oe.end?"|":"")+ae.terminatorEnd)),oe.illegal&&(me.illegalRe=j(oe.illegal)),oe.contains||(oe.contains=[]),oe.contains=[].concat(...oe.contains.map(function(Ze){return cs(Ze==="self"?oe:Ze)})),oe.contains.forEach(function(Ze){We(Ze,me)}),oe.starts&&We(oe.starts,ae),me.matcher=Ue(me),me}if(x.compilerExtensions||(x.compilerExtensions=[]),x.contains&&x.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return x.classNameAliases=i(x.classNameAliases||{}),We(x)}function vi(x){return x?x.endsWithParent||vi(x.starts):!1}function cs(x){return x.variants&&!x.cachedVariants&&(x.cachedVariants=x.variants.map(function(j){return i(x,{variants:null},j)})),x.cachedVariants?x.cachedVariants:vi(x)?i(x,{starts:x.starts?i(x.starts):null}):Object.isFrozen(x)?i(x):x}var us="11.11.1";class hs extends Error{constructor(j,ee){super(j),this.name="HTMLInjectionError",this.html=ee}}const wr=n,Ai=i,Ei=Symbol("nomatch"),ds=7,Ci=function(x){const j=Object.create(null),ee=Object.create(null),_e=[];let Ue=!0;const We="Could not find the language '{}', did you forget to load/include a language module?",oe={disableAutodetect:!0,name:"Plain text",contains:[]};let ae={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:u};function me(Q){return ae.noHighlightRe.test(Q)}function Ve(Q){let ue=Q.className+" ";ue+=Q.parentNode?Q.parentNode.className:"";const Le=ae.languageDetectRe.exec(ue);if(Le){const je=Tt(Le[1]);return je||(Ie(We.replace("{}",Le[1])),Ie("Falling back to no-highlight mode for this block.",Q)),je?Le[1]:"no-highlight"}return ue.split(/\s+/).find(je=>me(je)||Tt(je))}function Ze(Q,ue,Le){let je="",Xe="";typeof ue=="object"?(je=Q,Le=ue.ignoreIllegals,Xe=ue.language):(Ge("10.7.0","highlight(lang, code, ...args) has been deprecated."),Ge("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),Xe=Q,je=ue),Le===void 0&&(Le=!0);const bt={code:je,language:Xe};jn("before:highlight",bt);const zt=bt.result?bt.result:fn(bt.language,bt.code,Le);return zt.code=bt.code,jn("after:highlight",zt),zt}function fn(Q,ue,Le,je){const Xe=Object.create(null);function bt(ne,ce){return ne.keywords[ce]}function zt(){if(!ke.keywords){Ye.addText(qe);return}let ne=0;ke.keywordPatternRe.lastIndex=0;let ce=ke.keywordPatternRe.exec(qe),Ae="";for(;ce;){Ae+=qe.substring(ne,ce.index);const Ne=kt.case_insensitive?ce[0].toLowerCase():ce[0],Je=bt(ke,Ne);if(Je){const[Mt,Ls]=Je;if(Ye.addText(Ae),Ae="",Xe[Ne]=(Xe[Ne]||0)+1,Xe[Ne]<=ds&&(Fn+=Ls),Mt.startsWith("_"))Ae+=ce[0];else{const Ts=kt.classNameAliases[Mt]||Mt;_t(ce[0],Ts)}}else Ae+=ce[0];ne=ke.keywordPatternRe.lastIndex,ce=ke.keywordPatternRe.exec(qe)}Ae+=qe.substring(ne),Ye.addText(Ae)}function qn(){if(qe==="")return;let ne=null;if(typeof ke.subLanguage=="string"){if(!j[ke.subLanguage]){Ye.addText(qe);return}ne=fn(ke.subLanguage,qe,!0,Ii[ke.subLanguage]),Ii[ke.subLanguage]=ne._top}else ne=kr(qe,ke.subLanguage.length?ke.subLanguage:null);ke.relevance>0&&(Fn+=ne.relevance),Ye.__addSublanguage(ne._emitter,ne.language)}function ct(){ke.subLanguage!=null?qn():zt(),qe=""}function _t(ne,ce){ne!==""&&(Ye.startScope(ce),Ye.addText(ne),Ye.endScope())}function zi(ne,ce){let Ae=1;const Ne=ce.length-1;for(;Ae<=Ne;){if(!ne._emit[Ae]){Ae++;continue}const Je=kt.classNameAliases[ne[Ae]]||ne[Ae],Mt=ce[Ae];Je?_t(Mt,Je):(qe=Mt,zt(),qe=""),Ae++}}function Ri(ne,ce){return ne.scope&&typeof ne.scope=="string"&&Ye.openNode(kt.classNameAliases[ne.scope]||ne.scope),ne.beginScope&&(ne.beginScope._wrap?(_t(qe,kt.classNameAliases[ne.beginScope._wrap]||ne.beginScope._wrap),qe=""):ne.beginScope._multi&&(zi(ne.beginScope,ce),qe="")),ke=Object.create(ne,{parent:{value:ke}}),ke}function $i(ne,ce,Ae){let Ne=_(ne.endRe,Ae);if(Ne){if(ne["on:end"]){const Je=new t(ne);ne["on:end"](ce,Je),Je.isMatchIgnored&&(Ne=!1)}if(Ne){for(;ne.endsParent&&ne.parent;)ne=ne.parent;return ne}}if(ne.endsWithParent)return $i(ne.parent,ce,Ae)}function vs(ne){return ke.matcher.regexIndex===0?(qe+=ne[0],1):(Ar=!0,0)}function As(ne){const ce=ne[0],Ae=ne.rule,Ne=new t(Ae),Je=[Ae.__beforeBegin,Ae["on:begin"]];for(const Mt of Je)if(Mt&&(Mt(ne,Ne),Ne.isMatchIgnored))return vs(ce);return Ae.skip?qe+=ce:(Ae.excludeBegin&&(qe+=ce),ct(),!Ae.returnBegin&&!Ae.excludeBegin&&(qe=ce)),Ri(Ae,ne),Ae.returnBegin?0:ce.length}function Es(ne){const ce=ne[0],Ae=ue.substring(ne.index),Ne=$i(ke,ne,Ae);if(!Ne)return Ei;const Je=ke;ke.endScope&&ke.endScope._wrap?(ct(),_t(ce,ke.endScope._wrap)):ke.endScope&&ke.endScope._multi?(ct(),zi(ke.endScope,ne)):Je.skip?qe+=ce:(Je.returnEnd||Je.excludeEnd||(qe+=ce),ct(),Je.excludeEnd&&(qe=ce));do ke.scope&&Ye.closeNode(),!ke.skip&&!ke.subLanguage&&(Fn+=ke.relevance),ke=ke.parent;while(ke!==Ne.parent);return Ne.starts&&Ri(Ne.starts,ne),Je.returnEnd?0:ce.length}function Cs(){const ne=[];for(let ce=ke;ce!==kt;ce=ce.parent)ce.scope&&ne.unshift(ce.scope);ne.forEach(ce=>Ye.openNode(ce))}let Hn={};function Pi(ne,ce){const Ae=ce&&ce[0];if(qe+=ne,Ae==null)return ct(),0;if(Hn.type==="begin"&&ce.type==="end"&&Hn.index===ce.index&&Ae===""){if(qe+=ue.slice(ce.index,ce.index+1),!Ue){const Ne=new Error(`0 width match regex (${Q})`);throw Ne.languageName=Q,Ne.badRule=Hn.rule,Ne}return 1}if(Hn=ce,ce.type==="begin")return As(ce);if(ce.type==="illegal"&&!Le){const Ne=new Error('Illegal lexeme "'+Ae+'" for mode "'+(ke.scope||"<unnamed>")+'"');throw Ne.mode=ke,Ne}else if(ce.type==="end"){const Ne=Es(ce);if(Ne!==Ei)return Ne}if(ce.type==="illegal"&&Ae==="")return qe+=`
`,1;if(vr>1e5&&vr>ce.index*3)throw new Error("potential infinite loop, way more iterations than matches");return qe+=Ae,Ae.length}const kt=Tt(Q);if(!kt)throw ve(We.replace("{}",Q)),new Error('Unknown language: "'+Q+'"');const Ms=ls(kt);let Sr="",ke=je||Ms;const Ii={},Ye=new ae.__emitter(ae);Cs();let qe="",Fn=0,Ft=0,vr=0,Ar=!1;try{if(kt.__emitTokens)kt.__emitTokens(ue,Ye);else{for(ke.matcher.considerAll();;){vr++,Ar?Ar=!1:ke.matcher.considerAll(),ke.matcher.lastIndex=Ft;const ne=ke.matcher.exec(ue);if(!ne)break;const ce=ue.substring(Ft,ne.index),Ae=Pi(ce,ne);Ft=ne.index+Ae}Pi(ue.substring(Ft))}return Ye.finalize(),Sr=Ye.toHTML(),{language:Q,value:Sr,relevance:Fn,illegal:!1,_emitter:Ye,_top:ke}}catch(ne){if(ne.message&&ne.message.includes("Illegal"))return{language:Q,value:wr(ue),illegal:!0,relevance:0,_illegalBy:{message:ne.message,index:Ft,context:ue.slice(Ft-100,Ft+100),mode:ne.mode,resultSoFar:Sr},_emitter:Ye};if(Ue)return{language:Q,value:wr(ue),illegal:!1,relevance:0,errorRaised:ne,_emitter:Ye,_top:ke};throw ne}}function _r(Q){const ue={value:wr(Q),illegal:!1,relevance:0,_top:oe,_emitter:new ae.__emitter(ae)};return ue._emitter.addText(Q),ue}function kr(Q,ue){ue=ue||ae.languages||Object.keys(j);const Le=_r(Q),je=ue.filter(Tt).filter(Ti).map(ct=>fn(ct,Q,!1));je.unshift(Le);const Xe=je.sort((ct,_t)=>{if(ct.relevance!==_t.relevance)return _t.relevance-ct.relevance;if(ct.language&&_t.language){if(Tt(ct.language).supersetOf===_t.language)return 1;if(Tt(_t.language).supersetOf===ct.language)return-1}return 0}),[bt,zt]=Xe,qn=bt;return qn.secondBest=zt,qn}function fs(Q,ue,Le){const je=ue&&ee[ue]||Le;Q.classList.add("hljs"),Q.classList.add(`language-${je}`)}function xr(Q){let ue=null;const Le=Ve(Q);if(me(Le))return;if(jn("before:highlightElement",{el:Q,language:Le}),Q.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",Q);return}if(Q.children.length>0&&(ae.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(Q)),ae.throwUnescapedHTML))throw new hs("One of your code blocks includes unescaped HTML.",Q.innerHTML);ue=Q;const je=ue.textContent,Xe=Le?Ze(je,{language:Le,ignoreIllegals:!0}):kr(je);Q.innerHTML=Xe.value,Q.dataset.highlighted="yes",fs(Q,Le,Xe.language),Q.result={language:Xe.language,re:Xe.relevance,relevance:Xe.relevance},Xe.secondBest&&(Q.secondBest={language:Xe.secondBest.language,relevance:Xe.secondBest.relevance}),jn("after:highlightElement",{el:Q,result:Xe,text:je})}function gs(Q){ae=Ai(ae,Q)}const ps=()=>{Bn(),Ge("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function ms(){Bn(),Ge("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let Mi=!1;function Bn(){function Q(){Bn()}if(document.readyState==="loading"){Mi||window.addEventListener("DOMContentLoaded",Q,!1),Mi=!0;return}document.querySelectorAll(ae.cssSelector).forEach(xr)}function ys(Q,ue){let Le=null;try{Le=ue(x)}catch(je){if(ve("Language definition for '{}' could not be registered.".replace("{}",Q)),Ue)ve(je);else throw je;Le=oe}Le.name||(Le.name=Q),j[Q]=Le,Le.rawDefinition=ue.bind(null,x),Le.aliases&&Li(Le.aliases,{languageName:Q})}function bs(Q){delete j[Q];for(const ue of Object.keys(ee))ee[ue]===Q&&delete ee[ue]}function ws(){return Object.keys(j)}function Tt(Q){return Q=(Q||"").toLowerCase(),j[Q]||j[ee[Q]]}function Li(Q,{languageName:ue}){typeof Q=="string"&&(Q=[Q]),Q.forEach(Le=>{ee[Le.toLowerCase()]=ue})}function Ti(Q){const ue=Tt(Q);return ue&&!ue.disableAutodetect}function _s(Q){Q["before:highlightBlock"]&&!Q["before:highlightElement"]&&(Q["before:highlightElement"]=ue=>{Q["before:highlightBlock"](Object.assign({block:ue.el},ue))}),Q["after:highlightBlock"]&&!Q["after:highlightElement"]&&(Q["after:highlightElement"]=ue=>{Q["after:highlightBlock"](Object.assign({block:ue.el},ue))})}function ks(Q){_s(Q),_e.push(Q)}function xs(Q){const ue=_e.indexOf(Q);ue!==-1&&_e.splice(ue,1)}function jn(Q,ue){const Le=Q;_e.forEach(function(je){je[Le]&&je[Le](ue)})}function Ss(Q){return Ge("10.7.0","highlightBlock will be removed entirely in v12.0"),Ge("10.7.0","Please use highlightElement now."),xr(Q)}Object.assign(x,{highlight:Ze,highlightAuto:kr,highlightAll:Bn,highlightElement:xr,highlightBlock:Ss,configure:gs,initHighlighting:ps,initHighlightingOnLoad:ms,registerLanguage:ys,unregisterLanguage:bs,listLanguages:ws,getLanguage:Tt,registerAliases:Li,autoDetection:Ti,inherit:Ai,addPlugin:ks,removePlugin:xs}),x.debugMode=function(){Ue=!1},x.safeMode=function(){Ue=!0},x.versionString=us,x.regex={concat:m,lookahead:h,either:w,optional:p,anyNumberOfTimes:d};for(const Q in A)typeof A[Q]=="object"&&e(A[Q]);return Object.assign(x,A),x},en=Ci({});return en.newInstance=()=>Ci({}),Er=en,en.HighlightJS=en,en.default=en,Er}var Ds=Fs();const Re=fa(Ds);class dr{constructor(t={}){const{maxSize:n=0,ttlMs:i=0,onEvict:r=null}=t||{};this._map=new Map,this._maxSize=Math.max(0,Number(n)||0),this._ttlMs=Math.max(0,Number(i)||0),this._onEvict=typeof r=="function"?r:null}get size(){return this._map.size}has(t){const n=this._map.get(t);return n?this._ttlMs&&Date.now()-(n.ts||0)>=this._ttlMs?(this._evictKey(t,n),!1):(this._map.delete(t),this._map.set(t,n),!0):!1}get(t){const n=this._map.get(t);if(n){if(this._ttlMs&&Date.now()-(n.ts||0)>=this._ttlMs){this._evictKey(t,n);return}return this._map.delete(t),this._map.set(t,n),n.value}}set(t,n){if(this._map.has(t)&&this._map.delete(t),this._map.set(t,{value:n,ts:Date.now()}),this._maxSize&&this._map.size>this._maxSize)for(;this._map.size>this._maxSize;){const i=this._map.keys().next().value,r=this._map.get(i);if(this._map.delete(i),this._onEvict)try{this._onEvict(i,r&&r.value)}catch{}}return this}delete(t){return this._map.delete(t)}clear(){if(this._onEvict)for(const[t,n]of this._map.entries())try{this._onEvict(t,n&&n.value)}catch{}this._map.clear()}_evictKey(t,n){try{this._map.delete(t)}catch{}if(this._onEvict)try{this._onEvict(t,n&&n.value)}catch{}}}const Qn=new dr({maxSize:500});let ga=300*1e3;function Us(){Qn.clear()}function Ws(e){ga=Number(e)||0}async function ei(e,t){try{if(!e)return null;const n=Date.now();let i=Qn.get(e);if(i&&i.ok===!1&&n-(i.ts||0)>=ga&&(Qn.delete(e),i=void 0),i){if(i.module)return i.module;if(i.promise)try{return await i.promise}catch{return null}}const r={promise:null,module:null,ok:null,ts:Date.now()};Qn.set(e,r),r.promise=(async()=>{try{return await t()}catch{return null}})();try{const a=await r.promise;return r.module=a,r.ok=!!a,r.ts=Date.now(),a}catch{return r.module=null,r.ok=!1,r.ts=Date.now(),null}}catch{return null}}async function Zs(e){return await ei(e,async()=>{try{return await import(e)}catch{return null}})}const Gs="11.11.1",Ee=new Map,Xs="https://raw.githubusercontent.com/highlightjs/highlight.js/main/SUPPORTED_LANGUAGES.md",dt={shell:"bash",sh:"bash",zsh:"bash",js:"javascript",ts:"typescript",py:"python",csharp:"cs","c#":"cs"};dt.html="xml";dt.xhtml="xml";dt.markup="xml";const ti=new Set(["magic","undefined"]);let Nt=null,Qs=null;async function ni(e=Xs){if(e)return Nt||(Nt=(async()=>{try{const t=await fetch(e);if(!t.ok)return;const i=(await t.text()).split(/\r?\n/);let r=-1;for(let c=0;c<i.length;c++)if(/\|\s*Language\s*\|/i.test(i[c])){r=c;break}if(r===-1)return;const a=i[r].replace(/^\||\|$/g,"").split("|").map(c=>c.trim().toLowerCase());let s=a.findIndex(c=>/alias|aliases|equivalent|alt|alternates?/i.test(c));s===-1&&(s=1);let o=a.findIndex(c=>/file|filename|module|module name|module-name|short|slug/i.test(c));if(o===-1){const c=a.findIndex(u=>/language/i.test(u));o=c!==-1?c:0}let l=[];for(let c=r+1;c<i.length;c++){const u=i[c].trim();if(!u||!u.startsWith("|"))break;const g=u.replace(/^\||\|$/g,"").split("|").map(f=>f.trim());if(g.every(f=>/^-+$/.test(f)))continue;const h=g;if(!h.length)continue;const p=(h[o]||h[0]||"").toString().trim().toLowerCase();if(!p||/^-+$/.test(p))continue;Ee.set(p,p);const m=h[s]||"";if(m){const f=String(m).split(",").map(w=>w.replace(/`/g,"").trim()).filter(Boolean);if(f.length){const y=f[0].toLowerCase().replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");y&&/[a-z0-9]/i.test(y)&&(Ee.set(y,y),l.push(y))}}}try{const c=[];for(const u of l){const g=String(u||"").replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");g&&/[a-z0-9]/i.test(g)?c.push(g):Ee.delete(u)}l=c}catch(c){k("[codeblocksManager] cleanup aliases failed",c)}try{let c=0;for(const u of Array.from(Ee.keys())){if(!u||/^-+$/.test(u)||!/[a-z0-9]/i.test(u)){Ee.delete(u),c++;continue}if(/^[:]+/.test(u)){const g=u.replace(/^[:]+/,"");if(g&&/[a-z0-9]/i.test(g)){const h=Ee.get(u);Ee.delete(u),Ee.set(g,h)}else Ee.delete(u),c++}}for(const[u,g]of Array.from(Ee.entries()))(!g||/^-+$/.test(g)||!/[a-z0-9]/i.test(g))&&(Ee.delete(u),c++);try{const u=":---------------------";Ee.has(u)&&(Ee.delete(u),c++)}catch(u){k("[codeblocksManager] remove sep key failed",u)}try{const u=Array.from(Ee.keys()).sort()}catch(u){k("[codeblocksManager] compute supported keys failed",u)}}catch(c){k("[codeblocksManager] ignored error",c)}}catch(t){k("[codeblocksManager] loadSupportedLanguages failed",t)}})(),Nt)}const gn=new Set;async function on(e,t){if(Nt||(async()=>{try{await ni()}catch(r){k("[codeblocksManager] loadSupportedLanguages (IIFE) failed",r)}})(),Nt)try{await Nt}catch{}if(e=e==null?"":String(e),e=e.trim(),!e)return!1;const n=e.toLowerCase();if(ti.has(n))return!1;if(Ee.size&&!Ee.has(n)){const r=dt;if(!r[n]&&!r[e])return!1}if(gn.has(e))return!0;const i=dt;try{const r=(t||e||"").toString().replace(/\.js$/i,"").trim(),a=(i[e]||e||"").toString(),s=(i[r]||r||"").toString();let o=Array.from(new Set([a,s,r,e,i[r],i[e]].filter(Boolean))).map(u=>String(u).toLowerCase()).filter(u=>u&&u!=="undefined");Ee.size&&(o=o.filter(u=>{if(Ee.has(u))return!0;const g=dt[u];return!!(g&&Ee.has(g))}));let l=null,c=null;for(const u of o)try{if(l=await ei(u,async()=>{try{try{try{return await import(`highlight.js/lib/languages/${u}.js`)}catch{return await import(`highlight.js/lib/languages/${u}`)}}catch{try{return await import(`https://cdn.jsdelivr.net/npm/highlight.js/es/languages/${u}.js`)}catch{try{return await import(`https://cdn.jsdelivr.net/npm/highlight.js/lib/languages/${u}.js`)}catch{return null}}}}catch{return null}}),l){const g=l.default||l;try{const h=Ee.size&&Ee.get(e)||u||e;return Re.registerLanguage(h,g),gn.add(h),h!==e&&(Re.registerLanguage(e,g),gn.add(e)),!0}catch(h){c=h}}else try{if(Ee.has(u)||Ee.has(e)){const g=()=>({});try{Re.registerLanguage(u,g),gn.add(u)}catch{}try{u!==e&&(Re.registerLanguage(e,g),gn.add(e))}catch{}return!0}}catch{}}catch(g){c=g}if(c)throw c;return!1}catch{return!1}}let Dn=null;function pa(e){const t=e&&e.querySelector?e:typeof document<"u"?document:null;Nt||(async()=>{try{await ni()}catch(s){k("[codeblocksManager] loadSupportedLanguages (observer) failed",s)}})();const n=dt,r=Dn||(typeof IntersectionObserver>"u"?null:(Dn=new IntersectionObserver((s,o)=>{s.forEach(l=>{if(!l.isIntersecting)return;const c=l.target;try{o.unobserve(c)}catch(u){k("[codeblocksManager] observer unobserve failed",u)}(async()=>{try{const u=c.getAttribute&&c.getAttribute("class")||c.className||"",g=u.match(/language-([a-zA-Z0-9_+-]+)/)||u.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(g&&g[1]){const h=(g[1]||"").toLowerCase(),d=n[h]||h,p=Ee.size&&(Ee.get(d)||Ee.get(String(d).toLowerCase()))||d;try{await on(p)}catch(m){k("[codeblocksManager] registerLanguage failed",m)}try{try{const m=c.textContent||c.innerText||"";m!=null&&(c.textContent=m)}catch{}try{c&&c.dataset&&c.dataset.highlighted&&delete c.dataset.highlighted}catch{}Re.highlightElement(c)}catch(m){k("[codeblocksManager] hljs.highlightElement failed",m)}}else try{const h=c.textContent||"";try{if(Re&&typeof Re.getLanguage=="function"&&Re.getLanguage("plaintext")){const d=Re.highlight(h,{language:"plaintext"});if(d&&d.value)try{if(typeof document<"u"&&document.createRange&&typeof document.createRange=="function"){const p=document.createRange().createContextualFragment(d.value);if(typeof c.replaceChildren=="function")c.replaceChildren(...Array.from(p.childNodes));else{for(;c.firstChild;)c.removeChild(c.firstChild);c.appendChild(p)}}else c.innerHTML=d.value}catch{try{c.innerHTML=d.value}catch{}}}}catch{try{Re.highlightElement(c)}catch(p){k("[codeblocksManager] fallback highlightElement failed",p)}}}catch(h){k("[codeblocksManager] auto-detect plaintext failed",h)}}catch(u){k("[codeblocksManager] observer entry processing failed",u)}})()})},{root:null,rootMargin:"300px",threshold:.1}),Dn)),a=t&&t.querySelectorAll?t.querySelectorAll("pre code"):[];if(!r){a.forEach(async s=>{try{const o=s.getAttribute&&s.getAttribute("class")||s.className||"",l=o.match(/language-([a-zA-Z0-9_+-]+)/)||o.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(l&&l[1]){const c=(l[1]||"").toLowerCase(),u=n[c]||c,g=Ee.size&&(Ee.get(u)||Ee.get(String(u).toLowerCase()))||u;try{await on(g)}catch(h){k("[codeblocksManager] registerLanguage failed (no observer)",h)}}try{try{const c=s.textContent||s.innerText||"";c!=null&&(s.textContent=c)}catch{}try{s&&s.dataset&&s.dataset.highlighted&&delete s.dataset.highlighted}catch{}Re.highlightElement(s)}catch(c){k("[codeblocksManager] hljs.highlightElement failed (no observer)",c)}}catch(o){k("[codeblocksManager] loadSupportedLanguages fallback ignored error",o)}});return}a.forEach(s=>{try{r.observe(s)}catch(o){k("[codeblocksManager] observe failed",o)}})}function Ks(e,{useCdn:t=!0}={}){const n=typeof document<"u"&&document.head&&document.head.querySelector?document.head.querySelector("link[data-hl-theme]"):typeof document<"u"?document.querySelector("link[data-hl-theme]"):null,i=n&&n.getAttribute?n.getAttribute("data-hl-theme"):null,r=e==null?"default":String(e),a=r&&String(r).toLowerCase()||"";if(a==="default"||a==="monokai"){try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}return}if(i&&i.toLowerCase()===a)return;if(!t){try{k("Requested highlight theme not bundled; set useCdn=true to load theme from CDN")}catch{}return}const s=a,o=`https://cdn.jsdelivr.net/npm/highlight.js@${Gs}/styles/${s}.css`,l=document.createElement("link");l.rel="stylesheet",l.href=o,l.setAttribute("data-hl-theme",s),l.addEventListener("load",()=>{try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}}),document.head.appendChild(l)}let Dt="light";function Vs(e,t={}){if(document.querySelector(`link[href="${e}"]`))return;const n=document.createElement("link");if(n.rel="stylesheet",n.href=e,Object.entries(t).forEach(([i,r])=>n.setAttribute(i,r)),document.head.appendChild(n),t["data-bulmaswatch-theme"])try{if(n.getAttribute("data-bulmaswatch-observer"))return;let i=Number(n.getAttribute("data-bulmaswatch-move-count")||0),r=!1;const a=new MutationObserver(()=>{try{if(r)return;const o=n.parentNode;if(!o||o.lastElementChild===n)return;if(i>=1e3){n.setAttribute("data-bulmaswatch-move-stopped","1");return}r=!0;try{o.appendChild(n)}catch{}i+=1,n.setAttribute("data-bulmaswatch-move-count",String(i)),r=!1}catch{}});try{a.observe(document.head,{childList:!0}),n.setAttribute("data-bulmaswatch-observer","1"),n.setAttribute("data-bulmaswatch-move-count",String(i))}catch{}const s=document.head;s&&s.lastElementChild!==n&&s.appendChild(n)}catch{}}function Cr(){try{const e=typeof document<"u"&&document.head?document.head:document,t=Array.from(e.querySelectorAll("link[data-bulmaswatch-theme]"));for(const n of t)n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}try{const e=typeof document<"u"&&document.head?document.head:document,t=Array.from(e.querySelectorAll("style[data-bulma-override]"));for(const n of t)n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}}async function ma(e="none",t="/"){try{Bt("[bulmaManager] ensureBulma called",{bulmaCustomize:e,pageDir:t})}catch{}if(!e)return;if(e==="none"){try{Cr()}catch{}return}const n=[t+"bulma.css","/bulma.css"],i=Array.from(new Set(n));if(e==="local"){if(Cr(),document.querySelector("style[data-bulma-override]"))return;for(const r of i)try{const a=await fetch(r,{method:"GET"});if(a.ok){const s=await a.text(),o=document.createElement("style");o.setAttribute("data-bulma-override",r),o.appendChild(document.createTextNode(`
/* bulma override: ${r} */
`+s)),document.head.appendChild(o);return}}catch(a){k("[bulmaManager] fetch local bulma candidate failed",a)}return}try{const r=String(e).trim();if(!r)return;Cr();const a=`https://unpkg.com/bulmaswatch/${encodeURIComponent(r)}/bulmaswatch.min.css`;Vs(a,{"data-bulmaswatch-theme":r})}catch(r){k("[bulmaManager] ensureBulma failed",r)}}function ya(e){Dt=e==="dark"?"dark":e==="system"?"system":"light";try{const t=Array.from(document.querySelectorAll(".nimbi-mount"));if(t.length>0)for(const n of t)Dt==="dark"?n.setAttribute("data-theme","dark"):Dt==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme");else{const n=document.documentElement;Dt==="dark"?n.setAttribute("data-theme","dark"):Dt==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme")}}catch{}}function Ys(e){const t=document.documentElement;for(const[n,i]of Object.entries(e||{}))try{t.style.setProperty(`--${n}`,i)}catch(r){k("[bulmaManager] setThemeVars failed for",n,r)}}function ba(e){if(!e||!(e instanceof HTMLElement))return()=>{};const t=e.closest&&e.closest(".nimbi-mount")||null;try{t&&(Dt==="dark"?t.setAttribute("data-theme","dark"):Dt==="light"?t.setAttribute("data-theme","light"):t.removeAttribute("data-theme"))}catch{}return()=>{}}const wa={en:{navigation:"Navigation",onThisPage:"On this page",home:"Home",scrollToTop:"Scroll to top",readingTime:"{minutes} min read",searchPlaceholder:"Search…",searchNoResults:"No results",imagePreviewTitle:"Image preview",imagePreviewFit:"Fit to screen",imagePreviewOriginal:"Original size",imagePreviewZoomOut:"Zoom out",imagePreviewZoomIn:"Zoom in",imagePreviewClose:"Close"},es:{navigation:"Navegación",onThisPage:"En esta página",home:"Inicio",scrollToTop:"Ir arriba",readingTime:"{minutes} min de lectura",searchPlaceholder:"Buscar…",searchNoResults:"Sin resultados",imagePreviewTitle:"Previsualización de imagen",imagePreviewFit:"Ajustar a la pantalla",imagePreviewOriginal:"Tamaño original",imagePreviewZoomOut:"Alejar",imagePreviewZoomIn:"Acercar",imagePreviewClose:"Cerrar"},de:{navigation:"Navigation",onThisPage:"Auf dieser Seite",home:"Startseite",scrollToTop:"Nach oben",readingTime:"{minutes} min Lesezeit",searchPlaceholder:"Suchen…",searchNoResults:"Keine Ergebnisse",imagePreviewTitle:"Bildvorschau",imagePreviewFit:"An Bildschirm anpassen",imagePreviewOriginal:"Originalgröße",imagePreviewZoomOut:"Verkleinern",imagePreviewZoomIn:"Vergrößern",imagePreviewClose:"Schließen"},fr:{navigation:"Navigation",onThisPage:"Sur cette page",home:"Accueil",scrollToTop:"Aller en haut",readingTime:"{minutes} min de lecture",searchPlaceholder:"Rechercher…",searchNoResults:"Aucun résultat",imagePreviewTitle:"Aperçu de l’image",imagePreviewFit:"Ajuster à l’écran",imagePreviewOriginal:"Taille originale",imagePreviewZoomOut:"Dézoomer",imagePreviewZoomIn:"Zoomer",imagePreviewClose:"Fermer"},pt:{navigation:"Navegação",onThisPage:"Nesta página",home:"Início",scrollToTop:"Ir para o topo",readingTime:"{minutes} min de leitura",searchPlaceholder:"Procurar…",searchNoResults:"Sem resultados",imagePreviewTitle:"Visualização da imagem",imagePreviewFit:"Ajustar à tela",imagePreviewOriginal:"Tamanho original",imagePreviewZoomOut:"Diminuir",imagePreviewZoomIn:"Aumentar",imagePreviewClose:"Fechar"}},an=JSON.parse(JSON.stringify(wa));let rr="en";if(typeof navigator<"u"){const e=navigator.language||navigator.languages&&navigator.languages[0]||"en";rr=String(e).split("-")[0].toLowerCase()}wa[rr]||(rr="en");let jt=rr;function nn(e,t={}){const n=an[jt]||an.en;let i=n&&n[e]?n[e]:an.en[e]||"";for(const r of Object.keys(t))i=i.replace(new RegExp(`{${r}}`,"g"),String(t[r]));return i}async function ri(e,t){if(!e)return;let n=e;try{/^https?:\/\//.test(e)||(n=new URL(e,location.origin+t).toString());const i=await fetch(n);if(!i.ok)return;const r=await i.json();for(const a of Object.keys(r||{}))an[a]=Object.assign({},an[a]||{},r[a])}catch{}}function ii(e){const t=String(e).split("-")[0].toLowerCase();jt=an[t]?t:"en"}const Js=Object.freeze(Object.defineProperty({__proto__:null,get currentLang(){return jt},loadL10nFile:ri,setLang:ii,t:nn},Symbol.toStringTag,{value:"Module"}));function eo(e){try{return String(e||"").split("/").map(t=>encodeURIComponent(t)).join("/")}catch{return String(e||"")}}function qi(e,t=null,n=void 0){let r="#/"+eo(String(e||""));t&&(r+="#"+encodeURIComponent(String(t)));try{let a="";if(typeof n=="string")a=n;else if(typeof location<"u"&&location&&location.search)a=location.search;else if(typeof location<"u"&&location&&location.hash)try{const s=it(location.href);s&&s.params&&(a=s.params)}catch{}if(a){const s=typeof a=="string"&&a.startsWith("?")?a.slice(1):a;try{const o=new URLSearchParams(s);o.delete("page");const l=o.toString();l&&(r+="?"+l)}catch{const l=String(s||"").replace(/^page=[^&]*&?/,"");l&&(r+="?"+l)}}}catch{}return r}function it(e){try{const t=new URL(e,typeof location<"u"?location.href:"http://localhost/"),n=t.searchParams.get("page");if(n){let r=null,a="";if(t.hash){const c=t.hash.replace(/^#/,"");if(c.includes("&")){const u=c.split("&");r=u.shift()||null,a=u.join("&")}else r=c||null}const s=new URLSearchParams(t.search);s.delete("page");const l=[s.toString(),a].filter(Boolean).join("&");return{type:"canonical",page:decodeURIComponent(n),anchor:r,params:l}}const i=t.hash?decodeURIComponent(t.hash.replace(/^#/,"")):"";if(i&&i.startsWith("/")){let r=i,a="";if(r.indexOf("?")!==-1){const c=r.split("?");r=c.shift()||"",a=c.join("?")||""}let s=r,o=null;if(s.indexOf("#")!==-1){const c=s.split("#");s=c.shift()||"",o=c.join("#")||null}return{type:"cosmetic",page:s.replace(/^\/+/,"")||null,anchor:o,params:a}}return{type:"path",page:(t.pathname||"").replace(/^\//,"")||null,anchor:t.hash?t.hash.replace(/^#/,""):null,params:t.search?t.search.replace(/^\?/,""):""}}catch{return{type:"unknown",page:e,anchor:null,params:""}}}let Un=typeof DOMParser<"u"?new DOMParser:null;function He(){return Un||(typeof DOMParser<"u"?(Un=new DOMParser,Un):null)}async function zn(e,t,n=4){if(!Array.isArray(e)||e.length===0)return[];const i=new Array(e.length);let r=0;const a=[],s=Math.max(1,Number(n)||1);async function o(){for(;;){const l=r++;if(l>=e.length)return;try{i[l]=await t(e[l],l)}catch{i[l]=void 0}}}for(let l=0;l<Math.min(s,e.length);l++)a.push(o());return await Promise.all(a),i}const to=`/**
...
`;for(let f=l;f<=c;f++)if((t(h[f])||!g(h[f])&&(g(h[f+1])||t(h[f+1])))&&o++,t(h[f]))for(;f<=c&&(i(h[f+1])||g(h[f+1]));)f++;const d=o/u,p=Math.round(d*60*1e3);return{text:Math.ceil(d.toFixed(2))+" min read",minutes:d,time:p,words:o}}return Lr=r,Lr}var zo=To();const Ro=fa(zo),wn=new Map,$o=200;function Po(e){return String(e||"")}function Io(e,t){if(wn.set(e,t),wn.size>$o){const n=wn.keys().next().value;n&&wn.delete(n)}}function No(e){return e?String(e).trim().split(/\s+/).filter(Boolean).length:0}function Oo(e){const t=Po(e),n=wn.get(t);if(n)return Object.assign({},n);const i=Ro(e||""),r=typeof i.words=="number"?i.words:No(e),a={readingTime:i,wordCount:r};return Io(t,a),Object.assign({},a)}function Rn(e,t){let n=document.querySelector(`meta[name="${e}"]`);n||(n=document.createElement("meta"),n.setAttribute("name",e),document.head.appendChild(n)),n.setAttribute("content",t)}function Rt(e,t,n){let i=`meta[${e}="${t}"]`,r=document.querySelector(i);r||(r=document.createElement("meta"),r.setAttribute(e,t),document.head.appendChild(r)),r.setAttribute("content",n)}function Pa(e,t){try{let n=document.querySelector(`link[rel="${e}"]`);n||(n=document.createElement("link"),n.setAttribute("rel",e),document.head.appendChild(n)),n.setAttribute("href",t)}catch(n){k("[seoManager] upsertLinkRel failed",n)}}function Bo(e,t,n,i){const r=t&&String(t).trim()?t:e.title||document.title;Rt("property","og:title",r);const a=i&&String(i).trim()?i:e.description||"";a&&String(a).trim()&&Rt("property","og:description",a),a&&String(a).trim()&&Rt("name","twitter:description",a),Rt("name","twitter:card",e.twitter_card||"summary_large_image");const s=n||e.image;s&&(Rt("property","og:image",s),Rt("name","twitter:image",s))}function li(e,t,n,i,r=""){const a=e.meta||{},s=document&&document.querySelector&&document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",o=i&&String(i).trim()?i:a.description&&String(a.description).trim()?a.description:s&&String(s).trim()?s:"";o&&String(o).trim()&&Rn("description",o),Rn("robots",a.robots||"index,follow"),Bo(a,t,n,o)}function jo(){try{const e=['meta[name="site"]','meta[name="site-name"]','meta[name="siteName"]','meta[property="og:site_name"]','meta[name="twitter:site"]'];for(const t of e){const n=document.querySelector(t);if(n){const i=n.getAttribute("content")||"";if(i&&i.trim())return i.trim()}}}catch(e){k("[seoManager] getSiteNameFromMeta failed",e)}return""}function ci(e,t,n,i,r,a=""){try{const s=e.meta||{},o=n&&String(n).trim()?n:s.title||a||document.title,l=r&&String(r).trim()?r:s.description||document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",c=i||s.image||null;let u="";try{if(t){const p=Y(t);try{u=(location.origin+location.pathname).split("?")[0]+"?page="+encodeURIComponent(p)}catch{u=location.href.split("#")[0]}}else u=location.href.split("#")[0]}catch(p){u=location.href.split("#")[0],k("[seoManager] compute canonical failed",p)}u&&Pa("canonical",u);try{Rt("property","og:url",u)}catch(p){k("[seoManager] upsertMeta og:url failed",p)}const g={"@context":"https://schema.org","@type":"Article",headline:o||"",description:l||"",url:u||location.href.split("#")[0]};c&&(g.image=String(c)),s.date&&(g.datePublished=s.date),s.dateModified&&(g.dateModified=s.dateModified);const h="nimbi-jsonld";let d=document.getElementById(h);d||(d=document.createElement("script"),d.type="application/ld+json",d.id=h,document.head.appendChild(d)),d.textContent=JSON.stringify(g,null,2)}catch(s){k("[seoManager] setStructuredData failed",s)}}let Sn=typeof window<"u"&&window.__SEO_MAP?window.__SEO_MAP:{};function qo(e){try{if(!e||typeof e!="object"){Sn={};return}Sn=Object.assign({},e)}catch(t){k("[seoManager] setSeoMap failed",t)}}function Ho(e,t=""){try{if(!e)return;const n=Sn&&Sn[e]?Sn[e]:typeof window<"u"&&window.__SEO_MAP&&window.__SEO_MAP[e]?window.__SEO_MAP[e]:null;try{const i=location.origin+location.pathname+"?page="+encodeURIComponent(String(e||""));Pa("canonical",i);try{Rt("property","og:url",i)}catch{}}catch{}if(!n)return;try{n.title&&(document.title=String(n.title))}catch{}try{n.description&&Rn("description",String(n.description))}catch{}try{try{li({meta:n},n.title||void 0,n.image||void 0,n.description||void 0,t)}catch{}}catch{}try{ci({meta:n},e,n.title||void 0,n.image||void 0,n.description||void 0,t)}catch(i){k("[seoManager] inject structured data failed",i)}}catch(n){k("[seoManager] injectSeoForPage failed",n)}}function Yn(e={},t="",n=void 0,i=void 0){try{const r=e||{},a=typeof n=="string"&&n.trim()?n:r.title||"Not Found",s=typeof i=="string"&&i.trim()?i:r.description||"";try{Rn("robots","noindex,follow")}catch{}try{s&&String(s).trim()&&Rn("description",String(s))}catch{}try{li({meta:Object.assign({},r,{robots:"noindex,follow"})},a,r.image||void 0,s)}catch{}try{ci({meta:Object.assign({},r,{title:a,description:s})},t||"",a,r.image||void 0,s)}catch{}}catch(r){k("[seoManager] markNotFound failed",r)}}function Fo(e,t,n,i,r,a,s,o,l,c,u){try{if(i&&i.querySelector){const g=i.querySelector(".menu-label");g&&(g.textContent=o&&o.textContent||e("onThisPage"))}}catch(g){k("[seoManager] update toc label failed",g)}try{const g=n.meta&&n.meta.title?String(n.meta.title).trim():"",h=r.querySelector("img"),d=h&&(h.getAttribute("src")||h.src)||null;let p="";try{let w="";try{const y=o||(r&&r.querySelector?r.querySelector("h1"):null);if(y){let _=y.nextElementSibling;const b=[];for(;_&&!(_.tagName&&_.tagName.toLowerCase()==="h2");){try{if(_.classList&&_.classList.contains("nimbi-article-subtitle")){_=_.nextElementSibling;continue}}catch{}const v=(_.textContent||"").trim();v&&b.push(v),_=_.nextElementSibling}b.length&&(w=b.join(" ").replace(/\s+/g," ").trim()),!w&&l&&(w=String(l).trim())}}catch(y){k("[seoManager] compute descOverride failed",y)}w&&String(w).length>160&&(w=String(w).slice(0,157).trim()+"..."),p=w}catch(w){k("[seoManager] compute descOverride failed",w)}let m="";try{g&&(m=g)}catch{}if(!m)try{o&&o.textContent&&(m=String(o.textContent).trim())}catch{}if(!m)try{const w=r.querySelector("h2");w&&w.textContent&&(m=String(w.textContent).trim())}catch{}m||(m=a||"");try{li(n,m||void 0,d,p)}catch(w){k("[seoManager] setMetaTags failed",w)}try{ci(n,c,m||void 0,d,p,t)}catch(w){k("[seoManager] setStructuredData failed",w)}const f=jo();m?f?document.title=`${f} - ${m}`:document.title=`${t||"Site"} - ${m}`:g?document.title=g:document.title=t||document.title}catch(g){k("[seoManager] applyPageMeta failed",g)}try{try{const g=r.querySelectorAll(".nimbi-reading-time");g&&g.forEach(h=>h.remove())}catch{}if(l){const g=Oo(u.raw||""),h=g&&g.readingTime?g.readingTime:null,d=h&&typeof h.minutes=="number"?Math.ceil(h.minutes):0,p=d?e("readingTime",{minutes:d}):"";if(!p)return;const m=r.querySelector("h1");if(m){const f=r.querySelector(".nimbi-article-subtitle");try{if(f){const w=document.createElement("span");w.className="nimbi-reading-time",w.textContent=p,f.appendChild(w)}else{const w=document.createElement("p");w.className="nimbi-article-subtitle is-6 has-text-grey-light";const y=document.createElement("span");y.className="nimbi-reading-time",y.textContent=p,w.appendChild(y);try{m.parentElement.insertBefore(w,m.nextSibling)}catch{try{m.insertAdjacentElement("afterend",w)}catch{}}}}catch{try{const y=document.createElement("p");y.className="nimbi-article-subtitle is-6 has-text-grey-light";const _=document.createElement("span");_.className="nimbi-reading-time",_.textContent=p,y.appendChild(_),m.insertAdjacentElement("afterend",y)}catch{}}}}}catch(g){k("[seoManager] reading time update failed",g)}}let Ia=100;function Wi(e){Ia=e}function ut(){try{if(Jt(2))return!0}catch{}try{return!1}catch{return!1}}let vn=300*1e3,pn=null;function ht(e,t,n){try{if(typeof Be=="function"&&typeof Be.length=="number"&&Be.length>=3)return Be(e,t,{signal:n})}catch{}return Be(e,t)}function Zi(e){vn=e}const yt=new Map;function Do(e){if(!yt.has(e))return;const t=yt.get(e),n=Date.now();if(t.ts+vn<n){yt.delete(e);return}return yt.delete(e),yt.set(e,t),t.value}function Uo(e,t){if(Gi(),Gi(),yt.delete(e),yt.set(e,{value:t,ts:Date.now()}),yt.size>Ia){const n=yt.keys().next().value;n!==void 0&&yt.delete(n)}}function Gi(){if(!vn||vn<=0)return;const e=Date.now();for(const[t,n]of yt.entries())n.ts+vn<e&&yt.delete(t)}async function Wo(e,t,n){const i=new Set(rt);let r=[];try{if(typeof document<"u"&&document.getElementsByClassName){const a=s=>{const o=document.getElementsByClassName(s);for(let l=0;l<o.length;l++){const c=o[l].getElementsByTagName("a");for(let u=0;u<c.length;u++)r.push(c[u])}};a("nimbi-site-navbar"),a("navbar"),a("nimbi-nav")}else r=Array.from(document.querySelectorAll(".nimbi-site-navbar a, .navbar a, .nimbi-nav a"))}catch{try{r=Array.from(document.querySelectorAll(".nimbi-site-navbar a, .navbar a, .nimbi-nav a"))}catch{r=[]}}for(const a of Array.from(r||[])){const s=a.getAttribute("href")||"";if(s)try{try{const h=it(s);if(h){if(h.type==="canonical"&&h.page){const d=Y(h.page);if(d){i.add(d);continue}}if(h.type==="cosmetic"&&h.page){const d=h.page;if(V.has(d)){const p=V.get(d);if(p)return p}continue}}}catch{}const o=new URL(s,location.href);if(o.origin!==location.origin)continue;const l=(o.hash||o.pathname).match(/([^#?]+\.md)(?:$|[?#])/)||(o.pathname||"").match(/([^#?]+\.md)(?:$|[?#])/);if(l){let h=Y(l[1]);h&&i.add(h);continue}const c=(a.textContent||"").trim(),u=(o.pathname||"").replace(/^.*\//,"");if(c&&he(c)===e||u&&he(u.replace(/\.(html?|md)$/i,""))===e)return o.toString();if(/\.(html?)$/i.test(o.pathname)){let h=o.pathname.replace(/^\//,"");i.add(h);continue}const g=o.pathname||"";if(g){const h=new URL(t),d=Kt(h.pathname);if(g.indexOf(d)!==-1){let p=g.startsWith(d)?g.slice(d.length):g;p=Y(p),p&&i.add(p)}}}catch(o){k("[router] malformed URL while discovering index candidates",o)}}for(const a of i)try{if(!a||!String(a).includes(".md"))continue;const s=await ht(a,t,n);if(!s||!s.raw)continue;const o=(s.raw||"").match(/^#\s+(.+)$/m);if(o){const l=(o[1]||"").trim();if(l&&he(l)===e)return a}}catch(s){k("[router] fetchMarkdown during index discovery failed",s)}return null}function Zo(e){const t=[];if(String(e).includes(".md")||String(e).includes(".html"))/index\.html$/i.test(e)||t.push(e);else try{const n=decodeURIComponent(String(e||""));if(V.has(n)){const i=cn(n)||V.get(n);i&&(/\.(md|html?)$/i.test(i)?/index\.html$/i.test(i)||t.push(i):(t.push(i),t.push(i+".html")))}else{if(rt&&rt.size)for(const i of rt){const r=i.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(he(r)===n&&!/index\.html$/i.test(i)){t.push(i);break}}!t.length&&n&&!/\.(md|html?)$/i.test(n)&&(t.push(n+".html"),t.push(n+".md"))}}catch(n){k("[router] buildPageCandidates failed during slug handling",n)}return t}async function Go(e,t){const n=e||"";try{try{ha("fetchPageData")}catch{}try{da("fetchPageData")}catch{}}catch{}try{if(pn&&typeof pn.abort=="function")try{pn.abort()}catch{}}catch{}pn=typeof AbortController<"u"?new AbortController:null;const i=pn;let r=null;try{const y=it(typeof location<"u"?location.href:"");y&&y.anchor&&(r=y.anchor)}catch{try{r=location&&location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null}catch{r=null}}let a=e||"";try{(!a||String(a).trim()==="")&&typeof lt=="string"&&lt&&(a=String(lt))}catch{}let s=null;const o=String(n||"").includes(".md")||String(n||"").includes(".html");if(a&&String(a).includes("::")){const y=String(a).split("::",2);a=y[0],s=y[1]||null}const c=`${e}|||${typeof Js<"u"&&jt?jt:""}`,u=Do(c);if(u)a=u.resolved,s=u.anchor||s;else{if(!String(a).includes(".md")&&!String(a).includes(".html")){let y=decodeURIComponent(String(a||""));if(y&&typeof y=="string"&&(y=Y(y),y=ln(y)),V.has(y))a=cn(y)||V.get(y);else{let _=await Wo(y,t,i?i.signal:void 0);if(_)a=_;else if(Gt._refreshed&&rt&&rt.size||typeof t=="string"&&/^[a-z][a-z0-9+.-]*:\/\//i.test(t)){const b=await $a(y,t);b&&(a=b)}}}Uo(c,{resolved:a,anchor:s})}let g=!0;try{const y=String(a||"").includes(".md")||String(a||"").includes(".html")||a&&(a.startsWith("http://")||a.startsWith("https://")||a.startsWith("/"));g=typeof le=="string"&&le||V.has(a)||rt&&rt.size||Gt._refreshed||o||y}catch{g=!0}!s&&r&&(s=r);try{if(g&&a&&(a.startsWith("http://")||a.startsWith("https://")||a.startsWith("/"))){const y=a.startsWith("/")?new URL(a,location.origin).toString():a;try{const _=await fetch(y,i?{signal:i.signal}:void 0);if(_&&_.ok){const b=await _.text(),v=_&&_.headers&&typeof _.headers.get=="function"&&_.headers.get("content-type")||"",S=(b||"").toLowerCase();if(v&&v.indexOf&&v.indexOf("text/html")!==-1||S.indexOf("<!doctype")!==-1||S.indexOf("<html")!==-1){if(!o)try{let I=y;try{I=new URL(y).pathname.replace(/^\//,"")}catch{I=String(y||"").replace(/^\//,"")}const U=I.replace(/\.html$/i,".md");try{const z=await ht(U,t,i?i.signal:void 0);if(z&&z.raw)return{data:z,pagePath:U,anchor:s}}catch{}if(typeof le=="string"&&le)try{const z=await ht(le,t,i?i.signal:void 0);if(z&&z.raw){try{Yn(z.meta||{},le)}catch{}return{data:z,pagePath:le,anchor:s}}}catch{}try{w=new Error("site shell detected (absolute fetch)")}catch{}}catch{}if(S.indexOf('<div id="app"')!==-1||S.indexOf("nimbi-cms")!==-1||S.indexOf("nimbi-mount")!==-1||S.indexOf("nimbi-")!==-1||S.indexOf("initcms(")!==-1||S.indexOf("window.nimbi")!==-1||/\bnimbi\b/.test(S))try{let I=y;try{I=new URL(y).pathname.replace(/^\//,"")}catch{I=String(y||"").replace(/^\//,"")}const U=I.replace(/\.html$/i,".md");try{const z=await ht(U,t,i?i.signal:void 0);if(z&&z.raw)return{data:z,pagePath:U,anchor:s}}catch{}if(typeof le=="string"&&le)try{const z=await ht(le,t,i?i.signal:void 0);if(z&&z.raw){try{Yn(z.meta||{},le)}catch{}return{data:z,pagePath:le,anchor:s}}}catch{}try{w=new Error("site shell detected (absolute fetch)")}catch{}}catch{}}}}catch{}}}catch{}const h=Zo(a);try{if(ut())try{Bt("[router-debug] fetchPageData candidates",{originalRaw:n,resolved:a,pageCandidates:h})}catch{}}catch{}const d=String(n||"").includes(".md")||String(n||"").includes(".html");let p=null;if(!d)try{let y=decodeURIComponent(String(n||""));y=Y(y),y=ln(y),y&&!/\.(md|html?)$/i.test(y)&&(p=y)}catch{p=null}if(d&&h.length===0&&(String(a).includes(".md")||String(a).includes(".html"))&&h.push(a),h.length===0&&(String(a).includes(".md")||String(a).includes(".html"))&&h.push(a),h.length===1&&/index\.html$/i.test(h[0])&&!d&&!V.has(a)&&!V.has(decodeURIComponent(String(a||"")))&&!String(a||"").includes("/"))throw new Error("Unknown slug: index.html fallback prevented");let m=null,f=null,w=null;try{const y=String(a||"").includes(".md")||String(a||"").includes(".html")||a&&(a.startsWith("http://")||a.startsWith("https://")||a.startsWith("/"));g=typeof le=="string"&&le||V.has(a)||rt&&rt.size||Gt._refreshed||d||y}catch{g=!0}if(!g)w=new Error("no page data");else for(const y of h)if(y)try{const _=Y(y);if(m=await ht(_,t,i?i.signal:void 0),f=_,p&&!V.has(p))try{let b="";if(m&&m.isHtml)try{const v=He();if(v){const S=v.parseFromString(m.raw||"","text/html"),E=S.querySelector("h1")||S.querySelector("title");E&&E.textContent&&(b=E.textContent.trim())}}catch{}else{const v=(m&&m.raw||"").match(/^#\s+(.+)$/m);v&&v[1]&&(b=v[1].trim())}if(b&&he(b)!==p)try{if(/\.html$/i.test(_)){const S=_.replace(/\.html$/i,".md");if(h.includes(S))try{const E=await ht(S,t,i?i.signal:void 0);if(E&&E.raw)m=E,f=S;else if(typeof le=="string"&&le)try{const P=await ht(le,t,i?i.signal:void 0);if(P&&P.raw)m=P,f=le;else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{m=null,f=null,w=new Error("slug mismatch for candidate");continue}else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{try{const P=await ht(le,t,i?i.signal:void 0);if(P&&P.raw)m=P,f=le;else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{}try{if(!d&&/\.html$/i.test(_)){const b=_.replace(/\.html$/i,".md");if(h.includes(b))try{const S=String(m&&m.raw||"").trim().slice(0,128).toLowerCase();if(m&&m.isHtml||/^(?:<!doctype|<html|<title|<h1)/i.test(S)||S.indexOf('<div id="app"')!==-1||S.indexOf("nimbi-")!==-1||S.indexOf("nimbi")!==-1||S.indexOf("initcms(")!==-1){let P=!1;try{const I=await ht(b,t,i?i.signal:void 0);if(I&&I.raw)m=I,f=b,P=!0;else if(typeof le=="string"&&le)try{const U=await ht(le,t,i?i.signal:void 0);U&&U.raw&&(m=U,f=le,P=!0)}catch{}}catch{try{const U=await ht(le,t,i?i.signal:void 0);U&&U.raw&&(m=U,f=le,P=!0)}catch{}}if(!P){m=null,f=null,w=new Error("site shell detected (candidate HTML rejected)");continue}}}catch{}}}catch{}try{if(ut())try{Bt("[router-debug] fetchPageData accepted candidate",{candidate:_,pagePath:f,isHtml:m&&m.isHtml,snippet:m&&m.raw?String(m.raw).slice(0,160):null})}catch{}}catch{}break}catch(_){w=_;try{ut()&&k("[router] candidate fetch failed",{candidate:y,contentBase:t,err:_&&_.message||_})}catch{}}if(!m){const y=w&&(w.message||String(w))||null,_=y&&/failed to fetch md|site shell detected/i.test(y);try{if(ut())try{Bt("[router-debug] fetchPageData no data",{originalRaw:n,resolved:a,pageCandidates:h,fetchError:y})}catch{}}catch{}if(_)try{if(ut())try{k("[router] fetchPageData: no page data (expected)",{originalRaw:n,resolved:a,pageCandidates:h,contentBase:t,fetchError:y})}catch{}}catch{}else try{if(ut())try{nr("[router] fetchPageData: no page data for",{originalRaw:n,resolved:a,pageCandidates:h,contentBase:t,fetchError:y})}catch{}}catch{}if(typeof le=="string"&&le)try{const b=await ht(le,t,i?i.signal:void 0);if(b&&b.raw){try{Yn(b.meta||{},le)}catch{}return{data:b,pagePath:le,anchor:s}}}catch{}try{if(d&&String(n||"").toLowerCase().includes(".html"))try{const b=new URL(String(n||""),location.href).toString();ut()&&k("[router] attempting absolute HTML fetch fallback",b);const v=await fetch(b,i?{signal:i.signal}:void 0);if(v&&v.ok){const S=await v.text(),E=v&&v.headers&&typeof v.headers.get=="function"&&v.headers.get("content-type")||"",P=(S||"").toLowerCase(),I=E&&E.indexOf&&E.indexOf("text/html")!==-1||P.indexOf("<!doctype")!==-1||P.indexOf("<html")!==-1;if(!I&&ut())try{k("[router] absolute fetch returned non-HTML",()=>({abs:b,contentType:E,snippet:P.slice(0,200)}))}catch{}if(I){const U=(S||"").toLowerCase();if(/<title>\s*index of\b/i.test(S)||/<h1>\s*index of\b/i.test(S)||U.indexOf("parent directory")!==-1||/<title>\s*directory listing/i.test(S)||/<h1>\s*directory listing/i.test(S))try{ut()&&k("[router] absolute fetch returned directory listing; treating as not found",{abs:b})}catch{}else try{const O=b,W=new URL(".",O).toString();try{const H=He();if(H){const M=H.parseFromString(S||"","text/html"),F=(J,ze)=>{try{const xe=ze.getAttribute(J)||"";if(!xe||/^(https?:)?\/\//i.test(xe)||xe.startsWith("/")||xe.startsWith("#"))return;try{const Se=new URL(xe,O).toString();ze.setAttribute(J,Se)}catch(Se){k("[router] rewrite attribute failed",J,Se)}}catch(xe){k("[router] rewrite helper failed",xe)}},G=M.querySelectorAll("[src],[href],[srcset],[xlink:href],[poster]"),ie=[];for(const J of Array.from(G||[]))try{const ze=J.tagName?J.tagName.toLowerCase():"";if(ze==="a")continue;if(J.hasAttribute("src")){const xe=J.getAttribute("src");F("src",J);const Se=J.getAttribute("src");xe!==Se&&ie.push({attr:"src",tag:ze,before:xe,after:Se})}if(J.hasAttribute("href")&&ze==="link"){const xe=J.getAttribute("href");F("href",J);const Se=J.getAttribute("href");xe!==Se&&ie.push({attr:"href",tag:ze,before:xe,after:Se})}if(J.hasAttribute("href")&&ze!=="link"){const xe=J.getAttribute("href");F("href",J);const Se=J.getAttribute("href");xe!==Se&&ie.push({attr:"href",tag:ze,before:xe,after:Se})}if(J.hasAttribute("xlink:href")){const xe=J.getAttribute("xlink:href");F("xlink:href",J);const Se=J.getAttribute("xlink:href");xe!==Se&&ie.push({attr:"xlink:href",tag:ze,before:xe,after:Se})}if(J.hasAttribute("poster")){const xe=J.getAttribute("poster");F("poster",J);const Se=J.getAttribute("poster");xe!==Se&&ie.push({attr:"poster",tag:ze,before:xe,after:Se})}if(J.hasAttribute("srcset")){const Me=(J.getAttribute("srcset")||"").split(",").map(Fe=>Fe.trim()).filter(Boolean).map(Fe=>{const[R,N]=Fe.split(/\s+/,2);if(!R||/^(https?:)?\/\//i.test(R)||R.startsWith("/"))return Fe;try{const C=new URL(R,O).toString();return N?`${C} ${N}`:C}catch{return Fe}}).join(", ");J.setAttribute("srcset",Me)}}catch{}const ye=M.documentElement&&M.documentElement.outerHTML?M.documentElement.outerHTML:S;try{ut()&&ie&&ie.length&&k("[router] rewritten asset refs",{abs:b,rewritten:ie})}catch{}return{data:{raw:ye,isHtml:!0},pagePath:String(n||""),anchor:s}}}catch{}let te=S;return/<base\s+[^>]*>/i.test(S)||(/<head[^>]*>/i.test(S)?te=S.replace(/(<head[^>]*>)/i,`$1<base href="${W}">`):te=`<base href="${W}">`+S),{data:{raw:te,isHtml:!0},pagePath:String(n||""),anchor:s}}catch{return{data:{raw:S,isHtml:!0},pagePath:String(n||""),anchor:s}}}}}catch(b){ut()&&k("[router] absolute HTML fetch fallback failed",b)}}catch{}try{const b=decodeURIComponent(String(a||""));if(b&&!/\.(md|html?)$/i.test(b)&&typeof le=="string"&&le&&ut()){const S=[`/assets/${b}.html`,`/assets/${b}/index.html`];for(const E of S)try{const P=await fetch(E,Object.assign({method:"GET"},i?{signal:i.signal}:{}));if(P&&P.ok)return{data:{raw:await P.text(),isHtml:!0},pagePath:E.replace(/^\//,""),anchor:s}}catch{}}}catch(b){ut()&&k("[router] assets fallback failed",b)}throw new Error("no page data")}return{data:m,pagePath:f,anchor:s}}function pr(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Ht=pr();function Na(e){Ht=e}var Ut={exec:()=>null};function Te(e,t=""){let n=typeof e=="string"?e:e.source,i={replace:(r,a)=>{let s=typeof a=="string"?a:a.source;return s=s.replace(ot.caret,"$1"),n=n.replace(r,s),i},getRegex:()=>new RegExp(n,t)};return i}var Xo=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),ot={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}>`)},Qo=/^(?:[ \t]*(?:\n|$))+/,Ko=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Vo=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,On=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Yo=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,ui=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,Oa=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Ba=Te(Oa).replace(/bull/g,ui).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Jo=Te(Oa).replace(/bull/g,ui).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),hi=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,el=/^[^\n]+/,di=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,tl=Te(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",di).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),nl=Te(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,ui).getRegex(),mr="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",fi=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,rl=Te("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",fi).replace("tag",mr).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),ja=Te(hi).replace("hr",On).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",mr).getRegex(),il=Te(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",ja).getRegex(),gi={blockquote:il,code:Ko,def:tl,fences:Vo,heading:Yo,hr:On,html:rl,lheading:Ba,list:nl,newline:Qo,paragraph:ja,table:Ut,text:el},Xi=Te("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",On).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",mr).getRegex(),al={...gi,lheading:Jo,table:Xi,paragraph:Te(hi).replace("hr",On).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Xi).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",mr).getRegex()},sl={...gi,html:Te(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",fi).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ut,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:Te(hi).replace("hr",On).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Ba).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},ol=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,ll=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,qa=/^( {2,}|\\)\n(?!\s*$)/,cl=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,yr=/[\p{P}\p{S}]/u,pi=/[\s\p{P}\p{S}]/u,Ha=/[^\s\p{P}\p{S}]/u,ul=Te(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,pi).getRegex(),Fa=/(?!~)[\p{P}\p{S}]/u,hl=/(?!~)[\s\p{P}\p{S}]/u,dl=/(?:[^\s\p{P}\p{S}]|~)/u,Da=/(?![*_])[\p{P}\p{S}]/u,fl=/(?![*_])[\s\p{P}\p{S}]/u,gl=/(?:[^\s\p{P}\p{S}]|[*_])/u,pl=Te(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Xo?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Ua=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,ml=Te(Ua,"u").replace(/punct/g,yr).getRegex(),yl=Te(Ua,"u").replace(/punct/g,Fa).getRegex(),Wa="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",bl=Te(Wa,"gu").replace(/notPunctSpace/g,Ha).replace(/punctSpace/g,pi).replace(/punct/g,yr).getRegex(),wl=Te(Wa,"gu").replace(/notPunctSpace/g,dl).replace(/punctSpace/g,hl).replace(/punct/g,Fa).getRegex(),_l=Te("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Ha).replace(/punctSpace/g,pi).replace(/punct/g,yr).getRegex(),kl=Te(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,Da).getRegex(),xl="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",Sl=Te(xl,"gu").replace(/notPunctSpace/g,gl).replace(/punctSpace/g,fl).replace(/punct/g,Da).getRegex(),vl=Te(/\\(punct)/,"gu").replace(/punct/g,yr).getRegex(),Al=Te(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),El=Te(fi).replace("(?:-->|$)","-->").getRegex(),Cl=Te("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",El).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),sr=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Ml=Te(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",sr).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Za=Te(/^!?\[(label)\]\[(ref)\]/).replace("label",sr).replace("ref",di).getRegex(),Ga=Te(/^!?\[(ref)\](?:\[\])?/).replace("ref",di).getRegex(),Ll=Te("reflink|nolink(?!\\()","g").replace("reflink",Za).replace("nolink",Ga).getRegex(),Qi=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,mi={_backpedal:Ut,anyPunctuation:vl,autolink:Al,blockSkip:pl,br:qa,code:ll,del:Ut,delLDelim:Ut,delRDelim:Ut,emStrongLDelim:ml,emStrongRDelimAst:bl,emStrongRDelimUnd:_l,escape:ol,link:Ml,nolink:Ga,punctuation:ul,reflink:Za,reflinkSearch:Ll,tag:Cl,text:cl,url:Ut},Tl={...mi,link:Te(/^!?\[(label)\]\((.*?)\)/).replace("label",sr).getRegex(),reflink:Te(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",sr).getRegex()},Hr={...mi,emStrongRDelimAst:wl,emStrongLDelim:yl,delLDelim:kl,delRDelim:Sl,url:Te(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Qi).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:Te(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Qi).getRegex()},zl={...Hr,br:Te(qa).replace("{2,}","*").getRegex(),text:Te(Hr.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Zn={normal:gi,gfm:al,pedantic:sl},mn={normal:mi,gfm:Hr,breaks:zl,pedantic:Tl},Rl={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ki=e=>Rl[e];function xt(e,t){if(t){if(ot.escapeTest.test(e))return e.replace(ot.escapeReplace,Ki)}else if(ot.escapeTestNoEncode.test(e))return e.replace(ot.escapeReplaceNoEncode,Ki);return e}function Vi(e){try{e=encodeURI(e).replace(ot.percentDecode,"%")}catch{return null}return e}function Yi(e,t){let n=e.replace(ot.findPipe,(a,s,o)=>{let l=!1,c=s;for(;--c>=0&&o[c]==="\\";)l=!l;return l?"|":" |"}),i=n.split(ot.splitPipe),r=0;if(i[0].trim()||i.shift(),i.length>0&&!i.at(-1)?.trim()&&i.pop(),t)if(i.length>t)i.splice(t);else for(;i.length<t;)i.push("");for(;r<i.length;r++)i[r]=i[r].trim().replace(ot.slashPipe,"|");return i}function yn(e,t,n){let i=e.length;if(i===0)return"";let r=0;for(;r<i&&e.charAt(i-r-1)===t;)r++;return e.slice(0,i-r)}function $l(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let i=0;i<e.length;i++)if(e[i]==="\\")i++;else if(e[i]===t[0])n++;else if(e[i]===t[1]&&(n--,n<0))return i;return n>0?-2:-1}function Pl(e,t=0){let n=t,i="";for(let r of e)if(r==="	"){let a=4-n%4;i+=" ".repeat(a),n+=a}else i+=r,n++;return i}function Ji(e,t,n,i,r){let a=t.href,s=t.title||null,o=e[1].replace(r.other.outputLinkReplace,"$1");i.state.inLink=!0;let l={type:e[0].charAt(0)==="!"?"image":"link",raw:n,href:a,title:s,text:o,tokens:i.inlineTokens(o)};return i.state.inLink=!1,l}function Il(e,t,n){let i=e.match(n.other.indentCodeCompensation);if(i===null)return t;let r=i[1];return t.split(`
...
`,n}function Vr(e){const t=e&&Array.isArray(e.entries)?e.entries:Array.isArray(e)?e:[],n=xi().split("?")[0];let i=`<?xml version="1.0" encoding="UTF-8"?>
`;i+=`<rss version="2.0">
`,i+=`<channel>
...
`,i+=`</rss>
`,i}function Yr(e){const t=e&&Array.isArray(e.entries)?e.entries:Array.isArray(e)?e:[],n=xi().split("?")[0],i=e&&e.generatedAt?new Date(e.generatedAt).toISOString():new Date().toISOString();let r=`<?xml version="1.0" encoding="utf-8"?>
