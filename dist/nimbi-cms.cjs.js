"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const It={onPageLoad:[],onNavBuild:[],transformHtml:[]};function dn(e,t){if(!Object.prototype.hasOwnProperty.call(It,e))throw new Error('Unknown hook "'+e+'"');if(typeof t!="function")throw new TypeError("hook callback must be a function");It[e].push(t)}function hs(e){dn("onPageLoad",e)}function ds(e){dn("onNavBuild",e)}function fs(e){dn("transformHtml",e)}async function zn(e,t){const n=It[e]||[];for(const s of n)try{await s(t)}catch(r){console.warn("[nimbi-cms] runHooks callback failed",r)}}function ps(){Object.keys(It).forEach(e=>{It[e].length=0})}function Wr(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ln,kr;function gs(){if(kr)return Ln;kr=1;function e(w){return w instanceof Map?w.clear=w.delete=w.set=function(){throw new Error("map is read-only")}:w instanceof Set&&(w.add=w.clear=w.delete=function(){throw new Error("set is read-only")}),Object.freeze(w),Object.getOwnPropertyNames(w).forEach(x=>{const C=w[x],Y=typeof C;(Y==="object"||Y==="function")&&!Object.isFrozen(C)&&e(C)}),w}class t{constructor(x){x.data===void 0&&(x.data={}),this.data=x.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function n(w){return w.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function s(w,...x){const C=Object.create(null);for(const Y in w)C[Y]=w[Y];return x.forEach(function(Y){for(const xe in Y)C[xe]=Y[xe]}),C}const r="</span>",i=w=>!!w.scope,a=(w,{prefix:x})=>{if(w.startsWith("language:"))return w.replace("language:","language-");if(w.includes(".")){const C=w.split(".");return[`${x}${C.shift()}`,...C.map((Y,xe)=>`${Y}${"_".repeat(xe+1)}`)].join(" ")}return`${x}${w}`};class c{constructor(x,C){this.buffer="",this.classPrefix=C.classPrefix,x.walk(this)}addText(x){this.buffer+=n(x)}openNode(x){if(!i(x))return;const C=a(x.scope,{prefix:this.classPrefix});this.span(C)}closeNode(x){i(x)&&(this.buffer+=r)}value(){return this.buffer}span(x){this.buffer+=`<span class="${x}">`}}const o=(w={})=>{const x={children:[]};return Object.assign(x,w),x};class l{constructor(){this.rootNode=o(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(x){this.top.children.push(x)}openNode(x){const C=o({scope:x});this.add(C),this.stack.push(C)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(x){return this.constructor._walk(x,this.rootNode)}static _walk(x,C){return typeof C=="string"?x.addText(C):C.children&&(x.openNode(C),C.children.forEach(Y=>this._walk(x,Y)),x.closeNode(C)),x}static _collapse(x){typeof x!="string"&&x.children&&(x.children.every(C=>typeof C=="string")?x.children=[x.children.join("")]:x.children.forEach(C=>{l._collapse(C)}))}}class u extends l{constructor(x){super(),this.options=x}addText(x){x!==""&&this.add(x)}startScope(x){this.openNode(x)}endScope(){this.closeNode()}__addSublanguage(x,C){const Y=x.root;C&&(Y.scope=`language:${C}`),this.add(Y)}toHTML(){return new c(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function f(w){return w?typeof w=="string"?w:w.source:null}function g(w){return p("(?=",w,")")}function d(w){return p("(?:",w,")*")}function h(w){return p("(?:",w,")?")}function p(...w){return w.map(C=>f(C)).join("")}function m(w){const x=w[w.length-1];return typeof x=="object"&&x.constructor===Object?(w.splice(w.length-1,1),x):{}}function b(...w){return"("+(m(w).capture?"":"?:")+w.map(Y=>f(Y)).join("|")+")"}function y(w){return new RegExp(w.toString()+"|").exec("").length-1}function S(w,x){const C=w&&w.exec(x);return C&&C.index===0}const E=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function M(w,{joinWith:x}){let C=0;return w.map(Y=>{C+=1;const xe=C;let Se=f(Y),D="";for(;Se.length>0;){const N=E.exec(Se);if(!N){D+=Se;break}D+=Se.substring(0,N.index),Se=Se.substring(N.index+N[0].length),N[0][0]==="\\"&&N[1]?D+="\\"+String(Number(N[1])+xe):(D+=N[0],N[0]==="("&&C++)}return D}).map(Y=>`(${Y})`).join(x)}const B=/\b\B/,j="[a-zA-Z]\\w*",R="[a-zA-Z_]\\w*",Q="\\b\\d+(\\.\\d+)?",le="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",A="\\b(0b[01]+)",U="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",X=(w={})=>{const x=/^#![ ]*\//;return w.binary&&(w.begin=p(x,/.*\b/,w.binary,/\b.*/)),s({scope:"meta",begin:x,end:/$/,relevance:0,"on:begin":(C,Y)=>{C.index!==0&&Y.ignoreMatch()}},w)},q={begin:"\\\\[\\s\\S]",relevance:0},G={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[q]},v={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[q]},ue={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},ee=function(w,x,C={}){const Y=s({scope:"comment",begin:w,end:x,contains:[]},C);Y.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const xe=b("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return Y.contains.push({begin:p(/[ ]+/,"(",xe,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),Y},ce=ee("//","$"),L=ee("/\\*","\\*/"),T=ee("#","$"),$={scope:"number",begin:Q,relevance:0},I={scope:"number",begin:le,relevance:0},k={scope:"number",begin:A,relevance:0},P={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[q,{begin:/\[/,end:/\]/,relevance:0,contains:[q]}]},O={scope:"title",begin:j,relevance:0},ie={scope:"title",begin:R,relevance:0},de={begin:"\\.\\s*"+R,relevance:0};var ke=Object.freeze({__proto__:null,APOS_STRING_MODE:G,BACKSLASH_ESCAPE:q,BINARY_NUMBER_MODE:k,BINARY_NUMBER_RE:A,COMMENT:ee,C_BLOCK_COMMENT_MODE:L,C_LINE_COMMENT_MODE:ce,C_NUMBER_MODE:I,C_NUMBER_RE:le,END_SAME_AS_BEGIN:function(w){return Object.assign(w,{"on:begin":(x,C)=>{C.data._beginMatch=x[1]},"on:end":(x,C)=>{C.data._beginMatch!==x[1]&&C.ignoreMatch()}})},HASH_COMMENT_MODE:T,IDENT_RE:j,MATCH_NOTHING_RE:B,METHOD_GUARD:de,NUMBER_MODE:$,NUMBER_RE:Q,PHRASAL_WORDS_MODE:ue,QUOTE_STRING_MODE:v,REGEXP_MODE:P,RE_STARTERS_RE:U,SHEBANG:X,TITLE_MODE:O,UNDERSCORE_IDENT_RE:R,UNDERSCORE_TITLE_MODE:ie});function ge(w,x){w.input[w.index-1]==="."&&x.ignoreMatch()}function Ne(w,x){w.className!==void 0&&(w.scope=w.className,delete w.className)}function ct(w,x){x&&w.beginKeywords&&(w.begin="\\b("+w.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",w.__beforeBegin=ge,w.keywords=w.keywords||w.beginKeywords,delete w.beginKeywords,w.relevance===void 0&&(w.relevance=0))}function ut(w,x){Array.isArray(w.illegal)&&(w.illegal=b(...w.illegal))}function bn(w,x){if(w.match){if(w.begin||w.end)throw new Error("begin & end are not supported with match");w.begin=w.match,delete w.match}}function $i(w,x){w.relevance===void 0&&(w.relevance=1)}const Pi=(w,x)=>{if(!w.beforeMatch)return;if(w.starts)throw new Error("beforeMatch cannot be used with starts");const C=Object.assign({},w);Object.keys(w).forEach(Y=>{delete w[Y]}),w.keywords=C.keywords,w.begin=p(C.beforeMatch,g(C.begin)),w.starts={relevance:0,contains:[Object.assign(C,{endsParent:!0})]},w.relevance=0,delete C.beforeMatch},zi=["of","and","for","in","not","or","if","then","parent","list","value"],Ii="keyword";function ir(w,x,C=Ii){const Y=Object.create(null);return typeof w=="string"?xe(C,w.split(" ")):Array.isArray(w)?xe(C,w):Object.keys(w).forEach(function(Se){Object.assign(Y,ir(w[Se],x,Se))}),Y;function xe(Se,D){x&&(D=D.map(N=>N.toLowerCase())),D.forEach(function(N){const K=N.split("|");Y[K[0]]=[Se,Bi(K[0],K[1])]})}}function Bi(w,x){return x?Number(x):Ni(w)?0:1}function Ni(w){return zi.includes(w.toLowerCase())}const sr={},rt=w=>{console.error(w)},ar=(w,...x)=>{console.log(`WARN: ${w}`,...x)},ht=(w,x)=>{sr[`${w}/${x}`]||(console.log(`Deprecated as of ${w}. ${x}`),sr[`${w}/${x}`]=!0)},Ft=new Error;function or(w,x,{key:C}){let Y=0;const xe=w[C],Se={},D={};for(let N=1;N<=x.length;N++)D[N+Y]=xe[N],Se[N+Y]=!0,Y+=y(x[N-1]);w[C]=D,w[C]._emit=Se,w[C]._multi=!0}function Oi(w){if(Array.isArray(w.begin)){if(w.skip||w.excludeBegin||w.returnBegin)throw rt("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Ft;if(typeof w.beginScope!="object"||w.beginScope===null)throw rt("beginScope must be object"),Ft;or(w,w.begin,{key:"beginScope"}),w.begin=M(w.begin,{joinWith:""})}}function Di(w){if(Array.isArray(w.end)){if(w.skip||w.excludeEnd||w.returnEnd)throw rt("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Ft;if(typeof w.endScope!="object"||w.endScope===null)throw rt("endScope must be object"),Ft;or(w,w.end,{key:"endScope"}),w.end=M(w.end,{joinWith:""})}}function Hi(w){w.scope&&typeof w.scope=="object"&&w.scope!==null&&(w.beginScope=w.scope,delete w.scope)}function qi(w){Hi(w),typeof w.beginScope=="string"&&(w.beginScope={_wrap:w.beginScope}),typeof w.endScope=="string"&&(w.endScope={_wrap:w.endScope}),Oi(w),Di(w)}function ji(w){function x(D,N){return new RegExp(f(D),"m"+(w.case_insensitive?"i":"")+(w.unicodeRegex?"u":"")+(N?"g":""))}class C{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(N,K){K.position=this.position++,this.matchIndexes[this.matchAt]=K,this.regexes.push([K,N]),this.matchAt+=y(N)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const N=this.regexes.map(K=>K[1]);this.matcherRe=x(M(N,{joinWith:"|"}),!0),this.lastIndex=0}exec(N){this.matcherRe.lastIndex=this.lastIndex;const K=this.matcherRe.exec(N);if(!K)return null;const Le=K.findIndex((kt,kn)=>kn>0&&kt!==void 0),ve=this.matchIndexes[Le];return K.splice(0,Le),Object.assign(K,ve)}}class Y{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(N){if(this.multiRegexes[N])return this.multiRegexes[N];const K=new C;return this.rules.slice(N).forEach(([Le,ve])=>K.addRule(Le,ve)),K.compile(),this.multiRegexes[N]=K,K}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(N,K){this.rules.push([N,K]),K.type==="begin"&&this.count++}exec(N){const K=this.getMatcher(this.regexIndex);K.lastIndex=this.lastIndex;let Le=K.exec(N);if(this.resumingScanAtSamePosition()&&!(Le&&Le.index===this.lastIndex)){const ve=this.getMatcher(0);ve.lastIndex=this.lastIndex+1,Le=ve.exec(N)}return Le&&(this.regexIndex+=Le.position+1,this.regexIndex===this.count&&this.considerAll()),Le}}function xe(D){const N=new Y;return D.contains.forEach(K=>N.addRule(K.begin,{rule:K,type:"begin"})),D.terminatorEnd&&N.addRule(D.terminatorEnd,{type:"end"}),D.illegal&&N.addRule(D.illegal,{type:"illegal"}),N}function Se(D,N){const K=D;if(D.isCompiled)return K;[Ne,bn,qi,Pi].forEach(ve=>ve(D,N)),w.compilerExtensions.forEach(ve=>ve(D,N)),D.__beforeBegin=null,[ct,ut,$i].forEach(ve=>ve(D,N)),D.isCompiled=!0;let Le=null;return typeof D.keywords=="object"&&D.keywords.$pattern&&(D.keywords=Object.assign({},D.keywords),Le=D.keywords.$pattern,delete D.keywords.$pattern),Le=Le||/\w+/,D.keywords&&(D.keywords=ir(D.keywords,w.case_insensitive)),K.keywordPatternRe=x(Le,!0),N&&(D.begin||(D.begin=/\B|\b/),K.beginRe=x(K.begin),!D.end&&!D.endsWithParent&&(D.end=/\B|\b/),D.end&&(K.endRe=x(K.end)),K.terminatorEnd=f(K.end)||"",D.endsWithParent&&N.terminatorEnd&&(K.terminatorEnd+=(D.end?"|":"")+N.terminatorEnd)),D.illegal&&(K.illegalRe=x(D.illegal)),D.contains||(D.contains=[]),D.contains=[].concat(...D.contains.map(function(ve){return Ui(ve==="self"?D:ve)})),D.contains.forEach(function(ve){Se(ve,K)}),D.starts&&Se(D.starts,N),K.matcher=xe(K),K}if(w.compilerExtensions||(w.compilerExtensions=[]),w.contains&&w.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return w.classNameAliases=s(w.classNameAliases||{}),Se(w)}function lr(w){return w?w.endsWithParent||lr(w.starts):!1}function Ui(w){return w.variants&&!w.cachedVariants&&(w.cachedVariants=w.variants.map(function(x){return s(w,{variants:null},x)})),w.cachedVariants?w.cachedVariants:lr(w)?s(w,{starts:w.starts?s(w.starts):null}):Object.isFrozen(w)?s(w):w}var Wi="11.11.1";class Fi extends Error{constructor(x,C){super(x),this.name="HTMLInjectionError",this.html=C}}const yn=n,cr=s,ur=Symbol("nomatch"),Zi=7,hr=function(w){const x=Object.create(null),C=Object.create(null),Y=[];let xe=!0;const Se="Could not find the language '{}', did you forget to load/include a language module?",D={disableAutodetect:!0,name:"Plain text",contains:[]};let N={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:u};function K(_){return N.noHighlightRe.test(_)}function Le(_){let W=_.className+" ";W+=_.parentNode?_.parentNode.className:"";const se=N.languageDetectRe.exec(W);if(se){const me=Ke(se[1]);return me||(ar(Se.replace("{}",se[1])),ar("Falling back to no-highlight mode for this block.",_)),me?se[1]:"no-highlight"}return W.split(/\s+/).find(me=>K(me)||Ke(me))}function ve(_,W,se){let me="",Ee="";typeof W=="object"?(me=_,se=W.ignoreIllegals,Ee=W.language):(ht("10.7.0","highlight(lang, code, ...args) has been deprecated."),ht("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),Ee=_,me=W),se===void 0&&(se=!0);const qe={code:me,language:Ee};Gt("before:highlight",qe);const Ye=qe.result?qe.result:kt(qe.language,qe.code,se);return Ye.code=qe.code,Gt("after:highlight",Ye),Ye}function kt(_,W,se,me){const Ee=Object.create(null);function qe(z,H){return z.keywords[H]}function Ye(){if(!V.keywords){_e.addText(we);return}let z=0;V.keywordPatternRe.lastIndex=0;let H=V.keywordPatternRe.exec(we),te="";for(;H;){te+=we.substring(z,H.index);const fe=Ue.case_insensitive?H[0].toLowerCase():H[0],Me=qe(V,fe);if(Me){const[Ge,cs]=Me;if(_e.addText(te),te="",Ee[fe]=(Ee[fe]||0)+1,Ee[fe]<=Zi&&(Kt+=cs),Ge.startsWith("_"))te+=H[0];else{const us=Ue.classNameAliases[Ge]||Ge;je(H[0],us)}}else te+=H[0];z=V.keywordPatternRe.lastIndex,H=V.keywordPatternRe.exec(we)}te+=we.substring(z),_e.addText(te)}function Qt(){if(we==="")return;let z=null;if(typeof V.subLanguage=="string"){if(!x[V.subLanguage]){_e.addText(we);return}z=kt(V.subLanguage,we,!0,yr[V.subLanguage]),yr[V.subLanguage]=z._top}else z=xn(we,V.subLanguage.length?V.subLanguage:null);V.relevance>0&&(Kt+=z.relevance),_e.__addSublanguage(z._emitter,z.language)}function ze(){V.subLanguage!=null?Qt():Ye(),we=""}function je(z,H){z!==""&&(_e.startScope(H),_e.addText(z),_e.endScope())}function gr(z,H){let te=1;const fe=H.length-1;for(;te<=fe;){if(!z._emit[te]){te++;continue}const Me=Ue.classNameAliases[z[te]]||z[te],Ge=H[te];Me?je(Ge,Me):(we=Ge,Ye(),we=""),te++}}function mr(z,H){return z.scope&&typeof z.scope=="string"&&_e.openNode(Ue.classNameAliases[z.scope]||z.scope),z.beginScope&&(z.beginScope._wrap?(je(we,Ue.classNameAliases[z.beginScope._wrap]||z.beginScope._wrap),we=""):z.beginScope._multi&&(gr(z.beginScope,H),we="")),V=Object.create(z,{parent:{value:V}}),V}function wr(z,H,te){let fe=S(z.endRe,te);if(fe){if(z["on:end"]){const Me=new t(z);z["on:end"](H,Me),Me.isMatchIgnored&&(fe=!1)}if(fe){for(;z.endsParent&&z.parent;)z=z.parent;return z}}if(z.endsWithParent)return wr(z.parent,H,te)}function is(z){return V.matcher.regexIndex===0?(we+=z[0],1):(An=!0,0)}function ss(z){const H=z[0],te=z.rule,fe=new t(te),Me=[te.__beforeBegin,te["on:begin"]];for(const Ge of Me)if(Ge&&(Ge(z,fe),fe.isMatchIgnored))return is(H);return te.skip?we+=H:(te.excludeBegin&&(we+=H),ze(),!te.returnBegin&&!te.excludeBegin&&(we=H)),mr(te,z),te.returnBegin?0:H.length}function as(z){const H=z[0],te=W.substring(z.index),fe=wr(V,z,te);if(!fe)return ur;const Me=V;V.endScope&&V.endScope._wrap?(ze(),je(H,V.endScope._wrap)):V.endScope&&V.endScope._multi?(ze(),gr(V.endScope,z)):Me.skip?we+=H:(Me.returnEnd||Me.excludeEnd||(we+=H),ze(),Me.excludeEnd&&(we=H));do V.scope&&_e.closeNode(),!V.skip&&!V.subLanguage&&(Kt+=V.relevance),V=V.parent;while(V!==fe.parent);return fe.starts&&mr(fe.starts,z),Me.returnEnd?0:H.length}function os(){const z=[];for(let H=V;H!==Ue;H=H.parent)H.scope&&z.unshift(H.scope);z.forEach(H=>_e.openNode(H))}let Xt={};function br(z,H){const te=H&&H[0];if(we+=z,te==null)return ze(),0;if(Xt.type==="begin"&&H.type==="end"&&Xt.index===H.index&&te===""){if(we+=W.slice(H.index,H.index+1),!xe){const fe=new Error(`0 width match regex (${_})`);throw fe.languageName=_,fe.badRule=Xt.rule,fe}return 1}if(Xt=H,H.type==="begin")return ss(H);if(H.type==="illegal"&&!se){const fe=new Error('Illegal lexeme "'+te+'" for mode "'+(V.scope||"<unnamed>")+'"');throw fe.mode=V,fe}else if(H.type==="end"){const fe=as(H);if(fe!==ur)return fe}if(H.type==="illegal"&&te==="")return we+=`
`,1;if(En>1e5&&En>H.index*3)throw new Error("potential infinite loop, way more iterations than matches");return we+=te,te.length}const Ue=Ke(_);if(!Ue)throw rt(Se.replace("{}",_)),new Error('Unknown language: "'+_+'"');const ls=ji(Ue);let vn="",V=me||ls;const yr={},_e=new N.__emitter(N);os();let we="",Kt=0,it=0,En=0,An=!1;try{if(Ue.__emitTokens)Ue.__emitTokens(W,_e);else{for(V.matcher.considerAll();;){En++,An?An=!1:V.matcher.considerAll(),V.matcher.lastIndex=it;const z=V.matcher.exec(W);if(!z)break;const H=W.substring(it,z.index),te=br(H,z);it=z.index+te}br(W.substring(it))}return _e.finalize(),vn=_e.toHTML(),{language:_,value:vn,relevance:Kt,illegal:!1,_emitter:_e,_top:V}}catch(z){if(z.message&&z.message.includes("Illegal"))return{language:_,value:yn(W),illegal:!0,relevance:0,_illegalBy:{message:z.message,index:it,context:W.slice(it-100,it+100),mode:z.mode,resultSoFar:vn},_emitter:_e};if(xe)return{language:_,value:yn(W),illegal:!1,relevance:0,errorRaised:z,_emitter:_e,_top:V};throw z}}function kn(_){const W={value:yn(_),illegal:!1,relevance:0,_top:D,_emitter:new N.__emitter(N)};return W._emitter.addText(_),W}function xn(_,W){W=W||N.languages||Object.keys(x);const se=kn(_),me=W.filter(Ke).filter(pr).map(ze=>kt(ze,_,!1));me.unshift(se);const Ee=me.sort((ze,je)=>{if(ze.relevance!==je.relevance)return je.relevance-ze.relevance;if(ze.language&&je.language){if(Ke(ze.language).supersetOf===je.language)return 1;if(Ke(je.language).supersetOf===ze.language)return-1}return 0}),[qe,Ye]=Ee,Qt=qe;return Qt.secondBest=Ye,Qt}function Gi(_,W,se){const me=W&&C[W]||se;_.classList.add("hljs"),_.classList.add(`language-${me}`)}function Sn(_){let W=null;const se=Le(_);if(K(se))return;if(Gt("before:highlightElement",{el:_,language:se}),_.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",_);return}if(_.children.length>0&&(N.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(_)),N.throwUnescapedHTML))throw new Fi("One of your code blocks includes unescaped HTML.",_.innerHTML);W=_;const me=W.textContent,Ee=se?ve(me,{language:se,ignoreIllegals:!0}):xn(me);_.innerHTML=Ee.value,_.dataset.highlighted="yes",Gi(_,se,Ee.language),_.result={language:Ee.language,re:Ee.relevance,relevance:Ee.relevance},Ee.secondBest&&(_.secondBest={language:Ee.secondBest.language,relevance:Ee.secondBest.relevance}),Gt("after:highlightElement",{el:_,result:Ee,text:me})}function Qi(_){N=cr(N,_)}const Xi=()=>{Zt(),ht("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function Ki(){Zt(),ht("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let dr=!1;function Zt(){function _(){Zt()}if(document.readyState==="loading"){dr||window.addEventListener("DOMContentLoaded",_,!1),dr=!0;return}document.querySelectorAll(N.cssSelector).forEach(Sn)}function Yi(_,W){let se=null;try{se=W(w)}catch(me){if(rt("Language definition for '{}' could not be registered.".replace("{}",_)),xe)rt(me);else throw me;se=D}se.name||(se.name=_),x[_]=se,se.rawDefinition=W.bind(null,w),se.aliases&&fr(se.aliases,{languageName:_})}function Vi(_){delete x[_];for(const W of Object.keys(C))C[W]===_&&delete C[W]}function Ji(){return Object.keys(x)}function Ke(_){return _=(_||"").toLowerCase(),x[_]||x[C[_]]}function fr(_,{languageName:W}){typeof _=="string"&&(_=[_]),_.forEach(se=>{C[se.toLowerCase()]=W})}function pr(_){const W=Ke(_);return W&&!W.disableAutodetect}function es(_){_["before:highlightBlock"]&&!_["before:highlightElement"]&&(_["before:highlightElement"]=W=>{_["before:highlightBlock"](Object.assign({block:W.el},W))}),_["after:highlightBlock"]&&!_["after:highlightElement"]&&(_["after:highlightElement"]=W=>{_["after:highlightBlock"](Object.assign({block:W.el},W))})}function ts(_){es(_),Y.push(_)}function ns(_){const W=Y.indexOf(_);W!==-1&&Y.splice(W,1)}function Gt(_,W){const se=_;Y.forEach(function(me){me[se]&&me[se](W)})}function rs(_){return ht("10.7.0","highlightBlock will be removed entirely in v12.0"),ht("10.7.0","Please use highlightElement now."),Sn(_)}Object.assign(w,{highlight:ve,highlightAuto:xn,highlightAll:Zt,highlightElement:Sn,highlightBlock:rs,configure:Qi,initHighlighting:Xi,initHighlightingOnLoad:Ki,registerLanguage:Yi,unregisterLanguage:Vi,listLanguages:Ji,getLanguage:Ke,registerAliases:fr,autoDetection:pr,inherit:cr,addPlugin:ts,removePlugin:ns}),w.debugMode=function(){xe=!1},w.safeMode=function(){xe=!0},w.versionString=Wi,w.regex={concat:p,lookahead:g,either:b,optional:h,anyNumberOfTimes:d};for(const _ in ke)typeof ke[_]=="object"&&e(ke[_]);return Object.assign(w,ke),w},dt=hr({});return dt.newInstance=()=>hr({}),Ln=dt,dt.HighlightJS=dt,dt.default=dt,Ln}var ms=gs();const oe=Wr(ms),ws="11.11.1",ne=new Map,bs="https://raw.githubusercontent.com/highlightjs/highlight.js/main/SUPPORTED_LANGUAGES.md",Ie={shell:"bash",sh:"bash",zsh:"bash",js:"javascript",ts:"typescript",py:"python",csharp:"cs","c#":"cs"};Ie.html="xml";Ie.xhtml="xml";Ie.markup="xml";const Un=new Set(["magic","undefined"]);let et=null;const Tn=new Map,ys=300*1e3;async function Wn(e=bs){if(e)return et||(et=(async()=>{try{const t=await fetch(e);if(!t.ok)return;const s=(await t.text()).split(/\r?\n/);let r=-1;for(let l=0;l<s.length;l++)if(/\|\s*Language\s*\|/i.test(s[l])){r=l;break}if(r===-1)return;const i=s[r].replace(/^\||\|$/g,"").split("|").map(l=>l.trim().toLowerCase());let a=i.findIndex(l=>/alias|aliases|equivalent|alt|alternates?/i.test(l));a===-1&&(a=1);let c=i.findIndex(l=>/file|filename|module|module name|module-name|short|slug/i.test(l));if(c===-1){const l=i.findIndex(u=>/language/i.test(u));c=l!==-1?l:0}let o=[];for(let l=r+1;l<s.length;l++){const u=s[l].trim();if(!u||!u.startsWith("|"))break;const f=u.replace(/^\||\|$/g,"").split("|").map(m=>m.trim());if(f.every(m=>/^-+$/.test(m)))continue;const g=f;if(!g.length)continue;const h=(g[c]||g[0]||"").toString().trim().toLowerCase();if(!h||/^-+$/.test(h))continue;ne.set(h,h);const p=g[a]||"";if(p){const m=String(p).split(",").map(b=>b.replace(/`/g,"").trim()).filter(Boolean);if(m.length){const y=m[0].toLowerCase().replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");y&&/[a-z0-9]/i.test(y)&&(ne.set(y,y),o.push(y))}}}try{const l=[];for(const u of o){const f=String(u||"").replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");f&&/[a-z0-9]/i.test(f)?l.push(f):ne.delete(u)}o=l}catch(l){console.warn("[codeblocksManager] cleanup aliases failed",l)}try{let l=0;for(const u of Array.from(ne.keys())){if(!u||/^-+$/.test(u)||!/[a-z0-9]/i.test(u)){ne.delete(u),l++;continue}if(/^[:]+/.test(u)){const f=u.replace(/^[:]+/,"");if(f&&/[a-z0-9]/i.test(f)){const g=ne.get(u);ne.delete(u),ne.set(f,g)}else ne.delete(u),l++}}for(const[u,f]of Array.from(ne.entries()))(!f||/^-+$/.test(f)||!/[a-z0-9]/i.test(f))&&(ne.delete(u),l++);try{const u=":---------------------";ne.has(u)&&(ne.delete(u),l++)}catch(u){console.warn("[codeblocksManager] remove sep key failed",u)}try{const u=Array.from(ne.keys()).sort()}catch(u){console.warn("[codeblocksManager] compute supported keys failed",u)}}catch(l){console.warn("[codeblocksManager] ignored error",l)}}catch(t){console.warn("[codeblocksManager] loadSupportedLanguages failed",t)}})(),et)}const xt=new Set;async function bt(e,t){if(et||(async()=>{try{await Wn()}catch(r){console.warn("[codeblocksManager] loadSupportedLanguages (IIFE) failed",r)}})(),et)try{await et}catch{}if(e=e==null?"":String(e),e=e.trim(),!e)return!1;const n=e.toLowerCase();if(Un.has(n))return!1;if(ne.size&&!ne.has(n)){const r=Ie;if(!r[n]&&!r[e])return!1}if(xt.has(e))return!0;const s=Ie;try{const r=(t||e||"").toString().replace(/\.js$/i,"").trim(),i=(s[e]||e||"").toString(),a=(s[r]||r||"").toString();let c=Array.from(new Set([i,a,r,e,s[r],s[e]].filter(Boolean))).map(u=>String(u).toLowerCase()).filter(u=>u&&u!=="undefined");ne.size&&(c=c.filter(u=>{if(ne.has(u))return!0;const f=Ie[u];return!!(f&&ne.has(f))}));let o=null,l=null;for(const u of c)try{const f=Date.now();let g=Tn.get(u);if(g&&g.ok===!1&&f-(g.ts||0)>=ys&&(Tn.delete(u),g=void 0),g){if(g.module)o=g.module;else if(g.promise)try{o=await g.promise}catch{o=null}}else{const d={promise:null,module:null,ok:null,ts:0};Tn.set(u,d),d.promise=(async()=>{try{try{try{return await import(`highlight.js/lib/languages/${u}.js`)}catch{return await import(`highlight.js/lib/languages/${u}`)}}catch{try{const p=`https://cdn.jsdelivr.net/npm/highlight.js/es/languages/${u}.js`;return await new Function("u","return import(u)")(p)}catch{try{const m=`https://cdn.jsdelivr.net/npm/highlight.js/lib/languages/${u}.js`;return await new Function("u","return import(u)")(m)}catch{return null}}}}catch{return null}})();try{o=await d.promise,d.module=o,d.ok=!!o,d.ts=Date.now()}catch{d.module=null,d.ok=!1,d.ts=Date.now(),o=null}}if(o){const d=o.default||o;try{const h=ne.size&&ne.get(e)||u||e;return oe.registerLanguage(h,d),xt.add(h),h!==e&&(oe.registerLanguage(e,d),xt.add(e)),!0}catch(h){l=h}}else try{if(ne.has(u)||ne.has(e)){const d=()=>({});try{oe.registerLanguage(u,d),xt.add(u)}catch{}try{u!==e&&(oe.registerLanguage(e,d),xt.add(e))}catch{}return!0}}catch{}}catch(f){l=f}if(l)throw l;return!1}catch{return!1}}let Yt=null;function Fr(e=document){et||(async()=>{try{await Wn()}catch(i){console.warn("[codeblocksManager] loadSupportedLanguages (observer) failed",i)}})();const t=Ie,s=Yt||(typeof IntersectionObserver>"u"?null:(Yt=new IntersectionObserver((i,a)=>{i.forEach(c=>{if(!c.isIntersecting)return;const o=c.target;try{a.unobserve(o)}catch(l){console.warn("[codeblocksManager] observer unobserve failed",l)}(async()=>{try{const l=o.getAttribute&&o.getAttribute("class")||o.className||"",u=l.match(/language-([a-zA-Z0-9_+-]+)/)||l.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(u&&u[1]){const f=(u[1]||"").toLowerCase(),g=t[f]||f,d=ne.size&&(ne.get(g)||ne.get(String(g).toLowerCase()))||g;try{await bt(d)}catch(h){console.warn("[codeblocksManager] registerLanguage failed",h)}try{try{const h=o.textContent||o.innerText||"";h!=null&&(o.textContent=h)}catch{}try{o&&o.dataset&&o.dataset.highlighted&&delete o.dataset.highlighted}catch{}oe.highlightElement(o)}catch(h){console.warn("[codeblocksManager] hljs.highlightElement failed",h)}}else try{const f=o.textContent||"";try{if(oe&&typeof oe.getLanguage=="function"&&oe.getLanguage("plaintext")){const g=oe.highlight(f,{language:"plaintext"});g&&g.value&&(o.innerHTML=g.value)}}catch{try{oe.highlightElement(o)}catch(d){console.warn("[codeblocksManager] fallback highlightElement failed",d)}}}catch(f){console.warn("[codeblocksManager] auto-detect plaintext failed",f)}}catch(l){console.warn("[codeblocksManager] observer entry processing failed",l)}})()})},{root:null,rootMargin:"300px",threshold:.1}),Yt)),r=e&&e.querySelectorAll?e.querySelectorAll("pre code"):[];if(!s){r.forEach(async i=>{try{const a=i.getAttribute&&i.getAttribute("class")||i.className||"",c=a.match(/language-([a-zA-Z0-9_+-]+)/)||a.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(c&&c[1]){const o=(c[1]||"").toLowerCase(),l=t[o]||o,u=ne.size&&(ne.get(l)||ne.get(String(l).toLowerCase()))||l;try{await bt(u)}catch(f){console.warn("[codeblocksManager] registerLanguage failed (no observer)",f)}}try{try{const o=i.textContent||i.innerText||"";o!=null&&(i.textContent=o)}catch{}try{i&&i.dataset&&i.dataset.highlighted&&delete i.dataset.highlighted}catch{}oe.highlightElement(i)}catch(o){console.warn("[codeblocksManager] hljs.highlightElement failed (no observer)",o)}}catch(a){console.warn("[codeblocksManager] loadSupportedLanguages fallback ignored error",a)}});return}r.forEach(i=>{try{s.observe(i)}catch(a){console.warn("[codeblocksManager] observe failed",a)}})}function ks(e,{useCdn:t=!0}={}){const n=document.querySelector("link[data-hl-theme]"),s=n&&n.getAttribute?n.getAttribute("data-hl-theme"):null,r=e==null?"default":String(e),i=r&&String(r).toLowerCase()||"";if(i==="default"||i==="monokai"){try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}return}if(s&&s.toLowerCase()===i)return;if(!t){console.warn("Requested highlight theme not bundled; set useCdn=true to load theme from CDN");return}const a=i,c=`https://cdn.jsdelivr.net/npm/highlight.js@${ws}/styles/${a}.css`,o=document.createElement("link");o.rel="stylesheet",o.href=c,o.setAttribute("data-hl-theme",a),o.addEventListener("load",()=>{try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}}),document.head.appendChild(o)}let at="light";function xs(e,t={}){if(document.querySelector(`link[href="${e}"]`))return;const n=document.createElement("link");if(n.rel="stylesheet",n.href=e,Object.entries(t).forEach(([s,r])=>n.setAttribute(s,r)),document.head.appendChild(n),t["data-bulmaswatch-theme"])try{if(n.getAttribute("data-bulmaswatch-observer"))return;let s=Number(n.getAttribute("data-bulmaswatch-move-count")||0),r=!1;const i=new MutationObserver(()=>{try{if(r)return;const c=n.parentNode;if(!c||c.lastElementChild===n)return;if(s>=1e3){n.setAttribute("data-bulmaswatch-move-stopped","1");return}r=!0;try{c.appendChild(n)}catch{}s+=1,n.setAttribute("data-bulmaswatch-move-count",String(s)),r=!1}catch{}});try{i.observe(document.head,{childList:!0}),n.setAttribute("data-bulmaswatch-observer","1"),n.setAttribute("data-bulmaswatch-move-count",String(s))}catch{}const a=document.head;a&&a.lastElementChild!==n&&a.appendChild(n)}catch{}}function xr(){try{const e=Array.from(document.querySelectorAll("link[data-bulmaswatch-theme]"));for(const t of e)t&&t.parentNode&&t.parentNode.removeChild(t)}catch{}try{const e=Array.from(document.querySelectorAll("style[data-bulma-override]"));for(const t of e)t&&t.parentNode&&t.parentNode.removeChild(t)}catch{}}async function Zr(e="none",t="/"){if(typeof window<"u"&&window.__nimbiCMSDebug)try{console.debug("[bulmaManager] ensureBulma called",{bulmaCustomize:e,pageDir:t})}catch{}if(!e)return;if(e==="none"){try{const i=[location&&location.protocol&&location.protocol==="file:"?"https://unpkg.com/bulma/css/bulma.min.css":"//unpkg.com/bulma/css/bulma.min.css","https://unpkg.com/bulma/css/bulma.min.css"];let a=!1;for(const c of i)try{if(document.querySelector(`link[href="${c}"]`)){a=!0;break}}catch{}if(!a){const c=i[0],o=document.createElement("link");o.rel="stylesheet",o.href=c,o.setAttribute("data-bulma-base","1");const l=document.querySelector('link[href*="/dist/nimbi-cms.css"], link[href*="dist/nimbi-cms.css"]');l&&l.parentNode?l.parentNode.insertBefore(o,l):document.head.appendChild(o)}}catch{}try{const i=Array.from(document.querySelectorAll("link[data-bulmaswatch-theme]"));for(const a of i)a&&a.parentNode&&a.parentNode.removeChild(a)}catch{}try{const i=Array.from(document.querySelectorAll("style[data-bulma-override]"));for(const a of i)a&&a.parentNode&&a.parentNode.removeChild(a)}catch{}return}const s=[t+"bulma.css","/bulma.css"],r=Array.from(new Set(s));if(e==="local"){if(xr(),document.querySelector("style[data-bulma-override]"))return;for(const i of r)try{const a=await fetch(i,{method:"GET"});if(a.ok){const c=await a.text(),o=document.createElement("style");o.setAttribute("data-bulma-override",i),o.appendChild(document.createTextNode(`
/* bulma override: ${i} */
`+c)),document.head.appendChild(o);return}}catch(a){console.warn("[bulmaManager] fetch local bulma candidate failed",a)}return}try{const i=String(e).trim();if(!i)return;xr();const a=`https://unpkg.com/bulmaswatch/${encodeURIComponent(i)}/bulmaswatch.min.css`;xs(a,{"data-bulmaswatch-theme":i})}catch(i){console.warn("[bulmaManager] ensureBulma failed",i)}}function Gr(e){at=e==="dark"?"dark":e==="system"?"system":"light";try{const t=Array.from(document.querySelectorAll(".nimbi-mount"));if(t.length>0)for(const n of t)at==="dark"?n.setAttribute("data-theme","dark"):at==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme");else{const n=document.documentElement;at==="dark"?n.setAttribute("data-theme","dark"):at==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme")}}catch{}}function Ss(e){const t=document.documentElement;for(const[n,s]of Object.entries(e||{}))try{t.style.setProperty(`--${n}`,s)}catch(r){console.warn("[bulmaManager] setThemeVars failed for",n,r)}}function Qr(e){if(!e||!(e instanceof HTMLElement))return()=>{};const t=e.closest&&e.closest(".nimbi-mount")||null;try{t&&(at==="dark"?t.setAttribute("data-theme","dark"):at==="light"?t.setAttribute("data-theme","light"):t.removeAttribute("data-theme"))}catch{}return()=>{}}const Xr={en:{navigation:"Navigation",onThisPage:"On this page",home:"Home",scrollToTop:"Scroll to top",readingTime:"{minutes} min read",searchPlaceholder:"Search…",imagePreviewTitle:"Image preview",imagePreviewFit:"Fit to screen",imagePreviewOriginal:"Original size",imagePreviewZoomOut:"Zoom out",imagePreviewZoomIn:"Zoom in",imagePreviewClose:"Close"},es:{navigation:"Navegación",onThisPage:"En esta página",home:"Inicio",scrollToTop:"Ir arriba",readingTime:"{minutes} min de lectura",searchPlaceholder:"Buscar…",imagePreviewTitle:"Previsualización de imagen",imagePreviewFit:"Ajustar a la pantalla",imagePreviewOriginal:"Tamaño original",imagePreviewZoomOut:"Alejar",imagePreviewZoomIn:"Acercar",imagePreviewClose:"Cerrar"},de:{navigation:"Navigation",onThisPage:"Auf dieser Seite",home:"Startseite",scrollToTop:"Nach oben",readingTime:"{minutes} min Lesezeit",searchPlaceholder:"Suchen…",imagePreviewTitle:"Bildvorschau",imagePreviewFit:"An Bildschirm anpassen",imagePreviewOriginal:"Originalgröße",imagePreviewZoomOut:"Verkleinern",imagePreviewZoomIn:"Vergrößern",imagePreviewClose:"Schließen"},fr:{navigation:"Navigation",onThisPage:"Sur cette page",home:"Accueil",scrollToTop:"Aller en haut",readingTime:"{minutes} min de lecture",searchPlaceholder:"Rechercher…",imagePreviewTitle:"Aperçu de l’image",imagePreviewFit:"Ajuster à l’écran",imagePreviewOriginal:"Taille originale",imagePreviewZoomOut:"Dézoomer",imagePreviewZoomIn:"Zoomer",imagePreviewClose:"Fermer"},pt:{navigation:"Navegação",onThisPage:"Nesta página",home:"Início",scrollToTop:"Ir para o topo",readingTime:"{minutes} min de leitura",searchPlaceholder:"Procurar…",imagePreviewTitle:"Visualização da imagem",imagePreviewFit:"Ajustar à tela",imagePreviewOriginal:"Tamanho original",imagePreviewZoomOut:"Diminuir",imagePreviewZoomIn:"Aumentar",imagePreviewClose:"Fechar"}},mt=JSON.parse(JSON.stringify(Xr));let rn="en";if(typeof navigator<"u"){const e=navigator.language||navigator.languages&&navigator.languages[0]||"en";rn=String(e).split("-")[0].toLowerCase()}Xr[rn]||(rn="en");let tt=rn;function ft(e,t={}){const n=mt[tt]||mt.en;let s=n&&n[e]?n[e]:mt.en[e]||"";for(const r of Object.keys(t))s=s.replace(new RegExp(`{${r}}`,"g"),String(t[r]));return s}async function Fn(e,t){if(!e)return;let n=e;try{/^https?:\/\//.test(e)||(n=new URL(e,location.origin+t).toString());const s=await fetch(n);if(!s.ok)return;const r=await s.json();for(const i of Object.keys(r||{}))mt[i]=Object.assign({},mt[i]||{},r[i])}catch{}}function Zn(e){const t=String(e).split("-")[0].toLowerCase();tt=mt[t]?t:"en"}const vs=Object.freeze(Object.defineProperty({__proto__:null,get currentLang(){return tt},loadL10nFile:Fn,setLang:Zn,t:ft},Symbol.toStringTag,{value:"Module"})),Es=`import { buildSearchIndex, crawlForSlug } from '../slugManager.js'
