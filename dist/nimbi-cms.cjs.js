"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const St={onPageLoad:[],onNavBuild:[],transformHtml:[]};function Vt(t,e){if(!Object.prototype.hasOwnProperty.call(St,t))throw new Error('Unknown hook "'+t+'"');if(typeof e!="function")throw new TypeError("hook callback must be a function");St[t].push(e)}function ci(t){Vt("onPageLoad",t)}function ui(t){Vt("onNavBuild",t)}function hi(t){Vt("transformHtml",t)}async function bn(t,e){const r=St[t]||[];for(const i of r)try{await i(e)}catch(n){console.warn("[nimbi-cms] runHooks callback failed",n)}}function di(){Object.keys(St).forEach(t=>{St[t].length=0})}function Mr(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var un,cr;function pi(){if(cr)return un;cr=1;function t(g){return g instanceof Map?g.clear=g.delete=g.set=function(){throw new Error("map is read-only")}:g instanceof Set&&(g.add=g.clear=g.delete=function(){throw new Error("set is read-only")}),Object.freeze(g),Object.getOwnPropertyNames(g).forEach(S=>{const C=g[S],Z=typeof C;(Z==="object"||Z==="function")&&!Object.isFrozen(C)&&t(C)}),g}class e{constructor(S){S.data===void 0&&(S.data={}),this.data=S.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function r(g){return g.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function i(g,...S){const C=Object.create(null);for(const Z in g)C[Z]=g[Z];return S.forEach(function(Z){for(const pe in Z)C[pe]=Z[pe]}),C}const n="</span>",s=g=>!!g.scope,a=(g,{prefix:S})=>{if(g.startsWith("language:"))return g.replace("language:","language-");if(g.includes(".")){const C=g.split(".");return[`${S}${C.shift()}`,...C.map((Z,pe)=>`${Z}${"_".repeat(pe+1)}`)].join(" ")}return`${S}${g}`};class u{constructor(S,C){this.buffer="",this.classPrefix=C.classPrefix,S.walk(this)}addText(S){this.buffer+=r(S)}openNode(S){if(!s(S))return;const C=a(S.scope,{prefix:this.classPrefix});this.span(C)}closeNode(S){s(S)&&(this.buffer+=n)}value(){return this.buffer}span(S){this.buffer+=`<span class="${S}">`}}const l=(g={})=>{const S={children:[]};return Object.assign(S,g),S};class o{constructor(){this.rootNode=l(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(S){this.top.children.push(S)}openNode(S){const C=l({scope:S});this.add(C),this.stack.push(C)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(S){return this.constructor._walk(S,this.rootNode)}static _walk(S,C){return typeof C=="string"?S.addText(C):C.children&&(S.openNode(C),C.children.forEach(Z=>this._walk(S,Z)),S.closeNode(C)),S}static _collapse(S){typeof S!="string"&&S.children&&(S.children.every(C=>typeof C=="string")?S.children=[S.children.join("")]:S.children.forEach(C=>{o._collapse(C)}))}}class c extends o{constructor(S){super(),this.options=S}addText(S){S!==""&&this.add(S)}startScope(S){this.openNode(S)}endScope(){this.closeNode()}__addSublanguage(S,C){const Z=S.root;C&&(Z.scope=`language:${C}`),this.add(Z)}toHTML(){return new u(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function h(g){return g?typeof g=="string"?g:g.source:null}function f(g){return m("(?=",g,")")}function p(g){return m("(?:",g,")*")}function d(g){return m("(?:",g,")?")}function m(...g){return g.map(C=>h(C)).join("")}function w(g){const S=g[g.length-1];return typeof S=="object"&&S.constructor===Object?(g.splice(g.length-1,1),S):{}}function y(...g){return"("+(w(g).capture?"":"?:")+g.map(Z=>h(Z)).join("|")+")"}function x(g){return new RegExp(g.toString()+"|").exec("").length-1}function z(g,S){const C=g&&g.exec(S);return C&&C.index===0}const I=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function A(g,{joinWith:S}){let C=0;return g.map(Z=>{C+=1;const pe=C;let fe=h(Z),N="";for(;fe.length>0;){const B=I.exec(fe);if(!B){N+=fe;break}N+=fe.substring(0,B.index),fe=fe.substring(B.index+B[0].length),B[0][0]==="\\"&&B[1]?N+="\\"+String(Number(B[1])+pe):(N+=B[0],B[0]==="("&&C++)}return N}).map(Z=>`(${Z})`).join(S)}const q=/\b\B/,O="[a-zA-Z]\\w*",Q="[a-zA-Z_]\\w*",J="\\b\\d+(\\.\\d+)?",ne="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",P="\\b(0b[01]+)",T="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",$=(g={})=>{const S=/^#![ ]*\//;return g.binary&&(g.begin=m(S,/.*\b/,g.binary,/\b.*/)),i({scope:"meta",begin:S,end:/$/,relevance:0,"on:begin":(C,Z)=>{C.index!==0&&Z.ignoreMatch()}},g)},L={begin:"\\\\[\\s\\S]",relevance:0},v={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[L]},b={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[L]},E={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},M=function(g,S,C={}){const Z=i({scope:"comment",begin:g,end:S,contains:[]},C);Z.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const pe=y("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return Z.contains.push({begin:m(/[ ]+/,"(",pe,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),Z},k=M("//","$"),X=M("/\\*","\\*/"),he=M("#","$"),xe={scope:"number",begin:J,relevance:0},be={scope:"number",begin:ne,relevance:0},j={scope:"number",begin:P,relevance:0},ue={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[L,{begin:/\[/,end:/\]/,relevance:0,contains:[L]}]},se={scope:"title",begin:O,relevance:0},_e={scope:"title",begin:Q,relevance:0},$e={begin:"\\.\\s*"+Q,relevance:0};var Ct=Object.freeze({__proto__:null,APOS_STRING_MODE:v,BACKSLASH_ESCAPE:L,BINARY_NUMBER_MODE:j,BINARY_NUMBER_RE:P,COMMENT:M,C_BLOCK_COMMENT_MODE:X,C_LINE_COMMENT_MODE:k,C_NUMBER_MODE:be,C_NUMBER_RE:ne,END_SAME_AS_BEGIN:function(g){return Object.assign(g,{"on:begin":(S,C)=>{C.data._beginMatch=S[1]},"on:end":(S,C)=>{C.data._beginMatch!==S[1]&&C.ignoreMatch()}})},HASH_COMMENT_MODE:he,IDENT_RE:O,MATCH_NOTHING_RE:q,METHOD_GUARD:$e,NUMBER_MODE:xe,NUMBER_RE:J,PHRASAL_WORDS_MODE:E,QUOTE_STRING_MODE:b,REGEXP_MODE:ue,RE_STARTERS_RE:T,SHEBANG:$,TITLE_MODE:se,UNDERSCORE_IDENT_RE:Q,UNDERSCORE_TITLE_MODE:_e});function Es(g,S){g.input[g.index-1]==="."&&S.ignoreMatch()}function Rs(g,S){g.className!==void 0&&(g.scope=g.className,delete g.className)}function Ts(g,S){S&&g.beginKeywords&&(g.begin="\\b("+g.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",g.__beforeBegin=Es,g.keywords=g.keywords||g.beginKeywords,delete g.beginKeywords,g.relevance===void 0&&(g.relevance=0))}function Ls(g,S){Array.isArray(g.illegal)&&(g.illegal=y(...g.illegal))}function Cs(g,S){if(g.match){if(g.begin||g.end)throw new Error("begin & end are not supported with match");g.begin=g.match,delete g.match}}function _s(g,S){g.relevance===void 0&&(g.relevance=1)}const Ms=(g,S)=>{if(!g.beforeMatch)return;if(g.starts)throw new Error("beforeMatch cannot be used with starts");const C=Object.assign({},g);Object.keys(g).forEach(Z=>{delete g[Z]}),g.keywords=C.keywords,g.begin=m(C.beforeMatch,f(C.begin)),g.starts={relevance:0,contains:[Object.assign(C,{endsParent:!0})]},g.relevance=0,delete C.beforeMatch},$s=["of","and","for","in","not","or","if","then","parent","list","value"],Ps="keyword";function Gn(g,S,C=Ps){const Z=Object.create(null);return typeof g=="string"?pe(C,g.split(" ")):Array.isArray(g)?pe(C,g):Object.keys(g).forEach(function(fe){Object.assign(Z,Gn(g[fe],S,fe))}),Z;function pe(fe,N){S&&(N=N.map(B=>B.toLowerCase())),N.forEach(function(B){const F=B.split("|");Z[F[0]]=[fe,Is(F[0],F[1])]})}}function Is(g,S){return S?Number(S):Bs(g)?0:1}function Bs(g){return $s.includes(g.toLowerCase())}const Qn={},Ke=g=>{console.error(g)},Xn=(g,...S)=>{console.log(`WARN: ${g}`,...S)},tt=(g,S)=>{Qn[`${g}/${S}`]||(console.log(`Deprecated as of ${g}. ${S}`),Qn[`${g}/${S}`]=!0)},_t=new Error;function Kn(g,S,{key:C}){let Z=0;const pe=g[C],fe={},N={};for(let B=1;B<=S.length;B++)N[B+Z]=pe[B],fe[B+Z]=!0,Z+=x(S[B-1]);g[C]=N,g[C]._emit=fe,g[C]._multi=!0}function zs(g){if(Array.isArray(g.begin)){if(g.skip||g.excludeBegin||g.returnBegin)throw Ke("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),_t;if(typeof g.beginScope!="object"||g.beginScope===null)throw Ke("beginScope must be object"),_t;Kn(g,g.begin,{key:"beginScope"}),g.begin=A(g.begin,{joinWith:""})}}function Os(g){if(Array.isArray(g.end)){if(g.skip||g.excludeEnd||g.returnEnd)throw Ke("skip, excludeEnd, returnEnd not compatible with endScope: {}"),_t;if(typeof g.endScope!="object"||g.endScope===null)throw Ke("endScope must be object"),_t;Kn(g,g.end,{key:"endScope"}),g.end=A(g.end,{joinWith:""})}}function Ns(g){g.scope&&typeof g.scope=="object"&&g.scope!==null&&(g.beginScope=g.scope,delete g.scope)}function Ds(g){Ns(g),typeof g.beginScope=="string"&&(g.beginScope={_wrap:g.beginScope}),typeof g.endScope=="string"&&(g.endScope={_wrap:g.endScope}),zs(g),Os(g)}function Hs(g){function S(N,B){return new RegExp(h(N),"m"+(g.case_insensitive?"i":"")+(g.unicodeRegex?"u":"")+(B?"g":""))}class C{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(B,F){F.position=this.position++,this.matchIndexes[this.matchAt]=F,this.regexes.push([F,B]),this.matchAt+=x(B)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const B=this.regexes.map(F=>F[1]);this.matcherRe=S(A(B,{joinWith:"|"}),!0),this.lastIndex=0}exec(B){this.matcherRe.lastIndex=this.lastIndex;const F=this.matcherRe.exec(B);if(!F)return null;const we=F.findIndex((ct,rn)=>rn>0&&ct!==void 0),ge=this.matchIndexes[we];return F.splice(0,we),Object.assign(F,ge)}}class Z{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(B){if(this.multiRegexes[B])return this.multiRegexes[B];const F=new C;return this.rules.slice(B).forEach(([we,ge])=>F.addRule(we,ge)),F.compile(),this.multiRegexes[B]=F,F}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(B,F){this.rules.push([B,F]),F.type==="begin"&&this.count++}exec(B){const F=this.getMatcher(this.regexIndex);F.lastIndex=this.lastIndex;let we=F.exec(B);if(this.resumingScanAtSamePosition()&&!(we&&we.index===this.lastIndex)){const ge=this.getMatcher(0);ge.lastIndex=this.lastIndex+1,we=ge.exec(B)}return we&&(this.regexIndex+=we.position+1,this.regexIndex===this.count&&this.considerAll()),we}}function pe(N){const B=new Z;return N.contains.forEach(F=>B.addRule(F.begin,{rule:F,type:"begin"})),N.terminatorEnd&&B.addRule(N.terminatorEnd,{type:"end"}),N.illegal&&B.addRule(N.illegal,{type:"illegal"}),B}function fe(N,B){const F=N;if(N.isCompiled)return F;[Rs,Cs,Ds,Ms].forEach(ge=>ge(N,B)),g.compilerExtensions.forEach(ge=>ge(N,B)),N.__beforeBegin=null,[Ts,Ls,_s].forEach(ge=>ge(N,B)),N.isCompiled=!0;let we=null;return typeof N.keywords=="object"&&N.keywords.$pattern&&(N.keywords=Object.assign({},N.keywords),we=N.keywords.$pattern,delete N.keywords.$pattern),we=we||/\w+/,N.keywords&&(N.keywords=Gn(N.keywords,g.case_insensitive)),F.keywordPatternRe=S(we,!0),B&&(N.begin||(N.begin=/\B|\b/),F.beginRe=S(F.begin),!N.end&&!N.endsWithParent&&(N.end=/\B|\b/),N.end&&(F.endRe=S(F.end)),F.terminatorEnd=h(F.end)||"",N.endsWithParent&&B.terminatorEnd&&(F.terminatorEnd+=(N.end?"|":"")+B.terminatorEnd)),N.illegal&&(F.illegalRe=S(N.illegal)),N.contains||(N.contains=[]),N.contains=[].concat(...N.contains.map(function(ge){return Us(ge==="self"?N:ge)})),N.contains.forEach(function(ge){fe(ge,F)}),N.starts&&fe(N.starts,B),F.matcher=pe(F),F}if(g.compilerExtensions||(g.compilerExtensions=[]),g.contains&&g.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return g.classNameAliases=i(g.classNameAliases||{}),fe(g)}function Yn(g){return g?g.endsWithParent||Yn(g.starts):!1}function Us(g){return g.variants&&!g.cachedVariants&&(g.cachedVariants=g.variants.map(function(S){return i(g,{variants:null},S)})),g.cachedVariants?g.cachedVariants:Yn(g)?i(g,{starts:g.starts?i(g.starts):null}):Object.isFrozen(g)?i(g):g}var qs="11.11.1";class js extends Error{constructor(S,C){super(S),this.name="HTMLInjectionError",this.html=C}}const nn=r,Vn=i,Jn=Symbol("nomatch"),Fs=7,er=function(g){const S=Object.create(null),C=Object.create(null),Z=[];let pe=!0;const fe="Could not find the language '{}', did you forget to load/include a language module?",N={disableAutodetect:!0,name:"Plain text",contains:[]};let B={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:c};function F(R){return B.noHighlightRe.test(R)}function we(R){let H=R.className+" ";H+=R.parentNode?R.parentNode.className:"";const ee=B.languageDetectRe.exec(H);if(ee){const le=je(ee[1]);return le||(Xn(fe.replace("{}",ee[1])),Xn("Falling back to no-highlight mode for this block.",R)),le?ee[1]:"no-highlight"}return H.split(/\s+/).find(le=>F(le)||je(le))}function ge(R,H,ee){let le="",me="";typeof H=="object"?(le=R,ee=H.ignoreIllegals,me=H.language):(tt("10.7.0","highlight(lang, code, ...args) has been deprecated."),tt("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),me=R,le=H),ee===void 0&&(ee=!0);const Pe={code:le,language:me};$t("before:highlight",Pe);const Fe=Pe.result?Pe.result:ct(Pe.language,Pe.code,ee);return Fe.code=Pe.code,$t("after:highlight",Fe),Fe}function ct(R,H,ee,le){const me=Object.create(null);function Pe(_,D){return _.keywords[D]}function Fe(){if(!G.keywords){ye.addText(oe);return}let _=0;G.keywordPatternRe.lastIndex=0;let D=G.keywordPatternRe.exec(oe),K="";for(;D;){K+=oe.substring(_,D.index);const ae=Oe.case_insensitive?D[0].toLowerCase():D[0],Se=Pe(G,ae);if(Se){const[He,li]=Se;if(ye.addText(K),K="",me[ae]=(me[ae]||0)+1,me[ae]<=Fs&&(Bt+=li),He.startsWith("_"))K+=D[0];else{const oi=Oe.classNameAliases[He]||He;ze(D[0],oi)}}else K+=D[0];_=G.keywordPatternRe.lastIndex,D=G.keywordPatternRe.exec(oe)}K+=oe.substring(_),ye.addText(K)}function Pt(){if(oe==="")return;let _=null;if(typeof G.subLanguage=="string"){if(!S[G.subLanguage]){ye.addText(oe);return}_=ct(G.subLanguage,oe,!0,or[G.subLanguage]),or[G.subLanguage]=_._top}else _=sn(oe,G.subLanguage.length?G.subLanguage:null);G.relevance>0&&(Bt+=_.relevance),ye.__addSublanguage(_._emitter,_.language)}function Re(){G.subLanguage!=null?Pt():Fe(),oe=""}function ze(_,D){_!==""&&(ye.startScope(D),ye.addText(_),ye.endScope())}function sr(_,D){let K=1;const ae=D.length-1;for(;K<=ae;){if(!_._emit[K]){K++;continue}const Se=Oe.classNameAliases[_[K]]||_[K],He=D[K];Se?ze(He,Se):(oe=He,Fe(),oe=""),K++}}function ir(_,D){return _.scope&&typeof _.scope=="string"&&ye.openNode(Oe.classNameAliases[_.scope]||_.scope),_.beginScope&&(_.beginScope._wrap?(ze(oe,Oe.classNameAliases[_.beginScope._wrap]||_.beginScope._wrap),oe=""):_.beginScope._multi&&(sr(_.beginScope,D),oe="")),G=Object.create(_,{parent:{value:G}}),G}function ar(_,D,K){let ae=z(_.endRe,K);if(ae){if(_["on:end"]){const Se=new e(_);_["on:end"](D,Se),Se.isMatchIgnored&&(ae=!1)}if(ae){for(;_.endsParent&&_.parent;)_=_.parent;return _}}if(_.endsWithParent)return ar(_.parent,D,K)}function ni(_){return G.matcher.regexIndex===0?(oe+=_[0],1):(cn=!0,0)}function ri(_){const D=_[0],K=_.rule,ae=new e(K),Se=[K.__beforeBegin,K["on:begin"]];for(const He of Se)if(He&&(He(_,ae),ae.isMatchIgnored))return ni(D);return K.skip?oe+=D:(K.excludeBegin&&(oe+=D),Re(),!K.returnBegin&&!K.excludeBegin&&(oe=D)),ir(K,_),K.returnBegin?0:D.length}function si(_){const D=_[0],K=H.substring(_.index),ae=ar(G,_,K);if(!ae)return Jn;const Se=G;G.endScope&&G.endScope._wrap?(Re(),ze(D,G.endScope._wrap)):G.endScope&&G.endScope._multi?(Re(),sr(G.endScope,_)):Se.skip?oe+=D:(Se.returnEnd||Se.excludeEnd||(oe+=D),Re(),Se.excludeEnd&&(oe=D));do G.scope&&ye.closeNode(),!G.skip&&!G.subLanguage&&(Bt+=G.relevance),G=G.parent;while(G!==ae.parent);return ae.starts&&ir(ae.starts,_),Se.returnEnd?0:D.length}function ii(){const _=[];for(let D=G;D!==Oe;D=D.parent)D.scope&&_.unshift(D.scope);_.forEach(D=>ye.openNode(D))}let It={};function lr(_,D){const K=D&&D[0];if(oe+=_,K==null)return Re(),0;if(It.type==="begin"&&D.type==="end"&&It.index===D.index&&K===""){if(oe+=H.slice(D.index,D.index+1),!pe){const ae=new Error(`0 width match regex (${R})`);throw ae.languageName=R,ae.badRule=It.rule,ae}return 1}if(It=D,D.type==="begin")return ri(D);if(D.type==="illegal"&&!ee){const ae=new Error('Illegal lexeme "'+K+'" for mode "'+(G.scope||"<unnamed>")+'"');throw ae.mode=G,ae}else if(D.type==="end"){const ae=si(D);if(ae!==Jn)return ae}if(D.type==="illegal"&&K==="")return oe+=`
`,1;if(on>1e5&&on>D.index*3)throw new Error("potential infinite loop, way more iterations than matches");return oe+=K,K.length}const Oe=je(R);if(!Oe)throw Ke(fe.replace("{}",R)),new Error('Unknown language: "'+R+'"');const ai=Hs(Oe);let ln="",G=le||ai;const or={},ye=new B.__emitter(B);ii();let oe="",Bt=0,Ye=0,on=0,cn=!1;try{if(Oe.__emitTokens)Oe.__emitTokens(H,ye);else{for(G.matcher.considerAll();;){on++,cn?cn=!1:G.matcher.considerAll(),G.matcher.lastIndex=Ye;const _=G.matcher.exec(H);if(!_)break;const D=H.substring(Ye,_.index),K=lr(D,_);Ye=_.index+K}lr(H.substring(Ye))}return ye.finalize(),ln=ye.toHTML(),{language:R,value:ln,relevance:Bt,illegal:!1,_emitter:ye,_top:G}}catch(_){if(_.message&&_.message.includes("Illegal"))return{language:R,value:nn(H),illegal:!0,relevance:0,_illegalBy:{message:_.message,index:Ye,context:H.slice(Ye-100,Ye+100),mode:_.mode,resultSoFar:ln},_emitter:ye};if(pe)return{language:R,value:nn(H),illegal:!1,relevance:0,errorRaised:_,_emitter:ye,_top:G};throw _}}function rn(R){const H={value:nn(R),illegal:!1,relevance:0,_top:N,_emitter:new B.__emitter(B)};return H._emitter.addText(R),H}function sn(R,H){H=H||B.languages||Object.keys(S);const ee=rn(R),le=H.filter(je).filter(rr).map(Re=>ct(Re,R,!1));le.unshift(ee);const me=le.sort((Re,ze)=>{if(Re.relevance!==ze.relevance)return ze.relevance-Re.relevance;if(Re.language&&ze.language){if(je(Re.language).supersetOf===ze.language)return 1;if(je(ze.language).supersetOf===Re.language)return-1}return 0}),[Pe,Fe]=me,Pt=Pe;return Pt.secondBest=Fe,Pt}function Ws(R,H,ee){const le=H&&C[H]||ee;R.classList.add("hljs"),R.classList.add(`language-${le}`)}function an(R){let H=null;const ee=we(R);if(F(ee))return;if($t("before:highlightElement",{el:R,language:ee}),R.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",R);return}if(R.children.length>0&&(B.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(R)),B.throwUnescapedHTML))throw new js("One of your code blocks includes unescaped HTML.",R.innerHTML);H=R;const le=H.textContent,me=ee?ge(le,{language:ee,ignoreIllegals:!0}):sn(le);R.innerHTML=me.value,R.dataset.highlighted="yes",Ws(R,ee,me.language),R.result={language:me.language,re:me.relevance,relevance:me.relevance},me.secondBest&&(R.secondBest={language:me.secondBest.language,relevance:me.secondBest.relevance}),$t("after:highlightElement",{el:R,result:me,text:le})}function Zs(R){B=Vn(B,R)}const Gs=()=>{Mt(),tt("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function Qs(){Mt(),tt("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let tr=!1;function Mt(){function R(){Mt()}if(document.readyState==="loading"){tr||window.addEventListener("DOMContentLoaded",R,!1),tr=!0;return}document.querySelectorAll(B.cssSelector).forEach(an)}function Xs(R,H){let ee=null;try{ee=H(g)}catch(le){if(Ke("Language definition for '{}' could not be registered.".replace("{}",R)),pe)Ke(le);else throw le;ee=N}ee.name||(ee.name=R),S[R]=ee,ee.rawDefinition=H.bind(null,g),ee.aliases&&nr(ee.aliases,{languageName:R})}function Ks(R){delete S[R];for(const H of Object.keys(C))C[H]===R&&delete C[H]}function Ys(){return Object.keys(S)}function je(R){return R=(R||"").toLowerCase(),S[R]||S[C[R]]}function nr(R,{languageName:H}){typeof R=="string"&&(R=[R]),R.forEach(ee=>{C[ee.toLowerCase()]=H})}function rr(R){const H=je(R);return H&&!H.disableAutodetect}function Vs(R){R["before:highlightBlock"]&&!R["before:highlightElement"]&&(R["before:highlightElement"]=H=>{R["before:highlightBlock"](Object.assign({block:H.el},H))}),R["after:highlightBlock"]&&!R["after:highlightElement"]&&(R["after:highlightElement"]=H=>{R["after:highlightBlock"](Object.assign({block:H.el},H))})}function Js(R){Vs(R),Z.push(R)}function ei(R){const H=Z.indexOf(R);H!==-1&&Z.splice(H,1)}function $t(R,H){const ee=R;Z.forEach(function(le){le[ee]&&le[ee](H)})}function ti(R){return tt("10.7.0","highlightBlock will be removed entirely in v12.0"),tt("10.7.0","Please use highlightElement now."),an(R)}Object.assign(g,{highlight:ge,highlightAuto:sn,highlightAll:Mt,highlightElement:an,highlightBlock:ti,configure:Zs,initHighlighting:Gs,initHighlightingOnLoad:Qs,registerLanguage:Xs,unregisterLanguage:Ks,listLanguages:Ys,getLanguage:je,registerAliases:nr,autoDetection:rr,inherit:Vn,addPlugin:Js,removePlugin:ei}),g.debugMode=function(){pe=!1},g.safeMode=function(){pe=!0},g.versionString=qs,g.regex={concat:m,lookahead:f,either:y,optional:d,anyNumberOfTimes:p};for(const R in Ct)typeof Ct[R]=="object"&&t(Ct[R]);return Object.assign(g,Ct),g},nt=er({});return nt.newInstance=()=>er({}),un=nt,nt.HighlightJS=nt,nt.default=nt,un}var fi=pi();const ce=Mr(fi),V=new Map,gi="https://raw.githubusercontent.com/highlightjs/highlight.js/main/SUPPORTED_LANGUAGES.md",Te={shell:"bash",sh:"bash",zsh:"bash",js:"javascript",ts:"typescript",py:"python",csharp:"cs","c#":"cs"};Te.html="xml";Te.xhtml="xml";Te.markup="xml";const Cn=new Set(["magic","undefined"]);let Ge=null;const hn=new Map,mi=300*1e3;async function _n(t=gi){if(t)return Ge||(Ge=(async()=>{try{const e=await fetch(t);if(!e.ok)return;const i=(await e.text()).split(/\r?\n/);let n=-1;for(let o=0;o<i.length;o++)if(/\|\s*Language\s*\|/i.test(i[o])){n=o;break}if(n===-1)return;const s=i[n].replace(/^\||\|$/g,"").split("|").map(o=>o.trim().toLowerCase());let a=s.findIndex(o=>/alias|aliases|equivalent|alt|alternates?/i.test(o));a===-1&&(a=1);let u=s.findIndex(o=>/file|filename|module|module name|module-name|short|slug/i.test(o));if(u===-1){const o=s.findIndex(c=>/language/i.test(c));u=o!==-1?o:0}let l=[];for(let o=n+1;o<i.length;o++){const c=i[o].trim();if(!c||!c.startsWith("|"))break;const h=c.replace(/^\||\|$/g,"").split("|").map(w=>w.trim());if(h.every(w=>/^-+$/.test(w)))continue;const f=h;if(!f.length)continue;const d=(f[u]||f[0]||"").toString().trim().toLowerCase();if(!d||/^-+$/.test(d))continue;V.set(d,d);const m=f[a]||"";if(m){const w=String(m).split(",").map(y=>y.replace(/`/g,"").trim()).filter(Boolean);if(w.length){const x=w[0].toLowerCase().replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");x&&/[a-z0-9]/i.test(x)&&(V.set(x,x),l.push(x))}}}try{const o=[];for(const c of l){const h=String(c||"").replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");h&&/[a-z0-9]/i.test(h)?o.push(h):V.delete(c)}l=o}catch(o){console.warn("[codeblocksManager] cleanup aliases failed",o)}try{let o=0;for(const c of Array.from(V.keys())){if(!c||/^-+$/.test(c)||!/[a-z0-9]/i.test(c)){V.delete(c),o++;continue}if(/^[:]+/.test(c)){const h=c.replace(/^[:]+/,"");if(h&&/[a-z0-9]/i.test(h)){const f=V.get(c);V.delete(c),V.set(h,f)}else V.delete(c),o++}}for(const[c,h]of Array.from(V.entries()))(!h||/^-+$/.test(h)||!/[a-z0-9]/i.test(h))&&(V.delete(c),o++);try{const c=":---------------------";V.has(c)&&(V.delete(c),o++)}catch(c){console.warn("[codeblocksManager] remove sep key failed",c)}try{const c=Array.from(V.keys()).sort()}catch(c){console.warn("[codeblocksManager] compute supported keys failed",c)}}catch(o){console.warn("[codeblocksManager] ignored error",o)}}catch(e){console.warn("[codeblocksManager] loadSupportedLanguages failed",e)}})(),Ge)}const ut=new Set;async function lt(t,e){if(Ge||(async()=>{try{await _n()}catch(n){console.warn("[codeblocksManager] loadSupportedLanguages (IIFE) failed",n)}})(),Ge)try{await Ge}catch{}if(t=t==null?"":String(t),t=t.trim(),!t)return!1;const r=t.toLowerCase();if(Cn.has(r))return!1;if(V.size&&!V.has(r)){const n=Te;if(!n[r]&&!n[t])return!1}if(ut.has(t))return!0;const i=Te;try{const n=(e||t||"").toString().replace(/\.js$/i,"").trim(),s=(i[t]||t||"").toString(),a=(i[n]||n||"").toString();let u=Array.from(new Set([s,a,n,t,i[n],i[t]].filter(Boolean))).map(c=>String(c).toLowerCase()).filter(c=>c&&c!=="undefined");V.size&&(u=u.filter(c=>{if(V.has(c))return!0;const h=Te[c];return!!(h&&V.has(h))}));let l=null,o=null;for(const c of u)try{const h=Date.now();let f=hn.get(c);if(f&&f.ok===!1&&h-(f.ts||0)>=mi&&(hn.delete(c),f=void 0),f){if(f.module)l=f.module;else if(f.promise)try{l=await f.promise}catch{l=null}}else{const p={promise:null,module:null,ok:null,ts:0};hn.set(c,p),p.promise=(async()=>{try{try{try{return await import(`highlight.js/lib/languages/${c}.js`)}catch{return await import(`highlight.js/lib/languages/${c}`)}}catch{try{const m=`https://cdn.jsdelivr.net/npm/highlight.js/es/languages/${c}.js`;return await new Function("u","return import(u)")(m)}catch{try{const w=`https://cdn.jsdelivr.net/npm/highlight.js/lib/languages/${c}.js`;return await new Function("u","return import(u)")(w)}catch{return null}}}}catch{return null}})();try{l=await p.promise,p.module=l,p.ok=!!l,p.ts=Date.now()}catch{p.module=null,p.ok=!1,p.ts=Date.now(),l=null}}if(l){const p=l.default||l;try{const d=V.size&&V.get(t)||c||t;return ce.registerLanguage(d,p),ut.add(d),d!==t&&(ce.registerLanguage(t,p),ut.add(t)),!0}catch(d){o=d}}else try{if(V.has(c)||V.has(t)){const p=()=>({});try{ce.registerLanguage(c,p),ut.add(c)}catch{}try{c!==t&&(ce.registerLanguage(t,p),ut.add(t))}catch{}return!0}}catch{}}catch(h){o=h}if(o)throw o;return!1}catch{return!1}}let zt=null;function $r(t=document){Ge||(async()=>{try{await _n()}catch(s){console.warn("[codeblocksManager] loadSupportedLanguages (observer) failed",s)}})();const e=Te,i=zt||(typeof IntersectionObserver>"u"?null:(zt=new IntersectionObserver((s,a)=>{s.forEach(u=>{if(!u.isIntersecting)return;const l=u.target;try{a.unobserve(l)}catch(o){console.warn("[codeblocksManager] observer unobserve failed",o)}(async()=>{try{const o=l.getAttribute&&l.getAttribute("class")||l.className||"",c=o.match(/language-([a-zA-Z0-9_+-]+)/)||o.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(c&&c[1]){const h=(c[1]||"").toLowerCase(),f=e[h]||h,p=V.size&&(V.get(f)||V.get(String(f).toLowerCase()))||f;try{await lt(p)}catch(d){console.warn("[codeblocksManager] registerLanguage failed",d)}try{ce.highlightElement(l)}catch(d){console.warn("[codeblocksManager] hljs.highlightElement failed",d)}}else try{const h=l.textContent||"";try{if(ce&&typeof ce.getLanguage=="function"&&ce.getLanguage("plaintext")){const f=ce.highlight(h,{language:"plaintext"});f&&f.value&&(l.innerHTML=f.value)}}catch{try{ce.highlightElement(l)}catch(p){console.warn("[codeblocksManager] fallback highlightElement failed",p)}}}catch(h){console.warn("[codeblocksManager] auto-detect plaintext failed",h)}}catch(o){console.warn("[codeblocksManager] observer entry processing failed",o)}})()})},{root:null,rootMargin:"300px",threshold:.1}),zt)),n=t&&t.querySelectorAll?t.querySelectorAll("pre code"):[];if(!i){n.forEach(async s=>{try{const a=s.getAttribute&&s.getAttribute("class")||s.className||"",u=a.match(/language-([a-zA-Z0-9_+-]+)/)||a.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(u&&u[1]){const l=(u[1]||"").toLowerCase(),o=e[l]||l,c=V.size&&(V.get(o)||V.get(String(o).toLowerCase()))||o;try{await lt(c)}catch(h){console.warn("[codeblocksManager] registerLanguage failed (no observer)",h)}}try{ce.highlightElement(s)}catch(l){console.warn("[codeblocksManager] hljs.highlightElement failed (no observer)",l)}}catch(a){console.warn("[codeblocksManager] loadSupportedLanguages fallback ignored error",a)}});return}n.forEach(s=>{try{i.observe(s)}catch(a){console.warn("[codeblocksManager] observe failed",a)}})}function wi(t,{useCdn:e=!0}={}){const r=document.querySelector("link[data-hl-theme]");r&&r.remove();let i=t||"monokai";if(i==="monokai")return;if(!e){console.warn("Requested highlight theme not bundled; set useCdn=true to load from CDN");return}const n=`https://cdn.jsdelivr.net/npm/highlight.js@11.8.0/styles/${i}.css`,s=document.createElement("link");s.rel="stylesheet",s.href=n,s.setAttribute("data-hl-theme",i),document.head.appendChild(s)}let dn="light";function bi(t,e={}){if(document.querySelector(`link[href="${t}"]`))return;const r=document.createElement("link");r.rel="stylesheet",r.href=t,Object.entries(e).forEach(([i,n])=>r.setAttribute(i,n)),document.head.appendChild(r)}async function Pr(t="none",e="/"){if(!t||t==="none")return;const r=[e+"bulma.css","/bulma.css"],i=Array.from(new Set(r));if(t==="local"){if(document.querySelector("style[data-bulma-override]"))return;for(const n of i)try{const s=await fetch(n,{method:"GET"});if(s.ok){const a=await s.text(),u=document.createElement("style");u.setAttribute("data-bulma-override",n),u.appendChild(document.createTextNode(`
/* bulma override: ${n} */
`+a)),document.head.appendChild(u);return}}catch(s){console.warn("[bulmaManager] fetch local bulma candidate failed",s)}return}try{const n=String(t).trim();if(!n)return;const s=`https://unpkg.com/bulmaswatch/${encodeURIComponent(n)}/bulmaswatch.min.css`;bi(s,{"data-bulmaswatch-theme":n})}catch(n){console.warn("[bulmaManager] ensureBulma failed",n)}}function Ir(t){dn=t==="dark"?"dark":"light",document.documentElement.setAttribute("data-theme",dn),dn==="dark"?document.body.classList.add("is-dark"):document.body.classList.remove("is-dark")}function yi(t){const e=document.documentElement;for(const[r,i]of Object.entries(t||{}))try{e.style.setProperty(`--${r}`,i)}catch(n){console.warn("[bulmaManager] setThemeVars failed for",r,n)}}const Br={en:{navigation:"Navigation",onThisPage:"On this page",home:"Home",scrollToTop:"Scroll to top",readingTime:"{minutes} min read",searchPlaceholder:"Search…",imagePreviewTitle:"Image preview",imagePreviewFit:"Fit to screen",imagePreviewOriginal:"Original size",imagePreviewZoomOut:"Zoom out",imagePreviewZoomIn:"Zoom in",imagePreviewClose:"Close"},es:{navigation:"Navegación",onThisPage:"En esta página",home:"Inicio",scrollToTop:"Ir arriba",readingTime:"{minutes} min de lectura",searchPlaceholder:"Buscar…",imagePreviewTitle:"Previsualización de imagen",imagePreviewFit:"Ajustar a la pantalla",imagePreviewOriginal:"Tamaño original",imagePreviewZoomOut:"Alejar",imagePreviewZoomIn:"Acercar",imagePreviewClose:"Cerrar"},de:{navigation:"Navigation",onThisPage:"Auf dieser Seite",home:"Startseite",scrollToTop:"Nach oben",readingTime:"{minutes} min Lesezeit",searchPlaceholder:"Suchen…",imagePreviewTitle:"Bildvorschau",imagePreviewFit:"An Bildschirm anpassen",imagePreviewOriginal:"Originalgröße",imagePreviewZoomOut:"Verkleinern",imagePreviewZoomIn:"Vergrößern",imagePreviewClose:"Schließen"},fr:{navigation:"Navigation",onThisPage:"Sur cette page",home:"Accueil",scrollToTop:"Aller en haut",readingTime:"{minutes} min de lecture",searchPlaceholder:"Rechercher…",imagePreviewTitle:"Aperçu de l’image",imagePreviewFit:"Ajuster à l’écran",imagePreviewOriginal:"Taille originale",imagePreviewZoomOut:"Dézoomer",imagePreviewZoomIn:"Zoomer",imagePreviewClose:"Fermer"},pt:{navigation:"Navegação",onThisPage:"Nesta página",home:"Início",scrollToTop:"Ir para o topo",readingTime:"{minutes} min de leitura",searchPlaceholder:"Procurar…",imagePreviewTitle:"Visualização da imagem",imagePreviewFit:"Ajustar à tela",imagePreviewOriginal:"Tamanho original",imagePreviewZoomOut:"Diminuir",imagePreviewZoomIn:"Aumentar",imagePreviewClose:"Fechar"}},at=JSON.parse(JSON.stringify(Br));let jt="en";if(typeof navigator<"u"){const t=navigator.language||navigator.languages&&navigator.languages[0]||"en";jt=String(t).split("-")[0].toLowerCase()}Br[jt]||(jt="en");let Qe=jt;function st(t,e={}){const r=at[Qe]||at.en;let i=r&&r[t]?r[t]:at.en[t]||"";for(const n of Object.keys(e))i=i.replace(new RegExp(`{${n}}`,"g"),String(e[n]));return i}async function Mn(t,e){if(!t)return;let r=t;try{/^https?:\/\//.test(t)||(r=new URL(t,location.origin+e).toString());const i=await fetch(r);if(!i.ok)return;const n=await i.json();for(const s of Object.keys(n||{}))at[s]=Object.assign({},at[s]||{},n[s])}catch{}}function $n(t){const e=String(t).split("-")[0].toLowerCase();Qe=at[e]?e:"en"}const ki=Object.freeze(Object.defineProperty({__proto__:null,get currentLang(){return Qe},loadL10nFile:Mn,setLang:$n,t:st},Symbol.toStringTag,{value:"Module"})),xi=`import { buildSearchIndex, crawlForSlug } from '../slugManager.js'
...
`;function zr(t,e="worker"){let r=null;function i(){if(!r)try{const u=t();r=u||null,u&&u.addEventListener("error",()=>{try{r===u&&(r=null,u.terminate&&u.terminate())}catch(l){console.warn("["+e+"] worker termination failed",l)}})}catch(u){r=null,console.warn("["+e+"] worker init failed",u)}return r}function n(){try{r&&(r.terminate&&r.terminate(),r=null)}catch(u){console.warn("["+e+"] worker termination failed",u)}}function s(u,l=1e3){return new Promise((o,c)=>{const h=i();if(!h)return c(new Error("worker unavailable"));const f=String(Math.random());u.id=f;let p=null;const d=()=>{p&&clearTimeout(p),h.removeEventListener("message",m),h.removeEventListener("error",w)},m=y=>{const x=y.data||{};x.id===f&&(d(),x.error?c(new Error(x.error)):o(x.result))},w=y=>{d(),console.warn("["+e+"] worker error event",y);try{r===h&&(r=null,h.terminate&&h.terminate())}catch(x){console.warn("["+e+"] worker termination failed",x)}c(new Error(y&&y.message||"worker error"))};p=setTimeout(()=>{d(),console.warn("["+e+"] worker timed out");try{r===h&&(r=null,h.terminate&&h.terminate())}catch(y){console.warn("["+e+"] worker termination on timeout failed",y)}c(new Error("worker timeout"))},l),h.addEventListener("message",m),h.addEventListener("error",w);try{h.postMessage(u)}catch(y){d(),c(y)}})}return{get:i,send:s,terminate:n}}function Si(t){try{if(typeof Blob<"u"&&typeof URL<"u"&&t){const e=new Blob([t],{type:"application/javascript"}),r=URL.createObjectURL(e);return new Worker(r,{type:"module"})}}catch(e){console.warn("[worker-manager] createWorkerFromRaw failed",e)}return null}const De=new Set;function Pn(t){vi(),De.clear();for(const e of Le)e&&De.add(e);ur(Y),ur(U),Pn._refreshed=!0}function ur(t){if(!(!t||typeof t.values!="function"))for(const e of t.values())e&&De.add(e)}function hr(t){if(!t||typeof t.set!="function")return;const e=t.set;t.set=function(r,i){return i&&De.add(i),e.call(this,r,i)}}let dr=!1;function vi(){dr||(hr(Y),hr(U),dr=!0)}function Or(t){return!t||typeof t!="string"?!1:/^(https?:)?\/\//.test(t)||t.startsWith("mailto:")||t.startsWith("tel:")}function de(t){return String(t||"").replace(/^[.\/]+/,"")}function At(t){return String(t||"").replace(/\/+$/,"")}function vt(t){return At(t)+"/"}function Ai(t){try{if(!t||typeof document>"u"||!document.head||t.startsWith("data:")||document.head.querySelector(`link[rel="preload"][as="image"][href="${t}"]`))return;const r=document.createElement("link");r.rel="preload",r.as="image",r.href=t,document.head.appendChild(r)}catch(e){console.warn("[helpers] preloadImage failed",e)}}function Ot(t,e=0,r=!1){try{if(typeof window>"u"||!t||!t.querySelectorAll)return;const i=Array.from(t.querySelectorAll("img"));if(!i.length)return;const n=t,s=n&&n.getBoundingClientRect?n.getBoundingClientRect():null,a=0,u=typeof window<"u"&&(window.innerHeight||document.documentElement.clientHeight)||0,l=s?Math.max(a,s.top):a,c=(s?Math.min(u,s.bottom):u)+Number(e||0);let h=0;n&&(h=n.clientHeight||(s?s.height:0)),h||(h=u-a);let f=.6;try{const w=n&&window.getComputedStyle?window.getComputedStyle(n):null,y=w&&w.getPropertyValue("--nimbi-image-max-height-ratio"),x=y?parseFloat(y):NaN;!Number.isNaN(x)&&x>0&&x<=1&&(f=x)}catch(w){console.warn("[helpers] read CSS ratio failed",w)}const p=Math.max(200,Math.floor(h*f));let d=!1,m=null;if(i.forEach(w=>{try{const y=w.getAttribute?w.getAttribute("loading"):void 0;y!=="eager"&&w.setAttribute&&w.setAttribute("loading","lazy");const x=w.getBoundingClientRect?w.getBoundingClientRect():null,z=w.src||w.getAttribute&&w.getAttribute("src"),I=x&&x.height>1?x.height:p,A=x?x.top:0,q=A+I,O=!!(x&&I>0&&A<=c&&q>=l);O&&(w.setAttribute?(w.setAttribute("loading","eager"),w.setAttribute("fetchpriority","high"),w.setAttribute("data-eager-by-nimbi","1")):(w.loading="eager",w.fetchPriority="high"),Ai(z),d=!0),!m&&x&&x.top<=c&&(m={img:w,src:z,rect:x,beforeLoading:y}),r&&console.log("[helpers] setEagerForAboveFoldImages:",{src:z,rect:x,marginPx:e,visibleTop:l,visibleBottom:c,beforeLoading:y,isAboveFold:O,effectiveHeight:I,maxImageHeight:p})}catch(y){console.warn("[helpers] setEagerForAboveFoldImages per-image failed",y)}}),!d&&m){const{img:w,src:y,rect:x,beforeLoading:z}=m;try{w.setAttribute?(w.setAttribute("loading","eager"),w.setAttribute("fetchpriority","high"),w.setAttribute("data-eager-by-nimbi","1")):(w.loading="eager",w.fetchPriority="high"),r&&console.log("[helpers] setEagerForAboveFoldImages (fallback first visible):",{src:y,rect:x,marginPx:e,visibleTop:l,visibleBottom:c,beforeLoading:z,fallback:!0})}catch(I){console.warn("[helpers] setEagerForAboveFoldImages fallback failed",I)}}}catch(i){console.warn("[helpers] setEagerForAboveFoldImages failed",i)}}function Ft(t){try{const e=t();return e&&typeof e.then=="function"?e.catch(r=>{console.warn("[helpers] safe swallowed error",r)}):e}catch(e){console.warn("[helpers] safe swallowed error",e)}}try{typeof globalThis<"u"&&!globalThis.safe&&(globalThis.safe=Ft)}catch(t){console.warn("[helpers] global attach failed",t)}const Y=new Map;let Ce=[],In=!1;function Nr(t){In=!!t}function Dr(t){Ce=Array.isArray(t)?t.slice():[]}function Ei(){return Ce}const Hr=zr(()=>Si(xi),"slugManager");function Bn(){return Hr.get()}function Ur(t){return Hr.send(t)}async function Ri(t,e=1,r=void 0){if(!Bn())return Gt(t,e,r);try{return await Ur({type:"buildSearchIndex",contentBase:t,indexDepth:e,noIndexing:r})}catch(n){try{return await Gt(t,e,r)}catch(s){throw console.warn("[slugManager] buildSearchIndex fallback failed",s),n}}}async function Ti(t,e,r){return Bn()?Ur({type:"crawlForSlug",slug:t,base:e,maxQueue:r}):zn(t,e,r)}function We(t,e){if(t)if(Ce&&Ce.length){const i=e.split("/")[0],n=Ce.includes(i);let s=Y.get(t);(!s||typeof s=="string")&&(s={default:typeof s=="string"?s:void 0,langs:{}}),n?s.langs[i]=e:s.default=e,Y.set(t,s)}else Y.set(t,e)}const Jt=new Set;function Li(t){typeof t=="function"&&Jt.add(t)}function Ci(t){typeof t=="function"&&Jt.delete(t)}const U=new Map;let yn={},Le=[],ot="_404.md",it="_home.md";function kn(t){t!=null&&(ot=String(t||""))}function xn(t){t!=null&&(it=String(t||""))}function _i(t){yn=t||{}}const mt=new Map,Wt=new Set;function Mi(){mt.clear(),Wt.clear()}function $i(t){if(!t||t.length===0)return"";let e=t[0];for(let i=1;i<t.length;i++){const n=t[i];let s=0;const a=Math.min(e.length,n.length);for(;s<a&&e[s]===n[s];)s++;e=e.slice(0,s)}const r=e.lastIndexOf("/");return r===-1?e:e.slice(0,r+1)}function Zt(t){Y.clear(),U.clear(),Le=[],Ce=Ce||[];const e=Object.keys(yn||{});if(!e.length)return;let r="";try{if(t){try{/^[a-z][a-z0-9+.-]*:/i.test(String(t))?r=new URL(String(t)).pathname:r=String(t||"")}catch(i){r=String(t||""),console.warn("[slugManager] parse contentBase failed",i)}r=vt(r)}}catch(i){r="",console.warn("[slugManager] setContentBase prefix derivation failed",i)}r||(r=$i(e));for(const i of e){let n=i;r&&i.startsWith(r)?n=de(i.slice(r.length)):n=de(i),Le.push(n);try{Pn()}catch(a){console.warn("[slugManager] refreshIndexPaths failed",a)}const s=yn[i];if(typeof s=="string"){const a=(s||"").match(/^#\s+(.+)$/m);if(a&&a[1]){const u=ie(a[1].trim());if(u)try{if(Ce&&Ce.length){const o=n.split("/")[0],c=Ce.includes(o);let h=Y.get(u);(!h||typeof h=="string")&&(h={default:typeof h=="string"?h:void 0,langs:{}}),c?h.langs[o]=n:h.default=n,Y.set(u,h)}else Y.set(u,n);U.set(n,u)}catch(l){console.warn("[slugManager] set slug mapping failed",l)}}}}}try{Zt()}catch(t){console.warn("[slugManager] initial setContentBase failed",t)}function ie(t){let r=String(t||"").toLowerCase().replace(/[^a-z0-9\- ]/g,"").replace(/ /g,"-");return r=r.replace(/(?:-?)(?:md|html)$/,""),r.length>80&&(r=r.slice(0,80).replace(/-+$/g,"")),r}function Pi(t){return Et(t,void 0)}function Et(t,e){if(!t)return!1;if(t.startsWith("//"))return!0;if(/^[a-z][a-z0-9+.-]*:/i.test(t)){if(e&&typeof e=="string")try{const r=new URL(t),i=new URL(e);return r.origin!==i.origin?!0:!r.pathname.startsWith(i.pathname)}catch{return!0}return!0}if(t.startsWith("/")&&e&&typeof e=="string")try{const r=new URL(t,e),i=new URL(e);return r.origin!==i.origin?!0:!r.pathname.startsWith(i.pathname)}catch{return!0}return!1}function Dt(t){return t==null?t:String(t).replace(/\\([\\`*_{}\[\]()#+\-.!])/g,(e,r)=>r)}function Rt(t){if(!t||!Y.has(t))return null;const e=Y.get(t);if(!e)return null;if(typeof e=="string")return e;if(Ce&&Ce.length&&Qe&&e.langs&&e.langs[Qe])return e.langs[Qe];if(e.default)return e.default;if(e.langs){const r=Object.keys(e.langs);if(r.length)return e.langs[r[0]]}return null}const wt=new Map;function Ii(){wt.clear()}let ke=async function(t,e){if(!t)throw new Error("path required");try{const s=(String(t||"").match(/([^\/]+)\.md(?:$|[?#])/)||[])[1];if(s&&Y.has(s)){const a=Rt(s)||Y.get(s);a&&a!==t&&(t=a)}}catch(s){console.warn("[slugManager] slug mapping normalization failed",s)}const r=e==null?"":At(String(e));let i="";try{r?/^[a-z][a-z0-9+.-]*:/i.test(r)?i=r.replace(/\/$/,"")+"/"+t.replace(/^\//,""):i=(r.startsWith("/")?"":"/")+r.replace(/\/$/,"")+"/"+t.replace(/^\//,""):i="/"+t.replace(/^\//,"")}catch{i="/"+t.replace(/^\//,"")}if(wt.has(i))return wt.get(i);const n=(async()=>{const s=await fetch(i);if(!s||typeof s.ok!="boolean"||!s.ok){if(s&&s.status===404)try{const h=`${r}/${ot}`,f=await globalThis.fetch(h);if(f&&typeof f.ok=="boolean"&&f.ok)return{raw:await f.text(),status:404}}catch(h){console.warn("[slugManager] fetching fallback 404 failed",h)}let c="";try{s&&typeof s.clone=="function"?c=await s.clone().text():s&&typeof s.text=="function"?c=await s.text():c=""}catch(h){c="",console.warn("[slugManager] reading error body failed",h)}throw console.error("fetchMarkdown failed:",{url:i,status:s?s.status:void 0,statusText:s?s.statusText:void 0,body:c.slice(0,200)}),new Error("failed to fetch md")}const a=await s.text(),u=a.trim().slice(0,16).toLowerCase(),l=u.startsWith("<!doctype")||u.startsWith("<html"),o=l||String(t||"").toLowerCase().endsWith(".html");if(l&&String(t||"").toLowerCase().endsWith(".md")){try{const c=`${r}/${ot}`,h=await globalThis.fetch(c);if(h.ok)return{raw:await h.text(),status:404}}catch(c){console.warn("[slugManager] fetching fallback 404 failed",c)}throw console.error("fetchMarkdown: server returned HTML for .md request",i),new Error("failed to fetch md")}return o?{raw:a,isHtml:!0}:{raw:a}})();return wt.set(i,n),n};function Bi(t){typeof t=="function"&&(ke=t)}const Ht=new Map;function zi(t){if(!t||typeof t!="string")return"";let e=t.replace(/```[\s\S]*?```/g,"");return e=e.replace(/<pre[\s\S]*?<\/pre>/gi,""),e=e.replace(/<code[\s\S]*?<\/code>/gi,""),e=e.replace(/<!--([\s\S]*?)-->/g,""),e=e.replace(/^ {4,}.*$/gm,""),e=e.replace(/`[^`]*`/g,""),e}let Ue=[],ht=null;async function Gt(t,e=1,r=void 0){const i=Array.isArray(r)?Array.from(new Set((r||[]).map(n=>de(String(n||""))))):[];try{const n=de(String(ot||""));n&&!i.includes(n)&&i.push(n)}catch{}if(Ue&&Ue.length&&e===1&&!Ue.some(s=>{try{return i.includes(de(String(s.path||"")))}catch{return!1}}))return Ue;if(ht)return ht;ht=(async()=>{let n=Array.isArray(r)?Array.from(new Set((r||[]).map(o=>de(String(o||""))))):[];try{const o=de(String(ot||""));o&&!n.includes(o)&&n.push(o)}catch{}const s=o=>{if(!n||!n.length)return!1;for(const c of n)if(c&&(o===c||o.startsWith(c+"/")))return!0;return!1};let a=[];if(Le&&Le.length&&(a=Array.from(Le)),!a.length)for(const o of Y.values())o&&a.push(o);try{const o=await Wr(t);o&&o.length&&(a=a.concat(o))}catch(o){console.warn("[slugManager] crawlAllMarkdown during buildSearchIndex failed",o)}try{const o=new Set(a),c=[...a];for(o.size;c.length&&o.size<=Tt;){const h=c.shift();try{const f=await ke(h,t);if(f&&f.raw){if(f.status===404)continue;let p=f.raw;const d=[],m=String(h||"").replace(/^.*\//,"");if(/^readme(?:\.md)?$/i.test(m)&&In&&(!h||!h.includes("/")))continue;const w=zi(p),y=/\[[^\]]+\]\(([^)]+)\)/g;let x;for(;x=y.exec(w);)d.push(x[1]);const z=/<a\s+[^>]*href=["']([^"']+)["'][^>]*>/gi;for(;x=z.exec(w);)d.push(x[1]);const I=h&&h.includes("/")?h.substring(0,h.lastIndexOf("/")+1):"";for(let A of d)try{if(Et(A,t)||A.startsWith("..")||A.indexOf("/../")!==-1||(I&&!A.startsWith("./")&&!A.startsWith("/")&&!A.startsWith("../")&&(A=I+A),A=de(A),!/\.(md|html?)(?:$|[?#])/i.test(A))||(A=A.split(/[?#]/)[0],s(A)))continue;o.has(A)||(o.add(A),c.push(A),a.push(A))}catch(q){console.warn("[slugManager] href processing failed",A,q)}}}catch(f){console.warn("[slugManager] discovery fetch failed for",h,f)}}}catch(o){console.warn("[slugManager] discovery loop failed",o)}const u=new Set;a=a.filter(o=>!o||u.has(o)||s(o)?!1:(u.add(o),!0));const l=[];for(const o of a)if(/\.(?:md|html?)(?:$|[?#])/i.test(o))try{const c=await ke(o,t);if(c&&c.raw){if(c.status===404)continue;let h="",f="";if(c.isHtml)try{const m=new DOMParser().parseFromString(c.raw,"text/html"),w=m.querySelector("title")||m.querySelector("h1");w&&w.textContent&&(h=w.textContent.trim());const y=m.querySelector("p");if(y&&y.textContent&&(f=y.textContent.trim()),e>=2)try{const x=m.querySelector("h1"),z=x&&x.textContent?x.textContent.trim():h||"",I=(()=>{try{if(U.has(o))return U.get(o)}catch{}return ie(h||o)})(),A=Array.from(m.querySelectorAll("h2"));for(const q of A)try{const O=(q.textContent||"").trim();if(!O)continue;const Q=q.id?q.id:ie(O),J=I?`${I}::${Q}`:`${ie(o)}::${Q}`;let ne="",P=q.nextElementSibling;for(;P&&P.tagName&&P.tagName.toLowerCase()==="script";)P=P.nextElementSibling;P&&P.textContent&&(ne=String(P.textContent).trim()),l.push({slug:J,title:O,excerpt:ne,path:o,parentTitle:z})}catch(O){console.warn("[slugManager] indexing H2 failed",O)}if(e===3)try{const q=Array.from(m.querySelectorAll("h3"));for(const O of q)try{const Q=(O.textContent||"").trim();if(!Q)continue;const J=O.id?O.id:ie(Q),ne=I?`${I}::${J}`:`${ie(o)}::${J}`;let P="",T=O.nextElementSibling;for(;T&&T.tagName&&T.tagName.toLowerCase()==="script";)T=T.nextElementSibling;T&&T.textContent&&(P=String(T.textContent).trim()),l.push({slug:ne,title:Q,excerpt:P,path:o,parentTitle:z})}catch(Q){console.warn("[slugManager] indexing H3 failed",Q)}}catch(q){console.warn("[slugManager] collect H3s failed",q)}}catch(x){console.warn("[slugManager] collect H2s failed",x)}}catch(d){console.warn("[slugManager] parsing HTML for index failed",d)}else{const d=c.raw,m=d.match(/^#\s+(.+)$/m);h=m?m[1].trim():"";try{h=Dt(h)}catch{}const w=d.split(/\r?\n\s*\r?\n/);if(w.length>1)for(let y=1;y<w.length;y++){const x=w[y].trim();if(x&&!/^#/.test(x)){f=x.replace(/\r?\n/g," ");break}}if(e>=2){let y="",x="";try{const z=(d.match(/^#\s+(.+)$/m)||[])[1];y=z?z.trim():"",x=(function(){try{if(U.has(o))return U.get(o)}catch{}return ie(h||o)})();const I=/^##\s+(.+)$/gm;let A;for(;A=I.exec(d);)try{const q=(A[1]||"").trim(),O=Dt(q);if(!q)continue;const Q=ie(q),J=x?`${x}::${Q}`:`${ie(o)}::${Q}`,P=d.slice(I.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),T=P&&P[1]?String(P[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";l.push({slug:J,title:O,excerpt:T,path:o,parentTitle:y})}catch(q){console.warn("[slugManager] indexing markdown H2 failed",q)}}catch(z){console.warn("[slugManager] collect markdown H2s failed",z)}if(e===3)try{const z=/^###\s+(.+)$/gm;let I;for(;I=z.exec(d);)try{const A=(I[1]||"").trim(),q=Dt(A);if(!A)continue;const O=ie(A),Q=x?`${x}::${O}`:`${ie(o)}::${O}`,ne=d.slice(z.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),P=ne&&ne[1]?String(ne[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";l.push({slug:Q,title:q,excerpt:P,path:o,parentTitle:y})}catch(A){console.warn("[slugManager] indexing markdown H3 failed",A)}}catch(z){console.warn("[slugManager] collect markdown H3s failed",z)}}}let p="";try{U.has(o)&&(p=U.get(o))}catch(d){console.warn("[slugManager] mdToSlug access failed",d)}p||(p=ie(h||o)),l.push({slug:p,title:h,excerpt:f,path:o})}}catch(c){console.warn("[slugManager] buildSearchIndex: entry fetch failed",c)}try{Ue=l.filter(c=>{try{return!s(String(c.path||""))}catch{return!0}})}catch(o){console.warn("[slugManager] filtering index by excludes failed",o),Ue=l}return Ue})();try{await ht}catch(n){console.warn("[slugManager] awaiting _indexPromise failed",n)}return ht=null,Ue}const qr=1e3;let Tt=qr;function Oi(t){typeof t=="number"&&t>=0&&(Tt=t)}const jr=new DOMParser,Fr="a[href]";let zn=async function(t,e,r=Tt){if(Ht.has(t))return Ht.get(t);let i=null;const n=new Set,s=[""];for(;s.length&&!i&&!(s.length>r);){const a=s.shift();if(n.has(a))continue;n.add(a);let u=e;u.endsWith("/")||(u+="/"),u+=a;try{let l;try{l=await globalThis.fetch(u)}catch(f){console.warn("[slugManager] crawlAllMarkdown: fetch failed",{url:u,error:f});continue}if(!l||!l.ok){l&&!l.ok&&console.warn("[slugManager] crawlAllMarkdown: directory fetch non-ok",{url:u,status:l.status});continue}const o=await l.text(),h=jr.parseFromString(o,"text/html").querySelectorAll(Fr);for(const f of h)try{let p=f.getAttribute("href")||"";if(!p||Et(p,e)||p.startsWith("..")||p.indexOf("/../")!==-1)continue;if(p.endsWith("/")){const d=a+p;n.has(d)||s.push(d);continue}if(p.toLowerCase().endsWith(".md")){const d=de(a+p);try{if(U.has(d))continue;for(const m of Y.values());}catch(m){console.warn("[slugManager] slug map access failed",m)}try{const m=await ke(d,e);if(m&&m.raw){const w=(m.raw||"").match(/^#\s+(.+)$/m);if(w&&w[1]&&ie(w[1].trim())===t){i=d;break}}}catch(m){console.warn("[slugManager] crawlForSlug: fetchMarkdown failed",m)}}}catch(p){console.warn("[slugManager] crawlForSlug: link iteration failed",p)}}catch(l){console.warn("[slugManager] crawlForSlug: directory fetch failed",l)}}return Ht.set(t,i),i};async function Wr(t,e=Tt){const r=new Set,i=new Set,n=[""];for(;n.length&&!(n.length>e);){const s=n.shift();if(i.has(s))continue;i.add(s);let a=t;a.endsWith("/")||(a+="/"),a+=s;try{let u;try{u=await globalThis.fetch(a)}catch(h){console.warn("[slugManager] crawlAllMarkdown: fetch failed",{url:a,error:h});continue}if(!u||!u.ok){u&&!u.ok&&console.warn("[slugManager] crawlAllMarkdown: directory fetch non-ok",{url:a,status:u.status});continue}const l=await u.text(),c=jr.parseFromString(l,"text/html").querySelectorAll(Fr);for(const h of c)try{let f=h.getAttribute("href")||"";if(!f||Et(f,t)||f.startsWith("..")||f.indexOf("/../")!==-1)continue;if(f.endsWith("/")){const d=s+f;i.has(d)||n.push(d);continue}const p=(s+f).replace(/^\/+/,"");/\.(md|html?)$/i.test(p)&&r.add(p)}catch(f){console.warn("[slugManager] crawlAllMarkdown: link iteration failed",f)}}catch(u){console.warn("[slugManager] crawlAllMarkdown: directory fetch failed",u)}}return Array.from(r)}async function Zr(t,e,r){if(t&&typeof t=="string"&&(t=de(t),t=At(t)),Y.has(t))return Rt(t)||Y.get(t);for(const n of Jt)try{const s=await n(t,e);if(s)return We(t,s),U.set(s,t),s}catch(s){console.warn("[slugManager] slug resolver failed",s)}if(Le&&Le.length){if(mt.has(t)){const n=mt.get(t);return Y.set(t,n),U.set(n,t),n}for(const n of Le)if(!Wt.has(n))try{const s=await ke(n,e);if(s&&s.raw){const a=(s.raw||"").match(/^#\s+(.+)$/m);if(a&&a[1]){const u=ie(a[1].trim());if(Wt.add(n),u&&mt.set(u,n),u===t)return We(t,n),U.set(n,t),n}}}catch(s){console.warn("[slugManager] manifest title fetch failed",s)}}try{const n=await Gt(e);if(n&&n.length){const s=n.find(a=>a.slug===t);if(s)return We(t,s.path),U.set(s.path,t),s.path}}catch(n){console.warn("[slugManager] buildSearchIndex lookup failed",n)}try{const n=await zn(t,e,r);if(n)return We(t,n),U.set(n,t),n}catch(n){console.warn("[slugManager] crawlForSlug lookup failed",n)}const i=[`${t}.html`,`${t}.md`];for(const n of i)try{const s=await ke(n,e);if(s&&s.raw)return We(t,n),U.set(n,t),n}catch(s){console.warn("[slugManager] candidate fetch failed",s)}if(Le&&Le.length)for(const n of Le)try{const s=n.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(ie(s)===t)return We(t,n),U.set(n,t),n}catch(s){console.warn("[slugManager] build-time filename match failed",s)}try{const n=[];it&&typeof it=="string"&&it.trim()&&n.push(it),n.includes("_home.md")||n.push("_home.md");for(const s of n)try{const a=await ke(s,e);if(a&&a.raw){const u=(a.raw||"").match(/^#\s+(.+)$/m);if(u&&u[1]&&ie(u[1].trim())===t)return We(t,s),U.set(s,t),s}}catch{}}catch(n){console.warn("[slugManager] home page fetch failed",n)}return null}const Ut=Object.freeze(Object.defineProperty({__proto__:null,CRAWL_MAX_QUEUE:qr,_setAllMd:_i,_storeSlugMapping:We,addSlugResolver:Li,get allMarkdownPaths(){return Le},get availableLanguages(){return Ce},buildSearchIndex:Gt,buildSearchIndexWorker:Ri,clearFetchCache:Ii,clearListCaches:Mi,crawlAllMarkdown:Wr,crawlCache:Ht,crawlForSlug:zn,crawlForSlugWorker:Ti,get defaultCrawlMaxQueue(){return Tt},ensureSlug:Zr,fetchCache:wt,get fetchMarkdown(){return ke},getLanguages:Ei,get homePage(){return it},initSlugWorker:Bn,isExternalLink:Pi,isExternalLinkWithBase:Et,listPathsFetched:Wt,listSlugCache:mt,mdToSlug:U,get notFoundPage(){return ot},removeSlugResolver:Ci,resolveSlugPath:Rt,get searchIndex(){return Ue},setContentBase:Zt,setDefaultCrawlMaxQueue:Oi,setFetchMarkdown:Bi,setHomePage:xn,setLanguages:Dr,setNotFoundPage:kn,setSkipRootReadme:Nr,get skipRootReadme(){return In},slugResolvers:Jt,slugToMd:Y,slugify:ie,unescapeMarkdown:Dt},Symbol.toStringTag,{value:"Module"}));let Gr=100;function pr(t){Gr=t}let bt=300*1e3;function fr(t){bt=t}const Me=new Map;function Ni(t){if(!Me.has(t))return;const e=Me.get(t),r=Date.now();if(e.ts+bt<r){Me.delete(t);return}return Me.delete(t),Me.set(t,e),e.value}function Di(t,e){if(gr(),gr(),Me.delete(t),Me.set(t,{value:e,ts:Date.now()}),Me.size>Gr){const r=Me.keys().next().value;r!==void 0&&Me.delete(r)}}function gr(){if(!bt||bt<=0)return;const t=Date.now();for(const[e,r]of Me.entries())r.ts+bt<t&&Me.delete(e)}async function Hi(t,e){const r=new Set(De),i=document.querySelectorAll(".nimbi-site-navbar a, .navbar a, .nimbi-nav a");for(const n of Array.from(i||[])){const s=n.getAttribute("href")||"";if(s)try{const a=new URL(s,location.href);if(a.origin!==location.origin)continue;const u=(a.hash||a.pathname).match(/([^#?]+\.md)(?:$|[?#])/)||(a.pathname||"").match(/([^#?]+\.md)(?:$|[?#])/);if(u){let o=de(u[1]);o&&r.add(o);continue}const l=a.pathname||"";if(l){const o=new URL(e),c=vt(o.pathname);if(l.indexOf(c)!==-1){let h=l.startsWith(c)?l.slice(c.length):l;h=de(h),h&&r.add(h)}}}catch(a){console.warn("[router] malformed URL while discovering index candidates",a)}}for(const n of r)try{if(!n||!String(n).includes(".md"))continue;const s=await ke(n,e);if(!s||!s.raw)continue;const a=(s.raw||"").match(/^#\s+(.+)$/m);if(a){const u=(a[1]||"").trim();if(u&&ie(u)===t)return n}}catch(s){console.warn("[router] fetchMarkdown during index discovery failed",s)}return null}function Ui(t){const e=[];if(String(t).includes(".md")||String(t).includes(".html"))/index\.html$/i.test(t)||e.push(t);else try{const r=decodeURIComponent(String(t||""));if(Y.has(r)){const i=Rt(r)||Y.get(r);i&&(/\.(md|html?)$/i.test(i)?/index\.html$/i.test(i)||e.push(i):(e.push(i),e.push(i+".html")))}else{if(De&&De.size)for(const i of De){const n=i.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(ie(n)===r&&!/index\.html$/i.test(i)){e.push(i);break}}!e.length&&r&&!/\.(md|html?)$/i.test(r)&&(e.push(r+".html"),e.push(r+".md"))}}catch(r){console.warn("[router] buildPageCandidates failed during slug handling",r)}return e}async function qi(t,e){const r=t||"",i=location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null;let n=t||"",s=null;if(n&&String(n).includes("::")){const d=String(n).split("::",2);n=d[0],s=d[1]||null}const u=`${t}|||${typeof ki<"u"&&Qe?Qe:""}`,l=Ni(u);if(l)n=l.resolved,s=l.anchor||s;else{if(!String(n).includes(".md")&&!String(n).includes(".html")){let d=decodeURIComponent(String(n||""));if(d&&typeof d=="string"&&(d=de(d),d=At(d)),Y.has(d))n=Rt(d)||Y.get(d);else{let m=await Hi(d,e);if(m)n=m;else if(Pn._refreshed&&De&&De.size||typeof e=="string"&&/^[a-z][a-z0-9+.-]*:\/\//i.test(e)){const w=await Zr(d,e);w&&(n=w)}}}Di(u,{resolved:n,anchor:s})}!s&&i&&(s=i);const o=Ui(n),c=String(r||"").includes(".md")||String(r||"").includes(".html");if(c&&o.length===0&&(String(n).includes(".md")||String(n).includes(".html"))&&o.push(n),o.length===0&&(String(n).includes(".md")||String(n).includes(".html"))&&o.push(n),o.length===1&&/index\.html$/i.test(o[0])&&!c&&!Y.has(n)&&!Y.has(decodeURIComponent(String(n||"")))&&!String(n||"").includes("/"))throw new Error("Unknown slug: index.html fallback prevented");let h=null,f=null,p=null;for(const d of o)if(d)try{const m=de(d);h=await ke(m,e),f=m;break}catch(m){p=m;try{console.warn("[router] candidate fetch failed",{candidate:d,contentBase:e,err:m&&m.message||m})}catch{}}if(!h){try{console.error("[router] fetchPageData: no page data for",{originalRaw:r,resolved:n,pageCandidates:o,contentBase:e,fetchError:p&&(p.message||String(p))||null})}catch{}try{if(c&&String(r||"").toLowerCase().includes(".html"))try{const d=new URL(String(r||""),location.href).toString();console.warn("[router] attempting absolute HTML fetch fallback",d);const m=await fetch(d);if(m&&m.ok){const w=await m.text(),y=m&&m.headers&&typeof m.headers.get=="function"&&m.headers.get("content-type")||"",x=(w||"").toLowerCase(),z=y&&y.indexOf&&y.indexOf("text/html")!==-1||x.indexOf("<!doctype")!==-1||x.indexOf("<html")!==-1;if(z||console.warn("[router] absolute fetch returned non-HTML",{abs:d,contentType:y,snippet:x.slice(0,200)}),z)try{const I=d,A=new URL(".",I).toString();try{const O=typeof DOMParser<"u"?new DOMParser:null;if(O){const Q=O.parseFromString(w||"","text/html"),J=($,L)=>{try{const v=L.getAttribute($)||"";if(!v||/^(https?:)?\/\//i.test(v)||v.startsWith("/")||v.startsWith("#"))return;try{const b=new URL(v,I).toString();L.setAttribute($,b)}catch(b){console.warn("[router] rewrite attribute failed",$,b)}}catch(v){console.warn("[router] rewrite helper failed",v)}},ne=Q.querySelectorAll("[src],[href],[srcset],[xlink:href],[poster]"),P=[];for(const $ of Array.from(ne||[]))try{const L=$.tagName?$.tagName.toLowerCase():"";if(L==="a")continue;if($.hasAttribute("src")){const v=$.getAttribute("src");J("src",$);const b=$.getAttribute("src");v!==b&&P.push({attr:"src",tag:L,before:v,after:b})}if($.hasAttribute("href")&&L==="link"){const v=$.getAttribute("href");J("href",$);const b=$.getAttribute("href");v!==b&&P.push({attr:"href",tag:L,before:v,after:b})}if($.hasAttribute("href")&&L!=="link"){const v=$.getAttribute("href");J("href",$);const b=$.getAttribute("href");v!==b&&P.push({attr:"href",tag:L,before:v,after:b})}if($.hasAttribute("xlink:href")){const v=$.getAttribute("xlink:href");J("xlink:href",$);const b=$.getAttribute("xlink:href");v!==b&&P.push({attr:"xlink:href",tag:L,before:v,after:b})}if($.hasAttribute("poster")){const v=$.getAttribute("poster");J("poster",$);const b=$.getAttribute("poster");v!==b&&P.push({attr:"poster",tag:L,before:v,after:b})}if($.hasAttribute("srcset")){const E=($.getAttribute("srcset")||"").split(",").map(M=>M.trim()).filter(Boolean).map(M=>{const[k,X]=M.split(/\s+/,2);if(!k||/^(https?:)?\/\//i.test(k)||k.startsWith("/"))return M;try{const he=new URL(k,I).toString();return X?`${he} ${X}`:he}catch{return M}}).join(", ");$.setAttribute("srcset",E)}}catch{}const T=Q.documentElement&&Q.documentElement.outerHTML?Q.documentElement.outerHTML:w;try{P&&P.length&&console.warn("[router] rewritten asset refs",{abs:d,rewritten:P})}catch{}return{data:{raw:T,isHtml:!0},pagePath:String(r||""),anchor:s}}}catch{}let q=w;return/<base\s+[^>]*>/i.test(w)||(/<head[^>]*>/i.test(w)?q=w.replace(/(<head[^>]*>)/i,`$1<base href="${A}">`):q=`<base href="${A}">`+w),{data:{raw:q,isHtml:!0},pagePath:String(r||""),anchor:s}}catch{return{data:{raw:w,isHtml:!0},pagePath:String(r||""),anchor:s}}}}catch(d){console.warn("[router] absolute HTML fetch fallback failed",d)}}catch{}throw new Error("no page data")}return{data:h,pagePath:f,anchor:s}}function On(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var et=On();function Qr(t){et=t}var Ve={exec:()=>null};function te(t,e=""){let r=typeof t=="string"?t:t.source,i={replace:(n,s)=>{let a=typeof s=="string"?s:s.source;return a=a.replace(Ee.caret,"$1"),r=r.replace(n,a),i},getRegex:()=>new RegExp(r,e)};return i}var ji=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),Ee={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:t=>new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}#`),htmlBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}>`)},Fi=/^(?:[ \t]*(?:\n|$))+/,Wi=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Zi=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Lt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Gi=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Nn=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,Xr=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Kr=te(Xr).replace(/bull/g,Nn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Qi=te(Xr).replace(/bull/g,Nn).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Dn=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Xi=/^[^\n]+/,Hn=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Ki=te(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Hn).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Yi=te(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Nn).getRegex(),en="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Un=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Vi=te("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Un).replace("tag",en).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Yr=te(Dn).replace("hr",Lt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",en).getRegex(),Ji=te(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Yr).getRegex(),qn={blockquote:Ji,code:Wi,def:Ki,fences:Zi,heading:Gi,hr:Lt,html:Vi,lheading:Kr,list:Yi,newline:Fi,paragraph:Yr,table:Ve,text:Xi},mr=te("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Lt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",en).getRegex(),ea={...qn,lheading:Qi,table:mr,paragraph:te(Dn).replace("hr",Lt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",mr).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",en).getRegex()},ta={...qn,html:te(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Un).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ve,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:te(Dn).replace("hr",Lt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Kr).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},na=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,ra=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Vr=/^( {2,}|\\)\n(?!\s*$)/,sa=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,tn=/[\p{P}\p{S}]/u,jn=/[\s\p{P}\p{S}]/u,Jr=/[^\s\p{P}\p{S}]/u,ia=te(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,jn).getRegex(),es=/(?!~)[\p{P}\p{S}]/u,aa=/(?!~)[\s\p{P}\p{S}]/u,la=/(?:[^\s\p{P}\p{S}]|~)/u,ts=/(?![*_])[\p{P}\p{S}]/u,oa=/(?![*_])[\s\p{P}\p{S}]/u,ca=/(?:[^\s\p{P}\p{S}]|[*_])/u,ua=te(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",ji?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),ns=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,ha=te(ns,"u").replace(/punct/g,tn).getRegex(),da=te(ns,"u").replace(/punct/g,es).getRegex(),rs="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",pa=te(rs,"gu").replace(/notPunctSpace/g,Jr).replace(/punctSpace/g,jn).replace(/punct/g,tn).getRegex(),fa=te(rs,"gu").replace(/notPunctSpace/g,la).replace(/punctSpace/g,aa).replace(/punct/g,es).getRegex(),ga=te("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Jr).replace(/punctSpace/g,jn).replace(/punct/g,tn).getRegex(),ma=te(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,ts).getRegex(),wa="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",ba=te(wa,"gu").replace(/notPunctSpace/g,ca).replace(/punctSpace/g,oa).replace(/punct/g,ts).getRegex(),ya=te(/\\(punct)/,"gu").replace(/punct/g,tn).getRegex(),ka=te(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),xa=te(Un).replace("(?:-->|$)","-->").getRegex(),Sa=te("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",xa).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Qt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,va=te(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",Qt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),ss=te(/^!?\[(label)\]\[(ref)\]/).replace("label",Qt).replace("ref",Hn).getRegex(),is=te(/^!?\[(ref)\](?:\[\])?/).replace("ref",Hn).getRegex(),Aa=te("reflink|nolink(?!\\()","g").replace("reflink",ss).replace("nolink",is).getRegex(),wr=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Fn={_backpedal:Ve,anyPunctuation:ya,autolink:ka,blockSkip:ua,br:Vr,code:ra,del:Ve,delLDelim:Ve,delRDelim:Ve,emStrongLDelim:ha,emStrongRDelimAst:pa,emStrongRDelimUnd:ga,escape:na,link:va,nolink:is,punctuation:ia,reflink:ss,reflinkSearch:Aa,tag:Sa,text:sa,url:Ve},Ea={...Fn,link:te(/^!?\[(label)\]\((.*?)\)/).replace("label",Qt).getRegex(),reflink:te(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Qt).getRegex()},Sn={...Fn,emStrongRDelimAst:fa,emStrongLDelim:da,delLDelim:ma,delRDelim:ba,url:te(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",wr).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:te(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",wr).getRegex()},Ra={...Sn,br:te(Vr).replace("{2,}","*").getRegex(),text:te(Sn.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Nt={normal:qn,gfm:ea,pedantic:ta},dt={normal:Fn,gfm:Sn,breaks:Ra,pedantic:Ea},Ta={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},br=t=>Ta[t];function Ne(t,e){if(e){if(Ee.escapeTest.test(t))return t.replace(Ee.escapeReplace,br)}else if(Ee.escapeTestNoEncode.test(t))return t.replace(Ee.escapeReplaceNoEncode,br);return t}function yr(t){try{t=encodeURI(t).replace(Ee.percentDecode,"%")}catch{return null}return t}function kr(t,e){let r=t.replace(Ee.findPipe,(s,a,u)=>{let l=!1,o=a;for(;--o>=0&&u[o]==="\\";)l=!l;return l?"|":" |"}),i=r.split(Ee.splitPipe),n=0;if(i[0].trim()||i.shift(),i.length>0&&!i.at(-1)?.trim()&&i.pop(),e)if(i.length>e)i.splice(e);else for(;i.length<e;)i.push("");for(;n<i.length;n++)i[n]=i[n].trim().replace(Ee.slashPipe,"|");return i}function pt(t,e,r){let i=t.length;if(i===0)return"";let n=0;for(;n<i&&t.charAt(i-n-1)===e;)n++;return t.slice(0,i-n)}function La(t,e){if(t.indexOf(e[1])===-1)return-1;let r=0;for(let i=0;i<t.length;i++)if(t[i]==="\\")i++;else if(t[i]===e[0])r++;else if(t[i]===e[1]&&(r--,r<0))return i;return r>0?-2:-1}function Ca(t,e=0){let r=e,i="";for(let n of t)if(n==="	"){let s=4-r%4;i+=" ".repeat(s),r+=s}else i+=n,r++;return i}function xr(t,e,r,i,n){let s=e.href,a=e.title||null,u=t[1].replace(n.other.outputLinkReplace,"$1");i.state.inLink=!0;let l={type:t[0].charAt(0)==="!"?"image":"link",raw:r,href:s,title:a,text:u,tokens:i.inlineTokens(u)};return i.state.inLink=!1,l}function _a(t,e,r){let i=t.match(r.other.indentCodeCompensation);if(i===null)return e;let n=i[1];return e.split(`
...
`)}}}fences(t){let e=this.rules.block.fences.exec(t);if(e){let r=e[0],i=_a(r,e[3]||"",this.rules);return{type:"code",raw:r,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:i}}}heading(t){let e=this.rules.block.heading.exec(t);if(e){let r=e[2].trim();if(this.rules.other.endingHash.test(r)){let i=pt(r,"#");(this.options.pedantic||!i||this.rules.other.endingSpaceChar.test(i))&&(r=i.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:r,tokens:this.lexer.inline(r)}}}hr(t){let e=this.rules.block.hr.exec(t);if(e)return{type:"hr",raw:pt(e[0],`
...
`;for(let w=l;w<=o;w++)if((e(f[w])||!h(f[w])&&(h(f[w+1])||e(f[w+1])))&&u++,e(f[w]))for(;w<=o&&(i(f[w+1])||h(f[w+1]));)w++;const p=u/c,d=Math.round(p*60*1e3);return{text:Math.ceil(p.toFixed(2))+" min read",minutes:p,time:d,words:u}}return gn=n,gn}var Ya=Ka();const Va=Mr(Ya);function Cr(t,e){let r=document.querySelector(`meta[name="${t}"]`);r||(r=document.createElement("meta"),r.setAttribute("name",t),document.head.appendChild(r)),r.setAttribute("content",e)}function rt(t,e,r){let i=`meta[${t}="${e}"]`,n=document.querySelector(i);n||(n=document.createElement("meta"),n.setAttribute(t,e),document.head.appendChild(n)),n.setAttribute("content",r)}function Ja(t,e){try{let r=document.querySelector(`link[rel="${t}"]`);r||(r=document.createElement("link"),r.setAttribute("rel",t),document.head.appendChild(r)),r.setAttribute("href",e)}catch(r){console.warn("[seoManager] upsertLinkRel failed",r)}}function el(t,e,r,i){const n=e&&String(e).trim()?e:t.title||document.title;rt("property","og:title",n);const s=i&&String(i).trim()?i:t.description||"";s&&String(s).trim()&&rt("property","og:description",s),rt("name","twitter:card",t.twitter_card||"summary_large_image");const a=r||t.image;a&&(rt("property","og:image",a),rt("name","twitter:image",a))}function tl(t,e,r,i,n=""){const s=t.meta||{},a=document&&document.querySelector&&document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",u=i&&String(i).trim()?i:s.description&&String(s.description).trim()?s.description:a&&String(a).trim()?a:"";u&&String(u).trim()&&Cr("description",u),Cr("robots",s.robots||"index,follow"),el(s,e,r,u)}function nl(){try{const t=['meta[name="site"]','meta[name="site-name"]','meta[name="siteName"]','meta[property="og:site_name"]','meta[name="twitter:site"]'];for(const e of t){const r=document.querySelector(e);if(r){const i=r.getAttribute("content")||"";if(i&&i.trim())return i.trim()}}}catch(t){console.warn("[seoManager] getSiteNameFromMeta failed",t)}return""}function rl(t,e,r,i,n,s=""){try{const a=t.meta||{},u=r&&String(r).trim()?r:a.title||s||document.title,l=n&&String(n).trim()?n:a.description||document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",o=i||a.image||null;let c="";try{if(e){const d=de(e);try{c=(location.origin+location.pathname).split("?")[0]+"?page="+encodeURIComponent(d)}catch{c=location.href.split("#")[0]}}else c=location.href.split("#")[0]}catch(d){c=location.href.split("#")[0],console.warn("[seoManager] compute canonical failed",d)}c&&Ja("canonical",c);try{rt("property","og:url",c)}catch(d){console.warn("[seoManager] upsertMeta og:url failed",d)}const h={"@context":"https://schema.org","@type":"Article",headline:u||"",description:l||"",url:c||location.href.split("#")[0]};o&&(h.image=String(o)),a.date&&(h.datePublished=a.date),a.dateModified&&(h.dateModified=a.dateModified);const f="nimbi-jsonld";let p=document.getElementById(f);p||(p=document.createElement("script"),p.type="application/ld+json",p.id=f,document.head.appendChild(p)),p.textContent=JSON.stringify(h,null,2)}catch(a){console.warn("[seoManager] setStructuredData failed",a)}}function sl(t,e,r,i,n,s,a,u,l,o,c){try{const h=i.querySelector(".menu-label");h&&(h.textContent=u&&u.textContent||t("onThisPage"))}catch(h){console.warn("[seoManager] update toc label failed",h)}try{const h=r.meta&&r.meta.title?String(r.meta.title).trim():"",f=n.querySelector("img"),p=f&&(f.getAttribute("src")||f.src)||null;let d="";try{let w="";try{const y=u||(n&&n.querySelector?n.querySelector("h1"):null);if(y){let x=y.nextElementSibling;const z=[];for(;x&&!(x.tagName&&x.tagName.toLowerCase()==="h2");){const I=(x.textContent||"").trim();I&&z.push(I),x=x.nextElementSibling}z.length&&(w=z.join(" ").replace(/\s+/g," ").trim()),!w&&l&&(w=String(l).trim())}}catch(y){console.warn("[seoManager] compute descOverride failed",y)}w&&String(w).length>160&&(w=String(w).slice(0,157).trim()+"..."),d=w}catch(w){console.warn("[seoManager] compute descOverride failed",w)}try{tl(r,l,p,d)}catch(w){console.warn("[seoManager] setMetaTags failed",w)}try{rl(r,o,l,p,d,e)}catch(w){console.warn("[seoManager] setStructuredData failed",w)}const m=nl();l?m?document.title=`${m} - ${l}`:document.title=`${e||"Site"} - ${l}`:h?document.title=h:document.title=e||document.title}catch(h){console.warn("[seoManager] applyPageMeta failed",h)}try{const h=n.querySelector(".nimbi-reading-time");if(h&&h.remove(),l){const f=Va(c.raw||""),p=f&&typeof f.minutes=="number"?Math.ceil(f.minutes):0,d=document.createElement("p");d.className="nimbi-reading-time",d.textContent=p?t("readingTime",{minutes:p}):"";const m=n.querySelector("h1");m&&m.insertAdjacentElement("afterend",d)}}catch(h){console.warn("[seoManager] reading time update failed",h)}}let ve=null,W=null,Ae=1,Ze=(t,e)=>e,yt=0,kt=0,qt=()=>{},gt=.25;function il(){if(ve&&document.contains(ve))return ve;ve=null;const t=document.createElement("dialog");t.className="nimbi-image-preview",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label",Ze("imagePreviewTitle","Image preview")),t.innerHTML=`
  ...
  `,t.addEventListener("click",b=>{b.target===t&&mn()}),t.addEventListener("wheel",b=>{if(!ne())return;b.preventDefault();const E=b.deltaY<0?gt:-gt;qe(Ae+E),o(),c()},{passive:!1}),t.addEventListener("keydown",b=>{if(b.key==="Escape"){mn();return}if(Ae>1){const E=t.querySelector(".nimbi-image-preview__image-wrapper");if(!E)return;const M=40;switch(b.key){case"ArrowUp":E.scrollTop-=M,b.preventDefault();break;case"ArrowDown":E.scrollTop+=M,b.preventDefault();break;case"ArrowLeft":E.scrollLeft-=M,b.preventDefault();break;case"ArrowRight":E.scrollLeft+=M,b.preventDefault();break}}}),document.body.appendChild(t),ve=t,W=t.querySelector("[data-nimbi-preview-image]");const e=t.querySelector("[data-nimbi-preview-fit]"),r=t.querySelector("[data-nimbi-preview-original]"),i=t.querySelector("[data-nimbi-preview-zoom-in]"),n=t.querySelector("[data-nimbi-preview-zoom-out]"),s=t.querySelector("[data-nimbi-preview-reset]"),a=t.querySelector("[data-nimbi-preview-close]"),u=t.querySelector("[data-nimbi-preview-zoom-label]"),l=t.querySelector("[data-nimbi-preview-zoom-hud]");function o(){u&&(u.textContent=`${Math.round(Ae*100)}%`)}const c=()=>{l&&(l.textContent=`${Math.round(Ae*100)}%`,l.classList.add("visible"),clearTimeout(l._timeout),l._timeout=setTimeout(()=>l.classList.remove("visible"),800))};qt=o,i.addEventListener("click",()=>{qe(Ae+gt),o(),c()}),n.addEventListener("click",()=>{qe(Ae-gt),o(),c()}),e.addEventListener("click",()=>{xt(),o(),c()}),r.addEventListener("click",()=>{qe(1),o(),c()}),s.addEventListener("click",()=>{xt(),o(),c()}),a.addEventListener("click",mn),e.title=Ze("imagePreviewFit","Fit to screen"),r.title=Ze("imagePreviewOriginal","Original size"),n.title=Ze("imagePreviewZoomOut","Zoom out"),i.title=Ze("imagePreviewZoomIn","Zoom in"),a.title=Ze("imagePreviewClose","Close"),a.setAttribute("aria-label",Ze("imagePreviewClose","Close"));let h=!1,f=0,p=0,d=0,m=0;const w=new Map;let y=0,x=1;const z=(b,E)=>{const M=b.x-E.x,k=b.y-E.y;return Math.hypot(M,k)},I=()=>{h=!1,w.clear(),y=0,W&&(W.style.cursor="all-scroll")};let A=0,q=0,O=0;const Q=b=>{const E=Date.now(),M=E-A,k=b.clientX-q,X=b.clientY-O;A=E,q=b.clientX,O=b.clientY,M<300&&Math.hypot(k,X)<30&&(qe(Ae>1?1:2),o(),b.preventDefault())},J=b=>{qe(Ae>1?1:2),o(),b.preventDefault()},ne=()=>ve?typeof ve.open=="boolean"?ve.open:ve.classList.contains("is-active"):!1,P=(b,E,M=1)=>{if(w.has(M)&&w.set(M,{x:b,y:E}),w.size===2){const xe=Array.from(w.values()),be=z(xe[0],xe[1]);if(y>0){const j=be/y;qe(x*j)}return}if(!h)return;const k=W.closest(".nimbi-image-preview__image-wrapper");if(!k)return;const X=b-f,he=E-p;k.scrollLeft=d-X,k.scrollTop=m-he},T=(b,E,M=1)=>{if(!ne())return;if(w.set(M,{x:b,y:E}),w.size===2){const he=Array.from(w.values());y=z(he[0],he[1]),x=Ae;return}const k=W.closest(".nimbi-image-preview__image-wrapper");!k||!(k.scrollWidth>k.clientWidth||k.scrollHeight>k.clientHeight)||(h=!0,f=b,p=E,d=k.scrollLeft,m=k.scrollTop,W.style.cursor="all-scroll",window.addEventListener("pointermove",$),window.addEventListener("pointerup",L),window.addEventListener("pointercancel",L))},$=b=>{h&&(b.preventDefault(),P(b.clientX,b.clientY,b.pointerId))},L=()=>{I(),window.removeEventListener("pointermove",$),window.removeEventListener("pointerup",L),window.removeEventListener("pointercancel",L)};W.addEventListener("pointerdown",b=>{b.preventDefault(),T(b.clientX,b.clientY,b.pointerId)}),W.addEventListener("pointermove",b=>{(h||w.size===2)&&b.preventDefault(),P(b.clientX,b.clientY,b.pointerId)}),W.addEventListener("pointerup",b=>{b.preventDefault(),b.pointerType==="touch"&&Q(b),I()}),W.addEventListener("dblclick",J),W.addEventListener("pointercancel",I),W.addEventListener("mousedown",b=>{b.preventDefault(),T(b.clientX,b.clientY,1)}),W.addEventListener("mousemove",b=>{h&&b.preventDefault(),P(b.clientX,b.clientY,1)}),W.addEventListener("mouseup",b=>{b.preventDefault(),I()});const v=t.querySelector(".nimbi-image-preview__image-wrapper");return v&&(v.addEventListener("pointerdown",b=>{T(b.clientX,b.clientY,b.pointerId)}),v.addEventListener("pointermove",b=>{P(b.clientX,b.clientY,b.pointerId)}),v.addEventListener("pointerup",I),v.addEventListener("pointercancel",I),v.addEventListener("mousedown",b=>{T(b.clientX,b.clientY,1)}),v.addEventListener("mousemove",b=>{P(b.clientX,b.clientY,1)}),v.addEventListener("mouseup",I)),t}function qe(t){if(!W)return;const e=Number(t);Ae=Number.isFinite(e)?Math.max(.1,Math.min(4,e)):1;const i=W.getBoundingClientRect(),n=yt||W.naturalWidth||W.width||i.width||0,s=kt||W.naturalHeight||W.height||i.height||0;n&&s?(W.style.maxWidth="none",W.style.maxHeight="none",W.style.width=`${n*Ae}px`,W.style.height=`${s*Ae}px`,W.style.transform=""):(W.style.maxWidth="",W.style.maxHeight="",W.style.width="",W.style.height="",W.style.transform=`scale(${Ae})`),W&&(W.style.cursor="all-scroll")}function xt(){if(!W)return;const t=W.closest(".nimbi-image-preview__image-wrapper");if(!t)return;const e=t.getBoundingClientRect();if(e.width===0||e.height===0)return;const r=yt||W.naturalWidth||e.width,i=kt||W.naturalHeight||e.height;if(!r||!i)return;const n=e.width/r,s=e.height/i,a=Math.min(n,s,1);qe(Number.isFinite(a)?a:1)}function al(t,e="",r=0,i=0){const n=il();Ae=1,yt=r||0,kt=i||0,W.src=t,W.alt=e,W.style.transform="scale(1)";const s=()=>{yt=W.naturalWidth||W.width||0,kt=W.naturalHeight||W.height||0};if(s(),xt(),qt(),requestAnimationFrame(()=>{xt(),qt()}),!yt||!kt){const a=()=>{s(),requestAnimationFrame(()=>{xt(),qt()}),W.removeEventListener("load",a)};W.addEventListener("load",a)}typeof n.showModal=="function"&&(n.open||n.showModal()),n.classList.add("is-active"),n.focus()}function mn(){ve&&(typeof ve.close=="function"&&ve.open&&ve.close(),ve.classList.remove("is-active"))}function ll(t,{t:e,zoomStep:r=.25}={}){if(!t||!t.querySelectorAll)return;Ze=(p,d)=>(typeof e=="function"?e(p):void 0)||d,gt=r,t.addEventListener("click",p=>{const d=p.target;if(!d||d.tagName!=="IMG")return;const m=d;if(m.src){if(p.defaultPrevented!==!0){const w=m.closest("a");w&&w.getAttribute("href")&&p.preventDefault()}al(m.src,m.alt||"",m.naturalWidth||0,m.naturalHeight||0)}});let i=!1,n=0,s=0,a=0,u=0;const l=new Map;let o=0,c=1;const h=(p,d)=>{const m=p.x-d.x,w=p.y-d.y;return Math.hypot(m,w)};t.addEventListener("pointerdown",p=>{const d=p.target;if(!d||d.tagName!=="IMG"||!ve||!ve.open)return;if(l.set(p.pointerId,{x:p.clientX,y:p.clientY}),l.size===2){const w=Array.from(l.values());o=h(w[0],w[1]),c=Ae;return}const m=d.closest(".nimbi-image-preview__image-wrapper");m&&(Ae<=1||(p.preventDefault(),i=!0,n=p.clientX,s=p.clientY,a=m.scrollLeft,u=m.scrollTop,d.setPointerCapture(p.pointerId),d.style.cursor="grabbing"))}),t.addEventListener("pointermove",p=>{if(l.has(p.pointerId)&&l.set(p.pointerId,{x:p.clientX,y:p.clientY}),l.size===2){p.preventDefault();const x=Array.from(l.values()),z=h(x[0],x[1]);if(o>0){const I=z/o;qe(c*I)}return}if(!i)return;p.preventDefault();const m=p.target.closest(".nimbi-image-preview__image-wrapper");if(!m)return;const w=p.clientX-n,y=p.clientY-s;m.scrollLeft=a-w,m.scrollTop=u-y});const f=()=>{i=!1,l.clear(),o=0};t.addEventListener("pointerup",f),t.addEventListener("pointercancel",f)}function ol(t){const{contentWrap:e,navWrap:r,container:i,mountOverlay:n=null,t:s,contentBase:a,homePage:u,initialDocumentTitle:l,runHooks:o}=t||{};if(!e||!(e instanceof HTMLElement))throw new TypeError("contentWrap must be an HTMLElement");let c=null;const h=Oa(s,[{path:u,name:s("home"),isIndex:!0,children:[]}]);async function f(y,x){let z,I,A;try{({data:z,pagePath:I,anchor:A}=await qi(y,a))}catch(T){console.error("[nimbi-cms] fetchPageData failed",T),Tr(e,s,T);return}!A&&x&&(A=x);try{Ln(null)}catch(T){console.warn("[nimbi-cms] scrollToAnchorOrTop failed",T)}e.innerHTML="";const{article:q,parsed:O,toc:Q,topH1:J,h1Text:ne,slugKey:P}=await Wa(s,z,I,A,a);sl(s,l,O,Q,q,I,A,J,ne,P,z),r.innerHTML="",r.appendChild(Q),Ga(Q);try{await o("transformHtml",{article:q,parsed:O,toc:Q,pagePath:I,anchor:A,topH1:J,h1Text:ne,slugKey:P,data:z})}catch(T){console.warn("[nimbi-cms] transformHtml hooks failed",T)}e.appendChild(q);try{ll(q,{t:s})}catch(T){console.warn("[nimbi-cms] attachImagePreview failed",T)}try{Ot(i,100,!1),requestAnimationFrame(()=>Ot(i,100,!1)),setTimeout(()=>Ot(i,100,!1),250)}catch(T){console.warn("[nimbi-cms] setEagerForAboveFoldImages failed",T)}Ln(A),Qa(q,J,{mountOverlay:n,container:i,navWrap:r,t:s});try{await o("onPageLoad",{data:z,pagePath:I,anchor:A,article:q,toc:Q,topH1:J,h1Text:ne,slugKey:P,contentWrap:e,navWrap:r})}catch(T){console.warn("[nimbi-cms] onPageLoad hooks failed",T)}c=I}async function p(){let y=new URLSearchParams(location.search).get("page")||u;const x=location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null;try{await f(y,x)}catch(z){console.warn("[nimbi-cms] renderByQuery failed for",y,z),Tr(e,s,z)}}window.addEventListener("popstate",p);const d=()=>`nimbi-cms-scroll:${location.pathname}${location.search}`,m=()=>{try{const y=i||document.querySelector(".nimbi-cms");if(!y)return;const x={top:y.scrollTop||0,left:y.scrollLeft||0};sessionStorage.setItem(d(),JSON.stringify(x))}catch{}},w=()=>{try{const y=i||document.querySelector(".nimbi-cms");if(!y)return;const x=sessionStorage.getItem(d());if(!x)return;const z=JSON.parse(x);z&&typeof z.top=="number"&&y.scrollTo({top:z.top,left:z.left||0,behavior:"auto"})}catch{}};return window.addEventListener("pageshow",y=>{if(y.persisted)try{w(),Ot(i,100,!1)}catch(x){console.warn("[nimbi-cms] bfcache restore failed",x)}}),window.addEventListener("pagehide",()=>{try{m()}catch(y){console.warn("[nimbi-cms] save scroll position failed",y)}}),{renderByQuery:p,siteNav:h,getCurrentPagePath:()=>c}}function cl(t){try{const e=typeof t=="string"?t:typeof window<"u"&&window.location?window.location.search:"";if(!e)return{};const r=new URLSearchParams(e.startsWith("?")?e.slice(1):e),i={},n=s=>{if(s==null)return;const a=String(s).toLowerCase();if(a==="1"||a==="true"||a==="yes")return!0;if(a==="0"||a==="false"||a==="no")return!1};if(r.has("contentPath")&&(i.contentPath=r.get("contentPath")),r.has("searchIndex")){const s=n(r.get("searchIndex"));typeof s=="boolean"&&(i.searchIndex=s)}if(r.has("searchIndexMode")){const s=r.get("searchIndexMode");(s==="eager"||s==="lazy")&&(i.searchIndexMode=s)}if(r.has("defaultStyle")){const s=r.get("defaultStyle");(s==="light"||s==="dark")&&(i.defaultStyle=s)}if(r.has("bulmaCustomize")&&(i.bulmaCustomize=r.get("bulmaCustomize")),r.has("lang")&&(i.lang=r.get("lang")),r.has("l10nFile")){const s=r.get("l10nFile");i.l10nFile=s==="null"?null:s}if(r.has("cacheTtlMinutes")){const s=Number(r.get("cacheTtlMinutes"));Number.isFinite(s)&&s>=0&&(i.cacheTtlMinutes=s)}if(r.has("cacheMaxEntries")){const s=Number(r.get("cacheMaxEntries"));Number.isInteger(s)&&s>=0&&(i.cacheMaxEntries=s)}if(r.has("homePage")&&(i.homePage=r.get("homePage")),r.has("notFoundPage")&&(i.notFoundPage=r.get("notFoundPage")),r.has("availableLanguages")&&(i.availableLanguages=r.get("availableLanguages").split(",").map(s=>s.trim()).filter(Boolean)),r.has("indexDepth")){const s=Number(r.get("indexDepth"));Number.isInteger(s)&&(s===1||s===2||s===3)&&(i.indexDepth=s)}if(r.has("noIndexing")){const a=(r.get("noIndexing")||"").split(",").map(u=>u.trim()).filter(Boolean);a.length&&(i.noIndexing=a)}return i}catch{return{}}}function ul(t){return!(typeof t!="string"||!t.trim()||t.includes("..")||/^[a-zA-Z][a-zA-Z0-9+.-]*:\/\//.test(t)||t.startsWith("//")||t.startsWith("/")||/^[A-Za-z]:\\/.test(t))}function _r(t){if(typeof t!="string")return!1;const e=t.trim();return!(!e||e.includes("/")||e.includes("\\")||e.includes("..")||!/^[A-Za-z0-9._-]+\.(md|html)$/.test(e))}let wn="";async function hl(t={}){if(!t||typeof t!="object")throw new TypeError("initCMS(options): options must be an object");const e=cl();if(e&&(e.contentPath||e.homePage||e.notFoundPage))if(t&&t.allowUrlPathOverrides===!0)try{console.warn("[nimbi-cms] allowUrlPathOverrides enabled by host; honoring URL overrides for contentPath/homePage/notFoundPage")}catch(k){console.warn("[nimbi-cms] allowUrlPathOverrides logging failed",k)}else{try{console.warn("[nimbi-cms] ignoring unsafe URL overrides for contentPath/homePage/notFoundPage")}catch(k){console.warn("[nimbi-cms] logging ignore of URL overrides failed",k)}delete e.contentPath,delete e.homePage,delete e.notFoundPage}const r=Object.assign({},e,t),{el:i,contentPath:n="/content",crawlMaxQueue:s=1e3,searchIndex:a=!0,searchIndexMode:u="eager",indexDepth:l=1,noIndexing:o=void 0,defaultStyle:c="light",bulmaCustomize:h="none",lang:f=void 0,l10nFile:p=null,cacheTtlMinutes:d=5,cacheMaxEntries:m,markdownExtensions:w,availableLanguages:y,homePage:x="_home.md",notFoundPage:z="_404.md"}=r,{skipRootReadme:I=!1}=r;if(r.contentPath!=null&&!ul(r.contentPath))throw new TypeError('initCMS(options): "contentPath" contains unsafe characters or patterns');if(r.homePage!=null&&!_r(r.homePage))throw new TypeError('initCMS(options): "homePage" must be a simple basename ending with .md or .html');if(r.notFoundPage!=null&&!_r(r.notFoundPage))throw new TypeError('initCMS(options): "notFoundPage" must be a simple basename ending with .md or .html');if(!i)throw new Error("el is required");let A=i;if(typeof i=="string"){if(A=document.querySelector(i),!A)throw new Error(`el selector "${i}" did not match any element`)}else if(!(i instanceof Element))throw new TypeError("el must be a CSS selector string or a DOM element");if(typeof n!="string"||!n.trim())throw new TypeError('initCMS(options): "contentPath" must be a non-empty string when provided');if(typeof a!="boolean")throw new TypeError('initCMS(options): "searchIndex" must be a boolean when provided');if(u!=null&&u!=="eager"&&u!=="lazy")throw new TypeError('initCMS(options): "searchIndexMode" must be "eager" or "lazy" when provided');if(l!=null&&l!==1&&l!==2&&l!==3)throw new TypeError('initCMS(options): "indexDepth" must be 1, 2, or 3 when provided');if(c!=="light"&&c!=="dark")throw new TypeError('initCMS(options): "defaultStyle" must be "light" or "dark"');if(h!=null&&typeof h!="string")throw new TypeError('initCMS(options): "bulmaCustomize" must be a string when provided');if(f!=null&&typeof f!="string")throw new TypeError('initCMS(options): "lang" must be a string when provided');if(p!=null&&typeof p!="string")throw new TypeError('initCMS(options): "l10nFile" must be a string or null when provided');if(d!=null&&(typeof d!="number"||!Number.isFinite(d)||d<0))throw new TypeError('initCMS(options): "cacheTtlMinutes" must be a non‑negative number when provided');if(m!=null&&(typeof m!="number"||!Number.isInteger(m)||m<0))throw new TypeError('initCMS(options): "cacheMaxEntries" must be a non‑negative integer when provided');if(w!=null&&(!Array.isArray(w)||w.some(k=>!k||typeof k!="object")))throw new TypeError('initCMS(options): "markdownExtensions" must be an array of extension objects when provided');if(y!=null&&(!Array.isArray(y)||y.some(k=>typeof k!="string"||!k.trim())))throw new TypeError('initCMS(options): "availableLanguages" must be an array of non-empty strings when provided');if(o!=null&&(!Array.isArray(o)||o.some(k=>typeof k!="string"||!k.trim())))throw new TypeError('initCMS(options): "noIndexing" must be an array of non-empty strings when provided');if(I!=null&&typeof I!="boolean")throw new TypeError('initCMS(options): "skipRootReadme" must be a boolean when provided');if(x!=null&&(typeof x!="string"||!x.trim()||!/\.(md|html)$/.test(x)))throw new TypeError('initCMS(options): "homePage" must be a non-empty string ending with .md or .html');if(z!=null&&(typeof z!="string"||!z.trim()||!/\.(md|html)$/.test(z)))throw new TypeError('initCMS(options): "notFoundPage" must be a non-empty string ending with .md or .html');const q=!!a;try{Nr(!!I)}catch(k){console.warn("[nimbi-cms] setSkipRootReadme failed",k)}try{A.classList.add("nimbi-mount"),A.style.position=A.style.position||"relative",A.style.overflow=A.style.overflow||"hidden"}catch(k){console.warn("[nimbi-cms] mount element setup failed",k)}const O=document.createElement("div");O.className="nimbi-cms";try{O.style.position=O.style.position||"relative",O.style.overflow=O.style.overflow||"auto";try{O.style.webkitOverflowScrolling||(O.style.webkitOverflowScrolling="touch")}catch(k){console.warn("[nimbi-cms] set container webkitOverflowScrolling failed",k)}O.style.width=O.style.width||"100%",O.style.height=O.style.height||"100%",O.style.boxSizing=O.style.boxSizing||"border-box"}catch(k){console.warn("[nimbi-cms] container style setup failed",k)}const Q=document.createElement("div");Q.className="columns";const J=document.createElement("div");J.className="column is-full-mobile is-3-tablet nimbi-nav-wrap",J.setAttribute("role","navigation");try{const k=typeof st=="function"?st("navigation"):null;k&&J.setAttribute("aria-label",k)}catch(k){console.warn("[nimbi-cms] set nav aria-label failed",k)}Q.appendChild(J);const ne=document.createElement("div");ne.className="column nimbi-content",ne.setAttribute("role","main"),Q.appendChild(ne),O.appendChild(Q);const P=J,T=ne;A.appendChild(O);let $=null;try{$=A.querySelector(".nimbi-overlay"),$||($=document.createElement("div"),$.className="nimbi-overlay",A.appendChild($))}catch(k){$=null,console.warn("[nimbi-cms] mount overlay setup failed",k)}const L=location.pathname||"/",v=L.endsWith("/")?L:L.substring(0,L.lastIndexOf("/")+1);try{wn=document.title||""}catch(k){wn="",console.warn("[nimbi-cms] read initial document title failed",k)}let b=n;(b==="."||b==="./")&&(b=""),b.startsWith("./")&&(b=b.slice(2)),b.startsWith("/")&&(b=b.slice(1)),b!==""&&!b.endsWith("/")&&(b=b+"/");const E=new URL(v+b,location.origin).toString();try{xn&&xn(x)}catch(k){console.warn("[nimbi-cms] setHomePage failed",k)}p&&await Mn(p,v),y&&Array.isArray(y)&&Dr(y),f&&$n(f);const M=ol({contentWrap:T,navWrap:P,container:O,mountOverlay:$,t:st,contentBase:E,homePage:x,initialDocumentTitle:wn,runHooks:bn});if(typeof d=="number"&&d>=0&&typeof fr=="function"&&fr(d*60*1e3),typeof m=="number"&&m>=0&&typeof pr=="function"&&pr(m),w&&Array.isArray(w)&&w.length)try{w.forEach(k=>{typeof k=="object"&&za&&typeof Rn=="function"&&Rn(k)})}catch(k){console.warn("[nimbi-cms] applying markdownExtensions failed",k)}try{typeof s=="number"&&Promise.resolve().then(()=>Ut).then(({setDefaultCrawlMaxQueue:k})=>{try{k(s)}catch(X){console.warn("[nimbi-cms] setDefaultCrawlMaxQueue failed",X)}})}catch(k){console.warn("[nimbi-cms] setDefaultCrawlMaxQueue import failed",k)}try{Zt(E)}catch(k){console.warn("[nimbi-cms] setContentBase failed",k)}try{kn(z)}catch(k){console.warn("[nimbi-cms] setNotFoundPage failed",k)}try{Zt(E)}catch(k){console.warn("[nimbi-cms] setContentBase failed",k)}try{kn(z)}catch(k){console.warn("[nimbi-cms] setNotFoundPage failed",k)}try{await ke(x,E)}catch(k){throw x==="_home.md"?new Error("Required _home.md not found"):new Error(`Required ${x} not found at ${E}${x}: ${k.message}`)}Ir(c),await Pr(h,v);try{const k=document.createElement("header");k.className="nimbi-site-navbar",A.insertBefore(k,O);const X=await ke("_navigation.md",E),he=await Yt(X.raw||""),{navbar:xe,linkEls:be}=await Xa(k,O,he.html||"",E,x,st,M.renderByQuery,q,u,l,o);try{await bn("onNavBuild",{navWrap:P,navbar:xe,linkEls:be,contentBase:E})}catch(j){console.warn("[nimbi-cms] onNavBuild hooks failed",j)}try{const j=()=>{const ue=k&&k.getBoundingClientRect&&Math.round(k.getBoundingClientRect().height)||k&&k.offsetHeight||0;if(ue>0){try{A.style.setProperty("--nimbi-site-navbar-height",`${ue}px`)}catch(se){console.warn("[nimbi-cms] set CSS var failed",se)}try{O.style.paddingTop=""}catch(se){console.warn("[nimbi-cms] set container paddingTop failed",se)}try{const se=A&&A.getBoundingClientRect&&Math.round(A.getBoundingClientRect().height)||A&&A.clientHeight||0;if(se>0){const _e=Math.max(0,se-ue);try{O.style.boxSizing="border-box"}catch($e){console.warn("[nimbi-cms] set container boxSizing failed",$e)}try{O.style.height=`${_e}px`}catch($e){console.warn("[nimbi-cms] set container height failed",$e)}try{O.style.setProperty("--nimbi-cms-height",`${_e}px`)}catch($e){console.warn("[nimbi-cms] set --nimbi-cms-height failed",$e)}}else{try{O.style.height="calc(100vh - var(--nimbi-site-navbar-height))"}catch(_e){console.warn("[nimbi-cms] set container height failed",_e)}try{O.style.setProperty("--nimbi-cms-height","calc(100vh - var(--nimbi-site-navbar-height))")}catch(_e){console.warn("[nimbi-cms] set --nimbi-cms-height failed",_e)}}}catch(se){console.warn("[nimbi-cms] compute container height failed",se)}try{k.style.setProperty("--nimbi-site-navbar-height",`${ue}px`)}catch(se){console.warn("[nimbi-cms] set navbar CSS var failed",se)}}};j();try{if(typeof ResizeObserver<"u"){const ue=new ResizeObserver(()=>j());try{ue.observe(k)}catch(se){console.warn("[nimbi-cms] ResizeObserver.observe failed",se)}}}catch(ue){console.warn("[nimbi-cms] ResizeObserver setup failed",ue)}}catch(j){console.warn("[nimbi-cms] compute navbar height failed",j)}}catch(k){console.warn("[nimbi-cms] build navigation failed",k)}await M.renderByQuery();try{Promise.resolve().then(()=>dl).then(({getVersion:k})=>{typeof k=="function"&&k().then(X=>{try{const he=X||"0.0.0";try{const xe=be=>{const j=document.createElement("a");j.className="nimbi-version-label tag is-small",j.textContent=`Ninbi CMS v. ${he}`,j.href=be||"#",j.target="_blank",j.rel="noopener noreferrer nofollow",j.setAttribute("aria-label",`Ninbi CMS version ${he}`),j.style.position="absolute",j.style.left="8px",j.style.bottom="6px",j.style.fontSize="11px",j.style.opacity="0.6",j.style.zIndex="9999",j.style.userSelect="none",j.style.transition="opacity 150ms ease",j.addEventListener("mouseenter",()=>{try{j.style.opacity="0.95",j.classList.add("has-text-weight-semibold")}catch{}}),j.addEventListener("mouseleave",()=>{try{j.style.opacity="0.6",j.classList.remove("has-text-weight-semibold")}catch{}});const ue=()=>{try{const se=document.documentElement.getAttribute("data-theme")==="dark"||document.body.classList.contains("is-dark");j.classList.toggle("is-dark",se),j.classList.toggle("is-light",!se)}catch{}};ue();try{const se=new MutationObserver(_e=>{for(const $e of _e)$e.type==="attributes"&&($e.attributeName==="data-theme"||$e.attributeName==="class")&&ue()});se.observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]}),se.observe(document.body,{attributes:!0,attributeFilter:["class"]})}catch{}try{A.appendChild(j)}catch(se){console.warn("[nimbi-cms] append version label failed",se)}};(async()=>{try{const be=await Promise.resolve().then(()=>As).catch(()=>null),j=be&&(be.default||be);let ue=null;j&&(j.homepage&&typeof j.homepage=="string"?ue=j.homepage:j.repository&&(typeof j.repository=="string"?ue=j.repository:j.repository.url&&typeof j.repository.url=="string"&&(ue=j.repository.url)));try{ue&&new URL(ue)}catch{ue=null}xe(ue||"#")}catch{xe("#")}})()}catch(xe){console.warn("[nimbi-cms] building version label failed",xe)}}catch(he){console.warn("[nimbi-cms] building version label failed",he)}}).catch(X=>{console.warn("[nimbi-cms] getVersion() failed",X)})}).catch(k=>{console.warn("[nimbi-cms] import version module failed",k)})}catch(k){console.warn("[nimbi-cms] version label setup failed",k)}}async function us(){try{let t=null;try{t=await Promise.resolve().then(()=>As)}catch{try{if(typeof fetch=="function"&&typeof location<"u"){const i=new URL("../package.json",location.href).toString(),n=await fetch(i);n&&n.ok?t={default:await n.json()}:t=null}else t=null}catch{t=null}}const e=t?.default?.version||t?.version;return typeof e=="string"&&e.trim()?e:"0.0.0"}catch{return"0.0.0"}}const dl=Object.freeze(Object.defineProperty({__proto__:null,getVersion:us},Symbol.toStringTag,{value:"Module"})),hs="nimbi-cms",ds="0.1.0",ps={type:"git",url:"git+https://github.com/AbelVM/nimbiCMS.git"},fs="https://abelvm.github.io/nimbiCMS/",gs="module",ms={dev:"vite","dev:example":'sh -c "npm run build -- --outDir example/dist --config vite.config.js && vite example --port 5173 &"',build:"vite build --config vite.config.js","build:lib":"vite build --config vite.config.js","build:analyze":"ANALYZE=1 vite build --config vite.config.js",preview:"vite preview",test:"npx vitest run","gen-dts":"node scripts/gen-dts.js","check-dts":"npx tsc --noEmit src/index.d.ts --lib es2015,dom --skipLibCheck","type-test":"npx tsd",docs:"typedoc --options typedoc.json"},ws={bulma:"^1.0.4","highlight.js":"^11.11.1",marked:"^17.0.4"},bs={"@vitest/coverage-v8":"^4.0.18","comment-parser":"^0.7.6",eslint:"^10.0.3","eslint-plugin-unused-imports":"^4.4.1",glob:"^10.4.1",jsdom:"^28.1.0","reading-time":"^1.5.0",terser:"^5.17.0",typedoc:"^0.28.17","typedoc-plugin-markdown":"^4.10.0",typescript:"^5.9.3",tsd:"^0.33.0",vite:"^7.3.1","rollup-plugin-visualizer":"^5.8.0","vite-plugin-restart":"^2.0.0",vitest:"^4.0.18"},ys="dist/nimbi-cms.cjs.js",ks="dist/nimbi-cms.es.js",xs="src/index.d.ts",Ss="dist/nimbi-cms.js",vs=["dist","src/index.d.ts"],pl={name:hs,version:ds,repository:ps,homepage:fs,private:!0,type:gs,scripts:ms,dependencies:ws,devDependencies:bs,main:ys,module:ks,types:xs,unpkg:Ss,files:vs},As=Object.freeze(Object.defineProperty({__proto__:null,default:pl,dependencies:ws,devDependencies:bs,files:vs,homepage:fs,main:ys,module:ks,name:hs,repository:ps,scripts:ms,type:gs,types:xs,unpkg:Ss,version:ds},Symbol.toStringTag,{value:"Module"}));exports.BAD_LANGUAGES=Cn;exports.SUPPORTED_HLJS_MAP=V;exports._clearHooks=di;exports.addHook=Vt;exports.default=hl;exports.ensureBulma=Pr;exports.getVersion=us;exports.loadL10nFile=Mn;exports.loadSupportedLanguages=_n;exports.observeCodeBlocks=$r;exports.onNavBuild=ui;exports.onPageLoad=ci;exports.registerLanguage=lt;exports.runHooks=bn;exports.setHighlightTheme=wi;exports.setLang=$n;exports.setStyle=Ir;exports.setThemeVars=yi;exports.t=st;exports.transformHtml=hi;
