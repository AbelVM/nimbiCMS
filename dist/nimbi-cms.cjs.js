"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const Bt={onPageLoad:[],onNavBuild:[],transformHtml:[]};function dn(e,t){if(!Object.prototype.hasOwnProperty.call(Bt,e))throw new Error('Unknown hook "'+e+'"');if(typeof t!="function")throw new TypeError("hook callback must be a function");Bt[e].push(t)}function hs(e){dn("onPageLoad",e)}function ds(e){dn("onNavBuild",e)}function fs(e){dn("transformHtml",e)}async function zn(e,t){const n=Bt[e]||[];for(const s of n)try{await s(t)}catch(r){console.warn("[nimbi-cms] runHooks callback failed",r)}}function ps(){Object.keys(Bt).forEach(e=>{Bt[e].length=0})}function Fr(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ln,xr;function gs(){if(xr)return Ln;xr=1;function e(w){return w instanceof Map?w.clear=w.delete=w.set=function(){throw new Error("map is read-only")}:w instanceof Set&&(w.add=w.clear=w.delete=function(){throw new Error("set is read-only")}),Object.freeze(w),Object.getOwnPropertyNames(w).forEach(S=>{const C=w[S],ee=typeof C;(ee==="object"||ee==="function")&&!Object.isFrozen(C)&&e(C)}),w}class t{constructor(S){S.data===void 0&&(S.data={}),this.data=S.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function n(w){return w.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function s(w,...S){const C=Object.create(null);for(const ee in w)C[ee]=w[ee];return S.forEach(function(ee){for(const Se in ee)C[Se]=ee[Se]}),C}const r="</span>",i=w=>!!w.scope,a=(w,{prefix:S})=>{if(w.startsWith("language:"))return w.replace("language:","language-");if(w.includes(".")){const C=w.split(".");return[`${S}${C.shift()}`,...C.map((ee,Se)=>`${ee}${"_".repeat(Se+1)}`)].join(" ")}return`${S}${w}`};class c{constructor(S,C){this.buffer="",this.classPrefix=C.classPrefix,S.walk(this)}addText(S){this.buffer+=n(S)}openNode(S){if(!i(S))return;const C=a(S.scope,{prefix:this.classPrefix});this.span(C)}closeNode(S){i(S)&&(this.buffer+=r)}value(){return this.buffer}span(S){this.buffer+=`<span class="${S}">`}}const o=(w={})=>{const S={children:[]};return Object.assign(S,w),S};class l{constructor(){this.rootNode=o(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(S){this.top.children.push(S)}openNode(S){const C=o({scope:S});this.add(C),this.stack.push(C)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(S){return this.constructor._walk(S,this.rootNode)}static _walk(S,C){return typeof C=="string"?S.addText(C):C.children&&(S.openNode(C),C.children.forEach(ee=>this._walk(S,ee)),S.closeNode(C)),S}static _collapse(S){typeof S!="string"&&S.children&&(S.children.every(C=>typeof C=="string")?S.children=[S.children.join("")]:S.children.forEach(C=>{l._collapse(C)}))}}class u extends l{constructor(S){super(),this.options=S}addText(S){S!==""&&this.add(S)}startScope(S){this.openNode(S)}endScope(){this.closeNode()}__addSublanguage(S,C){const ee=S.root;C&&(ee.scope=`language:${C}`),this.add(ee)}toHTML(){return new c(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function f(w){return w?typeof w=="string"?w:w.source:null}function g(w){return p("(?=",w,")")}function d(w){return p("(?:",w,")*")}function h(w){return p("(?:",w,")?")}function p(...w){return w.map(C=>f(C)).join("")}function m(w){const S=w[w.length-1];return typeof S=="object"&&S.constructor===Object?(w.splice(w.length-1,1),S):{}}function b(...w){return"("+(m(w).capture?"":"?:")+w.map(ee=>f(ee)).join("|")+")"}function y(w){return new RegExp(w.toString()+"|").exec("").length-1}function k(w,S){const C=w&&w.exec(S);return C&&C.index===0}const A=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function M(w,{joinWith:S}){let C=0;return w.map(ee=>{C+=1;const Se=C;let ve=f(ee),O="";for(;ve.length>0;){const N=A.exec(ve);if(!N){O+=ve;break}O+=ve.substring(0,N.index),ve=ve.substring(N.index+N[0].length),N[0][0]==="\\"&&N[1]?O+="\\"+String(Number(N[1])+Se):(O+=N[0],N[0]==="("&&C++)}return O}).map(ee=>`(${ee})`).join(S)}const B=/\b\B/,H="[a-zA-Z]\\w*",R="[a-zA-Z_]\\w*",Q="\\b\\d+(\\.\\d+)?",de="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",L="\\b(0b[01]+)",j="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",X=(w={})=>{const S=/^#![ ]*\//;return w.binary&&(w.begin=p(S,/.*\b/,w.binary,/\b.*/)),s({scope:"meta",begin:S,end:/$/,relevance:0,"on:begin":(C,ee)=>{C.index!==0&&ee.ignoreMatch()}},w)},q={begin:"\\\\[\\s\\S]",relevance:0},G={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[q]},v={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[q]},pe={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},re=function(w,S,C={}){const ee=s({scope:"comment",begin:w,end:S,contains:[]},C);ee.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const Se=b("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return ee.contains.push({begin:p(/[ ]+/,"(",Se,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),ee},fe=re("//","$"),E=re("/\\*","\\*/"),T=re("#","$"),$={scope:"number",begin:Q,relevance:0},I={scope:"number",begin:de,relevance:0},x={scope:"number",begin:L,relevance:0},P={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[q,{begin:/\[/,end:/\]/,relevance:0,contains:[q]}]},W={scope:"title",begin:H,relevance:0},ue={scope:"title",begin:R,relevance:0},me={begin:"\\.\\s*"+R,relevance:0};var J=Object.freeze({__proto__:null,APOS_STRING_MODE:G,BACKSLASH_ESCAPE:q,BINARY_NUMBER_MODE:x,BINARY_NUMBER_RE:L,COMMENT:re,C_BLOCK_COMMENT_MODE:E,C_LINE_COMMENT_MODE:fe,C_NUMBER_MODE:I,C_NUMBER_RE:de,END_SAME_AS_BEGIN:function(w){return Object.assign(w,{"on:begin":(S,C)=>{C.data._beginMatch=S[1]},"on:end":(S,C)=>{C.data._beginMatch!==S[1]&&C.ignoreMatch()}})},HASH_COMMENT_MODE:T,IDENT_RE:H,MATCH_NOTHING_RE:B,METHOD_GUARD:me,NUMBER_MODE:$,NUMBER_RE:Q,PHRASAL_WORDS_MODE:pe,QUOTE_STRING_MODE:v,REGEXP_MODE:P,RE_STARTERS_RE:j,SHEBANG:X,TITLE_MODE:W,UNDERSCORE_IDENT_RE:R,UNDERSCORE_TITLE_MODE:ue});function V(w,S){w.input[w.index-1]==="."&&S.ignoreMatch()}function le(w,S){w.className!==void 0&&(w.scope=w.className,delete w.className)}function Ee(w,S){S&&w.beginKeywords&&(w.begin="\\b("+w.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",w.__beforeBegin=V,w.keywords=w.keywords||w.beginKeywords,delete w.beginKeywords,w.relevance===void 0&&(w.relevance=0))}function ht(w,S){Array.isArray(w.illegal)&&(w.illegal=b(...w.illegal))}function bn(w,S){if(w.match){if(w.begin||w.end)throw new Error("begin & end are not supported with match");w.begin=w.match,delete w.match}}function $i(w,S){w.relevance===void 0&&(w.relevance=1)}const Pi=(w,S)=>{if(!w.beforeMatch)return;if(w.starts)throw new Error("beforeMatch cannot be used with starts");const C=Object.assign({},w);Object.keys(w).forEach(ee=>{delete w[ee]}),w.keywords=C.keywords,w.begin=p(C.beforeMatch,g(C.begin)),w.starts={relevance:0,contains:[Object.assign(C,{endsParent:!0})]},w.relevance=0,delete C.beforeMatch},zi=["of","and","for","in","not","or","if","then","parent","list","value"],Ii="keyword";function sr(w,S,C=Ii){const ee=Object.create(null);return typeof w=="string"?Se(C,w.split(" ")):Array.isArray(w)?Se(C,w):Object.keys(w).forEach(function(ve){Object.assign(ee,sr(w[ve],S,ve))}),ee;function Se(ve,O){S&&(O=O.map(N=>N.toLowerCase())),O.forEach(function(N){const K=N.split("|");ee[K[0]]=[ve,Bi(K[0],K[1])]})}}function Bi(w,S){return S?Number(S):Ni(w)?0:1}function Ni(w){return zi.includes(w.toLowerCase())}const ar={},it=w=>{console.error(w)},or=(w,...S)=>{console.log(`WARN: ${w}`,...S)},dt=(w,S)=>{ar[`${w}/${S}`]||(console.log(`Deprecated as of ${w}. ${S}`),ar[`${w}/${S}`]=!0)},Ft=new Error;function lr(w,S,{key:C}){let ee=0;const Se=w[C],ve={},O={};for(let N=1;N<=S.length;N++)O[N+ee]=Se[N],ve[N+ee]=!0,ee+=y(S[N-1]);w[C]=O,w[C]._emit=ve,w[C]._multi=!0}function Oi(w){if(Array.isArray(w.begin)){if(w.skip||w.excludeBegin||w.returnBegin)throw it("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Ft;if(typeof w.beginScope!="object"||w.beginScope===null)throw it("beginScope must be object"),Ft;lr(w,w.begin,{key:"beginScope"}),w.begin=M(w.begin,{joinWith:""})}}function Di(w){if(Array.isArray(w.end)){if(w.skip||w.excludeEnd||w.returnEnd)throw it("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Ft;if(typeof w.endScope!="object"||w.endScope===null)throw it("endScope must be object"),Ft;lr(w,w.end,{key:"endScope"}),w.end=M(w.end,{joinWith:""})}}function qi(w){w.scope&&typeof w.scope=="object"&&w.scope!==null&&(w.beginScope=w.scope,delete w.scope)}function Hi(w){qi(w),typeof w.beginScope=="string"&&(w.beginScope={_wrap:w.beginScope}),typeof w.endScope=="string"&&(w.endScope={_wrap:w.endScope}),Oi(w),Di(w)}function ji(w){function S(O,N){return new RegExp(f(O),"m"+(w.case_insensitive?"i":"")+(w.unicodeRegex?"u":"")+(N?"g":""))}class C{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(N,K){K.position=this.position++,this.matchIndexes[this.matchAt]=K,this.regexes.push([K,N]),this.matchAt+=y(N)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const N=this.regexes.map(K=>K[1]);this.matcherRe=S(M(N,{joinWith:"|"}),!0),this.lastIndex=0}exec(N){this.matcherRe.lastIndex=this.lastIndex;const K=this.matcherRe.exec(N);if(!K)return null;const _e=K.findIndex((xt,kn)=>kn>0&&xt!==void 0),Ae=this.matchIndexes[_e];return K.splice(0,_e),Object.assign(K,Ae)}}class ee{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(N){if(this.multiRegexes[N])return this.multiRegexes[N];const K=new C;return this.rules.slice(N).forEach(([_e,Ae])=>K.addRule(_e,Ae)),K.compile(),this.multiRegexes[N]=K,K}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(N,K){this.rules.push([N,K]),K.type==="begin"&&this.count++}exec(N){const K=this.getMatcher(this.regexIndex);K.lastIndex=this.lastIndex;let _e=K.exec(N);if(this.resumingScanAtSamePosition()&&!(_e&&_e.index===this.lastIndex)){const Ae=this.getMatcher(0);Ae.lastIndex=this.lastIndex+1,_e=Ae.exec(N)}return _e&&(this.regexIndex+=_e.position+1,this.regexIndex===this.count&&this.considerAll()),_e}}function Se(O){const N=new ee;return O.contains.forEach(K=>N.addRule(K.begin,{rule:K,type:"begin"})),O.terminatorEnd&&N.addRule(O.terminatorEnd,{type:"end"}),O.illegal&&N.addRule(O.illegal,{type:"illegal"}),N}function ve(O,N){const K=O;if(O.isCompiled)return K;[le,bn,Hi,Pi].forEach(Ae=>Ae(O,N)),w.compilerExtensions.forEach(Ae=>Ae(O,N)),O.__beforeBegin=null,[Ee,ht,$i].forEach(Ae=>Ae(O,N)),O.isCompiled=!0;let _e=null;return typeof O.keywords=="object"&&O.keywords.$pattern&&(O.keywords=Object.assign({},O.keywords),_e=O.keywords.$pattern,delete O.keywords.$pattern),_e=_e||/\w+/,O.keywords&&(O.keywords=sr(O.keywords,w.case_insensitive)),K.keywordPatternRe=S(_e,!0),N&&(O.begin||(O.begin=/\B|\b/),K.beginRe=S(K.begin),!O.end&&!O.endsWithParent&&(O.end=/\B|\b/),O.end&&(K.endRe=S(K.end)),K.terminatorEnd=f(K.end)||"",O.endsWithParent&&N.terminatorEnd&&(K.terminatorEnd+=(O.end?"|":"")+N.terminatorEnd)),O.illegal&&(K.illegalRe=S(O.illegal)),O.contains||(O.contains=[]),O.contains=[].concat(...O.contains.map(function(Ae){return Ui(Ae==="self"?O:Ae)})),O.contains.forEach(function(Ae){ve(Ae,K)}),O.starts&&ve(O.starts,N),K.matcher=Se(K),K}if(w.compilerExtensions||(w.compilerExtensions=[]),w.contains&&w.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return w.classNameAliases=s(w.classNameAliases||{}),ve(w)}function cr(w){return w?w.endsWithParent||cr(w.starts):!1}function Ui(w){return w.variants&&!w.cachedVariants&&(w.cachedVariants=w.variants.map(function(S){return s(w,{variants:null},S)})),w.cachedVariants?w.cachedVariants:cr(w)?s(w,{starts:w.starts?s(w.starts):null}):Object.isFrozen(w)?s(w):w}var Wi="11.11.1";class Fi extends Error{constructor(S,C){super(S),this.name="HTMLInjectionError",this.html=C}}const yn=n,ur=s,hr=Symbol("nomatch"),Zi=7,dr=function(w){const S=Object.create(null),C=Object.create(null),ee=[];let Se=!0;const ve="Could not find the language '{}', did you forget to load/include a language module?",O={disableAutodetect:!0,name:"Plain text",contains:[]};let N={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:u};function K(_){return N.noHighlightRe.test(_)}function _e(_){let U=_.className+" ";U+=_.parentNode?_.parentNode.className:"";const oe=N.languageDetectRe.exec(U);if(oe){const be=Ve(oe[1]);return be||(or(ve.replace("{}",oe[1])),or("Falling back to no-highlight mode for this block.",_)),be?oe[1]:"no-highlight"}return U.split(/\s+/).find(be=>K(be)||Ve(be))}function Ae(_,U,oe){let be="",Le="";typeof U=="object"?(be=_,oe=U.ignoreIllegals,Le=U.language):(dt("10.7.0","highlight(lang, code, ...args) has been deprecated."),dt("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),Le=_,be=U),oe===void 0&&(oe=!0);const je={code:be,language:Le};Gt("before:highlight",je);const Je=je.result?je.result:xt(je.language,je.code,oe);return Je.code=je.code,Gt("after:highlight",Je),Je}function xt(_,U,oe,be){const Le=Object.create(null);function je(z,D){return z.keywords[D]}function Je(){if(!te.keywords){Ce.addText(ye);return}let z=0;te.keywordPatternRe.lastIndex=0;let D=te.keywordPatternRe.exec(ye),ie="";for(;D;){ie+=ye.substring(z,D.index);const we=We.case_insensitive?D[0].toLowerCase():D[0],Re=je(te,we);if(Re){const[Xe,cs]=Re;if(Ce.addText(ie),ie="",Le[we]=(Le[we]||0)+1,Le[we]<=Zi&&(Kt+=cs),Xe.startsWith("_"))ie+=D[0];else{const us=We.classNameAliases[Xe]||Xe;Ue(D[0],us)}}else ie+=D[0];z=te.keywordPatternRe.lastIndex,D=te.keywordPatternRe.exec(ye)}ie+=ye.substring(z),Ce.addText(ie)}function Qt(){if(ye==="")return;let z=null;if(typeof te.subLanguage=="string"){if(!S[te.subLanguage]){Ce.addText(ye);return}z=xt(te.subLanguage,ye,!0,kr[te.subLanguage]),kr[te.subLanguage]=z._top}else z=xn(ye,te.subLanguage.length?te.subLanguage:null);te.relevance>0&&(Kt+=z.relevance),Ce.__addSublanguage(z._emitter,z.language)}function Be(){te.subLanguage!=null?Qt():Je(),ye=""}function Ue(z,D){z!==""&&(Ce.startScope(D),Ce.addText(z),Ce.endScope())}function mr(z,D){let ie=1;const we=D.length-1;for(;ie<=we;){if(!z._emit[ie]){ie++;continue}const Re=We.classNameAliases[z[ie]]||z[ie],Xe=D[ie];Re?Ue(Xe,Re):(ye=Xe,Je(),ye=""),ie++}}function wr(z,D){return z.scope&&typeof z.scope=="string"&&Ce.openNode(We.classNameAliases[z.scope]||z.scope),z.beginScope&&(z.beginScope._wrap?(Ue(ye,We.classNameAliases[z.beginScope._wrap]||z.beginScope._wrap),ye=""):z.beginScope._multi&&(mr(z.beginScope,D),ye="")),te=Object.create(z,{parent:{value:te}}),te}function br(z,D,ie){let we=k(z.endRe,ie);if(we){if(z["on:end"]){const Re=new t(z);z["on:end"](D,Re),Re.isMatchIgnored&&(we=!1)}if(we){for(;z.endsParent&&z.parent;)z=z.parent;return z}}if(z.endsWithParent)return br(z.parent,D,ie)}function is(z){return te.matcher.regexIndex===0?(ye+=z[0],1):(An=!0,0)}function ss(z){const D=z[0],ie=z.rule,we=new t(ie),Re=[ie.__beforeBegin,ie["on:begin"]];for(const Xe of Re)if(Xe&&(Xe(z,we),we.isMatchIgnored))return is(D);return ie.skip?ye+=D:(ie.excludeBegin&&(ye+=D),Be(),!ie.returnBegin&&!ie.excludeBegin&&(ye=D)),wr(ie,z),ie.returnBegin?0:D.length}function as(z){const D=z[0],ie=U.substring(z.index),we=br(te,z,ie);if(!we)return hr;const Re=te;te.endScope&&te.endScope._wrap?(Be(),Ue(D,te.endScope._wrap)):te.endScope&&te.endScope._multi?(Be(),mr(te.endScope,z)):Re.skip?ye+=D:(Re.returnEnd||Re.excludeEnd||(ye+=D),Be(),Re.excludeEnd&&(ye=D));do te.scope&&Ce.closeNode(),!te.skip&&!te.subLanguage&&(Kt+=te.relevance),te=te.parent;while(te!==we.parent);return we.starts&&wr(we.starts,z),Re.returnEnd?0:D.length}function os(){const z=[];for(let D=te;D!==We;D=D.parent)D.scope&&z.unshift(D.scope);z.forEach(D=>Ce.openNode(D))}let Xt={};function yr(z,D){const ie=D&&D[0];if(ye+=z,ie==null)return Be(),0;if(Xt.type==="begin"&&D.type==="end"&&Xt.index===D.index&&ie===""){if(ye+=U.slice(D.index,D.index+1),!Se){const we=new Error(`0 width match regex (${_})`);throw we.languageName=_,we.badRule=Xt.rule,we}return 1}if(Xt=D,D.type==="begin")return ss(D);if(D.type==="illegal"&&!oe){const we=new Error('Illegal lexeme "'+ie+'" for mode "'+(te.scope||"<unnamed>")+'"');throw we.mode=te,we}else if(D.type==="end"){const we=as(D);if(we!==hr)return we}if(D.type==="illegal"&&ie==="")return ye+=`
`,1;if(En>1e5&&En>D.index*3)throw new Error("potential infinite loop, way more iterations than matches");return ye+=ie,ie.length}const We=Ve(_);if(!We)throw it(ve.replace("{}",_)),new Error('Unknown language: "'+_+'"');const ls=ji(We);let vn="",te=be||ls;const kr={},Ce=new N.__emitter(N);os();let ye="",Kt=0,st=0,En=0,An=!1;try{if(We.__emitTokens)We.__emitTokens(U,Ce);else{for(te.matcher.considerAll();;){En++,An?An=!1:te.matcher.considerAll(),te.matcher.lastIndex=st;const z=te.matcher.exec(U);if(!z)break;const D=U.substring(st,z.index),ie=yr(D,z);st=z.index+ie}yr(U.substring(st))}return Ce.finalize(),vn=Ce.toHTML(),{language:_,value:vn,relevance:Kt,illegal:!1,_emitter:Ce,_top:te}}catch(z){if(z.message&&z.message.includes("Illegal"))return{language:_,value:yn(U),illegal:!0,relevance:0,_illegalBy:{message:z.message,index:st,context:U.slice(st-100,st+100),mode:z.mode,resultSoFar:vn},_emitter:Ce};if(Se)return{language:_,value:yn(U),illegal:!1,relevance:0,errorRaised:z,_emitter:Ce,_top:te};throw z}}function kn(_){const U={value:yn(_),illegal:!1,relevance:0,_top:O,_emitter:new N.__emitter(N)};return U._emitter.addText(_),U}function xn(_,U){U=U||N.languages||Object.keys(S);const oe=kn(_),be=U.filter(Ve).filter(gr).map(Be=>xt(Be,_,!1));be.unshift(oe);const Le=be.sort((Be,Ue)=>{if(Be.relevance!==Ue.relevance)return Ue.relevance-Be.relevance;if(Be.language&&Ue.language){if(Ve(Be.language).supersetOf===Ue.language)return 1;if(Ve(Ue.language).supersetOf===Be.language)return-1}return 0}),[je,Je]=Le,Qt=je;return Qt.secondBest=Je,Qt}function Gi(_,U,oe){const be=U&&C[U]||oe;_.classList.add("hljs"),_.classList.add(`language-${be}`)}function Sn(_){let U=null;const oe=_e(_);if(K(oe))return;if(Gt("before:highlightElement",{el:_,language:oe}),_.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",_);return}if(_.children.length>0&&(N.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(_)),N.throwUnescapedHTML))throw new Fi("One of your code blocks includes unescaped HTML.",_.innerHTML);U=_;const be=U.textContent,Le=oe?Ae(be,{language:oe,ignoreIllegals:!0}):xn(be);_.innerHTML=Le.value,_.dataset.highlighted="yes",Gi(_,oe,Le.language),_.result={language:Le.language,re:Le.relevance,relevance:Le.relevance},Le.secondBest&&(_.secondBest={language:Le.secondBest.language,relevance:Le.secondBest.relevance}),Gt("after:highlightElement",{el:_,result:Le,text:be})}function Qi(_){N=ur(N,_)}const Xi=()=>{Zt(),dt("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function Ki(){Zt(),dt("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let fr=!1;function Zt(){function _(){Zt()}if(document.readyState==="loading"){fr||window.addEventListener("DOMContentLoaded",_,!1),fr=!0;return}document.querySelectorAll(N.cssSelector).forEach(Sn)}function Yi(_,U){let oe=null;try{oe=U(w)}catch(be){if(it("Language definition for '{}' could not be registered.".replace("{}",_)),Se)it(be);else throw be;oe=O}oe.name||(oe.name=_),S[_]=oe,oe.rawDefinition=U.bind(null,w),oe.aliases&&pr(oe.aliases,{languageName:_})}function Vi(_){delete S[_];for(const U of Object.keys(C))C[U]===_&&delete C[U]}function Ji(){return Object.keys(S)}function Ve(_){return _=(_||"").toLowerCase(),S[_]||S[C[_]]}function pr(_,{languageName:U}){typeof _=="string"&&(_=[_]),_.forEach(oe=>{C[oe.toLowerCase()]=U})}function gr(_){const U=Ve(_);return U&&!U.disableAutodetect}function es(_){_["before:highlightBlock"]&&!_["before:highlightElement"]&&(_["before:highlightElement"]=U=>{_["before:highlightBlock"](Object.assign({block:U.el},U))}),_["after:highlightBlock"]&&!_["after:highlightElement"]&&(_["after:highlightElement"]=U=>{_["after:highlightBlock"](Object.assign({block:U.el},U))})}function ts(_){es(_),ee.push(_)}function ns(_){const U=ee.indexOf(_);U!==-1&&ee.splice(U,1)}function Gt(_,U){const oe=_;ee.forEach(function(be){be[oe]&&be[oe](U)})}function rs(_){return dt("10.7.0","highlightBlock will be removed entirely in v12.0"),dt("10.7.0","Please use highlightElement now."),Sn(_)}Object.assign(w,{highlight:Ae,highlightAuto:xn,highlightAll:Zt,highlightElement:Sn,highlightBlock:rs,configure:Qi,initHighlighting:Xi,initHighlightingOnLoad:Ki,registerLanguage:Yi,unregisterLanguage:Vi,listLanguages:Ji,getLanguage:Ve,registerAliases:pr,autoDetection:gr,inherit:ur,addPlugin:ts,removePlugin:ns}),w.debugMode=function(){Se=!1},w.safeMode=function(){Se=!0},w.versionString=Wi,w.regex={concat:p,lookahead:g,either:b,optional:h,anyNumberOfTimes:d};for(const _ in J)typeof J[_]=="object"&&e(J[_]);return Object.assign(w,J),w},ft=dr({});return ft.newInstance=()=>dr({}),Ln=ft,ft.HighlightJS=ft,ft.default=ft,Ln}var ms=gs();const he=Fr(ms),ws="11.11.1",se=new Map,bs="https://raw.githubusercontent.com/highlightjs/highlight.js/main/SUPPORTED_LANGUAGES.md",Ne={shell:"bash",sh:"bash",zsh:"bash",js:"javascript",ts:"typescript",py:"python",csharp:"cs","c#":"cs"};Ne.html="xml";Ne.xhtml="xml";Ne.markup="xml";const Un=new Set(["magic","undefined"]);let tt=null;const Tn=new Map,ys=300*1e3;async function Wn(e=bs){if(e)return tt||(tt=(async()=>{try{const t=await fetch(e);if(!t.ok)return;const s=(await t.text()).split(/\r?\n/);let r=-1;for(let l=0;l<s.length;l++)if(/\|\s*Language\s*\|/i.test(s[l])){r=l;break}if(r===-1)return;const i=s[r].replace(/^\||\|$/g,"").split("|").map(l=>l.trim().toLowerCase());let a=i.findIndex(l=>/alias|aliases|equivalent|alt|alternates?/i.test(l));a===-1&&(a=1);let c=i.findIndex(l=>/file|filename|module|module name|module-name|short|slug/i.test(l));if(c===-1){const l=i.findIndex(u=>/language/i.test(u));c=l!==-1?l:0}let o=[];for(let l=r+1;l<s.length;l++){const u=s[l].trim();if(!u||!u.startsWith("|"))break;const f=u.replace(/^\||\|$/g,"").split("|").map(m=>m.trim());if(f.every(m=>/^-+$/.test(m)))continue;const g=f;if(!g.length)continue;const h=(g[c]||g[0]||"").toString().trim().toLowerCase();if(!h||/^-+$/.test(h))continue;se.set(h,h);const p=g[a]||"";if(p){const m=String(p).split(",").map(b=>b.replace(/`/g,"").trim()).filter(Boolean);if(m.length){const y=m[0].toLowerCase().replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");y&&/[a-z0-9]/i.test(y)&&(se.set(y,y),o.push(y))}}}try{const l=[];for(const u of o){const f=String(u||"").replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");f&&/[a-z0-9]/i.test(f)?l.push(f):se.delete(u)}o=l}catch(l){console.warn("[codeblocksManager] cleanup aliases failed",l)}try{let l=0;for(const u of Array.from(se.keys())){if(!u||/^-+$/.test(u)||!/[a-z0-9]/i.test(u)){se.delete(u),l++;continue}if(/^[:]+/.test(u)){const f=u.replace(/^[:]+/,"");if(f&&/[a-z0-9]/i.test(f)){const g=se.get(u);se.delete(u),se.set(f,g)}else se.delete(u),l++}}for(const[u,f]of Array.from(se.entries()))(!f||/^-+$/.test(f)||!/[a-z0-9]/i.test(f))&&(se.delete(u),l++);try{const u=":---------------------";se.has(u)&&(se.delete(u),l++)}catch(u){console.warn("[codeblocksManager] remove sep key failed",u)}try{const u=Array.from(se.keys()).sort()}catch(u){console.warn("[codeblocksManager] compute supported keys failed",u)}}catch(l){console.warn("[codeblocksManager] ignored error",l)}}catch(t){console.warn("[codeblocksManager] loadSupportedLanguages failed",t)}})(),tt)}const St=new Set;async function yt(e,t){if(tt||(async()=>{try{await Wn()}catch(r){console.warn("[codeblocksManager] loadSupportedLanguages (IIFE) failed",r)}})(),tt)try{await tt}catch{}if(e=e==null?"":String(e),e=e.trim(),!e)return!1;const n=e.toLowerCase();if(Un.has(n))return!1;if(se.size&&!se.has(n)){const r=Ne;if(!r[n]&&!r[e])return!1}if(St.has(e))return!0;const s=Ne;try{const r=(t||e||"").toString().replace(/\.js$/i,"").trim(),i=(s[e]||e||"").toString(),a=(s[r]||r||"").toString();let c=Array.from(new Set([i,a,r,e,s[r],s[e]].filter(Boolean))).map(u=>String(u).toLowerCase()).filter(u=>u&&u!=="undefined");se.size&&(c=c.filter(u=>{if(se.has(u))return!0;const f=Ne[u];return!!(f&&se.has(f))}));let o=null,l=null;for(const u of c)try{const f=Date.now();let g=Tn.get(u);if(g&&g.ok===!1&&f-(g.ts||0)>=ys&&(Tn.delete(u),g=void 0),g){if(g.module)o=g.module;else if(g.promise)try{o=await g.promise}catch{o=null}}else{const d={promise:null,module:null,ok:null,ts:0};Tn.set(u,d),d.promise=(async()=>{try{try{try{return await import(`highlight.js/lib/languages/${u}.js`)}catch{return await import(`highlight.js/lib/languages/${u}`)}}catch{try{const p=`https://cdn.jsdelivr.net/npm/highlight.js/es/languages/${u}.js`;return await new Function("u","return import(u)")(p)}catch{try{const m=`https://cdn.jsdelivr.net/npm/highlight.js/lib/languages/${u}.js`;return await new Function("u","return import(u)")(m)}catch{return null}}}}catch{return null}})();try{o=await d.promise,d.module=o,d.ok=!!o,d.ts=Date.now()}catch{d.module=null,d.ok=!1,d.ts=Date.now(),o=null}}if(o){const d=o.default||o;try{const h=se.size&&se.get(e)||u||e;return he.registerLanguage(h,d),St.add(h),h!==e&&(he.registerLanguage(e,d),St.add(e)),!0}catch(h){l=h}}else try{if(se.has(u)||se.has(e)){const d=()=>({});try{he.registerLanguage(u,d),St.add(u)}catch{}try{u!==e&&(he.registerLanguage(e,d),St.add(e))}catch{}return!0}}catch{}}catch(f){l=f}if(l)throw l;return!1}catch{return!1}}let Yt=null;function Zr(e=document){tt||(async()=>{try{await Wn()}catch(i){console.warn("[codeblocksManager] loadSupportedLanguages (observer) failed",i)}})();const t=Ne,s=Yt||(typeof IntersectionObserver>"u"?null:(Yt=new IntersectionObserver((i,a)=>{i.forEach(c=>{if(!c.isIntersecting)return;const o=c.target;try{a.unobserve(o)}catch(l){console.warn("[codeblocksManager] observer unobserve failed",l)}(async()=>{try{const l=o.getAttribute&&o.getAttribute("class")||o.className||"",u=l.match(/language-([a-zA-Z0-9_+-]+)/)||l.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(u&&u[1]){const f=(u[1]||"").toLowerCase(),g=t[f]||f,d=se.size&&(se.get(g)||se.get(String(g).toLowerCase()))||g;try{await yt(d)}catch(h){console.warn("[codeblocksManager] registerLanguage failed",h)}try{try{const h=o.textContent||o.innerText||"";h!=null&&(o.textContent=h)}catch{}try{o&&o.dataset&&o.dataset.highlighted&&delete o.dataset.highlighted}catch{}he.highlightElement(o)}catch(h){console.warn("[codeblocksManager] hljs.highlightElement failed",h)}}else try{const f=o.textContent||"";try{if(he&&typeof he.getLanguage=="function"&&he.getLanguage("plaintext")){const g=he.highlight(f,{language:"plaintext"});g&&g.value&&(o.innerHTML=g.value)}}catch{try{he.highlightElement(o)}catch(d){console.warn("[codeblocksManager] fallback highlightElement failed",d)}}}catch(f){console.warn("[codeblocksManager] auto-detect plaintext failed",f)}}catch(l){console.warn("[codeblocksManager] observer entry processing failed",l)}})()})},{root:null,rootMargin:"300px",threshold:.1}),Yt)),r=e&&e.querySelectorAll?e.querySelectorAll("pre code"):[];if(!s){r.forEach(async i=>{try{const a=i.getAttribute&&i.getAttribute("class")||i.className||"",c=a.match(/language-([a-zA-Z0-9_+-]+)/)||a.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(c&&c[1]){const o=(c[1]||"").toLowerCase(),l=t[o]||o,u=se.size&&(se.get(l)||se.get(String(l).toLowerCase()))||l;try{await yt(u)}catch(f){console.warn("[codeblocksManager] registerLanguage failed (no observer)",f)}}try{try{const o=i.textContent||i.innerText||"";o!=null&&(i.textContent=o)}catch{}try{i&&i.dataset&&i.dataset.highlighted&&delete i.dataset.highlighted}catch{}he.highlightElement(i)}catch(o){console.warn("[codeblocksManager] hljs.highlightElement failed (no observer)",o)}}catch(a){console.warn("[codeblocksManager] loadSupportedLanguages fallback ignored error",a)}});return}r.forEach(i=>{try{s.observe(i)}catch(a){console.warn("[codeblocksManager] observe failed",a)}})}function ks(e,{useCdn:t=!0}={}){const n=document.querySelector("link[data-hl-theme]"),s=n&&n.getAttribute?n.getAttribute("data-hl-theme"):null,r=e==null?"default":String(e),i=r&&String(r).toLowerCase()||"";if(i==="default"||i==="monokai"){try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}return}if(s&&s.toLowerCase()===i)return;if(!t){console.warn("Requested highlight theme not bundled; set useCdn=true to load theme from CDN");return}const a=i,c=`https://cdn.jsdelivr.net/npm/highlight.js@${ws}/styles/${a}.css`,o=document.createElement("link");o.rel="stylesheet",o.href=c,o.setAttribute("data-hl-theme",a),o.addEventListener("load",()=>{try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}}),document.head.appendChild(o)}let ot="light";function xs(e,t={}){if(document.querySelector(`link[href="${e}"]`))return;const n=document.createElement("link");if(n.rel="stylesheet",n.href=e,Object.entries(t).forEach(([s,r])=>n.setAttribute(s,r)),document.head.appendChild(n),t["data-bulmaswatch-theme"])try{if(n.getAttribute("data-bulmaswatch-observer"))return;let s=Number(n.getAttribute("data-bulmaswatch-move-count")||0),r=!1;const i=new MutationObserver(()=>{try{if(r)return;const c=n.parentNode;if(!c||c.lastElementChild===n)return;if(s>=1e3){n.setAttribute("data-bulmaswatch-move-stopped","1");return}r=!0;try{c.appendChild(n)}catch{}s+=1,n.setAttribute("data-bulmaswatch-move-count",String(s)),r=!1}catch{}});try{i.observe(document.head,{childList:!0}),n.setAttribute("data-bulmaswatch-observer","1"),n.setAttribute("data-bulmaswatch-move-count",String(s))}catch{}const a=document.head;a&&a.lastElementChild!==n&&a.appendChild(n)}catch{}}function Sr(){try{const e=Array.from(document.querySelectorAll("link[data-bulmaswatch-theme]"));for(const t of e)t&&t.parentNode&&t.parentNode.removeChild(t)}catch{}try{const e=Array.from(document.querySelectorAll("style[data-bulma-override]"));for(const t of e)t&&t.parentNode&&t.parentNode.removeChild(t)}catch{}}async function Gr(e="none",t="/"){if(typeof window<"u"&&window.__nimbiCMSDebug)try{console.debug("[bulmaManager] ensureBulma called",{bulmaCustomize:e,pageDir:t})}catch{}if(!e)return;if(e==="none"){try{const i=[location&&location.protocol&&location.protocol==="file:"?"https://unpkg.com/bulma/css/bulma.min.css":"//unpkg.com/bulma/css/bulma.min.css","https://unpkg.com/bulma/css/bulma.min.css"];let a=!1;for(const c of i)try{if(document.querySelector(`link[href="${c}"]`)){a=!0;break}}catch{}if(!a){const c=i[0],o=document.createElement("link");o.rel="stylesheet",o.href=c,o.setAttribute("data-bulma-base","1");const l=document.querySelector('link[href*="/dist/nimbi-cms.css"], link[href*="dist/nimbi-cms.css"]');l&&l.parentNode?l.parentNode.insertBefore(o,l):document.head.appendChild(o)}}catch{}try{const i=Array.from(document.querySelectorAll("link[data-bulmaswatch-theme]"));for(const a of i)a&&a.parentNode&&a.parentNode.removeChild(a)}catch{}try{const i=Array.from(document.querySelectorAll("style[data-bulma-override]"));for(const a of i)a&&a.parentNode&&a.parentNode.removeChild(a)}catch{}return}const s=[t+"bulma.css","/bulma.css"],r=Array.from(new Set(s));if(e==="local"){if(Sr(),document.querySelector("style[data-bulma-override]"))return;for(const i of r)try{const a=await fetch(i,{method:"GET"});if(a.ok){const c=await a.text(),o=document.createElement("style");o.setAttribute("data-bulma-override",i),o.appendChild(document.createTextNode(`
/* bulma override: ${i} */
`+c)),document.head.appendChild(o);return}}catch(a){console.warn("[bulmaManager] fetch local bulma candidate failed",a)}return}try{const i=String(e).trim();if(!i)return;Sr();const a=`https://unpkg.com/bulmaswatch/${encodeURIComponent(i)}/bulmaswatch.min.css`;xs(a,{"data-bulmaswatch-theme":i})}catch(i){console.warn("[bulmaManager] ensureBulma failed",i)}}function Qr(e){ot=e==="dark"?"dark":e==="system"?"system":"light";try{const t=Array.from(document.querySelectorAll(".nimbi-mount"));if(t.length>0)for(const n of t)ot==="dark"?n.setAttribute("data-theme","dark"):ot==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme");else{const n=document.documentElement;ot==="dark"?n.setAttribute("data-theme","dark"):ot==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme")}}catch{}}function Ss(e){const t=document.documentElement;for(const[n,s]of Object.entries(e||{}))try{t.style.setProperty(`--${n}`,s)}catch(r){console.warn("[bulmaManager] setThemeVars failed for",n,r)}}function Xr(e){if(!e||!(e instanceof HTMLElement))return()=>{};const t=e.closest&&e.closest(".nimbi-mount")||null;try{t&&(ot==="dark"?t.setAttribute("data-theme","dark"):ot==="light"?t.setAttribute("data-theme","light"):t.removeAttribute("data-theme"))}catch{}return()=>{}}const Kr={en:{navigation:"Navigation",onThisPage:"On this page",home:"Home",scrollToTop:"Scroll to top",readingTime:"{minutes} min read",searchPlaceholder:"Search…",imagePreviewTitle:"Image preview",imagePreviewFit:"Fit to screen",imagePreviewOriginal:"Original size",imagePreviewZoomOut:"Zoom out",imagePreviewZoomIn:"Zoom in",imagePreviewClose:"Close"},es:{navigation:"Navegación",onThisPage:"En esta página",home:"Inicio",scrollToTop:"Ir arriba",readingTime:"{minutes} min de lectura",searchPlaceholder:"Buscar…",imagePreviewTitle:"Previsualización de imagen",imagePreviewFit:"Ajustar a la pantalla",imagePreviewOriginal:"Tamaño original",imagePreviewZoomOut:"Alejar",imagePreviewZoomIn:"Acercar",imagePreviewClose:"Cerrar"},de:{navigation:"Navigation",onThisPage:"Auf dieser Seite",home:"Startseite",scrollToTop:"Nach oben",readingTime:"{minutes} min Lesezeit",searchPlaceholder:"Suchen…",imagePreviewTitle:"Bildvorschau",imagePreviewFit:"An Bildschirm anpassen",imagePreviewOriginal:"Originalgröße",imagePreviewZoomOut:"Verkleinern",imagePreviewZoomIn:"Vergrößern",imagePreviewClose:"Schließen"},fr:{navigation:"Navigation",onThisPage:"Sur cette page",home:"Accueil",scrollToTop:"Aller en haut",readingTime:"{minutes} min de lecture",searchPlaceholder:"Rechercher…",imagePreviewTitle:"Aperçu de l’image",imagePreviewFit:"Ajuster à l’écran",imagePreviewOriginal:"Taille originale",imagePreviewZoomOut:"Dézoomer",imagePreviewZoomIn:"Zoomer",imagePreviewClose:"Fermer"},pt:{navigation:"Navegação",onThisPage:"Nesta página",home:"Início",scrollToTop:"Ir para o topo",readingTime:"{minutes} min de leitura",searchPlaceholder:"Procurar…",imagePreviewTitle:"Visualização da imagem",imagePreviewFit:"Ajustar à tela",imagePreviewOriginal:"Tamanho original",imagePreviewZoomOut:"Diminuir",imagePreviewZoomIn:"Aumentar",imagePreviewClose:"Fechar"}},wt=JSON.parse(JSON.stringify(Kr));let rn="en";if(typeof navigator<"u"){const e=navigator.language||navigator.languages&&navigator.languages[0]||"en";rn=String(e).split("-")[0].toLowerCase()}Kr[rn]||(rn="en");let nt=rn;function pt(e,t={}){const n=wt[nt]||wt.en;let s=n&&n[e]?n[e]:wt.en[e]||"";for(const r of Object.keys(t))s=s.replace(new RegExp(`{${r}}`,"g"),String(t[r]));return s}async function Fn(e,t){if(!e)return;let n=e;try{/^https?:\/\//.test(e)||(n=new URL(e,location.origin+t).toString());const s=await fetch(n);if(!s.ok)return;const r=await s.json();for(const i of Object.keys(r||{}))wt[i]=Object.assign({},wt[i]||{},r[i])}catch{}}function Zn(e){const t=String(e).split("-")[0].toLowerCase();nt=wt[t]?t:"en"}const vs=Object.freeze(Object.defineProperty({__proto__:null,get currentLang(){return nt},loadL10nFile:Fn,setLang:Zn,t:pt},Symbol.toStringTag,{value:"Module"})),Es=`import { buildSearchIndex, crawlForSlug } from '../slugManager.js'
...
`}strong({tokens:e}){return`<strong>${this.parser.parseInline(e)}</strong>`}em({tokens:e}){return`<em>${this.parser.parseInline(e)}</em>`}codespan({text:e}){return`<code>${Fe(e,!0)}</code>`}br(e){return"<br>"}del({tokens:e}){return`<del>${this.parser.parseInline(e)}</del>`}link({href:e,title:t,tokens:n}){let s=this.parser.parseInline(n),r=$r(e);if(r===null)return s;e=r;let i='<a href="'+e+'"';return t&&(i+=' title="'+Fe(t)+'"'),i+=">"+s+"</a>",i}image({href:e,title:t,text:n,tokens:s}){s&&(n=this.parser.parseInline(s,this.parser.textRenderer));let r=$r(e);if(r===null)return Fe(n);e=r;let i=`<img src="${e}" alt="${Fe(n)}"`;return t&&(i+=` title="${Fe(t)}"`),i+=">",i}text(e){return"tokens"in e&&e.tokens?this.parser.parseInline(e.tokens):"escaped"in e&&e.escaped?e.text:Fe(e.text)}},wn=class{strong({text:e}){return e}em({text:e}){return e}codespan({text:e}){return e}del({text:e}){return e}html({text:e}){return e}text({text:e}){return e}link({text:e}){return""+e}image({text:e}){return""+e}br(){return""}checkbox({raw:e}){return e}},qe=class Dn{options;renderer;textRenderer;constructor(t){this.options=t||rt,this.options.renderer=this.options.renderer||new Dt,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new wn}static parse(t,n){return new Dn(n).parse(t)}static parseInline(t,n){return new Dn(n).parseInline(t)}parse(t){let n="";for(let s=0;s<t.length;s++){let r=t[s];if(this.options.extensions?.renderers?.[r.type]){let a=r,c=this.options.extensions.renderers[a.type].call({parser:this},a);if(c!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(a.type)){n+=c||"";continue}}let i=r;switch(i.type){case"space":{n+=this.renderer.space(i);break}case"hr":{n+=this.renderer.hr(i);break}case"heading":{n+=this.renderer.heading(i);break}case"code":{n+=this.renderer.code(i);break}case"table":{n+=this.renderer.table(i);break}case"blockquote":{n+=this.renderer.blockquote(i);break}case"list":{n+=this.renderer.list(i);break}case"checkbox":{n+=this.renderer.checkbox(i);break}case"html":{n+=this.renderer.html(i);break}case"def":{n+=this.renderer.def(i);break}case"paragraph":{n+=this.renderer.paragraph(i);break}case"text":{n+=this.renderer.text(i);break}default:{let a='Token with "'+i.type+'" type was not found.';if(this.options.silent)return console.error(a),"";throw new Error(a)}}}return n}parseInline(t,n=this.renderer){let s="";for(let r=0;r<t.length;r++){let i=t[r];if(this.options.extensions?.renderers?.[i.type]){let c=this.options.extensions.renderers[i.type].call({parser:this},i);if(c!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(i.type)){s+=c||"";continue}}let a=i;switch(a.type){case"escape":{s+=n.text(a);break}case"html":{s+=n.html(a);break}case"link":{s+=n.link(a);break}case"image":{s+=n.image(a);break}case"checkbox":{s+=n.checkbox(a);break}case"strong":{s+=n.strong(a);break}case"em":{s+=n.em(a);break}case"codespan":{s+=n.codespan(a);break}case"br":{s+=n.br(a);break}case"del":{s+=n.del(a);break}case"text":{s+=n.text(a);break}default:{let c='Token with "'+a.type+'" type was not found.';if(this.options.silent)return console.error(c),"";throw new Error(c)}}}return s}},mt=class{options;block;constructor(e){this.options=e||rt}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens","emStrongMask"]);static passThroughHooksRespectAsync=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}emStrongMask(e){return e}provideLexer(){return this.block?De.lex:De.lexInline}provideParser(){return this.block?qe.parse:qe.parseInline}},Ei=class{defaults=pn();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=qe;Renderer=Dt;TextRenderer=wn;Lexer=De;Tokenizer=Ot;Hooks=mt;constructor(...e){this.use(...e)}walkTokens(e,t){let n=[];for(let s of e)switch(n=n.concat(t.call(this,s)),s.type){case"table":{let r=s;for(let i of r.header)n=n.concat(this.walkTokens(i.tokens,t));for(let i of r.rows)for(let a of i)n=n.concat(this.walkTokens(a.tokens,t));break}case"list":{let r=s;n=n.concat(this.walkTokens(r.items,t));break}default:{let r=s;this.defaults.extensions?.childTokens?.[r.type]?this.defaults.extensions.childTokens[r.type].forEach(i=>{let a=r[i].flat(1/0);n=n.concat(this.walkTokens(a,t))}):r.tokens&&(n=n.concat(this.walkTokens(r.tokens,t)))}}return n}use(...e){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(n=>{let s={...n};if(s.async=this.defaults.async||s.async||!1,n.extensions&&(n.extensions.forEach(r=>{if(!r.name)throw new Error("extension name required");if("renderer"in r){let i=t.renderers[r.name];i?t.renderers[r.name]=function(...a){let c=r.renderer.apply(this,a);return c===!1&&(c=i.apply(this,a)),c}:t.renderers[r.name]=r.renderer}if("tokenizer"in r){if(!r.level||r.level!=="block"&&r.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let i=t[r.level];i?i.unshift(r.tokenizer):t[r.level]=[r.tokenizer],r.start&&(r.level==="block"?t.startBlock?t.startBlock.push(r.start):t.startBlock=[r.start]:r.level==="inline"&&(t.startInline?t.startInline.push(r.start):t.startInline=[r.start]))}"childTokens"in r&&r.childTokens&&(t.childTokens[r.name]=r.childTokens)}),s.extensions=t),n.renderer){let r=this.defaults.renderer||new Dt(this.defaults);for(let i in n.renderer){if(!(i in r))throw new Error(`renderer '${i}' does not exist`);if(["options","parser"].includes(i))continue;let a=i,c=n.renderer[a],o=r[a];r[a]=(...l)=>{let u=c.apply(r,l);return u===!1&&(u=o.apply(r,l)),u||""}}s.renderer=r}if(n.tokenizer){let r=this.defaults.tokenizer||new Ot(this.defaults);for(let i in n.tokenizer){if(!(i in r))throw new Error(`tokenizer '${i}' does not exist`);if(["options","rules","lexer"].includes(i))continue;let a=i,c=n.tokenizer[a],o=r[a];r[a]=(...l)=>{let u=c.apply(r,l);return u===!1&&(u=o.apply(r,l)),u}}s.tokenizer=r}if(n.hooks){let r=this.defaults.hooks||new mt;for(let i in n.hooks){if(!(i in r))throw new Error(`hook '${i}' does not exist`);if(["options","block"].includes(i))continue;let a=i,c=n.hooks[a],o=r[a];mt.passThroughHooks.has(i)?r[a]=l=>{if(this.defaults.async&&mt.passThroughHooksRespectAsync.has(i))return(async()=>{let f=await c.call(r,l);return o.call(r,f)})();let u=c.call(r,l);return o.call(r,u)}:r[a]=(...l)=>{if(this.defaults.async)return(async()=>{let f=await c.apply(r,l);return f===!1&&(f=await o.apply(r,l)),f})();let u=c.apply(r,l);return u===!1&&(u=o.apply(r,l)),u}}s.hooks=r}if(n.walkTokens){let r=this.defaults.walkTokens,i=n.walkTokens;s.walkTokens=function(a){let c=[];return c.push(i.call(this,a)),r&&(c=c.concat(r.call(this,a))),c}}this.defaults={...this.defaults,...s}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return De.lex(e,t??this.defaults)}parser(e,t){return qe.parse(e,t??this.defaults)}parseMarkdown(e){return(t,n)=>{let s={...n},r={...this.defaults,...s},i=this.onError(!!r.silent,!!r.async);if(this.defaults.async===!0&&s.async===!1)return i(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof t>"u"||t===null)return i(new Error("marked(): input parameter is undefined or null"));if(typeof t!="string")return i(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(t)+", string expected"));if(r.hooks&&(r.hooks.options=r,r.hooks.block=e),r.async)return(async()=>{let a=r.hooks?await r.hooks.preprocess(t):t,c=await(r.hooks?await r.hooks.provideLexer():e?De.lex:De.lexInline)(a,r),o=r.hooks?await r.hooks.processAllTokens(c):c;r.walkTokens&&await Promise.all(this.walkTokens(o,r.walkTokens));let l=await(r.hooks?await r.hooks.provideParser():e?qe.parse:qe.parseInline)(o,r);return r.hooks?await r.hooks.postprocess(l):l})().catch(i);try{r.hooks&&(t=r.hooks.preprocess(t));let a=(r.hooks?r.hooks.provideLexer():e?De.lex:De.lexInline)(t,r);r.hooks&&(a=r.hooks.processAllTokens(a)),r.walkTokens&&this.walkTokens(a,r.walkTokens);let c=(r.hooks?r.hooks.provideParser():e?qe.parse:qe.parseInline)(a,r);return r.hooks&&(c=r.hooks.postprocess(c)),c}catch(a){return i(a)}}}onError(e,t){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,e){let s="<p>An error occurred:</p><pre>"+Fe(n.message+"",!0)+"</pre>";return t?Promise.resolve(s):s}if(t)return Promise.reject(n);throw n}}},ut=new Ei;function ae(e,t){return ut.parse(e,t)}ae.options=ae.setOptions=function(e){return ut.setOptions(e),ae.defaults=ut.defaults,di(ae.defaults),ae};ae.getDefaults=pn;ae.defaults=rt;ae.use=function(...e){return ut.use(...e),ae.defaults=ut.defaults,di(ae.defaults),ae};ae.walkTokens=function(e,t){return ut.walkTokens(e,t)};ae.parseInline=ut.parseInline;ae.Parser=qe;ae.parser=qe.parse;ae.Renderer=Dt;ae.TextRenderer=wn;ae.Lexer=De;ae.lexer=De.lex;ae.Tokenizer=Ot;ae.Hooks=mt;ae.parse=ae;var Na=ae.options,Oa=ae.setOptions,Da=ae.use,qa=ae.walkTokens,Ha=ae.parseInline,ja=ae,Ua=qe.parse,Wa=De.lex;const Ir=Object.freeze(Object.defineProperty({__proto__:null,Hooks:mt,Lexer:De,Marked:Ei,Parser:qe,Renderer:Dt,TextRenderer:wn,Tokenizer:Ot,get defaults(){return rt},getDefaults:pn,lexer:Wa,marked:ae,options:Na,parse:ja,parseInline:Ha,parser:Ua,setOptions:Oa,use:Da,walkTokens:qa},Symbol.toStringTag,{value:"Module"})),Ai=`function O() {
