"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const xt={onPageLoad:[],onNavBuild:[],transformHtml:[]};function Yt(t,e){if(!Object.prototype.hasOwnProperty.call(xt,t))throw new Error('Unknown hook "'+t+'"');if(typeof e!="function")throw new TypeError("hook callback must be a function");xt[t].push(e)}function li(t){Yt("onPageLoad",t)}function oi(t){Yt("onNavBuild",t)}function ci(t){Yt("transformHtml",t)}async function wn(t,e){const r=xt[t]||[];for(const i of r)try{await i(e)}catch(n){console.warn("[nimbi-cms] runHooks callback failed",n)}}function ui(){Object.keys(xt).forEach(t=>{xt[t].length=0})}function $r(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var cn,or;function hi(){if(or)return cn;or=1;function t(g){return g instanceof Map?g.clear=g.delete=g.set=function(){throw new Error("map is read-only")}:g instanceof Set&&(g.add=g.clear=g.delete=function(){throw new Error("set is read-only")}),Object.freeze(g),Object.getOwnPropertyNames(g).forEach(S=>{const L=g[S],F=typeof L;(F==="object"||F==="function")&&!Object.isFrozen(L)&&t(L)}),g}class e{constructor(S){S.data===void 0&&(S.data={}),this.data=S.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function r(g){return g.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function i(g,...S){const L=Object.create(null);for(const F in g)L[F]=g[F];return S.forEach(function(F){for(const he in F)L[he]=F[he]}),L}const n="</span>",s=g=>!!g.scope,a=(g,{prefix:S})=>{if(g.startsWith("language:"))return g.replace("language:","language-");if(g.includes(".")){const L=g.split(".");return[`${S}${L.shift()}`,...L.map((F,he)=>`${F}${"_".repeat(he+1)}`)].join(" ")}return`${S}${g}`};class h{constructor(S,L){this.buffer="",this.classPrefix=L.classPrefix,S.walk(this)}addText(S){this.buffer+=r(S)}openNode(S){if(!s(S))return;const L=a(S.scope,{prefix:this.classPrefix});this.span(L)}closeNode(S){s(S)&&(this.buffer+=n)}value(){return this.buffer}span(S){this.buffer+=`<span class="${S}">`}}const l=(g={})=>{const S={children:[]};return Object.assign(S,g),S};class o{constructor(){this.rootNode=l(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(S){this.top.children.push(S)}openNode(S){const L=l({scope:S});this.add(L),this.stack.push(L)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(S){return this.constructor._walk(S,this.rootNode)}static _walk(S,L){return typeof L=="string"?S.addText(L):L.children&&(S.openNode(L),L.children.forEach(F=>this._walk(S,F)),S.closeNode(L)),S}static _collapse(S){typeof S!="string"&&S.children&&(S.children.every(L=>typeof L=="string")?S.children=[S.children.join("")]:S.children.forEach(L=>{o._collapse(L)}))}}class u extends o{constructor(S){super(),this.options=S}addText(S){S!==""&&this.add(S)}startScope(S){this.openNode(S)}endScope(){this.closeNode()}__addSublanguage(S,L){const F=S.root;L&&(F.scope=`language:${L}`),this.add(F)}toHTML(){return new h(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function c(g){return g?typeof g=="string"?g:g.source:null}function f(g){return m("(?=",g,")")}function p(g){return m("(?:",g,")*")}function d(g){return m("(?:",g,")?")}function m(...g){return g.map(L=>c(L)).join("")}function w(g){const S=g[g.length-1];return typeof S=="object"&&S.constructor===Object?(g.splice(g.length-1,1),S):{}}function y(...g){return"("+(w(g).capture?"":"?:")+g.map(F=>c(F)).join("|")+")"}function x(g){return new RegExp(g.toString()+"|").exec("").length-1}function z(g,S){const L=g&&g.exec(S);return L&&L.index===0}const R=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function _(g,{joinWith:S}){let L=0;return g.map(F=>{L+=1;const he=L;let de=c(F),N="";for(;de.length>0;){const B=R.exec(de);if(!B){N+=de;break}N+=de.substring(0,B.index),de=de.substring(B.index+B[0].length),B[0][0]==="\\"&&B[1]?N+="\\"+String(Number(B[1])+he):(N+=B[0],B[0]==="("&&L++)}return N}).map(F=>`(${F})`).join(S)}const q=/\b\B/,O="[a-zA-Z]\\w*",Q="[a-zA-Z_]\\w*",Y="\\b\\d+(\\.\\d+)?",te="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",P="\\b(0b[01]+)",T="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",I=(g={})=>{const S=/^#![ ]*\//;return g.binary&&(g.begin=m(S,/.*\b/,g.binary,/\b.*/)),i({scope:"meta",begin:S,end:/$/,relevance:0,"on:begin":(L,F)=>{L.index!==0&&F.ignoreMatch()}},g)},C={begin:"\\\\[\\s\\S]",relevance:0},v={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[C]},b={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[C]},E={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},$=function(g,S,L={}){const F=i({scope:"comment",begin:g,end:S,contains:[]},L);F.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const he=y("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return F.contains.push({begin:m(/[ ]+/,"(",he,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),F},k=$("//","$"),G=$("/\\*","\\*/"),ue=$("#","$"),oe={scope:"number",begin:Y,relevance:0},Le={scope:"number",begin:te,relevance:0},ve={scope:"number",begin:P,relevance:0},Ee={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[C,{begin:/\[/,end:/\]/,relevance:0,contains:[C]}]},fe={scope:"title",begin:O,relevance:0},Ie={scope:"title",begin:Q,relevance:0},Xe={begin:"\\.\\s*"+Q,relevance:0};var Ct=Object.freeze({__proto__:null,APOS_STRING_MODE:v,BACKSLASH_ESCAPE:C,BINARY_NUMBER_MODE:ve,BINARY_NUMBER_RE:P,COMMENT:$,C_BLOCK_COMMENT_MODE:G,C_LINE_COMMENT_MODE:k,C_NUMBER_MODE:Le,C_NUMBER_RE:te,END_SAME_AS_BEGIN:function(g){return Object.assign(g,{"on:begin":(S,L)=>{L.data._beginMatch=S[1]},"on:end":(S,L)=>{L.data._beginMatch!==S[1]&&L.ignoreMatch()}})},HASH_COMMENT_MODE:ue,IDENT_RE:O,MATCH_NOTHING_RE:q,METHOD_GUARD:Xe,NUMBER_MODE:oe,NUMBER_RE:Y,PHRASAL_WORDS_MODE:E,QUOTE_STRING_MODE:b,REGEXP_MODE:Ee,RE_STARTERS_RE:T,SHEBANG:I,TITLE_MODE:fe,UNDERSCORE_IDENT_RE:Q,UNDERSCORE_TITLE_MODE:Ie});function vs(g,S){g.input[g.index-1]==="."&&S.ignoreMatch()}function Es(g,S){g.className!==void 0&&(g.scope=g.className,delete g.className)}function As(g,S){S&&g.beginKeywords&&(g.begin="\\b("+g.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",g.__beforeBegin=vs,g.keywords=g.keywords||g.beginKeywords,delete g.beginKeywords,g.relevance===void 0&&(g.relevance=0))}function Rs(g,S){Array.isArray(g.illegal)&&(g.illegal=y(...g.illegal))}function Ts(g,S){if(g.match){if(g.begin||g.end)throw new Error("begin & end are not supported with match");g.begin=g.match,delete g.match}}function Cs(g,S){g.relevance===void 0&&(g.relevance=1)}const Ls=(g,S)=>{if(!g.beforeMatch)return;if(g.starts)throw new Error("beforeMatch cannot be used with starts");const L=Object.assign({},g);Object.keys(g).forEach(F=>{delete g[F]}),g.keywords=L.keywords,g.begin=m(L.beforeMatch,f(L.begin)),g.starts={relevance:0,contains:[Object.assign(L,{endsParent:!0})]},g.relevance=0,delete L.beforeMatch},_s=["of","and","for","in","not","or","if","then","parent","list","value"],Ms="keyword";function Zn(g,S,L=Ms){const F=Object.create(null);return typeof g=="string"?he(L,g.split(" ")):Array.isArray(g)?he(L,g):Object.keys(g).forEach(function(de){Object.assign(F,Zn(g[de],S,de))}),F;function he(de,N){S&&(N=N.map(B=>B.toLowerCase())),N.forEach(function(B){const j=B.split("|");F[j[0]]=[de,$s(j[0],j[1])]})}}function $s(g,S){return S?Number(S):Ps(g)?0:1}function Ps(g){return _s.includes(g.toLowerCase())}const Qn={},Ke=g=>{console.error(g)},Gn=(g,...S)=>{console.log(`WARN: ${g}`,...S)},tt=(g,S)=>{Qn[`${g}/${S}`]||(console.log(`Deprecated as of ${g}. ${S}`),Qn[`${g}/${S}`]=!0)},Lt=new Error;function Xn(g,S,{key:L}){let F=0;const he=g[L],de={},N={};for(let B=1;B<=S.length;B++)N[B+F]=he[B],de[B+F]=!0,F+=x(S[B-1]);g[L]=N,g[L]._emit=de,g[L]._multi=!0}function Is(g){if(Array.isArray(g.begin)){if(g.skip||g.excludeBegin||g.returnBegin)throw Ke("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Lt;if(typeof g.beginScope!="object"||g.beginScope===null)throw Ke("beginScope must be object"),Lt;Xn(g,g.begin,{key:"beginScope"}),g.begin=_(g.begin,{joinWith:""})}}function zs(g){if(Array.isArray(g.end)){if(g.skip||g.excludeEnd||g.returnEnd)throw Ke("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Lt;if(typeof g.endScope!="object"||g.endScope===null)throw Ke("endScope must be object"),Lt;Xn(g,g.end,{key:"endScope"}),g.end=_(g.end,{joinWith:""})}}function Bs(g){g.scope&&typeof g.scope=="object"&&g.scope!==null&&(g.beginScope=g.scope,delete g.scope)}function Os(g){Bs(g),typeof g.beginScope=="string"&&(g.beginScope={_wrap:g.beginScope}),typeof g.endScope=="string"&&(g.endScope={_wrap:g.endScope}),Is(g),zs(g)}function Ns(g){function S(N,B){return new RegExp(c(N),"m"+(g.case_insensitive?"i":"")+(g.unicodeRegex?"u":"")+(B?"g":""))}class L{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(B,j){j.position=this.position++,this.matchIndexes[this.matchAt]=j,this.regexes.push([j,B]),this.matchAt+=x(B)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const B=this.regexes.map(j=>j[1]);this.matcherRe=S(_(B,{joinWith:"|"}),!0),this.lastIndex=0}exec(B){this.matcherRe.lastIndex=this.lastIndex;const j=this.matcherRe.exec(B);if(!j)return null;const me=j.findIndex((ct,nn)=>nn>0&&ct!==void 0),pe=this.matchIndexes[me];return j.splice(0,me),Object.assign(j,pe)}}class F{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(B){if(this.multiRegexes[B])return this.multiRegexes[B];const j=new L;return this.rules.slice(B).forEach(([me,pe])=>j.addRule(me,pe)),j.compile(),this.multiRegexes[B]=j,j}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(B,j){this.rules.push([B,j]),j.type==="begin"&&this.count++}exec(B){const j=this.getMatcher(this.regexIndex);j.lastIndex=this.lastIndex;let me=j.exec(B);if(this.resumingScanAtSamePosition()&&!(me&&me.index===this.lastIndex)){const pe=this.getMatcher(0);pe.lastIndex=this.lastIndex+1,me=pe.exec(B)}return me&&(this.regexIndex+=me.position+1,this.regexIndex===this.count&&this.considerAll()),me}}function he(N){const B=new F;return N.contains.forEach(j=>B.addRule(j.begin,{rule:j,type:"begin"})),N.terminatorEnd&&B.addRule(N.terminatorEnd,{type:"end"}),N.illegal&&B.addRule(N.illegal,{type:"illegal"}),B}function de(N,B){const j=N;if(N.isCompiled)return j;[Es,Ts,Os,Ls].forEach(pe=>pe(N,B)),g.compilerExtensions.forEach(pe=>pe(N,B)),N.__beforeBegin=null,[As,Rs,Cs].forEach(pe=>pe(N,B)),N.isCompiled=!0;let me=null;return typeof N.keywords=="object"&&N.keywords.$pattern&&(N.keywords=Object.assign({},N.keywords),me=N.keywords.$pattern,delete N.keywords.$pattern),me=me||/\w+/,N.keywords&&(N.keywords=Zn(N.keywords,g.case_insensitive)),j.keywordPatternRe=S(me,!0),B&&(N.begin||(N.begin=/\B|\b/),j.beginRe=S(j.begin),!N.end&&!N.endsWithParent&&(N.end=/\B|\b/),N.end&&(j.endRe=S(j.end)),j.terminatorEnd=c(j.end)||"",N.endsWithParent&&B.terminatorEnd&&(j.terminatorEnd+=(N.end?"|":"")+B.terminatorEnd)),N.illegal&&(j.illegalRe=S(N.illegal)),N.contains||(N.contains=[]),N.contains=[].concat(...N.contains.map(function(pe){return Ds(pe==="self"?N:pe)})),N.contains.forEach(function(pe){de(pe,j)}),N.starts&&de(N.starts,B),j.matcher=he(j),j}if(g.compilerExtensions||(g.compilerExtensions=[]),g.contains&&g.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return g.classNameAliases=i(g.classNameAliases||{}),de(g)}function Kn(g){return g?g.endsWithParent||Kn(g.starts):!1}function Ds(g){return g.variants&&!g.cachedVariants&&(g.cachedVariants=g.variants.map(function(S){return i(g,{variants:null},S)})),g.cachedVariants?g.cachedVariants:Kn(g)?i(g,{starts:g.starts?i(g.starts):null}):Object.isFrozen(g)?i(g):g}var Hs="11.11.1";class Us extends Error{constructor(S,L){super(S),this.name="HTMLInjectionError",this.html=L}}const tn=r,Yn=i,Vn=Symbol("nomatch"),qs=7,Jn=function(g){const S=Object.create(null),L=Object.create(null),F=[];let he=!0;const de="Could not find the language '{}', did you forget to load/include a language module?",N={disableAutodetect:!0,name:"Plain text",contains:[]};let B={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:u};function j(A){return B.noHighlightRe.test(A)}function me(A){let U=A.className+" ";U+=A.parentNode?A.parentNode.className:"";const V=B.languageDetectRe.exec(U);if(V){const ie=qe(V[1]);return ie||(Gn(de.replace("{}",V[1])),Gn("Falling back to no-highlight mode for this block.",A)),ie?V[1]:"no-highlight"}return U.split(/\s+/).find(ie=>j(ie)||qe(ie))}function pe(A,U,V){let ie="",ge="";typeof U=="object"?(ie=A,V=U.ignoreIllegals,ge=U.language):(tt("10.7.0","highlight(lang, code, ...args) has been deprecated."),tt("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),ge=A,ie=U),V===void 0&&(V=!0);const Me={code:ie,language:ge};Mt("before:highlight",Me);const je=Me.result?Me.result:ct(Me.language,Me.code,V);return je.code=Me.code,Mt("after:highlight",je),je}function ct(A,U,V,ie){const ge=Object.create(null);function Me(M,D){return M.keywords[D]}function je(){if(!Z.keywords){we.addText(ae);return}let M=0;Z.keywordPatternRe.lastIndex=0;let D=Z.keywordPatternRe.exec(ae),X="";for(;D;){X+=ae.substring(M,D.index);const se=Be.case_insensitive?D[0].toLowerCase():D[0],ye=Me(Z,se);if(ye){const[De,ii]=ye;if(we.addText(X),X="",ge[se]=(ge[se]||0)+1,ge[se]<=qs&&(It+=ii),De.startsWith("_"))X+=D[0];else{const ai=Be.classNameAliases[De]||De;ze(D[0],ai)}}else X+=D[0];M=Z.keywordPatternRe.lastIndex,D=Z.keywordPatternRe.exec(ae)}X+=ae.substring(M),we.addText(X)}function $t(){if(ae==="")return;let M=null;if(typeof Z.subLanguage=="string"){if(!S[Z.subLanguage]){we.addText(ae);return}M=ct(Z.subLanguage,ae,!0,lr[Z.subLanguage]),lr[Z.subLanguage]=M._top}else M=rn(ae,Z.subLanguage.length?Z.subLanguage:null);Z.relevance>0&&(It+=M.relevance),we.__addSublanguage(M._emitter,M.language)}function Ae(){Z.subLanguage!=null?$t():je(),ae=""}function ze(M,D){M!==""&&(we.startScope(D),we.addText(M),we.endScope())}function rr(M,D){let X=1;const se=D.length-1;for(;X<=se;){if(!M._emit[X]){X++;continue}const ye=Be.classNameAliases[M[X]]||M[X],De=D[X];ye?ze(De,ye):(ae=De,je(),ae=""),X++}}function sr(M,D){return M.scope&&typeof M.scope=="string"&&we.openNode(Be.classNameAliases[M.scope]||M.scope),M.beginScope&&(M.beginScope._wrap?(ze(ae,Be.classNameAliases[M.beginScope._wrap]||M.beginScope._wrap),ae=""):M.beginScope._multi&&(rr(M.beginScope,D),ae="")),Z=Object.create(M,{parent:{value:Z}}),Z}function ir(M,D,X){let se=z(M.endRe,X);if(se){if(M["on:end"]){const ye=new e(M);M["on:end"](D,ye),ye.isMatchIgnored&&(se=!1)}if(se){for(;M.endsParent&&M.parent;)M=M.parent;return M}}if(M.endsWithParent)return ir(M.parent,D,X)}function ei(M){return Z.matcher.regexIndex===0?(ae+=M[0],1):(on=!0,0)}function ti(M){const D=M[0],X=M.rule,se=new e(X),ye=[X.__beforeBegin,X["on:begin"]];for(const De of ye)if(De&&(De(M,se),se.isMatchIgnored))return ei(D);return X.skip?ae+=D:(X.excludeBegin&&(ae+=D),Ae(),!X.returnBegin&&!X.excludeBegin&&(ae=D)),sr(X,M),X.returnBegin?0:D.length}function ni(M){const D=M[0],X=U.substring(M.index),se=ir(Z,M,X);if(!se)return Vn;const ye=Z;Z.endScope&&Z.endScope._wrap?(Ae(),ze(D,Z.endScope._wrap)):Z.endScope&&Z.endScope._multi?(Ae(),rr(Z.endScope,M)):ye.skip?ae+=D:(ye.returnEnd||ye.excludeEnd||(ae+=D),Ae(),ye.excludeEnd&&(ae=D));do Z.scope&&we.closeNode(),!Z.skip&&!Z.subLanguage&&(It+=Z.relevance),Z=Z.parent;while(Z!==se.parent);return se.starts&&sr(se.starts,M),ye.returnEnd?0:D.length}function ri(){const M=[];for(let D=Z;D!==Be;D=D.parent)D.scope&&M.unshift(D.scope);M.forEach(D=>we.openNode(D))}let Pt={};function ar(M,D){const X=D&&D[0];if(ae+=M,X==null)return Ae(),0;if(Pt.type==="begin"&&D.type==="end"&&Pt.index===D.index&&X===""){if(ae+=U.slice(D.index,D.index+1),!he){const se=new Error(`0 width match regex (${A})`);throw se.languageName=A,se.badRule=Pt.rule,se}return 1}if(Pt=D,D.type==="begin")return ti(D);if(D.type==="illegal"&&!V){const se=new Error('Illegal lexeme "'+X+'" for mode "'+(Z.scope||"<unnamed>")+'"');throw se.mode=Z,se}else if(D.type==="end"){const se=ni(D);if(se!==Vn)return se}if(D.type==="illegal"&&X==="")return ae+=`
`,1;if(ln>1e5&&ln>D.index*3)throw new Error("potential infinite loop, way more iterations than matches");return ae+=X,X.length}const Be=qe(A);if(!Be)throw Ke(de.replace("{}",A)),new Error('Unknown language: "'+A+'"');const si=Ns(Be);let an="",Z=ie||si;const lr={},we=new B.__emitter(B);ri();let ae="",It=0,Ye=0,ln=0,on=!1;try{if(Be.__emitTokens)Be.__emitTokens(U,we);else{for(Z.matcher.considerAll();;){ln++,on?on=!1:Z.matcher.considerAll(),Z.matcher.lastIndex=Ye;const M=Z.matcher.exec(U);if(!M)break;const D=U.substring(Ye,M.index),X=ar(D,M);Ye=M.index+X}ar(U.substring(Ye))}return we.finalize(),an=we.toHTML(),{language:A,value:an,relevance:It,illegal:!1,_emitter:we,_top:Z}}catch(M){if(M.message&&M.message.includes("Illegal"))return{language:A,value:tn(U),illegal:!0,relevance:0,_illegalBy:{message:M.message,index:Ye,context:U.slice(Ye-100,Ye+100),mode:M.mode,resultSoFar:an},_emitter:we};if(he)return{language:A,value:tn(U),illegal:!1,relevance:0,errorRaised:M,_emitter:we,_top:Z};throw M}}function nn(A){const U={value:tn(A),illegal:!1,relevance:0,_top:N,_emitter:new B.__emitter(B)};return U._emitter.addText(A),U}function rn(A,U){U=U||B.languages||Object.keys(S);const V=nn(A),ie=U.filter(qe).filter(nr).map(Ae=>ct(Ae,A,!1));ie.unshift(V);const ge=ie.sort((Ae,ze)=>{if(Ae.relevance!==ze.relevance)return ze.relevance-Ae.relevance;if(Ae.language&&ze.language){if(qe(Ae.language).supersetOf===ze.language)return 1;if(qe(ze.language).supersetOf===Ae.language)return-1}return 0}),[Me,je]=ge,$t=Me;return $t.secondBest=je,$t}function js(A,U,V){const ie=U&&L[U]||V;A.classList.add("hljs"),A.classList.add(`language-${ie}`)}function sn(A){let U=null;const V=me(A);if(j(V))return;if(Mt("before:highlightElement",{el:A,language:V}),A.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",A);return}if(A.children.length>0&&(B.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(A)),B.throwUnescapedHTML))throw new Us("One of your code blocks includes unescaped HTML.",A.innerHTML);U=A;const ie=U.textContent,ge=V?pe(ie,{language:V,ignoreIllegals:!0}):rn(ie);A.innerHTML=ge.value,A.dataset.highlighted="yes",js(A,V,ge.language),A.result={language:ge.language,re:ge.relevance,relevance:ge.relevance},ge.secondBest&&(A.secondBest={language:ge.secondBest.language,relevance:ge.secondBest.relevance}),Mt("after:highlightElement",{el:A,result:ge,text:ie})}function Ws(A){B=Yn(B,A)}const Fs=()=>{_t(),tt("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function Zs(){_t(),tt("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let er=!1;function _t(){function A(){_t()}if(document.readyState==="loading"){er||window.addEventListener("DOMContentLoaded",A,!1),er=!0;return}document.querySelectorAll(B.cssSelector).forEach(sn)}function Qs(A,U){let V=null;try{V=U(g)}catch(ie){if(Ke("Language definition for '{}' could not be registered.".replace("{}",A)),he)Ke(ie);else throw ie;V=N}V.name||(V.name=A),S[A]=V,V.rawDefinition=U.bind(null,g),V.aliases&&tr(V.aliases,{languageName:A})}function Gs(A){delete S[A];for(const U of Object.keys(L))L[U]===A&&delete L[U]}function Xs(){return Object.keys(S)}function qe(A){return A=(A||"").toLowerCase(),S[A]||S[L[A]]}function tr(A,{languageName:U}){typeof A=="string"&&(A=[A]),A.forEach(V=>{L[V.toLowerCase()]=U})}function nr(A){const U=qe(A);return U&&!U.disableAutodetect}function Ks(A){A["before:highlightBlock"]&&!A["before:highlightElement"]&&(A["before:highlightElement"]=U=>{A["before:highlightBlock"](Object.assign({block:U.el},U))}),A["after:highlightBlock"]&&!A["after:highlightElement"]&&(A["after:highlightElement"]=U=>{A["after:highlightBlock"](Object.assign({block:U.el},U))})}function Ys(A){Ks(A),F.push(A)}function Vs(A){const U=F.indexOf(A);U!==-1&&F.splice(U,1)}function Mt(A,U){const V=A;F.forEach(function(ie){ie[V]&&ie[V](U)})}function Js(A){return tt("10.7.0","highlightBlock will be removed entirely in v12.0"),tt("10.7.0","Please use highlightElement now."),sn(A)}Object.assign(g,{highlight:pe,highlightAuto:rn,highlightAll:_t,highlightElement:sn,highlightBlock:Js,configure:Ws,initHighlighting:Fs,initHighlightingOnLoad:Zs,registerLanguage:Qs,unregisterLanguage:Gs,listLanguages:Xs,getLanguage:qe,registerAliases:tr,autoDetection:nr,inherit:Yn,addPlugin:Ys,removePlugin:Vs}),g.debugMode=function(){he=!1},g.safeMode=function(){he=!0},g.versionString=Hs,g.regex={concat:m,lookahead:f,either:y,optional:d,anyNumberOfTimes:p};for(const A in Ct)typeof Ct[A]=="object"&&t(Ct[A]);return Object.assign(g,Ct),g},nt=Jn({});return nt.newInstance=()=>Jn({}),cn=nt,nt.HighlightJS=nt,nt.default=nt,cn}var di=hi();const le=$r(di),J=new Map,pi="https://raw.githubusercontent.com/highlightjs/highlight.js/main/SUPPORTED_LANGUAGES.md",Re={shell:"bash",sh:"bash",zsh:"bash",js:"javascript",ts:"typescript",py:"python",csharp:"cs","c#":"cs"};Re.html="xml";Re.xhtml="xml";Re.markup="xml";const Cn=new Set(["magic","undefined"]);let Ze=null;const cr=new Map,fi=300*1e3;async function Ln(t=pi){if(t)return Ze||(Ze=(async()=>{try{const e=await fetch(t);if(!e.ok)return;const i=(await e.text()).split(/\r?\n/);let n=-1;for(let o=0;o<i.length;o++)if(/\|\s*Language\s*\|/i.test(i[o])){n=o;break}if(n===-1)return;const s=i[n].replace(/^\||\|$/g,"").split("|").map(o=>o.trim().toLowerCase());let a=s.findIndex(o=>/alias|aliases|equivalent|alt|alternates?/i.test(o));a===-1&&(a=1);let h=s.findIndex(o=>/file|filename|module|module name|module-name|short|slug/i.test(o));if(h===-1){const o=s.findIndex(u=>/language/i.test(u));h=o!==-1?o:0}let l=[];for(let o=n+1;o<i.length;o++){const u=i[o].trim();if(!u||!u.startsWith("|"))break;const c=u.replace(/^\||\|$/g,"").split("|").map(w=>w.trim());if(c.every(w=>/^-+$/.test(w)))continue;const f=c;if(!f.length)continue;const d=(f[h]||f[0]||"").toString().trim().toLowerCase();if(!d||/^-+$/.test(d))continue;J.set(d,d);const m=f[a]||"";if(m){const w=String(m).split(",").map(y=>y.replace(/`/g,"").trim()).filter(Boolean);if(w.length){const x=w[0].toLowerCase().replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");x&&/[a-z0-9]/i.test(x)&&(J.set(x,x),l.push(x))}}}try{const o=[];for(const u of l){const c=String(u||"").replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");c&&/[a-z0-9]/i.test(c)?o.push(c):J.delete(u)}l=o}catch(o){console.warn("[codeblocksManager] cleanup aliases failed",o)}try{let o=0;for(const u of Array.from(J.keys())){if(!u||/^-+$/.test(u)||!/[a-z0-9]/i.test(u)){J.delete(u),o++;continue}if(/^[:]+/.test(u)){const c=u.replace(/^[:]+/,"");if(c&&/[a-z0-9]/i.test(c)){const f=J.get(u);J.delete(u),J.set(c,f)}else J.delete(u),o++}}for(const[u,c]of Array.from(J.entries()))(!c||/^-+$/.test(c)||!/[a-z0-9]/i.test(c))&&(J.delete(u),o++);try{const u=":---------------------";J.has(u)&&(J.delete(u),o++)}catch(u){console.warn("[codeblocksManager] remove sep key failed",u)}try{const u=Array.from(J.keys()).sort()}catch(u){console.warn("[codeblocksManager] compute supported keys failed",u)}}catch(o){console.warn("[codeblocksManager] ignored error",o)}}catch(e){console.warn("[codeblocksManager] loadSupportedLanguages failed",e)}})(),Ze)}const un=new Set;async function lt(t,e){if(Ze||(async()=>{try{await Ln()}catch(n){console.warn("[codeblocksManager] loadSupportedLanguages (IIFE) failed",n)}})(),Ze)try{await Ze}catch{}if(t=t==null?"":String(t),t=t.trim(),!t)return!1;const r=t.toLowerCase();if(Cn.has(r))return!1;if(J.size&&!J.has(r)){const n=Re;if(!n[r]&&!n[t])return!1}if(un.has(t))return!0;const i=Re;try{const n=(e||t||"").toString().replace(/\.js$/i,"").trim(),s=(i[t]||t||"").toString(),a=(i[n]||n||"").toString();let h=Array.from(new Set([s,a,n,t,i[n],i[t]].filter(Boolean))).map(u=>String(u).toLowerCase()).filter(u=>u&&u!=="undefined");J.size&&(h=h.filter(u=>{if(J.has(u))return!0;const c=Re[u];return!!(c&&J.has(c))}));let l=null,o=null;for(const u of h)try{const c=Date.now(),f=cr.get(u);if(f){if(f.ok===!1&&c-(f.ts||0)<fi)l=null;else if(f.module)l=f.module;else if(f.promise)try{l=await f.promise}catch{l=null}}else{const p={promise:null,module:null,ok:null,ts:0};cr.set(u,p),p.promise=(async()=>{try{try{return await import(`highlight.js/lib/languages/${u}.js`)}catch{try{const m=`https://cdn.jsdelivr.net/npm/highlight.js/es/languages/${u}.js`;return await new Function("u","return import(u)")(m)}catch{try{const w=`https://cdn.jsdelivr.net/npm/highlight.js/lib/languages/${u}.js`;return await new Function("u","return import(u)")(w)}catch{return null}}}}catch{return null}})();try{l=await p.promise,p.module=l,p.ok=!!l,p.ts=Date.now()}catch{p.module=null,p.ok=!1,p.ts=Date.now(),l=null}}if(l){const p=l.default||l;try{const d=J.size&&J.get(t)||u||t;return le.registerLanguage(d,p),un.add(d),d!==t&&(le.registerLanguage(t,p),un.add(t)),!0}catch(d){o=d}}}catch(c){o=c}if(o)throw o;return!1}catch{return!1}}let zt=null;function Pr(t=document){Ze||(async()=>{try{await Ln()}catch(s){console.warn("[codeblocksManager] loadSupportedLanguages (observer) failed",s)}})();const e=Re,i=zt||(typeof IntersectionObserver>"u"?null:(zt=new IntersectionObserver((s,a)=>{s.forEach(h=>{if(!h.isIntersecting)return;const l=h.target;try{a.unobserve(l)}catch(o){console.warn("[codeblocksManager] observer unobserve failed",o)}(async()=>{try{const o=l.getAttribute&&l.getAttribute("class")||l.className||"",u=o.match(/language-([a-zA-Z0-9_+-]+)/)||o.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(u&&u[1]){const c=(u[1]||"").toLowerCase(),f=e[c]||c,p=J.size&&(J.get(f)||J.get(String(f).toLowerCase()))||f;try{await lt(p)}catch(d){console.warn("[codeblocksManager] registerLanguage failed",d)}try{le.highlightElement(l)}catch(d){console.warn("[codeblocksManager] hljs.highlightElement failed",d)}}else try{const c=l.textContent||"";try{if(le&&typeof le.getLanguage=="function"&&le.getLanguage("plaintext")){const f=le.highlight(c,{language:"plaintext"});f&&f.value&&(l.innerHTML=f.value)}}catch{try{le.highlightElement(l)}catch(p){console.warn("[codeblocksManager] fallback highlightElement failed",p)}}}catch(c){console.warn("[codeblocksManager] auto-detect plaintext failed",c)}}catch(o){console.warn("[codeblocksManager] observer entry processing failed",o)}})()})},{root:null,rootMargin:"300px",threshold:.1}),zt)),n=t&&t.querySelectorAll?t.querySelectorAll("pre code"):[];if(!i){n.forEach(async s=>{try{const a=s.getAttribute&&s.getAttribute("class")||s.className||"",h=a.match(/language-([a-zA-Z0-9_+-]+)/)||a.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(h&&h[1]){const l=(h[1]||"").toLowerCase(),o=e[l]||l,u=J.size&&(J.get(o)||J.get(String(o).toLowerCase()))||o;try{await lt(u)}catch(c){console.warn("[codeblocksManager] registerLanguage failed (no observer)",c)}}try{le.highlightElement(s)}catch(l){console.warn("[codeblocksManager] hljs.highlightElement failed (no observer)",l)}}catch(a){console.warn("[codeblocksManager] loadSupportedLanguages fallback ignored error",a)}});return}n.forEach(s=>{try{i.observe(s)}catch(a){console.warn("[codeblocksManager] observe failed",a)}})}function gi(t,{useCdn:e=!0}={}){const r=document.querySelector("link[data-hl-theme]");r&&r.remove();let i=t||"monokai";if(i==="monokai")return;if(!e){console.warn("Requested highlight theme not bundled; set useCdn=true to load from CDN");return}const n=`https://cdn.jsdelivr.net/npm/highlight.js@11.8.0/styles/${i}.css`,s=document.createElement("link");s.rel="stylesheet",s.href=n,s.setAttribute("data-hl-theme",i),document.head.appendChild(s)}let hn="light";function mi(t,e={}){if(document.querySelector(`link[href="${t}"]`))return;const r=document.createElement("link");r.rel="stylesheet",r.href=t,Object.entries(e).forEach(([i,n])=>r.setAttribute(i,n)),document.head.appendChild(r)}async function Ir(t="none",e="/"){if(!t||t==="none")return;const r=[e+"bulma.css","/bulma.css"],i=Array.from(new Set(r));if(t==="local"){if(document.querySelector("style[data-bulma-override]"))return;for(const n of i)try{const s=await fetch(n,{method:"GET"});if(s.ok){const a=await s.text(),h=document.createElement("style");h.setAttribute("data-bulma-override",n),h.appendChild(document.createTextNode(`
/* bulma override: ${n} */
...
`;function Or(t,e="worker"){let r=null;function i(){if(!r)try{const h=t();r=h||null,h&&h.addEventListener("error",()=>{try{r===h&&(r=null,h.terminate&&h.terminate())}catch(l){console.warn("["+e+"] worker termination failed",l)}})}catch(h){r=null,console.warn("["+e+"] worker init failed",h)}return r}function n(){try{r&&(r.terminate&&r.terminate(),r=null)}catch(h){console.warn("["+e+"] worker termination failed",h)}}function s(h,l=1e3){return new Promise((o,u)=>{const c=i();if(!c)return u(new Error("worker unavailable"));const f=String(Math.random());h.id=f;let p=null;const d=()=>{p&&clearTimeout(p),c.removeEventListener("message",m),c.removeEventListener("error",w)},m=y=>{const x=y.data||{};x.id===f&&(d(),x.error?u(new Error(x.error)):o(x.result))},w=y=>{d(),console.warn("["+e+"] worker error event",y);try{r===c&&(r=null,c.terminate&&c.terminate())}catch(x){console.warn("["+e+"] worker termination failed",x)}u(new Error(y&&y.message||"worker error"))};p=setTimeout(()=>{d(),console.warn("["+e+"] worker timed out");try{r===c&&(r=null,c.terminate&&c.terminate())}catch(y){console.warn("["+e+"] worker termination on timeout failed",y)}u(new Error("worker timeout"))},l),c.addEventListener("message",m),c.addEventListener("error",w);try{c.postMessage(h)}catch(y){d(),u(y)}})}return{get:i,send:s,terminate:n}}function ki(t){try{if(typeof Blob<"u"&&typeof URL<"u"&&t){const e=new Blob([t],{type:"application/javascript"}),r=URL.createObjectURL(e);return new Worker(r,{type:"module"})}}catch(e){console.warn("[worker-manager] createWorkerFromRaw failed",e)}return null}const Ne=new Set;function $n(t){xi(),Ne.clear();for(const e of Te)e&&Ne.add(e);ur(K),ur(H),$n._refreshed=!0}function ur(t){if(!(!t||typeof t.values!="function"))for(const e of t.values())e&&Ne.add(e)}function hr(t){if(!t||typeof t.set!="function")return;const e=t.set;t.set=function(r,i){return i&&Ne.add(i),e.call(this,r,i)}}let dr=!1;function xi(){dr||(hr(K),hr(H),dr=!0)}function Nr(t){return!t||typeof t!="string"?!1:/^(https?:)?\/\//.test(t)||t.startsWith("mailto:")||t.startsWith("tel:")}function ce(t){return String(t||"").replace(/^[.\/]+/,"")}function vt(t){return String(t||"").replace(/\/+$/,"")}function St(t){return vt(t)+"/"}function Si(t){try{if(!t||typeof document>"u"||!document.head||t.startsWith("data:")||document.head.querySelector(`link[rel="preload"][as="image"][href="${t}"]`))return;const r=document.createElement("link");r.rel="preload",r.as="image",r.href=t,document.head.appendChild(r)}catch(e){console.warn("[helpers] preloadImage failed",e)}}function Bt(t,e=0,r=!1){try{if(typeof window>"u"||!t||!t.querySelectorAll)return;const i=Array.from(t.querySelectorAll("img"));if(!i.length)return;const n=t,s=n&&n.getBoundingClientRect?n.getBoundingClientRect():null,a=0,h=typeof window<"u"&&(window.innerHeight||document.documentElement.clientHeight)||0,l=s?Math.max(a,s.top):a,u=(s?Math.min(h,s.bottom):h)+Number(e||0);let c=0;n&&(c=n.clientHeight||(s?s.height:0)),c||(c=h-a);let f=.6;try{const w=n&&window.getComputedStyle?window.getComputedStyle(n):null,y=w&&w.getPropertyValue("--nimbi-image-max-height-ratio"),x=y?parseFloat(y):NaN;!Number.isNaN(x)&&x>0&&x<=1&&(f=x)}catch(w){console.warn("[helpers] read CSS ratio failed",w)}const p=Math.max(200,Math.floor(c*f));let d=!1,m=null;if(i.forEach(w=>{try{const y=w.getAttribute?w.getAttribute("loading"):void 0;y!=="eager"&&w.setAttribute&&w.setAttribute("loading","lazy");const x=w.getBoundingClientRect?w.getBoundingClientRect():null,z=w.src||w.getAttribute&&w.getAttribute("src"),R=x&&x.height>1?x.height:p,_=x?x.top:0,q=_+R,O=!!(x&&R>0&&_<=u&&q>=l);O&&(w.setAttribute?(w.setAttribute("loading","eager"),w.setAttribute("fetchpriority","high"),w.setAttribute("data-eager-by-nimbi","1")):(w.loading="eager",w.fetchPriority="high"),Si(z),d=!0),!m&&x&&x.top<=u&&(m={img:w,src:z,rect:x,beforeLoading:y}),r&&console.log("[helpers] setEagerForAboveFoldImages:",{src:z,rect:x,marginPx:e,visibleTop:l,visibleBottom:u,beforeLoading:y,isAboveFold:O,effectiveHeight:R,maxImageHeight:p})}catch(y){console.warn("[helpers] setEagerForAboveFoldImages per-image failed",y)}}),!d&&m){const{img:w,src:y,rect:x,beforeLoading:z}=m;try{w.setAttribute?(w.setAttribute("loading","eager"),w.setAttribute("fetchpriority","high"),w.setAttribute("data-eager-by-nimbi","1")):(w.loading="eager",w.fetchPriority="high"),r&&console.log("[helpers] setEagerForAboveFoldImages (fallback first visible):",{src:y,rect:x,marginPx:e,visibleTop:l,visibleBottom:u,beforeLoading:z,fallback:!0})}catch(R){console.warn("[helpers] setEagerForAboveFoldImages fallback failed",R)}}}catch(i){console.warn("[helpers] setEagerForAboveFoldImages failed",i)}}function jt(t){try{const e=t();return e&&typeof e.then=="function"?e.catch(r=>{console.warn("[helpers] safe swallowed error",r)}):e}catch(e){console.warn("[helpers] safe swallowed error",e)}}try{typeof globalThis<"u"&&!globalThis.safe&&(globalThis.safe=jt)}catch(t){console.warn("[helpers] global attach failed",t)}const K=new Map;let Ce=[],Pn=!1;function Dr(t){Pn=!!t}function Hr(t){Ce=Array.isArray(t)?t.slice():[]}function vi(){return Ce}const Ur=Or(()=>ki(yi),"slugManager");function In(){return Ur.get()}function qr(t){return Ur.send(t)}async function Ei(t,e=1,r=void 0){if(!In())return Zt(t,e,r);try{return await qr({type:"buildSearchIndex",contentBase:t,indexDepth:e,noIndexing:r})}catch(n){try{return await Zt(t,e,r)}catch(s){throw console.warn("[slugManager] buildSearchIndex fallback failed",s),n}}}async function Ai(t,e,r){return In()?qr({type:"crawlForSlug",slug:t,base:e,maxQueue:r}):zn(t,e,r)}function We(t,e){if(t)if(Ce&&Ce.length){const i=e.split("/")[0],n=Ce.includes(i);let s=K.get(t);(!s||typeof s=="string")&&(s={default:typeof s=="string"?s:void 0,langs:{}}),n?s.langs[i]=e:s.default=e,K.set(t,s)}else K.set(t,e)}const Vt=new Set;function Ri(t){typeof t=="function"&&Vt.add(t)}function Ti(t){typeof t=="function"&&Vt.delete(t)}const H=new Map;let bn={},Te=[],ot="_404.md",it="_home.md";function yn(t){t!=null&&(ot=String(t||""))}function kn(t){t!=null&&(it=String(t||""))}function Ci(t){bn=t||{}}const gt=new Map,Wt=new Set;function Li(){gt.clear(),Wt.clear()}function _i(t){if(!t||t.length===0)return"";let e=t[0];for(let i=1;i<t.length;i++){const n=t[i];let s=0;const a=Math.min(e.length,n.length);for(;s<a&&e[s]===n[s];)s++;e=e.slice(0,s)}const r=e.lastIndexOf("/");return r===-1?e:e.slice(0,r+1)}function Ft(t){K.clear(),H.clear(),Te=[],Ce=Ce||[];const e=Object.keys(bn||{});if(!e.length)return;let r="";try{if(t){try{/^[a-z][a-z0-9+.-]*:/i.test(String(t))?r=new URL(String(t)).pathname:r=String(t||"")}catch(i){r=String(t||""),console.warn("[slugManager] parse contentBase failed",i)}r=St(r)}}catch(i){r="",console.warn("[slugManager] setContentBase prefix derivation failed",i)}r||(r=_i(e));for(const i of e){let n=i;r&&i.startsWith(r)?n=ce(i.slice(r.length)):n=ce(i),Te.push(n);try{$n()}catch(a){console.warn("[slugManager] refreshIndexPaths failed",a)}const s=bn[i];if(typeof s=="string"){const a=(s||"").match(/^#\s+(.+)$/m);if(a&&a[1]){const h=re(a[1].trim());if(h)try{if(Ce&&Ce.length){const o=n.split("/")[0],u=Ce.includes(o);let c=K.get(h);(!c||typeof c=="string")&&(c={default:typeof c=="string"?c:void 0,langs:{}}),u?c.langs[o]=n:c.default=n,K.set(h,c)}else K.set(h,n);H.set(n,h)}catch(l){console.warn("[slugManager] set slug mapping failed",l)}}}}}try{Ft()}catch(t){console.warn("[slugManager] initial setContentBase failed",t)}function re(t){let e=String(t||"").toLowerCase().replace(/[^a-z0-9\- ]/g,"").replace(/ /g,"-");return e=e.replace(/(?:-?)(?:md|html)$/,""),e}function Mi(t){return Et(t,void 0)}function Et(t,e){if(!t)return!1;if(t.startsWith("//"))return!0;if(/^[a-z][a-z0-9+.-]*:/i.test(t)){if(e&&typeof e=="string")try{const r=new URL(t),i=new URL(e);return r.origin!==i.origin?!0:!r.pathname.startsWith(i.pathname)}catch{return!0}return!0}if(t.startsWith("/")&&e&&typeof e=="string")try{const r=new URL(t,e),i=new URL(e);return r.origin!==i.origin?!0:!r.pathname.startsWith(i.pathname)}catch{return!0}return!1}function Nt(t){return t==null?t:String(t).replace(/\\([\\`*_{}\[\]()#+\-.!])/g,(e,r)=>r)}function At(t){if(!t||!K.has(t))return null;const e=K.get(t);if(!e)return null;if(typeof e=="string")return e;if(Ce&&Ce.length&&Qe&&e.langs&&e.langs[Qe])return e.langs[Qe];if(e.default)return e.default;if(e.langs){const r=Object.keys(e.langs);if(r.length)return e.langs[r[0]]}return null}const mt=new Map;function $i(){mt.clear()}let be=async function(t,e){if(!t)throw new Error("path required");try{const s=(String(t||"").match(/([^\/]+)\.md(?:$|[?#])/)||[])[1];if(s&&K.has(s)){const a=At(s)||K.get(s);a&&a!==t&&(t=a)}}catch(s){console.warn("[slugManager] slug mapping normalization failed",s)}const r=e==null?"":vt(String(e));let i="";try{r?/^[a-z][a-z0-9+.-]*:/i.test(r)?i=r.replace(/\/$/,"")+"/"+t.replace(/^\//,""):i=(r.startsWith("/")?"":"/")+r.replace(/\/$/,"")+"/"+t.replace(/^\//,""):i="/"+t.replace(/^\//,"")}catch{i="/"+t.replace(/^\//,"")}if(mt.has(i))return mt.get(i);const n=(async()=>{const s=await fetch(i);if(!s||typeof s.ok!="boolean"||!s.ok){if(s&&s.status===404)try{const c=`${r}/${ot}`,f=await globalThis.fetch(c);if(f&&typeof f.ok=="boolean"&&f.ok)return{raw:await f.text(),status:404}}catch(c){console.warn("[slugManager] fetching fallback 404 failed",c)}let u="";try{s&&typeof s.clone=="function"?u=await s.clone().text():s&&typeof s.text=="function"?u=await s.text():u=""}catch(c){u="",console.warn("[slugManager] reading error body failed",c)}throw console.error("fetchMarkdown failed:",{url:i,status:s?s.status:void 0,statusText:s?s.statusText:void 0,body:u.slice(0,200)}),new Error("failed to fetch md")}const a=await s.text(),h=a.trim().slice(0,16).toLowerCase(),l=h.startsWith("<!doctype")||h.startsWith("<html"),o=l||String(t||"").toLowerCase().endsWith(".html");if(l&&String(t||"").toLowerCase().endsWith(".md")){try{const u=`${r}/${ot}`,c=await globalThis.fetch(u);if(c.ok)return{raw:await c.text(),status:404}}catch(u){console.warn("[slugManager] fetching fallback 404 failed",u)}throw console.error("fetchMarkdown: server returned HTML for .md request",i),new Error("failed to fetch md")}return o?{raw:a,isHtml:!0}:{raw:a}})();return mt.set(i,n),n};function Pi(t){typeof t=="function"&&(be=t)}const Dt=new Map;let He=[],ut=null;async function Zt(t,e=1,r=void 0){const i=Array.isArray(r)?Array.from(new Set((r||[]).map(n=>ce(String(n||""))))):[];try{const n=ce(String(ot||""));n&&!i.includes(n)&&i.push(n)}catch{}if(He&&He.length&&e===1&&!He.some(s=>{try{return i.includes(ce(String(s.path||"")))}catch{return!1}}))return He;if(ut)return ut;ut=(async()=>{let n=Array.isArray(r)?Array.from(new Set((r||[]).map(o=>ce(String(o||""))))):[];try{const o=ce(String(ot||""));o&&!n.includes(o)&&n.push(o)}catch{}const s=o=>{if(!n||!n.length)return!1;for(const u of n)if(u&&(o===u||o.startsWith(u+"/")))return!0;return!1};let a=[];if(Te&&Te.length&&(a=Array.from(Te)),!a.length)for(const o of K.values())o&&a.push(o);try{const o=await Zr(t);o&&o.length&&(a=a.concat(o))}catch(o){console.warn("[slugManager] crawlAllMarkdown during buildSearchIndex failed",o)}try{const o=new Set(a),u=[...a];for(o.size;u.length&&o.size<=Rt;){const c=u.shift();try{const f=await be(c,t);if(f&&f.raw){if(f.status===404)continue;let p=f.raw;const d=[],m=String(c||"").replace(/^.*\//,"");if(/^readme(?:\.md)?$/i.test(m)&&Pn&&(!c||!c.includes("/")))continue;const w=/\[[^\]]+\]\(([^)]+)\)/g;let y;for(;y=w.exec(p);)d.push(y[1]);const x=/<a\s+[^>]*href=["']([^"']+)["'][^>]*>/gi;for(;y=x.exec(p);)d.push(y[1]);const z=c&&c.includes("/")?c.substring(0,c.lastIndexOf("/")+1):"";for(let R of d)try{if(Et(R,t)||R.startsWith("..")||R.indexOf("/../")!==-1||(z&&!R.startsWith("./")&&!R.startsWith("/")&&!R.startsWith("../")&&(R=z+R),R=ce(R),!/\.(md|html?)(?:$|[?#])/i.test(R))||(R=R.split(/[?#]/)[0],s(R)))continue;o.has(R)||(o.add(R),u.push(R),a.push(R))}catch(_){console.warn("[slugManager] href processing failed",R,_)}}}catch(f){console.warn("[slugManager] discovery fetch failed for",c,f)}}}catch(o){console.warn("[slugManager] discovery loop failed",o)}const h=new Set;a=a.filter(o=>!o||h.has(o)||s(o)?!1:(h.add(o),!0));const l=[];for(const o of a)if(/\.(?:md|html?)(?:$|[?#])/i.test(o))try{const u=await be(o,t);if(u&&u.raw){if(u.status===404)continue;let c="",f="";if(u.isHtml)try{const m=new DOMParser().parseFromString(u.raw,"text/html"),w=m.querySelector("title")||m.querySelector("h1");w&&w.textContent&&(c=w.textContent.trim());const y=m.querySelector("p");if(y&&y.textContent&&(f=y.textContent.trim()),e>=2)try{const x=m.querySelector("h1"),z=x&&x.textContent?x.textContent.trim():c||"",R=(()=>{try{if(H.has(o))return H.get(o)}catch{}return re(c||o)})(),_=Array.from(m.querySelectorAll("h2"));for(const q of _)try{const O=(q.textContent||"").trim();if(!O)continue;const Q=q.id?q.id:re(O),Y=R?`${R}::${Q}`:`${re(o)}::${Q}`;let te="",P=q.nextElementSibling;for(;P&&P.tagName&&P.tagName.toLowerCase()==="script";)P=P.nextElementSibling;P&&P.textContent&&(te=String(P.textContent).trim()),l.push({slug:Y,title:O,excerpt:te,path:o,parentTitle:z})}catch(O){console.warn("[slugManager] indexing H2 failed",O)}if(e===3)try{const q=Array.from(m.querySelectorAll("h3"));for(const O of q)try{const Q=(O.textContent||"").trim();if(!Q)continue;const Y=O.id?O.id:re(Q),te=R?`${R}::${Y}`:`${re(o)}::${Y}`;let P="",T=O.nextElementSibling;for(;T&&T.tagName&&T.tagName.toLowerCase()==="script";)T=T.nextElementSibling;T&&T.textContent&&(P=String(T.textContent).trim()),l.push({slug:te,title:Q,excerpt:P,path:o,parentTitle:z})}catch(Q){console.warn("[slugManager] indexing H3 failed",Q)}}catch(q){console.warn("[slugManager] collect H3s failed",q)}}catch(x){console.warn("[slugManager] collect H2s failed",x)}}catch(d){console.warn("[slugManager] parsing HTML for index failed",d)}else{const d=u.raw,m=d.match(/^#\s+(.+)$/m);c=m?m[1].trim():"";try{c=Nt(c)}catch{}const w=d.split(/\r?\n\s*\r?\n/);if(w.length>1)for(let y=1;y<w.length;y++){const x=w[y].trim();if(x&&!/^#/.test(x)){f=x.replace(/\r?\n/g," ");break}}if(e>=2){let y="",x="";try{const z=(d.match(/^#\s+(.+)$/m)||[])[1];y=z?z.trim():"",x=(function(){try{if(H.has(o))return H.get(o)}catch{}return re(c||o)})();const R=/^##\s+(.+)$/gm;let _;for(;_=R.exec(d);)try{const q=(_[1]||"").trim(),O=Nt(q);if(!q)continue;const Q=re(q),Y=x?`${x}::${Q}`:`${re(o)}::${Q}`,P=d.slice(R.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),T=P&&P[1]?String(P[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";l.push({slug:Y,title:O,excerpt:T,path:o,parentTitle:y})}catch(q){console.warn("[slugManager] indexing markdown H2 failed",q)}}catch(z){console.warn("[slugManager] collect markdown H2s failed",z)}if(e===3)try{const z=/^###\s+(.+)$/gm;let R;for(;R=z.exec(d);)try{const _=(R[1]||"").trim(),q=Nt(_);if(!_)continue;const O=re(_),Q=x?`${x}::${O}`:`${re(o)}::${O}`,te=d.slice(z.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),P=te&&te[1]?String(te[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";l.push({slug:Q,title:q,excerpt:P,path:o,parentTitle:y})}catch(_){console.warn("[slugManager] indexing markdown H3 failed",_)}}catch(z){console.warn("[slugManager] collect markdown H3s failed",z)}}}let p="";try{H.has(o)&&(p=H.get(o))}catch(d){console.warn("[slugManager] mdToSlug access failed",d)}p||(p=re(c||o)),l.push({slug:p,title:c,excerpt:f,path:o})}}catch(u){console.warn("[slugManager] buildSearchIndex: entry fetch failed",u)}try{He=l.filter(u=>{try{return!s(String(u.path||""))}catch{return!0}})}catch(o){console.warn("[slugManager] filtering index by excludes failed",o),He=l}return He})();try{await ut}catch(n){console.warn("[slugManager] awaiting _indexPromise failed",n)}return ut=null,He}const jr=1e3;let Rt=jr;function Ii(t){typeof t=="number"&&t>=0&&(Rt=t)}const Wr=new DOMParser,Fr="a[href]";let zn=async function(t,e,r=Rt){if(Dt.has(t))return Dt.get(t);let i=null;const n=new Set,s=[""];for(;s.length&&!i&&!(s.length>r);){const a=s.shift();if(n.has(a))continue;n.add(a);let h=e;h.endsWith("/")||(h+="/"),h+=a;try{const l=await globalThis.fetch(h);if(!l.ok)continue;const o=await l.text(),c=Wr.parseFromString(o,"text/html").querySelectorAll(Fr);for(const f of c)try{let p=f.getAttribute("href")||"";if(!p||Et(p,e)||p.startsWith("..")||p.indexOf("/../")!==-1)continue;if(p.endsWith("/")){const d=a+p;n.has(d)||s.push(d);continue}if(p.toLowerCase().endsWith(".md")){const d=ce(a+p);try{if(H.has(d))continue;for(const m of K.values());}catch(m){console.warn("[slugManager] slug map access failed",m)}try{const m=await be(d,e);if(m&&m.raw){const w=(m.raw||"").match(/^#\s+(.+)$/m);if(w&&w[1]&&re(w[1].trim())===t){i=d;break}}}catch(m){console.warn("[slugManager] crawlForSlug: fetchMarkdown failed",m)}}}catch(p){console.warn("[slugManager] crawlForSlug: link iteration failed",p)}}catch(l){console.warn("[slugManager] crawlForSlug: directory fetch failed",l)}}return Dt.set(t,i),i};async function Zr(t,e=Rt){const r=new Set,i=new Set,n=[""];for(;n.length&&!(n.length>e);){const s=n.shift();if(i.has(s))continue;i.add(s);let a=t;a.endsWith("/")||(a+="/"),a+=s;try{const h=await globalThis.fetch(a);if(!h.ok)continue;const l=await h.text(),u=Wr.parseFromString(l,"text/html").querySelectorAll(Fr);for(const c of u)try{let f=c.getAttribute("href")||"";if(!f||Et(f,t)||f.startsWith("..")||f.indexOf("/../")!==-1)continue;if(f.endsWith("/")){const d=s+f;i.has(d)||n.push(d);continue}const p=(s+f).replace(/^\/+/,"");/\.(md|html?)$/i.test(p)&&r.add(p)}catch(f){console.warn("[slugManager] crawlAllMarkdown: link iteration failed",f)}}catch(h){console.warn("[slugManager] crawlAllMarkdown: directory fetch failed",h)}}return Array.from(r)}async function Qr(t,e,r){if(t&&typeof t=="string"&&(t=ce(t),t=vt(t)),K.has(t))return At(t)||K.get(t);for(const n of Vt)try{const s=await n(t,e);if(s)return We(t,s),H.set(s,t),s}catch(s){console.warn("[slugManager] slug resolver failed",s)}if(Te&&Te.length){if(gt.has(t)){const n=gt.get(t);return K.set(t,n),H.set(n,t),n}for(const n of Te)if(!Wt.has(n))try{const s=await be(n,e);if(s&&s.raw){const a=(s.raw||"").match(/^#\s+(.+)$/m);if(a&&a[1]){const h=re(a[1].trim());if(Wt.add(n),h&&gt.set(h,n),h===t)return We(t,n),H.set(n,t),n}}}catch(s){console.warn("[slugManager] manifest title fetch failed",s)}}try{const n=await Zt(e);if(n&&n.length){const s=n.find(a=>a.slug===t);if(s)return We(t,s.path),H.set(s.path,t),s.path}}catch(n){console.warn("[slugManager] buildSearchIndex lookup failed",n)}try{const n=await zn(t,e,r);if(n)return We(t,n),H.set(n,t),n}catch(n){console.warn("[slugManager] crawlForSlug lookup failed",n)}const i=[`${t}.html`,`${t}.md`];for(const n of i)try{const s=await be(n,e);if(s&&s.raw)return We(t,n),H.set(n,t),n}catch(s){console.warn("[slugManager] candidate fetch failed",s)}if(Te&&Te.length)for(const n of Te)try{const s=n.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(re(s)===t)return We(t,n),H.set(n,t),n}catch(s){console.warn("[slugManager] build-time filename match failed",s)}try{const n=[];it&&typeof it=="string"&&it.trim()&&n.push(it),n.includes("_home.md")||n.push("_home.md");for(const s of n)try{const a=await be(s,e);if(a&&a.raw){const h=(a.raw||"").match(/^#\s+(.+)$/m);if(h&&h[1]&&re(h[1].trim())===t)return We(t,s),H.set(s,t),s}}catch{}}catch(n){console.warn("[slugManager] home page fetch failed",n)}return null}const Ht=Object.freeze(Object.defineProperty({__proto__:null,CRAWL_MAX_QUEUE:jr,_setAllMd:Ci,_storeSlugMapping:We,addSlugResolver:Ri,get allMarkdownPaths(){return Te},get availableLanguages(){return Ce},buildSearchIndex:Zt,buildSearchIndexWorker:Ei,clearFetchCache:$i,clearListCaches:Li,crawlAllMarkdown:Zr,crawlCache:Dt,crawlForSlug:zn,crawlForSlugWorker:Ai,get defaultCrawlMaxQueue(){return Rt},ensureSlug:Qr,fetchCache:mt,get fetchMarkdown(){return be},getLanguages:vi,get homePage(){return it},initSlugWorker:In,isExternalLink:Mi,isExternalLinkWithBase:Et,listPathsFetched:Wt,listSlugCache:gt,mdToSlug:H,get notFoundPage(){return ot},removeSlugResolver:Ti,resolveSlugPath:At,get searchIndex(){return He},setContentBase:Ft,setDefaultCrawlMaxQueue:Ii,setFetchMarkdown:Pi,setHomePage:kn,setLanguages:Hr,setNotFoundPage:yn,setSkipRootReadme:Dr,get skipRootReadme(){return Pn},slugResolvers:Vt,slugToMd:K,slugify:re,unescapeMarkdown:Nt},Symbol.toStringTag,{value:"Module"}));let Gr=100;function pr(t){Gr=t}let wt=300*1e3;function fr(t){wt=t}const _e=new Map;function zi(t){if(!_e.has(t))return;const e=_e.get(t),r=Date.now();if(e.ts+wt<r){_e.delete(t);return}return _e.delete(t),_e.set(t,e),e.value}function Bi(t,e){if(gr(),gr(),_e.delete(t),_e.set(t,{value:e,ts:Date.now()}),_e.size>Gr){const r=_e.keys().next().value;r!==void 0&&_e.delete(r)}}function gr(){if(!wt||wt<=0)return;const t=Date.now();for(const[e,r]of _e.entries())r.ts+wt<t&&_e.delete(e)}async function Oi(t,e){const r=new Set(Ne),i=document.querySelectorAll(".nimbi-site-navbar a, .navbar a, .nimbi-nav a");for(const n of Array.from(i||[])){const s=n.getAttribute("href")||"";if(s)try{const a=new URL(s,location.href);if(a.origin!==location.origin)continue;const h=(a.hash||a.pathname).match(/([^#?]+\.md)(?:$|[?#])/)||(a.pathname||"").match(/([^#?]+\.md)(?:$|[?#])/);if(h){let o=ce(h[1]);o&&r.add(o);continue}const l=a.pathname||"";if(l){const o=new URL(e),u=St(o.pathname);if(l.indexOf(u)!==-1){let c=l.startsWith(u)?l.slice(u.length):l;c=ce(c),c&&r.add(c)}}}catch(a){console.warn("[router] malformed URL while discovering index candidates",a)}}for(const n of r)try{if(!n||!String(n).includes(".md"))continue;const s=await be(n,e);if(!s||!s.raw)continue;const a=(s.raw||"").match(/^#\s+(.+)$/m);if(a){const h=(a[1]||"").trim();if(h&&re(h)===t)return n}}catch(s){console.warn("[router] fetchMarkdown during index discovery failed",s)}return null}function Ni(t){const e=[];if(String(t).includes(".md")||String(t).includes(".html"))/index\.html$/i.test(t)||e.push(t);else try{const r=decodeURIComponent(String(t||""));if(K.has(r)){const i=At(r)||K.get(r);i&&(/\.(md|html?)$/i.test(i)?/index\.html$/i.test(i)||e.push(i):(e.push(i),e.push(i+".html")))}else{if(Ne&&Ne.size)for(const i of Ne){const n=i.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(re(n)===r&&!/index\.html$/i.test(i)){e.push(i);break}}!e.length&&r&&!/\.(md|html?)$/i.test(r)&&(e.push(r+".html"),e.push(r+".md"))}}catch(r){console.warn("[router] buildPageCandidates failed during slug handling",r)}return e}async function Di(t,e){const r=t||"",i=location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null;let n=t||"",s=null;if(n&&String(n).includes("::")){const d=String(n).split("::",2);n=d[0],s=d[1]||null}const h=`${t}|||${typeof bi<"u"&&Qe?Qe:""}`,l=zi(h);if(l)n=l.resolved,s=l.anchor||s;else{if(!String(n).includes(".md")&&!String(n).includes(".html")){let d=decodeURIComponent(String(n||""));if(d&&typeof d=="string"&&(d=ce(d),d=vt(d)),K.has(d))n=At(d)||K.get(d);else{let m=await Oi(d,e);if(m)n=m;else if($n._refreshed&&Ne&&Ne.size||typeof e=="string"&&/^[a-z][a-z0-9+.-]*:\/\//i.test(e)){const w=await Qr(d,e);w&&(n=w)}}}Bi(h,{resolved:n,anchor:s})}!s&&i&&(s=i);const o=Ni(n),u=String(r||"").includes(".md")||String(r||"").includes(".html");if(u&&o.length===0&&(String(n).includes(".md")||String(n).includes(".html"))&&o.push(n),o.length===0&&(String(n).includes(".md")||String(n).includes(".html"))&&o.push(n),o.length===1&&/index\.html$/i.test(o[0])&&!u&&!K.has(n)&&!K.has(decodeURIComponent(String(n||"")))&&!String(n||"").includes("/"))throw new Error("Unknown slug: index.html fallback prevented");let c=null,f=null,p=null;for(const d of o)if(d)try{const m=ce(d);c=await be(m,e),f=m;break}catch(m){p=m;try{console.warn("[router] candidate fetch failed",{candidate:d,contentBase:e,err:m&&m.message||m})}catch{}}if(!c){try{console.error("[router] fetchPageData: no page data for",{originalRaw:r,resolved:n,pageCandidates:o,contentBase:e,fetchError:p&&(p.message||String(p))||null})}catch{}try{if(u&&String(r||"").toLowerCase().includes(".html"))try{const d=new URL(String(r||""),location.href).toString();console.warn("[router] attempting absolute HTML fetch fallback",d);const m=await fetch(d);if(m&&m.ok){const w=await m.text(),y=m&&m.headers&&typeof m.headers.get=="function"&&m.headers.get("content-type")||"",x=(w||"").toLowerCase(),z=y&&y.indexOf&&y.indexOf("text/html")!==-1||x.indexOf("<!doctype")!==-1||x.indexOf("<html")!==-1;if(z||console.warn("[router] absolute fetch returned non-HTML",{abs:d,contentType:y,snippet:x.slice(0,200)}),z)try{const R=d,_=new URL(".",R).toString();try{const O=typeof DOMParser<"u"?new DOMParser:null;if(O){const Q=O.parseFromString(w||"","text/html"),Y=(I,C)=>{try{const v=C.getAttribute(I)||"";if(!v||/^(https?:)?\/\//i.test(v)||v.startsWith("/")||v.startsWith("#"))return;try{const b=new URL(v,R).toString();C.setAttribute(I,b)}catch{}}catch{}},te=Q.querySelectorAll("[src],[href],[srcset],[xlink:href],[poster]"),P=[];for(const I of Array.from(te||[]))try{const C=I.tagName?I.tagName.toLowerCase():"";if(C==="a")continue;if(I.hasAttribute("src")){const v=I.getAttribute("src");Y("src",I);const b=I.getAttribute("src");v!==b&&P.push({attr:"src",tag:C,before:v,after:b})}if(I.hasAttribute("href")&&C==="link"){const v=I.getAttribute("href");Y("href",I);const b=I.getAttribute("href");v!==b&&P.push({attr:"href",tag:C,before:v,after:b})}if(I.hasAttribute("href")&&C!=="link"){const v=I.getAttribute("href");Y("href",I);const b=I.getAttribute("href");v!==b&&P.push({attr:"href",tag:C,before:v,after:b})}if(I.hasAttribute("xlink:href")){const v=I.getAttribute("xlink:href");Y("xlink:href",I);const b=I.getAttribute("xlink:href");v!==b&&P.push({attr:"xlink:href",tag:C,before:v,after:b})}if(I.hasAttribute("poster")){const v=I.getAttribute("poster");Y("poster",I);const b=I.getAttribute("poster");v!==b&&P.push({attr:"poster",tag:C,before:v,after:b})}if(I.hasAttribute("srcset")){const E=(I.getAttribute("srcset")||"").split(",").map($=>$.trim()).filter(Boolean).map($=>{const[k,G]=$.split(/\s+/,2);if(!k||/^(https?:)?\/\//i.test(k)||k.startsWith("/"))return $;try{const ue=new URL(k,R).toString();return G?`${ue} ${G}`:ue}catch{return $}}).join(", ");I.setAttribute("srcset",E)}}catch{}const T=Q.documentElement&&Q.documentElement.outerHTML?Q.documentElement.outerHTML:w;try{P&&P.length&&console.warn("[router] rewritten asset refs",{abs:d,rewritten:P})}catch{}return{data:{raw:T,isHtml:!0},pagePath:String(r||""),anchor:s}}}catch{}let q=w;return/<base\s+[^>]*>/i.test(w)||(/<head[^>]*>/i.test(w)?q=w.replace(/(<head[^>]*>)/i,`$1<base href="${_}">`):q=`<base href="${_}">`+w),{data:{raw:q,isHtml:!0},pagePath:String(r||""),anchor:s}}catch{return{data:{raw:w,isHtml:!0},pagePath:String(r||""),anchor:s}}}}catch(d){console.warn("[router] absolute HTML fetch fallback failed",d)}}catch{}throw new Error("no page data")}return{data:c,pagePath:f,anchor:s}}function Bn(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var et=Bn();function Xr(t){et=t}var Ve={exec:()=>null};function ee(t,e=""){let r=typeof t=="string"?t:t.source,i={replace:(n,s)=>{let a=typeof s=="string"?s:s.source;return a=a.replace(Se.caret,"$1"),r=r.replace(n,a),i},getRegex:()=>new RegExp(r,e)};return i}var Hi=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),Se={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:t=>new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}#`),htmlBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}>`)},Ui=/^(?:[ \t]*(?:\n|$))+/,qi=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,ji=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Tt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Wi=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,On=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,Kr=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Yr=ee(Kr).replace(/bull/g,On).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Fi=ee(Kr).replace(/bull/g,On).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Nn=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Zi=/^[^\n]+/,Dn=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Qi=ee(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Dn).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Gi=ee(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,On).getRegex(),Jt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Hn=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Xi=ee("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Hn).replace("tag",Jt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Vr=ee(Nn).replace("hr",Tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Jt).getRegex(),Ki=ee(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Vr).getRegex(),Un={blockquote:Ki,code:qi,def:Qi,fences:ji,heading:Wi,hr:Tt,html:Xi,lheading:Yr,list:Gi,newline:Ui,paragraph:Vr,table:Ve,text:Zi},mr=ee("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Jt).getRegex(),Yi={...Un,lheading:Fi,table:mr,paragraph:ee(Nn).replace("hr",Tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",mr).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Jt).getRegex()},Vi={...Un,html:ee(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Hn).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ve,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:ee(Nn).replace("hr",Tt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Yr).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Ji=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,ea=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Jr=/^( {2,}|\\)\n(?!\s*$)/,ta=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,en=/[\p{P}\p{S}]/u,qn=/[\s\p{P}\p{S}]/u,es=/[^\s\p{P}\p{S}]/u,na=ee(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,qn).getRegex(),ts=/(?!~)[\p{P}\p{S}]/u,ra=/(?!~)[\s\p{P}\p{S}]/u,sa=/(?:[^\s\p{P}\p{S}]|~)/u,ns=/(?![*_])[\p{P}\p{S}]/u,ia=/(?![*_])[\s\p{P}\p{S}]/u,aa=/(?:[^\s\p{P}\p{S}]|[*_])/u,la=ee(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Hi?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),rs=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,oa=ee(rs,"u").replace(/punct/g,en).getRegex(),ca=ee(rs,"u").replace(/punct/g,ts).getRegex(),ss="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",ua=ee(ss,"gu").replace(/notPunctSpace/g,es).replace(/punctSpace/g,qn).replace(/punct/g,en).getRegex(),ha=ee(ss,"gu").replace(/notPunctSpace/g,sa).replace(/punctSpace/g,ra).replace(/punct/g,ts).getRegex(),da=ee("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,es).replace(/punctSpace/g,qn).replace(/punct/g,en).getRegex(),pa=ee(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,ns).getRegex(),fa="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",ga=ee(fa,"gu").replace(/notPunctSpace/g,aa).replace(/punctSpace/g,ia).replace(/punct/g,ns).getRegex(),ma=ee(/\\(punct)/,"gu").replace(/punct/g,en).getRegex(),wa=ee(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),ba=ee(Hn).replace("(?:-->|$)","-->").getRegex(),ya=ee("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",ba).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Qt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,ka=ee(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",Qt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),is=ee(/^!?\[(label)\]\[(ref)\]/).replace("label",Qt).replace("ref",Dn).getRegex(),as=ee(/^!?\[(ref)\](?:\[\])?/).replace("ref",Dn).getRegex(),xa=ee("reflink|nolink(?!\\()","g").replace("reflink",is).replace("nolink",as).getRegex(),wr=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,jn={_backpedal:Ve,anyPunctuation:ma,autolink:wa,blockSkip:la,br:Jr,code:ea,del:Ve,delLDelim:Ve,delRDelim:Ve,emStrongLDelim:oa,emStrongRDelimAst:ua,emStrongRDelimUnd:da,escape:Ji,link:ka,nolink:as,punctuation:na,reflink:is,reflinkSearch:xa,tag:ya,text:ta,url:Ve},Sa={...jn,link:ee(/^!?\[(label)\]\((.*?)\)/).replace("label",Qt).getRegex(),reflink:ee(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Qt).getRegex()},xn={...jn,emStrongRDelimAst:ha,emStrongLDelim:ca,delLDelim:pa,delRDelim:ga,url:ee(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",wr).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:ee(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",wr).getRegex()},va={...xn,br:ee(Jr).replace("{2,}","*").getRegex(),text:ee(xn.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Ot={normal:Un,gfm:Yi,pedantic:Vi},ht={normal:jn,gfm:xn,breaks:va,pedantic:Sa},Ea={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},br=t=>Ea[t];function Oe(t,e){if(e){if(Se.escapeTest.test(t))return t.replace(Se.escapeReplace,br)}else if(Se.escapeTestNoEncode.test(t))return t.replace(Se.escapeReplaceNoEncode,br);return t}function yr(t){try{t=encodeURI(t).replace(Se.percentDecode,"%")}catch{return null}return t}function kr(t,e){let r=t.replace(Se.findPipe,(s,a,h)=>{let l=!1,o=a;for(;--o>=0&&h[o]==="\\";)l=!l;return l?"|":" |"}),i=r.split(Se.splitPipe),n=0;if(i[0].trim()||i.shift(),i.length>0&&!i.at(-1)?.trim()&&i.pop(),e)if(i.length>e)i.splice(e);else for(;i.length<e;)i.push("");for(;n<i.length;n++)i[n]=i[n].trim().replace(Se.slashPipe,"|");return i}function dt(t,e,r){let i=t.length;if(i===0)return"";let n=0;for(;n<i&&t.charAt(i-n-1)===e;)n++;return t.slice(0,i-n)}function Aa(t,e){if(t.indexOf(e[1])===-1)return-1;let r=0;for(let i=0;i<t.length;i++)if(t[i]==="\\")i++;else if(t[i]===e[0])r++;else if(t[i]===e[1]&&(r--,r<0))return i;return r>0?-2:-1}function Ra(t,e=0){let r=e,i="";for(let n of t)if(n==="	"){let s=4-r%4;i+=" ".repeat(s),r+=s}else i+=n,r++;return i}function xr(t,e,r,i,n){let s=e.href,a=e.title||null,h=t[1].replace(n.other.outputLinkReplace,"$1");i.state.inLink=!0;let l={type:t[0].charAt(0)==="!"?"image":"link",raw:r,href:s,title:a,text:h,tokens:i.inlineTokens(h)};return i.state.inLink=!1,l}function Ta(t,e,r){let i=t.match(r.other.indentCodeCompensation);if(i===null)return e;let n=i[1];return e.split(`
...
`)}}}fences(t){let e=this.rules.block.fences.exec(t);if(e){let r=e[0],i=Ta(r,e[3]||"",this.rules);return{type:"code",raw:r,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:i}}}heading(t){let e=this.rules.block.heading.exec(t);if(e){let r=e[2].trim();if(this.rules.other.endingHash.test(r)){let i=dt(r,"#");(this.options.pedantic||!i||this.rules.other.endingSpaceChar.test(i))&&(r=i.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:r,tokens:this.lexer.inline(r)}}}hr(t){let e=this.rules.block.hr.exec(t);if(e)return{type:"hr",raw:dt(e[0],`
...
${o}`:o,n=n?`${n}
${u}`:u;let c=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(u,s,!0),this.lexer.state.top=c,r.length===0)break;let f=s.at(-1);if(f?.type==="code")break;if(f?.type==="blockquote"){let p=f,d=p.raw+`
`+r.join(`
...
`;for(let w=l;w<=o;w++)if((e(f[w])||!c(f[w])&&(c(f[w+1])||e(f[w+1])))&&h++,e(f[w]))for(;w<=o&&(i(f[w+1])||c(f[w+1]));)w++;const p=h/u,d=Math.round(p*60*1e3);return{text:Math.ceil(p.toFixed(2))+" min read",minutes:p,time:d,words:h}}return fn=n,fn}var Ga=Qa();const Xa=$r(Ga);function Lr(t,e){let r=document.querySelector(`meta[name="${t}"]`);r||(r=document.createElement("meta"),r.setAttribute("name",t),document.head.appendChild(r)),r.setAttribute("content",e)}function rt(t,e,r){let i=`meta[${t}="${e}"]`,n=document.querySelector(i);n||(n=document.createElement("meta"),n.setAttribute(t,e),document.head.appendChild(n)),n.setAttribute("content",r)}function Ka(t,e){try{let r=document.querySelector(`link[rel="${t}"]`);r||(r=document.createElement("link"),r.setAttribute("rel",t),document.head.appendChild(r)),r.setAttribute("href",e)}catch(r){console.warn("[seoManager] upsertLinkRel failed",r)}}function Ya(t,e,r,i){const n=e&&String(e).trim()?e:t.title||document.title;rt("property","og:title",n);const s=i&&String(i).trim()?i:t.description||"";s&&String(s).trim()&&rt("property","og:description",s),rt("name","twitter:card",t.twitter_card||"summary_large_image");const a=r||t.image;a&&(rt("property","og:image",a),rt("name","twitter:image",a))}function Va(t,e,r,i,n=""){const s=t.meta||{},a=document&&document.querySelector&&document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",h=i&&String(i).trim()?i:s.description&&String(s.description).trim()?s.description:a&&String(a).trim()?a:"";h&&String(h).trim()&&Lr("description",h),Lr("robots",s.robots||"index,follow"),Ya(s,e,r,h)}function Ja(){try{const t=['meta[name="site"]','meta[name="site-name"]','meta[name="siteName"]','meta[property="og:site_name"]','meta[name="twitter:site"]'];for(const e of t){const r=document.querySelector(e);if(r){const i=r.getAttribute("content")||"";if(i&&i.trim())return i.trim()}}}catch(t){console.warn("[seoManager] getSiteNameFromMeta failed",t)}return""}function el(t,e,r,i,n,s=""){try{const a=t.meta||{},h=r&&String(r).trim()?r:a.title||s||document.title,l=n&&String(n).trim()?n:a.description||document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",o=i||a.image||null;let u="";try{if(e){const d=ce(e);try{u=(location.origin+location.pathname).split("?")[0]+"?page="+encodeURIComponent(d)}catch{u=location.href.split("#")[0]}}else u=location.href.split("#")[0]}catch(d){u=location.href.split("#")[0],console.warn("[seoManager] compute canonical failed",d)}u&&Ka("canonical",u);try{rt("property","og:url",u)}catch(d){console.warn("[seoManager] upsertMeta og:url failed",d)}const c={"@context":"https://schema.org","@type":"Article",headline:h||"",description:l||"",url:u||location.href.split("#")[0]};o&&(c.image=String(o)),a.date&&(c.datePublished=a.date),a.dateModified&&(c.dateModified=a.dateModified);const f="nimbi-jsonld";let p=document.getElementById(f);p||(p=document.createElement("script"),p.type="application/ld+json",p.id=f,document.head.appendChild(p)),p.textContent=JSON.stringify(c,null,2)}catch(a){console.warn("[seoManager] setStructuredData failed",a)}}function tl(t,e,r,i,n,s,a,h,l,o,u){try{const c=i.querySelector(".menu-label");c&&(c.textContent=h&&h.textContent||t("onThisPage"))}catch(c){console.warn("[seoManager] update toc label failed",c)}try{const c=r.meta&&r.meta.title?String(r.meta.title).trim():"",f=n.querySelector("img"),p=f&&(f.getAttribute("src")||f.src)||null;let d="";try{let w="";try{const y=h||(n&&n.querySelector?n.querySelector("h1"):null);if(y){let x=y.nextElementSibling;const z=[];for(;x&&!(x.tagName&&x.tagName.toLowerCase()==="h2");){const R=(x.textContent||"").trim();R&&z.push(R),x=x.nextElementSibling}z.length&&(w=z.join(" ").replace(/\s+/g," ").trim()),!w&&l&&(w=String(l).trim())}}catch(y){console.warn("[seoManager] compute descOverride failed",y)}w&&String(w).length>160&&(w=String(w).slice(0,157).trim()+"..."),d=w}catch(w){console.warn("[seoManager] compute descOverride failed",w)}try{Va(r,l,p,d)}catch(w){console.warn("[seoManager] setMetaTags failed",w)}try{el(r,o,l,p,d,e)}catch(w){console.warn("[seoManager] setStructuredData failed",w)}const m=Ja();l?m?document.title=`${m} - ${l}`:document.title=`${e||"Site"} - ${l}`:c?document.title=c:document.title=e||document.title}catch(c){console.warn("[seoManager] applyPageMeta failed",c)}try{const c=n.querySelector(".nimbi-reading-time");if(c&&c.remove(),l){const f=Xa(u.raw||""),p=f&&typeof f.minutes=="number"?Math.ceil(f.minutes):0,d=document.createElement("p");d.className="nimbi-reading-time",d.textContent=p?t("readingTime",{minutes:p}):"";const m=n.querySelector("h1");m&&m.insertAdjacentElement("afterend",d)}}catch(c){console.warn("[seoManager] reading time update failed",c)}}let ke=null,W=null,xe=1,Fe=(t,e)=>e,bt=0,yt=0,Ut=()=>{},ft=.25;function nl(){if(ke&&document.contains(ke))return ke;ke=null;const t=document.createElement("dialog");t.className="nimbi-image-preview",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label",Fe("imagePreviewTitle","Image preview")),t.innerHTML=`
  ...
  `,t.addEventListener("click",b=>{b.target===t&&gn()}),t.addEventListener("wheel",b=>{if(!te())return;b.preventDefault();const E=b.deltaY<0?ft:-ft;Ue(xe+E),o(),u()},{passive:!1}),t.addEventListener("keydown",b=>{if(b.key==="Escape"){gn();return}if(xe>1){const E=t.querySelector(".nimbi-image-preview__image-wrapper");if(!E)return;const $=40;switch(b.key){case"ArrowUp":E.scrollTop-=$,b.preventDefault();break;case"ArrowDown":E.scrollTop+=$,b.preventDefault();break;case"ArrowLeft":E.scrollLeft-=$,b.preventDefault();break;case"ArrowRight":E.scrollLeft+=$,b.preventDefault();break}}}),document.body.appendChild(t),ke=t,W=t.querySelector("[data-nimbi-preview-image]");const e=t.querySelector("[data-nimbi-preview-fit]"),r=t.querySelector("[data-nimbi-preview-original]"),i=t.querySelector("[data-nimbi-preview-zoom-in]"),n=t.querySelector("[data-nimbi-preview-zoom-out]"),s=t.querySelector("[data-nimbi-preview-reset]"),a=t.querySelector("[data-nimbi-preview-close]"),h=t.querySelector("[data-nimbi-preview-zoom-label]"),l=t.querySelector("[data-nimbi-preview-zoom-hud]");function o(){h&&(h.textContent=`${Math.round(xe*100)}%`)}const u=()=>{l&&(l.textContent=`${Math.round(xe*100)}%`,l.classList.add("visible"),clearTimeout(l._timeout),l._timeout=setTimeout(()=>l.classList.remove("visible"),800))};Ut=o,i.addEventListener("click",()=>{Ue(xe+ft),o(),u()}),n.addEventListener("click",()=>{Ue(xe-ft),o(),u()}),e.addEventListener("click",()=>{kt(),o(),u()}),r.addEventListener("click",()=>{Ue(1),o(),u()}),s.addEventListener("click",()=>{kt(),o(),u()}),a.addEventListener("click",gn),e.title=Fe("imagePreviewFit","Fit to screen"),r.title=Fe("imagePreviewOriginal","Original size"),n.title=Fe("imagePreviewZoomOut","Zoom out"),i.title=Fe("imagePreviewZoomIn","Zoom in"),a.title=Fe("imagePreviewClose","Close"),a.setAttribute("aria-label",Fe("imagePreviewClose","Close"));let c=!1,f=0,p=0,d=0,m=0;const w=new Map;let y=0,x=1;const z=(b,E)=>{const $=b.x-E.x,k=b.y-E.y;return Math.hypot($,k)},R=()=>{c=!1,w.clear(),y=0,W&&(W.style.cursor="all-scroll")};let _=0,q=0,O=0;const Q=b=>{const E=Date.now(),$=E-_,k=b.clientX-q,G=b.clientY-O;_=E,q=b.clientX,O=b.clientY,$<300&&Math.hypot(k,G)<30&&(Ue(xe>1?1:2),o(),b.preventDefault())},Y=b=>{Ue(xe>1?1:2),o(),b.preventDefault()},te=()=>ke?typeof ke.open=="boolean"?ke.open:ke.classList.contains("is-active"):!1,P=(b,E,$=1)=>{if(w.has($)&&w.set($,{x:b,y:E}),w.size===2){const oe=Array.from(w.values()),Le=z(oe[0],oe[1]);if(y>0){const ve=Le/y;Ue(x*ve)}return}if(!c)return;const k=W.closest(".nimbi-image-preview__image-wrapper");if(!k)return;const G=b-f,ue=E-p;k.scrollLeft=d-G,k.scrollTop=m-ue},T=(b,E,$=1)=>{if(!te())return;if(w.set($,{x:b,y:E}),w.size===2){const ue=Array.from(w.values());y=z(ue[0],ue[1]),x=xe;return}const k=W.closest(".nimbi-image-preview__image-wrapper");!k||!(k.scrollWidth>k.clientWidth||k.scrollHeight>k.clientHeight)||(c=!0,f=b,p=E,d=k.scrollLeft,m=k.scrollTop,W.style.cursor="all-scroll",window.addEventListener("pointermove",I),window.addEventListener("pointerup",C),window.addEventListener("pointercancel",C))},I=b=>{c&&(b.preventDefault(),P(b.clientX,b.clientY,b.pointerId))},C=()=>{R(),window.removeEventListener("pointermove",I),window.removeEventListener("pointerup",C),window.removeEventListener("pointercancel",C)};W.addEventListener("pointerdown",b=>{b.preventDefault(),T(b.clientX,b.clientY,b.pointerId)}),W.addEventListener("pointermove",b=>{(c||w.size===2)&&b.preventDefault(),P(b.clientX,b.clientY,b.pointerId)}),W.addEventListener("pointerup",b=>{b.preventDefault(),b.pointerType==="touch"&&Q(b),R()}),W.addEventListener("dblclick",Y),W.addEventListener("pointercancel",R),W.addEventListener("mousedown",b=>{b.preventDefault(),T(b.clientX,b.clientY,1)}),W.addEventListener("mousemove",b=>{c&&b.preventDefault(),P(b.clientX,b.clientY,1)}),W.addEventListener("mouseup",b=>{b.preventDefault(),R()});const v=t.querySelector(".nimbi-image-preview__image-wrapper");return v&&(v.addEventListener("pointerdown",b=>{T(b.clientX,b.clientY,b.pointerId)}),v.addEventListener("pointermove",b=>{P(b.clientX,b.clientY,b.pointerId)}),v.addEventListener("pointerup",R),v.addEventListener("pointercancel",R),v.addEventListener("mousedown",b=>{T(b.clientX,b.clientY,1)}),v.addEventListener("mousemove",b=>{P(b.clientX,b.clientY,1)}),v.addEventListener("mouseup",R)),t}function Ue(t){if(!W)return;const e=Number(t);xe=Number.isFinite(e)?Math.max(.1,Math.min(4,e)):1;const i=W.getBoundingClientRect(),n=bt||W.naturalWidth||W.width||i.width||0,s=yt||W.naturalHeight||W.height||i.height||0;n&&s?(W.style.maxWidth="none",W.style.maxHeight="none",W.style.width=`${n*xe}px`,W.style.height=`${s*xe}px`,W.style.transform=""):(W.style.maxWidth="",W.style.maxHeight="",W.style.width="",W.style.height="",W.style.transform=`scale(${xe})`),W&&(W.style.cursor="all-scroll")}function kt(){if(!W)return;const t=W.closest(".nimbi-image-preview__image-wrapper");if(!t)return;const e=t.getBoundingClientRect();if(e.width===0||e.height===0)return;const r=bt||W.naturalWidth||e.width,i=yt||W.naturalHeight||e.height;if(!r||!i)return;const n=e.width/r,s=e.height/i,a=Math.min(n,s,1);Ue(Number.isFinite(a)?a:1)}function rl(t,e="",r=0,i=0){const n=nl();xe=1,bt=r||0,yt=i||0,W.src=t,W.alt=e,W.style.transform="scale(1)";const s=()=>{bt=W.naturalWidth||W.width||0,yt=W.naturalHeight||W.height||0};if(s(),kt(),Ut(),requestAnimationFrame(()=>{kt(),Ut()}),!bt||!yt){const a=()=>{s(),requestAnimationFrame(()=>{kt(),Ut()}),W.removeEventListener("load",a)};W.addEventListener("load",a)}typeof n.showModal=="function"&&(n.open||n.showModal()),n.classList.add("is-active"),n.focus()}function gn(){ke&&(typeof ke.close=="function"&&ke.open&&ke.close(),ke.classList.remove("is-active"))}function sl(t,{t:e,zoomStep:r=.25}={}){if(!t||!t.querySelectorAll)return;Fe=(p,d)=>(typeof e=="function"?e(p):void 0)||d,ft=r,t.addEventListener("click",p=>{const d=p.target;if(!d||d.tagName!=="IMG")return;const m=d;if(m.src){if(p.defaultPrevented!==!0){const w=m.closest("a");w&&w.getAttribute("href")&&p.preventDefault()}rl(m.src,m.alt||"",m.naturalWidth||0,m.naturalHeight||0)}});let i=!1,n=0,s=0,a=0,h=0;const l=new Map;let o=0,u=1;const c=(p,d)=>{const m=p.x-d.x,w=p.y-d.y;return Math.hypot(m,w)};t.addEventListener("pointerdown",p=>{const d=p.target;if(!d||d.tagName!=="IMG"||!ke||!ke.open)return;if(l.set(p.pointerId,{x:p.clientX,y:p.clientY}),l.size===2){const w=Array.from(l.values());o=c(w[0],w[1]),u=xe;return}const m=d.closest(".nimbi-image-preview__image-wrapper");m&&(xe<=1||(p.preventDefault(),i=!0,n=p.clientX,s=p.clientY,a=m.scrollLeft,h=m.scrollTop,d.setPointerCapture(p.pointerId),d.style.cursor="grabbing"))}),t.addEventListener("pointermove",p=>{if(l.has(p.pointerId)&&l.set(p.pointerId,{x:p.clientX,y:p.clientY}),l.size===2){p.preventDefault();const x=Array.from(l.values()),z=c(x[0],x[1]);if(o>0){const R=z/o;Ue(u*R)}return}if(!i)return;p.preventDefault();const m=p.target.closest(".nimbi-image-preview__image-wrapper");if(!m)return;const w=p.clientX-n,y=p.clientY-s;m.scrollLeft=a-w,m.scrollTop=h-y});const f=()=>{i=!1,l.clear(),o=0};t.addEventListener("pointerup",f),t.addEventListener("pointercancel",f)}function il(t){const{contentWrap:e,navWrap:r,container:i,mountOverlay:n=null,t:s,contentBase:a,homePage:h,initialDocumentTitle:l,runHooks:o}=t||{};if(!e||!(e instanceof HTMLElement))throw new TypeError("contentWrap must be an HTMLElement");let u=null;const c=Ia(s,[{path:h,name:s("home"),isIndex:!0,children:[]}]);async function f(y,x){let z,R,_;try{({data:z,pagePath:R,anchor:_}=await Di(y,a))}catch(T){console.error("[nimbi-cms] fetchPageData failed",T),Tr(e,s,T);return}!_&&x&&(_=x);try{Tn(null)}catch(T){console.warn("[nimbi-cms] scrollToAnchorOrTop failed",T)}e.innerHTML="";const{article:q,parsed:O,toc:Q,topH1:Y,h1Text:te,slugKey:P}=await qa(s,z,R,_,a);tl(s,l,O,Q,q,R,_,Y,te,P,z),r.innerHTML="",r.appendChild(Q),Wa(Q);try{await o("transformHtml",{article:q,parsed:O,toc:Q,pagePath:R,anchor:_,topH1:Y,h1Text:te,slugKey:P,data:z})}catch(T){console.warn("[nimbi-cms] transformHtml hooks failed",T)}e.appendChild(q);try{sl(q,{t:s})}catch(T){console.warn("[nimbi-cms] attachImagePreview failed",T)}try{Bt(i,100,!1),requestAnimationFrame(()=>Bt(i,100,!1)),setTimeout(()=>Bt(i,100,!1),250)}catch(T){console.warn("[nimbi-cms] setEagerForAboveFoldImages failed",T)}Tn(_),Fa(q,Y,{mountOverlay:n,container:i,navWrap:r,t:s});try{await o("onPageLoad",{data:z,pagePath:R,anchor:_,article:q,toc:Q,topH1:Y,h1Text:te,slugKey:P,contentWrap:e,navWrap:r})}catch(T){console.warn("[nimbi-cms] onPageLoad hooks failed",T)}u=R}async function p(){let y=new URLSearchParams(location.search).get("page")||h;const x=location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null;try{await f(y,x)}catch(z){console.warn("[nimbi-cms] renderByQuery failed for",y,z),Tr(e,s,z)}}window.addEventListener("popstate",p);const d=()=>`nimbi-cms-scroll:${location.pathname}${location.search}`,m=()=>{try{const y=i||document.querySelector(".nimbi-cms");if(!y)return;const x={top:y.scrollTop||0,left:y.scrollLeft||0};sessionStorage.setItem(d(),JSON.stringify(x))}catch{}},w=()=>{try{const y=i||document.querySelector(".nimbi-cms");if(!y)return;const x=sessionStorage.getItem(d());if(!x)return;const z=JSON.parse(x);z&&typeof z.top=="number"&&y.scrollTo({top:z.top,left:z.left||0,behavior:"auto"})}catch{}};return window.addEventListener("pageshow",y=>{if(y.persisted)try{w(),Bt(i,100,!1)}catch(x){console.warn("[nimbi-cms] bfcache restore failed",x)}}),window.addEventListener("pagehide",()=>{try{m()}catch(y){console.warn("[nimbi-cms] save scroll position failed",y)}}),{renderByQuery:p,siteNav:c,getCurrentPagePath:()=>u}}function al(t){try{const e=typeof t=="string"?t:typeof window<"u"&&window.location?window.location.search:"";if(!e)return{};const r=new URLSearchParams(e.startsWith("?")?e.slice(1):e),i={},n=s=>{if(s==null)return;const a=String(s).toLowerCase();if(a==="1"||a==="true"||a==="yes")return!0;if(a==="0"||a==="false"||a==="no")return!1};if(r.has("contentPath")&&(i.contentPath=r.get("contentPath")),r.has("searchIndex")){const s=n(r.get("searchIndex"));typeof s=="boolean"&&(i.searchIndex=s)}if(r.has("searchIndexMode")){const s=r.get("searchIndexMode");(s==="eager"||s==="lazy")&&(i.searchIndexMode=s)}if(r.has("defaultStyle")){const s=r.get("defaultStyle");(s==="light"||s==="dark")&&(i.defaultStyle=s)}if(r.has("bulmaCustomize")&&(i.bulmaCustomize=r.get("bulmaCustomize")),r.has("lang")&&(i.lang=r.get("lang")),r.has("l10nFile")){const s=r.get("l10nFile");i.l10nFile=s==="null"?null:s}if(r.has("cacheTtlMinutes")){const s=Number(r.get("cacheTtlMinutes"));Number.isFinite(s)&&s>=0&&(i.cacheTtlMinutes=s)}if(r.has("cacheMaxEntries")){const s=Number(r.get("cacheMaxEntries"));Number.isInteger(s)&&s>=0&&(i.cacheMaxEntries=s)}if(r.has("homePage")&&(i.homePage=r.get("homePage")),r.has("notFoundPage")&&(i.notFoundPage=r.get("notFoundPage")),r.has("availableLanguages")&&(i.availableLanguages=r.get("availableLanguages").split(",").map(s=>s.trim()).filter(Boolean)),r.has("indexDepth")){const s=Number(r.get("indexDepth"));Number.isInteger(s)&&(s===1||s===2||s===3)&&(i.indexDepth=s)}if(r.has("noIndexing")){const a=(r.get("noIndexing")||"").split(",").map(h=>h.trim()).filter(Boolean);a.length&&(i.noIndexing=a)}return i}catch{return{}}}function ll(t){return!(typeof t!="string"||!t.trim()||t.includes("..")||/^[a-zA-Z][a-zA-Z0-9+.-]*:\/\//.test(t)||t.startsWith("//")||t.startsWith("/")||/^[A-Za-z]:\\/.test(t))}function _r(t){if(typeof t!="string")return!1;const e=t.trim();return!(!e||e.includes("/")||e.includes("\\")||e.includes("..")||!/^[A-Za-z0-9._-]+\.(md|html)$/.test(e))}let mn="";async function ol(t={}){if(!t||typeof t!="object")throw new TypeError("initCMS(options): options must be an object");const e=al();if(e&&(e.contentPath||e.homePage||e.notFoundPage))if(t&&t.allowUrlPathOverrides===!0)try{console.warn("[nimbi-cms] allowUrlPathOverrides enabled by host; honoring URL overrides for contentPath/homePage/notFoundPage")}catch(k){console.warn("[nimbi-cms] allowUrlPathOverrides logging failed",k)}else{try{console.warn("[nimbi-cms] ignoring unsafe URL overrides for contentPath/homePage/notFoundPage")}catch(k){console.warn("[nimbi-cms] logging ignore of URL overrides failed",k)}delete e.contentPath,delete e.homePage,delete e.notFoundPage}const r=Object.assign({},e,t),{el:i,contentPath:n="/content",crawlMaxQueue:s=1e3,searchIndex:a=!0,searchIndexMode:h="eager",indexDepth:l=1,noIndexing:o=void 0,defaultStyle:u="light",bulmaCustomize:c="none",lang:f=void 0,l10nFile:p=null,cacheTtlMinutes:d=5,cacheMaxEntries:m,markdownExtensions:w,availableLanguages:y,homePage:x="_home.md",notFoundPage:z="_404.md"}=r,{skipRootReadme:R=!1}=r;if(r.contentPath!=null&&!ll(r.contentPath))throw new TypeError('initCMS(options): "contentPath" contains unsafe characters or patterns');if(r.homePage!=null&&!_r(r.homePage))throw new TypeError('initCMS(options): "homePage" must be a simple basename ending with .md or .html');if(r.notFoundPage!=null&&!_r(r.notFoundPage))throw new TypeError('initCMS(options): "notFoundPage" must be a simple basename ending with .md or .html');if(!i)throw new Error("el is required");let _=i;if(typeof i=="string"){if(_=document.querySelector(i),!_)throw new Error(`el selector "${i}" did not match any element`)}else if(!(i instanceof Element))throw new TypeError("el must be a CSS selector string or a DOM element");if(typeof n!="string"||!n.trim())throw new TypeError('initCMS(options): "contentPath" must be a non-empty string when provided');if(typeof a!="boolean")throw new TypeError('initCMS(options): "searchIndex" must be a boolean when provided');if(h!=null&&h!=="eager"&&h!=="lazy")throw new TypeError('initCMS(options): "searchIndexMode" must be "eager" or "lazy" when provided');if(l!=null&&l!==1&&l!==2&&l!==3)throw new TypeError('initCMS(options): "indexDepth" must be 1, 2, or 3 when provided');if(u!=="light"&&u!=="dark")throw new TypeError('initCMS(options): "defaultStyle" must be "light" or "dark"');if(c!=null&&typeof c!="string")throw new TypeError('initCMS(options): "bulmaCustomize" must be a string when provided');if(f!=null&&typeof f!="string")throw new TypeError('initCMS(options): "lang" must be a string when provided');if(p!=null&&typeof p!="string")throw new TypeError('initCMS(options): "l10nFile" must be a string or null when provided');if(d!=null&&(typeof d!="number"||!Number.isFinite(d)||d<0))throw new TypeError('initCMS(options): "cacheTtlMinutes" must be a non‑negative number when provided');if(m!=null&&(typeof m!="number"||!Number.isInteger(m)||m<0))throw new TypeError('initCMS(options): "cacheMaxEntries" must be a non‑negative integer when provided');if(w!=null&&(!Array.isArray(w)||w.some(k=>!k||typeof k!="object")))throw new TypeError('initCMS(options): "markdownExtensions" must be an array of extension objects when provided');if(y!=null&&(!Array.isArray(y)||y.some(k=>typeof k!="string"||!k.trim())))throw new TypeError('initCMS(options): "availableLanguages" must be an array of non-empty strings when provided');if(o!=null&&(!Array.isArray(o)||o.some(k=>typeof k!="string"||!k.trim())))throw new TypeError('initCMS(options): "noIndexing" must be an array of non-empty strings when provided');if(R!=null&&typeof R!="boolean")throw new TypeError('initCMS(options): "skipRootReadme" must be a boolean when provided');if(x!=null&&(typeof x!="string"||!x.trim()||!/\.(md|html)$/.test(x)))throw new TypeError('initCMS(options): "homePage" must be a non-empty string ending with .md or .html');if(z!=null&&(typeof z!="string"||!z.trim()||!/\.(md|html)$/.test(z)))throw new TypeError('initCMS(options): "notFoundPage" must be a non-empty string ending with .md or .html');const q=!!a;try{Dr(!!R)}catch(k){console.warn("[nimbi-cms] setSkipRootReadme failed",k)}try{_.classList.add("nimbi-mount"),_.style.position=_.style.position||"relative",_.style.overflow=_.style.overflow||"hidden"}catch(k){console.warn("[nimbi-cms] mount element setup failed",k)}const O=document.createElement("div");O.className="nimbi-cms";try{O.style.position=O.style.position||"relative",O.style.overflow=O.style.overflow||"auto";try{O.style.webkitOverflowScrolling||(O.style.webkitOverflowScrolling="touch")}catch(k){console.warn("[nimbi-cms] set container webkitOverflowScrolling failed",k)}O.style.width=O.style.width||"100%",O.style.height=O.style.height||"100%",O.style.boxSizing=O.style.boxSizing||"border-box"}catch(k){console.warn("[nimbi-cms] container style setup failed",k)}const Q=document.createElement("div");Q.className="columns";const Y=document.createElement("div");Y.className="column is-full-mobile is-3-tablet nimbi-nav-wrap",Y.setAttribute("role","navigation");try{const k=typeof st=="function"?st("navigation"):null;k&&Y.setAttribute("aria-label",k)}catch(k){console.warn("[nimbi-cms] set nav aria-label failed",k)}Q.appendChild(Y);const te=document.createElement("div");te.className="column nimbi-content",te.setAttribute("role","main"),Q.appendChild(te),O.appendChild(Q);const P=Y,T=te;_.appendChild(O);let I=null;try{I=_.querySelector(".nimbi-overlay"),I||(I=document.createElement("div"),I.className="nimbi-overlay",_.appendChild(I))}catch(k){I=null,console.warn("[nimbi-cms] mount overlay setup failed",k)}const C=location.pathname||"/",v=C.endsWith("/")?C:C.substring(0,C.lastIndexOf("/")+1);try{mn=document.title||""}catch(k){mn="",console.warn("[nimbi-cms] read initial document title failed",k)}let b=n;(b==="."||b==="./")&&(b=""),b.startsWith("./")&&(b=b.slice(2)),b.startsWith("/")&&(b=b.slice(1)),b!==""&&!b.endsWith("/")&&(b=b+"/");const E=new URL(v+b,location.origin).toString();try{kn&&kn(x)}catch{}p&&await _n(p,v),y&&Array.isArray(y)&&Hr(y),f&&Mn(f);const $=il({contentWrap:T,navWrap:P,container:O,mountOverlay:I,t:st,contentBase:E,homePage:x,initialDocumentTitle:mn,runHooks:wn});if(typeof d=="number"&&d>=0&&typeof fr=="function"&&fr(d*60*1e3),typeof m=="number"&&m>=0&&typeof pr=="function"&&pr(m),w&&Array.isArray(w)&&w.length)try{w.forEach(k=>{typeof k=="object"&&Pa&&typeof An=="function"&&An(k)})}catch(k){console.warn("[nimbi-cms] applying markdownExtensions failed",k)}try{typeof s=="number"&&Promise.resolve().then(()=>Ht).then(({setDefaultCrawlMaxQueue:k})=>{try{k(s)}catch(G){console.warn("[nimbi-cms] setDefaultCrawlMaxQueue failed",G)}})}catch(k){console.warn("[nimbi-cms] setDefaultCrawlMaxQueue import failed",k)}try{Ft(E)}catch(k){console.warn("[nimbi-cms] setContentBase failed",k)}try{yn(z)}catch(k){console.warn("[nimbi-cms] setNotFoundPage failed",k)}try{Ft(E)}catch(k){console.warn("[nimbi-cms] setContentBase failed",k)}try{yn(z)}catch(k){console.warn("[nimbi-cms] setNotFoundPage failed",k)}try{await be(x,E)}catch(k){throw x==="_home.md"?new Error("Required _home.md not found"):new Error(`Required ${x} not found at ${E}${x}: ${k.message}`)}zr(u),await Ir(c,v);try{const k=document.createElement("header");k.className="nimbi-site-navbar",_.insertBefore(k,O);const G=await be("_navigation.md",E),ue=await Kt(G.raw||""),{navbar:oe,linkEls:Le}=await Za(k,O,ue.html||"",E,x,st,$.renderByQuery,q,h,l,o);try{await wn("onNavBuild",{navWrap:P,navbar:oe,linkEls:Le,contentBase:E})}catch(ve){console.warn("[nimbi-cms] onNavBuild hooks failed",ve)}try{const ve=()=>{const Ee=k&&k.getBoundingClientRect&&Math.round(k.getBoundingClientRect().height)||k&&k.offsetHeight||0;if(Ee>0){try{_.style.setProperty("--nimbi-site-navbar-height",`${Ee}px`)}catch(fe){console.warn("[nimbi-cms] set CSS var failed",fe)}try{O.style.paddingTop=""}catch(fe){console.warn("[nimbi-cms] set container paddingTop failed",fe)}try{const fe=_&&_.getBoundingClientRect&&Math.round(_.getBoundingClientRect().height)||_&&_.clientHeight||0;if(fe>0){const Ie=Math.max(0,fe-Ee);try{O.style.boxSizing="border-box"}catch(Xe){console.warn("[nimbi-cms] set container boxSizing failed",Xe)}try{O.style.height=`${Ie}px`}catch(Xe){console.warn("[nimbi-cms] set container height failed",Xe)}try{O.style.setProperty("--nimbi-cms-height",`${Ie}px`)}catch(Xe){console.warn("[nimbi-cms] set --nimbi-cms-height failed",Xe)}}else{try{O.style.height="calc(100% - var(--nimbi-site-navbar-height))"}catch(Ie){console.warn("[nimbi-cms] set container height failed",Ie)}try{O.style.setProperty("--nimbi-cms-height","calc(100% - var(--nimbi-site-navbar-height))")}catch(Ie){console.warn("[nimbi-cms] set --nimbi-cms-height failed",Ie)}}}catch(fe){console.warn("[nimbi-cms] compute container height failed",fe)}try{k.style.setProperty("--nimbi-site-navbar-height",`${Ee}px`)}catch(fe){console.warn("[nimbi-cms] set navbar CSS var failed",fe)}}};ve();try{if(typeof ResizeObserver<"u"){const Ee=new ResizeObserver(()=>ve());try{Ee.observe(k)}catch(fe){console.warn("[nimbi-cms] ResizeObserver.observe failed",fe)}}}catch(Ee){console.warn("[nimbi-cms] ResizeObserver setup failed",Ee)}}catch(ve){console.warn("[nimbi-cms] compute navbar height failed",ve)}}catch(k){console.warn("[nimbi-cms] build navigation failed",k)}await $.renderByQuery();try{Promise.resolve().then(()=>cl).then(({getVersion:k})=>{typeof k=="function"&&k().then(G=>{try{const ue=G||"0.0.0",oe=document.createElement("div");oe.className="nimbi-version-label",oe.textContent=`Ninbi CMS v. ${ue}`,oe.style.position="absolute",oe.style.left="8px",oe.style.bottom="6px",oe.style.fontSize="11px",oe.style.opacity="0.6",oe.style.pointerEvents="none",oe.style.zIndex="9999",oe.style.userSelect="none";try{_.appendChild(oe)}catch(Le){console.warn("[nimbi-cms] append version label failed",Le)}}catch(ue){console.warn("[nimbi-cms] building version label failed",ue)}}).catch(G=>{console.warn("[nimbi-cms] getVersion() failed",G)})}).catch(k=>{console.warn("[nimbi-cms] import version module failed",k)})}catch(k){console.warn("[nimbi-cms] version label setup failed",k)}}async function hs(){try{let t=null;try{t=await Promise.resolve().then(()=>Mr)}catch{try{t=await Promise.resolve().then(()=>Mr)}catch{t=null}}const e=t?.default?.version||t?.version;return typeof e=="string"&&e.trim()?e:"0.0.0"}catch{return"0.0.0"}}const cl=Object.freeze(Object.defineProperty({__proto__:null,getVersion:hs},Symbol.toStringTag,{value:"Module"})),ds="nimbi-cms",ps="0.1.0",fs="module",gs={dev:"vite","dev:example":'sh -c "npm run build -- --outDir example/dist --config vite.config.js && vite example --port 5173 &"',build:"vite build --config vite.config.js","build:lib":"vite build --config vite.config.js","build:analyze":"ANALYZE=1 vite build --config vite.config.js",preview:"vite preview",test:"npx vitest run","gen-dts":"node scripts/gen-dts.js","check-dts":"npx tsc --noEmit src/index.d.ts --lib es2015,dom --skipLibCheck","type-test":"npx tsd",docs:"typedoc --options typedoc.json"},ms={bulma:"^1.0.4","highlight.js":"^11.11.1",marked:"^17.0.4"},ws={"@vitest/coverage-v8":"^4.0.18","comment-parser":"^0.7.6",eslint:"^10.0.3","eslint-plugin-unused-imports":"^4.4.1",glob:"^10.4.1",jsdom:"^28.1.0","reading-time":"^1.5.0",terser:"^5.17.0",typedoc:"^0.28.17","typedoc-plugin-markdown":"^4.10.0",typescript:"^5.9.3",tsd:"^0.33.0",vite:"^7.3.1","rollup-plugin-visualizer":"^5.8.0","vite-plugin-restart":"^2.0.0",vitest:"^4.0.18"},bs="dist/nimbi-cms.cjs.js",ys="dist/nimbi-cms.es.js",ks="src/index.d.ts",xs="dist/nimbi-cms.js",Ss=["dist","src/index.d.ts"],ul={name:ds,version:ps,private:!0,type:fs,scripts:gs,dependencies:ms,devDependencies:ws,main:bs,module:ys,types:ks,unpkg:xs,files:Ss},Mr=Object.freeze(Object.defineProperty({__proto__:null,default:ul,dependencies:ms,devDependencies:ws,files:Ss,main:bs,module:ys,name:ds,scripts:gs,type:fs,types:ks,unpkg:xs,version:ps},Symbol.toStringTag,{value:"Module"}));exports.BAD_LANGUAGES=Cn;exports.SUPPORTED_HLJS_MAP=J;exports._clearHooks=ui;exports.addHook=Yt;exports.default=ol;exports.ensureBulma=Ir;exports.getVersion=hs;exports.loadL10nFile=_n;exports.loadSupportedLanguages=Ln;exports.observeCodeBlocks=Pr;exports.onNavBuild=oi;exports.onPageLoad=li;exports.registerLanguage=lt;exports.runHooks=wn;exports.setHighlightTheme=gi;exports.setLang=Mn;exports.setStyle=zr;exports.setThemeVars=wi;exports.t=st;exports.transformHtml=ci;
