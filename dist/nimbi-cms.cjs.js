"use strict";var Ps=Object.create;var Bi=Object.defineProperty;var Is=Object.getOwnPropertyDescriptor;var Ns=Object.getOwnPropertyNames;var Os=Object.getPrototypeOf,Bs=Object.prototype.hasOwnProperty;var js=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of Ns(t))!Bs.call(e,r)&&r!==n&&Bi(e,r,{get:()=>t[r],enumerable:!(i=Is(t,r))||i.enumerable});return e};var qs=(e,t,n)=>(n=e!=null?Ps(Os(e)):{},js(t||!e||!e.__esModule?Bi(n,"default",{value:e,enumerable:!0}):n,e));Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});let Or=0;const ji=Object.create(null);function qi(e){try{const t=Number(e);Or=Number.isFinite(t)&&t>=0?Math.max(0,Math.min(3,Math.floor(t))):0}catch{Or=0}}function en(e=1){try{return Number(Or)>=Number(e||1)}catch{return!1}}function ni(){return en(1)}function ir(...e){try{if(!en(1)||!console||typeof console.error!="function")return;const t=e.map(n=>typeof n=="function"?n():n);console.error(...t)}catch{}}function k(...e){try{if(!en(2)||!console||typeof console.warn!="function")return;const t=e.map(n=>typeof n=="function"?n():n);console.warn(...t)}catch{}}function $t(...e){try{if(!en(3)||!console||typeof console.info!="function")return;const t=e.map(n=>typeof n=="function"?n():n);console.info(...t)}catch{}}function jt(...e){try{if(!en(3)||!console||typeof console.log!="function")return;const t=e.map(n=>typeof n=="function"?n():n);console.log(...t)}catch{}}function fa(e){try{if(!ni())return;const t=String(e||"");if(!t)return;ji[t]=(ji[t]||0)+1}catch{}}function ga(e){try{if(typeof globalThis>"u"||!globalThis.__nimbiCMSDebug)return;const t=String(e||"");if(!t)return;try{globalThis.__nimbiCMSDebug[t]=(globalThis.__nimbiCMSDebug[t]||0)+1}catch{}}catch{}}const zn={onPageLoad:[],onNavBuild:[],transformHtml:[]};function gr(e,t){if(!Object.prototype.hasOwnProperty.call(zn,e))throw new Error('Unknown hook "'+e+'"');if(typeof t!="function")throw new TypeError("hook callback must be a function");zn[e].push(t)}function Hs(e){gr("onPageLoad",e)}function Fs(e){gr("onNavBuild",e)}function Ds(e){gr("transformHtml",e)}async function Br(e,t){const n=zn[e]||[];for(const i of n)try{await i(t)}catch(r){try{k("[nimbi-cms] runHooks callback failed",r)}catch{}}}function Us(){Object.keys(zn).forEach(e=>{zn[e].length=0})}function pa(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Lr,Hi;function Ws(){if(Hi)return Lr;Hi=1;function e(x){return x instanceof Map?x.clear=x.delete=x.set=function(){throw new Error("map is read-only")}:x instanceof Set&&(x.add=x.clear=x.delete=function(){throw new Error("set is read-only")}),Object.freeze(x),Object.getOwnPropertyNames(x).forEach(q=>{const ee=x[q],_e=typeof ee;(_e==="object"||_e==="function")&&!Object.isFrozen(ee)&&e(ee)}),x}class t{constructor(q){q.data===void 0&&(q.data={}),this.data=q.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function n(x){return x.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function i(x,...q){const ee=Object.create(null);for(const _e in x)ee[_e]=x[_e];return q.forEach(function(_e){for(const Ue in _e)ee[Ue]=_e[Ue]}),ee}const r="</span>",a=x=>!!x.scope,s=(x,{prefix:q})=>{if(x.startsWith("language:"))return x.replace("language:","language-");if(x.includes(".")){const ee=x.split(".");return[`${q}${ee.shift()}`,...ee.map((_e,Ue)=>`${_e}${"_".repeat(Ue+1)}`)].join(" ")}return`${q}${x}`};class o{constructor(q,ee){this.buffer="",this.classPrefix=ee.classPrefix,q.walk(this)}addText(q){this.buffer+=n(q)}openNode(q){if(!a(q))return;const ee=s(q.scope,{prefix:this.classPrefix});this.span(ee)}closeNode(q){a(q)&&(this.buffer+=r)}value(){return this.buffer}span(q){this.buffer+=`<span class="${q}">`}}const l=(x={})=>{const q={children:[]};return Object.assign(q,x),q};class c{constructor(){this.rootNode=l(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(q){this.top.children.push(q)}openNode(q){const ee=l({scope:q});this.add(ee),this.stack.push(ee)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(q){return this.constructor._walk(q,this.rootNode)}static _walk(q,ee){return typeof ee=="string"?q.addText(ee):ee.children&&(q.openNode(ee),ee.children.forEach(_e=>this._walk(q,_e)),q.closeNode(ee)),q}static _collapse(q){typeof q!="string"&&q.children&&(q.children.every(ee=>typeof ee=="string")?q.children=[q.children.join("")]:q.children.forEach(ee=>{c._collapse(ee)}))}}class u extends c{constructor(q){super(),this.options=q}addText(q){q!==""&&this.add(q)}startScope(q){this.openNode(q)}endScope(){this.closeNode()}__addSublanguage(q,ee){const _e=q.root;ee&&(_e.scope=`language:${ee}`),this.add(_e)}toHTML(){return new o(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function g(x){return x?typeof x=="string"?x:x.source:null}function h(x){return m("(?=",x,")")}function d(x){return m("(?:",x,")*")}function p(x){return m("(?:",x,")?")}function m(...x){return x.map(ee=>g(ee)).join("")}function f(x){const q=x[x.length-1];return typeof q=="object"&&q.constructor===Object?(x.splice(x.length-1,1),q):{}}function w(...x){return"("+(f(x).capture?"":"?:")+x.map(_e=>g(_e)).join("|")+")"}function y(x){return new RegExp(x.toString()+"|").exec("").length-1}function _(x,q){const ee=x&&x.exec(q);return ee&&ee.index===0}const b=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function A(x,{joinWith:q}){let ee=0;return x.map(_e=>{ee+=1;const Ue=ee;let We=g(_e),oe="";for(;We.length>0;){const ae=b.exec(We);if(!ae){oe+=We;break}oe+=We.substring(0,ae.index),We=We.substring(ae.index+ae[0].length),ae[0][0]==="\\"&&ae[1]?oe+="\\"+String(Number(ae[1])+Ue):(oe+=ae[0],ae[0]==="("&&ee++)}return oe}).map(_e=>`(${_e})`).join(q)}const S=/\b\B/,E="[a-zA-Z]\\w*",I="[a-zA-Z_]\\w*",N="\\b\\d+(\\.\\d+)?",U="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",z="\\b(0b[01]+)",O="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",W=(x={})=>{const q=/^#![ ]*\//;return x.binary&&(x.begin=m(q,/.*\b/,x.binary,/\b.*/)),i({scope:"meta",begin:q,end:/$/,relevance:0,"on:begin":(ee,_e)=>{ee.index!==0&&_e.ignoreMatch()}},x)},te={begin:"\\\\[\\s\\S]",relevance:0},H={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[te]},L={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[te]},F={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},G=function(x,q,ee={}){const _e=i({scope:"comment",begin:x,end:q,contains:[]},ee);_e.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const Ue=w("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return _e.contains.push({begin:m(/[ ]+/,"(",Ue,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),_e},ie=G("//","$"),pe=G("/\\*","\\*/"),J=G("#","$"),ze={scope:"number",begin:N,relevance:0},xe={scope:"number",begin:U,relevance:0},Se={scope:"number",begin:z,relevance:0},Ee={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[te,{begin:/\[/,end:/\]/,relevance:0,contains:[te]}]},Fe={scope:"title",begin:E,relevance:0},R={scope:"title",begin:I,relevance:0},P={begin:"\\.\\s*"+I,relevance:0};var v=Object.freeze({__proto__:null,APOS_STRING_MODE:H,BACKSLASH_ESCAPE:te,BINARY_NUMBER_MODE:Se,BINARY_NUMBER_RE:z,COMMENT:G,C_BLOCK_COMMENT_MODE:pe,C_LINE_COMMENT_MODE:ie,C_NUMBER_MODE:xe,C_NUMBER_RE:U,END_SAME_AS_BEGIN:function(x){return Object.assign(x,{"on:begin":(q,ee)=>{ee.data._beginMatch=q[1]},"on:end":(q,ee)=>{ee.data._beginMatch!==q[1]&&ee.ignoreMatch()}})},HASH_COMMENT_MODE:J,IDENT_RE:E,MATCH_NOTHING_RE:S,METHOD_GUARD:P,NUMBER_MODE:ze,NUMBER_RE:N,PHRASAL_WORDS_MODE:F,QUOTE_STRING_MODE:L,REGEXP_MODE:Ee,RE_STARTERS_RE:O,SHEBANG:W,TITLE_MODE:Fe,UNDERSCORE_IDENT_RE:I,UNDERSCORE_TITLE_MODE:R});function M(x,q){x.input[x.index-1]==="."&&q.ignoreMatch()}function D(x,q){x.className!==void 0&&(x.scope=x.className,delete x.className)}function K(x,q){q&&x.beginKeywords&&(x.begin="\\b("+x.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",x.__beforeBegin=M,x.keywords=x.keywords||x.beginKeywords,delete x.beginKeywords,x.relevance===void 0&&(x.relevance=0))}function j(x,q){Array.isArray(x.illegal)&&(x.illegal=w(...x.illegal))}function $(x,q){if(x.match){if(x.begin||x.end)throw new Error("begin & end are not supported with match");x.begin=x.match,delete x.match}}function T(x,q){x.relevance===void 0&&(x.relevance=1)}const B=(x,q)=>{if(!x.beforeMatch)return;if(x.starts)throw new Error("beforeMatch cannot be used with starts");const ee=Object.assign({},x);Object.keys(x).forEach(_e=>{delete x[_e]}),x.keywords=ee.keywords,x.begin=m(ee.beforeMatch,h(ee.begin)),x.starts={relevance:0,contains:[Object.assign(ee,{endsParent:!0})]},x.relevance=0,delete ee.beforeMatch},Q=["of","and","for","in","not","or","if","then","parent","list","value"],se="keyword";function me(x,q,ee=se){const _e=Object.create(null);return typeof x=="string"?Ue(ee,x.split(" ")):Array.isArray(x)?Ue(ee,x):Object.keys(x).forEach(function(We){Object.assign(_e,me(x[We],q,We))}),_e;function Ue(We,oe){q&&(oe=oe.map(ae=>ae.toLowerCase())),oe.forEach(function(ae){const ye=ae.split("|");_e[ye[0]]=[We,be(ye[0],ye[1])]})}}function be(x,q){return q?Number(q):ge(x)?0:1}function ge(x){return Q.includes(x.toLowerCase())}const we={},ve=x=>{console.error(x)},Ie=(x,...q)=>{console.log(`WARN: ${x}`,...q)},Ge=(x,q)=>{we[`${x}/${q}`]||(console.log(`Deprecated as of ${x}. ${q}`),we[`${x}/${q}`]=!0)},Et=new Error;function fn(x,q,{key:ee}){let _e=0;const Ue=x[ee],We={},oe={};for(let ae=1;ae<=q.length;ae++)oe[ae+_e]=Ue[ae],We[ae+_e]=!0,_e+=y(q[ae-1]);x[ee]=oe,x[ee]._emit=We,x[ee]._multi=!0}function Ct(x){if(Array.isArray(x.begin)){if(x.skip||x.excludeBegin||x.returnBegin)throw ve("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Et;if(typeof x.beginScope!="object"||x.beginScope===null)throw ve("beginScope must be object"),Et;fn(x,x.begin,{key:"beginScope"}),x.begin=A(x.begin,{joinWith:""})}}function ls(x){if(Array.isArray(x.end)){if(x.skip||x.excludeEnd||x.returnEnd)throw ve("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Et;if(typeof x.endScope!="object"||x.endScope===null)throw ve("endScope must be object"),Et;fn(x,x.end,{key:"endScope"}),x.end=A(x.end,{joinWith:""})}}function cs(x){x.scope&&typeof x.scope=="object"&&x.scope!==null&&(x.beginScope=x.scope,delete x.scope)}function us(x){cs(x),typeof x.beginScope=="string"&&(x.beginScope={_wrap:x.beginScope}),typeof x.endScope=="string"&&(x.endScope={_wrap:x.endScope}),Ct(x),ls(x)}function hs(x){function q(oe,ae){return new RegExp(g(oe),"m"+(x.case_insensitive?"i":"")+(x.unicodeRegex?"u":"")+(ae?"g":""))}class ee{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(ae,ye){ye.position=this.position++,this.matchIndexes[this.matchAt]=ye,this.regexes.push([ye,ae]),this.matchAt+=y(ae)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const ae=this.regexes.map(ye=>ye[1]);this.matcherRe=q(A(ae,{joinWith:"|"}),!0),this.lastIndex=0}exec(ae){this.matcherRe.lastIndex=this.lastIndex;const ye=this.matcherRe.exec(ae);if(!ye)return null;const Ve=ye.findIndex((gn,Sr)=>Sr>0&&gn!==void 0),Ze=this.matchIndexes[Ve];return ye.splice(0,Ve),Object.assign(ye,Ze)}}class _e{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(ae){if(this.multiRegexes[ae])return this.multiRegexes[ae];const ye=new ee;return this.rules.slice(ae).forEach(([Ve,Ze])=>ye.addRule(Ve,Ze)),ye.compile(),this.multiRegexes[ae]=ye,ye}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(ae,ye){this.rules.push([ae,ye]),ye.type==="begin"&&this.count++}exec(ae){const ye=this.getMatcher(this.regexIndex);ye.lastIndex=this.lastIndex;let Ve=ye.exec(ae);if(this.resumingScanAtSamePosition()&&!(Ve&&Ve.index===this.lastIndex)){const Ze=this.getMatcher(0);Ze.lastIndex=this.lastIndex+1,Ve=Ze.exec(ae)}return Ve&&(this.regexIndex+=Ve.position+1,this.regexIndex===this.count&&this.considerAll()),Ve}}function Ue(oe){const ae=new _e;return oe.contains.forEach(ye=>ae.addRule(ye.begin,{rule:ye,type:"begin"})),oe.terminatorEnd&&ae.addRule(oe.terminatorEnd,{type:"end"}),oe.illegal&&ae.addRule(oe.illegal,{type:"illegal"}),ae}function We(oe,ae){const ye=oe;if(oe.isCompiled)return ye;[D,$,us,B].forEach(Ze=>Ze(oe,ae)),x.compilerExtensions.forEach(Ze=>Ze(oe,ae)),oe.__beforeBegin=null,[K,j,T].forEach(Ze=>Ze(oe,ae)),oe.isCompiled=!0;let Ve=null;return typeof oe.keywords=="object"&&oe.keywords.$pattern&&(oe.keywords=Object.assign({},oe.keywords),Ve=oe.keywords.$pattern,delete oe.keywords.$pattern),Ve=Ve||/\w+/,oe.keywords&&(oe.keywords=me(oe.keywords,x.case_insensitive)),ye.keywordPatternRe=q(Ve,!0),ae&&(oe.begin||(oe.begin=/\B|\b/),ye.beginRe=q(ye.begin),!oe.end&&!oe.endsWithParent&&(oe.end=/\B|\b/),oe.end&&(ye.endRe=q(ye.end)),ye.terminatorEnd=g(ye.end)||"",oe.endsWithParent&&ae.terminatorEnd&&(ye.terminatorEnd+=(oe.end?"|":"")+ae.terminatorEnd)),oe.illegal&&(ye.illegalRe=q(oe.illegal)),oe.contains||(oe.contains=[]),oe.contains=[].concat(...oe.contains.map(function(Ze){return ds(Ze==="self"?oe:Ze)})),oe.contains.forEach(function(Ze){We(Ze,ye)}),oe.starts&&We(oe.starts,ae),ye.matcher=Ue(ye),ye}if(x.compilerExtensions||(x.compilerExtensions=[]),x.contains&&x.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return x.classNameAliases=i(x.classNameAliases||{}),We(x)}function Ei(x){return x?x.endsWithParent||Ei(x.starts):!1}function ds(x){return x.variants&&!x.cachedVariants&&(x.cachedVariants=x.variants.map(function(q){return i(x,{variants:null},q)})),x.cachedVariants?x.cachedVariants:Ei(x)?i(x,{starts:x.starts?i(x.starts):null}):Object.isFrozen(x)?i(x):x}var fs="11.11.1";class gs extends Error{constructor(q,ee){super(q),this.name="HTMLInjectionError",this.html=ee}}const xr=n,Ci=i,Mi=Symbol("nomatch"),ps=7,Li=function(x){const q=Object.create(null),ee=Object.create(null),_e=[];let Ue=!0;const We="Could not find the language '{}', did you forget to load/include a language module?",oe={disableAutodetect:!0,name:"Plain text",contains:[]};let ae={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:u};function ye(X){return ae.noHighlightRe.test(X)}function Ve(X){let ue=X.className+" ";ue+=X.parentNode?X.parentNode.className:"";const Le=ae.languageDetectRe.exec(ue);if(Le){const je=Tt(Le[1]);return je||(Ie(We.replace("{}",Le[1])),Ie("Falling back to no-highlight mode for this block.",X)),je?Le[1]:"no-highlight"}return ue.split(/\s+/).find(je=>ye(je)||Tt(je))}function Ze(X,ue,Le){let je="",Qe="";typeof ue=="object"?(je=X,Le=ue.ignoreIllegals,Qe=ue.language):(Ge("10.7.0","highlight(lang, code, ...args) has been deprecated."),Ge("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),Qe=X,je=ue),Le===void 0&&(Le=!0);const bt={code:je,language:Qe};qn("before:highlight",bt);const zt=bt.result?bt.result:gn(bt.language,bt.code,Le);return zt.code=bt.code,qn("after:highlight",zt),zt}function gn(X,ue,Le,je){const Qe=Object.create(null);function bt(ne,ce){return ne.keywords[ce]}function zt(){if(!ke.keywords){Ye.addText(qe);return}let ne=0;ke.keywordPatternRe.lastIndex=0;let ce=ke.keywordPatternRe.exec(qe),Ae="";for(;ce;){Ae+=qe.substring(ne,ce.index);const Ne=kt.case_insensitive?ce[0].toLowerCase():ce[0],et=bt(ke,Ne);if(et){const[Mt,Rs]=et;if(Ye.addText(Ae),Ae="",Qe[Ne]=(Qe[Ne]||0)+1,Qe[Ne]<=ps&&(Dn+=Rs),Mt.startsWith("_"))Ae+=ce[0];else{const $s=kt.classNameAliases[Mt]||Mt;_t(ce[0],$s)}}else Ae+=ce[0];ne=ke.keywordPatternRe.lastIndex,ce=ke.keywordPatternRe.exec(qe)}Ae+=qe.substring(ne),Ye.addText(Ae)}function Hn(){if(qe==="")return;let ne=null;if(typeof ke.subLanguage=="string"){if(!q[ke.subLanguage]){Ye.addText(qe);return}ne=gn(ke.subLanguage,qe,!0,Oi[ke.subLanguage]),Oi[ke.subLanguage]=ne._top}else ne=vr(qe,ke.subLanguage.length?ke.subLanguage:null);ke.relevance>0&&(Dn+=ne.relevance),Ye.__addSublanguage(ne._emitter,ne.language)}function ct(){ke.subLanguage!=null?Hn():zt(),qe=""}function _t(ne,ce){ne!==""&&(Ye.startScope(ce),Ye.addText(ne),Ye.endScope())}function $i(ne,ce){let Ae=1;const Ne=ce.length-1;for(;Ae<=Ne;){if(!ne._emit[Ae]){Ae++;continue}const et=kt.classNameAliases[ne[Ae]]||ne[Ae],Mt=ce[Ae];et?_t(Mt,et):(qe=Mt,zt(),qe=""),Ae++}}function Pi(ne,ce){return ne.scope&&typeof ne.scope=="string"&&Ye.openNode(kt.classNameAliases[ne.scope]||ne.scope),ne.beginScope&&(ne.beginScope._wrap?(_t(qe,kt.classNameAliases[ne.beginScope._wrap]||ne.beginScope._wrap),qe=""):ne.beginScope._multi&&($i(ne.beginScope,ce),qe="")),ke=Object.create(ne,{parent:{value:ke}}),ke}function Ii(ne,ce,Ae){let Ne=_(ne.endRe,Ae);if(Ne){if(ne["on:end"]){const et=new t(ne);ne["on:end"](ce,et),et.isMatchIgnored&&(Ne=!1)}if(Ne){for(;ne.endsParent&&ne.parent;)ne=ne.parent;return ne}}if(ne.endsWithParent)return Ii(ne.parent,ce,Ae)}function Cs(ne){return ke.matcher.regexIndex===0?(qe+=ne[0],1):(Mr=!0,0)}function Ms(ne){const ce=ne[0],Ae=ne.rule,Ne=new t(Ae),et=[Ae.__beforeBegin,Ae["on:begin"]];for(const Mt of et)if(Mt&&(Mt(ne,Ne),Ne.isMatchIgnored))return Cs(ce);return Ae.skip?qe+=ce:(Ae.excludeBegin&&(qe+=ce),ct(),!Ae.returnBegin&&!Ae.excludeBegin&&(qe=ce)),Pi(Ae,ne),Ae.returnBegin?0:ce.length}function Ls(ne){const ce=ne[0],Ae=ue.substring(ne.index),Ne=Ii(ke,ne,Ae);if(!Ne)return Mi;const et=ke;ke.endScope&&ke.endScope._wrap?(ct(),_t(ce,ke.endScope._wrap)):ke.endScope&&ke.endScope._multi?(ct(),$i(ke.endScope,ne)):et.skip?qe+=ce:(et.returnEnd||et.excludeEnd||(qe+=ce),ct(),et.excludeEnd&&(qe=ce));do ke.scope&&Ye.closeNode(),!ke.skip&&!ke.subLanguage&&(Dn+=ke.relevance),ke=ke.parent;while(ke!==Ne.parent);return Ne.starts&&Pi(Ne.starts,ne),et.returnEnd?0:ce.length}function Ts(){const ne=[];for(let ce=ke;ce!==kt;ce=ce.parent)ce.scope&&ne.unshift(ce.scope);ne.forEach(ce=>Ye.openNode(ce))}let Fn={};function Ni(ne,ce){const Ae=ce&&ce[0];if(qe+=ne,Ae==null)return ct(),0;if(Fn.type==="begin"&&ce.type==="end"&&Fn.index===ce.index&&Ae===""){if(qe+=ue.slice(ce.index,ce.index+1),!Ue){const Ne=new Error(`0 width match regex (${X})`);throw Ne.languageName=X,Ne.badRule=Fn.rule,Ne}return 1}if(Fn=ce,ce.type==="begin")return Ms(ce);if(ce.type==="illegal"&&!Le){const Ne=new Error('Illegal lexeme "'+Ae+'" for mode "'+(ke.scope||"<unnamed>")+'"');throw Ne.mode=ke,Ne}else if(ce.type==="end"){const Ne=Ls(ce);if(Ne!==Mi)return Ne}if(ce.type==="illegal"&&Ae==="")return qe+=`
`,1;if(Cr>1e5&&Cr>ce.index*3)throw new Error("potential infinite loop, way more iterations than matches");return qe+=Ae,Ae.length}const kt=Tt(X);if(!kt)throw ve(We.replace("{}",X)),new Error('Unknown language: "'+X+'"');const zs=hs(kt);let Er="",ke=je||zs;const Oi={},Ye=new ae.__emitter(ae);Ts();let qe="",Dn=0,Dt=0,Cr=0,Mr=!1;try{if(kt.__emitTokens)kt.__emitTokens(ue,Ye);else{for(ke.matcher.considerAll();;){Cr++,Mr?Mr=!1:ke.matcher.considerAll(),ke.matcher.lastIndex=Dt;const ne=ke.matcher.exec(ue);if(!ne)break;const ce=ue.substring(Dt,ne.index),Ae=Ni(ce,ne);Dt=ne.index+Ae}Ni(ue.substring(Dt))}return Ye.finalize(),Er=Ye.toHTML(),{language:X,value:Er,relevance:Dn,illegal:!1,_emitter:Ye,_top:ke}}catch(ne){if(ne.message&&ne.message.includes("Illegal"))return{language:X,value:xr(ue),illegal:!0,relevance:0,_illegalBy:{message:ne.message,index:Dt,context:ue.slice(Dt-100,Dt+100),mode:ne.mode,resultSoFar:Er},_emitter:Ye};if(Ue)return{language:X,value:xr(ue),illegal:!1,relevance:0,errorRaised:ne,_emitter:Ye,_top:ke};throw ne}}function Sr(X){const ue={value:xr(X),illegal:!1,relevance:0,_top:oe,_emitter:new ae.__emitter(ae)};return ue._emitter.addText(X),ue}function vr(X,ue){ue=ue||ae.languages||Object.keys(q);const Le=Sr(X),je=ue.filter(Tt).filter(Ri).map(ct=>gn(ct,X,!1));je.unshift(Le);const Qe=je.sort((ct,_t)=>{if(ct.relevance!==_t.relevance)return _t.relevance-ct.relevance;if(ct.language&&_t.language){if(Tt(ct.language).supersetOf===_t.language)return 1;if(Tt(_t.language).supersetOf===ct.language)return-1}return 0}),[bt,zt]=Qe,Hn=bt;return Hn.secondBest=zt,Hn}function ms(X,ue,Le){const je=ue&&ee[ue]||Le;X.classList.add("hljs"),X.classList.add(`language-${je}`)}function Ar(X){let ue=null;const Le=Ve(X);if(ye(Le))return;if(qn("before:highlightElement",{el:X,language:Le}),X.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",X);return}if(X.children.length>0&&(ae.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(X)),ae.throwUnescapedHTML))throw new gs("One of your code blocks includes unescaped HTML.",X.innerHTML);ue=X;const je=ue.textContent,Qe=Le?Ze(je,{language:Le,ignoreIllegals:!0}):vr(je);X.innerHTML=Qe.value,X.dataset.highlighted="yes",ms(X,Le,Qe.language),X.result={language:Qe.language,re:Qe.relevance,relevance:Qe.relevance},Qe.secondBest&&(X.secondBest={language:Qe.secondBest.language,relevance:Qe.secondBest.relevance}),qn("after:highlightElement",{el:X,result:Qe,text:je})}function ys(X){ae=Ci(ae,X)}const bs=()=>{jn(),Ge("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function ws(){jn(),Ge("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let Ti=!1;function jn(){function X(){jn()}if(document.readyState==="loading"){Ti||window.addEventListener("DOMContentLoaded",X,!1),Ti=!0;return}document.querySelectorAll(ae.cssSelector).forEach(Ar)}function _s(X,ue){let Le=null;try{Le=ue(x)}catch(je){if(ve("Language definition for '{}' could not be registered.".replace("{}",X)),Ue)ve(je);else throw je;Le=oe}Le.name||(Le.name=X),q[X]=Le,Le.rawDefinition=ue.bind(null,x),Le.aliases&&zi(Le.aliases,{languageName:X})}function ks(X){delete q[X];for(const ue of Object.keys(ee))ee[ue]===X&&delete ee[ue]}function xs(){return Object.keys(q)}function Tt(X){return X=(X||"").toLowerCase(),q[X]||q[ee[X]]}function zi(X,{languageName:ue}){typeof X=="string"&&(X=[X]),X.forEach(Le=>{ee[Le.toLowerCase()]=ue})}function Ri(X){const ue=Tt(X);return ue&&!ue.disableAutodetect}function Ss(X){X["before:highlightBlock"]&&!X["before:highlightElement"]&&(X["before:highlightElement"]=ue=>{X["before:highlightBlock"](Object.assign({block:ue.el},ue))}),X["after:highlightBlock"]&&!X["after:highlightElement"]&&(X["after:highlightElement"]=ue=>{X["after:highlightBlock"](Object.assign({block:ue.el},ue))})}function vs(X){Ss(X),_e.push(X)}function As(X){const ue=_e.indexOf(X);ue!==-1&&_e.splice(ue,1)}function qn(X,ue){const Le=X;_e.forEach(function(je){je[Le]&&je[Le](ue)})}function Es(X){return Ge("10.7.0","highlightBlock will be removed entirely in v12.0"),Ge("10.7.0","Please use highlightElement now."),Ar(X)}Object.assign(x,{highlight:Ze,highlightAuto:vr,highlightAll:jn,highlightElement:Ar,highlightBlock:Es,configure:ys,initHighlighting:bs,initHighlightingOnLoad:ws,registerLanguage:_s,unregisterLanguage:ks,listLanguages:xs,getLanguage:Tt,registerAliases:zi,autoDetection:Ri,inherit:Ci,addPlugin:vs,removePlugin:As}),x.debugMode=function(){Ue=!1},x.safeMode=function(){Ue=!0},x.versionString=fs,x.regex={concat:m,lookahead:h,either:w,optional:p,anyNumberOfTimes:d};for(const X in v)typeof v[X]=="object"&&e(v[X]);return Object.assign(x,v),x},tn=Li({});return tn.newInstance=()=>Li({}),Lr=tn,tn.HighlightJS=tn,tn.default=tn,Lr}var Zs=Ws();const Re=pa(Zs);class pr{constructor(t={}){const{maxSize:n=0,ttlMs:i=0,onEvict:r=null}=t||{};this._map=new Map,this._maxSize=Math.max(0,Number(n)||0),this._ttlMs=Math.max(0,Number(i)||0),this._onEvict=typeof r=="function"?r:null}get size(){return this._map.size}has(t){const n=this._map.get(t);return n?this._ttlMs&&Date.now()-(n.ts||0)>=this._ttlMs?(this._evictKey(t,n),!1):(this._map.delete(t),this._map.set(t,n),!0):!1}get(t){const n=this._map.get(t);if(n){if(this._ttlMs&&Date.now()-(n.ts||0)>=this._ttlMs){this._evictKey(t,n);return}return this._map.delete(t),this._map.set(t,n),n.value}}set(t,n){if(this._map.has(t)&&this._map.delete(t),this._map.set(t,{value:n,ts:Date.now()}),this._maxSize&&this._map.size>this._maxSize)for(;this._map.size>this._maxSize;){const i=this._map.keys().next().value,r=this._map.get(i);if(this._map.delete(i),this._onEvict)try{this._onEvict(i,r&&r.value)}catch{}}return this}delete(t){return this._map.delete(t)}clear(){if(this._onEvict)for(const[t,n]of this._map.entries())try{this._onEvict(t,n&&n.value)}catch{}this._map.clear()}_evictKey(t,n){try{this._map.delete(t)}catch{}if(this._onEvict)try{this._onEvict(t,n&&n.value)}catch{}}}const Kn=new pr({maxSize:500});let ma=300*1e3;function Gs(){Kn.clear()}function Qs(e){ma=Number(e)||0}async function ri(e,t){try{if(!e)return null;const n=Date.now();let i=Kn.get(e);if(i&&i.ok===!1&&n-(i.ts||0)>=ma&&(Kn.delete(e),i=void 0),i){if(i.module)return i.module;if(i.promise)try{return await i.promise}catch{return null}}const r={promise:null,module:null,ok:null,ts:Date.now()};Kn.set(e,r),r.promise=(async()=>{try{return await t()}catch{return null}})();try{const a=await r.promise;return r.module=a,r.ok=!!a,r.ts=Date.now(),a}catch{return r.module=null,r.ok=!1,r.ts=Date.now(),null}}catch{return null}}async function Xs(e){return await ri(e,async()=>{try{return await import(e)}catch{return null}})}const Ks="11.11.1",Ce=new Map,Vs="https://raw.githubusercontent.com/highlightjs/highlight.js/main/SUPPORTED_LANGUAGES.md",dt={shell:"bash",sh:"bash",zsh:"bash",js:"javascript",ts:"typescript",py:"python",csharp:"cs","c#":"cs"};dt.html="xml";dt.xhtml="xml";dt.markup="xml";const ii=new Set(["magic","undefined"]);let Nt=null,Ys=null;async function ai(e=Vs){if(e)return Nt||(Nt=(async()=>{try{const t=await fetch(e);if(!t.ok)return;const i=(await t.text()).split(/\r?\n/);let r=-1;for(let c=0;c<i.length;c++)if(/\|\s*Language\s*\|/i.test(i[c])){r=c;break}if(r===-1)return;const a=i[r].replace(/^\||\|$/g,"").split("|").map(c=>c.trim().toLowerCase());let s=a.findIndex(c=>/alias|aliases|equivalent|alt|alternates?/i.test(c));s===-1&&(s=1);let o=a.findIndex(c=>/file|filename|module|module name|module-name|short|slug/i.test(c));if(o===-1){const c=a.findIndex(u=>/language/i.test(u));o=c!==-1?c:0}let l=[];for(let c=r+1;c<i.length;c++){const u=i[c].trim();if(!u||!u.startsWith("|"))break;const g=u.replace(/^\||\|$/g,"").split("|").map(f=>f.trim());if(g.every(f=>/^-+$/.test(f)))continue;const h=g;if(!h.length)continue;const p=(h[o]||h[0]||"").toString().trim().toLowerCase();if(!p||/^-+$/.test(p))continue;Ce.set(p,p);const m=h[s]||"";if(m){const f=String(m).split(",").map(w=>w.replace(/`/g,"").trim()).filter(Boolean);if(f.length){const y=f[0].toLowerCase().replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");y&&/[a-z0-9]/i.test(y)&&(Ce.set(y,y),l.push(y))}}}try{const c=[];for(const u of l){const g=String(u||"").replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");g&&/[a-z0-9]/i.test(g)?c.push(g):Ce.delete(u)}l=c}catch(c){k("[codeblocksManager] cleanup aliases failed",c)}try{let c=0;for(const u of Array.from(Ce.keys())){if(!u||/^-+$/.test(u)||!/[a-z0-9]/i.test(u)){Ce.delete(u),c++;continue}if(/^[:]+/.test(u)){const g=u.replace(/^[:]+/,"");if(g&&/[a-z0-9]/i.test(g)){const h=Ce.get(u);Ce.delete(u),Ce.set(g,h)}else Ce.delete(u),c++}}for(const[u,g]of Array.from(Ce.entries()))(!g||/^-+$/.test(g)||!/[a-z0-9]/i.test(g))&&(Ce.delete(u),c++);try{const u=":---------------------";Ce.has(u)&&(Ce.delete(u),c++)}catch(u){k("[codeblocksManager] remove sep key failed",u)}try{const u=Array.from(Ce.keys()).sort()}catch(u){k("[codeblocksManager] compute supported keys failed",u)}}catch(c){k("[codeblocksManager] ignored error",c)}}catch(t){k("[codeblocksManager] loadSupportedLanguages failed",t)}})(),Nt)}const pn=new Set;async function ln(e,t){if(Nt||(async()=>{try{await ai()}catch(r){k("[codeblocksManager] loadSupportedLanguages (IIFE) failed",r)}})(),Nt)try{await Nt}catch{}if(e=e==null?"":String(e),e=e.trim(),!e)return!1;const n=e.toLowerCase();if(ii.has(n))return!1;if(Ce.size&&!Ce.has(n)){const r=dt;if(!r[n]&&!r[e])return!1}if(pn.has(e))return!0;const i=dt;try{const r=(t||e||"").toString().replace(/\.js$/i,"").trim(),a=(i[e]||e||"").toString(),s=(i[r]||r||"").toString();let o=Array.from(new Set([a,s,r,e,i[r],i[e]].filter(Boolean))).map(u=>String(u).toLowerCase()).filter(u=>u&&u!=="undefined");Ce.size&&(o=o.filter(u=>{if(Ce.has(u))return!0;const g=dt[u];return!!(g&&Ce.has(g))}));let l=null,c=null;for(const u of o)try{if(l=await ri(u,async()=>{try{try{try{return await import(`highlight.js/lib/languages/${u}.js`)}catch{return await import(`highlight.js/lib/languages/${u}`)}}catch{try{return await import(`https://cdn.jsdelivr.net/npm/highlight.js/es/languages/${u}.js`)}catch{try{return await import(`https://cdn.jsdelivr.net/npm/highlight.js/lib/languages/${u}.js`)}catch{return null}}}}catch{return null}}),l){const g=l.default||l;try{const h=Ce.size&&Ce.get(e)||u||e;return Re.registerLanguage(h,g),pn.add(h),h!==e&&(Re.registerLanguage(e,g),pn.add(e)),!0}catch(h){c=h}}else try{if(Ce.has(u)||Ce.has(e)){const g=()=>({});try{Re.registerLanguage(u,g),pn.add(u)}catch{}try{u!==e&&(Re.registerLanguage(e,g),pn.add(e))}catch{}return!0}}catch{}}catch(g){c=g}if(c)throw c;return!1}catch{return!1}}let Un=null;function ya(e){const t=e&&e.querySelector?e:typeof document<"u"?document:null;Nt||(async()=>{try{await ai()}catch(s){k("[codeblocksManager] loadSupportedLanguages (observer) failed",s)}})();const n=dt,r=Un||(typeof IntersectionObserver>"u"?null:(Un=new IntersectionObserver((s,o)=>{s.forEach(l=>{if(!l.isIntersecting)return;const c=l.target;try{o.unobserve(c)}catch(u){k("[codeblocksManager] observer unobserve failed",u)}(async()=>{try{const u=c.getAttribute&&c.getAttribute("class")||c.className||"",g=u.match(/language-([a-zA-Z0-9_+-]+)/)||u.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(g&&g[1]){const h=(g[1]||"").toLowerCase(),d=n[h]||h,p=Ce.size&&(Ce.get(d)||Ce.get(String(d).toLowerCase()))||d;try{await ln(p)}catch(m){k("[codeblocksManager] registerLanguage failed",m)}try{try{const m=c.textContent||c.innerText||"";m!=null&&(c.textContent=m)}catch{}try{c&&c.dataset&&c.dataset.highlighted&&delete c.dataset.highlighted}catch{}Re.highlightElement(c)}catch(m){k("[codeblocksManager] hljs.highlightElement failed",m)}}else try{const h=c.textContent||"";try{if(Re&&typeof Re.getLanguage=="function"&&Re.getLanguage("plaintext")){const d=Re.highlight(h,{language:"plaintext"});if(d&&d.value)try{if(typeof document<"u"&&document.createRange&&typeof document.createRange=="function"){const p=document.createRange().createContextualFragment(d.value);if(typeof c.replaceChildren=="function")c.replaceChildren(...Array.from(p.childNodes));else{for(;c.firstChild;)c.removeChild(c.firstChild);c.appendChild(p)}}else c.innerHTML=d.value}catch{try{c.innerHTML=d.value}catch{}}}}catch{try{Re.highlightElement(c)}catch(p){k("[codeblocksManager] fallback highlightElement failed",p)}}}catch(h){k("[codeblocksManager] auto-detect plaintext failed",h)}}catch(u){k("[codeblocksManager] observer entry processing failed",u)}})()})},{root:null,rootMargin:"300px",threshold:.1}),Un)),a=t&&t.querySelectorAll?t.querySelectorAll("pre code"):[];if(!r){a.forEach(async s=>{try{const o=s.getAttribute&&s.getAttribute("class")||s.className||"",l=o.match(/language-([a-zA-Z0-9_+-]+)/)||o.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(l&&l[1]){const c=(l[1]||"").toLowerCase(),u=n[c]||c,g=Ce.size&&(Ce.get(u)||Ce.get(String(u).toLowerCase()))||u;try{await ln(g)}catch(h){k("[codeblocksManager] registerLanguage failed (no observer)",h)}}try{try{const c=s.textContent||s.innerText||"";c!=null&&(s.textContent=c)}catch{}try{s&&s.dataset&&s.dataset.highlighted&&delete s.dataset.highlighted}catch{}Re.highlightElement(s)}catch(c){k("[codeblocksManager] hljs.highlightElement failed (no observer)",c)}}catch(o){k("[codeblocksManager] loadSupportedLanguages fallback ignored error",o)}});return}a.forEach(s=>{try{r.observe(s)}catch(o){k("[codeblocksManager] observe failed",o)}})}function Js(e,{useCdn:t=!0}={}){const n=typeof document<"u"&&document.head&&document.head.querySelector?document.head.querySelector("link[data-hl-theme]"):typeof document<"u"?document.querySelector("link[data-hl-theme]"):null,i=n&&n.getAttribute?n.getAttribute("data-hl-theme"):null,r=e==null?"default":String(e),a=r&&String(r).toLowerCase()||"";if(a==="default"||a==="monokai"){try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}return}if(i&&i.toLowerCase()===a)return;if(!t){try{k("Requested highlight theme not bundled; set useCdn=true to load theme from CDN")}catch{}return}const s=a,o=`https://cdn.jsdelivr.net/npm/highlight.js@${Ks}/styles/${s}.css`,l=document.createElement("link");l.rel="stylesheet",l.href=o,l.setAttribute("data-hl-theme",s),l.addEventListener("load",()=>{try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}}),document.head.appendChild(l)}let Ut="light";function eo(e,t={}){if(document.querySelector(`link[href="${e}"]`))return;const n=document.createElement("link");if(n.rel="stylesheet",n.href=e,Object.entries(t).forEach(([i,r])=>n.setAttribute(i,r)),document.head.appendChild(n),t["data-bulmaswatch-theme"])try{if(n.getAttribute("data-bulmaswatch-observer"))return;let i=Number(n.getAttribute("data-bulmaswatch-move-count")||0),r=!1;const a=new MutationObserver(()=>{try{if(r)return;const o=n.parentNode;if(!o||o.lastElementChild===n)return;if(i>=1e3){n.setAttribute("data-bulmaswatch-move-stopped","1");return}r=!0;try{o.appendChild(n)}catch{}i+=1,n.setAttribute("data-bulmaswatch-move-count",String(i)),r=!1}catch{}});try{a.observe(document.head,{childList:!0}),n.setAttribute("data-bulmaswatch-observer","1"),n.setAttribute("data-bulmaswatch-move-count",String(i))}catch{}const s=document.head;s&&s.lastElementChild!==n&&s.appendChild(n)}catch{}}function Tr(){try{const e=typeof document<"u"&&document.head?document.head:document,t=Array.from(e.querySelectorAll("link[data-bulmaswatch-theme]"));for(const n of t)n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}try{const e=typeof document<"u"&&document.head?document.head:document,t=Array.from(e.querySelectorAll("style[data-bulma-override]"));for(const n of t)n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}}async function ba(e="none",t="/"){try{jt("[bulmaManager] ensureBulma called",{bulmaCustomize:e,pageDir:t})}catch{}if(!e)return;if(e==="none"){try{Tr()}catch{}return}const n=[t+"bulma.css","/bulma.css"],i=Array.from(new Set(n));if(e==="local"){if(Tr(),document.querySelector("style[data-bulma-override]"))return;for(const r of i)try{const a=await fetch(r,{method:"GET"});if(a.ok){const s=await a.text(),o=document.createElement("style");o.setAttribute("data-bulma-override",r),o.appendChild(document.createTextNode(`
/* bulma override: ${r} */
`+s)),document.head.appendChild(o);return}}catch(a){k("[bulmaManager] fetch local bulma candidate failed",a)}return}try{const r=String(e).trim();if(!r)return;Tr();const a=`https://unpkg.com/bulmaswatch/${encodeURIComponent(r)}/bulmaswatch.min.css`;eo(a,{"data-bulmaswatch-theme":r})}catch(r){k("[bulmaManager] ensureBulma failed",r)}}function wa(e){Ut=e==="dark"?"dark":e==="system"?"system":"light";try{const t=Array.from(document.querySelectorAll(".nimbi-mount"));if(t.length>0)for(const n of t)Ut==="dark"?n.setAttribute("data-theme","dark"):Ut==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme");else{const n=document.documentElement;Ut==="dark"?n.setAttribute("data-theme","dark"):Ut==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme")}}catch{}}function to(e){const t=document.documentElement;for(const[n,i]of Object.entries(e||{}))try{t.style.setProperty(`--${n}`,i)}catch(r){k("[bulmaManager] setThemeVars failed for",n,r)}}function _a(e){if(!e||!(e instanceof HTMLElement))return()=>{};const t=e.closest&&e.closest(".nimbi-mount")||null;try{t&&(Ut==="dark"?t.setAttribute("data-theme","dark"):Ut==="light"?t.setAttribute("data-theme","light"):t.removeAttribute("data-theme"))}catch{}return()=>{}}const ka={en:{navigation:"Navigation",onThisPage:"On this page",home:"Home",scrollToTop:"Scroll to top",readingTime:"{minutes} min read",searchPlaceholder:"Search…",searchNoResults:"No results",imagePreviewTitle:"Image preview",imagePreviewFit:"Fit to screen",imagePreviewOriginal:"Original size",imagePreviewZoomOut:"Zoom out",imagePreviewZoomIn:"Zoom in",imagePreviewClose:"Close"},es:{navigation:"Navegación",onThisPage:"En esta página",home:"Inicio",scrollToTop:"Ir arriba",readingTime:"{minutes} min de lectura",searchPlaceholder:"Buscar…",searchNoResults:"Sin resultados",imagePreviewTitle:"Previsualización de imagen",imagePreviewFit:"Ajustar a la pantalla",imagePreviewOriginal:"Tamaño original",imagePreviewZoomOut:"Alejar",imagePreviewZoomIn:"Acercar",imagePreviewClose:"Cerrar"},de:{navigation:"Navigation",onThisPage:"Auf dieser Seite",home:"Startseite",scrollToTop:"Nach oben",readingTime:"{minutes} min Lesezeit",searchPlaceholder:"Suchen…",searchNoResults:"Keine Ergebnisse",imagePreviewTitle:"Bildvorschau",imagePreviewFit:"An Bildschirm anpassen",imagePreviewOriginal:"Originalgröße",imagePreviewZoomOut:"Verkleinern",imagePreviewZoomIn:"Vergrößern",imagePreviewClose:"Schließen"},fr:{navigation:"Navigation",onThisPage:"Sur cette page",home:"Accueil",scrollToTop:"Aller en haut",readingTime:"{minutes} min de lecture",searchPlaceholder:"Rechercher…",searchNoResults:"Aucun résultat",imagePreviewTitle:"Aperçu de l’image",imagePreviewFit:"Ajuster à l’écran",imagePreviewOriginal:"Taille originale",imagePreviewZoomOut:"Dézoomer",imagePreviewZoomIn:"Zoomer",imagePreviewClose:"Fermer"},pt:{navigation:"Navegação",onThisPage:"Nesta página",home:"Início",scrollToTop:"Ir para o topo",readingTime:"{minutes} min de leitura",searchPlaceholder:"Procurar…",searchNoResults:"Sem resultados",imagePreviewTitle:"Visualização da imagem",imagePreviewFit:"Ajustar à tela",imagePreviewOriginal:"Tamanho original",imagePreviewZoomOut:"Diminuir",imagePreviewZoomIn:"Aumentar",imagePreviewClose:"Fechar"}},sn=JSON.parse(JSON.stringify(ka));let ar="en";if(typeof navigator<"u"){const e=navigator.language||navigator.languages&&navigator.languages[0]||"en";ar=String(e).split("-")[0].toLowerCase()}ka[ar]||(ar="en");let qt=ar;function rn(e,t={}){const n=sn[qt]||sn.en;let i=n&&n[e]?n[e]:sn.en[e]||"";for(const r of Object.keys(t))i=i.replace(new RegExp(`{${r}}`,"g"),String(t[r]));return i}async function si(e,t){if(!e)return;let n=e;try{/^https?:\/\//.test(e)||(n=new URL(e,location.origin+t).toString());const i=await fetch(n);if(!i.ok)return;const r=await i.json();for(const a of Object.keys(r||{}))sn[a]=Object.assign({},sn[a]||{},r[a])}catch{}}function oi(e){const t=String(e).split("-")[0].toLowerCase();qt=sn[t]?t:"en"}const no=Object.freeze(Object.defineProperty({__proto__:null,get currentLang(){return qt},loadL10nFile:si,setLang:oi,t:rn},Symbol.toStringTag,{value:"Module"}));function ro(e){try{return String(e||"").split("/").map(t=>encodeURIComponent(t)).join("/")}catch{return String(e||"")}}function Fi(e,t=null,n=void 0){let r="#/"+ro(String(e||""));t&&(r+="#"+encodeURIComponent(String(t)));try{let a="";if(typeof n=="string")a=n;else if(typeof location<"u"&&location&&location.search)a=location.search;else if(typeof location<"u"&&location&&location.hash)try{const s=Je(location.href);s&&s.params&&(a=s.params)}catch{}if(a){const s=typeof a=="string"&&a.startsWith("?")?a.slice(1):a;try{const o=new URLSearchParams(s);o.delete("page");const l=o.toString();l&&(r+="?"+l)}catch{const l=String(s||"").replace(/^page=[^&]*&?/,"");l&&(r+="?"+l)}}}catch{}return r}function Je(e){try{const t=new URL(e,typeof location<"u"?location.href:"http://localhost/"),n=t.searchParams.get("page");if(n){let r=null,a="";if(t.hash){const c=t.hash.replace(/^#/,"");if(c.includes("&")){const u=c.split("&");r=u.shift()||null,a=u.join("&")}else r=c||null}const s=new URLSearchParams(t.search);s.delete("page");const l=[s.toString(),a].filter(Boolean).join("&");return{type:"canonical",page:decodeURIComponent(n),anchor:r,params:l}}const i=t.hash?decodeURIComponent(t.hash.replace(/^#/,"")):"";if(i&&i.startsWith("/")){let r=i,a="";if(r.indexOf("?")!==-1){const c=r.split("?");r=c.shift()||"",a=c.join("?")||""}let s=r,o=null;if(s.indexOf("#")!==-1){const c=s.split("#");s=c.shift()||"",o=c.join("#")||null}return{type:"cosmetic",page:s.replace(/^\/+/,"")||null,anchor:o,params:a}}return{type:"path",page:(t.pathname||"").replace(/^\//,"")||null,anchor:t.hash?t.hash.replace(/^#/,""):null,params:t.search?t.search.replace(/^\?/,""):""}}catch{return{type:"unknown",page:e,anchor:null,params:""}}}let Wn=typeof DOMParser<"u"?new DOMParser:null;function He(){return Wn||(typeof DOMParser<"u"?(Wn=new DOMParser,Wn):null)}async function Rn(e,t,n=4){if(!Array.isArray(e)||e.length===0)return[];const i=new Array(e.length);let r=0;const a=[],s=Math.max(1,Number(n)||1);async function o(){for(;;){const l=r++;if(l>=e.length)return;try{i[l]=await t(e[l],l)}catch{i[l]=void 0}}}for(let l=0;l<Math.min(s,e.length);l++)a.push(o());return await Promise.all(a),i}const io=`/**
...
`;function ao(e,t="worker"){let n=null;function i(...l){try{k(...l)}catch{}}function r(){if(!n)try{const l=e();n=l||null,l&&l.addEventListener("error",()=>{try{n===l&&(n=null,l.terminate&&l.terminate())}catch(c){i("["+t+"] worker termination failed",c)}})}catch(l){n=null,i("["+t+"] worker init failed",l)}return n}function a(){try{n&&(n.terminate&&n.terminate(),n=null)}catch(l){i("["+t+"] worker termination failed",l)}}function s(l,c=1e4){return new Promise((u,g)=>{const h=r();if(!h)return g(new Error("worker unavailable"));const d=String(Math.random()),p=Object.assign({},l,{id:d});let m=null;const f=()=>{m&&clearTimeout(m),h.removeEventListener("message",w),h.removeEventListener("error",y)},w=_=>{const b=_.data||{};b.id===d&&(f(),b.error?g(new Error(b.error)):u(b.result))},y=_=>{f(),i("["+t+"] worker error event",_);try{n===h&&(n=null,h.terminate&&h.terminate())}catch(b){i("["+t+"] worker termination failed",b)}g(new Error(_&&_.message||"worker error"))};m=setTimeout(()=>{f(),i("["+t+"] worker timed out");try{n===h&&(n=null,h.terminate&&h.terminate())}catch(_){i("["+t+"] worker termination on timeout failed",_)}g(new Error("worker timeout"))},c),h.addEventListener("message",w),h.addEventListener("error",y);try{h.postMessage(p)}catch(_){f(),g(_)}})}return{get:r,send:s,terminate:a}}function xa(e,t="worker-pool",n=2){const i=new Array(n).fill(null);let r=0;function a(...p){try{k(...p)}catch{}}function s(p){if(!i[p])try{const m=e();i[p]=m||null,m&&m.addEventListener("error",()=>{try{i[p]===m&&(i[p]=null,m.terminate&&m.terminate())}catch(f){a("["+t+"] worker termination failed",f)}})}catch(m){i[p]=null,a("["+t+"] worker init failed",m)}return i[p]}const o=new Array(n).fill(0),l=new Array(n).fill(null),c=30*1e3;function u(p){try{o[p]=Date.now(),l[p]&&(clearTimeout(l[p]),l[p]=null),l[p]=setTimeout(()=>{try{i[p]&&(i[p].terminate&&i[p].terminate(),i[p]=null)}catch(m){a("["+t+"] idle termination failed",m)}l[p]=null},c)}catch{}}function g(){for(let p=0;p<i.length;p++){const m=s(p);if(m)return m}return null}function h(){for(let p=0;p<i.length;p++)try{i[p]&&(i[p].terminate&&i[p].terminate(),i[p]=null)}catch(m){a("["+t+"] worker termination failed",m)}}function d(p,m=1e4){return new Promise((f,w)=>{const y=r++%i.length,_=b=>{const A=(y+b)%i.length,S=s(A);if(!S)return b+1<i.length?_(b+1):w(new Error("worker pool unavailable"));const E=String(Math.random()),I=Object.assign({},p,{id:E});let N=null;const U=()=>{N&&clearTimeout(N),S.removeEventListener("message",z),S.removeEventListener("error",O)},z=W=>{const te=W.data||{};te.id===E&&(U(),te.error?w(new Error(te.error)):f(te.result))},O=W=>{U(),a("["+t+"] worker error event",W);try{i[A]===S&&(i[A]=null,S.terminate&&S.terminate())}catch(te){a("["+t+"] worker termination failed",te)}w(new Error(W&&W.message||"worker error"))};N=setTimeout(()=>{U(),a("["+t+"] worker timed out");try{i[A]===S&&(i[A]=null,S.terminate&&S.terminate())}catch(W){a("["+t+"] worker termination on timeout failed",W)}w(new Error("worker timeout"))},m),S.addEventListener("message",z),S.addEventListener("error",O);try{u(A),S.postMessage(I)}catch(W){U(),w(W)}};_(0)})}return{get:g,send:d,terminate:h}}function so(e,t,n="worker"){return ao(()=>{try{const a=Gt(e);if(a)try{if(!(typeof process<"u"&&process.env&&process.env.VITEST))return a}catch{return a}}catch{}if(typeof t!="function")return null;const r={message:[],error:[]};return{addEventListener(a,s){r[a]||(r[a]=[]),r[a].push(s)},removeEventListener(a,s){if(!r[a])return;const o=r[a].indexOf(s);o!==-1&&r[a].splice(o,1)},postMessage(a){setTimeout(async()=>{try{const o={data:await t(a)};(r.message||[]).forEach(l=>l(o))}catch(s){const o={data:{id:a&&a.id,error:String(s)}};(r.message||[]).forEach(l=>l(o))}},0)},terminate(){Object.keys(r).forEach(a=>r[a].length=0)}}},n)}function Gt(e){try{if(typeof Blob<"u"&&typeof URL<"u"&&e)try{Gt._blobUrlCache||(Gt._blobUrlCache=new pr({maxSize:200,onEvict:(i,r)=>{try{typeof URL<"u"&&r&&URL.revokeObjectURL(r)}catch{}}}));const t=Gt._blobUrlCache;let n=t.get(e);if(!n){const i=new Blob([e],{type:"application/javascript"});n=URL.createObjectURL(i),t.set(e,n)}return new Worker(n,{type:"module"})}catch(t){try{k("[worker-manager] createWorkerFromRaw failed",t)}catch{}}}catch(t){try{k("[worker-manager] createWorkerFromRaw failed",t)}catch{}}return null}function oo(){return typeof requestIdleCallback=="function"?new Promise(e=>{try{requestIdleCallback(e,{timeout:50})}catch{setTimeout(e,0)}}):new Promise(e=>setTimeout(e,0))}async function Pt(e,t=50){try{if(!e||!t)return;e%t===0&&await oo()}catch{}}const it=new Set;function Qt(e){if(lo(),it.clear(),Array.isArray(Oe)&&Oe.length)for(const t of Oe)t&&it.add(t);else for(const t of $e)t&&it.add(t);Di(V),Di(Z),Qt._refreshed=!0}function Di(e){if(!(!e||typeof e.values!="function"))for(const t of e.values())t&&it.add(t)}function Ui(e){if(!e||typeof e.set!="function")return;const t=e.set;e.set=function(n,i){return i&&it.add(i),t.call(this,n,i)}}let Wi=!1;function lo(){Wi||(Ui(V),Ui(Z),Wi=!0)}const zr=Object.freeze(Object.defineProperty({__proto__:null,indexSet:it,refreshIndexPaths:Qt},Symbol.toStringTag,{value:"Module"}));function dn(e,t=1e3){const n=new Map;function i(r){const a=r===void 0?"__undefined":String(r);if(n.has(a)){const o=n.get(a);return n.delete(a),n.set(a,o),o}const s=e(r);try{if(n.set(a,s),n.size>t){const o=n.keys().next().value;n.delete(o)}}catch{}return s}return i._cache=n,i._reset=()=>n.clear(),i}function jr(e){return!e||typeof e!="string"?!1:/^(https?:)?\/\//.test(e)||e.startsWith("mailto:")||e.startsWith("tel:")}const Y=dn(function(e){return String(e||"").replace(/^[.\/]+/,"")},2e3),cn=dn(function(e){return String(e||"").replace(/\/+$/,"")},2e3),Vt=dn(function(e){return cn(String(e||""))+"/"},2e3);function co(e){try{if(!e||typeof document>"u"||!document.head||e.startsWith("data:")||document.head.querySelector(`link[rel="preload"][as="image"][href="${e}"]`))return;const n=document.createElement("link");n.rel="preload",n.as="image",n.href=e,document.head.appendChild(n)}catch(t){k("[helpers] preloadImage failed",t)}}function Zn(e,t=0,n=!1){try{if(typeof window>"u"||!e||!e.querySelectorAll)return;const i=Array.from(e.querySelectorAll("img"));if(!i.length)return;const r=e,a=r&&r.getBoundingClientRect?r.getBoundingClientRect():null,s=0,o=typeof window<"u"&&(window.innerHeight||document.documentElement.clientHeight)||0,l=a?Math.max(s,a.top):s,u=(a?Math.min(o,a.bottom):o)+Number(t||0);let g=0;r&&(g=r.clientHeight||(a?a.height:0)),g||(g=o-s);let h=.6;try{const f=r&&window.getComputedStyle?window.getComputedStyle(r):null,w=f&&f.getPropertyValue("--nimbi-image-max-height-ratio"),y=w?parseFloat(w):NaN;!Number.isNaN(y)&&y>0&&y<=1&&(h=y)}catch(f){k("[helpers] read CSS ratio failed",f)}const d=Math.max(200,Math.floor(g*h));let p=!1,m=null;if(i.forEach(f=>{try{const w=f.getAttribute?f.getAttribute("loading"):void 0;w!=="eager"&&f.setAttribute&&f.setAttribute("loading","lazy");const y=f.getBoundingClientRect?f.getBoundingClientRect():null,_=f.src||f.getAttribute&&f.getAttribute("src"),b=y&&y.height>1?y.height:d,A=y?y.top:0,S=A+b;y&&b>0&&A<=u&&S>=l&&(f.setAttribute?(f.setAttribute("loading","eager"),f.setAttribute("fetchpriority","high"),f.setAttribute("data-eager-by-nimbi","1")):(f.loading="eager",f.fetchPriority="high"),co(_),p=!0),!m&&y&&y.top<=u&&(m={img:f,src:_,rect:y,beforeLoading:w})}catch(w){k("[helpers] setEagerForAboveFoldImages per-image failed",w)}}),!p&&m){const{img:f,src:w,rect:y,beforeLoading:_}=m;try{f.setAttribute?(f.setAttribute("loading","eager"),f.setAttribute("fetchpriority","high"),f.setAttribute("data-eager-by-nimbi","1")):(f.loading="eager",f.fetchPriority="high")}catch(b){k("[helpers] setEagerForAboveFoldImages fallback failed",b)}}}catch(i){k("[helpers] setEagerForAboveFoldImages failed",i)}}function Pe(e,t=null,n){try{const i=typeof n=="string"?n:typeof window<"u"&&window.location?window.location.search:"",r=new URLSearchParams(i.startsWith("?")?i.slice(1):i),a=String(e||"");r.delete("page");const s=new URLSearchParams;s.set("page",a);for(const[c,u]of r.entries())s.append(c,u);const o=s.toString();let l=o?`?${o}`:"";return t&&(l+=`#${encodeURIComponent(t)}`),l||`?page=${encodeURIComponent(a)}`}catch{const r=`?page=${encodeURIComponent(String(e||""))}`;return t?`${r}#${encodeURIComponent(t)}`:r}}dn(function(e){try{const t=String(e||"");return t.includes("%")?t:encodeURI(t)}catch(t){return k("[helpers] encodeURL failed",t),String(e||"")}},2e3);function sr(e){try{const t=e();return t&&typeof t.then=="function"?t.catch(n=>{k("[helpers] safe swallowed error",n)}):t}catch(t){k("[helpers] safe swallowed error",t)}}try{typeof globalThis<"u"&&!globalThis.safe&&(globalThis.safe=sr)}catch(e){k("[helpers] global attach failed",e)}const uo=dn(function(e){try{if(!e&&e!==0)return"";const t=String(e),n={amp:"&",lt:"<",gt:">",quot:'"',apos:"'",nbsp:" "};return t.replace(/&(#x?[0-9a-fA-F]+|[a-zA-Z]+);/g,(i,r)=>{if(!r)return i;if(r[0]==="#")try{return r[1]==="x"||r[1]==="X"?String.fromCharCode(parseInt(r.slice(2),16)):String.fromCharCode(parseInt(r.slice(1),10))}catch{return i}return n[r]!==void 0?n[r]:i})}catch{return String(e||"")}},2e3),V=new Map,or=new Map;function Vn(e){try{if(!e)return;let t=Ot,n="";if(e.type==="cosmetic"){const r=e.page!=null&&String(e.page).trim()!=="";t=r?String(e.page):Ot,n="#/"+(r?String(e.page):""),e.anchor&&(n+="#"+String(e.anchor)),e.params&&(n+="?"+String(e.params))}else if(e.type==="path"){const r=e.page!=null&&String(e.page).trim()!=="";t=r?String(e.page):Ot,n="/"+(r?String(e.page):""),e.anchor&&(n+="#"+String(e.anchor)),e.params&&(n+="?"+String(e.params))}else if(e.type==="canonical")if(e.page)t=e.page,n="?page="+encodeURIComponent(e.page),e.anchor&&(n+="#"+String(e.anchor)),e.params&&(n+="?"+String(e.params));else{t=Ot;try{n=typeof location<"u"&&location&&location.pathname?String(location.pathname):"/",typeof location<"u"&&location.search&&(n+=String(location.search)),typeof location<"u"&&location.hash&&(n+=String(location.hash))}catch{n="/"}}else return;const i=or.get(t)||[];i.push(n),or.set(t,i)}catch{}}function Sa(e,t){try{const n=String(e||""),i=or.get(n);if(!i||!i.length)return;try{const r=typeof globalThis<"u"?globalThis:null;if(r){try{r.__nimbiColdRouteResolved||(r.__nimbiColdRouteResolved=[])}catch{}for(const a of i)try{const s={slug:n,token:a,rel:String(t||"")};try{r.__nimbiColdRouteResolved.push(s)}catch{}try{r&&typeof r.dispatchEvent=="function"&&r.dispatchEvent(new CustomEvent("nimbi.coldRouteResolved",{detail:s}))}catch{}try{r&&r.__nimbiUI&&typeof r.__nimbiUI.renderByQuery=="function"&&r.__nimbiUI.renderByQuery().catch(()=>{})}catch{}}catch{}}}catch{}or.delete(n)}catch{}}try{const e=V.set;V.set=function(t,n){const i=Map.prototype.has.call(this,t),r=Map.prototype.set.call(this,t,n);try{i||Sa(t,n)}catch{}return r}}catch{}let st=[],li=!1;function ho(e){li=!!e}function va(e){st=Array.isArray(e)?e.slice():[]}function fo(){return st}const mr=typeof navigator<"u"&&navigator.hardwareConcurrency?Math.max(1,Math.floor(navigator.hardwareConcurrency/2)):2,Aa=xa(()=>Gt(io),"slugManager",mr);function go(){try{if(ni())return!0}catch{}try{return!!(typeof le=="string"&&le)}catch{return!1}}function fe(...e){try{jt(...e)}catch{}}function po(){return Aa.get()}function Ea(e){return Aa.send(e,5e3)}async function qr(e,t=1,n=void 0){const i=await Promise.resolve().then(()=>at);if(!(i.initSlugWorker&&i.initSlugWorker()))throw new Error("slug worker required but unavailable");return await Ea({type:"buildSearchIndex",contentBase:e,indexDepth:t,noIndexing:n})}async function mo(e,t,n){const i=await Promise.resolve().then(()=>at);if(!(i.initSlugWorker&&i.initSlugWorker()))throw new Error("slug worker required but unavailable");return Ea({type:"crawlForSlug",slug:e,base:t,maxQueue:n})}function rt(e,t){if(!e)return;let n=null;try{n=Y(typeof t=="string"?t:String(t||""))}catch{n=String(t||"")}if(n){try{if(st&&st.length){const r=String(n).split("/")[0],a=st.includes(r);let s=V.get(e);if(!s||typeof s=="string")s={default:typeof s=="string"?Y(s):void 0,langs:{}};else try{s.default&&(s.default=Y(s.default))}catch{}a?s.langs[r]=n:s.default=n,V.set(e,s)}else{const i=V.has(e)?V.get(e):void 0;if(!i)V.set(e,n);else{let r=null;try{typeof i=="string"?r=Y(i):i&&typeof i=="object"&&(r=i.default?Y(i.default):null)}catch{r=null}if(r===n)V.set(e,n);else{let a=null,s=2;for(;a=`${e}-${s}`,!!V.has(a);){let o=V.get(a),l=null;try{typeof o=="string"?l=Y(o):o&&typeof o=="object"&&(l=o.default?Y(o.default):null)}catch{l=null}if(l===n){e=a;break}if(s+=1,s>1e4)break}try{if(!V.has(a))V.set(a,n),e=a;else if(V.get(a)===n)e=a;else{const o=new Set;for(const c of V.keys())o.add(c);const l=typeof Xt=="function"?Xt(e,o):`${e}-2`;V.set(l,n),e=l}}catch{}}}}}catch{}try{if(n){try{Z.set(n,e)}catch{}try{if($e&&typeof $e.has=="function"){if(!$e.has(n)){try{$e.add(n)}catch{}try{Array.isArray(Oe)&&!Oe.includes(n)&&Oe.push(n)}catch{}}}else try{Array.isArray(Oe)&&!Oe.includes(n)&&Oe.push(n)}catch{}}catch{}}}catch{}}}const yr=new Set;function yo(e){typeof e=="function"&&yr.add(e)}function bo(e){typeof e=="function"&&yr.delete(e)}const Z=new Map;let Hr={},Oe=[];const $e=new Set;let le="_404.md",ot=null;const Ot="_home";function Ca(e){if(e==null){le=null;return}le=String(e||"")}function Ma(e){if(e==null){ot=null;return}ot=String(e||"");try{try{Sa(Ot,ot)}catch{}}catch{}}function wo(e){Hr=e||{}}function La(e){try{if(Array.isArray(re)||(re=[]),!Array.isArray(e))return;try{Array.isArray(re)||(re=[]),re.length=0;for(const t of e)re.push(t);try{if(typeof window<"u")try{window.__nimbiLiveSearchIndex=re}catch{}}catch{}}catch(t){fe("[slugManager] replacing searchIndex by assignment fallback",t);try{re=Array.from(e)}catch{}}}catch{}}const xn=new Map,lr=new Set;function _o(){xn.clear(),lr.clear()}function ko(e){if(!e||e.length===0)return"";let t=e[0];for(let i=1;i<e.length;i++){const r=e[i];let a=0;const s=Math.min(t.length,r.length);for(;a<s&&t[a]===r[a];)a++;t=t.slice(0,a)}const n=t.lastIndexOf("/");return n===-1?t:t.slice(0,n+1)}const he=dn(function(e){let n=String(e||"").toLowerCase().replace(/[^a-z0-9\- ]/g,"").replace(/ /g,"-");return n=n.replace(/(?:-?)(?:md|html)$/,""),n=n.replace(/-+/g,"-"),n=n.replace(/^-|-$/g,""),n.length>80&&(n=n.slice(0,80).replace(/-+$/g,"")),n},2e3);function ci(e){V.clear(),Z.clear(),Oe=[];try{$e.clear()}catch{}st=st||[];const t=Object.keys(Hr||{});if(!t.length)return;let n="";try{if(e){try{/^[a-z][a-z0-9+.-]*:/i.test(String(e))?n=new URL(String(e)).pathname:n=String(e||"")}catch(i){n=String(e||""),fe("[slugManager] parse contentBase failed",i)}n=Vt(n)}}catch(i){n="",fe("[slugManager] setContentBase prefix derivation failed",i)}n||(n=ko(t));for(const i of t){let r=i;n&&i.startsWith(n)?r=Y(i.slice(n.length)):r=Y(i),Oe.push(r);try{$e.add(r)}catch{}try{Qt()}catch(s){fe("[slugManager] refreshIndexPaths failed",s)}const a=Hr[i];if(typeof a=="string"){const s=(a||"").match(/^#\s+(.+)$/m);if(s&&s[1]){const o=he(s[1].trim());if(o)try{let l=o;if((!st||!st.length)&&(l=Xt(l,new Set(V.keys()))),st&&st.length){const u=r.split("/")[0],g=st.includes(u);let h=V.get(l);(!h||typeof h=="string")&&(h={default:typeof h=="string"?h:void 0,langs:{}}),g?h.langs[u]=r:h.default=r,V.set(l,h)}else V.set(l,r);Z.set(r,l)}catch(l){fe("[slugManager] set slug mapping failed",l)}}}}}try{ci()}catch(e){fe("[slugManager] initial setContentBase failed",e)}function Xt(e,t){if(!t.has(e))return e;let n=2,i=`${e}-${n}`;for(;t.has(i);)n+=1,i=`${e}-${n}`;return i}function xo(e){return Nn(e,void 0)}function Nn(e,t){if(!e)return!1;if(e.startsWith("//"))return!0;if(/^[a-z][a-z0-9+.-]*:/i.test(e)){if(t&&typeof t=="string")try{const n=new URL(e),i=new URL(t);return n.origin!==i.origin?!0:!n.pathname.startsWith(i.pathname)}catch{return!0}return!0}if(e.startsWith("/")&&t&&typeof t=="string")try{const n=new URL(e,t),i=new URL(t);return n.origin!==i.origin?!0:!n.pathname.startsWith(i.pathname)}catch{return!0}return!1}function Yn(e){return e==null?e:String(e).replace(/\\([\\`*_{}\[\]()#+\-.!])/g,(t,n)=>n)}function un(e){if(!e||!V.has(e))return null;const t=V.get(e);if(!t)return null;if(typeof t=="string")return t;if(st&&st.length&&qt&&t.langs&&t.langs[qt])return t.langs[qt];if(t.default)return t.default;if(t.langs){const n=Object.keys(t.langs);if(n.length)return t.langs[n[0]]}return null}const gt=new pr({maxSize:2e3});function So(){gt.clear(),Ht.clear()}const Ht=new pr({maxSize:2e3});let Ta=60*1e3;function vo(e){Ta=Number(e)||0}function Ao(e){try{const t=Math.max(0,Number(e)||0);gt&&typeof gt._maxSize<"u"&&(gt._maxSize=t)}catch{}}function Eo(e){try{const t=Math.max(0,Number(e)||0);gt&&typeof gt._ttlMs<"u"&&(gt._ttlMs=t)}catch{}}function Co(e){try{const t=Math.max(0,Number(e)||0);Ht&&typeof Ht._maxSize<"u"&&(Ht._maxSize=t)}catch{}}let Fr=Math.max(1,Math.min(mr,5));function Mo(e){try{Fr=Math.max(1,Number(e)||1)}catch{Fr=1}}function Sn(){return Fr}let Be=async function(e,t,n){if(!e)throw new Error("path required");try{if(typeof e=="string"&&(e.indexOf("?page=")!==-1||e.startsWith("?")||e.startsWith("#/")||e.indexOf("#/")!==-1))try{const c=Je(e);c&&c.page&&(e=c.page)}catch{}}catch{}try{const c=(String(e||"").match(/([^\/]+)\.md(?:$|[?#])/)||[])[1],u=typeof e=="string"&&String(e).indexOf("/")===-1;if(c&&(u||!1)&&V.has(c)){const h=un(c)||V.get(c);h&&h!==e&&(e=h)}}catch(c){fe("[slugManager] slug mapping normalization failed",c)}try{if(typeof e=="string"&&e.indexOf("::")!==-1){const c=String(e).split("::",1)[0];if(c)try{if(V.has(c)){const u=un(c)||V.get(c);u?e=u:e=c}else e=c}catch{e=c}}}catch(c){fe("[slugManager] path sanitize failed",c)}try{if(t)try{let u=(/^[a-z][a-z0-9+.-]*:/i.test(String(t))?new URL(String(t)):new URL(String(t),typeof location<"u"?location.origin:"http://localhost")).pathname||"";if(u=u.replace(/^\/+|\/+$/g,""),u)try{const g=String(e||"");if(!/^[a-z][a-z0-9+.-]*:/i.test(g)){let h=g.replace(/^\/+/,"");h===u?e="":h.startsWith(u+"/")?e=h.slice(u.length+1):e=h}}catch{}}catch{}}catch{}if(!(n&&n.force===!0||typeof le=="string"&&le||V&&V.size||$e&&$e.size||ni()))throw new Error("failed to fetch md");const r=t==null?"":cn(String(t));let a="";try{const c=typeof location<"u"&&location.origin?location.origin:"http://localhost";let u=c.replace(/\/$/,"")+"/";r&&(/^[a-z][a-z0-9+.-]*:/i.test(r)?u=r.replace(/\/$/,"")+"/":r.startsWith("/")?u=c.replace(/\/$/,"")+r.replace(/\/$/,"")+"/":u=c.replace(/\/$/,"")+"/"+r.replace(/\/$/,"")+"/");try{a=new URL(e.replace(/^\//,""),u).toString()}catch{a=c.replace(/\/$/,"")+"/"+e.replace(/^\//,"")}}catch{a=(typeof location<"u"&&location.origin?location.origin:"http://localhost")+"/"+e.replace(/^\//,"")}const s=n&&n.signal;try{const c=Ht.get(a);if(c&&c>Date.now())return Promise.reject(new Error("failed to fetch md"));c&&Ht.delete(a)}catch{}if(gt.has(a))return gt.get(a);const l=(async()=>{const c=await fetch(a,s?{signal:s}:void 0);if(!c||typeof c.ok!="boolean"||!c.ok){if(c&&c.status===404&&typeof le=="string"&&le)try{const m=`${r}/${le}`,f=await globalThis.fetch(m,s?{signal:s}:void 0);if(f&&typeof f.ok=="boolean"&&f.ok)return{raw:await f.text(),status:404}}catch(m){fe("[slugManager] fetching fallback 404 failed",m)}let p="";try{c&&typeof c.clone=="function"?p=await c.clone().text():c&&typeof c.text=="function"?p=await c.text():p=""}catch(m){p="",fe("[slugManager] reading error body failed",m)}try{const m=c?c.status:void 0;if(m===404)try{k("fetchMarkdown failed (404):",()=>({url:a,status:m,statusText:c?c.statusText:void 0,body:p.slice(0,200)}))}catch{}else try{ir("fetchMarkdown failed:",()=>({url:a,status:m,statusText:c?c.statusText:void 0,body:p.slice(0,200)}))}catch{}}catch{}throw new Error("failed to fetch md")}const u=await c.text(),g=u.trim().slice(0,128).toLowerCase(),h=/^(?:<!doctype|<html|<title|<h1)/.test(g),d=h||String(e||"").toLowerCase().endsWith(".html");if(h&&String(e||"").toLowerCase().endsWith(".md")){try{if(typeof le=="string"&&le){const p=`${r}/${le}`,m=await globalThis.fetch(p,s?{signal:s}:void 0);if(m.ok)return{raw:await m.text(),status:404}}}catch(p){fe("[slugManager] fetching fallback 404 failed",p)}throw go()&&ir("fetchMarkdown: server returned HTML for .md request",a),new Error("failed to fetch md")}return d?{raw:u,isHtml:!0}:{raw:u}})().catch(c=>{if(c&&c.name==="AbortError"){try{gt.delete(a)}catch{}throw c}try{Ht.set(a,Date.now()+Ta)}catch{}try{gt.delete(a)}catch{}throw c});return gt.set(a,l),l};function Lo(e){typeof e=="function"&&(Be=e)}const Jn=new Map;function To(e){if(!e||typeof e!="string")return"";let t=e.replace(/```[\s\S]*?```/g,"");return t=t.replace(/<pre[\s\S]*?<\/pre>/gi,""),t=t.replace(/<code[\s\S]*?<\/code>/gi,""),t=t.replace(/<!--([\s\S]*?)-->/g,""),t=t.replace(/^ {4,}.*$/gm,""),t=t.replace(/`[^`]*`/g,""),t}let re=[];function zo(){return re}try{if(typeof window<"u")try{Object.defineProperty(window,"__nimbiSearchIndex",{get(){return re},enumerable:!0,configurable:!0})}catch{try{window.__nimbiSearchIndex=re}catch{}}}catch{}try{if(typeof window<"u")try{Object.defineProperty(window,"__nimbiIndexReady",{get(){return Dr},enumerable:!0,configurable:!0})}catch{try{window.__nimbiIndexReady=Dr}catch{}}}catch{}let It=null;async function Zt(e,t=1,n=void 0,i=void 0){const r=Array.isArray(n)?Array.from(new Set((n||[]).map(a=>Y(String(a||""))))):[];try{const a=Y(String(le||""));a&&!r.includes(a)&&r.push(a)}catch{}if(re&&re.length&&t===1&&!re.some(s=>{try{return r.includes(Y(String(s.path||"")))}catch{return!1}}))return re;if(It)return It;It=(async()=>{let a=Array.isArray(n)?Array.from(new Set((n||[]).map(f=>Y(String(f||""))))):[];try{const f=Y(String(le||""));f&&!a.includes(f)&&a.push(f)}catch{}const s=f=>{if(!a||!a.length)return!1;for(const w of a)if(w&&(f===w||f.startsWith(w+"/")))return!0;return!1};let o=[];try{if(Array.isArray(i)&&i.length)for(const f of i)try{const w=Y(String(f||""));w&&o.push(w)}catch{}}catch{}if(Array.isArray(Oe)&&Oe.length&&(o=Array.from(Oe)),!o.length){if(Z&&typeof Z.size=="number"&&Z.size)try{o=Array.from(Z.keys())}catch{o=[]}else for(const f of V.values())if(f){if(typeof f=="string")o.push(f);else if(f&&typeof f=="object"){f.default&&o.push(f.default);const w=f.langs||{};for(const y of Object.keys(w||{}))try{w[y]&&o.push(w[y])}catch{}}}}try{const f=await Ia(e);f&&f.length&&(o=o.concat(f))}catch(f){fe("[slugManager] crawlAllMarkdown during buildSearchIndex failed",f)}try{const f=new Set(o),w=[...o],y=Math.max(1,Math.min(Sn(),w.length||Sn()));let _=0;const b=async()=>{for(;!(f.size>On);){const S=w.shift();if(!S)break;try{const E=await Be(S,e);if(E&&E.raw){if(E.status===404)continue;let I=E.raw;const N=[],U=String(S||"").replace(/^.*\//,"");if(/^readme(?:\.md)?$/i.test(U)&&li&&(!S||!S.includes("/")))continue;const z=To(I),O=/\[[^\]]+\]\(([^)]+)\)/g;let W;for(;W=O.exec(z);)N.push(W[1]);const te=/<a\s+[^>]*href=["']([^"']+)["'][^>]*>/gi;for(;W=te.exec(z);)N.push(W[1]);const H=S&&S.includes("/")?S.substring(0,S.lastIndexOf("/")+1):"";for(let L of N)try{if(Nn(L,e)||L.startsWith("..")||L.indexOf("/../")!==-1||(H&&!L.startsWith("./")&&!L.startsWith("/")&&!L.startsWith("../")&&(L=H+L),L=Y(L),!/\.(md|html?)(?:$|[?#])/i.test(L))||(L=L.split(/[?#]/)[0],s(L)))continue;f.has(L)||(f.add(L),w.push(L),o.push(L))}catch(F){fe("[slugManager] href processing failed",L,F)}}}catch(E){fe("[slugManager] discovery fetch failed for",S,E)}try{_++,await Pt(_,32)}catch{}}},A=[];for(let S=0;S<y;S++)A.push(b());await Promise.all(A)}catch(f){fe("[slugManager] discovery loop failed",f)}const l=new Set;o=o.filter(f=>!f||l.has(f)||s(f)?!1:(l.add(f),!0));const c=[],u=new Map,g=o.filter(f=>/\.(?:md|html?)(?:$|[?#])/i.test(f)),h=Math.max(1,Math.min(Sn(),g.length||1)),d=g.slice(),p=[];for(let f=0;f<h;f++)p.push((async()=>{for(;d.length;){const w=d.shift();if(!w)break;try{const y=await Be(w,e);u.set(w,y)}catch(y){fe("[slugManager] buildSearchIndex: entry fetch failed",w,y),u.set(w,null)}}})());await Promise.all(p);let m=0;for(const f of o){try{m++,await Pt(m,16)}catch{}if(/\.(?:md|html?)(?:$|[?#])/i.test(f))try{const w=u.get(f);if(!w||!w.raw||w.status===404)continue;let y="",_="",b=null;if(w.isHtml)try{const S=He(),E=S?S.parseFromString(w.raw,"text/html"):null,I=E?E.querySelector("title")||E.querySelector("h1"):null;I&&I.textContent&&(y=I.textContent.trim());const N=E?E.querySelector("p"):null;if(N&&N.textContent&&(_=N.textContent.trim()),t>=2)try{const U=E?E.querySelector("h1"):null,z=U&&U.textContent?U.textContent.trim():y||"";try{const W=Z&&typeof Z.has=="function"&&Z.has(f)?Z.get(f):null;if(W)b=W;else{let te=he(y||f);const H=new Set;try{for(const F of V.keys())H.add(F)}catch{}try{for(const F of c)F&&F.slug&&H.add(String(F.slug).split("::")[0])}catch{}let L=!1;try{if(V.has(te)){const F=V.get(te);if(typeof F=="string")F===f&&(L=!0);else if(F&&typeof F=="object"){F.default===f&&(L=!0);for(const G of Object.keys(F.langs||{}))if(F.langs[G]===f){L=!0;break}}}}catch{}!L&&H.has(te)&&(te=Xt(te,H)),b=te;try{Z.has(f)||rt(b,f)}catch{}}}catch(W){fe("[slugManager] derive pageSlug failed",W)}const O=Array.from(E.querySelectorAll("h2"));for(const W of O)try{const te=(W.textContent||"").trim();if(!te)continue;const H=W.id?W.id:he(te),L=b?`${b}::${H}`:`${he(f)}::${H}`;let F="",G=W.nextElementSibling;for(;G&&G.tagName&&G.tagName.toLowerCase()==="script";)G=G.nextElementSibling;G&&G.textContent&&(F=String(G.textContent).trim()),c.push({slug:L,title:te,excerpt:F,path:f,parentTitle:z})}catch(te){fe("[slugManager] indexing H2 failed",te)}if(t===3)try{const W=Array.from(E.querySelectorAll("h3"));for(const te of W)try{const H=(te.textContent||"").trim();if(!H)continue;const L=te.id?te.id:he(H),F=b?`${b}::${L}`:`${he(f)}::${L}`;let G="",ie=te.nextElementSibling;for(;ie&&ie.tagName&&ie.tagName.toLowerCase()==="script";)ie=ie.nextElementSibling;ie&&ie.textContent&&(G=String(ie.textContent).trim()),c.push({slug:F,title:H,excerpt:G,path:f,parentTitle:z})}catch(H){fe("[slugManager] indexing H3 failed",H)}}catch(W){fe("[slugManager] collect H3s failed",W)}}catch(U){fe("[slugManager] collect H2s failed",U)}}catch(S){fe("[slugManager] parsing HTML for index failed",S)}else{const S=w.raw,E=S.match(/^#\s+(.+)$/m);y=E?E[1].trim():"";try{y=Yn(y)}catch{}const I=S.split(/\r?\n\s*\r?\n/);if(I.length>1)for(let N=1;N<I.length;N++){const U=I[N].trim();if(U&&!/^#/.test(U)){_=U.replace(/\r?\n/g," ");break}}if(t>=2){let N="";try{const U=(S.match(/^#\s+(.+)$/m)||[])[1];N=U?U.trim():"";try{const W=Z&&typeof Z.has=="function"&&Z.has(f)?Z.get(f):null;if(W)b=W;else{let te=he(y||f);const H=new Set;try{for(const F of V.keys())H.add(F)}catch{}try{for(const F of c)F&&F.slug&&H.add(String(F.slug).split("::")[0])}catch{}let L=!1;try{if(V.has(te)){const F=V.get(te);if(typeof F=="string")F===f&&(L=!0);else if(F&&typeof F=="object"){F.default===f&&(L=!0);for(const G of Object.keys(F.langs||{}))if(F.langs[G]===f){L=!0;break}}}}catch{}!L&&H.has(te)&&(te=Xt(te,H)),b=te;try{Z.has(f)||rt(b,f)}catch{}}}catch(W){fe("[slugManager] derive pageSlug failed",W)}const z=/^##\s+(.+)$/gm;let O;for(;O=z.exec(S);)try{const W=(O[1]||"").trim(),te=Yn(W);if(!W)continue;const H=he(W),L=b?`${b}::${H}`:`${he(f)}::${H}`,G=S.slice(z.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),ie=G&&G[1]?String(G[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";c.push({slug:L,title:te,excerpt:ie,path:f,parentTitle:N})}catch(W){fe("[slugManager] indexing markdown H2 failed",W)}}catch(U){fe("[slugManager] collect markdown H2s failed",U)}if(t===3)try{const U=/^###\s+(.+)$/gm;let z;for(;z=U.exec(S);)try{const O=(z[1]||"").trim(),W=Yn(O);if(!O)continue;const te=he(O),H=b?`${b}::${te}`:`${he(f)}::${te}`,F=S.slice(U.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),G=F&&F[1]?String(F[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";c.push({slug:H,title:W,excerpt:G,path:f,parentTitle:N})}catch(O){fe("[slugManager] indexing markdown H3 failed",O)}}catch(U){fe("[slugManager] collect markdown H3s failed",U)}}}let A="";try{Z.has(f)&&(A=Z.get(f))}catch(S){fe("[slugManager] mdToSlug access failed",S)}if(!A){try{if(!b){const S=Z&&typeof Z.has=="function"&&Z.has(f)?Z.get(f):null;if(S)b=S;else{let E=he(y||f);const I=new Set;try{for(const U of V.keys())I.add(U)}catch{}try{for(const U of c)U&&U.slug&&I.add(String(U.slug).split("::")[0])}catch{}let N=!1;try{if(V.has(E)){const U=V.get(E);if(typeof U=="string")U===f&&(N=!0);else if(U&&typeof U=="object"){U.default===f&&(N=!0);for(const z of Object.keys(U.langs||{}))if(U.langs[z]===f){N=!0;break}}}}catch{}!N&&I.has(E)&&(E=Xt(E,I)),b=E;try{Z.has(f)||rt(b,f)}catch{}}}}catch(S){fe("[slugManager] derive pageSlug failed",S)}A=b||he(y||f)}c.push({slug:A,title:y,excerpt:_,path:f})}catch(w){fe("[slugManager] buildSearchIndex: entry processing failed",w)}}try{const f=c.filter(w=>{try{return!s(String(w.path||""))}catch{return!0}});try{Array.isArray(re)||(re=[]),re.length=0;for(const w of f)re.push(w)}catch{try{re=Array.from(f)}catch{re=f}}try{if(typeof window<"u"){try{window.__nimbiResolvedIndex=re}catch{}try{const w=[],y=new Set;for(const _ of re)try{if(!_||!_.slug)continue;const b=String(_.slug).split("::")[0];if(y.has(b))continue;y.add(b);const A={slug:b};_.title?A.title=String(_.title):_.parentTitle&&(A.title=String(_.parentTitle)),_.path&&(A.path=String(_.path)),w.push(A)}catch{}try{window.__nimbiSitemapJson={generatedAt:new Date().toISOString(),entries:w}}catch{}try{window.__nimbiSitemapFinal=w}catch{}}catch{}}}catch{}}catch(f){fe("[slugManager] filtering index by excludes failed",f);try{Array.isArray(re)||(re=[]),re.length=0;for(const w of c)re.push(w)}catch{try{re=Array.from(c)}catch{re=c}}try{if(typeof window<"u")try{window.__nimbiResolvedIndex=re}catch{}}catch{}}return re})();try{await It}catch(a){fe("[slugManager] awaiting _indexPromise failed",a)}return It=null,re}async function Bt(e={}){try{const t=typeof e.timeoutMs=="number"?e.timeoutMs:8e3,n=e.contentBase,i=typeof e.indexDepth=="number"?e.indexDepth:1,r=Array.isArray(e.noIndexing)?e.noIndexing:void 0,a=Array.isArray(e.seedPaths)?e.seedPaths:void 0,s=typeof e.startBuild=="boolean"?e.startBuild:!0;if(Array.isArray(re)&&re.length&&!It&&!s)return re;if(It){try{await It}catch{}return re}if(s){try{if(typeof qr=="function")try{const l=await qr(n,i,r,a);if(Array.isArray(l)&&l.length){try{La(l)}catch{}return re}}catch{}}catch{}try{return await Zt(n,i,r,a),re}catch{}}const o=Date.now();for(;Date.now()-o<t;){if(Array.isArray(re)&&re.length)return re;await new Promise(l=>setTimeout(l,150))}return re}catch{return re}}async function Dr(e={}){try{const t=Object.assign({},e);typeof t.startBuild!="boolean"&&(t.startBuild=!0),typeof t.timeoutMs!="number"&&(t.timeoutMs=1/0);try{return await Bt(t)}catch{return re}}catch{return re}}const za=1e3;let On=za;function Ro(e){typeof e=="number"&&e>=0&&(On=e)}const Ra=He(),$a="a[href]";let Pa=async function(e,t,n=On){if(Jn.has(e))return Jn.get(e);let i=null;const r=new Set,a=[""],s=typeof location<"u"&&location.origin?location.origin:"http://localhost";let o=s+"/";try{t&&(/^[a-z][a-z0-9+.-]*:/i.test(String(t))?o=String(t).replace(/\/$/,"")+"/":String(t).startsWith("/")?o=s+String(t).replace(/\/$/,"")+"/":o=s+"/"+String(t).replace(/\/$/,"")+"/")}catch{o=s+"/"}const l=Math.max(1,Math.min(mr,6));for(;a.length&&!i&&!(a.length>n);){const c=a.splice(0,l);await Rn(c,async u=>{if(u==null||r.has(u))return;r.add(u);let g="";try{g=new URL(u||"",o).toString()}catch{g=(String(t||"")||s)+"/"+String(u||"").replace(/^\//,"")}try{let h;try{h=await globalThis.fetch(g)}catch(w){fe("[slugManager] crawlForSlug: fetch failed",{url:g,error:w});return}if(!h||!h.ok){h&&!h.ok&&fe("[slugManager] crawlForSlug: directory fetch non-ok",{url:g,status:h.status});return}const d=await h.text(),p=Ra.parseFromString(d,"text/html");let m=[];try{p&&typeof p.getElementsByTagName=="function"?m=p.getElementsByTagName("a"):p&&typeof p.querySelectorAll=="function"?m=p.querySelectorAll($a):m=[]}catch{try{m=p.getElementsByTagName?p.getElementsByTagName("a"):[]}catch{m=[]}}const f=g;for(const w of m)try{if(i)break;let y=w.getAttribute("href")||"";if(!y||Nn(y,t)||y.startsWith("..")||y.indexOf("/../")!==-1)continue;if(y.endsWith("/")){try{const _=new URL(y,f),b=new URL(o).pathname,A=_.pathname.startsWith(b)?_.pathname.slice(b.length):_.pathname.replace(/^\//,""),S=Vt(Y(A));r.has(S)||a.push(S)}catch{const b=Y(u+y);r.has(b)||a.push(b)}continue}if(y.toLowerCase().endsWith(".md")){let _="";try{const b=new URL(y,f),A=new URL(o).pathname;_=b.pathname.startsWith(A)?b.pathname.slice(A.length):b.pathname.replace(/^\//,"")}catch{_=(u+y).replace(/^\//,"")}_=Y(_);try{if(Z.has(_))continue;for(const b of V.values());}catch(b){fe("[slugManager] slug map access failed",b)}try{const b=await Be(_,t);if(b&&b.raw){const A=(b.raw||"").match(/^#\s+(.+)$/m);if(A&&A[1]&&he(A[1].trim())===e){i=_;break}}}catch(b){fe("[slugManager] crawlForSlug: fetchMarkdown failed",b)}}}catch(y){fe("[slugManager] crawlForSlug: link iteration failed",y)}}catch(h){fe("[slugManager] crawlForSlug: directory fetch failed",h)}},l)}return Jn.set(e,i),i};async function Ia(e,t=On){const n=new Set,i=new Set,r=[""],a=typeof location<"u"&&location.origin?location.origin:"http://localhost";let s=a+"/";try{e&&(/^[a-z][a-z0-9+.-]*:/i.test(String(e))?s=String(e).replace(/\/$/,"")+"/":String(e).startsWith("/")?s=a+String(e).replace(/\/$/,"")+"/":s=a+"/"+String(e).replace(/\/$/,"")+"/")}catch{s=a+"/"}const o=Math.max(1,Math.min(mr,6));for(;r.length&&!(r.length>t);){const l=r.splice(0,o);await Rn(l,async c=>{if(c==null||i.has(c))return;i.add(c);let u="";try{u=new URL(c||"",s).toString()}catch{u=(String(e||"")||a)+"/"+String(c||"").replace(/^\//,"")}try{let g;try{g=await globalThis.fetch(u)}catch(f){fe("[slugManager] crawlAllMarkdown: fetch failed",{url:u,error:f});return}if(!g||!g.ok){g&&!g.ok&&fe("[slugManager] crawlAllMarkdown: directory fetch non-ok",{url:u,status:g.status});return}const h=await g.text(),d=Ra.parseFromString(h,"text/html");let p=[];try{d&&typeof d.getElementsByTagName=="function"?p=d.getElementsByTagName("a"):d&&typeof d.querySelectorAll=="function"?p=d.querySelectorAll($a):p=[]}catch{try{p=d.getElementsByTagName?d.getElementsByTagName("a"):[]}catch{p=[]}}const m=u;for(const f of p)try{let w=f.getAttribute("href")||"";if(!w||Nn(w,e)||w.startsWith("..")||w.indexOf("/../")!==-1)continue;if(w.endsWith("/")){try{const _=new URL(w,m),b=new URL(s).pathname,A=_.pathname.startsWith(b)?_.pathname.slice(b.length):_.pathname.replace(/^\//,""),S=Vt(Y(A));i.has(S)||r.push(S)}catch{const b=c+w;i.has(b)||r.push(b)}continue}let y="";try{const _=new URL(w,m),b=new URL(s).pathname;y=_.pathname.startsWith(b)?_.pathname.slice(b.length):_.pathname.replace(/^\//,"")}catch{y=(c+w).replace(/^\//,"")}y=Y(y),/\.(md|html?)$/i.test(y)&&n.add(y)}catch(w){fe("[slugManager] crawlAllMarkdown: link iteration failed",w)}}catch(g){fe("[slugManager] crawlAllMarkdown: directory fetch failed",g)}},o)}return Array.from(n)}async function Na(e,t,n){if(e&&typeof e=="string"&&(e=Y(e),e=cn(e)),V.has(e))return un(e)||V.get(e);try{if(!(typeof le=="string"&&le||V.has(e)||$e&&$e.size||Qt._refreshed||typeof t=="string"&&/^[a-z][a-z0-9+.-]*:\/\//i.test(t)))return null}catch{}for(const r of yr)try{const a=await r(e,t);if(a)return rt(e,a),a}catch(a){fe("[slugManager] slug resolver failed",a)}if($e&&$e.size){if(xn.has(e)){const r=xn.get(e);return rt(e,r),r}for(const r of Oe)if(!lr.has(r))try{const a=await Be(r,t);if(a&&a.raw){const s=(a.raw||"").match(/^#\s+(.+)$/m);if(s&&s[1]){const o=he(s[1].trim());if(lr.add(r),o&&xn.set(o,r),o===e)return rt(e,r),r}}}catch(a){fe("[slugManager] manifest title fetch failed",a)}try{crawlBatchYieldCount++,await Pt(crawlBatchYieldCount,8)}catch{}}try{const r=await Zt(t);if(r&&r.length){const a=r.find(s=>s.slug===e);if(a)return rt(e,a.path),a.path}}catch(r){fe("[slugManager] buildSearchIndex lookup failed",r)}try{const r=await Pa(e,t,n);if(r)return rt(e,r),r}catch(r){fe("[slugManager] crawlForSlug lookup failed",r)}const i=[`${e}.html`,`${e}.md`];for(const r of i)try{const a=await Be(r,t);if(a&&a.raw)return rt(e,r),r}catch(a){fe("[slugManager] candidate fetch failed",a)}if($e&&$e.size)for(const r of Oe)try{const a=r.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(he(a)===e)return rt(e,r),r}catch(a){fe("[slugManager] build-time filename match failed",a)}try{if(ot&&typeof ot=="string"&&ot.trim())try{const r=await Be(ot,t);if(r&&r.raw){const a=(r.raw||"").match(/^#\s+(.+)$/m);if(a&&a[1]&&he(a[1].trim())===e)return rt(e,ot),ot}}catch(r){fe("[slugManager] home page fetch failed",r)}}catch(r){fe("[slugManager] home page fetch failed",r)}return null}const at=Object.freeze(Object.defineProperty({__proto__:null,CRAWL_MAX_QUEUE:za,HOME_SLUG:Ot,_setAllMd:wo,_setSearchIndex:La,_storeSlugMapping:rt,addSlugResolver:yo,get allMarkdownPaths(){return Oe},allMarkdownPathsSet:$e,get availableLanguages(){return st},awaitSearchIndex:Dr,buildSearchIndex:Zt,buildSearchIndexWorker:qr,clearFetchCache:So,clearListCaches:_o,crawlAllMarkdown:Ia,crawlCache:Jn,crawlForSlug:Pa,crawlForSlugWorker:mo,get defaultCrawlMaxQueue(){return On},ensureSlug:Na,fetchCache:gt,get fetchMarkdown(){return Be},getFetchConcurrency:Sn,getLanguages:fo,getSearchIndex:zo,get homePage(){return ot},initSlugWorker:po,isExternalLink:xo,isExternalLinkWithBase:Nn,listPathsFetched:lr,listSlugCache:xn,mdToSlug:Z,negativeFetchCache:Ht,get notFoundPage(){return le},removeSlugResolver:bo,resolveSlugPath:un,get searchIndex(){return re},setContentBase:ci,setDefaultCrawlMaxQueue:Ro,setFetchCacheMaxSize:Ao,setFetchCacheTTL:Eo,setFetchConcurrency:Mo,setFetchMarkdown:Lo,setFetchNegativeCacheTTL:vo,setHomePage:Ma,setLanguages:va,setNegativeFetchCacheMaxSize:Co,setNotFoundPage:Ca,setSkipRootReadme:ho,get skipRootReadme(){return li},slugResolvers:yr,slugToMd:V,slugify:he,unescapeMarkdown:Yn,uniqueSlug:Xt,watchForColdHashRoute:Vn,whenSearchIndexReady:Bt},Symbol.toStringTag,{value:"Module"}));var Rr,Zi;function $o(){if(Zi)return Rr;Zi=1;function e(a,s){return s.some(([o,l])=>o<=a&&a<=l)}function t(a){if(typeof a!="string")return!1;const s=a.charCodeAt(0);return e(s,[[12352,12447],[19968,40959],[44032,55203],[131072,191456]])}function n(a){return` 
...
`;for(let f=l;f<=c;f++)if((t(h[f])||!g(h[f])&&(g(h[f+1])||t(h[f+1])))&&o++,t(h[f]))for(;f<=c&&(i(h[f+1])||g(h[f+1]));)f++;const d=o/u,p=Math.round(d*60*1e3);return{text:Math.ceil(d.toFixed(2))+" min read",minutes:d,time:p,words:o}}return Rr=r,Rr}var Po=$o();const Io=pa(Po),_n=new Map,No=200;function Oo(e){return String(e||"")}function Bo(e,t){if(_n.set(e,t),_n.size>No){const n=_n.keys().next().value;n&&_n.delete(n)}}function jo(e){return e?String(e).trim().split(/\s+/).filter(Boolean).length:0}function qo(e){const t=Oo(e),n=_n.get(t);if(n)return Object.assign({},n);const i=Io(e||""),r=typeof i.words=="number"?i.words:jo(e),a={readingTime:i,wordCount:r};return Bo(t,a),Object.assign({},a)}function $n(e,t){let n=document.querySelector(`meta[name="${e}"]`);n||(n=document.createElement("meta"),n.setAttribute("name",e),document.head.appendChild(n)),n.setAttribute("content",t)}function Rt(e,t,n){let i=`meta[${e}="${t}"]`,r=document.querySelector(i);r||(r=document.createElement("meta"),r.setAttribute(e,t),document.head.appendChild(r)),r.setAttribute("content",n)}function Oa(e,t){try{let n=document.querySelector(`link[rel="${e}"]`);n||(n=document.createElement("link"),n.setAttribute("rel",e),document.head.appendChild(n)),n.setAttribute("href",t)}catch(n){k("[seoManager] upsertLinkRel failed",n)}}function Ho(e,t,n,i){const r=t&&String(t).trim()?t:e.title||document.title;Rt("property","og:title",r);const a=i&&String(i).trim()?i:e.description||"";a&&String(a).trim()&&Rt("property","og:description",a),a&&String(a).trim()&&Rt("name","twitter:description",a),Rt("name","twitter:card",e.twitter_card||"summary_large_image");const s=n||e.image;s&&(Rt("property","og:image",s),Rt("name","twitter:image",s))}function ui(e,t,n,i,r=""){const a=e.meta||{},s=document&&document.querySelector&&document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",o=i&&String(i).trim()?i:a.description&&String(a.description).trim()?a.description:s&&String(s).trim()?s:"";o&&String(o).trim()&&$n("description",o),$n("robots",a.robots||"index,follow"),Ho(a,t,n,o)}function Fo(){try{const e=['meta[name="site"]','meta[name="site-name"]','meta[name="siteName"]','meta[property="og:site_name"]','meta[name="twitter:site"]'];for(const t of e){const n=document.querySelector(t);if(n){const i=n.getAttribute("content")||"";if(i&&i.trim())return i.trim()}}}catch(e){k("[seoManager] getSiteNameFromMeta failed",e)}return""}function hi(e,t,n,i,r,a=""){try{const s=e.meta||{},o=n&&String(n).trim()?n:s.title||a||document.title,l=r&&String(r).trim()?r:s.description||document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",c=i||s.image||null;let u="";try{if(t){const p=Y(t);try{u=(location.origin+location.pathname).split("?")[0]+"?page="+encodeURIComponent(p)}catch{u=location.href.split("#")[0]}}else u=location.href.split("#")[0]}catch(p){u=location.href.split("#")[0],k("[seoManager] compute canonical failed",p)}u&&Oa("canonical",u);try{Rt("property","og:url",u)}catch(p){k("[seoManager] upsertMeta og:url failed",p)}const g={"@context":"https://schema.org","@type":"Article",headline:o||"",description:l||"",url:u||location.href.split("#")[0]};c&&(g.image=String(c)),s.date&&(g.datePublished=s.date),s.dateModified&&(g.dateModified=s.dateModified);const h="nimbi-jsonld";let d=document.getElementById(h);d||(d=document.createElement("script"),d.type="application/ld+json",d.id=h,document.head.appendChild(d)),d.textContent=JSON.stringify(g,null,2)}catch(s){k("[seoManager] setStructuredData failed",s)}}let vn=typeof window<"u"&&window.__SEO_MAP?window.__SEO_MAP:{};function Do(e){try{if(!e||typeof e!="object"){vn={};return}vn=Object.assign({},e)}catch(t){k("[seoManager] setSeoMap failed",t)}}function Uo(e,t=""){try{if(!e)return;const n=vn&&vn[e]?vn[e]:typeof window<"u"&&window.__SEO_MAP&&window.__SEO_MAP[e]?window.__SEO_MAP[e]:null;try{const i=location.origin+location.pathname+"?page="+encodeURIComponent(String(e||""));Oa("canonical",i);try{Rt("property","og:url",i)}catch{}}catch{}if(!n)return;try{n.title&&(document.title=String(n.title))}catch{}try{n.description&&$n("description",String(n.description))}catch{}try{try{ui({meta:n},n.title||void 0,n.image||void 0,n.description||void 0,t)}catch{}}catch{}try{hi({meta:n},e,n.title||void 0,n.image||void 0,n.description||void 0,t)}catch(i){k("[seoManager] inject structured data failed",i)}}catch(n){k("[seoManager] injectSeoForPage failed",n)}}function er(e={},t="",n=void 0,i=void 0){try{const r=e||{},a=typeof n=="string"&&n.trim()?n:r.title||"Not Found",s=typeof i=="string"&&i.trim()?i:r.description||"";try{$n("robots","noindex,follow")}catch{}try{s&&String(s).trim()&&$n("description",String(s))}catch{}try{ui({meta:Object.assign({},r,{robots:"noindex,follow"})},a,r.image||void 0,s)}catch{}try{hi({meta:Object.assign({},r,{title:a,description:s})},t||"",a,r.image||void 0,s)}catch{}}catch(r){k("[seoManager] markNotFound failed",r)}}function Wo(e,t,n,i,r,a,s,o,l,c,u){try{if(i&&i.querySelector){const g=i.querySelector(".menu-label");g&&(g.textContent=o&&o.textContent||e("onThisPage"))}}catch(g){k("[seoManager] update toc label failed",g)}try{const g=n.meta&&n.meta.title?String(n.meta.title).trim():"",h=r.querySelector("img"),d=h&&(h.getAttribute("src")||h.src)||null;let p="";try{let w="";try{const y=o||(r&&r.querySelector?r.querySelector("h1"):null);if(y){let _=y.nextElementSibling;const b=[];for(;_&&!(_.tagName&&_.tagName.toLowerCase()==="h2");){try{if(_.classList&&_.classList.contains("nimbi-article-subtitle")){_=_.nextElementSibling;continue}}catch{}const A=(_.textContent||"").trim();A&&b.push(A),_=_.nextElementSibling}b.length&&(w=b.join(" ").replace(/\s+/g," ").trim()),!w&&l&&(w=String(l).trim())}}catch(y){k("[seoManager] compute descOverride failed",y)}w&&String(w).length>160&&(w=String(w).slice(0,157).trim()+"..."),p=w}catch(w){k("[seoManager] compute descOverride failed",w)}let m="";try{g&&(m=g)}catch{}if(!m)try{o&&o.textContent&&(m=String(o.textContent).trim())}catch{}if(!m)try{const w=r.querySelector("h2");w&&w.textContent&&(m=String(w.textContent).trim())}catch{}m||(m=a||"");try{ui(n,m||void 0,d,p)}catch(w){k("[seoManager] setMetaTags failed",w)}try{hi(n,c,m||void 0,d,p,t)}catch(w){k("[seoManager] setStructuredData failed",w)}const f=Fo();m?f?document.title=`${f} - ${m}`:document.title=`${t||"Site"} - ${m}`:g?document.title=g:document.title=t||document.title}catch(g){k("[seoManager] applyPageMeta failed",g)}try{try{const g=r.querySelectorAll(".nimbi-reading-time");g&&g.forEach(h=>h.remove())}catch{}if(l){const g=qo(u.raw||""),h=g&&g.readingTime?g.readingTime:null,d=h&&typeof h.minutes=="number"?Math.ceil(h.minutes):0,p=d?e("readingTime",{minutes:d}):"";if(!p)return;const m=r.querySelector("h1");if(m){const f=r.querySelector(".nimbi-article-subtitle");try{if(f){const w=document.createElement("span");w.className="nimbi-reading-time",w.textContent=p,f.appendChild(w)}else{const w=document.createElement("p");w.className="nimbi-article-subtitle is-6 has-text-grey-light";const y=document.createElement("span");y.className="nimbi-reading-time",y.textContent=p,w.appendChild(y);try{m.parentElement.insertBefore(w,m.nextSibling)}catch{try{m.insertAdjacentElement("afterend",w)}catch{}}}}catch{try{const y=document.createElement("p");y.className="nimbi-article-subtitle is-6 has-text-grey-light";const _=document.createElement("span");_.className="nimbi-reading-time",_.textContent=p,y.appendChild(_),m.insertAdjacentElement("afterend",y)}catch{}}}}}catch(g){k("[seoManager] reading time update failed",g)}}let Ba=100;function Gi(e){Ba=e}function ut(){try{if(en(2))return!0}catch{}try{return!1}catch{return!1}}let An=300*1e3,mn=null;function ht(e,t,n){try{if(typeof Be=="function"&&typeof Be.length=="number"&&Be.length>=3)return Be(e,t,{signal:n})}catch{}return Be(e,t)}function Qi(e){An=e}const yt=new Map;function Zo(e){if(!yt.has(e))return;const t=yt.get(e),n=Date.now();if(t.ts+An<n){yt.delete(e);return}return yt.delete(e),yt.set(e,t),t.value}function Go(e,t){if(Xi(),Xi(),yt.delete(e),yt.set(e,{value:t,ts:Date.now()}),yt.size>Ba){const n=yt.keys().next().value;n!==void 0&&yt.delete(n)}}function Xi(){if(!An||An<=0)return;const e=Date.now();for(const[t,n]of yt.entries())n.ts+An<e&&yt.delete(t)}async function Qo(e,t,n){const i=new Set(it);let r=[];try{if(typeof document<"u"&&document.getElementsByClassName){const a=s=>{const o=document.getElementsByClassName(s);for(let l=0;l<o.length;l++){const c=o[l].getElementsByTagName("a");for(let u=0;u<c.length;u++)r.push(c[u])}};a("nimbi-site-navbar"),a("navbar"),a("nimbi-nav")}else r=Array.from(document.querySelectorAll(".nimbi-site-navbar a, .navbar a, .nimbi-nav a"))}catch{try{r=Array.from(document.querySelectorAll(".nimbi-site-navbar a, .navbar a, .nimbi-nav a"))}catch{r=[]}}for(const a of Array.from(r||[])){const s=a.getAttribute("href")||"";if(s)try{try{const h=Je(s);if(h){if(h.type==="canonical"&&h.page){const d=Y(h.page);if(d){i.add(d);continue}}if(h.type==="cosmetic"&&h.page){const d=h.page;if(V.has(d)){const p=V.get(d);if(p)return p}continue}}}catch{}const o=new URL(s,location.href);if(o.origin!==location.origin)continue;const l=(o.hash||o.pathname).match(/([^#?]+\.md)(?:$|[?#])/)||(o.pathname||"").match(/([^#?]+\.md)(?:$|[?#])/);if(l){let h=Y(l[1]);h&&i.add(h);continue}const c=(a.textContent||"").trim(),u=(o.pathname||"").replace(/^.*\//,"");if(c&&he(c)===e||u&&he(u.replace(/\.(html?|md)$/i,""))===e)return o.toString();if(/\.(html?)$/i.test(o.pathname)){let h=o.pathname.replace(/^\//,"");i.add(h);continue}const g=o.pathname||"";if(g){const h=new URL(t),d=Vt(h.pathname);if(g.indexOf(d)!==-1){let p=g.startsWith(d)?g.slice(d.length):g;p=Y(p),p&&i.add(p)}}}catch(o){k("[router] malformed URL while discovering index candidates",o)}}for(const a of i)try{if(!a||!String(a).includes(".md"))continue;const s=await ht(a,t,n);if(!s||!s.raw)continue;const o=(s.raw||"").match(/^#\s+(.+)$/m);if(o){const l=(o[1]||"").trim();if(l&&he(l)===e)return a}}catch(s){k("[router] fetchMarkdown during index discovery failed",s)}return null}function Xo(e){const t=[];if(String(e).includes(".md")||String(e).includes(".html"))/index\.html$/i.test(e)||t.push(e);else try{const n=decodeURIComponent(String(e||""));if(V.has(n)){const i=un(n)||V.get(n);i&&(/\.(md|html?)$/i.test(i)?/index\.html$/i.test(i)||t.push(i):(t.push(i),t.push(i+".html")))}else{if(it&&it.size)for(const i of it){const r=i.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(he(r)===n&&!/index\.html$/i.test(i)){t.push(i);break}}!t.length&&n&&!/\.(md|html?)$/i.test(n)&&(t.push(n+".html"),t.push(n+".md"))}}catch(n){k("[router] buildPageCandidates failed during slug handling",n)}return t}async function Ko(e,t){const n=e||"";try{try{fa("fetchPageData")}catch{}try{ga("fetchPageData")}catch{}}catch{}try{if(mn&&typeof mn.abort=="function")try{mn.abort()}catch{}}catch{}mn=typeof AbortController<"u"?new AbortController:null;const i=mn;let r=null;try{const y=Je(typeof location<"u"?location.href:"");y&&y.anchor&&(r=y.anchor)}catch{try{r=location&&location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null}catch{r=null}}let a=e||"";try{(!a||String(a).trim()==="")&&typeof ot=="string"&&ot&&(a=String(ot))}catch{}let s=null;const o=String(n||"").includes(".md")||String(n||"").includes(".html");if(a&&String(a).includes("::")){const y=String(a).split("::",2);a=y[0],s=y[1]||null}const c=`${e}|||${typeof no<"u"&&qt?qt:""}`,u=Zo(c);if(u)a=u.resolved,s=u.anchor||s;else{if(!String(a).includes(".md")&&!String(a).includes(".html")){let y=decodeURIComponent(String(a||""));if(y&&typeof y=="string"&&(y=Y(y),y=cn(y)),V.has(y))a=un(y)||V.get(y);else{let _=await Qo(y,t,i?i.signal:void 0);if(_)a=_;else if(Qt._refreshed&&it&&it.size||typeof t=="string"&&/^[a-z][a-z0-9+.-]*:\/\//i.test(t)){const b=await Na(y,t);b&&(a=b)}}}Go(c,{resolved:a,anchor:s})}let g=!0;try{const y=String(a||"").includes(".md")||String(a||"").includes(".html")||a&&(a.startsWith("http://")||a.startsWith("https://")||a.startsWith("/"));g=typeof le=="string"&&le||V.has(a)||it&&it.size||Qt._refreshed||o||y}catch{g=!0}!s&&r&&(s=r);try{if(g&&a&&(a.startsWith("http://")||a.startsWith("https://")||a.startsWith("/"))){const y=a.startsWith("/")?new URL(a,location.origin).toString():a;try{const _=await fetch(y,i?{signal:i.signal}:void 0);if(_&&_.ok){const b=await _.text(),A=_&&_.headers&&typeof _.headers.get=="function"&&_.headers.get("content-type")||"",S=(b||"").toLowerCase();if(A&&A.indexOf&&A.indexOf("text/html")!==-1||S.indexOf("<!doctype")!==-1||S.indexOf("<html")!==-1){if(!o)try{let N=y;try{N=new URL(y).pathname.replace(/^\//,"")}catch{N=String(y||"").replace(/^\//,"")}const U=N.replace(/\.html$/i,".md");try{const z=await ht(U,t,i?i.signal:void 0);if(z&&z.raw)return{data:z,pagePath:U,anchor:s}}catch{}if(typeof le=="string"&&le)try{const z=await ht(le,t,i?i.signal:void 0);if(z&&z.raw){try{er(z.meta||{},le)}catch{}return{data:z,pagePath:le,anchor:s}}}catch{}try{w=new Error("site shell detected (absolute fetch)")}catch{}}catch{}if(S.indexOf('<div id="app"')!==-1||S.indexOf("nimbi-cms")!==-1||S.indexOf("nimbi-mount")!==-1||S.indexOf("nimbi-")!==-1||S.indexOf("initcms(")!==-1||S.indexOf("window.nimbi")!==-1||/\bnimbi\b/.test(S))try{let N=y;try{N=new URL(y).pathname.replace(/^\//,"")}catch{N=String(y||"").replace(/^\//,"")}const U=N.replace(/\.html$/i,".md");try{const z=await ht(U,t,i?i.signal:void 0);if(z&&z.raw)return{data:z,pagePath:U,anchor:s}}catch{}if(typeof le=="string"&&le)try{const z=await ht(le,t,i?i.signal:void 0);if(z&&z.raw){try{er(z.meta||{},le)}catch{}return{data:z,pagePath:le,anchor:s}}}catch{}try{w=new Error("site shell detected (absolute fetch)")}catch{}}catch{}}}}catch{}}}catch{}const h=Xo(a);try{if(ut())try{jt("[router-debug] fetchPageData candidates",{originalRaw:n,resolved:a,pageCandidates:h})}catch{}}catch{}const d=String(n||"").includes(".md")||String(n||"").includes(".html");let p=null;if(!d)try{let y=decodeURIComponent(String(n||""));y=Y(y),y=cn(y),y&&!/\.(md|html?)$/i.test(y)&&(p=y)}catch{p=null}if(d&&h.length===0&&(String(a).includes(".md")||String(a).includes(".html"))&&h.push(a),h.length===0&&(String(a).includes(".md")||String(a).includes(".html"))&&h.push(a),h.length===1&&/index\.html$/i.test(h[0])&&!d&&!V.has(a)&&!V.has(decodeURIComponent(String(a||"")))&&!String(a||"").includes("/"))throw new Error("Unknown slug: index.html fallback prevented");let m=null,f=null,w=null;try{const y=String(a||"").includes(".md")||String(a||"").includes(".html")||a&&(a.startsWith("http://")||a.startsWith("https://")||a.startsWith("/"));g=typeof le=="string"&&le||V.has(a)||it&&it.size||Qt._refreshed||d||y}catch{g=!0}if(!g)w=new Error("no page data");else for(const y of h)if(y)try{const _=Y(y);if(m=await ht(_,t,i?i.signal:void 0),f=_,p&&!V.has(p))try{let b="";if(m&&m.isHtml)try{const A=He();if(A){const S=A.parseFromString(m.raw||"","text/html"),E=S.querySelector("h1")||S.querySelector("title");E&&E.textContent&&(b=E.textContent.trim())}}catch{}else{const A=(m&&m.raw||"").match(/^#\s+(.+)$/m);A&&A[1]&&(b=A[1].trim())}if(b&&he(b)!==p)try{if(/\.html$/i.test(_)){const S=_.replace(/\.html$/i,".md");if(h.includes(S))try{const E=await ht(S,t,i?i.signal:void 0);if(E&&E.raw)m=E,f=S;else if(typeof le=="string"&&le)try{const I=await ht(le,t,i?i.signal:void 0);if(I&&I.raw)m=I,f=le;else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{m=null,f=null,w=new Error("slug mismatch for candidate");continue}else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{try{const I=await ht(le,t,i?i.signal:void 0);if(I&&I.raw)m=I,f=le;else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}else{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{m=null,f=null,w=new Error("slug mismatch for candidate");continue}}catch{}try{if(!d&&/\.html$/i.test(_)){const b=_.replace(/\.html$/i,".md");if(h.includes(b))try{const S=String(m&&m.raw||"").trim().slice(0,128).toLowerCase();if(m&&m.isHtml||/^(?:<!doctype|<html|<title|<h1)/i.test(S)||S.indexOf('<div id="app"')!==-1||S.indexOf("nimbi-")!==-1||S.indexOf("nimbi")!==-1||S.indexOf("initcms(")!==-1){let I=!1;try{const N=await ht(b,t,i?i.signal:void 0);if(N&&N.raw)m=N,f=b,I=!0;else if(typeof le=="string"&&le)try{const U=await ht(le,t,i?i.signal:void 0);U&&U.raw&&(m=U,f=le,I=!0)}catch{}}catch{try{const U=await ht(le,t,i?i.signal:void 0);U&&U.raw&&(m=U,f=le,I=!0)}catch{}}if(!I){m=null,f=null,w=new Error("site shell detected (candidate HTML rejected)");continue}}}catch{}}}catch{}try{if(ut())try{jt("[router-debug] fetchPageData accepted candidate",{candidate:_,pagePath:f,isHtml:m&&m.isHtml,snippet:m&&m.raw?String(m.raw).slice(0,160):null})}catch{}}catch{}break}catch(_){w=_;try{ut()&&k("[router] candidate fetch failed",{candidate:y,contentBase:t,err:_&&_.message||_})}catch{}}if(!m){const y=w&&(w.message||String(w))||null,_=y&&/failed to fetch md|site shell detected/i.test(y);try{if(ut())try{jt("[router-debug] fetchPageData no data",{originalRaw:n,resolved:a,pageCandidates:h,fetchError:y})}catch{}}catch{}if(_)try{if(ut())try{k("[router] fetchPageData: no page data (expected)",{originalRaw:n,resolved:a,pageCandidates:h,contentBase:t,fetchError:y})}catch{}}catch{}else try{if(ut())try{ir("[router] fetchPageData: no page data for",{originalRaw:n,resolved:a,pageCandidates:h,contentBase:t,fetchError:y})}catch{}}catch{}if(typeof le=="string"&&le)try{const b=await ht(le,t,i?i.signal:void 0);if(b&&b.raw){try{er(b.meta||{},le)}catch{}return{data:b,pagePath:le,anchor:s}}}catch{}try{if(d&&String(n||"").toLowerCase().includes(".html"))try{const b=new URL(String(n||""),location.href).toString();ut()&&k("[router] attempting absolute HTML fetch fallback",b);const A=await fetch(b,i?{signal:i.signal}:void 0);if(A&&A.ok){const S=await A.text(),E=A&&A.headers&&typeof A.headers.get=="function"&&A.headers.get("content-type")||"",I=(S||"").toLowerCase(),N=E&&E.indexOf&&E.indexOf("text/html")!==-1||I.indexOf("<!doctype")!==-1||I.indexOf("<html")!==-1;if(!N&&ut())try{k("[router] absolute fetch returned non-HTML",()=>({abs:b,contentType:E,snippet:I.slice(0,200)}))}catch{}if(N){const U=(S||"").toLowerCase();if(/<title>\s*index of\b/i.test(S)||/<h1>\s*index of\b/i.test(S)||U.indexOf("parent directory")!==-1||/<title>\s*directory listing/i.test(S)||/<h1>\s*directory listing/i.test(S))try{ut()&&k("[router] absolute fetch returned directory listing; treating as not found",{abs:b})}catch{}else try{const O=b,W=new URL(".",O).toString();try{const H=He();if(H){const L=H.parseFromString(S||"","text/html"),F=(J,ze)=>{try{const xe=ze.getAttribute(J)||"";if(!xe||/^(https?:)?\/\//i.test(xe)||xe.startsWith("/")||xe.startsWith("#"))return;try{const Se=new URL(xe,O).toString();ze.setAttribute(J,Se)}catch(Se){k("[router] rewrite attribute failed",J,Se)}}catch(xe){k("[router] rewrite helper failed",xe)}},G=L.querySelectorAll("[src],[href],[srcset],[xlink:href],[poster]"),ie=[];for(const J of Array.from(G||[]))try{const ze=J.tagName?J.tagName.toLowerCase():"";if(ze==="a")continue;if(J.hasAttribute("src")){const xe=J.getAttribute("src");F("src",J);const Se=J.getAttribute("src");xe!==Se&&ie.push({attr:"src",tag:ze,before:xe,after:Se})}if(J.hasAttribute("href")&&ze==="link"){const xe=J.getAttribute("href");F("href",J);const Se=J.getAttribute("href");xe!==Se&&ie.push({attr:"href",tag:ze,before:xe,after:Se})}if(J.hasAttribute("href")&&ze!=="link"){const xe=J.getAttribute("href");F("href",J);const Se=J.getAttribute("href");xe!==Se&&ie.push({attr:"href",tag:ze,before:xe,after:Se})}if(J.hasAttribute("xlink:href")){const xe=J.getAttribute("xlink:href");F("xlink:href",J);const Se=J.getAttribute("xlink:href");xe!==Se&&ie.push({attr:"xlink:href",tag:ze,before:xe,after:Se})}if(J.hasAttribute("poster")){const xe=J.getAttribute("poster");F("poster",J);const Se=J.getAttribute("poster");xe!==Se&&ie.push({attr:"poster",tag:ze,before:xe,after:Se})}if(J.hasAttribute("srcset")){const Ee=(J.getAttribute("srcset")||"").split(",").map(Fe=>Fe.trim()).filter(Boolean).map(Fe=>{const[R,P]=Fe.split(/\s+/,2);if(!R||/^(https?:)?\/\//i.test(R)||R.startsWith("/"))return Fe;try{const C=new URL(R,O).toString();return P?`${C} ${P}`:C}catch{return Fe}}).join(", ");J.setAttribute("srcset",Ee)}}catch{}const pe=L.documentElement&&L.documentElement.outerHTML?L.documentElement.outerHTML:S;try{ut()&&ie&&ie.length&&k("[router] rewritten asset refs",{abs:b,rewritten:ie})}catch{}return{data:{raw:pe,isHtml:!0},pagePath:String(n||""),anchor:s}}}catch{}let te=S;return/<base\s+[^>]*>/i.test(S)||(/<head[^>]*>/i.test(S)?te=S.replace(/(<head[^>]*>)/i,`$1<base href="${W}">`):te=`<base href="${W}">`+S),{data:{raw:te,isHtml:!0},pagePath:String(n||""),anchor:s}}catch{return{data:{raw:S,isHtml:!0},pagePath:String(n||""),anchor:s}}}}}catch(b){ut()&&k("[router] absolute HTML fetch fallback failed",b)}}catch{}try{const b=decodeURIComponent(String(a||""));if(b&&!/\.(md|html?)$/i.test(b)&&typeof le=="string"&&le&&ut()){const S=[`/assets/${b}.html`,`/assets/${b}/index.html`];for(const E of S)try{const I=await fetch(E,Object.assign({method:"GET"},i?{signal:i.signal}:{}));if(I&&I.ok)return{data:{raw:await I.text(),isHtml:!0},pagePath:E.replace(/^\//,""),anchor:s}}catch{}}}catch(b){ut()&&k("[router] assets fallback failed",b)}throw new Error("no page data")}return{data:m,pagePath:f,anchor:s}}function br(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Ft=br();function ja(e){Ft=e}var Wt={exec:()=>null};function Te(e,t=""){let n=typeof e=="string"?e:e.source,i={replace:(r,a)=>{let s=typeof a=="string"?a:a.source;return s=s.replace(lt.caret,"$1"),n=n.replace(r,s),i},getRegex:()=>new RegExp(n,t)};return i}var Vo=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),lt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}>`)},Yo=/^(?:[ \t]*(?:\n|$))+/,Jo=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,el=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Bn=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,tl=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,di=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,qa=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Ha=Te(qa).replace(/bull/g,di).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),nl=Te(qa).replace(/bull/g,di).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),fi=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,rl=/^[^\n]+/,gi=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,il=Te(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",gi).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),al=Te(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,di).getRegex(),wr="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",pi=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,sl=Te("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",pi).replace("tag",wr).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Fa=Te(fi).replace("hr",Bn).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",wr).getRegex(),ol=Te(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Fa).getRegex(),mi={blockquote:ol,code:Jo,def:il,fences:el,heading:tl,hr:Bn,html:sl,lheading:Ha,list:al,newline:Yo,paragraph:Fa,table:Wt,text:rl},Ki=Te("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Bn).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",wr).getRegex(),ll={...mi,lheading:nl,table:Ki,paragraph:Te(fi).replace("hr",Bn).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Ki).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",wr).getRegex()},cl={...mi,html:Te(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",pi).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Wt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:Te(fi).replace("hr",Bn).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Ha).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},ul=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,hl=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Da=/^( {2,}|\\)\n(?!\s*$)/,dl=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,_r=/[\p{P}\p{S}]/u,yi=/[\s\p{P}\p{S}]/u,Ua=/[^\s\p{P}\p{S}]/u,fl=Te(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,yi).getRegex(),Wa=/(?!~)[\p{P}\p{S}]/u,gl=/(?!~)[\s\p{P}\p{S}]/u,pl=/(?:[^\s\p{P}\p{S}]|~)/u,Za=/(?![*_])[\p{P}\p{S}]/u,ml=/(?![*_])[\s\p{P}\p{S}]/u,yl=/(?:[^\s\p{P}\p{S}]|[*_])/u,bl=Te(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Vo?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Ga=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,wl=Te(Ga,"u").replace(/punct/g,_r).getRegex(),_l=Te(Ga,"u").replace(/punct/g,Wa).getRegex(),Qa="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",kl=Te(Qa,"gu").replace(/notPunctSpace/g,Ua).replace(/punctSpace/g,yi).replace(/punct/g,_r).getRegex(),xl=Te(Qa,"gu").replace(/notPunctSpace/g,pl).replace(/punctSpace/g,gl).replace(/punct/g,Wa).getRegex(),Sl=Te("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Ua).replace(/punctSpace/g,yi).replace(/punct/g,_r).getRegex(),vl=Te(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,Za).getRegex(),Al="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",El=Te(Al,"gu").replace(/notPunctSpace/g,yl).replace(/punctSpace/g,ml).replace(/punct/g,Za).getRegex(),Cl=Te(/\\(punct)/,"gu").replace(/punct/g,_r).getRegex(),Ml=Te(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Ll=Te(pi).replace("(?:-->|$)","-->").getRegex(),Tl=Te("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Ll).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),cr=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,zl=Te(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",cr).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Xa=Te(/^!?\[(label)\]\[(ref)\]/).replace("label",cr).replace("ref",gi).getRegex(),Ka=Te(/^!?\[(ref)\](?:\[\])?/).replace("ref",gi).getRegex(),Rl=Te("reflink|nolink(?!\\()","g").replace("reflink",Xa).replace("nolink",Ka).getRegex(),Vi=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,bi={_backpedal:Wt,anyPunctuation:Cl,autolink:Ml,blockSkip:bl,br:Da,code:hl,del:Wt,delLDelim:Wt,delRDelim:Wt,emStrongLDelim:wl,emStrongRDelimAst:kl,emStrongRDelimUnd:Sl,escape:ul,link:zl,nolink:Ka,punctuation:fl,reflink:Xa,reflinkSearch:Rl,tag:Tl,text:dl,url:Wt},$l={...bi,link:Te(/^!?\[(label)\]\((.*?)\)/).replace("label",cr).getRegex(),reflink:Te(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",cr).getRegex()},Ur={...bi,emStrongRDelimAst:xl,emStrongLDelim:_l,delLDelim:vl,delRDelim:El,url:Te(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Vi).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:Te(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Vi).getRegex()},Pl={...Ur,br:Te(Da).replace("{2,}","*").getRegex(),text:Te(Ur.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Gn={normal:mi,gfm:ll,pedantic:cl},yn={normal:bi,gfm:Ur,breaks:Pl,pedantic:$l},Il={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Yi=e=>Il[e];function xt(e,t){if(t){if(lt.escapeTest.test(e))return e.replace(lt.escapeReplace,Yi)}else if(lt.escapeTestNoEncode.test(e))return e.replace(lt.escapeReplaceNoEncode,Yi);return e}function Ji(e){try{e=encodeURI(e).replace(lt.percentDecode,"%")}catch{return null}return e}function ea(e,t){let n=e.replace(lt.findPipe,(a,s,o)=>{let l=!1,c=s;for(;--c>=0&&o[c]==="\\";)l=!l;return l?"|":" |"}),i=n.split(lt.splitPipe),r=0;if(i[0].trim()||i.shift(),i.length>0&&!i.at(-1)?.trim()&&i.pop(),t)if(i.length>t)i.splice(t);else for(;i.length<t;)i.push("");for(;r<i.length;r++)i[r]=i[r].trim().replace(lt.slashPipe,"|");return i}function bn(e,t,n){let i=e.length;if(i===0)return"";let r=0;for(;r<i&&e.charAt(i-r-1)===t;)r++;return e.slice(0,i-r)}function Nl(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let i=0;i<e.length;i++)if(e[i]==="\\")i++;else if(e[i]===t[0])n++;else if(e[i]===t[1]&&(n--,n<0))return i;return n>0?-2:-1}function Ol(e,t=0){let n=t,i="";for(let r of e)if(r==="	"){let a=4-n%4;i+=" ".repeat(a),n+=a}else i+=r,n++;return i}function ta(e,t,n,i,r){let a=t.href,s=t.title||null,o=e[1].replace(r.other.outputLinkReplace,"$1");i.state.inLink=!0;let l={type:e[0].charAt(0)==="!"?"image":"link",raw:n,href:a,title:s,text:o,tokens:i.inlineTokens(o)};return i.state.inLink=!1,l}function Bl(e,t,n){let i=e.match(n.other.indentCodeCompensation);if(i===null)return t;let r=i[1];return t.split(`
...
`;onmessage=async e=>{const t=e.data||{};try{if(t.type==="rewriteAnchors"){const{id:n,html:i,contentBase:r,pagePath:a}=t;try{const s=He();if(!s)postMessage({id:n,result:i});else{const o=s.parseFromString(i||"","text/html"),l=o.body;await Si(l,r,a,{canonical:!0}),postMessage({id:n,result:o.body.innerHTML})}}catch(s){postMessage({id:n,error:String(s)})}return}}catch(n){postMessage({id:t.id,error:String(n)})}};async function ns(e){try{if(e&&e.type==="rewriteAnchors"){const{id:t,html:n,contentBase:i,pagePath:r}=e;try{const a=He();if(!a)return{id:t,result:n};const s=a.parseFromString(n||"","text/html"),o=s.body;return await Si(o,i,r,{canonical:!0}),{id:t,result:s.body.innerHTML}}catch(a){return{id:t,error:String(a)}}}return{id:e&&e.id,error:"unsupported message"}}catch(t){return{id:e&&e.id,error:String(t)}}}const sc=Object.freeze(Object.defineProperty({__proto__:null,handleAnchorWorkerMessage:ns},Symbol.toStringTag,{value:"Module"}));function ft(e,t=null){try{const n=typeof location<"u"&&location&&typeof location.pathname=="string"&&location.pathname||"/";return String(n)+Fi(e,t)}catch{return Fi(e,t)}}function oc(...e){try{k(...e)}catch{}}function fr(e){try{if(en(3))return!0}catch{}try{if(typeof le=="string"&&le)return!0}catch{}try{if(V&&V.size)return!0}catch{}try{if($e&&$e.size)return!0}catch{}return!1}function vt(e,t){try{if(typeof rt=="function")try{rt(e,t);return}catch{}}catch{}try{e&&t&&V&&typeof V.set=="function"&&!V.has(e)&&V.set(e,t)}catch{}try{t&&Z&&typeof Z.set=="function"&&Z.set(t,e)}catch{}try{if($e&&typeof $e.has=="function"){if(!$e.has(t)){try{$e.add(t)}catch{}try{Array.isArray(Oe)&&!Oe.includes(t)&&Oe.push(t)}catch{}}}else try{Array.isArray(Oe)&&!Oe.includes(t)&&Oe.push(t)}catch{}}catch{}}function lc(e,t){try{return new URL(e,t).pathname}catch{try{return new URL(e,typeof location<"u"?location.href:"http://localhost/").pathname}catch{try{return(String(t||"").replace(/\/$/,"")+"/"+String(e||"").replace(/^\//,"")).replace(/\/\\+/g,"/")}catch{return String(e||"")}}}}function Vr(e,t){try{if(!e)return e;if(!t)return String(e||"");const n=String(t||"").replace(/^\/+|\/+$/g,"");if(!n)return String(e||"");let i=String(e||"");i=i.replace(/^\/+/,"");const r=n+"/";for(;i.startsWith(r);)i=i.slice(r.length);return i===n?"":i}catch{return String(e||"")}}function cc(e,t){const n=document.createElement("aside");n.className="menu box nimbi-nav";const i=document.createElement("p");i.className="menu-label",i.textContent=e("navigation"),n.appendChild(i);const r=document.createElement("ul");r.className="menu-list";try{const a=document.createDocumentFragment();t.forEach(s=>{const o=document.createElement("li"),l=document.createElement("a");try{const c=String(s.path||"");try{l.setAttribute("href",Pe(c))}catch{c&&c.indexOf("/")===-1?l.setAttribute("href","#"+encodeURIComponent(c)):l.setAttribute("href",ft(c))}}catch{l.setAttribute("href","#"+s.path)}if(l.textContent=s.name,o.appendChild(l),s.children&&s.children.length){const c=document.createElement("ul");s.children.forEach(u=>{const g=document.createElement("li"),h=document.createElement("a");try{const d=String(u.path||"");try{h.setAttribute("href",Pe(d))}catch{d&&d.indexOf("/")===-1?h.setAttribute("href","#"+encodeURIComponent(d)):h.setAttribute("href",ft(d))}}catch{h.setAttribute("href","#"+u.path)}h.textContent=u.name,g.appendChild(h),c.appendChild(g)}),o.appendChild(c)}a.appendChild(o)}),r.appendChild(a)}catch{t.forEach(s=>{try{const o=document.createElement("li"),l=document.createElement("a");try{const c=String(s.path||"");try{l.setAttribute("href",Pe(c))}catch{c&&c.indexOf("/")===-1?l.setAttribute("href","#"+encodeURIComponent(c)):l.setAttribute("href",ft(c))}}catch{l.setAttribute("href","#"+s.path)}if(l.textContent=s.name,o.appendChild(l),s.children&&s.children.length){const c=document.createElement("ul");s.children.forEach(u=>{const g=document.createElement("li"),h=document.createElement("a");try{const d=String(u.path||"");try{h.setAttribute("href",Pe(d))}catch{d&&d.indexOf("/")===-1?h.setAttribute("href","#"+encodeURIComponent(d)):h.setAttribute("href",ft(d))}}catch{h.setAttribute("href","#"+u.path)}h.textContent=u.name,g.appendChild(h),c.appendChild(g)}),o.appendChild(c)}r.appendChild(o)}catch(o){k("[htmlBuilder] createNavTree item failed",o)}})}return n.appendChild(r),n}function uc(e,t,n=""){const i=document.createElement("aside");i.className="menu box nimbi-toc-inner is-hidden-mobile";const r=document.createElement("p");r.className="menu-label",r.textContent=e("onThisPage"),i.appendChild(r);const a=document.createElement("ul");a.className="menu-list";try{const o={};(t||[]).forEach(l=>{try{if(!l||l.level===1)return;const c=Number(l.level)>=2?Number(l.level):2,u=document.createElement("li"),g=document.createElement("a"),h=uo(l.text||""),d=l.id||he(h);g.textContent=h;try{const w=String(n||"").replace(/^[\\.\\/]+/,""),y=w&&Z&&Z.has&&Z.has(w)?Z.get(w):w;y?g.href=Pe(y,d):g.href=`#${encodeURIComponent(d)}`}catch(w){k("[htmlBuilder] buildTocElement href normalization failed",w),g.href=`#${encodeURIComponent(d)}`}if(u.appendChild(g),c===2){a.appendChild(u),o[2]=u,Object.keys(o).forEach(w=>{Number(w)>2&&delete o[w]});return}let p=c-1;for(;p>2&&!o[p];)p--;p<2&&(p=2);let m=o[p];if(!m){a.appendChild(u),o[c]=u;return}let f=m.querySelector("ul");f||(f=document.createElement("ul"),m.appendChild(f)),f.appendChild(u),o[c]=u}catch(c){k("[htmlBuilder] buildTocElement item failed",c,l)}})}catch(o){k("[htmlBuilder] buildTocElement failed",o)}return i.appendChild(a),a.querySelectorAll("li").length<=1?null:i}function rs(e){e.querySelectorAll("h1,h2,h3,h4,h5,h6").forEach(n=>{n.id||(n.id=he(n.textContent||""))})}function hc(e,t,n){try{const i=e.querySelectorAll("img");if(i&&i.length){const r=t&&t.includes("/")?t.substring(0,t.lastIndexOf("/")+1):"";i.forEach(a=>{const s=a.getAttribute("src")||"";if(s&&!(/^(https?:)?\/\//.test(s)||s.startsWith("/")))try{const o=new URL(r+s,n).toString();a.src=o;try{a.getAttribute("loading")||a.setAttribute("data-want-lazy","1")}catch(l){k("[htmlBuilder] set image loading attribute failed",l)}}catch(o){k("[htmlBuilder] resolve image src failed",o)}})}}catch(i){k("[htmlBuilder] lazyLoadImages failed",i)}}function aa(e,t,n){try{const i=t&&t.includes("/")?t.substring(0,t.lastIndexOf("/")+1):"";let r=null;try{const o=new URL(n,location.href);r=new URL(i||".",o).toString()}catch{try{r=new URL(i||".",location.href).toString()}catch{r=i||"./"}}let a=null;try{a=e.querySelectorAll("[src],[href],[srcset],[poster]")}catch{const l=[];try{l.push(...Array.from(e.getElementsByTagName("img")||[]))}catch{}try{l.push(...Array.from(e.getElementsByTagName("link")||[]))}catch{}try{l.push(...Array.from(e.getElementsByTagName("video")||[]))}catch{}try{l.push(...Array.from(e.getElementsByTagName("use")||[]))}catch{}try{l.push(...Array.from(e.querySelectorAll("[srcset]")||[]))}catch{}a=l}let s=Array.from(a||[]);try{const o=Array.from(e.getElementsByTagName("use")||[]);for(const l of o)s.indexOf(l)===-1&&s.push(l)}catch{}for(const o of Array.from(s||[]))try{const l=o.tagName?o.tagName.toLowerCase():"",c=u=>{try{const g=o.getAttribute(u)||"";if(!g||/^(https?:)?\/\//i.test(g)||g.startsWith("/")||g.startsWith("#"))return;try{o.setAttribute(u,new URL(g,r).toString())}catch(h){k("[htmlBuilder] rewrite asset attribute failed",u,g,h)}}catch(g){k("[htmlBuilder] rewriteAttr failed",g)}};if(o.hasAttribute&&o.hasAttribute("src")&&c("src"),o.hasAttribute&&o.hasAttribute("href")&&l!=="a"&&c("href"),o.hasAttribute&&o.hasAttribute("xlink:href")&&c("xlink:href"),o.hasAttribute&&o.hasAttribute("poster")&&c("poster"),o.hasAttribute&&o.hasAttribute("srcset")){const h=(o.getAttribute("srcset")||"").split(",").map(d=>d.trim()).filter(Boolean).map(d=>{const[p,m]=d.split(/\s+/,2);if(!p||/^(https?:)?\/\//i.test(p)||p.startsWith("/"))return d;try{const f=new URL(p,r).toString();return m?`${f} ${m}`:f}catch{return d}}).join(", ");o.setAttribute("srcset",h)}}catch(l){k("[htmlBuilder] rewriteRelativeAssets node processing failed",l)}}catch(i){k("[htmlBuilder] rewriteRelativeAssets failed",i)}}let sa="",$r=null,oa="";async function Si(e,t,n,i={}){try{i=i||{},typeof i.canonical>"u"&&(i.canonical=!0);const r=e.querySelectorAll("a");if(!r||!r.length)return;let a,s;if(t===sa&&$r)a=$r,s=oa;else{try{a=new URL(t,location.href),s=Vt(a.pathname)}catch{try{a=new URL(t,location.href),s=Vt(a.pathname)}catch{a=null,s="/"}}sa=t,$r=a,oa=s}const o=new Set,l=[],c=new Set,u=[];for(const g of Array.from(r))try{try{if(g.closest&&g.closest("h1,h2,h3,h4,h5,h6"))continue}catch{}const h=g.getAttribute("href")||"";if(!h||jr(h))continue;try{if(h.startsWith("?")||h.indexOf("?")!==-1)try{const p=new URL(h,t||location.href),m=p.searchParams.get("page");if(m&&m.indexOf("/")===-1&&n){const f=n.includes("/")?n.substring(0,n.lastIndexOf("/")+1):"";if(f){const w=Y(f+m),y=i&&i.canonical?Pe(w,p.hash?p.hash.replace(/^#/,""):null):ft(w,p.hash?p.hash.replace(/^#/,""):null);g.setAttribute("href",y);continue}}}catch{}}catch{}if(h.startsWith("/")&&!h.endsWith(".md"))continue;const d=h.match(/^([^#?]+\.md)(?:[#](.+))?$/);if(d){let p=d[1];const m=d[2];!p.startsWith("/")&&n&&(p=(n.includes("/")?n.substring(0,n.lastIndexOf("/")+1):"")+p);try{const f=new URL(p,t).pathname;let w=f.startsWith(s)?f.slice(s.length):f;w=Vr(w,s),w=Y(w),l.push({node:g,mdPathRaw:p,frag:m,rel:w}),Z.has(w)||o.add(w)}catch(f){k("[htmlBuilder] resolve mdPath failed",f)}continue}try{let p=h;!h.startsWith("/")&&n&&(h.startsWith("#")?p=n+h:p=(n.includes("/")?n.substring(0,n.lastIndexOf("/")+1):"")+h);const f=new URL(p,t).pathname||"";if(f&&f.indexOf(s)!==-1){let w=f.startsWith(s)?f.slice(s.length):f;if(w=Vr(w,s),w=Y(w),w=cn(w),w||(w=Ot),!w.endsWith(".md")){let y=null;try{if(Z&&Z.has&&Z.has(w))y=Z.get(w);else try{const _=String(w||"").replace(/^.*\//,"");_&&Z.has&&Z.has(_)&&(y=Z.get(_))}catch(_){k("[htmlBuilder] mdToSlug baseName check failed",_)}}catch(_){k("[htmlBuilder] mdToSlug access check failed",_)}if(!y)try{const _=String(w||"").replace(/^.*\//,"");for(const[b,A]of V||[])if(A===w||A===_){y=b;break}}catch{}if(y){const _=i&&i.canonical?Pe(y,null):ft(y);g.setAttribute("href",_)}else{let _=w;try{/\.[^\/]+$/.test(String(w||""))||(_=String(w||"")+".html")}catch{_=w}c.add(_),u.push({node:g,rel:_})}}}}catch(p){k("[htmlBuilder] resolving href to URL failed",p)}}catch(h){k("[htmlBuilder] processing anchor failed",h)}if(o.size)if(fr(t))await Rn(Array.from(o),async g=>{try{try{const d=String(g).match(/([^\/]+)\.md$/),p=d&&d[1];if(p&&V.has(p)){try{const m=V.get(p);if(m)try{const f=typeof m=="string"?m:m&&m.default?m.default:null;f&&vt(p,f)}catch(f){k("[htmlBuilder] _storeSlugMapping failed",f)}}catch(m){k("[htmlBuilder] reading slugToMd failed",m)}return}}catch(d){k("[htmlBuilder] basename slug lookup failed",d)}const h=await Be(g,t);if(h&&h.raw){const d=(h.raw||"").match(/^#\s+(.+)$/m);if(d&&d[1]){const p=he(d[1].trim());if(p)try{vt(p,g)}catch(m){k("[htmlBuilder] setting slug mapping failed",m)}}}}catch(h){k("[htmlBuilder] fetchMarkdown during rewriteAnchors failed",h)}},6);else{try{k("[htmlBuilder] skipping md title probes (probing disabled)")}catch{}for(const g of Array.from(o))try{const h=String(g).match(/([^\/]+)\.md$/),d=h&&h[1];if(d){const p=he(d);if(p)try{vt(p,g)}catch(m){k("[htmlBuilder] setting fallback slug mapping failed",m)}}}catch{}}if(c.size)if(fr(t))await Rn(Array.from(c),async g=>{try{const h=await Be(g,t);if(h&&h.raw)try{const d=He(),p=d?d.parseFromString(h.raw,"text/html"):null,m=p?p.querySelector("title"):null,f=p?p.querySelector("h1"):null,w=m&&m.textContent&&m.textContent.trim()?m.textContent.trim():f&&f.textContent?f.textContent.trim():null;if(w){const y=he(w);if(y)try{vt(y,g)}catch(_){k("[htmlBuilder] setting html slug mapping failed",_)}}}catch(d){k("[htmlBuilder] parse fetched HTML failed",d)}}catch(h){k("[htmlBuilder] fetchMarkdown for htmlPending failed",h)}},5);else{try{k("[htmlBuilder] skipping html title probes (probing disabled)")}catch{}for(const g of Array.from(c))try{const h=String(g).match(/([^\/]+)\.html$/),d=h&&h[1];if(d){const p=he(d);if(p)try{vt(p,g)}catch(m){k("[htmlBuilder] setting fallback html slug mapping failed",m)}}}catch{}}for(const g of l){const{node:h,frag:d,rel:p}=g;let m=null;try{Z.has(p)&&(m=Z.get(p))}catch(f){k("[htmlBuilder] mdToSlug access failed",f)}if(m){const f=i&&i.canonical?Pe(m,d):ft(m,d);h.setAttribute("href",f)}else{const f=i&&i.canonical?Pe(p,d):ft(p,d);h.setAttribute("href",f)}}for(const g of u){const{node:h,rel:d}=g;let p=null;try{Z.has(d)&&(p=Z.get(d))}catch(m){k("[htmlBuilder] mdToSlug access failed for htmlAnchorInfo",m)}if(!p)try{const m=String(d||"").replace(/^.*\//,"");Z.has(m)&&(p=Z.get(m))}catch(m){k("[htmlBuilder] mdToSlug baseName access failed for htmlAnchorInfo",m)}if(p){const m=i&&i.canonical?Pe(p,null):ft(p);h.setAttribute("href",m)}else{const m=i&&i.canonical?Pe(d,null):ft(d);h.setAttribute("href",m)}}}catch(r){k("[htmlBuilder] rewriteAnchors failed",r)}}function dc(e,t,n,i){const r=t.querySelector("h1"),a=r?(r.textContent||"").trim():"";let s="";try{let o="";try{e&&e.meta&&e.meta.title&&(o=String(e.meta.title).trim())}catch{}if(!o&&a&&(o=a),!o)try{const l=t.querySelector("h2");l&&l.textContent&&(o=String(l.textContent).trim())}catch{}!o&&n&&(o=String(n)),o&&(s=he(o)),s||(s=Ot);try{if(n){try{vt(s,n)}catch(l){k("[htmlBuilder] computeSlug set slug mapping failed",l)}try{const l=Y(String(n||""));if(Z&&typeof Z.has=="function"&&Z.has(l))s=Z.get(l);else try{for(const[c,u]of V||[])try{const g=typeof u=="string"?u:u&&u.default?u.default:null;if(g&&Y(String(g))===l){s=c;break}}catch{}}catch{}}catch{}}}catch(l){k("[htmlBuilder] computeSlug set slug mapping failed",l)}try{let l=i||"";if(!l)try{const c=Je(typeof location<"u"?location.href:"");c&&c.anchor&&c.page&&String(c.page)===String(s)?l=c.anchor:l=""}catch{l=""}try{history.replaceState({page:s},"",ft(s,l))}catch(c){k("[htmlBuilder] computeSlug history replace failed",c)}}catch(l){k("[htmlBuilder] computeSlug inner failed",l)}}catch(o){k("[htmlBuilder] computeSlug failed",o)}try{if(e&&e.meta&&e.meta.title&&r){const o=String(e.meta.title).trim();if(o&&o!==a){try{s&&(r.id=s)}catch{}try{if(Array.isArray(e.toc))for(const l of e.toc)try{if(l&&Number(l.level)===1&&String(l.text).trim()===(a||"").trim()){l.id=s;break}}catch{}}catch{}}}}catch{}return{topH1:r,h1Text:a,slugKey:s}}async function fc(e,t){if(!e||!e.length)return;const n=new Set;for(const s of Array.from(e||[]))try{const o=s.getAttribute("href")||"";if(!o)continue;let u=Y(o).split(/::|#/,2)[0];try{const h=u.indexOf("?");h!==-1&&(u=u.slice(0,h))}catch{}if(!u||(u.includes(".")||(u=u+".html"),!/\.html(?:$|[?#])/.test(u)&&!u.toLowerCase().endsWith(".html")))continue;const g=u;try{if(Z&&Z.has&&Z.has(g))continue}catch(h){k("[htmlBuilder] mdToSlug check failed",h)}try{let h=!1;for(const d of V.values())if(d===g){h=!0;break}if(h)continue}catch(h){k("[htmlBuilder] slugToMd iteration failed",h)}n.add(g)}catch(o){k("[htmlBuilder] preScanHtmlSlugs anchor iteration failed",o)}if(!n.size)return;if(!fr()){try{k("[htmlBuilder] skipping preScanHtmlSlugs (probing disabled)")}catch{}for(const s of Array.from(n))try{const o=String(s).match(/([^\/]+)\.html$/),l=o&&o[1];if(l){const c=he(l);if(c)try{vt(c,s)}catch(u){k("[htmlBuilder] setting fallback preScanHtmlSlugs mapping failed",u)}}}catch{}return}const i=async s=>{try{const o=await Be(s,t);if(o&&o.raw)try{const c=He().parseFromString(o.raw,"text/html"),u=c.querySelector("title"),g=c.querySelector("h1"),h=u&&u.textContent&&u.textContent.trim()?u.textContent.trim():g&&g.textContent?g.textContent.trim():null;if(h){const d=he(h);if(d)try{vt(d,s)}catch(p){k("[htmlBuilder] set slugToMd/mdToSlug failed",p)}}}catch(l){k("[htmlBuilder] parse HTML title failed",l)}}catch(o){k("[htmlBuilder] fetchAndExtract failed",o)}},r=Array.from(n),a=Math.max(1,Math.min(Sn(),r.length||1));await Rn(r,i,a)}async function gc(e,t){if(!e||!e.length)return;const n=[],i=new Set;let r="";try{const a=new URL(t,typeof location<"u"?location.href:"http://localhost/");r=Vt(a.pathname)}catch(a){r="",k("[htmlBuilder] preMapMdSlugs parse base failed",a)}for(const a of Array.from(e||[]))try{const s=a.getAttribute("href")||"";if(!s)continue;const o=s.match(/^([^#?]+\.md)(?:[#](.+))?$/);if(o){let l=Y(o[1]);try{let c;try{c=lc(l,t)}catch(g){c=l,k("[htmlBuilder] resolve mdPath URL failed",g)}let u=c&&r&&c.startsWith(r)?c.slice(r.length):String(c||"").replace(/^\//,"");u=Vr(u,r),n.push({rel:u}),Z.has(u)||i.add(u)}catch(c){k("[htmlBuilder] rewriteAnchors failed",c)}continue}}catch(s){k("[htmlBuilder] preMapMdSlugs anchor iteration failed",s)}if(i.size)if(fr())await Promise.all(Array.from(i).map(async a=>{try{const s=String(a).match(/([^\/]+)\.md$/),o=s&&s[1];if(o&&V.has(o)){try{const l=V.get(o);if(l)try{const c=typeof l=="string"?l:l&&l.default?l.default:null;c&&vt(o,c)}catch(c){k("[htmlBuilder] _storeSlugMapping failed",c)}}catch(l){k("[htmlBuilder] preMapMdSlugs slug map access failed",l)}return}}catch(s){k("[htmlBuilder] preMapMdSlugs basename check failed",s)}try{const s=await Be(a,t);if(s&&s.raw){const o=(s.raw||"").match(/^#\s+(.+)$/m);if(o&&o[1]){const l=he(o[1].trim());if(l)try{vt(l,a)}catch(c){k("[htmlBuilder] preMapMdSlugs setting slug mapping failed",c)}}}}catch(s){k("[htmlBuilder] preMapMdSlugs fetch failed",s)}}));else try{k("[htmlBuilder] skipping preMapMdSlugs probes (probing disabled)")}catch{}}He();function Pr(e){try{const n=He().parseFromString(e||"","text/html");rs(n);try{n.querySelectorAll("img").forEach(l=>{try{l.getAttribute("loading")||l.setAttribute("data-want-lazy","1")}catch(c){k("[htmlBuilder] parseHtml set image loading attribute failed",c)}})}catch(o){k("[htmlBuilder] parseHtml query images failed",o)}n.querySelectorAll("pre code, code[class]").forEach(o=>{try{const l=o.getAttribute&&o.getAttribute("class")||o.className||"",c=l.match(/language-([a-zA-Z0-9_+-]+)/)||l.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(c&&c[1]){const u=(c[1]||"").toLowerCase(),g=Ce.size&&(Ce.get(u)||Ce.get(String(u).toLowerCase()))||u;try{(async()=>{try{await ln(g)}catch(h){k("[htmlBuilder] registerLanguage failed",h)}})()}catch(h){k("[htmlBuilder] schedule registerLanguage failed",h)}}else try{if(Re&&typeof Re.getLanguage=="function"&&Re.getLanguage("plaintext")){const u=Re.highlight?Re.highlight(o.textContent||"",{language:"plaintext"}):null;if(u&&u.value)try{if(typeof document<"u"&&document.createRange&&typeof document.createRange=="function"){const g=document.createRange().createContextualFragment(u.value);if(typeof o.replaceChildren=="function")o.replaceChildren(...Array.from(g.childNodes));else{for(;o.firstChild;)o.removeChild(o.firstChild);o.appendChild(g)}}else o.innerHTML=u.value}catch{try{o.innerHTML=u.value}catch{}}}}catch(u){k("[htmlBuilder] plaintext highlight fallback failed",u)}}catch(l){k("[htmlBuilder] code element processing failed",l)}});const r=[];n.querySelectorAll("h1,h2,h3,h4,h5,h6").forEach(o=>{r.push({level:Number(o.tagName.substring(1)),text:(o.textContent||"").trim(),id:o.id})});const s={};try{const o=n.querySelector("title");o&&o.textContent&&String(o.textContent).trim()&&(s.title=String(o.textContent).trim())}catch{}return{html:n.body.innerHTML,meta:s,toc:r}}catch(t){return k("[htmlBuilder] parseHtml failed",t),{html:e||"",meta:{},toc:[]}}}async function is(e){const t=Kr?await Kr(e||"",Ce):En(e||"",Ce),n=new Set(t),i=[];for(const r of n)try{const a=Ce.size&&(Ce.get(r)||Ce.get(String(r).toLowerCase()))||r;try{i.push(ln(a))}catch(s){k("[htmlBuilder] ensureLanguages push canonical failed",s)}if(String(r)!==String(a))try{i.push(ln(r))}catch(s){k("[htmlBuilder] ensureLanguages push alias failed",s)}}catch(a){k("[htmlBuilder] ensureLanguages inner failed",a)}try{await Promise.all(i)}catch(r){k("[htmlBuilder] ensureLanguages failed",r)}}async function pc(e){if(await is(e),hn){const t=await hn(e||"");return!t||typeof t!="object"?{html:String(e||""),meta:{},toc:[]}:(Array.isArray(t.toc)||(t.toc=[]),t.meta||(t.meta={}),t)}return{html:String(e||""),meta:{},toc:[]}}async function mc(e,t,n,i,r){let a=null,s=null;if(t.isHtml)try{const h=He();if(h){const d=h.parseFromString(t.raw||"","text/html");try{aa(d.body,n,r)}catch(p){k("[htmlBuilder] rewriteRelativeAssets failed in prepareArticle (inner)",p)}a=Pr(d.documentElement&&d.documentElement.outerHTML?d.documentElement.outerHTML:t.raw||"")}else a=Pr(t.raw||"")}catch{a=Pr(t.raw||"")}else{const h=t.raw||"",d=64*1024;if(h&&h.length>d&&Xr){try{await is(h)}catch{}s=document.createElement("article"),s.className="nimbi-article content";const p=[];let m={};try{await Xr(h,(f,w)=>{try{w&&w.meta&&(m=Object.assign(m,w.meta))}catch{}try{w&&Array.isArray(w.toc)&&w.toc.length&&p.push(...w.toc)}catch{}try{nr(()=>{try{const y=He();if(y){const _=y.parseFromString(String(f||""),"text/html"),b=Array.from(_.body.childNodes||[]);b.length?s.append(...b):s.insertAdjacentHTML("beforeend",f||"")}else{const _=document&&typeof document.createRange=="function"?document.createRange():null;if(_&&typeof _.createContextualFragment=="function"){const b=_.createContextualFragment(String(f||""));s.append(...Array.from(b.childNodes))}else s.insertAdjacentHTML("beforeend",f||"")}}catch{try{s.insertAdjacentHTML("beforeend",f||"")}catch{}}})}catch{}},{chunkSize:d})}catch(f){k("[htmlBuilder] streamParseMarkdown failed, falling back",f)}a={html:s.innerHTML,meta:m||{},toc:p}}else a=await pc(t.raw||"")}let o;if(s)o=s;else{o=document.createElement("article"),o.className="nimbi-article content";try{const h=He&&He();if(h){const d=h.parseFromString(String(a.html||""),"text/html"),p=Array.from(d.body.childNodes||[]);p.length?o.replaceChildren(...p):o.innerHTML=a.html}else try{const d=document&&typeof document.createRange=="function"?document.createRange():null;if(d&&typeof d.createContextualFragment=="function"){const p=d.createContextualFragment(String(a.html||""));o.replaceChildren(...Array.from(p.childNodes))}else o.innerHTML=a.html}catch{o.innerHTML=a.html}}catch{try{o.innerHTML=a.html}catch(d){k("[htmlBuilder] set article html failed",d)}}}try{aa(o,n,r)}catch(h){k("[htmlBuilder] rewriteRelativeAssets failed in prepareArticle",h)}try{rs(o)}catch(h){k("[htmlBuilder] addHeadingIds failed",h)}try{o.querySelectorAll("pre code, code[class]").forEach(d=>{try{const p=d.getAttribute&&d.getAttribute("class")||d.className||"",m=String(p||"").replace(/\blanguage-undefined\b|\blang-undefined\b/g,"").trim();if(m)try{d.setAttribute&&d.setAttribute("class",m)}catch(f){d.className=m,k("[htmlBuilder] set element class failed",f)}else try{d.removeAttribute&&d.removeAttribute("class")}catch(f){d.className="",k("[htmlBuilder] remove element class failed",f)}}catch(p){k("[htmlBuilder] code element cleanup failed",p)}})}catch(h){k("[htmlBuilder] processing code elements failed",h)}try{ya(o)}catch(h){k("[htmlBuilder] observeCodeBlocks failed",h)}hc(o,n,r);try{(o.querySelectorAll&&o.querySelectorAll("img")||[]).forEach(d=>{try{const p=d.parentElement;if(!p||p.tagName.toLowerCase()!=="p"||p.childNodes.length!==1)return;const m=document.createElement("figure");m.className="image",p.replaceWith(m),m.appendChild(d)}catch{}})}catch(h){k("[htmlBuilder] wrap images in Bulma image helper failed",h)}try{(o.querySelectorAll&&o.querySelectorAll("table")||[]).forEach(d=>{try{if(d.classList)d.classList.contains("table")||d.classList.add("table");else{const p=d.getAttribute&&d.getAttribute("class")?d.getAttribute("class"):"",m=String(p||"").split(/\s+/).filter(Boolean);m.indexOf("table")===-1&&m.push("table");try{d.setAttribute&&d.setAttribute("class",m.join(" "))}catch{d.className=m.join(" ")}}}catch{}})}catch(h){k("[htmlBuilder] add Bulma table class failed",h)}const{topH1:l,h1Text:c,slugKey:u}=dc(a,o,n,i);try{if(l&&a&&a.meta&&(a.meta.author||a.meta.date)&&!(l.parentElement&&l.parentElement.querySelector&&l.parentElement.querySelector(".nimbi-article-subtitle"))){const d=a.meta.author?String(a.meta.author).trim():"",p=a.meta.date?String(a.meta.date).trim():"";let m="";try{const w=new Date(p);p&&!isNaN(w.getTime())?m=w.toLocaleDateString():m=p}catch{m=p}const f=[];if(d&&f.push(d),m&&f.push(m),f.length){const w=document.createElement("p"),y=f[0]?String(f[0]).replace(/"/g,"").trim():"",_=f.slice(1);if(w.className="nimbi-article-subtitle is-6 has-text-grey-light",y){const b=document.createElement("span");b.className="nimbi-article-author",b.textContent=y,w.appendChild(b)}if(_.length){const b=document.createElement("span");b.className="nimbi-article-meta",b.textContent=_.join(" • "),w.appendChild(b)}try{l.parentElement.insertBefore(w,l.nextSibling)}catch{try{l.insertAdjacentElement("afterend",w)}catch{}}}}}catch{}try{await _c(o,r,n)}catch(h){oc("[htmlBuilder] rewriteAnchorsWorker failed, falling back to main thread",h),await Si(o,r,n)}const g=uc(e,a.toc,n);return{article:o,parsed:a,toc:g,topH1:l,h1Text:c,slugKey:u}}function yc(e){if(!(!e||!e.querySelectorAll))try{const t=Array.from(e.querySelectorAll("script"));for(const n of t)try{const i=document.createElement("script");for(const a of Array.from(n.attributes||[]))try{i.setAttribute(a.name,a.value)}catch{}if(!n.src){const a=n.textContent||"";let s=!1;try{new Function(a)(),s=!0}catch{s=!1}if(s){n.parentNode&&n.parentNode.removeChild(n);try{$t("[htmlBuilder] executed inline script via Function")}catch{}continue}try{i.type="module"}catch{}i.textContent=a}if(n.src)try{if(document.querySelector&&document.querySelector(`script[src="${n.src}"]`)){n.parentNode&&n.parentNode.removeChild(n);continue}}catch{}const r=n.src||"<inline>";i.addEventListener("error",a=>{try{k("[htmlBuilder] injected script error",{src:r,ev:a})}catch{}}),i.addEventListener("load",()=>{try{$t("[htmlBuilder] injected script loaded",{src:r,hasNimbi:!!(window&&window.nimbiCMS)})}catch{}});try{(document.head||document.body||document.documentElement).appendChild(i)}catch{try{try{i.type="text/javascript"}catch{}(document.head||document.body||document.documentElement).appendChild(i)}catch(s){try{k("[htmlBuilder] injected script append failed, skipping",{src:r,err:s})}catch{}}}n.parentNode&&n.parentNode.removeChild(n);try{$t("[htmlBuilder] executed injected script",r)}catch{}}catch(i){k("[htmlBuilder] execute injected script failed",i)}}catch{}}function la(e,t,n){if(e)try{typeof e.replaceChildren=="function"?e.replaceChildren():e.innerHTML=""}catch{try{e.innerHTML=""}catch{}}const i=document.createElement("article");i.className="nimbi-article content nimbi-not-found";const r=document.createElement("h1");r.textContent=t&&t("notFound")||"Page not found";const a=document.createElement("p");a.textContent=n&&n.message?String(n.message):"Failed to resolve the requested page.",i.appendChild(r),i.appendChild(a),e&&e.appendChild&&e.appendChild(i);try{if(!le)try{const s=document.createElement("p"),o=t&&t("goHome")||"Go back to";s.textContent=o+" ";const l=document.createElement("a");try{l.href=Pe(ot)}catch{l.href=Pe(ot||"")}l.textContent=t&&t("home")||"Home",s.appendChild(l),e&&e.appendChild&&e.appendChild(s)}catch{}}catch{}try{try{er({title:t&&t("notFound")||"Not Found",description:t&&t("notFoundDescription")||""},le,t&&t("notFound")||"Not Found",t&&t("notFoundDescription")||"")}catch{}}catch{}try{try{const s=typeof window<"u"&&window.__nimbiNotFoundRedirect?String(window.__nimbiNotFoundRedirect).trim():null;if(s)try{const o=new URL(s,location.origin).toString();if((location.href||"").split("#")[0]!==o)try{location.replace(o)}catch{location.href=o}}catch{}}catch{}}catch{}}const as=so(ac,sc&&ns,"anchor");function bc(){return as.get()}function wc(e){return as.send(e,2e3)}async function _c(e,t,n){if(!bc())throw new Error("anchor worker unavailable");if(!e||typeof e.innerHTML!="string")throw new Error("invalid article element");const r=String(e.innerHTML),a=await wc({type:"rewriteAnchors",html:r,contentBase:t,pagePath:n});if(a&&typeof a=="string")try{const s=He&&He();if(s){const o=s.parseFromString(String(a||""),"text/html"),l=Array.from(o.body.childNodes||[]);l.length?e.replaceChildren(...l):e.innerHTML=a}else try{const o=document&&typeof document.createRange=="function"?document.createRange():null;if(o&&typeof o.createContextualFragment=="function"){const l=o.createContextualFragment(String(a||""));e.replaceChildren(...Array.from(l.childNodes))}else e.innerHTML=a}catch{e.innerHTML=a}}catch(s){k("[htmlBuilder] applying rewritten anchors failed",s)}}function kc(e){try{e.addEventListener("click",t=>{const n=t.target&&t.target.closest?t.target.closest("a"):null;if(!n)return;const i=n.getAttribute("href")||"";try{const r=Je(i),a=r&&r.page?r.page:null,s=r&&r.anchor?r.anchor:null;if(!a&&!s)return;t.preventDefault();let o=null;try{history&&history.state&&history.state.page&&(o=history.state.page)}catch(l){o=null,k("[htmlBuilder] access history.state failed",l)}try{o||(o=new URL(location.href).searchParams.get("page"))}catch(l){k("[htmlBuilder] parse current location failed",l)}if(!a&&s||a&&o&&String(a)===String(o)){try{if(!a&&s)try{history.replaceState(history.state,"",(location.pathname||"")+(location.search||"")+(s?"#"+encodeURIComponent(s):""))}catch(l){k("[htmlBuilder] history.replaceState failed",l)}else try{history.replaceState({page:o||a},"",ft(o||a,s))}catch(l){k("[htmlBuilder] history.replaceState failed",l)}}catch(l){k("[htmlBuilder] update history for anchor failed",l)}try{t.stopImmediatePropagation&&t.stopImmediatePropagation(),t.stopPropagation&&t.stopPropagation()}catch(l){k("[htmlBuilder] stopPropagation failed",l)}try{Yr(s)}catch(l){k("[htmlBuilder] scrollToAnchorOrTop failed",l)}return}history.pushState({page:a},"",ft(a,s));try{if(typeof window<"u"&&typeof window.renderByQuery=="function")try{window.renderByQuery()}catch(l){k("[htmlBuilder] window.renderByQuery failed",l)}else if(typeof window<"u")try{window.dispatchEvent(new PopStateEvent("popstate"))}catch(l){k("[htmlBuilder] dispatch popstate failed",l)}else try{renderByQuery()}catch(l){k("[htmlBuilder] renderByQuery failed",l)}}catch(l){k("[htmlBuilder] SPA navigation invocation failed",l)}}catch(r){k("[htmlBuilder] non-URL href in attachTocClickHandler",r)}})}catch(t){k("[htmlBuilder] attachTocClickHandler failed",t)}}function Yr(e){const t=document.querySelector(".nimbi-cms")||null;if(e){const n=document.getElementById(e);if(n)try{const i=()=>{try{if(t&&t.scrollTo&&t.contains(n)){const r=n.getBoundingClientRect().top-t.getBoundingClientRect().top+t.scrollTop;t.scrollTo({top:r,behavior:"smooth"})}else try{n.scrollIntoView({behavior:"smooth",block:"start"})}catch{try{n.scrollIntoView()}catch(a){k("[htmlBuilder] scrollIntoView failed",a)}}}catch{try{n.scrollIntoView()}catch(a){k("[htmlBuilder] final scroll fallback failed",a)}}};try{requestAnimationFrame(()=>setTimeout(i,50))}catch(r){k("[htmlBuilder] scheduling scroll failed",r),setTimeout(i,50)}}catch(i){try{n.scrollIntoView()}catch(r){k("[htmlBuilder] final scroll fallback failed",r)}k("[htmlBuilder] doScroll failed",i)}}else try{t&&t.scrollTo?t.scrollTo({top:0,behavior:"smooth"}):window.scrollTo(0,0)}catch(n){try{window.scrollTo(0,0)}catch(i){k("[htmlBuilder] window.scrollTo failed",i)}k("[htmlBuilder] scroll to top failed",n)}}function xc(e,t,{mountOverlay:n=null,container:i=null,mountEl:r=null,navWrap:a=null,t:s=null}={}){try{const o=s||(m=>typeof m=="string"?m:""),l=i||document.querySelector(".nimbi-cms"),c=r||document.querySelector(".nimbi-mount"),u=n||document.querySelector(".nimbi-overlay"),g=a||document.querySelector(".nimbi-nav-wrap");let d=document.querySelector(".nimbi-scroll-top");if(!d){d=document.createElement("button"),d.className="nimbi-scroll-top button is-primary is-rounded is-small",d.setAttribute("aria-label",o("scrollToTop")),d.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 19V6"/><path d="M5 12l7-7 7 7"/></svg>';try{u&&u.appendChild?u.appendChild(d):l&&l.appendChild?l.appendChild(d):c&&c.appendChild?c.appendChild(d):document.body.appendChild(d)}catch{try{document.body.appendChild(d)}catch(f){k("[htmlBuilder] append scroll top button failed",f)}}try{try{_a(d)}catch{}}catch(m){k("[htmlBuilder] set scroll-top button theme registration failed",m)}d.addEventListener("click",()=>{try{i&&i.scrollTo?i.scrollTo({top:0,left:0,behavior:"smooth"}):r&&r.scrollTo?r.scrollTo({top:0,left:0,behavior:"smooth"}):window.scrollTo({top:0,left:0,behavior:"smooth"})}catch{try{i&&(i.scrollTop=0)}catch(f){k("[htmlBuilder] fallback container scrollTop failed",f)}try{r&&(r.scrollTop=0)}catch(f){k("[htmlBuilder] fallback mountEl scrollTop failed",f)}try{document.documentElement.scrollTop=0}catch(f){k("[htmlBuilder] fallback document scrollTop failed",f)}}})}const p=g&&g.querySelector?g.querySelector(".menu-label"):null;if(t){if(!d._nimbiObserver)if(typeof globalThis<"u"&&typeof globalThis.IntersectionObserver<"u"){const m=globalThis.IntersectionObserver,f=new m(w=>{for(const y of w)y.target instanceof Element&&(y.isIntersecting?(d.classList.remove("show"),p&&p.classList.remove("show")):(d.classList.add("show"),p&&p.classList.add("show")))},{root:i instanceof Element?i:r instanceof Element?r:null,threshold:0});d._nimbiObserver=f}else d._nimbiObserver=null;try{d._nimbiObserver&&typeof d._nimbiObserver.disconnect=="function"&&d._nimbiObserver.disconnect()}catch(m){k("[htmlBuilder] observer disconnect failed",m)}try{d._nimbiObserver&&typeof d._nimbiObserver.observe=="function"&&d._nimbiObserver.observe(t)}catch(m){k("[htmlBuilder] observer observe failed",m)}try{const m=()=>{try{const f=l instanceof Element?l.getBoundingClientRect():{top:0,bottom:window.innerHeight},w=t.getBoundingClientRect();!(w.bottom<f.top||w.top>f.bottom)?(d.classList.remove("show"),p&&p.classList.remove("show")):(d.classList.add("show"),p&&p.classList.add("show"))}catch(f){k("[htmlBuilder] checkIntersect failed",f)}};m(),typeof globalThis<"u"&&typeof globalThis.IntersectionObserver<"u"||setTimeout(m,100)}catch(m){k("[htmlBuilder] checkIntersect outer failed",m)}}else{d.classList.remove("show"),p&&p.classList.remove("show");const m=i instanceof Element?i:r instanceof Element?r:window,f=()=>{try{(m===window?window.scrollY:m.scrollTop||0)>10?(d.classList.add("show"),p&&p.classList.add("show")):(d.classList.remove("show"),p&&p.classList.remove("show"))}catch(w){k("[htmlBuilder] onScroll handler failed",w)}};sr(()=>m.addEventListener("scroll",rc(f))),f()}}catch(o){k("[htmlBuilder] ensureScrollTopButton failed",o)}}function nn(e,t){try{if(typeof rt=="function")try{rt(e,t);return}catch{}}catch{}try{e&&t&&V&&typeof V.set=="function"&&!V.has(e)&&V.set(e,t)}catch{}try{t&&Z&&typeof Z.set=="function"&&Z.set(t,e)}catch{}try{if($e&&typeof $e.has=="function"){if(!$e.has(t)){try{$e.add(t)}catch{}try{Array.isArray(Oe)&&!Oe.includes(t)&&Oe.push(t)}catch{}}}else try{Array.isArray(Oe)&&!Oe.includes(t)&&Oe.push(t)}catch{}}catch{}}function ca(e,t){try{if(!e)return;try{const n=e[t];if(typeof n<"u")return n}catch{}try{if(e.default)return e.default[t]}catch{}return}catch{return}}function Sc(e){try{if(!Array.isArray(e))return e;e.forEach(t=>{try{if(!t||typeof t!="object")return;let n=typeof t.slug=="string"?String(t.slug):"",i=null;if(n&&n.indexOf("::")!==-1){const o=n.split("::");n=o[0]||"",i=o.slice(1).join("::")||null}const r=!!(n&&(n.indexOf(".")!==-1||n.indexOf("/")!==-1));let a="";try{if(t.path&&typeof t.path=="string"){const o=Y(String(t.path||""));if(a=findSlugForPath(o)||(Z&&Z.has(o)?Z.get(o):"")||"",!a)if(t.title&&String(t.title).trim())a=he(String(t.title).trim());else{const l=o.replace(/^.*\//,"").replace(/\.(?:md|html?)$/i,"");a=he(l||o)}}else if(r){const o=String(n).replace(/\.(?:md|html?)$/i,""),l=findSlugForPath(o)||(Z&&Z.has(o)?Z.get(o):"")||"";l?a=l:t.title&&String(t.title).trim()?a=he(String(t.title).trim()):a=he(o)}else!n&&t.title&&String(t.title).trim()?a=he(String(t.title).trim()):a=n||""}catch{try{a=t.title&&String(t.title).trim()?he(String(t.title).trim()):n?he(n):""}catch{a=n}}let s=a||"";i&&(s=s?`${s}::${i}`:`${he(i)}`),s&&(t.slug=s);try{if(t.path&&s){const o=String(s).split("::")[0];try{nn(o,Y(String(t.path||"")))}catch{}}}catch{}}catch{}})}catch{}return e}async function vc(e,t,n,i,r,a,s,o,l="eager",c=1,u=void 0,g="favicon"){if(!e||!(e instanceof HTMLElement))throw new TypeError("navbarWrap must be an HTMLElement");const h=He(),d=h?h.parseFromString(n||"","text/html"):null,p=d?d.querySelectorAll("a"):[];await sr(()=>fc(p,i)),await sr(()=>gc(p,i));try{ie(p,i)}catch{}try{if(t&&t instanceof HTMLElement&&(!t.hasAttribute||!t.hasAttribute("role")))try{t.setAttribute("role","main")}catch{}}catch{}let m=null,f=null,w=null,y=null,_=null,b=null,A=!1,S=null;const E=new Map;function I(){try{const R=typeof O<"u"&&O&&O.querySelector?O.querySelector(".navbar-burger"):e&&e.querySelector?e.querySelector(".navbar-burger"):typeof document<"u"?document.querySelector(".navbar-burger"):null,P=R&&R.dataset?R.dataset.target:null,C=P?typeof O<"u"&&O&&O.querySelector?O.querySelector(`#${P}`)||document.getElementById(P):e&&e.querySelector?e.querySelector(`#${P}`):typeof document<"u"?document.getElementById(P):null:null;if(R&&R.classList&&R.classList.contains("is-active")){try{R.classList.remove("is-active")}catch{}try{R.setAttribute("aria-expanded","false")}catch{}if(C&&C.classList)try{C.classList.remove("is-active")}catch{}}}catch(R){k("[nimbi-cms] closeMobileMenu failed",R)}}async function N(){const R=t&&t instanceof HTMLElement?t:typeof document<"u"?document.querySelector(".nimbi-content"):null;try{R&&R.classList.add("is-inactive")}catch{}try{const P=s&&s();P&&typeof P.then=="function"&&await P}catch(P){try{k("[nimbi-cms] renderByQuery failed",P)}catch{}}finally{try{if(typeof requestAnimationFrame=="function")requestAnimationFrame(()=>{try{R&&R.classList.remove("is-inactive")}catch{}});else try{R&&R.classList.remove("is-inactive")}catch{}}catch{try{R&&R.classList.remove("is-inactive")}catch{}}}}function U(R){try{let P=R&&typeof R.slug=="string"?String(R.slug):"",C=null;try{P&&P.indexOf("::")!==-1&&(C=P.split("::").slice(1).join("::")||null)}catch{}try{if(R&&R.path&&typeof R.path=="string"){const v=Y(String(R.path||"")),M=v.replace(/^.*\//,"");try{if(E&&E.has(v))return{page:E.get(v),hash:C};if(E&&E.has(M))return{page:E.get(M),hash:C}}catch{}try{if(Z&&Z.has(v))return{page:Z.get(v),hash:C}}catch{}try{const D=G(v);if(D)return{page:D,hash:C}}catch{}}}catch{}if(P&&P.indexOf("::")!==-1){const v=P.split("::");P=v[0]||"",C=v.slice(1).join("::")||null}if(P&&(P.includes(".")||P.includes("/"))){const v=Y(R&&R.path?String(R.path):P),M=v.replace(/^.*\//,"");try{if(E&&E.has(v))return{page:E.get(v),hash:C};if(E&&E.has(M))return{page:E.get(M),hash:C}}catch{}try{let D=G(v);if(!D)try{const K=String(v||"").replace(/^\/+/,""),j=K.replace(/^.*\//,"");for(const[$,T]of V.entries())try{let B=null;if(typeof T=="string"?B=Y(String(T||"")):T&&typeof T=="object"&&(T.default?B=Y(String(T.default||"")):B=null),!B)continue;if(B===K||B.endsWith("/"+K)||K.endsWith("/"+B)||B.endsWith(j)||K.endsWith(j)){D=$;break}}catch{}}catch{}if(D)P=D;else try{const K=String(P).replace(/\.(?:md|html?)$/i,"");P=he(K||v)}catch{P=he(v)}}catch{P=he(v)}}return!P&&R&&R.path&&(P=he(Y(String(R.path||"")))),{page:P,hash:C}}catch{return{page:R&&R.slug||"",hash:null}}}const z=()=>m||(m=(async()=>{try{const R=await Promise.resolve().then(()=>at),P=typeof globalThis<"u"?globalThis.buildSearchIndex:void 0,C=typeof globalThis<"u"?globalThis.buildSearchIndexWorker:void 0,v=ca(R,"buildSearchIndex"),M=ca(R,"buildSearchIndexWorker"),D=typeof P=="function"?P:v||void 0,K=typeof C=="function"?C:M||void 0;jt("[nimbi-cms test] ensureSearchIndex: buildFn="+typeof D+" workerFn="+typeof K+" (global preferred)");const j=[];try{r&&j.push(r)}catch{}try{navigationPage&&j.push(navigationPage)}catch{}if(l==="lazy"&&typeof K=="function")try{const $=await K(i,c,u,j.length?j:void 0);if($&&$.length){try{if(R&&typeof R._setSearchIndex=="function")try{R._setSearchIndex($)}catch{}}catch{}return $}}catch($){k("[nimbi-cms] worker builder threw",$)}return typeof D=="function"?(jt("[nimbi-cms test] calling buildFn"),await D(i,c,u,j.length?j:void 0)):[]}catch(R){return k("[nimbi-cms] buildSearchIndex failed",R),[]}finally{if(f){try{f.removeAttribute("disabled")}catch{}try{w&&w.classList.remove("is-loading")}catch{}}}})(),m.then(R=>{try{try{S=Array.isArray(R)?R:null}catch{S=null}try{Sc(R)}catch{}try{if(typeof window<"u"){try{(async()=>{try{const M=await Promise.resolve().then(()=>at);try{try{M&&typeof M._setSearchIndex=="function"&&M._setSearchIndex(Array.isArray(R)?R:[])}catch{}Object.defineProperty(window,"__nimbiResolvedIndex",{get(){return M&&Array.isArray(M.searchIndex)?M.searchIndex:Array.isArray(S)?S:[]},enumerable:!0,configurable:!0})}catch{try{window.__nimbiResolvedIndex=M&&Array.isArray(M.searchIndex)?M.searchIndex:Array.isArray(S)?S:[]}catch{}}}catch{try{window.__nimbiResolvedIndex=Array.isArray(re)?re:Array.isArray(S)?S:[]}catch{}}})()}catch{}try{window.__nimbi_contentBase=i}catch{}try{window.__nimbi_indexDepth=c}catch{}try{window.__nimbi_noIndexing=u}catch{}}}catch{}const P=String(f&&f.value||"").trim().toLowerCase();if(!P||!Array.isArray(R)||!R.length)return;const C=R.filter(M=>M.title&&M.title.toLowerCase().includes(P)||M.excerpt&&M.excerpt.toLowerCase().includes(P));if(!C||!C.length)return;const v=typeof _<"u"&&_?_:typeof document<"u"?document.getElementById("nimbi-search-results"):null;if(!v)return;try{typeof v.replaceChildren=="function"?v.replaceChildren():v.innerHTML=""}catch{try{v.innerHTML=""}catch{}}try{const M=document.createElement("div");M.className="panel nimbi-search-panel",C.slice(0,10).forEach(D=>{try{if(D.parentTitle){const T=document.createElement("p");T.className="panel-heading nimbi-search-title nimbi-search-parent",T.textContent=D.parentTitle,M.appendChild(T)}const K=document.createElement("a");K.className="panel-block nimbi-search-result";const j=U(D);K.href=Pe(j.page,j.hash),K.setAttribute("role","button");try{if(D.path&&typeof D.path=="string")try{nn(j.page,D.path)}catch{}}catch{}const $=document.createElement("div");$.className="is-size-6 has-text-weight-semibold",$.textContent=D.title,K.appendChild($),K.addEventListener("click",()=>{try{v.style.display="none"}catch{}}),M.appendChild(K)}catch{}}),nr(()=>{try{v.appendChild(M)}catch{}});try{v.style.display="block"}catch{}}catch{}}catch{}}).catch(()=>{}).finally(()=>{(async()=>{try{if(A)return;A=!0;const R=await Promise.resolve().then(()=>Tn);try{await R.handleSitemapRequest({homePage:r,contentBase:i,indexDepth:c,noIndexing:u,includeAllMarkdown:!0})}catch(P){k("[nimbi-cms] sitemap trigger failed",P)}}catch(R){try{k("[nimbi-cms] sitemap dynamic import failed",R)}catch{}}})()}),m),O=document.createElement("nav");O.className="navbar",O.setAttribute("role","navigation"),O.setAttribute("aria-label","main navigation");const W=document.createElement("div");W.className="navbar-brand";const te=p[0],H=document.createElement("a");if(H.className="navbar-item",te){const R=te.getAttribute("href")||"#";try{const C=new URL(R,location.href).searchParams.get("page"),v=C?decodeURIComponent(C):r;let M=null;try{typeof v=="string"&&(/(?:\.md|\.html?)$/i.test(v)||v.includes("/"))&&(M=G(v))}catch{}!M&&typeof v=="string"&&!String(v).includes(".")&&(M=v);const D=M||v;H.href=Pe(D),(!H.textContent||!String(H.textContent).trim())&&(H.textContent=a("home"))}catch{try{const C=typeof r=="string"&&(/(?:\.md|\.html?)$/i.test(r)||r.includes("/"))?G(r):typeof r=="string"&&!r.includes(".")?r:null;H.href=Pe(C||r)}catch{H.href=Pe(r)}H.textContent=a("home")}}else H.href=Pe(r),H.textContent=a("home");async function L(R){try{if(!R||R==="none")return null;if(R==="favicon")try{const P=document.querySelector('link[rel~="icon"],link[rel="shortcut icon"]');if(!P)return null;const C=P.getAttribute("href")||"";return C&&/\.png(?:\?|$)/i.test(C)?new URL(C,location.href).toString():null}catch{return null}if(R==="copy-first"||R==="move-first")try{const P=await Be(r,i);if(!P||!P.raw)return null;const C=He(),v=C?C.parseFromString(P.raw,"text/html"):null,M=v?v.querySelector("img"):null;if(!M)return null;const D=M.getAttribute("src")||"";if(!D)return null;const K=new URL(D,location.href).toString();if(R==="move-first")try{document.documentElement.setAttribute("data-nimbi-logo-moved",K)}catch{}return K}catch{return null}try{return new URL(R,location.href).toString()}catch{return null}}catch{return null}}let F=null;try{F=await L(g)}catch{F=null}if(F)try{const R=document.createElement("img");R.className="nimbi-navbar-logo";const P=a&&typeof a=="function"&&(a("home")||a("siteLogo"))||"";R.alt=P,R.title=P,R.src=F;try{R.style.marginRight="0.5em"}catch{}try{(!H.textContent||!String(H.textContent).trim())&&(H.textContent=P)}catch{}try{H.insertBefore(R,H.firstChild)}catch{try{H.appendChild(R)}catch{}}}catch{}W.appendChild(H),H.addEventListener("click",function(R){const P=H.getAttribute("href")||"";if(P.startsWith("?page=")){R.preventDefault();const C=new URL(P,location.href),v=C.searchParams.get("page"),M=C.hash?C.hash.replace(/^#/,""):null;history.pushState({page:v},"",Pe(v,M)),N();try{I()}catch{}}});function G(R){try{if(!R)return null;const P=Y(String(R||""));try{if(Z&&Z.has(P))return Z.get(P)}catch{}const C=P.replace(/^.*\//,"");try{if(Z&&Z.has(C))return Z.get(C)}catch{}try{for(const[v,M]of V.entries())if(M){if(typeof M=="string"){if(Y(M)===P)return v}else if(M&&typeof M=="object"){if(M.default&&Y(M.default)===P)return v;const D=M.langs||{};for(const K in D)if(D[K]&&Y(D[K])===P)return v}}}catch{}return null}catch{return null}}async function ie(R,P){try{if(!R||!R.length)return;const C=[];for(let j=0;j<R.length;j++)try{const $=R[j];if(!$||typeof $.getAttribute!="function")continue;const T=$.getAttribute("href")||"";if(!T||jr(T))continue;let B=null;try{const we=Je(T);we&&we.page&&(B=we.page)}catch{}if(!B){const we=String(T||"").split(/[?#]/,1),ve=we&&we[0]?we[0]:T;(/\.(?:md|html?)$/i.test(ve)||ve.indexOf("/")!==-1)&&(B=Y(String(ve||"")))}if(!B)continue;try{if(P&&typeof P=="string")try{let ve=new URL(P,typeof location<"u"?location.origin:"http://localhost").pathname||"";if(ve=ve.replace(/^\/+|\/+$/g,""),ve){let Ie=String(B||"");Ie=Ie.replace(/^\/+/,""),Ie===ve?B="":Ie.startsWith(ve+"/")?B=Ie.slice(ve.length+1):B=Ie}}catch{}}catch{}const Q=Y(String(B||"")),se=Q.replace(/^.*\//,"");let me=null;try{E&&E.has(Q)&&(me=E.get(Q))}catch{}try{!me&&Z&&Z.has(Q)&&(me=Z.get(Q))}catch{}if(me)continue;let be=null;try{be=$.textContent&&String($.textContent).trim()?String($.textContent).trim():null}catch{be=null}let ge=null;if(be)ge=he(be);else{const we=se.replace(/\.(?:md|html?)$/i,"");ge=he(we||Q)}if(ge)try{C.push({path:Q,candidate:ge})}catch{}}catch{}if(!C.length)return;const v=3;let M=0;const D=async()=>{for(;M<C.length;){const j=C[M++];if(!(!j||!j.path))try{const $=await Be(j.path,P);if(!$||!$.raw)continue;let T=null;if($.isHtml)try{const B=He(),Q=B?B.parseFromString($.raw,"text/html"):null,se=Q?Q.querySelector("h1")||Q.querySelector("title"):null;se&&se.textContent&&(T=String(se.textContent).trim())}catch{}else try{const B=$.raw.match(/^#\s+(.+)$/m);B&&B[1]&&(T=String(B[1]).trim())}catch{}if(T){const B=he(T);if(B&&B!==j.candidate){try{nn(B,j.path)}catch{}try{E.set(j.path,B)}catch{}try{E.set(j.path.replace(/^.*\//,""),B)}catch{}try{const Q=await Promise.resolve().then(()=>at);try{if(Array.isArray(Q.searchIndex)){let se=!1;for(const me of Q.searchIndex)try{if(me&&me.path===j.path&&me.slug){const ge=String(me.slug).split("::").slice(1).join("::");me.slug=ge?`${B}::${ge}`:B,se=!0}}catch{}try{se&&typeof Q._setSearchIndex=="function"&&Q._setSearchIndex(Q.searchIndex)}catch{}}}catch{}}catch{}}}}catch{}}},K=[];for(let j=0;j<v;j++)K.push(D());try{await Promise.all(K)}catch{}}catch{}}const pe=document.createElement("a");pe.className="navbar-burger",pe.setAttribute("role","button"),pe.setAttribute("aria-label","menu"),pe.setAttribute("aria-expanded","false");const J="nimbi-navbar-menu";pe.dataset.target=J,pe.innerHTML='<span aria-hidden="true"></span><span aria-hidden="true"></span><span aria-hidden="true"></span>',W.appendChild(pe);try{pe.addEventListener("click",R=>{try{const P=pe.dataset&&pe.dataset.target?pe.dataset.target:null,C=P?O&&O.querySelector?O.querySelector(`#${P}`)||(e&&e.querySelector?e.querySelector(`#${P}`):document.getElementById(P)):e&&e.querySelector?e.querySelector(`#${P}`)||document.getElementById(P):typeof document<"u"?document.getElementById(P):null:null;pe.classList.contains("is-active")?(pe.classList.remove("is-active"),pe.setAttribute("aria-expanded","false"),C&&C.classList.remove("is-active")):(pe.classList.add("is-active"),pe.setAttribute("aria-expanded","true"),C&&C.classList.add("is-active"))}catch(P){k("[nimbi-cms] navbar burger toggle failed",P)}})}catch(R){k("[nimbi-cms] burger event binding failed",R)}const ze=document.createElement("div");ze.className="navbar-menu",ze.id=J;const xe=document.createElement("div");xe.className="navbar-start";let Se=null,Ee=null;if(!o)Se=null,f=null,y=null,_=null,b=null;else{Se=document.createElement("div"),Se.className="navbar-end",Ee=document.createElement("div"),Ee.className="navbar-item",f=document.createElement("input"),f.className="input",f.type="search",f.placeholder=a("searchPlaceholder")||"",f.id="nimbi-search";try{const v=(a&&typeof a=="function"?a("searchAria"):null)||f.placeholder||"Search";try{f.setAttribute("aria-label",v)}catch{}try{f.setAttribute("aria-controls","nimbi-search-results")}catch{}try{f.setAttribute("aria-autocomplete","list")}catch{}try{f.setAttribute("role","combobox")}catch{}}catch{}l==="eager"&&(f.disabled=!0),w=document.createElement("div"),w.className="control",l==="eager"&&w.classList.add("is-loading"),w.appendChild(f),Ee.appendChild(w),y=document.createElement("div"),y.className="dropdown is-right",y.id="nimbi-search-dropdown";const R=document.createElement("div");R.className="dropdown-trigger",R.appendChild(Ee);const P=document.createElement("div");P.className="dropdown-menu",P.setAttribute("role","menu"),_=document.createElement("div"),_.id="nimbi-search-results",_.className="dropdown-content nimbi-search-results",b=_,P.appendChild(_),y.appendChild(R),y.appendChild(P),Se.appendChild(y);const C=v=>{if(!_)return;try{if(typeof _.replaceChildren=="function")_.replaceChildren();else for(;_.firstChild;)_.removeChild(_.firstChild)}catch{try{_.innerHTML=""}catch{}}let M=-1;function D($){try{const T=_.querySelector(".nimbi-search-result.is-selected");T&&T.classList.remove("is-selected");const B=_.querySelectorAll(".nimbi-search-result");if(!B||!B.length)return;if($<0){M=-1;return}$>=B.length&&($=B.length-1);const Q=B[$];if(Q){Q.classList.add("is-selected"),M=$;try{Q.scrollIntoView({block:"nearest"})}catch{}}}catch{}}function K($){try{const T=$.key,B=_.querySelectorAll(".nimbi-search-result");if(!B||!B.length)return;if(T==="ArrowDown"){$.preventDefault();const Q=M<0?0:Math.min(B.length-1,M+1);D(Q);return}if(T==="ArrowUp"){$.preventDefault();const Q=M<=0?0:M-1;D(Q);return}if(T==="Enter"){$.preventDefault();const Q=_.querySelector(".nimbi-search-result.is-selected")||_.querySelector(".nimbi-search-result");if(Q)try{Q.click()}catch{}return}if(T==="Escape"){try{y.classList.remove("is-active")}catch{}try{document.documentElement.classList.remove("nimbi-search-open")}catch{}try{_.style.display="none"}catch{}try{_.classList.remove("is-open")}catch{}try{_.removeAttribute("tabindex")}catch{}try{_.removeEventListener("keydown",K)}catch{}try{f&&f.focus()}catch{}try{f&&f.removeEventListener("keydown",j)}catch{}return}}catch{}}function j($){try{if($&&$.key==="ArrowDown"){$.preventDefault();try{_.focus()}catch{}D(0)}}catch{}}try{const $=String(f&&f.value||"").trim();if(!v||!v.length){if(!$){try{y&&y.classList.remove("is-active")}catch{}try{document.documentElement.classList.remove("nimbi-search-open")}catch{}try{_&&(_.style.display="none",_.classList.remove("is-open"),_.removeAttribute("tabindex"))}catch{}try{_&&_.removeEventListener("keydown",K)}catch{}return}try{const T=document.createElement("div");T.className="panel nimbi-search-panel";const B=document.createElement("p");B.className="panel-block nimbi-search-no-results",B.textContent=a&&typeof a=="function"?a("searchNoResults"):"No results",T.appendChild(B),nr(()=>{try{_.appendChild(T)}catch{}})}catch{}if(y){y.classList.add("is-active");try{document.documentElement.classList.add("nimbi-search-open")}catch{}}try{_.style.display="block"}catch{}try{_.classList.add("is-open")}catch{}try{_.setAttribute("tabindex","0")}catch{}return}}catch{}try{const $=document.createElement("div");$.className="panel nimbi-search-panel";const T=document.createDocumentFragment();v.forEach(B=>{if(B.parentTitle){const be=document.createElement("p");be.textContent=B.parentTitle,be.className="panel-heading nimbi-search-title nimbi-search-parent",T.appendChild(be)}const Q=document.createElement("a");Q.className="panel-block nimbi-search-result";const se=U(B);Q.href=Pe(se.page,se.hash),Q.setAttribute("role","button");try{if(B.path&&typeof B.path=="string")try{nn(se.page,B.path)}catch{}}catch{}const me=document.createElement("div");me.className="is-size-6 has-text-weight-semibold",me.textContent=B.title,Q.appendChild(me),Q.addEventListener("click",be=>{try{try{be&&be.preventDefault&&be.preventDefault()}catch{}try{be&&be.stopPropagation&&be.stopPropagation()}catch{}if(y){y.classList.remove("is-active");try{document.documentElement.classList.remove("nimbi-search-open")}catch{}}try{_.style.display="none"}catch{}try{_.classList.remove("is-open")}catch{}try{_.removeAttribute("tabindex")}catch{}try{_.removeEventListener("keydown",K)}catch{}try{f&&f.removeEventListener("keydown",j)}catch{}try{const ge=Q.getAttribute&&Q.getAttribute("href")||"";let we=null,ve=null;try{const Ie=new URL(ge,location.href);we=Ie.searchParams.get("page"),ve=Ie.hash?Ie.hash.replace(/^#/,""):null}catch{}if(we)try{history.pushState({page:we},"",Pe(we,ve));try{N()}catch{try{typeof window<"u"&&typeof window.renderByQuery=="function"&&window.renderByQuery()}catch{}}return}catch{}}catch{}try{window.location.href=Q.href}catch{}}catch{}}),T.appendChild(Q)}),$.appendChild(T),nr(()=>{try{_.appendChild($)}catch{}})}catch{}if(y){y.classList.add("is-active");try{document.documentElement.classList.add("nimbi-search-open")}catch{}}try{_.style.display="block"}catch{}try{_.classList.add("is-open")}catch{}try{_.setAttribute("tabindex","0")}catch{}try{_.addEventListener("keydown",K)}catch{}try{f&&f.addEventListener("keydown",j)}catch{}};if(f){const v=nc(async()=>{const M=f||(typeof O<"u"&&O&&O.querySelector?O.querySelector("input#nimbi-search"):e&&e.querySelector?e.querySelector("input#nimbi-search"):typeof document<"u"?document.querySelector("input#nimbi-search"):null),D=String(M&&M.value||"").trim().toLowerCase();if(!D){try{y&&y.classList.remove("is-active")}catch{}try{document.documentElement.classList.remove("nimbi-search-open")}catch{}try{_&&(_.style.display="none",_.classList.remove("is-open"),_.removeAttribute("tabindex"))}catch{}return}try{await z();const K=await m,j=Array.isArray(K)?K.filter($=>$.title&&$.title.toLowerCase().includes(D)||$.excerpt&&$.excerpt.toLowerCase().includes(D)):[];C(j.slice(0,10))}catch(K){k("[nimbi-cms] search input handler failed",K),C([])}},50);try{f.addEventListener("input",v)}catch{}try{document.addEventListener("input",M=>{try{M&&M.target&&M.target.id==="nimbi-search"&&v(M)}catch{}},!0)}catch{}}if(l==="eager"){try{m=z()}catch(v){k("[nimbi-cms] eager search index init failed",v),m=Promise.resolve([])}m.finally(()=>{const v=f||(typeof O<"u"&&O&&O.querySelector?O.querySelector("input#nimbi-search"):e&&e.querySelector?e.querySelector("input#nimbi-search"):typeof document<"u"?document.querySelector("input#nimbi-search"):null);if(v){try{v.removeAttribute("disabled")}catch{}try{w&&w.classList.remove("is-loading")}catch{}}(async()=>{try{if(A)return;A=!0;const M=await m.catch(()=>[]),D=await Promise.resolve().then(()=>Tn);try{await D.handleSitemapRequest({index:Array.isArray(M)?M:void 0,homePage:r,contentBase:i,indexDepth:c,noIndexing:u,includeAllMarkdown:!0})}catch(K){k("[nimbi-cms] sitemap trigger failed",K)}}catch(M){try{k("[nimbi-cms] sitemap dynamic import failed",M)}catch{}}})()})}try{const v=M=>{try{const D=M&&M.target;if(!b||!b.classList.contains("is-open")&&b.style&&b.style.display!=="block"||D&&(b.contains(D)||f&&(D===f||f.contains&&f.contains(D))))return;if(y){y.classList.remove("is-active");try{document.documentElement.classList.remove("nimbi-search-open")}catch{}}try{b.style.display="none"}catch{}try{b.classList.remove("is-open")}catch{}}catch{}};document.addEventListener("click",v,!0),document.addEventListener("touchstart",v,!0)}catch{}}const Fe=document.createDocumentFragment();for(let R=0;R<p.length;R++){const P=p[R];if(R===0)continue;const C=P.getAttribute("href")||"#";let v=C;const M=document.createElement("a");M.className="navbar-item";try{let D=null;try{D=Je(String(C||""))}catch{D=null}let K=null,j=null;if(D&&(D.type==="canonical"&&D.page||D.type==="cosmetic"&&D.page)&&(K=D.page,j=D.anchor),K&&(/\.(?:md|html?)$/i.test(K)||K.includes("/")?v=K:M.href=Pe(K,j)),/^[^#]*\.md(?:$|[#?])/.test(v)||v.endsWith(".md")){const T=Y(v).split(/::|#/,2),B=T[0],Q=T[1],se=G(B);se?M.href=Pe(se,Q):M.href=Pe(B,Q)}else if(/\.html(?:$|[#?])/.test(v)||v.endsWith(".html")){const T=Y(v).split(/::|#/,2);let B=T[0];B&&!B.toLowerCase().endsWith(".html")&&(B=B+".html");const Q=T[1],se=G(B);if(se)M.href=Pe(se,Q);else try{const me=await Be(B,i);if(me&&me.raw)try{const be=He(),ge=be?be.parseFromString(me.raw,"text/html"):null,we=ge?ge.querySelector("title"):null,ve=ge?ge.querySelector("h1"):null,Ie=we&&we.textContent&&we.textContent.trim()?we.textContent.trim():ve&&ve.textContent?ve.textContent.trim():null;if(Ie){const Ge=he(Ie);if(Ge){try{nn(Ge,B)}catch(Et){k("[nimbi-cms] slugToMd/mdToSlug set failed",Et)}M.href=Pe(Ge,Q)}else M.href=Pe(B,Q)}else M.href=Pe(B,Q)}catch{M.href=Pe(B,Q)}else M.href=v}catch{M.href=v}}else M.href=v}catch(D){k("[nimbi-cms] nav item href parse failed",D),M.href=v}try{const D=P.textContent&&String(P.textContent).trim()?String(P.textContent).trim():null;if(D)try{const K=he(D);if(K){const j=M.getAttribute("href")||"";let $=null;if(/^[^#?]*\.(?:md|html?)(?:$|[?#])/i.test(j))$=Y(String(j||"").split(/[?#]/)[0]);else try{const T=Je(j);T&&T.type==="canonical"&&T.page&&($=Y(T.page))}catch{}if($){let T=!1;try{if(/\.(?:html?)(?:$|[?#])/i.test(String($||"")))T=!0;else if(/\.(?:md)(?:$|[?#])/i.test(String($||"")))T=!1;else{const B=String($||"").replace(/^\.\//,""),Q=B.replace(/^.*\//,"");$e&&$e.size&&($e.has(B)||$e.has(Q))&&(T=!0)}}catch{T=!1}if(T)try{const B=Y(String($||"").split(/[?#]/)[0]);let Q=!1;try{G&&typeof G=="function"&&G(B)&&(Q=!0)}catch{}try{nn(K,$)}catch{}try{if(B){try{E.set(B,K)}catch{}try{const se=B.replace(/^.*\//,"");se&&E.set(se,K)}catch{}}}catch{}if(Q)try{M.href=Pe(K)}catch{}}catch{}}}}catch(K){k("[nimbi-cms] nav slug mapping failed",K)}}catch(D){k("[nimbi-cms] nav slug mapping failed",D)}M.textContent=P.textContent||v,Fe.appendChild(M)}try{xe.appendChild(Fe)}catch{}ze.appendChild(xe),Se&&ze.appendChild(Se),O.appendChild(W),O.appendChild(ze),e.appendChild(O);try{const R=P=>{try{const C=typeof O<"u"&&O&&O.querySelector?O.querySelector(".navbar-burger"):e&&e.querySelector?e.querySelector(".navbar-burger"):typeof document<"u"?document.querySelector(".navbar-burger"):null;if(!C||!C.classList.contains("is-active"))return;const v=C&&C.closest?C.closest(".navbar"):O;if(v&&v.contains(P.target))return;I()}catch{}};document.addEventListener("click",R,!0),document.addEventListener("touchstart",R,!0)}catch{}try{ze.addEventListener("click",R=>{const P=R.target&&R.target.closest?R.target.closest("a"):null;if(!P)return;const C=P.getAttribute("href")||"";try{const v=new URL(C,location.href),M=v.searchParams.get("page"),D=v.hash?v.hash.replace(/^#/,""):null;M&&(R.preventDefault(),history.pushState({page:M},"",Pe(M,D)),N())}catch(v){k("[nimbi-cms] navbar click handler failed",v)}try{const v=typeof O<"u"&&O&&O.querySelector?O.querySelector(".navbar-burger"):e&&e.querySelector?e.querySelector(".navbar-burger"):null,M=v&&v.dataset?v.dataset.target:null,D=M?O&&O.querySelector?O.querySelector(`#${M}`)||(e&&e.querySelector?e.querySelector(`#${M}`):document.getElementById(M)):e&&e.querySelector?e.querySelector(`#${M}`)||document.getElementById(M):typeof document<"u"?document.getElementById(M):null:null;v&&v.classList.contains("is-active")&&(v.classList.remove("is-active"),v.setAttribute("aria-expanded","false"),D&&D.classList.remove("is-active"))}catch(v){k("[nimbi-cms] mobile menu close failed",v)}})}catch(R){k("[nimbi-cms] attach content click handler failed",R)}try{t.addEventListener("click",R=>{const P=R.target&&R.target.closest?R.target.closest("a"):null;if(!P)return;const C=P.getAttribute("href")||"";if(C&&!jr(C))try{const v=new URL(C,location.href),M=v.searchParams.get("page"),D=v.hash?v.hash.replace(/^#/,""):null;M&&(R.preventDefault(),history.pushState({page:M},"",Pe(M,D)),N())}catch(v){k("[nimbi-cms] container click URL parse failed",v)}})}catch(R){k("[nimbi-cms] build navbar failed",R)}return{navbar:O,linkEls:p}}try{document.addEventListener("input",e=>{try{if(e&&e.target&&e.target.id==="nimbi-search"){const t=document.getElementById("nimbi-search-results");if(t&&e.target&&e.target.value)try{t.style.display="block"}catch{}}}catch{}},!0)}catch{}let nt=null,de=null,Xe=1,St=(e,t)=>t,Cn=0,Mn=0,rr=()=>{},kn=.25;function Ac(){if(nt&&document.contains(nt))return nt;nt=null;const e=document.createElement("dialog");e.className="nimbi-image-preview modal",e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.setAttribute("aria-label",St("imagePreviewTitle","Image preview"));try{const L=document.createElement("div");L.className="modal-background";const F=document.createElement("div");F.className="modal-content";const G=document.createElement("div");G.className="nimbi-image-preview__content box",G.setAttribute("role","document");const ie=document.createElement("button");ie.className="button is-small nimbi-image-preview__close",ie.type="button",ie.setAttribute("data-nimbi-preview-close",""),ie.textContent="✕";const pe=document.createElement("div");pe.className="nimbi-image-preview__image-wrapper";const J=document.createElement("img");J.setAttribute("data-nimbi-preview-image",""),J.alt="",pe.appendChild(J);const ze=document.createElement("div");ze.className="nimbi-image-preview__controls";const xe=document.createElement("div");xe.className="nimbi-image-preview__group";const Se=document.createElement("button");Se.className="button is-small",Se.type="button",Se.setAttribute("data-nimbi-preview-fit",""),Se.textContent="⤢";const Ee=document.createElement("button");Ee.className="button is-small",Ee.type="button",Ee.setAttribute("data-nimbi-preview-original",""),Ee.textContent="1:1";const Fe=document.createElement("button");Fe.className="button is-small",Fe.type="button",Fe.setAttribute("data-nimbi-preview-reset",""),Fe.textContent="⟲",xe.appendChild(Se),xe.appendChild(Ee),xe.appendChild(Fe);const R=document.createElement("div");R.className="nimbi-image-preview__group";const P=document.createElement("button");P.className="button is-small",P.type="button",P.setAttribute("data-nimbi-preview-zoom-out",""),P.textContent="−";const C=document.createElement("div");C.className="nimbi-image-preview__zoom",C.setAttribute("data-nimbi-preview-zoom-label",""),C.textContent="100%";const v=document.createElement("button");v.className="button is-small",v.type="button",v.setAttribute("data-nimbi-preview-zoom-in",""),v.textContent="＋",R.appendChild(P),R.appendChild(C),R.appendChild(v),ze.appendChild(xe),ze.appendChild(R),G.appendChild(ie),G.appendChild(pe),G.appendChild(ze),F.appendChild(G),e.appendChild(L),e.appendChild(F)}catch{e.innerHTML=`
...
`,n}function ei(e){const t=e&&Array.isArray(e.entries)?e.entries:Array.isArray(e)?e:[],n=vi().split("?")[0];let i=`<?xml version="1.0" encoding="UTF-8"?>
`;i+=`<rss version="2.0">
`,i+=`<channel>
...
`,i+=`</rss>
`,i}function ti(e){const t=e&&Array.isArray(e.entries)?e.entries:Array.isArray(e)?e:[],n=vi().split("?")[0],i=e&&e.generatedAt?new Date(e.generatedAt).toISOString():new Date().toISOString();let r=`<?xml version="1.0" encoding="utf-8"?>
