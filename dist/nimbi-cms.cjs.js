"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const Lt={onPageLoad:[],onNavBuild:[],transformHtml:[]};function rn(t,e){if(!Object.prototype.hasOwnProperty.call(Lt,t))throw new Error('Unknown hook "'+t+'"');if(typeof e!="function")throw new TypeError("hook callback must be a function");Lt[t].push(e)}function ys(t){rn("onPageLoad",t)}function ks(t){rn("onNavBuild",t)}function xs(t){rn("transformHtml",t)}async function vn(t,e){const n=Lt[t]||[];for(const s of n)try{await s(e)}catch(r){console.warn("[nimbi-cms] runHooks callback failed",r)}}function Ss(){Object.keys(Lt).forEach(t=>{Lt[t].length=0})}function Br(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var mn,fr;function vs(){if(fr)return mn;fr=1;function t(w){return w instanceof Map?w.clear=w.delete=w.set=function(){throw new Error("map is read-only")}:w instanceof Set&&(w.add=w.clear=w.delete=function(){throw new Error("set is read-only")}),Object.freeze(w),Object.getOwnPropertyNames(w).forEach(x=>{const L=w[x],K=typeof L;(K==="object"||K==="function")&&!Object.isFrozen(L)&&t(L)}),w}class e{constructor(x){x.data===void 0&&(x.data={}),this.data=x.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function n(w){return w.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function s(w,...x){const L=Object.create(null);for(const K in w)L[K]=w[K];return x.forEach(function(K){for(const we in K)L[we]=K[we]}),L}const r="</span>",i=w=>!!w.scope,a=(w,{prefix:x})=>{if(w.startsWith("language:"))return w.replace("language:","language-");if(w.includes(".")){const L=w.split(".");return[`${x}${L.shift()}`,...L.map((K,we)=>`${K}${"_".repeat(we+1)}`)].join(" ")}return`${x}${w}`};class c{constructor(x,L){this.buffer="",this.classPrefix=L.classPrefix,x.walk(this)}addText(x){this.buffer+=n(x)}openNode(x){if(!i(x))return;const L=a(x.scope,{prefix:this.classPrefix});this.span(L)}closeNode(x){i(x)&&(this.buffer+=r)}value(){return this.buffer}span(x){this.buffer+=`<span class="${x}">`}}const o=(w={})=>{const x={children:[]};return Object.assign(x,w),x};class u{constructor(){this.rootNode=o(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(x){this.top.children.push(x)}openNode(x){const L=o({scope:x});this.add(L),this.stack.push(L)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(x){return this.constructor._walk(x,this.rootNode)}static _walk(x,L){return typeof L=="string"?x.addText(L):L.children&&(x.openNode(L),L.children.forEach(K=>this._walk(x,K)),x.closeNode(L)),x}static _collapse(x){typeof x!="string"&&x.children&&(x.children.every(L=>typeof L=="string")?x.children=[x.children.join("")]:x.children.forEach(L=>{u._collapse(L)}))}}class l extends u{constructor(x){super(),this.options=x}addText(x){x!==""&&this.add(x)}startScope(x){this.openNode(x)}endScope(){this.closeNode()}__addSublanguage(x,L){const K=x.root;L&&(K.scope=`language:${L}`),this.add(K)}toHTML(){return new c(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function d(w){return w?typeof w=="string"?w:w.source:null}function p(w){return g("(?=",w,")")}function f(w){return g("(?:",w,")*")}function h(w){return g("(?:",w,")?")}function g(...w){return w.map(L=>d(L)).join("")}function m(w){const x=w[w.length-1];return typeof x=="object"&&x.constructor===Object?(w.splice(w.length-1,1),x):{}}function b(...w){return"("+(m(w).capture?"":"?:")+w.map(K=>d(K)).join("|")+")"}function k(w){return new RegExp(w.toString()+"|").exec("").length-1}function A(w,x){const L=w&&w.exec(x);return L&&L.index===0}const C=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function M(w,{joinWith:x}){let L=0;return w.map(K=>{L+=1;const we=L;let be=d(K),N="";for(;be.length>0;){const P=C.exec(be);if(!P){N+=be;break}N+=be.substring(0,P.index),be=be.substring(P.index+P[0].length),P[0][0]==="\\"&&P[1]?N+="\\"+String(Number(P[1])+we):(N+=P[0],P[0]==="("&&L++)}return N}).map(K=>`(${K})`).join(x)}const z=/\b\B/,Z="[a-zA-Z]\\w*",V="[a-zA-Z_]\\w*",ie="\\b\\d+(\\.\\d+)?",J="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",W="\\b(0b[01]+)",X="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",D=(w={})=>{const x=/^#![ ]*\//;return w.binary&&(w.begin=g(x,/.*\b/,w.binary,/\b.*/)),s({scope:"meta",begin:x,end:/$/,relevance:0,"on:begin":(L,K)=>{L.index!==0&&K.ignoreMatch()}},w)},he={begin:"\\\\[\\s\\S]",relevance:0},F={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[he]},S={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[he]},re={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},Q=function(w,x,L={}){const K=s({scope:"comment",begin:w,end:x,contains:[]},L);K.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const we=b("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return K.contains.push({begin:g(/[ ]+/,"(",we,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),K},v=Q("//","$"),$=Q("/\\*","\\*/"),y=Q("#","$"),R={scope:"number",begin:ie,relevance:0},I={scope:"number",begin:J,relevance:0},_={scope:"number",begin:W,relevance:0},O={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[he,{begin:/\[/,end:/\]/,relevance:0,contains:[he]}]},B={scope:"title",begin:Z,relevance:0},ce={scope:"title",begin:V,relevance:0},ge={begin:"\\.\\s*"+V,relevance:0};var Pe=Object.freeze({__proto__:null,APOS_STRING_MODE:F,BACKSLASH_ESCAPE:he,BINARY_NUMBER_MODE:_,BINARY_NUMBER_RE:W,COMMENT:Q,C_BLOCK_COMMENT_MODE:$,C_LINE_COMMENT_MODE:v,C_NUMBER_MODE:I,C_NUMBER_RE:J,END_SAME_AS_BEGIN:function(w){return Object.assign(w,{"on:begin":(x,L)=>{L.data._beginMatch=x[1]},"on:end":(x,L)=>{L.data._beginMatch!==x[1]&&L.ignoreMatch()}})},HASH_COMMENT_MODE:y,IDENT_RE:Z,MATCH_NOTHING_RE:z,METHOD_GUARD:ge,NUMBER_MODE:R,NUMBER_RE:ie,PHRASAL_WORDS_MODE:re,QUOTE_STRING_MODE:S,REGEXP_MODE:O,RE_STARTERS_RE:X,SHEBANG:D,TITLE_MODE:B,UNDERSCORE_IDENT_RE:V,UNDERSCORE_TITLE_MODE:ce});function ft(w,x){w.input[w.index-1]==="."&&x.ignoreMatch()}function It(w,x){w.className!==void 0&&(w.scope=w.className,delete w.className)}function it(w,x){x&&w.beginKeywords&&(w.begin="\\b("+w.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",w.__beforeBegin=ft,w.keywords=w.keywords||w.beginKeywords,delete w.beginKeywords,w.relevance===void 0&&(w.relevance=0))}function ln(w,x){Array.isArray(w.illegal)&&(w.illegal=b(...w.illegal))}function qi(w,x){if(w.match){if(w.begin||w.end)throw new Error("begin & end are not supported with match");w.begin=w.match,delete w.match}}function Di(w,x){w.relevance===void 0&&(w.relevance=1)}const Hi=(w,x)=>{if(!w.beforeMatch)return;if(w.starts)throw new Error("beforeMatch cannot be used with starts");const L=Object.assign({},w);Object.keys(w).forEach(K=>{delete w[K]}),w.keywords=L.keywords,w.begin=g(L.beforeMatch,p(L.begin)),w.starts={relevance:0,contains:[Object.assign(L,{endsParent:!0})]},w.relevance=0,delete L.beforeMatch},Ui=["of","and","for","in","not","or","if","then","parent","list","value"],ji="keyword";function Yn(w,x,L=ji){const K=Object.create(null);return typeof w=="string"?we(L,w.split(" ")):Array.isArray(w)?we(L,w):Object.keys(w).forEach(function(be){Object.assign(K,Yn(w[be],x,be))}),K;function we(be,N){x&&(N=N.map(P=>P.toLowerCase())),N.forEach(function(P){const G=P.split("|");K[G[0]]=[be,Fi(G[0],G[1])]})}}function Fi(w,x){return x?Number(x):Wi(w)?0:1}function Wi(w){return Ui.includes(w.toLowerCase())}const Vn={},Ve=w=>{console.error(w)},Jn=(w,...x)=>{console.log(`WARN: ${w}`,...x)},st=(w,x)=>{Vn[`${w}/${x}`]||(console.log(`Deprecated as of ${w}. ${x}`),Vn[`${w}/${x}`]=!0)},zt=new Error;function er(w,x,{key:L}){let K=0;const we=w[L],be={},N={};for(let P=1;P<=x.length;P++)N[P+K]=we[P],be[P+K]=!0,K+=k(x[P-1]);w[L]=N,w[L]._emit=be,w[L]._multi=!0}function Zi(w){if(Array.isArray(w.begin)){if(w.skip||w.excludeBegin||w.returnBegin)throw Ve("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),zt;if(typeof w.beginScope!="object"||w.beginScope===null)throw Ve("beginScope must be object"),zt;er(w,w.begin,{key:"beginScope"}),w.begin=M(w.begin,{joinWith:""})}}function Gi(w){if(Array.isArray(w.end)){if(w.skip||w.excludeEnd||w.returnEnd)throw Ve("skip, excludeEnd, returnEnd not compatible with endScope: {}"),zt;if(typeof w.endScope!="object"||w.endScope===null)throw Ve("endScope must be object"),zt;er(w,w.end,{key:"endScope"}),w.end=M(w.end,{joinWith:""})}}function Qi(w){w.scope&&typeof w.scope=="object"&&w.scope!==null&&(w.beginScope=w.scope,delete w.scope)}function Xi(w){Qi(w),typeof w.beginScope=="string"&&(w.beginScope={_wrap:w.beginScope}),typeof w.endScope=="string"&&(w.endScope={_wrap:w.endScope}),Zi(w),Gi(w)}function Ki(w){function x(N,P){return new RegExp(d(N),"m"+(w.case_insensitive?"i":"")+(w.unicodeRegex?"u":"")+(P?"g":""))}class L{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(P,G){G.position=this.position++,this.matchIndexes[this.matchAt]=G,this.regexes.push([G,P]),this.matchAt+=k(P)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const P=this.regexes.map(G=>G[1]);this.matcherRe=x(M(P,{joinWith:"|"}),!0),this.lastIndex=0}exec(P){this.matcherRe.lastIndex=this.lastIndex;const G=this.matcherRe.exec(P);if(!G)return null;const Se=G.findIndex((pt,un)=>un>0&&pt!==void 0),ye=this.matchIndexes[Se];return G.splice(0,Se),Object.assign(G,ye)}}class K{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(P){if(this.multiRegexes[P])return this.multiRegexes[P];const G=new L;return this.rules.slice(P).forEach(([Se,ye])=>G.addRule(Se,ye)),G.compile(),this.multiRegexes[P]=G,G}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(P,G){this.rules.push([P,G]),G.type==="begin"&&this.count++}exec(P){const G=this.getMatcher(this.regexIndex);G.lastIndex=this.lastIndex;let Se=G.exec(P);if(this.resumingScanAtSamePosition()&&!(Se&&Se.index===this.lastIndex)){const ye=this.getMatcher(0);ye.lastIndex=this.lastIndex+1,Se=ye.exec(P)}return Se&&(this.regexIndex+=Se.position+1,this.regexIndex===this.count&&this.considerAll()),Se}}function we(N){const P=new K;return N.contains.forEach(G=>P.addRule(G.begin,{rule:G,type:"begin"})),N.terminatorEnd&&P.addRule(N.terminatorEnd,{type:"end"}),N.illegal&&P.addRule(N.illegal,{type:"illegal"}),P}function be(N,P){const G=N;if(N.isCompiled)return G;[It,qi,Xi,Hi].forEach(ye=>ye(N,P)),w.compilerExtensions.forEach(ye=>ye(N,P)),N.__beforeBegin=null,[it,ln,Di].forEach(ye=>ye(N,P)),N.isCompiled=!0;let Se=null;return typeof N.keywords=="object"&&N.keywords.$pattern&&(N.keywords=Object.assign({},N.keywords),Se=N.keywords.$pattern,delete N.keywords.$pattern),Se=Se||/\w+/,N.keywords&&(N.keywords=Yn(N.keywords,w.case_insensitive)),G.keywordPatternRe=x(Se,!0),P&&(N.begin||(N.begin=/\B|\b/),G.beginRe=x(G.begin),!N.end&&!N.endsWithParent&&(N.end=/\B|\b/),N.end&&(G.endRe=x(G.end)),G.terminatorEnd=d(G.end)||"",N.endsWithParent&&P.terminatorEnd&&(G.terminatorEnd+=(N.end?"|":"")+P.terminatorEnd)),N.illegal&&(G.illegalRe=x(N.illegal)),N.contains||(N.contains=[]),N.contains=[].concat(...N.contains.map(function(ye){return Yi(ye==="self"?N:ye)})),N.contains.forEach(function(ye){be(ye,G)}),N.starts&&be(N.starts,P),G.matcher=we(G),G}if(w.compilerExtensions||(w.compilerExtensions=[]),w.contains&&w.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return w.classNameAliases=s(w.classNameAliases||{}),be(w)}function tr(w){return w?w.endsWithParent||tr(w.starts):!1}function Yi(w){return w.variants&&!w.cachedVariants&&(w.cachedVariants=w.variants.map(function(x){return s(w,{variants:null},x)})),w.cachedVariants?w.cachedVariants:tr(w)?s(w,{starts:w.starts?s(w.starts):null}):Object.isFrozen(w)?s(w):w}var Vi="11.11.1";class Ji extends Error{constructor(x,L){super(x),this.name="HTMLInjectionError",this.html=L}}const cn=n,nr=s,rr=Symbol("nomatch"),es=7,ir=function(w){const x=Object.create(null),L=Object.create(null),K=[];let we=!0;const be="Could not find the language '{}', did you forget to load/include a language module?",N={disableAutodetect:!0,name:"Plain text",contains:[]};let P={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:l};function G(E){return P.noHighlightRe.test(E)}function Se(E){let H=E.className+" ";H+=E.parentNode?E.parentNode.className:"";const se=P.languageDetectRe.exec(H);if(se){const de=We(se[1]);return de||(Jn(be.replace("{}",se[1])),Jn("Falling back to no-highlight mode for this block.",E)),de?se[1]:"no-highlight"}return H.split(/\s+/).find(de=>G(de)||We(de))}function ye(E,H,se){let de="",ke="";typeof H=="object"?(de=E,se=H.ignoreIllegals,ke=H.language):(st("10.7.0","highlight(lang, code, ...args) has been deprecated."),st("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),ke=E,de=H),se===void 0&&(se=!0);const Ie={code:de,language:ke};Nt("before:highlight",Ie);const Ze=Ie.result?Ie.result:pt(Ie.language,Ie.code,se);return Ze.code=Ie.code,Nt("after:highlight",Ze),Ze}function pt(E,H,se,de){const ke=Object.create(null);function Ie(T,q){return T.keywords[q]}function Ze(){if(!Y.keywords){Ae.addText(fe);return}let T=0;Y.keywordPatternRe.lastIndex=0;let q=Y.keywordPatternRe.exec(fe),ee="";for(;q;){ee+=fe.substring(T,q.index);const ue=Oe.case_insensitive?q[0].toLowerCase():q[0],Ee=Ie(Y,ue);if(Ee){const[Ue,ws]=Ee;if(Ae.addText(ee),ee="",ke[ue]=(ke[ue]||0)+1,ke[ue]<=es&&(Dt+=ws),Ue.startsWith("_"))ee+=q[0];else{const bs=Oe.classNameAliases[Ue]||Ue;Ne(q[0],bs)}}else ee+=q[0];T=Y.keywordPatternRe.lastIndex,q=Y.keywordPatternRe.exec(fe)}ee+=fe.substring(T),Ae.addText(ee)}function Ot(){if(fe==="")return;let T=null;if(typeof Y.subLanguage=="string"){if(!x[Y.subLanguage]){Ae.addText(fe);return}T=pt(Y.subLanguage,fe,!0,dr[Y.subLanguage]),dr[Y.subLanguage]=T._top}else T=hn(fe,Y.subLanguage.length?Y.subLanguage:null);Y.relevance>0&&(Dt+=T.relevance),Ae.__addSublanguage(T._emitter,T.language)}function Ce(){Y.subLanguage!=null?Ot():Ze(),fe=""}function Ne(T,q){T!==""&&(Ae.startScope(q),Ae.addText(T),Ae.endScope())}function lr(T,q){let ee=1;const ue=q.length-1;for(;ee<=ue;){if(!T._emit[ee]){ee++;continue}const Ee=Oe.classNameAliases[T[ee]]||T[ee],Ue=q[ee];Ee?Ne(Ue,Ee):(fe=Ue,Ze(),fe=""),ee++}}function cr(T,q){return T.scope&&typeof T.scope=="string"&&Ae.openNode(Oe.classNameAliases[T.scope]||T.scope),T.beginScope&&(T.beginScope._wrap?(Ne(fe,Oe.classNameAliases[T.beginScope._wrap]||T.beginScope._wrap),fe=""):T.beginScope._multi&&(lr(T.beginScope,q),fe="")),Y=Object.create(T,{parent:{value:Y}}),Y}function ur(T,q,ee){let ue=A(T.endRe,ee);if(ue){if(T["on:end"]){const Ee=new e(T);T["on:end"](q,Ee),Ee.isMatchIgnored&&(ue=!1)}if(ue){for(;T.endsParent&&T.parent;)T=T.parent;return T}}if(T.endsWithParent)return ur(T.parent,q,ee)}function ds(T){return Y.matcher.regexIndex===0?(fe+=T[0],1):(gn=!0,0)}function fs(T){const q=T[0],ee=T.rule,ue=new e(ee),Ee=[ee.__beforeBegin,ee["on:begin"]];for(const Ue of Ee)if(Ue&&(Ue(T,ue),ue.isMatchIgnored))return ds(q);return ee.skip?fe+=q:(ee.excludeBegin&&(fe+=q),Ce(),!ee.returnBegin&&!ee.excludeBegin&&(fe=q)),cr(ee,T),ee.returnBegin?0:q.length}function ps(T){const q=T[0],ee=H.substring(T.index),ue=ur(Y,T,ee);if(!ue)return rr;const Ee=Y;Y.endScope&&Y.endScope._wrap?(Ce(),Ne(q,Y.endScope._wrap)):Y.endScope&&Y.endScope._multi?(Ce(),lr(Y.endScope,T)):Ee.skip?fe+=q:(Ee.returnEnd||Ee.excludeEnd||(fe+=q),Ce(),Ee.excludeEnd&&(fe=q));do Y.scope&&Ae.closeNode(),!Y.skip&&!Y.subLanguage&&(Dt+=Y.relevance),Y=Y.parent;while(Y!==ue.parent);return ue.starts&&cr(ue.starts,T),Ee.returnEnd?0:q.length}function gs(){const T=[];for(let q=Y;q!==Oe;q=q.parent)q.scope&&T.unshift(q.scope);T.forEach(q=>Ae.openNode(q))}let qt={};function hr(T,q){const ee=q&&q[0];if(fe+=T,ee==null)return Ce(),0;if(qt.type==="begin"&&q.type==="end"&&qt.index===q.index&&ee===""){if(fe+=H.slice(q.index,q.index+1),!we){const ue=new Error(`0 width match regex (${E})`);throw ue.languageName=E,ue.badRule=qt.rule,ue}return 1}if(qt=q,q.type==="begin")return fs(q);if(q.type==="illegal"&&!se){const ue=new Error('Illegal lexeme "'+ee+'" for mode "'+(Y.scope||"<unnamed>")+'"');throw ue.mode=Y,ue}else if(q.type==="end"){const ue=ps(q);if(ue!==rr)return ue}if(q.type==="illegal"&&ee==="")return fe+=`
`,1;if(pn>1e5&&pn>q.index*3)throw new Error("potential infinite loop, way more iterations than matches");return fe+=ee,ee.length}const Oe=We(E);if(!Oe)throw Ve(be.replace("{}",E)),new Error('Unknown language: "'+E+'"');const ms=Ki(Oe);let fn="",Y=de||ms;const dr={},Ae=new P.__emitter(P);gs();let fe="",Dt=0,Je=0,pn=0,gn=!1;try{if(Oe.__emitTokens)Oe.__emitTokens(H,Ae);else{for(Y.matcher.considerAll();;){pn++,gn?gn=!1:Y.matcher.considerAll(),Y.matcher.lastIndex=Je;const T=Y.matcher.exec(H);if(!T)break;const q=H.substring(Je,T.index),ee=hr(q,T);Je=T.index+ee}hr(H.substring(Je))}return Ae.finalize(),fn=Ae.toHTML(),{language:E,value:fn,relevance:Dt,illegal:!1,_emitter:Ae,_top:Y}}catch(T){if(T.message&&T.message.includes("Illegal"))return{language:E,value:cn(H),illegal:!0,relevance:0,_illegalBy:{message:T.message,index:Je,context:H.slice(Je-100,Je+100),mode:T.mode,resultSoFar:fn},_emitter:Ae};if(we)return{language:E,value:cn(H),illegal:!1,relevance:0,errorRaised:T,_emitter:Ae,_top:Y};throw T}}function un(E){const H={value:cn(E),illegal:!1,relevance:0,_top:N,_emitter:new P.__emitter(P)};return H._emitter.addText(E),H}function hn(E,H){H=H||P.languages||Object.keys(x);const se=un(E),de=H.filter(We).filter(or).map(Ce=>pt(Ce,E,!1));de.unshift(se);const ke=de.sort((Ce,Ne)=>{if(Ce.relevance!==Ne.relevance)return Ne.relevance-Ce.relevance;if(Ce.language&&Ne.language){if(We(Ce.language).supersetOf===Ne.language)return 1;if(We(Ne.language).supersetOf===Ce.language)return-1}return 0}),[Ie,Ze]=ke,Ot=Ie;return Ot.secondBest=Ze,Ot}function ts(E,H,se){const de=H&&L[H]||se;E.classList.add("hljs"),E.classList.add(`language-${de}`)}function dn(E){let H=null;const se=Se(E);if(G(se))return;if(Nt("before:highlightElement",{el:E,language:se}),E.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",E);return}if(E.children.length>0&&(P.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(E)),P.throwUnescapedHTML))throw new Ji("One of your code blocks includes unescaped HTML.",E.innerHTML);H=E;const de=H.textContent,ke=se?ye(de,{language:se,ignoreIllegals:!0}):hn(de);E.innerHTML=ke.value,E.dataset.highlighted="yes",ts(E,se,ke.language),E.result={language:ke.language,re:ke.relevance,relevance:ke.relevance},ke.secondBest&&(E.secondBest={language:ke.secondBest.language,relevance:ke.secondBest.relevance}),Nt("after:highlightElement",{el:E,result:ke,text:de})}function ns(E){P=nr(P,E)}const rs=()=>{Bt(),st("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function is(){Bt(),st("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let sr=!1;function Bt(){function E(){Bt()}if(document.readyState==="loading"){sr||window.addEventListener("DOMContentLoaded",E,!1),sr=!0;return}document.querySelectorAll(P.cssSelector).forEach(dn)}function ss(E,H){let se=null;try{se=H(w)}catch(de){if(Ve("Language definition for '{}' could not be registered.".replace("{}",E)),we)Ve(de);else throw de;se=N}se.name||(se.name=E),x[E]=se,se.rawDefinition=H.bind(null,w),se.aliases&&ar(se.aliases,{languageName:E})}function as(E){delete x[E];for(const H of Object.keys(L))L[H]===E&&delete L[H]}function os(){return Object.keys(x)}function We(E){return E=(E||"").toLowerCase(),x[E]||x[L[E]]}function ar(E,{languageName:H}){typeof E=="string"&&(E=[E]),E.forEach(se=>{L[se.toLowerCase()]=H})}function or(E){const H=We(E);return H&&!H.disableAutodetect}function ls(E){E["before:highlightBlock"]&&!E["before:highlightElement"]&&(E["before:highlightElement"]=H=>{E["before:highlightBlock"](Object.assign({block:H.el},H))}),E["after:highlightBlock"]&&!E["after:highlightElement"]&&(E["after:highlightElement"]=H=>{E["after:highlightBlock"](Object.assign({block:H.el},H))})}function cs(E){ls(E),K.push(E)}function us(E){const H=K.indexOf(E);H!==-1&&K.splice(H,1)}function Nt(E,H){const se=E;K.forEach(function(de){de[se]&&de[se](H)})}function hs(E){return st("10.7.0","highlightBlock will be removed entirely in v12.0"),st("10.7.0","Please use highlightElement now."),dn(E)}Object.assign(w,{highlight:ye,highlightAuto:hn,highlightAll:Bt,highlightElement:dn,highlightBlock:hs,configure:ns,initHighlighting:rs,initHighlightingOnLoad:is,registerLanguage:ss,unregisterLanguage:as,listLanguages:os,getLanguage:We,registerAliases:ar,autoDetection:or,inherit:nr,addPlugin:cs,removePlugin:us}),w.debugMode=function(){we=!1},w.safeMode=function(){we=!0},w.versionString=Vi,w.regex={concat:g,lookahead:p,either:b,optional:h,anyNumberOfTimes:f};for(const E in Pe)typeof Pe[E]=="object"&&t(Pe[E]);return Object.assign(w,Pe),w},at=ir({});return at.newInstance=()=>ir({}),mn=at,at.HighlightJS=at,at.default=at,mn}var As=vs();const pe=Br(As),Es="11.11.1",ne=new Map,Rs="https://raw.githubusercontent.com/highlightjs/highlight.js/main/SUPPORTED_LANGUAGES.md",Me={shell:"bash",sh:"bash",zsh:"bash",js:"javascript",ts:"typescript",py:"python",csharp:"cs","c#":"cs"};Me.html="xml";Me.xhtml="xml";Me.markup="xml";const Pn=new Set(["magic","undefined"]);let Xe=null;const wn=new Map,Ls=300*1e3;async function In(t=Rs){if(t)return Xe||(Xe=(async()=>{try{const e=await fetch(t);if(!e.ok)return;const s=(await e.text()).split(/\r?\n/);let r=-1;for(let u=0;u<s.length;u++)if(/\|\s*Language\s*\|/i.test(s[u])){r=u;break}if(r===-1)return;const i=s[r].replace(/^\||\|$/g,"").split("|").map(u=>u.trim().toLowerCase());let a=i.findIndex(u=>/alias|aliases|equivalent|alt|alternates?/i.test(u));a===-1&&(a=1);let c=i.findIndex(u=>/file|filename|module|module name|module-name|short|slug/i.test(u));if(c===-1){const u=i.findIndex(l=>/language/i.test(l));c=u!==-1?u:0}let o=[];for(let u=r+1;u<s.length;u++){const l=s[u].trim();if(!l||!l.startsWith("|"))break;const d=l.replace(/^\||\|$/g,"").split("|").map(m=>m.trim());if(d.every(m=>/^-+$/.test(m)))continue;const p=d;if(!p.length)continue;const h=(p[c]||p[0]||"").toString().trim().toLowerCase();if(!h||/^-+$/.test(h))continue;ne.set(h,h);const g=p[a]||"";if(g){const m=String(g).split(",").map(b=>b.replace(/`/g,"").trim()).filter(Boolean);if(m.length){const k=m[0].toLowerCase().replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");k&&/[a-z0-9]/i.test(k)&&(ne.set(k,k),o.push(k))}}}try{const u=[];for(const l of o){const d=String(l||"").replace(/^[:]+/,"").replace(/[^a-z0-9_-]+/ig,"");d&&/[a-z0-9]/i.test(d)?u.push(d):ne.delete(l)}o=u}catch(u){console.warn("[codeblocksManager] cleanup aliases failed",u)}try{let u=0;for(const l of Array.from(ne.keys())){if(!l||/^-+$/.test(l)||!/[a-z0-9]/i.test(l)){ne.delete(l),u++;continue}if(/^[:]+/.test(l)){const d=l.replace(/^[:]+/,"");if(d&&/[a-z0-9]/i.test(d)){const p=ne.get(l);ne.delete(l),ne.set(d,p)}else ne.delete(l),u++}}for(const[l,d]of Array.from(ne.entries()))(!d||/^-+$/.test(d)||!/[a-z0-9]/i.test(d))&&(ne.delete(l),u++);try{const l=":---------------------";ne.has(l)&&(ne.delete(l),u++)}catch(l){console.warn("[codeblocksManager] remove sep key failed",l)}try{const l=Array.from(ne.keys()).sort()}catch(l){console.warn("[codeblocksManager] compute supported keys failed",l)}}catch(u){console.warn("[codeblocksManager] ignored error",u)}}catch(e){console.warn("[codeblocksManager] loadSupportedLanguages failed",e)}})(),Xe)}const gt=new Set;async function ht(t,e){if(Xe||(async()=>{try{await In()}catch(r){console.warn("[codeblocksManager] loadSupportedLanguages (IIFE) failed",r)}})(),Xe)try{await Xe}catch{}if(t=t==null?"":String(t),t=t.trim(),!t)return!1;const n=t.toLowerCase();if(Pn.has(n))return!1;if(ne.size&&!ne.has(n)){const r=Me;if(!r[n]&&!r[t])return!1}if(gt.has(t))return!0;const s=Me;try{const r=(e||t||"").toString().replace(/\.js$/i,"").trim(),i=(s[t]||t||"").toString(),a=(s[r]||r||"").toString();let c=Array.from(new Set([i,a,r,t,s[r],s[t]].filter(Boolean))).map(l=>String(l).toLowerCase()).filter(l=>l&&l!=="undefined");ne.size&&(c=c.filter(l=>{if(ne.has(l))return!0;const d=Me[l];return!!(d&&ne.has(d))}));let o=null,u=null;for(const l of c)try{const d=Date.now();let p=wn.get(l);if(p&&p.ok===!1&&d-(p.ts||0)>=Ls&&(wn.delete(l),p=void 0),p){if(p.module)o=p.module;else if(p.promise)try{o=await p.promise}catch{o=null}}else{const f={promise:null,module:null,ok:null,ts:0};wn.set(l,f),f.promise=(async()=>{try{try{try{return await import(`highlight.js/lib/languages/${l}.js`)}catch{return await import(`highlight.js/lib/languages/${l}`)}}catch{try{const g=`https://cdn.jsdelivr.net/npm/highlight.js/es/languages/${l}.js`;return await new Function("u","return import(u)")(g)}catch{try{const m=`https://cdn.jsdelivr.net/npm/highlight.js/lib/languages/${l}.js`;return await new Function("u","return import(u)")(m)}catch{return null}}}}catch{return null}})();try{o=await f.promise,f.module=o,f.ok=!!o,f.ts=Date.now()}catch{f.module=null,f.ok=!1,f.ts=Date.now(),o=null}}if(o){const f=o.default||o;try{const h=ne.size&&ne.get(t)||l||t;return pe.registerLanguage(h,f),gt.add(h),h!==t&&(pe.registerLanguage(t,f),gt.add(t)),!0}catch(h){u=h}}else try{if(ne.has(l)||ne.has(t)){const f=()=>({});try{pe.registerLanguage(l,f),gt.add(l)}catch{}try{l!==t&&(pe.registerLanguage(t,f),gt.add(t))}catch{}return!0}}catch{}}catch(d){u=d}if(u)throw u;return!1}catch{return!1}}let Ht=null;function Nr(t=document){Xe||(async()=>{try{await In()}catch(i){console.warn("[codeblocksManager] loadSupportedLanguages (observer) failed",i)}})();const e=Me,s=Ht||(typeof IntersectionObserver>"u"?null:(Ht=new IntersectionObserver((i,a)=>{i.forEach(c=>{if(!c.isIntersecting)return;const o=c.target;try{a.unobserve(o)}catch(u){console.warn("[codeblocksManager] observer unobserve failed",u)}(async()=>{try{const u=o.getAttribute&&o.getAttribute("class")||o.className||"",l=u.match(/language-([a-zA-Z0-9_+-]+)/)||u.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(l&&l[1]){const d=(l[1]||"").toLowerCase(),p=e[d]||d,f=ne.size&&(ne.get(p)||ne.get(String(p).toLowerCase()))||p;try{await ht(f)}catch(h){console.warn("[codeblocksManager] registerLanguage failed",h)}try{try{const h=o.textContent||o.innerText||"";h!=null&&(o.textContent=h)}catch{}try{o&&o.dataset&&o.dataset.highlighted&&delete o.dataset.highlighted}catch{}pe.highlightElement(o)}catch(h){console.warn("[codeblocksManager] hljs.highlightElement failed",h)}}else try{const d=o.textContent||"";try{if(pe&&typeof pe.getLanguage=="function"&&pe.getLanguage("plaintext")){const p=pe.highlight(d,{language:"plaintext"});p&&p.value&&(o.innerHTML=p.value)}}catch{try{pe.highlightElement(o)}catch(f){console.warn("[codeblocksManager] fallback highlightElement failed",f)}}}catch(d){console.warn("[codeblocksManager] auto-detect plaintext failed",d)}}catch(u){console.warn("[codeblocksManager] observer entry processing failed",u)}})()})},{root:null,rootMargin:"300px",threshold:.1}),Ht)),r=t&&t.querySelectorAll?t.querySelectorAll("pre code"):[];if(!s){r.forEach(async i=>{try{const a=i.getAttribute&&i.getAttribute("class")||i.className||"",c=a.match(/language-([a-zA-Z0-9_+-]+)/)||a.match(/lang(?:uage)?-?([a-zA-Z0-9_+-]+)/);if(c&&c[1]){const o=(c[1]||"").toLowerCase(),u=e[o]||o,l=ne.size&&(ne.get(u)||ne.get(String(u).toLowerCase()))||u;try{await ht(l)}catch(d){console.warn("[codeblocksManager] registerLanguage failed (no observer)",d)}}try{try{const o=i.textContent||i.innerText||"";o!=null&&(i.textContent=o)}catch{}try{i&&i.dataset&&i.dataset.highlighted&&delete i.dataset.highlighted}catch{}pe.highlightElement(i)}catch(o){console.warn("[codeblocksManager] hljs.highlightElement failed (no observer)",o)}}catch(a){console.warn("[codeblocksManager] loadSupportedLanguages fallback ignored error",a)}});return}r.forEach(i=>{try{s.observe(i)}catch(a){console.warn("[codeblocksManager] observe failed",a)}})}function Ts(t,{useCdn:e=!0}={}){const n=document.querySelector("link[data-hl-theme]"),s=n&&n.getAttribute?n.getAttribute("data-hl-theme"):null,r=t==null?"default":String(t),i=r&&String(r).toLowerCase()||"";if(i==="default"||i==="monokai"){try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}return}if(s&&s.toLowerCase()===i)return;if(!e){console.warn("Requested highlight theme not bundled; set useCdn=true to load theme from CDN");return}const a=i,c=`https://cdn.jsdelivr.net/npm/highlight.js@${Es}/styles/${a}.css`,o=document.createElement("link");o.rel="stylesheet",o.href=c,o.setAttribute("data-hl-theme",a),o.addEventListener("load",()=>{try{n&&n.parentNode&&n.parentNode.removeChild(n)}catch{}}),document.head.appendChild(o)}let et="light";function Cs(t,e={}){if(document.querySelector(`link[href="${t}"]`))return;const n=document.createElement("link");n.rel="stylesheet",n.href=t,Object.entries(e).forEach(([s,r])=>n.setAttribute(s,r)),document.head.appendChild(n)}async function Or(t="none",e="/"){if(!t||t==="none")return;const n=[e+"bulma.css","/bulma.css"],s=Array.from(new Set(n));if(t==="local"){if(document.querySelector("style[data-bulma-override]"))return;for(const r of s)try{const i=await fetch(r,{method:"GET"});if(i.ok){const a=await i.text(),c=document.createElement("style");c.setAttribute("data-bulma-override",r),c.appendChild(document.createTextNode(`
/* bulma override: ${r} */
`+a)),document.head.appendChild(c);return}}catch(i){console.warn("[bulmaManager] fetch local bulma candidate failed",i)}return}try{const r=String(t).trim();if(!r)return;const i=`https://unpkg.com/bulmaswatch/${encodeURIComponent(r)}/bulmaswatch.min.css`;Cs(i,{"data-bulmaswatch-theme":r})}catch(r){console.warn("[bulmaManager] ensureBulma failed",r)}}function qr(t){et=t==="dark"?"dark":t==="system"?"system":"light";try{const e=Array.from(document.querySelectorAll(".nimbi-mount"));if(e.length>0)for(const n of e)et==="dark"?n.setAttribute("data-theme","dark"):et==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme");else{const n=document.documentElement;et==="dark"?n.setAttribute("data-theme","dark"):et==="light"?n.setAttribute("data-theme","light"):n.removeAttribute("data-theme")}}catch{}}function Ms(t){const e=document.documentElement;for(const[n,s]of Object.entries(t||{}))try{e.style.setProperty(`--${n}`,s)}catch(r){console.warn("[bulmaManager] setThemeVars failed for",n,r)}}function Dr(t){if(!t||!(t instanceof HTMLElement))return()=>{};const e=t.closest&&t.closest(".nimbi-mount")||null;try{e&&(et==="dark"?e.setAttribute("data-theme","dark"):et==="light"?e.setAttribute("data-theme","light"):e.removeAttribute("data-theme"))}catch{}return()=>{}}const Hr={en:{navigation:"Navigation",onThisPage:"On this page",home:"Home",scrollToTop:"Scroll to top",readingTime:"{minutes} min read",searchPlaceholder:"Search…",imagePreviewTitle:"Image preview",imagePreviewFit:"Fit to screen",imagePreviewOriginal:"Original size",imagePreviewZoomOut:"Zoom out",imagePreviewZoomIn:"Zoom in",imagePreviewClose:"Close"},es:{navigation:"Navegación",onThisPage:"En esta página",home:"Inicio",scrollToTop:"Ir arriba",readingTime:"{minutes} min de lectura",searchPlaceholder:"Buscar…",imagePreviewTitle:"Previsualización de imagen",imagePreviewFit:"Ajustar a la pantalla",imagePreviewOriginal:"Tamaño original",imagePreviewZoomOut:"Alejar",imagePreviewZoomIn:"Acercar",imagePreviewClose:"Cerrar"},de:{navigation:"Navigation",onThisPage:"Auf dieser Seite",home:"Startseite",scrollToTop:"Nach oben",readingTime:"{minutes} min Lesezeit",searchPlaceholder:"Suchen…",imagePreviewTitle:"Bildvorschau",imagePreviewFit:"An Bildschirm anpassen",imagePreviewOriginal:"Originalgröße",imagePreviewZoomOut:"Verkleinern",imagePreviewZoomIn:"Vergrößern",imagePreviewClose:"Schließen"},fr:{navigation:"Navigation",onThisPage:"Sur cette page",home:"Accueil",scrollToTop:"Aller en haut",readingTime:"{minutes} min de lecture",searchPlaceholder:"Rechercher…",imagePreviewTitle:"Aperçu de l’image",imagePreviewFit:"Ajuster à l’écran",imagePreviewOriginal:"Taille originale",imagePreviewZoomOut:"Dézoomer",imagePreviewZoomIn:"Zoomer",imagePreviewClose:"Fermer"},pt:{navigation:"Navegação",onThisPage:"Nesta página",home:"Início",scrollToTop:"Ir para o topo",readingTime:"{minutes} min de leitura",searchPlaceholder:"Procurar…",imagePreviewTitle:"Visualização da imagem",imagePreviewFit:"Ajustar à tela",imagePreviewOriginal:"Tamanho original",imagePreviewZoomOut:"Diminuir",imagePreviewZoomIn:"Aumentar",imagePreviewClose:"Fechar"}},ut=JSON.parse(JSON.stringify(Hr));let Qt="en";if(typeof navigator<"u"){const t=navigator.language||navigator.languages&&navigator.languages[0]||"en";Qt=String(t).split("-")[0].toLowerCase()}Hr[Qt]||(Qt="en");let Ke=Qt;function lt(t,e={}){const n=ut[Ke]||ut.en;let s=n&&n[t]?n[t]:ut.en[t]||"";for(const r of Object.keys(e))s=s.replace(new RegExp(`{${r}}`,"g"),String(e[r]));return s}async function zn(t,e){if(!t)return;let n=t;try{/^https?:\/\//.test(t)||(n=new URL(t,location.origin+e).toString());const s=await fetch(n);if(!s.ok)return;const r=await s.json();for(const i of Object.keys(r||{}))ut[i]=Object.assign({},ut[i]||{},r[i])}catch{}}function Bn(t){const e=String(t).split("-")[0].toLowerCase();Ke=ut[e]?e:"en"}const _s=Object.freeze(Object.defineProperty({__proto__:null,get currentLang(){return Ke},loadL10nFile:zn,setLang:Bn,t:lt},Symbol.toStringTag,{value:"Module"})),$s=`import { buildSearchIndex, crawlForSlug } from '../slugManager.js'
...
`;function Ur(t,e="worker"){let n=null;function s(){if(!n)try{const c=t();n=c||null,c&&c.addEventListener("error",()=>{try{n===c&&(n=null,c.terminate&&c.terminate())}catch(o){console.warn("["+e+"] worker termination failed",o)}})}catch(c){n=null,console.warn("["+e+"] worker init failed",c)}return n}function r(){try{n&&(n.terminate&&n.terminate(),n=null)}catch(c){console.warn("["+e+"] worker termination failed",c)}}function i(c,o=1e3){return new Promise((u,l)=>{const d=s();if(!d)return l(new Error("worker unavailable"));const p=String(Math.random());c.id=p;let f=null;const h=()=>{f&&clearTimeout(f),d.removeEventListener("message",g),d.removeEventListener("error",m)},g=b=>{const k=b.data||{};k.id===p&&(h(),k.error?l(new Error(k.error)):u(k.result))},m=b=>{h(),console.warn("["+e+"] worker error event",b);try{n===d&&(n=null,d.terminate&&d.terminate())}catch(k){console.warn("["+e+"] worker termination failed",k)}l(new Error(b&&b.message||"worker error"))};f=setTimeout(()=>{h(),console.warn("["+e+"] worker timed out");try{n===d&&(n=null,d.terminate&&d.terminate())}catch(b){console.warn("["+e+"] worker termination on timeout failed",b)}l(new Error("worker timeout"))},o),d.addEventListener("message",g),d.addEventListener("error",m);try{d.postMessage(c)}catch(b){h(),l(b)}})}return{get:s,send:i,terminate:r}}function Ps(t){try{if(typeof Blob<"u"&&typeof URL<"u"&&t){const e=new Blob([t],{type:"application/javascript"}),n=URL.createObjectURL(e);return new Worker(n,{type:"module"})}}catch(e){console.warn("[worker-manager] createWorkerFromRaw failed",e)}return null}const De=new Set;function Nn(t){Is(),De.clear();for(const e of _e)e&&De.add(e);pr(te),pr(j),Nn._refreshed=!0}function pr(t){if(!(!t||typeof t.values!="function"))for(const e of t.values())e&&De.add(e)}function gr(t){if(!t||typeof t.set!="function")return;const e=t.set;t.set=function(n,s){return s&&De.add(s),e.call(this,n,s)}}let mr=!1;function Is(){mr||(gr(te),gr(j),mr=!0)}function jr(t){return!t||typeof t!="string"?!1:/^(https?:)?\/\//.test(t)||t.startsWith("mailto:")||t.startsWith("tel:")}function me(t){return String(t||"").replace(/^[.\/]+/,"")}function Ct(t){return String(t||"").replace(/\/+$/,"")}function Tt(t){return Ct(t)+"/"}function zs(t){try{if(!t||typeof document>"u"||!document.head||t.startsWith("data:")||document.head.querySelector(`link[rel="preload"][as="image"][href="${t}"]`))return;const n=document.createElement("link");n.rel="preload",n.as="image",n.href=t,document.head.appendChild(n)}catch(e){console.warn("[helpers] preloadImage failed",e)}}function Ut(t,e=0,n=!1){try{if(typeof window>"u"||!t||!t.querySelectorAll)return;const s=Array.from(t.querySelectorAll("img"));if(!s.length)return;const r=t,i=r&&r.getBoundingClientRect?r.getBoundingClientRect():null,a=0,c=typeof window<"u"&&(window.innerHeight||document.documentElement.clientHeight)||0,o=i?Math.max(a,i.top):a,l=(i?Math.min(c,i.bottom):c)+Number(e||0);let d=0;r&&(d=r.clientHeight||(i?i.height:0)),d||(d=c-a);let p=.6;try{const m=r&&window.getComputedStyle?window.getComputedStyle(r):null,b=m&&m.getPropertyValue("--nimbi-image-max-height-ratio"),k=b?parseFloat(b):NaN;!Number.isNaN(k)&&k>0&&k<=1&&(p=k)}catch(m){console.warn("[helpers] read CSS ratio failed",m)}const f=Math.max(200,Math.floor(d*p));let h=!1,g=null;if(s.forEach(m=>{try{const b=m.getAttribute?m.getAttribute("loading"):void 0;b!=="eager"&&m.setAttribute&&m.setAttribute("loading","lazy");const k=m.getBoundingClientRect?m.getBoundingClientRect():null,A=m.src||m.getAttribute&&m.getAttribute("src"),C=k&&k.height>1?k.height:f,M=k?k.top:0,z=M+C;k&&C>0&&M<=l&&z>=o&&(m.setAttribute?(m.setAttribute("loading","eager"),m.setAttribute("fetchpriority","high"),m.setAttribute("data-eager-by-nimbi","1")):(m.loading="eager",m.fetchPriority="high"),zs(A),h=!0),!g&&k&&k.top<=l&&(g={img:m,src:A,rect:k,beforeLoading:b})}catch(b){console.warn("[helpers] setEagerForAboveFoldImages per-image failed",b)}}),!h&&g){const{img:m,src:b,rect:k,beforeLoading:A}=g;try{m.setAttribute?(m.setAttribute("loading","eager"),m.setAttribute("fetchpriority","high"),m.setAttribute("data-eager-by-nimbi","1")):(m.loading="eager",m.fetchPriority="high")}catch(C){console.warn("[helpers] setEagerForAboveFoldImages fallback failed",C)}}}catch(s){console.warn("[helpers] setEagerForAboveFoldImages failed",s)}}function Xt(t){try{const e=t();return e&&typeof e.then=="function"?e.catch(n=>{console.warn("[helpers] safe swallowed error",n)}):e}catch(e){console.warn("[helpers] safe swallowed error",e)}}try{typeof globalThis<"u"&&!globalThis.safe&&(globalThis.safe=Xt)}catch(t){console.warn("[helpers] global attach failed",t)}const te=new Map;let Le=[],On=!1;function Bs(t){On=!!t}function Fr(t){Le=Array.isArray(t)?t.slice():[]}function Ns(){return Le}const Wr=Ur(()=>Ps($s),"slugManager");function qn(){return Wr.get()}function Zr(t){return Wr.send(t)}async function Os(t,e=1,n=void 0){if(!qn())return Vt(t,e,n);try{return await Zr({type:"buildSearchIndex",contentBase:t,indexDepth:e,noIndexing:n})}catch(r){try{return await Vt(t,e,n)}catch(i){throw console.warn("[slugManager] buildSearchIndex fallback failed",i),r}}}async function qs(t,e,n){return qn()?Zr({type:"crawlForSlug",slug:t,base:e,maxQueue:n}):Dn(t,e,n)}function Ge(t,e){if(t)if(Le&&Le.length){const s=e.split("/")[0],r=Le.includes(s);let i=te.get(t);(!i||typeof i=="string")&&(i={default:typeof i=="string"?i:void 0,langs:{}}),r?i.langs[s]=e:i.default=e,te.set(t,i)}else te.set(t,e)}const sn=new Set;function Ds(t){typeof t=="function"&&sn.add(t)}function Hs(t){typeof t=="function"&&sn.delete(t)}const j=new Map;let An={},_e=[],dt="_404.md",ct="_home.md";function En(t){t!=null&&(dt=String(t||""))}function Us(t){t!=null&&(ct=String(t||""))}function js(t){An=t||{}}const xt=new Map,Kt=new Set;function Fs(){xt.clear(),Kt.clear()}function Ws(t){if(!t||t.length===0)return"";let e=t[0];for(let s=1;s<t.length;s++){const r=t[s];let i=0;const a=Math.min(e.length,r.length);for(;i<a&&e[i]===r[i];)i++;e=e.slice(0,i)}const n=e.lastIndexOf("/");return n===-1?e:e.slice(0,n+1)}function Yt(t){te.clear(),j.clear(),_e=[],Le=Le||[];const e=Object.keys(An||{});if(!e.length)return;let n="";try{if(t){try{/^[a-z][a-z0-9+.-]*:/i.test(String(t))?n=new URL(String(t)).pathname:n=String(t||"")}catch(s){n=String(t||""),console.warn("[slugManager] parse contentBase failed",s)}n=Tt(n)}}catch(s){n="",console.warn("[slugManager] setContentBase prefix derivation failed",s)}n||(n=Ws(e));for(const s of e){let r=s;n&&s.startsWith(n)?r=me(s.slice(n.length)):r=me(s),_e.push(r);try{Nn()}catch(a){console.warn("[slugManager] refreshIndexPaths failed",a)}const i=An[s];if(typeof i=="string"){const a=(i||"").match(/^#\s+(.+)$/m);if(a&&a[1]){const c=le(a[1].trim());if(c)try{let o=c;if((!Le||!Le.length)&&(o=Gr(o,new Set(te.keys()))),Le&&Le.length){const l=r.split("/")[0],d=Le.includes(l);let p=te.get(o);(!p||typeof p=="string")&&(p={default:typeof p=="string"?p:void 0,langs:{}}),d?p.langs[l]=r:p.default=r,te.set(o,p)}else te.set(o,r);j.set(r,o)}catch(o){console.warn("[slugManager] set slug mapping failed",o)}}}}}try{Yt()}catch(t){console.warn("[slugManager] initial setContentBase failed",t)}function le(t){let n=String(t||"").toLowerCase().replace(/[^a-z0-9\- ]/g,"").replace(/ /g,"-");return n=n.replace(/(?:-?)(?:md|html)$/,""),n=n.replace(/-+/g,"-"),n=n.replace(/^-|-$/g,""),n.length>80&&(n=n.slice(0,80).replace(/-+$/g,"")),n}function Gr(t,e){if(!e.has(t))return t;let n=2,s=`${t}-${n}`;for(;e.has(s);)n+=1,s=`${t}-${n}`;return s}function Zs(t){return Mt(t,void 0)}function Mt(t,e){if(!t)return!1;if(t.startsWith("//"))return!0;if(/^[a-z][a-z0-9+.-]*:/i.test(t)){if(e&&typeof e=="string")try{const n=new URL(t),s=new URL(e);return n.origin!==s.origin?!0:!n.pathname.startsWith(s.pathname)}catch{return!0}return!0}if(t.startsWith("/")&&e&&typeof e=="string")try{const n=new URL(t,e),s=new URL(e);return n.origin!==s.origin?!0:!n.pathname.startsWith(s.pathname)}catch{return!0}return!1}function Ft(t){return t==null?t:String(t).replace(/\\([\\`*_{}\[\]()#+\-.!])/g,(e,n)=>n)}function _t(t){if(!t||!te.has(t))return null;const e=te.get(t);if(!e)return null;if(typeof e=="string")return e;if(Le&&Le.length&&Ke&&e.langs&&e.langs[Ke])return e.langs[Ke];if(e.default)return e.default;if(e.langs){const n=Object.keys(e.langs);if(n.length)return e.langs[n[0]]}return null}const St=new Map;function Gs(){St.clear()}let ve=async function(t,e){if(!t)throw new Error("path required");try{const i=(String(t||"").match(/([^\/]+)\.md(?:$|[?#])/)||[])[1];if(i&&te.has(i)){const a=_t(i)||te.get(i);a&&a!==t&&(t=a)}}catch(i){console.warn("[slugManager] slug mapping normalization failed",i)}const n=e==null?"":Ct(String(e));let s="";try{if(n)if(/^[a-z][a-z0-9+.-]*:/i.test(n))s=n.replace(/\/$/,"")+"/"+t.replace(/^\//,"");else if(n.startsWith("/"))s=n.replace(/\/$/,"")+"/"+t.replace(/^\//,"");else{const i=typeof location<"u"&&location.origin?location.origin:"http://localhost",a=n.startsWith("/")?n:"/"+n;s=i+a.replace(/\/$/,"")+"/"+t.replace(/^\//,"")}else s=(typeof location<"u"&&location.origin?location.origin:"http://localhost")+"/"+t.replace(/^\//,"")}catch{s="/"+t.replace(/^\//,"")}if(St.has(s))return St.get(s);const r=(async()=>{const i=await fetch(s);if(!i||typeof i.ok!="boolean"||!i.ok){if(i&&i.status===404)try{const d=`${n}/${dt}`,p=await globalThis.fetch(d);if(p&&typeof p.ok=="boolean"&&p.ok)return{raw:await p.text(),status:404}}catch(d){console.warn("[slugManager] fetching fallback 404 failed",d)}let l="";try{i&&typeof i.clone=="function"?l=await i.clone().text():i&&typeof i.text=="function"?l=await i.text():l=""}catch(d){l="",console.warn("[slugManager] reading error body failed",d)}throw console.error("fetchMarkdown failed:",{url:s,status:i?i.status:void 0,statusText:i?i.statusText:void 0,body:l.slice(0,200)}),new Error("failed to fetch md")}const a=await i.text(),c=a.trim().slice(0,16).toLowerCase(),o=c.startsWith("<!doctype")||c.startsWith("<html"),u=o||String(t||"").toLowerCase().endsWith(".html");if(o&&String(t||"").toLowerCase().endsWith(".md")){try{const l=`${n}/${dt}`,d=await globalThis.fetch(l);if(d.ok)return{raw:await d.text(),status:404}}catch(l){console.warn("[slugManager] fetching fallback 404 failed",l)}throw console.error("fetchMarkdown: server returned HTML for .md request",s),new Error("failed to fetch md")}return u?{raw:a,isHtml:!0}:{raw:a}})();return St.set(s,r),r};function Qs(t){typeof t=="function"&&(ve=t)}const Wt=new Map;function Xs(t){if(!t||typeof t!="string")return"";let e=t.replace(/```[\s\S]*?```/g,"");return e=e.replace(/<pre[\s\S]*?<\/pre>/gi,""),e=e.replace(/<code[\s\S]*?<\/code>/gi,""),e=e.replace(/<!--([\s\S]*?)-->/g,""),e=e.replace(/^ {4,}.*$/gm,""),e=e.replace(/`[^`]*`/g,""),e}let je=[],mt=null;async function Vt(t,e=1,n=void 0){const s=Array.isArray(n)?Array.from(new Set((n||[]).map(r=>me(String(r||""))))):[];try{const r=me(String(dt||""));r&&!s.includes(r)&&s.push(r)}catch{}if(je&&je.length&&e===1&&!je.some(i=>{try{return s.includes(me(String(i.path||"")))}catch{return!1}}))return je;if(mt)return mt;mt=(async()=>{let r=Array.isArray(n)?Array.from(new Set((n||[]).map(u=>me(String(u||""))))):[];try{const u=me(String(dt||""));u&&!r.includes(u)&&r.push(u)}catch{}const i=u=>{if(!r||!r.length)return!1;for(const l of r)if(l&&(u===l||u.startsWith(l+"/")))return!0;return!1};let a=[];if(_e&&_e.length&&(a=Array.from(_e)),!a.length)for(const u of te.values())u&&a.push(u);try{const u=await Yr(t);u&&u.length&&(a=a.concat(u))}catch(u){console.warn("[slugManager] crawlAllMarkdown during buildSearchIndex failed",u)}try{const u=new Set(a),l=[...a];for(u.size;l.length&&u.size<=$t;){const d=l.shift();try{const p=await ve(d,t);if(p&&p.raw){if(p.status===404)continue;let f=p.raw;const h=[],g=String(d||"").replace(/^.*\//,"");if(/^readme(?:\.md)?$/i.test(g)&&On&&(!d||!d.includes("/")))continue;const m=Xs(f),b=/\[[^\]]+\]\(([^)]+)\)/g;let k;for(;k=b.exec(m);)h.push(k[1]);const A=/<a\s+[^>]*href=["']([^"']+)["'][^>]*>/gi;for(;k=A.exec(m);)h.push(k[1]);const C=d&&d.includes("/")?d.substring(0,d.lastIndexOf("/")+1):"";for(let M of h)try{if(Mt(M,t)||M.startsWith("..")||M.indexOf("/../")!==-1||(C&&!M.startsWith("./")&&!M.startsWith("/")&&!M.startsWith("../")&&(M=C+M),M=me(M),!/\.(md|html?)(?:$|[?#])/i.test(M))||(M=M.split(/[?#]/)[0],i(M)))continue;u.has(M)||(u.add(M),l.push(M),a.push(M))}catch(z){console.warn("[slugManager] href processing failed",M,z)}}}catch(p){console.warn("[slugManager] discovery fetch failed for",d,p)}}}catch(u){console.warn("[slugManager] discovery loop failed",u)}const c=new Set;a=a.filter(u=>!u||c.has(u)||i(u)?!1:(c.add(u),!0));const o=[];for(const u of a)if(/\.(?:md|html?)(?:$|[?#])/i.test(u))try{const l=await ve(u,t);if(l&&l.raw){if(l.status===404)continue;let d="",p="";if(l.isHtml)try{const g=new DOMParser().parseFromString(l.raw,"text/html"),m=g.querySelector("title")||g.querySelector("h1");m&&m.textContent&&(d=m.textContent.trim());const b=g.querySelector("p");if(b&&b.textContent&&(p=b.textContent.trim()),e>=2)try{const k=g.querySelector("h1"),A=k&&k.textContent?k.textContent.trim():d||"",C=(()=>{try{if(j.has(u))return j.get(u)}catch{}return le(d||u)})(),M=Array.from(g.querySelectorAll("h2"));for(const z of M)try{const Z=(z.textContent||"").trim();if(!Z)continue;const V=z.id?z.id:le(Z),ie=C?`${C}::${V}`:`${le(u)}::${V}`;let J="",W=z.nextElementSibling;for(;W&&W.tagName&&W.tagName.toLowerCase()==="script";)W=W.nextElementSibling;W&&W.textContent&&(J=String(W.textContent).trim()),o.push({slug:ie,title:Z,excerpt:J,path:u,parentTitle:A})}catch(Z){console.warn("[slugManager] indexing H2 failed",Z)}if(e===3)try{const z=Array.from(g.querySelectorAll("h3"));for(const Z of z)try{const V=(Z.textContent||"").trim();if(!V)continue;const ie=Z.id?Z.id:le(V),J=C?`${C}::${ie}`:`${le(u)}::${ie}`;let W="",X=Z.nextElementSibling;for(;X&&X.tagName&&X.tagName.toLowerCase()==="script";)X=X.nextElementSibling;X&&X.textContent&&(W=String(X.textContent).trim()),o.push({slug:J,title:V,excerpt:W,path:u,parentTitle:A})}catch(V){console.warn("[slugManager] indexing H3 failed",V)}}catch(z){console.warn("[slugManager] collect H3s failed",z)}}catch(k){console.warn("[slugManager] collect H2s failed",k)}}catch(h){console.warn("[slugManager] parsing HTML for index failed",h)}else{const h=l.raw,g=h.match(/^#\s+(.+)$/m);d=g?g[1].trim():"";try{d=Ft(d)}catch{}const m=h.split(/\r?\n\s*\r?\n/);if(m.length>1)for(let b=1;b<m.length;b++){const k=m[b].trim();if(k&&!/^#/.test(k)){p=k.replace(/\r?\n/g," ");break}}if(e>=2){let b="",k="";try{const A=(h.match(/^#\s+(.+)$/m)||[])[1];b=A?A.trim():"",k=(function(){try{if(j.has(u))return j.get(u)}catch{}return le(d||u)})();const C=/^##\s+(.+)$/gm;let M;for(;M=C.exec(h);)try{const z=(M[1]||"").trim(),Z=Ft(z);if(!z)continue;const V=le(z),ie=k?`${k}::${V}`:`${le(u)}::${V}`,W=h.slice(C.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),X=W&&W[1]?String(W[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";o.push({slug:ie,title:Z,excerpt:X,path:u,parentTitle:b})}catch(z){console.warn("[slugManager] indexing markdown H2 failed",z)}}catch(A){console.warn("[slugManager] collect markdown H2s failed",A)}if(e===3)try{const A=/^###\s+(.+)$/gm;let C;for(;C=A.exec(h);)try{const M=(C[1]||"").trim(),z=Ft(M);if(!M)continue;const Z=le(M),V=k?`${k}::${Z}`:`${le(u)}::${Z}`,J=h.slice(A.lastIndex).match(/^(?:\r?\n)*([^\r\n][^\r\n]*(?:\r?\n[^\r\n].*)*)/),W=J&&J[1]?String(J[1]).trim().split(/\r?\n/).join(" ").slice(0,300):"";o.push({slug:V,title:z,excerpt:W,path:u,parentTitle:b})}catch(M){console.warn("[slugManager] indexing markdown H3 failed",M)}}catch(A){console.warn("[slugManager] collect markdown H3s failed",A)}}}let f="";try{j.has(u)&&(f=j.get(u))}catch(h){console.warn("[slugManager] mdToSlug access failed",h)}f||(f=le(d||u)),o.push({slug:f,title:d,excerpt:p,path:u})}}catch(l){console.warn("[slugManager] buildSearchIndex: entry fetch failed",l)}try{je=o.filter(l=>{try{return!i(String(l.path||""))}catch{return!0}})}catch(u){console.warn("[slugManager] filtering index by excludes failed",u),je=o}return je})();try{await mt}catch(r){console.warn("[slugManager] awaiting _indexPromise failed",r)}return mt=null,je}const Qr=1e3;let $t=Qr;function Ks(t){typeof t=="number"&&t>=0&&($t=t)}const Xr=new DOMParser,Kr="a[href]";let Dn=async function(t,e,n=$t){if(Wt.has(t))return Wt.get(t);let s=null;const r=new Set,i=[""];for(;i.length&&!s&&!(i.length>n);){const a=i.shift();if(r.has(a))continue;r.add(a);let c=e;c.endsWith("/")||(c+="/"),c+=a;try{let o;try{o=await globalThis.fetch(c)}catch(p){console.warn("[slugManager] crawlAllMarkdown: fetch failed",{url:c,error:p});continue}if(!o||!o.ok){o&&!o.ok&&console.warn("[slugManager] crawlAllMarkdown: directory fetch non-ok",{url:c,status:o.status});continue}const u=await o.text(),d=Xr.parseFromString(u,"text/html").querySelectorAll(Kr);for(const p of d)try{let f=p.getAttribute("href")||"";if(!f||Mt(f,e)||f.startsWith("..")||f.indexOf("/../")!==-1)continue;if(f.endsWith("/")){const h=a+f;r.has(h)||i.push(h);continue}if(f.toLowerCase().endsWith(".md")){const h=me(a+f);try{if(j.has(h))continue;for(const g of te.values());}catch(g){console.warn("[slugManager] slug map access failed",g)}try{const g=await ve(h,e);if(g&&g.raw){const m=(g.raw||"").match(/^#\s+(.+)$/m);if(m&&m[1]&&le(m[1].trim())===t){s=h;break}}}catch(g){console.warn("[slugManager] crawlForSlug: fetchMarkdown failed",g)}}}catch(f){console.warn("[slugManager] crawlForSlug: link iteration failed",f)}}catch(o){console.warn("[slugManager] crawlForSlug: directory fetch failed",o)}}return Wt.set(t,s),s};async function Yr(t,e=$t){const n=new Set,s=new Set,r=[""];for(;r.length&&!(r.length>e);){const i=r.shift();if(s.has(i))continue;s.add(i);let a=t;a.endsWith("/")||(a+="/"),a+=i;try{let c;try{c=await globalThis.fetch(a)}catch(d){console.warn("[slugManager] crawlAllMarkdown: fetch failed",{url:a,error:d});continue}if(!c||!c.ok){c&&!c.ok&&console.warn("[slugManager] crawlAllMarkdown: directory fetch non-ok",{url:a,status:c.status});continue}const o=await c.text(),l=Xr.parseFromString(o,"text/html").querySelectorAll(Kr);for(const d of l)try{let p=d.getAttribute("href")||"";if(!p||Mt(p,t)||p.startsWith("..")||p.indexOf("/../")!==-1)continue;if(p.endsWith("/")){const h=i+p;s.has(h)||r.push(h);continue}const f=(i+p).replace(/^\/+/,"");/\.(md|html?)$/i.test(f)&&n.add(f)}catch(p){console.warn("[slugManager] crawlAllMarkdown: link iteration failed",p)}}catch(c){console.warn("[slugManager] crawlAllMarkdown: directory fetch failed",c)}}return Array.from(n)}async function Vr(t,e,n){if(t&&typeof t=="string"&&(t=me(t),t=Ct(t)),te.has(t))return _t(t)||te.get(t);for(const r of sn)try{const i=await r(t,e);if(i)return Ge(t,i),j.set(i,t),i}catch(i){console.warn("[slugManager] slug resolver failed",i)}if(_e&&_e.length){if(xt.has(t)){const r=xt.get(t);return te.set(t,r),j.set(r,t),r}for(const r of _e)if(!Kt.has(r))try{const i=await ve(r,e);if(i&&i.raw){const a=(i.raw||"").match(/^#\s+(.+)$/m);if(a&&a[1]){const c=le(a[1].trim());if(Kt.add(r),c&&xt.set(c,r),c===t)return Ge(t,r),j.set(r,t),r}}}catch(i){console.warn("[slugManager] manifest title fetch failed",i)}}try{const r=await Vt(e);if(r&&r.length){const i=r.find(a=>a.slug===t);if(i)return Ge(t,i.path),j.set(i.path,t),i.path}}catch(r){console.warn("[slugManager] buildSearchIndex lookup failed",r)}try{const r=await Dn(t,e,n);if(r)return Ge(t,r),j.set(r,t),r}catch(r){console.warn("[slugManager] crawlForSlug lookup failed",r)}const s=[`${t}.html`,`${t}.md`];for(const r of s)try{const i=await ve(r,e);if(i&&i.raw)return Ge(t,r),j.set(r,t),r}catch(i){console.warn("[slugManager] candidate fetch failed",i)}if(_e&&_e.length)for(const r of _e)try{const i=r.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(le(i)===t)return Ge(t,r),j.set(r,t),r}catch(i){console.warn("[slugManager] build-time filename match failed",i)}try{const r=[];ct&&typeof ct=="string"&&ct.trim()&&r.push(ct),r.includes("_home.md")||r.push("_home.md");for(const i of r)try{const a=await ve(i,e);if(a&&a.raw){const c=(a.raw||"").match(/^#\s+(.+)$/m);if(c&&c[1]&&le(c[1].trim())===t)return Ge(t,i),j.set(i,t),i}}catch{}}catch(r){console.warn("[slugManager] home page fetch failed",r)}return null}const Zt=Object.freeze(Object.defineProperty({__proto__:null,CRAWL_MAX_QUEUE:Qr,_setAllMd:js,_storeSlugMapping:Ge,addSlugResolver:Ds,get allMarkdownPaths(){return _e},get availableLanguages(){return Le},buildSearchIndex:Vt,buildSearchIndexWorker:Os,clearFetchCache:Gs,clearListCaches:Fs,crawlAllMarkdown:Yr,crawlCache:Wt,crawlForSlug:Dn,crawlForSlugWorker:qs,get defaultCrawlMaxQueue(){return $t},ensureSlug:Vr,fetchCache:St,get fetchMarkdown(){return ve},getLanguages:Ns,get homePage(){return ct},initSlugWorker:qn,isExternalLink:Zs,isExternalLinkWithBase:Mt,listPathsFetched:Kt,listSlugCache:xt,mdToSlug:j,get notFoundPage(){return dt},removeSlugResolver:Hs,resolveSlugPath:_t,get searchIndex(){return je},setContentBase:Yt,setDefaultCrawlMaxQueue:Ks,setFetchMarkdown:Qs,setHomePage:Us,setLanguages:Fr,setNotFoundPage:En,setSkipRootReadme:Bs,get skipRootReadme(){return On},slugResolvers:sn,slugToMd:te,slugify:le,unescapeMarkdown:Ft,uniqueSlug:Gr},Symbol.toStringTag,{value:"Module"}));let Jr=100;function wr(t){Jr=t}let vt=300*1e3;function br(t){vt=t}const $e=new Map;function Ys(t){if(!$e.has(t))return;const e=$e.get(t),n=Date.now();if(e.ts+vt<n){$e.delete(t);return}return $e.delete(t),$e.set(t,e),e.value}function Vs(t,e){if(yr(),yr(),$e.delete(t),$e.set(t,{value:e,ts:Date.now()}),$e.size>Jr){const n=$e.keys().next().value;n!==void 0&&$e.delete(n)}}function yr(){if(!vt||vt<=0)return;const t=Date.now();for(const[e,n]of $e.entries())n.ts+vt<t&&$e.delete(e)}async function Js(t,e){const n=new Set(De),s=document.querySelectorAll(".nimbi-site-navbar a, .navbar a, .nimbi-nav a");for(const r of Array.from(s||[])){const i=r.getAttribute("href")||"";if(i)try{const a=new URL(i,location.href);if(a.origin!==location.origin)continue;const c=(a.hash||a.pathname).match(/([^#?]+\.md)(?:$|[?#])/)||(a.pathname||"").match(/([^#?]+\.md)(?:$|[?#])/);if(c){let d=me(c[1]);d&&n.add(d);continue}const o=(r.textContent||"").trim(),u=(a.pathname||"").replace(/^.*\//,"");if(o&&le(o)===t||u&&le(u.replace(/\.(html?|md)$/i,""))===t)return a.toString();if(/\.(html?)$/i.test(a.pathname)){let d=a.pathname.replace(/^\//,"");n.add(d);continue}const l=a.pathname||"";if(l){const d=new URL(e),p=Tt(d.pathname);if(l.indexOf(p)!==-1){let f=l.startsWith(p)?l.slice(p.length):l;f=me(f),f&&n.add(f)}}}catch(a){console.warn("[router] malformed URL while discovering index candidates",a)}}for(const r of n)try{if(!r||!String(r).includes(".md"))continue;const i=await ve(r,e);if(!i||!i.raw)continue;const a=(i.raw||"").match(/^#\s+(.+)$/m);if(a){const c=(a[1]||"").trim();if(c&&le(c)===t)return r}}catch(i){console.warn("[router] fetchMarkdown during index discovery failed",i)}return null}function ea(t){const e=[];if(String(t).includes(".md")||String(t).includes(".html"))/index\.html$/i.test(t)||e.push(t);else try{const n=decodeURIComponent(String(t||""));if(te.has(n)){const s=_t(n)||te.get(n);s&&(/\.(md|html?)$/i.test(s)?/index\.html$/i.test(s)||e.push(s):(e.push(s),e.push(s+".html")))}else{if(De&&De.size)for(const s of De){const r=s.replace(/^.*\//,"").replace(/\.(md|html?)$/i,"");if(le(r)===n&&!/index\.html$/i.test(s)){e.push(s);break}}!e.length&&n&&!/\.(md|html?)$/i.test(n)&&(e.push(n+".html"),e.push(n+".md"))}}catch(n){console.warn("[router] buildPageCandidates failed during slug handling",n)}return e}async function ta(t,e){const n=t||"",s=location.hash?decodeURIComponent(location.hash.replace(/^#/,"")):null;let r=t||"",i=null;if(r&&String(r).includes("::")){const h=String(r).split("::",2);r=h[0],i=h[1]||null}const c=`${t}|||${typeof _s<"u"&&Ke?Ke:""}`,o=Ys(c);if(o)r=o.resolved,i=o.anchor||i;else{if(!String(r).includes(".md")&&!String(r).includes(".html")){let h=decodeURIComponent(String(r||""));if(h&&typeof h=="string"&&(h=me(h),h=Ct(h)),te.has(h))r=_t(h)||te.get(h);else{let g=await Js(h,e);if(g)r=g;else if(Nn._refreshed&&De&&De.size||typeof e=="string"&&/^[a-z][a-z0-9+.-]*:\/\//i.test(e)){const m=await Vr(h,e);m&&(r=m)}}}Vs(c,{resolved:r,anchor:i})}!i&&s&&(i=s);try{if(r&&(r.startsWith("http://")||r.startsWith("https://")||r.startsWith("/"))){const h=r.startsWith("/")?new URL(r,location.origin).toString():r;try{const g=await fetch(h);if(g&&g.ok){const m=await g.text(),b=g&&g.headers&&typeof g.headers.get=="function"&&g.headers.get("content-type")||"",k=(m||"").toLowerCase();if(b&&b.indexOf&&b.indexOf("text/html")!==-1||k.indexOf("<!doctype")!==-1||k.indexOf("<html")!==-1)return{data:{raw:m,isHtml:!0},pagePath:h.replace(/^\//,""),anchor:i}}}catch{}}}catch{}const u=ea(r),l=String(n||"").includes(".md")||String(n||"").includes(".html");if(l&&u.length===0&&(String(r).includes(".md")||String(r).includes(".html"))&&u.push(r),u.length===0&&(String(r).includes(".md")||String(r).includes(".html"))&&u.push(r),u.length===1&&/index\.html$/i.test(u[0])&&!l&&!te.has(r)&&!te.has(decodeURIComponent(String(r||"")))&&!String(r||"").includes("/"))throw new Error("Unknown slug: index.html fallback prevented");let d=null,p=null,f=null;for(const h of u)if(h)try{const g=me(h);d=await ve(g,e),p=g;break}catch(g){f=g;try{console.warn("[router] candidate fetch failed",{candidate:h,contentBase:e,err:g&&g.message||g})}catch{}}if(!d){try{console.error("[router] fetchPageData: no page data for",{originalRaw:n,resolved:r,pageCandidates:u,contentBase:e,fetchError:f&&(f.message||String(f))||null})}catch{}try{if(l&&String(n||"").toLowerCase().includes(".html"))try{const h=new URL(String(n||""),location.href).toString();console.warn("[router] attempting absolute HTML fetch fallback",h);const g=await fetch(h);if(g&&g.ok){const m=await g.text(),b=g&&g.headers&&typeof g.headers.get=="function"&&g.headers.get("content-type")||"",k=(m||"").toLowerCase(),A=b&&b.indexOf&&b.indexOf("text/html")!==-1||k.indexOf("<!doctype")!==-1||k.indexOf("<html")!==-1;if(A||console.warn("[router] absolute fetch returned non-HTML",{abs:h,contentType:b,snippet:k.slice(0,200)}),A)try{const C=h,M=new URL(".",C).toString();try{const Z=typeof DOMParser<"u"?new DOMParser:null;if(Z){const V=Z.parseFromString(m||"","text/html"),ie=(D,he)=>{try{const F=he.getAttribute(D)||"";if(!F||/^(https?:)?\/\//i.test(F)||F.startsWith("/")||F.startsWith("#"))return;try{const S=new URL(F,C).toString();he.setAttribute(D,S)}catch(S){console.warn("[router] rewrite attribute failed",D,S)}}catch(F){console.warn("[router] rewrite helper failed",F)}},J=V.querySelectorAll("[src],[href],[srcset],[xlink:href],[poster]"),W=[];for(const D of Array.from(J||[]))try{const he=D.tagName?D.tagName.toLowerCase():"";if(he==="a")continue;if(D.hasAttribute("src")){const F=D.getAttribute("src");ie("src",D);const S=D.getAttribute("src");F!==S&&W.push({attr:"src",tag:he,before:F,after:S})}if(D.hasAttribute("href")&&he==="link"){const F=D.getAttribute("href");ie("href",D);const S=D.getAttribute("href");F!==S&&W.push({attr:"href",tag:he,before:F,after:S})}if(D.hasAttribute("href")&&he!=="link"){const F=D.getAttribute("href");ie("href",D);const S=D.getAttribute("href");F!==S&&W.push({attr:"href",tag:he,before:F,after:S})}if(D.hasAttribute("xlink:href")){const F=D.getAttribute("xlink:href");ie("xlink:href",D);const S=D.getAttribute("xlink:href");F!==S&&W.push({attr:"xlink:href",tag:he,before:F,after:S})}if(D.hasAttribute("poster")){const F=D.getAttribute("poster");ie("poster",D);const S=D.getAttribute("poster");F!==S&&W.push({attr:"poster",tag:he,before:F,after:S})}if(D.hasAttribute("srcset")){const re=(D.getAttribute("srcset")||"").split(",").map(Q=>Q.trim()).filter(Boolean).map(Q=>{const[v,$]=Q.split(/\s+/,2);if(!v||/^(https?:)?\/\//i.test(v)||v.startsWith("/"))return Q;try{const y=new URL(v,C).toString();return $?`${y} ${$}`:y}catch{return Q}}).join(", ");D.setAttribute("srcset",re)}}catch{}const X=V.documentElement&&V.documentElement.outerHTML?V.documentElement.outerHTML:m;try{W&&W.length&&console.warn("[router] rewritten asset refs",{abs:h,rewritten:W})}catch{}return{data:{raw:X,isHtml:!0},pagePath:String(n||""),anchor:i}}}catch{}let z=m;return/<base\s+[^>]*>/i.test(m)||(/<head[^>]*>/i.test(m)?z=m.replace(/(<head[^>]*>)/i,`$1<base href="${M}">`):z=`<base href="${M}">`+m),{data:{raw:z,isHtml:!0},pagePath:String(n||""),anchor:i}}catch{return{data:{raw:m,isHtml:!0},pagePath:String(n||""),anchor:i}}}}catch(h){console.warn("[router] absolute HTML fetch fallback failed",h)}}catch{}try{const h=decodeURIComponent(String(r||""));if(h&&!/\.(md|html?)$/i.test(h)){const g=[`/assets/${h}.html`,`/assets/${h}/index.html`];for(const m of g)try{const b=await fetch(m,{method:"GET"});if(b&&b.ok)return{data:{raw:await b.text(),isHtml:!0},pagePath:m.replace(/^\//,""),anchor:i}}catch{}}}catch(h){console.warn("[router] assets fallback failed",h)}throw new Error("no page data")}return{data:d,pagePath:p,anchor:i}}function Hn(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var rt=Hn();function ei(t){rt=t}var tt={exec:()=>null};function ae(t,e=""){let n=typeof t=="string"?t:t.source,s={replace:(r,i)=>{let a=typeof i=="string"?i:i.source;return a=a.replace(Te.caret,"$1"),n=n.replace(r,a),s},getRegex:()=>new RegExp(n,e)};return s}var na=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),Te={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:t=>new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}#`),htmlBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}>`)},ra=/^(?:[ \t]*(?:\n|$))+/,ia=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,sa=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Pt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,aa=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Un=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,ti=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,ni=ae(ti).replace(/bull/g,Un).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),oa=ae(ti).replace(/bull/g,Un).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),jn=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,la=/^[^\n]+/,Fn=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,ca=ae(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Fn).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),ua=ae(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Un).getRegex(),an="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Wn=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ha=ae("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Wn).replace("tag",an).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),ri=ae(jn).replace("hr",Pt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",an).getRegex(),da=ae(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",ri).getRegex(),Zn={blockquote:da,code:ia,def:ca,fences:sa,heading:aa,hr:Pt,html:ha,lheading:ni,list:ua,newline:ra,paragraph:ri,table:tt,text:la},kr=ae("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Pt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",an).getRegex(),fa={...Zn,lheading:oa,table:kr,paragraph:ae(jn).replace("hr",Pt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",kr).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",an).getRegex()},pa={...Zn,html:ae(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Wn).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:tt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:ae(jn).replace("hr",Pt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",ni).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},ga=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,ma=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,ii=/^( {2,}|\\)\n(?!\s*$)/,wa=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,on=/[\p{P}\p{S}]/u,Gn=/[\s\p{P}\p{S}]/u,si=/[^\s\p{P}\p{S}]/u,ba=ae(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Gn).getRegex(),ai=/(?!~)[\p{P}\p{S}]/u,ya=/(?!~)[\s\p{P}\p{S}]/u,ka=/(?:[^\s\p{P}\p{S}]|~)/u,oi=/(?![*_])[\p{P}\p{S}]/u,xa=/(?![*_])[\s\p{P}\p{S}]/u,Sa=/(?:[^\s\p{P}\p{S}]|[*_])/u,va=ae(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",na?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),li=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Aa=ae(li,"u").replace(/punct/g,on).getRegex(),Ea=ae(li,"u").replace(/punct/g,ai).getRegex(),ci="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Ra=ae(ci,"gu").replace(/notPunctSpace/g,si).replace(/punctSpace/g,Gn).replace(/punct/g,on).getRegex(),La=ae(ci,"gu").replace(/notPunctSpace/g,ka).replace(/punctSpace/g,ya).replace(/punct/g,ai).getRegex(),Ta=ae("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,si).replace(/punctSpace/g,Gn).replace(/punct/g,on).getRegex(),Ca=ae(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,oi).getRegex(),Ma="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",_a=ae(Ma,"gu").replace(/notPunctSpace/g,Sa).replace(/punctSpace/g,xa).replace(/punct/g,oi).getRegex(),$a=ae(/\\(punct)/,"gu").replace(/punct/g,on).getRegex(),Pa=ae(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Ia=ae(Wn).replace("(?:-->|$)","-->").getRegex(),za=ae("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Ia).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Jt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Ba=ae(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",Jt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),ui=ae(/^!?\[(label)\]\[(ref)\]/).replace("label",Jt).replace("ref",Fn).getRegex(),hi=ae(/^!?\[(ref)\](?:\[\])?/).replace("ref",Fn).getRegex(),Na=ae("reflink|nolink(?!\\()","g").replace("reflink",ui).replace("nolink",hi).getRegex(),xr=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Qn={_backpedal:tt,anyPunctuation:$a,autolink:Pa,blockSkip:va,br:ii,code:ma,del:tt,delLDelim:tt,delRDelim:tt,emStrongLDelim:Aa,emStrongRDelimAst:Ra,emStrongRDelimUnd:Ta,escape:ga,link:Ba,nolink:hi,punctuation:ba,reflink:ui,reflinkSearch:Na,tag:za,text:wa,url:tt},Oa={...Qn,link:ae(/^!?\[(label)\]\((.*?)\)/).replace("label",Jt).getRegex(),reflink:ae(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Jt).getRegex()},Rn={...Qn,emStrongRDelimAst:La,emStrongLDelim:Ea,delLDelim:Ca,delRDelim:_a,url:ae(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",xr).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:ae(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",xr).getRegex()},qa={...Rn,br:ae(ii).replace("{2,}","*").getRegex(),text:ae(Rn.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},jt={normal:Zn,gfm:fa,pedantic:pa},wt={normal:Qn,gfm:Rn,breaks:qa,pedantic:Oa},Da={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Sr=t=>Da[t];function qe(t,e){if(e){if(Te.escapeTest.test(t))return t.replace(Te.escapeReplace,Sr)}else if(Te.escapeTestNoEncode.test(t))return t.replace(Te.escapeReplaceNoEncode,Sr);return t}function vr(t){try{t=encodeURI(t).replace(Te.percentDecode,"%")}catch{return null}return t}function Ar(t,e){let n=t.replace(Te.findPipe,(i,a,c)=>{let o=!1,u=a;for(;--u>=0&&c[u]==="\\";)o=!o;return o?"|":" |"}),s=n.split(Te.splitPipe),r=0;if(s[0].trim()||s.shift(),s.length>0&&!s.at(-1)?.trim()&&s.pop(),e)if(s.length>e)s.splice(e);else for(;s.length<e;)s.push("");for(;r<s.length;r++)s[r]=s[r].trim().replace(Te.slashPipe,"|");return s}function bt(t,e,n){let s=t.length;if(s===0)return"";let r=0;for(;r<s&&t.charAt(s-r-1)===e;)r++;return t.slice(0,s-r)}function Ha(t,e){if(t.indexOf(e[1])===-1)return-1;let n=0;for(let s=0;s<t.length;s++)if(t[s]==="\\")s++;else if(t[s]===e[0])n++;else if(t[s]===e[1]&&(n--,n<0))return s;return n>0?-2:-1}function Ua(t,e=0){let n=e,s="";for(let r of t)if(r==="	"){let i=4-n%4;s+=" ".repeat(i),n+=i}else s+=r,n++;return s}function Er(t,e,n,s,r){let i=e.href,a=e.title||null,c=t[1].replace(r.other.outputLinkReplace,"$1");s.state.inLink=!0;let o={type:t[0].charAt(0)==="!"?"image":"link",raw:n,href:i,title:a,text:c,tokens:s.inlineTokens(c)};return s.state.inLink=!1,o}function ja(t,e,n){let s=t.match(n.other.indentCodeCompensation);if(s===null)return e;let r=s[1];return e.split(`
...
`;for(let m=o;m<=u;m++)if((e(p[m])||!d(p[m])&&(d(p[m+1])||e(p[m+1])))&&c++,e(p[m]))for(;m<=u&&(s(p[m+1])||d(p[m+1]));)m++;const f=c/l,h=Math.round(f*60*1e3);return{text:Math.ceil(f.toFixed(2))+" min read",minutes:f,time:h,words:c}}return kn=r,kn}var fo=ho();const po=Br(fo);function Ir(t,e){let n=document.querySelector(`meta[name="${t}"]`);n||(n=document.createElement("meta"),n.setAttribute("name",t),document.head.appendChild(n)),n.setAttribute("content",e)}function ot(t,e,n){let s=`meta[${t}="${e}"]`,r=document.querySelector(s);r||(r=document.createElement("meta"),r.setAttribute(t,e),document.head.appendChild(r)),r.setAttribute("content",n)}function go(t,e){try{let n=document.querySelector(`link[rel="${t}"]`);n||(n=document.createElement("link"),n.setAttribute("rel",t),document.head.appendChild(n)),n.setAttribute("href",e)}catch(n){console.warn("[seoManager] upsertLinkRel failed",n)}}function mo(t,e,n,s){const r=e&&String(e).trim()?e:t.title||document.title;ot("property","og:title",r);const i=s&&String(s).trim()?s:t.description||"";i&&String(i).trim()&&ot("property","og:description",i),ot("name","twitter:card",t.twitter_card||"summary_large_image");const a=n||t.image;a&&(ot("property","og:image",a),ot("name","twitter:image",a))}function wo(t,e,n,s,r=""){const i=t.meta||{},a=document&&document.querySelector&&document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",c=s&&String(s).trim()?s:i.description&&String(i.description).trim()?i.description:a&&String(a).trim()?a:"";c&&String(c).trim()&&Ir("description",c),Ir("robots",i.robots||"index,follow"),mo(i,e,n,c)}function bo(){try{const t=['meta[name="site"]','meta[name="site-name"]','meta[name="siteName"]','meta[property="og:site_name"]','meta[name="twitter:site"]'];for(const e of t){const n=document.querySelector(e);if(n){const s=n.getAttribute("content")||"";if(s&&s.trim())return s.trim()}}}catch(t){console.warn("[seoManager] getSiteNameFromMeta failed",t)}return""}function yo(t,e,n,s,r,i=""){try{const a=t.meta||{},c=n&&String(n).trim()?n:a.title||i||document.title,o=r&&String(r).trim()?r:a.description||document.querySelector('meta[name="description"]')&&document.querySelector('meta[name="description"]').getAttribute("content")||"",u=s||a.image||null;let l="";try{if(e){const h=me(e);try{l=(location.origin+location.pathname).split("?")[0]+"?page="+encodeURIComponent(h)}catch{l=location.href.split("#")[0]}}else l=location.href.split("#")[0]}catch(h){l=location.href.split("#")[0],console.warn("[seoManager] compute canonical failed",h)}l&&go("canonical",l);try{ot("property","og:url",l)}catch(h){console.warn("[seoManager] upsertMeta og:url failed",h)}const d={"@context":"https://schema.org","@type":"Article",headline:c||"",description:o||"",url:l||location.href.split("#")[0]};u&&(d.image=String(u)),a.date&&(d.datePublished=a.date),a.dateModified&&(d.dateModified=a.dateModified);const p="nimbi-jsonld";let f=document.getElementById(p);f||(f=document.createElement("script"),f.type="application/ld+json",f.id=p,document.head.appendChild(f)),f.textContent=JSON.stringify(d,null,2)}catch(a){console.warn("[seoManager] setStructuredData failed",a)}}function ko(t,e,n,s,r,i,a,c,o,u,l){try{if(s&&s.querySelector){const d=s.querySelector(".menu-label");d&&(d.textContent=c&&c.textContent||t("onThisPage"))}}catch(d){console.warn("[seoManager] update toc label failed",d)}try{const d=n.meta&&n.meta.title?String(n.meta.title).trim():"",p=r.querySelector("img"),f=p&&(p.getAttribute("src")||p.src)||null;let h="";try{let b="";try{const k=c||(r&&r.querySelector?r.querySelector("h1"):null);if(k){let A=k.nextElementSibling;const C=[];for(;A&&!(A.tagName&&A.tagName.toLowerCase()==="h2");){const M=(A.textContent||"").trim();M&&C.push(M),A=A.nextElementSibling}C.length&&(b=C.join(" ").replace(/\s+/g," ").trim()),!b&&o&&(b=String(o).trim())}}catch(k){console.warn("[seoManager] compute descOverride failed",k)}b&&String(b).length>160&&(b=String(b).slice(0,157).trim()+"..."),h=b}catch(b){console.warn("[seoManager] compute descOverride failed",b)}let g="";try{d&&(g=d)}catch{}if(!g)try{c&&c.textContent&&(g=String(c.textContent).trim())}catch{}if(!g)try{const b=r.querySelector("h2");b&&b.textContent&&(g=String(b.textContent).trim())}catch{}g||(g=i||"");try{wo(n,g||void 0,f,h)}catch(b){console.warn("[seoManager] setMetaTags failed",b)}try{yo(n,u,g||void 0,f,h,e)}catch(b){console.warn("[seoManager] setStructuredData failed",b)}const m=bo();g?m?document.title=`${m} - ${g}`:document.title=`${e||"Site"} - ${g}`:d?document.title=d:document.title=e||document.title}catch(d){console.warn("[seoManager] applyPageMeta failed",d)}try{const d=r.querySelector(".nimbi-reading-time");if(d&&d.remove(),o){const p=po(l.raw||""),f=p&&typeof p.minutes=="number"?Math.ceil(p.minutes):0,h=document.createElement("p");h.className="nimbi-reading-time",h.textContent=f?t("readingTime",{minutes:f}):"";const g=r.querySelector("h1");g&&g.insertAdjacentElement("afterend",h)}}catch(d){console.warn("[seoManager] reading time update failed",d)}}let Re=null,U=null,xe=1,Qe=(t,e)=>e,At=0,Et=0,Gt=()=>{},kt=.25;function xo(){if(Re&&document.contains(Re))return Re;Re=null;const t=document.createElement("dialog");t.className="nimbi-image-preview modal",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label",Qe("imagePreviewTitle","Image preview")),t.innerHTML=`
