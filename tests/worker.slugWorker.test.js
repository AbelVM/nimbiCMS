...
describe('slugWorker handler', () => {
  ...
  it('handles buildSearchIndex success', async () => {
    ...
    vi.spyOn(slugMgr, 'buildSearchIndex').mockResolvedValue(fake)
  ...
  it('handles buildSearchIndex error', async () => {
    vi.spyOn(slugMgr, 'buildSearchIndex').mockRejectedValue(new Error('boom'))
  ...
  it('handles crawlForSlug success and undefined -> null', async () => {
    vi.spyOn(slugMgr, 'crawlForSlug').mockResolvedValue(undefined)
  ...
  it('handles crawlForSlug found', async () => {
    vi.spyOn(slugMgr, 'crawlForSlug').mockResolvedValue('path/to.md')
  ...
  it('handles crawlForSlug error', async () => {
    vi.spyOn(slugMgr, 'crawlForSlug').mockRejectedValue(new Error('crawl fail'))
